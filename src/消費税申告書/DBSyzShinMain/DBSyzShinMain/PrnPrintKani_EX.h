...
class CPrnPrintKani_EX : public ICSDialog
{
	DECLARE_DYNAMIC(CPrnPrintKani_EX)

public:
	CPrnPrintKani_EX(CWnd* pParent = NULL);   // 標準コンストラクタ
	virtual ~CPrnPrintKani_EX();

// ダイアログ データ
	enum { IDD = IDD_DIALOG_PRN_PRINT_KANI_EX };
