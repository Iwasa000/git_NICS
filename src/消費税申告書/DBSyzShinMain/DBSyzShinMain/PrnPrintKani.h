...
class CPrnPrintKani : public ICSDialog
{
	DECLARE_DYNAMIC(CPrnPrintKani)

public:
	CPrnPrintKani(CWnd* pParent = NULL);   // 標準コンストラクタ
	virtual ~CPrnPrintKani();

// ダイアログ データ
	enum { IDD = IDD_DIALOG_PRN_PRINT_KANI };
