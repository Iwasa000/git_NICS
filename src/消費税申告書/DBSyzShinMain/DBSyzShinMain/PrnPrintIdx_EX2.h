...
#define	CHEK25		21			// 付表６（税率別消費税額計算表）
#define	CHEK20		22			// 付表６・付表７
#define	CHEK06		23			// 第２６号様式
#define	CHEK18		24			// 第２６号様式Ａ４ヨコ控用
#define	CHEK09		25			// 消費税の還付申告に関する明細書（表面）
#define	CHEK10		26			// 消費税の還付申告に関する明細書（裏面）
#define	CHEK11		27			// 更正の請求書
#define	CHEK12		28			// 課税取引金額計算表　個別指定用 
#define	CHEK13		29			// 特定収入計算表　個別指定用  
#define	CHEK14		30			// 税務代理書面　個別指定用   
//#define	CHEK15		31			// 課税売上高計算表
//#define	CHEK16		32			// 課税仕入高計算表 
//#define	CHEK17		33			// 特定収入計算表
#define	CHEK22		31			// 特例１
#define	CHEK23		32			// 特例２
#define	CHEK24		33			// 特例３

// 部数
#define	TITLE_08	34			// 『部数』
#define	CHEK04_1_BUSU		35	// 付表１－１
#define	CHEK04_2_BUSU		36	// 付表１－２
#define	CHEK04_3_BUSU		37	// 付表１－３
#define	CHEK03_1_BUSU		38	// 付表２－１
#define	CHEK03_2_BUSU		39	// 付表２－２
#define	CHEK03_3_BUSU		40	// 付表２－３
#define	CHEK25_BUSU			41	// 付表６（税率別消費税額計算表）
#define	CHEK20_BUSU			42	// 付表６・付表７
#define	CHEK06_BUSU			43	// 第２６号様式
#define	CHEK18_BUSU			44	// 第２６号様式Ａ４ヨコ控用
#define	CHEK09_BUSU			45	// 消費税の還付申告に関する明細書（表面）
#define	CHEK10_BUSU			46	// 消費税の還付申告に関する明細書（裏面）
#define	CHEK11_BUSU			47	// 更正の請求書
#define	CHEK22_BUSU			48	// 特例１
#define	CHEK23_BUSU			49	// 特例２
#define	CHEK24_BUSU			50	// 特例３
#define	CHEK12_BUSU			51	// 課税取引金額計算表　個別指定用 
#define	CHEK13_BUSU			52	// 特定収入計算表　個別指定用  
#define	CHEK14_BUSU			53	// 税務代理書面　個別指定用   
//#define	CHEK15_BUSU			57	// 課税売上高計算表
//#define	CHEK16_BUSU			58	// 課税仕入高計算表 
//#define	CHEK17_BUSU			59	// 特定収入計算表
...
static SH_ITEMINDEX	PrnTbl1[]	=	{
	...
	{	CHEK25,		0, 0, 0		},	// 付表６（税率別消費税額計算表）
	{	CHEK20,		0, 0, 0		},	// 付表６・付表７
	{	CHEK06,		1, 1, 0		},	// 第２６号様式
...
static SH_ITEMINDEX	PrnTbl3[]	=	{
	...
	{	CHEK06,		0, 0, 0		},	// 第２６号様式
	{	CHEK18,		0, 0, 0		},	// 第２６号様式Ａ４ヨコ控用
	{	CHEK25,		18,18,0		},	// 付表６（税率別消費税額計算表）
	{	CHEK20,		14,14,0		},	// 付表６・付表７
...
{CHEK25_BUSU,0x79,-1},								// 付表６（税率別消費税額計算表）
{CHEK20_BUSU,0x16,-1},								// 付表６・付表７
...
{	
	...
	{CHEK25,CHEK25_BUSU,-1,-1,-1,-1,-1,-1,-1,-1},
...
#define	CHEK25_OLD		21			// 付表６（税率別消費税額計算表）
#define	CHEK20_OLD		22			// 付表６・付表７
#define	CHEK06_OLD		23			// 第２６号様式
#define	CHEK18_OLD		24			// 第２６号様式Ａ４ヨコ控用
#define	CHEK09_OLD		25			// 消費税の還付申告に関する明細書（表面）
#define	CHEK10_OLD		26			// 消費税の還付申告に関する明細書（裏面）
#define	CHEK11_OLD		27			// 更正の請求書
#define	CHEK12_OLD		28			// 課税取引金額計算表　事業所得用 
#define	CHEK13_OLD		29			// 課税取引金額計算表　農業所得用 
#define	CHEK14_OLD		30			// 課税取引金額計算表　不動産所得用  
#define	CHEK15_OLD		31			// 課税売上高計算表
#define	CHEK16_OLD		32			// 課税仕入高計算表 
#define	CHEK17_OLD		33			// 特定収入計算表
#define	CHEK22_OLD		34			// 特例１
#define	CHEK23_OLD		35			// 特例２
#define	CHEK24_OLD		36			// 特例３

// 部数
#define	TITLE_08_OLD	37			// 『部数』
#define	CHEK04_1_BUSU_OLD		38	// 付表１－１
#define	CHEK04_2_BUSU_OLD		39	// 付表１－２
#define	CHEK04_3_BUSU_OLD		40	// 付表１－３
#define	CHEK03_1_BUSU_OLD		41	// 付表２－１
#define	CHEK03_2_BUSU_OLD		42	// 付表２－２
#define	CHEK03_3_BUSU_OLD		43	// 付表２－３
#define	CHEK25_BUSU_OLD			44	// 付表６（税率別消費税額計算表）
#define	CHEK20_BUSU_OLD			45	// 付表６・付表７
#define	CHEK06_BUSU_OLD			46	// 第２６号様式
#define	CHEK18_BUSU_OLD			47	// 第２６号様式Ａ４ヨコ控用
#define	CHEK09_BUSU_OLD			48	// 消費税の還付申告に関する明細書（表面）
#define	CHEK10_BUSU_OLD			49	// 消費税の還付申告に関する明細書（裏面）
#define	CHEK11_BUSU_OLD			50	// 更正の請求書
#define	CHEK22_BUSU_OLD			51	// 特例１
#define	CHEK23_BUSU_OLD			52	// 特例２
#define	CHEK24_BUSU_OLD			53	// 特例３
#define	CHEK12_BUSU_OLD			54	// 課税取引金額計算表　事業所得用 
#define	CHEK13_BUSU_OLD			55	// 課税取引金額計算表　農業所得用 
#define	CHEK14_BUSU_OLD			56	// 課税取引金額計算表　不動産所得用  
#define	CHEK15_BUSU_OLD			57	// 課税売上高計算表
#define	CHEK16_BUSU_OLD			58	// 課税仕入高計算表 
#define	CHEK17_BUSU_OLD			59	// 特定収入計算表