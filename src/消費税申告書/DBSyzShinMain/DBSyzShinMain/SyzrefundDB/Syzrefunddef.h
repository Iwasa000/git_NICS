...
#define ZICOLOR  BC_GREEN
#define CLCOLOR  BC_GREEN
#define HPCOLOR  BC_CREAM	//	’ •[F
...
#define KPSsLN 16  // ‘Y‚Ìí—Ş“™
#define KPSnLN 20  // æˆøæZŠ
#define KPSaLN 30  // æˆøæZŠ 

#define KPStLN 20  // å‚Èæˆø¤•i
#define KPSzLN 16  // ŠŠÅŠÖ–¼

#define KPEbnLN 20 // ‹âs–¼
#define KPEstLN 20 // x“X–¼
#define KPEykLN 8  // —a‹àí•Ê

#define KPEsnLN 40 // å‚È’ÊŠÖ‹ÆÒ@–¼
#define KPEaLN  40 // å‚È’ÊŠÖ‹ÆÒ@ZŠ

#define KPSpLN 120 // “Áê–î

#define KPRrLN 40  // ‚»‚Ì‘¼‚Ì——R
