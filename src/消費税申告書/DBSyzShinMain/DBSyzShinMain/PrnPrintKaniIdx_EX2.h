...
#define	CHEK23				24	// 付表６（税率別消費税額計算表）
#define	CHEK21				25	// 付表６
#define	CHEK06_K			26	// 第２６号様式
#define	CHEK18_K  			27	// 第２６号様式Ａ４ヨコ控用
#define	CHEK09_K			28	// 消費税の還付申告に関する明細書（表面）
#define	CHEK10_K  			29	// 消費税の還付申告に関する明細書（裏面）
#define	CHEK11_K			30	// 更正の請求書
#define	CHEK22_K			34	// 特例１
#define	CHEK12_K			31	// 課税取引金額計算表　個別指定用 
#define	CHEK13_K			32	// 特定収入計算表　個別指定用  
#define	CHEK14_K			33	// 税務代理書面　個別指定用  
//#define	CHEK15_K			34	// 課税売上高計算表
//#define	CHEK19				35	// 事業別売上高[13'09.19]

// 部数
#define	TITLE_08			35	// 『部数』
#define	CHEK04_1_BUSU		36	// 付表４－１
#define	CHEK04_2_BUSU		37	// 付表４－２
#define	CHEK04_3_BUSU		38	// 付表４－３
#define	CHEK03_1_BUSU		39	// 付表５－１
#define	CHEK03_2_BUSU		40	// 付表５－１(２)
#define	CHEK05_1_BUSU		41	// 付表５－２
#define	CHEK05_2_BUSU		42	// 付表５－２(２)
#define	CHEK06_1_BUSU		43	// 付表５－３
#define	CHEK06_2_BUSU		44	// 付表５－３(２)
#define	CHEK23_BUSU			45	// 付表６（税率別消費税額計算表）
#define	CHEK21_BUSU			46	// 付表６・付表７
#define	CHEK06_BUSU_K		47	// 第２６号様式
#define	CHEK18_BUSU_K		48	// 第２６号様式Ａ４ヨコ控用
#define	CHEK09_BUSU_K		49	// 消費税の還付申告に関する明細書（表面）
#define	CHEK10_BUSU_K		50	// 消費税の還付申告に関する明細書（裏面）
#define	CHEK11_BUSU_K		51	// 更正の請求書
#define	CHEK22_BUSU_K		52	// 特例１
#define	CHEK12_BUSU_K		53	// 課税取引金額計算表　個別指定用 
#define	CHEK13_BUSU_K		54	// 特定収入計算表　個別指定用  
#define	CHEK14_BUSU_K		55	// 税務代理書面　個別指定用  
//#define	CHEK15_BUSU_K		58	// 課税売上高計算表
//#define	CHEK19_BUSU			59	// 事業別売上高[13'09.19]
...
static SH_ITEMINDEX	PrnTbl1_K[]	=	{
	...
	{	CHEK23,	0, 0, 0		},	// 付表６（税率別消費税額計算表）
	{	CHEK21,	0, 0, 0		},	// 付表６・付表７
...
static SH_ITEMINDEX	PrnTbl3_K[]	=	{
	...
	{	CHEK23,17,17, 0		},	// 付表６（税率別消費税額計算表）
	{	CHEK21,13,13, 0		},	// 付表６・付表７
	{	CHEK06_K, 0, 0, 0	},	// 第２６号様式
	{	CHEK18_K, 0, 0, 0	},	// 第２６号様式Ａ４ヨコ控用
...
{CHEK23_BUSU,0x79,-1},								// 付表６（税率別消費税額計算表）
{CHEK21_BUSU,0x16,-1},								// 付表６・付表７
...
// 24/03/22_411 cor -->
//{CHEK12_BUSU_K,0x12,-1},							// 課税取引金額計算表　事業所得用 
//{CHEK13_BUSU_K,0x14,-1},							// 課税取引金額計算表　農業所得用 
//{CHEK14_BUSU_K,0x13,-1},							// 課税取引金額計算表　不動産所得用 
// --------------------
// 課税取引金額計算表　個別指定用 
...
#define	CHEK23_OLD				24	// 付表６（税率別消費税額計算表）
#define	CHEK21_OLD				25	// 付表６
#define	CHEK06_K_OLD			26	// 第２６号様式
#define	CHEK18_K_OLD			27	// 第２６号様式Ａ４ヨコ控用
#define	CHEK09_K_OLD			28	// 消費税の還付申告に関する明細書（表面）
#define	CHEK10_K_OLD  			29	// 消費税の還付申告に関する明細書（裏面）
#define	CHEK11_K_OLD			30	// 更正の請求書
#define	CHEK22_K_OLD			36	// 特例１
#define	CHEK12_K_OLD			31	// 課税取引金額計算表　事業所得用 
#define	CHEK13_K_OLD			32	// 課税取引金額計算表　農業所得用 
#define	CHEK14_K_OLD			33	// 課税取引金額計算表　不動産所得用 
#define	CHEK15_K_OLD			34	// 課税売上高計算表
#define	CHEK19_OLD				35	// 事業別売上高[13'09.19]

// 部数
#define	TITLE_08_OLD			37	// 『部数』
#define	CHEK04_1_BUSU_OLD		38	// 付表４－１
#define	CHEK04_2_BUSU_OLD		39	// 付表４－２
#define	CHEK04_3_BUSU_OLD		40	// 付表４－３
#define	CHEK03_1_BUSU_OLD		41	// 付表５－１
#define	CHEK03_2_BUSU_OLD		42	// 付表５－１(２)
#define	CHEK05_1_BUSU_OLD		43	// 付表５－２
#define	CHEK05_2_BUSU_OLD		44	// 付表５－２(２)
#define	CHEK06_1_BUSU_OLD		45	// 付表５－３
#define	CHEK06_2_BUSU_OLD		46	// 付表５－３(２)
#define	CHEK23_BUSU_OLD			47	// 付表６（税率別消費税額計算表）
#define	CHEK21_BUSU_OLD			48	// 付表６・付表７
#define	CHEK06_BUSU_K_OLD		49	// 第２６号様式
#define	CHEK18_BUSU_K_OLD		50	// 第２６号様式Ａ４ヨコ控用
#define	CHEK09_BUSU_K_OLD		51	// 消費税の還付申告に関する明細書（表面）
#define	CHEK10_BUSU_K_OLD		52	// 消費税の還付申告に関する明細書（裏面）
#define	CHEK11_BUSU_K_OLD		53	// 更正の請求書
#define	CHEK22_BUSU_K_OLD		54	// 特例１
#define	CHEK12_BUSU_K_OLD		55	// 課税取引金額計算表　事業所得用 
#define	CHEK13_BUSU_K_OLD		56	// 課税取引金額計算表　農業所得用 
#define	CHEK14_BUSU_K_OLD		57	// 課税取引金額計算表　不動産所得用 
#define	CHEK15_BUSU_K_OLD		58	// 課税売上高計算表
#define	CHEK19_BUSU_OLD			59	// 事業別売上高[13'09.19]