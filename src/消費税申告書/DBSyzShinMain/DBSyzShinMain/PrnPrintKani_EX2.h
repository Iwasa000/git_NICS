...
class CPrnPrintKani_EX2 : public ICSDialog
{
	DECLARE_DYNAMIC(CPrnPrintKani_EX2)

public:
	CPrnPrintKani_EX2(CWnd* pParent = NULL);   // 標準コンストラクタ
	virtual ~CPrnPrintKani_EX2();

// ダイアログ データ
	enum { IDD = IDD_DIALOG_PRN_PRINT_KANI_EX2 };
...
private:
	...
	BOOL				m_isNoneMTForm;		// 付表4-3 / 5-3 新様式で出力
...
public:
	...
	CButton m_WithMynoCheck;
	afx_msg void OnBnClickedCheckWithMyno();
