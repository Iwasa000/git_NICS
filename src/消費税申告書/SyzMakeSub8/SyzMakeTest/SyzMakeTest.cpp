// SyzMakeTest.cpp : アプリケーションのクラス動作を定義します。
//
...
BEGIN_MESSAGE_MAP(CSyzMakeTestApp, ICSWinApp)
	ON_COMMAND(ID_APP_ABOUT, OnAppAbout)
	ON_COMMAND(ID_FILE_NEW, &ICSWinApp::OnFileNew)
END_MESSAGE_MAP()


// CSyzMakeTestApp コンストラクション

CSyzMakeTestApp::CSyzMakeTestApp()
{
	// TODO: この位置に構築用コードを追加してください。
	// ここに InitInstance 中の重要な初期化処理をすべて記述してください。
}

// 唯一の CSyzMakeTestApp オブジェクトです。

CSyzMakeTestApp theApp;

// CSyzMakeTestApp 初期化

int CSyzMakeTestApp::BeginApp()
{
	return	ICSWinApp::BeginApp();
}

BOOL CSyzMakeTestApp::InitInstance()
{
	...
	CreateDocTemplate( IDR_SYZMAKETESTTYPE,
		RUNTIME_CLASS(CSyzMakeTestDoc),
		RUNTIME_CLASS(CChildFrame), // カスタム MDI 子フレーム
		RUNTIME_CLASS(CSyzMakeTestView));
...
void CSyzMakeTestApp::OnAppAbout()
{
	CAboutDlg aboutDlg;
	aboutDlg.DoModal();
}

// CSyzMakeTestApp メッセージ ハンドラ
