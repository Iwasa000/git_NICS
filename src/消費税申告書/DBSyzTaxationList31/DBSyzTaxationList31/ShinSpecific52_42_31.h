...
class CShinSpecific52_42_31 : public CSpcBaseDlg
{
	DECLARE_DYNAMIC(CShinSpecific52_42_31)

public:
	CShinSpecific52_42_31(CWnd* pParent = nullptr, TSREC52* pRec = NULL);   // 標準コンストラクター
	virtual ~CShinSpecific52_42_31();

	// ダイアログ データ
	enum { IDD = IDD_DIALOG_K52_42_31 };


public:
	void SpecificInit52_42_31();
	void SetItemPosition();
	// 表示
	void SpecificDisp52_42_31();
	// 次フォーカスの場所検索（上下左右動作）
...
protected:
	...
	DECLARE_MESSAGE_MAP()
public:
	CIcsdiagctrl m_Specific52_42_31;
