...
class CShinJigyo31 : public CSyzBaseDlg
{
	DECLARE_DYNAMIC(CShinJigyo31)

public:
	CShinJigyo31(CWnd* pParent = nullptr);   // 標準コンストラクター
	virtual ~CShinJigyo31();

// ダイアログ データ
//#ifdef AFX_DESIGN_TIME
	enum { IDD = IDD_DIALOG_JIGYO31 };
//#endif
