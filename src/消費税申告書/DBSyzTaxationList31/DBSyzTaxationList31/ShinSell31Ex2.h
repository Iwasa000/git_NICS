...
class CShinSell31Ex2 : public CSyzBaseDlg
{
	DECLARE_DYNAMIC(CShinSell31Ex2)

public:
	CShinSell31Ex2(CWnd* pParent = nullptr);   // 標準コンストラクター
	virtual ~CShinSell31Ex2();

// ダイアログ データ
#ifdef AFX_DESIGN_TIME
	enum { IDD = IDD_DIALOG_SELL31_ex2 };
#endif
