...
class CShinSpecific52_43_31 : public CSpcBaseDlg
{
	DECLARE_DYNAMIC(CShinSpecific52_43_31)

public:
	CShinSpecific52_43_31(CWnd* pParent = nullptr, TSREC52* pRec = NULL);   // 標準コンストラクター
	virtual ~CShinSpecific52_43_31();

	// ダイアログ データ
	enum { IDD = IDD_DIALOG_K52_43_31 };

public:
	void SpecificInit52_43_31();
	void SetItemPosition();
	// 表示
	void SpecificDisp52_43_31();
...
protected:
	...
	DECLARE_MESSAGE_MAP()
public:
	CIcsdiagctrl m_Specific52_43_31;
