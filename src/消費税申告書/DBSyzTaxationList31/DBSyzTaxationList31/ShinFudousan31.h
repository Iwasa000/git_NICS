...
class CShinFudousan31 : public CSyzBaseDlg
{
	DECLARE_DYNAMIC(CShinFudousan31)

public:
	CShinFudousan31(CWnd* pParent = NULL);   // 標準コンストラクタ
	virtual ~CShinFudousan31();

// ダイアログ データ
	enum { IDD = IDD_DIALOG_FUDOUSAN31};
