...
class CShinFudousan31Ex : public CSyzBaseDlg
{
	DECLARE_DYNAMIC(CShinFudousan31Ex)

public:
	CShinFudousan31Ex(CWnd* pParent = NULL);   // 標準コンストラクタ
	virtual ~CShinFudousan31Ex();

// ダイアログ データ
	enum { IDD = IDD_DIALOG_FUDOUSAN31_ex};
