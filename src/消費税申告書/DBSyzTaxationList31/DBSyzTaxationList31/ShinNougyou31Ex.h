...
class CShinNougyou31Ex : public CSyzBaseDlg
{
	DECLARE_DYNAMIC(CShinNougyou31Ex)

public:
	CShinNougyou31Ex(CWnd* pParent = NULL);   // 標準コンストラクタ
	virtual ~CShinNougyou31Ex();

// ダイアログ データ
	enum { IDD = IDD_DIALOG_NOUGYOU31 };
	...
	// ダイアグデータ表示
	void DispNougyou31DiagData( long dlin );
	// カーソル移動
