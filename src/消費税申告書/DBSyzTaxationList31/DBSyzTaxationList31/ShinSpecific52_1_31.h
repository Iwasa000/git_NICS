...
class CShinSpecific52_1_31 : public CSpcBaseDlg
{
	DECLARE_DYNAMIC(CShinSpecific52_1_31)

public:
// 24/02/15_特定収入 cor -->
	//CShinSpecific52_1_31(CWnd* pParent = nullptr);   // 標準コンストラクター
// -------------------------
	CShinSpecific52_1_31(CWnd* pParent = nullptr, TSREC52* pRec=NULL);   // 標準コンストラクター
// 24/02/15_特定収入 cor <--
	virtual ~CShinSpecific52_1_31();

	// ダイアログ データ

	enum { IDD = IDD_DIALOG_K52_1_31 };

public:
	void SpecificInit52_1_31();
	void SetItemPosition();

	// 金額表示
	void SpecificDisp52_1_31();
	// 次フォーカスの場所検索（上下左右動作）
	...
	void IndexControl();
	// 再計算
	void Specific52_1_31_Calq();
	void CalcSelDisable();
	// 
	void CalcSelChange( int pSel );
...
protected:
	...
	DECLARE_MESSAGE_MAP()
public:
	CIcsdiagctrl m_Specific52_1_31;
