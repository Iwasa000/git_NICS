...
class CShinKniinp31Ex : public CSyzBaseDlg
{
	DECLARE_DYNAMIC(CShinKniinp31Ex)

public:
	CShinKniinp31Ex(CWnd* pParent = NULL);   // 標準コンストラクタ
	virtual ~CShinKniinp31Ex();
...
// ダイアログ データ
	enum { IDD = IDD_DIALOG_JIGYO_SELL31_ex };
