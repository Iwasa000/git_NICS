...
class CShinBuy31Ex : public CSyzBaseDlg
{
	DECLARE_DYNAMIC(CShinBuy31Ex)

public:
	CShinBuy31Ex(CWnd* pParent = NULL);   // 標準コンストラクター
	virtual ~CShinBuy31Ex();

// ダイアログ データ

	enum { IDD = IDD_DIALOG_BUY31_ex };
