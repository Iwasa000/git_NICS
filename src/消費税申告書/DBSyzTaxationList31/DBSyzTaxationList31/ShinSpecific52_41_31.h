...
class CShinSpecific52_41_31 : public CSpcBaseDlg
{
	DECLARE_DYNAMIC(CShinSpecific52_41_31)

public:
	//CShinSpecific52_41_31(CWnd* pParent = nullptr);   // 標準コンストラクター
	CShinSpecific52_41_31(CWnd* pParent = nullptr, TSREC52* pRec = NULL);   // 標準コンストラクター
	virtual ~CShinSpecific52_41_31();

	// ダイアログ データ

	enum { IDD = IDD_DIALOG_K52_41_31 };

public:
	void SpecificInit52_41_31();
	void SetItemPosition();
	// 表示
	void SpecificDisp52_41_31();
	// 次フォーカスの場所検索（上下左右動作）
...
protected:
	...
	DECLARE_MESSAGE_MAP()
public:
	CIcsdiagctrl m_Specific52_41_31;
