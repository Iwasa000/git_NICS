...
class CShinSpecific22_31 : public CSpcBaseDlg
{
	DECLARE_DYNAMIC(CShinSpecific22_31)

public:
	CShinSpecific22_31(CWnd* pParent = nullptr);   // 標準コンストラクター
	virtual ~CShinSpecific22_31();

// ダイアログ データ
//#ifdef AFX_DESIGN_TIME
	enum { IDD = IDD_DIALOG_K22_31 };
//#endif
private:
	long				m_Spage;
	int					m_TableNo;
