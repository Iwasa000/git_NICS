// SyzAcsTest.cpp : アプリケーションのクラス動作を定義します。
//
...
BEGIN_MESSAGE_MAP(CSyzAcsTestApp, ICSWinApp)
	ON_COMMAND(ID_APP_ABOUT, OnAppAbout)
	ON_COMMAND(ID_FILE_NEW, &ICSWinApp::OnFileNew)
END_MESSAGE_MAP()


// CSyzAcsTestApp コンストラクション

CSyzAcsTestApp::CSyzAcsTestApp()
{
	// TODO: この位置に構築用コードを追加してください。
	// ここに InitInstance 中の重要な初期化処理をすべて記述してください。
}

// 唯一の CSyzAcsTestApp オブジェクトです。

CSyzAcsTestApp theApp;

// CSyzAcsTestApp 初期化

int CSyzAcsTestApp::BeginApp()
{
	return	ICSWinApp::BeginApp();
}

BOOL CSyzAcsTestApp::InitInstance()
{
	...
	CreateDocTemplate( IDR_SYZACSTESTTYPE,
		RUNTIME_CLASS(CSyzAcsTestDoc),
		RUNTIME_CLASS(CChildFrame), // カスタム MDI 子フレーム
		RUNTIME_CLASS(CSyzAcsTestView));
...
void CSyzAcsTestApp::OnAppAbout()
{
	CAboutDlg aboutDlg;
	aboutDlg.DoModal();
}

// CSyzAcsTestApp メッセージ ハンドラ
