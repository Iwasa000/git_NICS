...
static SH_TAGNAME tagData201[] = {
	...
	// ñ∆ê≈îÑè„äz
	{ _T("CRB00060"), 999 },
	// îÒâ€ê≈éëéYÇÃóAèoìôÇÃã‡äzÅAäCäOéxìXìôÇ÷ÇÃà⁄ëóÇµÇΩéëéYÇÃâøäz
	{ _T("CRB00070"), 999 },
	...
	//{ _T("AED00030"), 3 },
	{ _T("CRD00000"), 999 },
	// â€ê≈édì¸ÇÍÇ…åWÇÈéxï•ëŒâøÇÃäz(ê≈çûÇ›)
	{ _T("CRE00020"), 0 },
	{ _T("CRE00030"), 1 },
	{ _T("CRE00040"), 3 },
	{ _T("CRE00050"), 999 },
	// â€ê≈édì¸ÇÍÇ…åWÇÈè¡îÔê≈äz
	{ _T("CRE00070"), 0 },
	{ _T("CRE00080"), 1 },
	{ _T("CRE00090"), 3 },
	{ _T("CRE00100"), 999 },
//----> 20230120
	// ìKäiêøãÅèëî≠çséñã∆é“Å`Åcéxï•Ç¢ëŒâøÇÃäz(ê≈çûÇ›)
	{ _T("CRE00350"), 0 },
	{ _T("CRE00360"), 1 },
	{ _T("CRE00370"), 3 },
	{ _T("CRE00380"), 999 },
	// ìKäiêøãÅèëî≠çséñã∆é“Å`Åcè¡îÔê≈äzÇ∆Ç›Ç»Ç≥ÇÍÇÈäz
	{ _T("CRE00400"), 0 },
	{ _T("CRE00410"), 1 },
	{ _T("CRE00420"), 3 },
	{ _T("CRE00430"), 999 },
//<---- 20230120
	...
	{ _T("CRE00220"), 3 },
	{ _T("CRE00230"), 999 },
	// î[ê≈ã`ñ±ÇÃñ∆èúÇéÛÇØÇ»Ç¢(éÛÇØÇÈ)Ç±Ç∆Ç∆Ç»Ç¡ÇΩèÍçáÇ…
	// Ç®ÇØÇÈè¡îÔê≈äzÇÃí≤êÆ(â¡éZñîÇÕå∏éZ)äz
	{ _T("CRE00250"), 0 },
	{ _T("CRE00260"), 1 },
	{ _T("CRE00270"), 3 },
	{ _T("CRE00280"), 999 },
	// â€ê≈édì¸ÇÍìôÇÃê≈äzÇÃçáåväz
	{ _T("CRE00300"), 0 },
	{ _T("CRE00310"), 1 },
	{ _T("CRE00320"), 3 },
	{ _T("CRE00330"), 999 },
	// â€ê≈îÑè„çÇÇ™5â≠â~à»â∫ÅAÇ©Ç¬ÅAâ€ê≈îÑè„äÑçáÇ™95Åìà»è„ÇÃèÍçá
	{ _T("CRF00010"), 0 },
	{ _T("CRF00020"), 1 },
	{ _T("CRF00030"), 3 },
	{ _T("CRF00040"), 999 },
	// â€ê≈îÑè„çÇÇ™5â≠â~í¥ñîÇÕâ€ê≈îÑè„äÑçáÇ™95Åìñ¢ñûÇÃèÍçá
	// 15ÇÃÇ§ÇøÅAâ€ê≈îÑè„Ç∞Ç…ÇÃÇ›óvÇ∑ÇÈÇ‡ÇÃ
	{ _T("CRG00030"), 0 },
	{ _T("CRG00040"), 1 },
	{ _T("CRG00050"), 3 },
	{ _T("CRG00060"), 999 },
	// 15ÇÃÇ§ÇøÅAâ€ê≈îÑè„Ç∆îÒâ€ê≈îÑè„Ç…ã§í ÇµÇƒóvÇ∑ÇÈÇ‡ÇÃ
	{ _T("CRG00080"), 0 },
	{ _T("CRG00090"), 1 },
	{ _T("CRG00100"), 3 },
	{ _T("CRG00110"), 999 },
	// å¬ï ëŒâûï˚éÆÇ…ÇÊÇËçTèúÇ∑ÇÈâ€ê≈édì¸ìôÇÃê≈äz
	{ _T("CRG00130"), 0 },
	{ _T("CRG00140"), 1 },
	{ _T("CRG00150"), 3 },
	{ _T("CRG00160"), 999 },
	// àÍäáî‰ó·îzï™ï˚éÆÇ…ÇÊÇËçTèúÇ∑ÇÈâ€ê≈édì¸ÇÍìôÇÃê≈äz
	{ _T("CRG00180"), 0 },
	{ _T("CRG00190"), 1 },
	{ _T("CRG00200"), 3 },
	{ _T("CRG00210"), 999 },
	// â€ê≈îÑè„äÑçáïœìÆéûÇÃí≤êÆëŒè€å≈íËéëéYÇ…åWÇÈè¡îÔê≈äzÇÃí≤êÆäz
	{ _T("CRH00020"), 0 },
	{ _T("CRH00030"), 1 },
	{ _T("CRH00040"), 3 },
	{ _T("CRH00050"), 999 },
	// í≤êÆëŒè€å≈íËéëéYÇâ€ê≈ã∆ñ±ópÇ…ì]ópÇµÇΩèÍçáÇÃí≤êÆäz
	{ _T("CRH00070"), 0 },
	{ _T("CRH00080"), 1 },
	{ _T("CRH00090"), 3 },
	{ _T("CRH00100"), 999 },
	// ãèèZópë›éÿåöï®Çâ€ê≈í¿ë›ópÇ…ãüÇµÇΩ(è˜ìnÇµÇΩ)èÍçáÇÃâ¡éZäz
	{ _T("CRH00120"), 0 },
	{ _T("CRH00130"), 1 },
	{ _T("CRH00140"), 3 },
	{ _T("CRH00150"), 999 },
...
int CH31SnFhyo2_01Data::GetData( CDBNpSub *pDBNpSub, int sn_seq )
{
	...
	for ( int i = 0; ; i++ ) {
		...
		// îÒâ€ê≈éëéYÇÃóAèoìôÇÃã‡äzÅAäCäOéxìXÇ÷à⁄ëóÇµÇΩéëéYÇÃâøäz
...
//<---- 20230120
		...
		// î[ê≈ã`ñ±ÇÃñ∆èúÇéÛÇØÇ»Ç¢(éÛÇØÇÈ)Ç±Ç∆Ç∆Ç»Ç¡ÇΩèÍçáÇ…Ç®ÇØÇÈè¡îÔê≈äzÇÃí≤êÆ(â¡éZñîÇÕå∏éZ)äz
		...
		// â€ê≈îÑè„çÇÇ™5â≠â~à»â∫ÅAÇ©Ç¬ÅAâ€ê≈îÑè„äÑçáÇ™95%à»è„ÇÃèÍçá
		...
		// 15ÇÃÇ§ÇøÅAâ€ê≈îÑè„Ç…ÇÃÇ›óvÇ∑ÇÈÇ‡ÇÃ
		...
		// 15ÇÃÇ§ÇøÅAâ€ê≈îÑè„Ç∆îÒâ€ê≈îÑÇËè„Ç∞Ç…ã§í ÇµÇƒóvÇ∑ÇÈÇ‡ÇÃ
		...
		// å¬ï ëŒâûï˚éÆÇ…ÇÊÇËçTèúÇ∑ÇÈâ€ê≈édì¸ÇÍìôÇÃê≈äz
		...
		// â€ê≈îÑè„äÑçáïœìÆéûÇÃí≤êÆëŒè€å≈íËéëéYÇ…åWÇÈè¡îÔê≈äzÇÃí≤êÆ(â¡éZñîÇÕå∏éZ)äz
		...
		// í≤êÆëŒè€å≈íËéëéYÇâ€ê≈ã∆ñ±óp(îÒâ€ê≈ã∆ñ±óp)Ç…ì]ópÇµÇΩèÍçáÇÃí≤êÆ(â¡éZñîÇÕå∏éZ)äz
...
int CH31SnFhyo2_01Data::SetData( CDBNpSub *pDBNpSub, int sn_seq )
{
	...
	if ( ( pShLstVal->MoveFirst() == -1 ) || ( pShLstVal->st == -1 ) ) {	// ÉfÅ[É^Ç»Çµ
		...
		// îÒâ€ê≈éëéYÇÃóAèoìôÇÃã‡äzÅAäCäOéxìXìôÇ÷à⁄ëóÇµÇΩéëéYÇÃäz
		pShLstVal->AddNew();
		pShLstVal->sn_seq = sn_seq;
		pShLstVal->version = nowVersion;
		pShLstVal->hyoId = pHyoID;
		...
		// â€ê≈édì¸ÇÍÇ…åWÇÈéxï•Ç¢ëŒâøÇÃäz(ê≈çûÇ›)
		pShLstVal->AddNew();
		pShLstVal->sn_seq = sn_seq;
		pShLstVal->version = nowVersion;
		pShLstVal->hyoId = pHyoID;
...
//		pShLstVal->sign1 = 0;
		...
		// 15Ç…ÇÃÇ§ÇøÅAâ€ê≈îÑè„Ç…ÇÃÇ›óvÇ∑ÇÈÇ‡ÇÃ
		pShLstVal->AddNew();
		pShLstVal->sn_seq = sn_seq;
		pShLstVal->version = nowVersion;
		pShLstVal->hyoId = pHyoID;
		...
		// 15ÇÃÇ§ÇøÅAâ€ê≈îÑè„Ç∆îÒâ€ê≈îÑè„Ç∞Ç…ã§í ÇµÇƒóvÇ∑ÇÈÇ‡ÇÃ
		pShLstVal->AddNew();
		pShLstVal->sn_seq = sn_seq;
		pShLstVal->version = nowVersion;
		pShLstVal->hyoId = pHyoID;
...
//		pShLstVal->sign1 = 0;
		...
		for ( int i = 0; ; i++ ) {
			...
			// îÒâ€ê≈éëéYÇÃóAèoìôÇÃã‡äzÅAäCäOéxìXìôÇ÷à⁄ëóÇµÇΩéëéYÇÃâøäz
			else if ( pShLstVal->itmId == _T( "CRB00070" ) ) {
				pShLstVal->Edit();
				m_Util.val_to_asci ( &pShLstVal->val, Sn_F201_3F );
				pShLstVal->Update();
			...
			// â€ê≈îÑè„çÇÇ™5â≠â~à»â∫ÅAÇ©Ç¬ÅAâ€ê≈îÑè„äÑçáÇ™95%ñ¢ñûÇÃèÍçá
			else if ( pShLstVal->itmId == _T( "CRF00010" ) ) {
				pShLstVal->Edit();
				m_Util.val_to_asci ( &pShLstVal->val, Sn_F201_16X );
				pShLstVal->Update();
...
/*			// 15ÇÃÇ§ÇøÅAâ€ê≈îÑè„Ç∞Ç…ÇÃÇ›óvÇ∑ÇÈÇ‡ÇÃ
			...
			// 15ÇÃÇ§ÇøÅAâ€ê≈îÑè„Ç∞Ç∆îÒâ€ê≈îÑÇËè„Ç∞Ç…ã§í ÇµÇƒóvÇ∑ÇÈÇ‡ÇÃ
...
// à¯êî	pDBNpSub	ÅF	
//		type		ÅF	
//		ClearType	ÅF	D0:ON	:	éËì¸óÕã‡äzÇÉNÉäÉAÇµÇ»Ç¢
//-----------------------------------------------------------------------------
// ï‘ëóíl	0		ÅF	
//-----------------------------------------------------------------------------
...
{
//	Sn_F201_10sw = 0;//yoshida190909 ÉRÉÅÉìÉgâª
	Sn_F201_12sw = 0;
	Sn_F201_19sw = 0;
	Sn_F201_20sw = 0;
	Sn_F201_23sw = 0;
	//---->20230120
//	Sn_F201_28sw = 0; // Ç±Ç±Ç≈óéÇ∆Ç∑Ç∆òAìÆÅ®îÒòAìÆéûÇ…ReadData2ÇÃã‡äzÉZÉbÉgÇÃó¨ÇÍÇ…ì¸ÇÁÇ»Ç¢ÇÃÇ≈âΩÇ‡ÇµÇ»Ç¢
	//<----20230120
