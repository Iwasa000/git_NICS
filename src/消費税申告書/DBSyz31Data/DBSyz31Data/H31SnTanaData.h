...
class SYZSHIN31DATA_CLASS_EXPORT CH31SnTanaData
{
...
public:
	...
	unsigned char	Sn_menzk[3][MONY_BUF_SIZE],		// 調整課税仕入等に係る棚卸資産額
					...
					Sn_MNK624[MONY_BUF_SIZE],		// 調整課税仕入等に係る棚卸資産額(6.24%分)
					Sn_MNZ624[MONY_BUF_SIZE],		//				 〃			  消費税額(〃)
					Sn_MNK78[MONY_BUF_SIZE],		// 調整課税仕入等に係る棚卸資産額(7.8%分)
					Sn_MNZ78[MONY_BUF_SIZE],		//				 〃			  消費税額(〃)
					Sn_mnk624[3][MONY_BUF_SIZE],	// 調整課税仕入等に係る棚卸資産額(6.24%分)
					Sn_mnz624[3][MONY_BUF_SIZE],	//				 〃			  消費税額(〃)
					Sn_mnk78[3][MONY_BUF_SIZE],		// 調整課税仕入等に係る棚卸資産額(7.8%分)
					Sn_mnz78[3][MONY_BUF_SIZE],		//				 〃			  消費税額(〃)
...
public:
	CH31SnTanaData(BOOL isTransitionalMeasure );	// 標準コンストラクタ
	~CH31SnTanaData();
