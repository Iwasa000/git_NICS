...
class CShinSpecific53 : public CSpcBaseDlg
{
	DECLARE_DYNAMIC(CShinSpecific53)

public:
	CShinSpecific53(CWnd* pParent = NULL);   // 標準コンストラクタ
	CShinSpecific53(int zeitype, CWnd* pParent = NULL);   // 標準コンストラクタ
	virtual ~CShinSpecific53();

// ダイアログ データ
	enum { IDD = IDD_DIALOG_K53 };
