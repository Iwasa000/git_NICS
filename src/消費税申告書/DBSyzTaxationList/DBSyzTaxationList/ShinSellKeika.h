...
class CShinSellKeika : public CSyzBaseDlg
{
	DECLARE_DYNAMIC(CShinSellKeika)

public:
	CShinSellKeika(CWnd* pParent = NULL);   // 標準コンストラクタ
	virtual ~CShinSellKeika();

// ダイアログ データ
	enum { IDD = IDD_DIALOG_SELL_KEIKA };
