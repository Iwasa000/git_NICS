...
class CShinSpecific22keika : public CSpcBaseDlg
{
	DECLARE_DYNAMIC(CShinSpecific22keika)

public:
	CShinSpecific22keika(CWnd* pParent = NULL);   // 標準コンストラクタ
	CShinSpecific22keika(int zeitype, CWnd* pParent = NULL);   // 標準コンストラクタ
	virtual ~CShinSpecific22keika();

// ダイアログ データ
	enum { IDD = IDD_DIALOG_K22_KEIKA };
