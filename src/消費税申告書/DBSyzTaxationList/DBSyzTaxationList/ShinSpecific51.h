...
class CShinSpecific51 : public CSpcBaseDlg
{
	DECLARE_DYNAMIC(CShinSpecific51)

public:
	CShinSpecific51(CWnd* pParent = NULL);   // 標準コンストラクタ
	CShinSpecific51(int zeitype, CWnd* pParent = NULL);   // 標準コンストラクタ
	virtual ~CShinSpecific51();

// ダイアログ データ
	enum { IDD = IDD_DIALOG_K51 };
