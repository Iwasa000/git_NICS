...
#include "ShinKniinpKeika6syuIdx.h"

// CShinKniinpKeika6syu ダイアログ

IMPLEMENT_DYNAMIC(CShinKniinpKeika6syu, CSyzBaseDlg)

CShinKniinpKeika6syu::CShinKniinpKeika6syu(CWnd* pParent /*=NULL*/)
	: CSyzBaseDlg(CShinKniinpKeika6syu::IDD, pParent)
	, m_pParent(pParent)
	, m_Idx(0)
	, m_Lin(0)
	, m_Clm(0)
...
CShinKniinpKeika6syu::~CShinKniinpKeika6syu()
{
}

void CShinKniinpKeika6syu::DoDataExchange(CDataExchange* pDX)
{
...
BEGIN_MESSAGE_MAP(CShinKniinpKeika6syu, CSyzBaseDlg)
END_MESSAGE_MAP()


// CShinKniinpKeika6syu メッセージ ハンドラ

BOOL CShinKniinpKeika6syu::OnInitDialog()
{
	...
	m_BottomIdx = 36;//コントロールの一番下のIDX指定するとスクロー9ルがそこまでいく
...
// ダイアグラム初期属性セット
//-----------------------------------------------------------------------------
void CShinKniinpKeika6syu::InitDiagAttr()
{
	int	cnt = 0;
	int	Flg;
	while( 1 ){
...
BOOL CShinKniinpKeika6syu::PreTranslateMessage(MSG* pMsg)
{
...
// 引数	mode	：	
//-----------------------------------------------------------------------------
void CShinKniinpKeika6syu::DispList( int mode )
{
...
// ダイアグデータ表示
//-----------------------------------------------------------------------------
void CShinKniinpKeika6syu::DispKniinpKeikaDiagData( long dlin )
{
...
// 返送値	
//-----------------------------------------------------------------------------
int CShinKniinpKeika6syu::GetDiagData( long index, short leng, DIAGRAM_DATA *data, int mode )
{
...
BEGIN_EVENTSINK_MAP(CShinKniinpKeika6syu, CSyzBaseDlg)
ON_EVENT(CShinKniinpKeika6syu, IDC_ICSDIAG8CTRL1, 1, CShinKniinpKeika6syu::EditONIcsdiag8ctrl1, VTS_I2)
ON_EVENT(CShinKniinpKeika6syu, IDC_ICSDIAG8CTRL1, 2, CShinKniinpKeika6syu::EditOFFIcsdiag8ctrl1, VTS_I2)
ON_EVENT(CShinKniinpKeika6syu, IDC_ICSDIAG8CTRL1, 3, CShinKniinpKeika6syu::TerminationIcsdiag8ctrl1, VTS_I2 VTS_I2 VTS_I2 VTS_UNKNOWN)
END_EVENTSINK_MAP()

void CShinKniinpKeika6syu::EditONIcsdiag8ctrl1(short index)
{
...
void CShinKniinpKeika6syu::EditOFFIcsdiag8ctrl1(short index)
{
	// TODO: ここにメッセージ ハンドラ コードを追加します。
	DIAGRAM_DATA	data;
...
void CShinKniinpKeika6syu::TerminationIcsdiag8ctrl1(short index, short nChar, short length, LPUNKNOWN data)
{
	// TODO: ここにメッセージ ハンドラ コードを追加します。
	if( nChar == 0 ){
		return;
...
//　戻り値　：　次のフォーカスインデックス
//-----------------------------------------------------------------------------
//int CShinKniinpKeika6syu::UpDownFocusMoveCheck(int Index , int Move)
int CShinKniinpKeika6syu::FocusMoveCheck(int Index , int Move)
{
	int idx = 0;
	int i = 0 , j = 0;
	BOOL end_flg = FALSE;
...
void CShinKniinpKeika6syu::SetFocusRange()
{
...
// 初期ポジションセット'14.09.01
//-----------------------------------------------------------------------------
void CShinKniinpKeika6syu::SetItemPosition()
{
	int index;
...
int CShinKniinpKeika6syu::DispJudge( int clm, int line )
{
	int st = 0;
	int j = 0;
...
// 手入力サインのクリア
int CShinKniinpKeika6syu::ClearManualInputSign()
{
	int rt = 0;
