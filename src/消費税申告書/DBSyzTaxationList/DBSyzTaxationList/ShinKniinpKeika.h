...
class CShinKniinpKeika : public CSyzBaseDlg
{
	DECLARE_DYNAMIC(CShinKniinpKeika)

public:
	CShinKniinpKeika(CWnd* pParent = NULL);   // 標準コンストラクタ
	virtual ~CShinKniinpKeika();
...
// ダイアログ データ
	enum { IDD = IDD_DIALOG_JIGYO_SELL_KEIKA };
