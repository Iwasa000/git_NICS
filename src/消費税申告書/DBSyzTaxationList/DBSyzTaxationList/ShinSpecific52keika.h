...
class CShinSpecific52keika : public CSpcBaseDlg
{
	DECLARE_DYNAMIC(CShinSpecific52keika)

public:
	CShinSpecific52keika(CWnd* pParent = NULL);   // 標準コンストラクタ
	CShinSpecific52keika(int zeitype, CWnd* pParent = NULL);   // 標準コンストラクタ
	virtual ~CShinSpecific52keika();

// ダイアログ データ
	enum { IDD = IDD_DIALOG_K52_KEIKA };
