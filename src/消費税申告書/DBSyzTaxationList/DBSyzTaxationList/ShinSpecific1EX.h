...
class CShinSpecific1EX : public CSpcBaseDlg
{
	DECLARE_DYNAMIC(CShinSpecific1EX)

public:
	CShinSpecific1EX(CWnd* pParent = NULL);   // 標準コンストラクタ
	virtual ~CShinSpecific1EX();

// ダイアログ データ
	enum { IDD = IDD_DIALOG_K1_EX };
