...
class CShinNougyou : public CSyzBaseDlg
{
	DECLARE_DYNAMIC(CShinNougyou)

public:
	CShinNougyou(CWnd* pParent = NULL);   // 標準コンストラクタ
	virtual ~CShinNougyou();

// ダイアログ データ
	enum { IDD = IDD_DIALOG_NOUGYOU };
	...
	// ダイアグデータ表示
	void DispNougyouDiagData( long dlin );
	// カーソル移動
