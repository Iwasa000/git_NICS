...
////			-1	ÅF	ÉGÉâÅ[
////-----------------------------------------------------------------------------
////int CSpecPassOffEx::InitDisp()
//int CSpecPassOffEx::Disp_goukei()
//{
...
int CSpecPassOffEx::Disp_8per()
{
	...
	if( m_pArith->l_cmp( (*m_pSpcListData)->stval.SpTswr, WORK0 ) > 0 ){	// ì¡ó·é˚ì¸äÑçáÇTÅìà»è„	
		...
		if( m_pArith->l_cmp( (*m_pSpcListData)->stval.SpUwri, WORK0 ) >= 0 ) {	// â€ê≈îÑè„äÑçáÇXÇTÅìà»è„
			memset( WORK0, '\0', sizeof(WORK0) );
//-- '15.05.05 --
//			m_pArith->l_add( WORK0, (*m_pSpcListData)->stval.SpTsyu63, (*m_pSpcListData)->stval.SpKsyu63 );
//			m_pArith->l_add( WORK0, WORK0, (*m_pSpcListData)->stval.SpHsyu63 );
//---------------
...
int CSpecPassOffEx::Disp_5per()
{
	...
	if( m_pArith->l_cmp( (*m_pSpcListData)->stval.SpTswr, WORK0 ) > 0 ){	// ì¡ó·é˚ì¸äÑçáÇTÅìà»è„	
		...
		if( m_pArith->l_cmp( (*m_pSpcListData)->stval.SpUwri, WORK0 ) >= 0 ) {	// â€ê≈îÑè„äÑçáÇXÇTÅìà»è„
			memset( WORK0, '\0', sizeof(WORK0) );
//-- '15.05.05 --
//			m_pArith->l_add( WORK0, (*m_pSpcListData)->stval.SpTsyu4, (*m_pSpcListData)->stval.SpKsyu4 );
//			m_pArith->l_add( WORK0, WORK0, (*m_pSpcListData)->stval.SpHsyu4 );
//---------------
...
//			-1			ÅF	ÉGÉâÅ[
//-----------------------------------------------------------------------------
int CSpecPassOffEx::Init( CSnHeadData **pSnHeadData, CH26SpcListData **pSpcListData, CArithEx *pArith )
{
	ASSERT( pSnHeadData );
	if( pSnHeadData == NULL ){
		return -1;
