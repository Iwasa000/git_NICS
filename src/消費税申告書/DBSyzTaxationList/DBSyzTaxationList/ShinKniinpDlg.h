...
class CShinKniinpDlg : public CSyzBaseDlg
{
	DECLARE_DYNAMIC(CShinKniinpDlg)

public:
	CShinKniinpDlg(CWnd* pParent = NULL);   // 標準コンストラクタ
	virtual ~CShinKniinpDlg();

// ダイアログ データ
	enum { IDD = IDD_DIALOG_JIGYO_SELL };
