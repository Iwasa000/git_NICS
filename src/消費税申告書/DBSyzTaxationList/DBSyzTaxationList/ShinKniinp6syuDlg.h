...
class CShinKniinp6syuDlg : public CSyzBaseDlg
{
	DECLARE_DYNAMIC(CShinKniinp6syuDlg)

public:
	CShinKniinp6syuDlg(CWnd* pParent = NULL);   // 標準コンストラクタ
	virtual ~CShinKniinp6syuDlg();

// ダイアログ データ
	enum { IDD = IDD_DIALOG_JIGYO_SELL_6SYU };
	...
	// ダイアグデータ表示
	void DispKniinpDiagData( long dlin );
