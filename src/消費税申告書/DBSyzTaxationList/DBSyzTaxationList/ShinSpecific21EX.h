...
class CShinSpecific21EX : public CSpcBaseDlg
{
	DECLARE_DYNAMIC(CShinSpecific21EX)

public:
	CShinSpecific21EX(CWnd* pParent = NULL);   // 標準コンストラクタ
	virtual ~CShinSpecific21EX();

// ダイアログ データ
	enum { IDD = IDD_DIALOG_K21_EX };
...
public:
	...
	// セットポジション
//	void SetItemPosition( int IndexNo );//yoshida150311
	// 初期設定
	void SpecificInit21();
	// 表示
	void SpecificDisp21();
