...
class CShinFudousanKeika : public CSyzBaseDlg
{
	DECLARE_DYNAMIC(CShinFudousanKeika)

public:
	CShinFudousanKeika(CWnd* pParent = NULL);   // 標準コンストラクタ
	virtual ~CShinFudousanKeika();

// ダイアログ データ
	enum { IDD = IDD_DIALOG_FUDOUSAN_KEIKA };
	...
	// ダイアグデータ表示
	void DispFudousanKeikaDiagData( long dlin );
	// カーソル移動
