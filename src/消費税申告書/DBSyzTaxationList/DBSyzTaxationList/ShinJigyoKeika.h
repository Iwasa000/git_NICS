...
class CShinJigyoKeika : public CSyzBaseDlg
{
	DECLARE_DYNAMIC(CShinJigyoKeika)

public:
	CShinJigyoKeika(CWnd* pParent = NULL);   // 標準コンストラクタ
	virtual ~CShinJigyoKeika();

// ダイアログ データ
	enum { IDD = IDD_DIALOG_JIGYO_KEIKA };
	...
	// ダイアグデータ表示
	void DispJigyoKeikaDiagData( long dlin );
	// カーソル移動
