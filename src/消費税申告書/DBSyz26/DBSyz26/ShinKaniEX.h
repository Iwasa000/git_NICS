...
class CShinKaniEX : public CSyzBaseDlg
{
	DECLARE_DYNAMIC(CShinKaniEX)

public:
	CShinKaniEX(CWnd* pParent = NULL);   // 標準コンストラクタ
	virtual ~CShinKaniEX();
...
// ダイアログ データ
	...
	// 初期情報のセット
	int InitInfo( CH27SnHonpyoData **pSnHonpyoData, CH27SnFhyo10Data **pSnFhyo40Data, CSnHeadData **pSnHeadData, CArithEx *pArith, SYC_SHININFO *pShinInfo );//[Y]
...
private:
	...
	//== 帳票データ本体 ==
	CH27SnHonpyoData	**m_pSnHonpyoData;
