...
// ˆø”	sw	F	•\Ž¦Ø‘ÖƒXƒCƒbƒ`
//-----------------------------------------------------------------------------
void CShinKani::calqx_89( int sw )
{
...
//-----------------------------------------------------------------------------
void CShinKani::calqx_1112( int sw )
{
...
// ˆø”	sw	F	•\Ž¦Ø‘ÖƒXƒCƒbƒ`
//-----------------------------------------------------------------------------
void CShinKani::calqx_17( int sw )
{
...
// ˆø”	sw	F	•\Ž¦Ø‘ÖƒXƒCƒbƒ`
//-----------------------------------------------------------------------------
void CShinKani::calqx_18( int sw )
{
...
// ˆø”	sw	F	•\Ž¦Ø‘ÖƒXƒCƒbƒ`
//-----------------------------------------------------------------------------
void CShinKani::calqx_1920( int sw )
{
...
// ˆø”	sw	F	•\Ž¦Ø‘ÖƒXƒCƒbƒ`
//-----------------------------------------------------------------------------
void CShinKani::calqx_2223( int sw )
{
...
// ˆø”	sw	F	•\Ž¦Ø‘ÖƒXƒCƒbƒ`
//-----------------------------------------------------------------------------
void CShinKani::calqx_26( int sw )
{
...
//		sw		F	
//-----------------------------------------------------------------------------
void CShinKani::calqx_all( int atno, int sw )
{
	while( 1 ){
		switch( atno ){
			case	1 :
...
// •Ê•\‚ÌŒvŽZ
//-----------------------------------------------------------------------------
void CShinKani::calqx_otherlists()
{
	if( m_pParent ){
