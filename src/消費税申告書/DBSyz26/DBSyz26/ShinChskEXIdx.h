...
#define	CHTEISYUTU		60		// 提出年月日
#define	CHUCHUKJI_G		78		// ○年○月○日　課税期間分の中間申告書（自）元号
#define	CHUCHUKITA_G	79		// ○年○月○日　課税期間分の中間申告書（至）元号
#define	CHUZKJI_G		63		// 前課税期間　自元号
#define	CHUZKITA_G		64		// 前課税期間　至元号
#define	CHUSNMD_G		72		// 修正・更正・決定の年月日元号
#define	CHUTAIJI_G		73		// 中間申告対象期間 自元号
#define	CHUTAIITA_G		74		// 中間申告対象期間 至元号
