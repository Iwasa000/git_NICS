...
//-----------------------------------------------------------------------------
void CShinIppan::calq_by_OtherChange( int ksw )
{
	m_DpSw = -1;
	m_kanisw = ksw;
	ReadData();
...
//		sw		F	ŒvŽZƒXƒCƒbƒ`
//-----------------------------------------------------------------------------
void CShinIppan::calqx_all( int atno, int sw )
{
	while( 1 ){
		switch( atno ){
			case	1 :
...
// ˆø”	sw	F	ŒvŽZƒXƒCƒbƒ`
//-----------------------------------------------------------------------------
void CShinIppan::calqx_7( int sw )
{
...
// ˆø”	sw	F	ŒvŽZƒXƒCƒbƒ`
//-----------------------------------------------------------------------------
void CShinIppan::calqx_89( int sw )
{
...
// ˆø”	sw	F	ŒvŽZƒXƒCƒbƒ`
//-----------------------------------------------------------------------------
void CShinIppan::calqx_1112( int sw )
{
...
//			FALSE	F	ŒvŽZ‚¹‚¸
//-----------------------------------------------------------------------------
int CShinIppan::calqx_14( int sw )
{
...
// ˆø”	sw	F	ŒvŽZƒXƒCƒbƒ`
//-----------------------------------------------------------------------------
void CShinIppan::calqx_17( int sw )
{
...
// ˆø”	sw	F	ŒvŽZƒXƒCƒbƒ`
//-----------------------------------------------------------------------------
void CShinIppan::calqx_18( int sw )
{
...
// ˆø”	sw	F	ŒvŽZƒXƒCƒbƒ`
//-----------------------------------------------------------------------------
void CShinIppan::calqx_1920( int sw )
{
	char	WORK0[MONY_BUF_SIZE] = {0};
...
// ˆø”	sw	F	ŒvŽZƒXƒCƒbƒ`
//-----------------------------------------------------------------------------
void CShinIppan::calqx_2223( int sw )
{
...
// •Ô‘—’l	
//-----------------------------------------------------------------------------
int CShinIppan::calqx_25( int sw )
{
	// ’†ŠÔŠŽ‰ü³“ú‘OŠJŽn‚Í’n•ûÁ”ïÅ“ü—Í–³‚µ
//	if( ! (((*m_pSnHeadData)->Sn_SKKBN&0xff) % 2) && pSyzShin->N_ver != 2 ){
	if( 0 ){
...
//-----------------------------------------------------------------------------
void CShinIppan::calqx_26( int sw )
{
