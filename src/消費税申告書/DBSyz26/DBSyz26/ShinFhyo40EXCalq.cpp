...
// 引数	sw	：	
//-----------------------------------------------------------------------------
void CShinFhyo40EX::f4calq_3( int sw )
{
...
// 引数	sw	：	
//-----------------------------------------------------------------------------
void CShinFhyo40EX::f4calq_4( int sw )
{
...
// 引数	sw	：
//-----------------------------------------------------------------------------
void CShinFhyo40EX::f4calq_5( int sw )
{
	char	WORK0[MONY_BUF_SIZE]={0};
...
// 引数	sw	：
//-----------------------------------------------------------------------------
void CShinFhyo40EX::f4calq_6( int sw )
{
...
// 引数	sw	：
//-----------------------------------------------------------------------------
void CShinFhyo40EX::f4calq_78( int sw )
{
...
// 引数	sw	：
//-----------------------------------------------------------------------------
void CShinFhyo40EX::f4calq_9( int sw )
{
...
// 引数	sw	：	
//-----------------------------------------------------------------------------
void CShinFhyo40EX::f4calq_10( int sw )
{
	char	WORK0[MONY_BUF_SIZE]={0};
...
// 引数	sw	：	
//-----------------------------------------------------------------------------
void CShinFhyo40EX::f4calq_11( int sw )
{
	char	WORK0[MONY_BUF_SIZE]={0};
	// 3%
...
// 引数	sw	：	
//-----------------------------------------------------------------------------
void CShinFhyo40EX::f4calq_1213( int sw )
{
	if( !sw ){
...
// 引数	sw	：	
//-----------------------------------------------------------------------------
void CShinFhyo40EX::f4calq_14( int sw )
{
...
// 引数	sw	：	
//-----------------------------------------------------------------------------
void CShinFhyo40EX::f4calq_15( int sw )
{
	char	WORK0[MONY_BUF_SIZE]={0};
...
//		sw		：	
//-----------------------------------------------------------------------------
void CShinFhyo40EX::f4calq_all( int atno, int sw )
{
	while(1){
		switch( atno ){
			case	1 :
...
// 他表からの計算
//-----------------------------------------------------------------------------
void CShinFhyo40EX::calq_by_OtherChange()
{
	ReadData( 0 );
	f4calq_all( 1, 1 );
	WriteData();
}
void CShinFhyo40EX::calqx_otherlists(){
