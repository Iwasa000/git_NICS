...
IMPLEMENT_DYNAMIC(CShinFhyo52, CSyzBaseDlg)

CShinFhyo52::CShinFhyo52(CWnd* pParent /*=NULL*/)
	: CSyzBaseDlg(CShinFhyo52::IDD, pParent)
	...
	, m_SvSzsw(-1)
{
	...
	F520c = F521c = F522c = F523c = F524c = F525c = 0;
	F5212c = F5213c = F5214c = F5215c = F5216c = F5217c = 0;
	F5218c = F5219c = 0;
	F5220c = F5221c = F5222c = F5223c = F5224c = F5225c = F5226c = F5227c = F5228c = F5229c = 0;
...
CShinFhyo52::~CShinFhyo52()
{
}

void CShinFhyo52::DoDataExchange(CDataExchange* pDX)
{
...
BEGIN_MESSAGE_MAP(CShinFhyo52, CSyzBaseDlg)
END_MESSAGE_MAP()


// CShinFhyo52 メッセージ ハンドラ

BOOL CShinFhyo52::PreTranslateMessage(MSG* pMsg)
{
...
// 金額フィールドの連結	('14.06.10)
//-----------------------------------------------------------------------------
void CShinFhyo52::ConnectMonyField()
{
	memset( &m_Fh5Mony, '\0', sizeof(SH_FH5_MONY) );

	m_Fh5Mony.pF5212[0] = F5212T;
	m_Fh5Mony.pF5212[1] = F5212A;
	m_Fh5Mony.pF5212[2] = F5212B;
	m_Fh5Mony.pF5212[3] = F5212C;
...
//			-1			：	エラー
//-----------------------------------------------------------------------------
int CShinFhyo52::InitInfo( CH26SnFhyo50Data **pSnFhyo52Data, CH26SnFhyo10Data **pSnFhyo40Data, CH26SnHonpyoData **pSnHonpyoData, CSnHeadData **pSnHeadData, CArithEx *pArith, SYC_SHININFO *pShinInfo, CDBNpSub *pZmSub, CSyzSyukei *pSubSyzSyukei )
{
...
// 返送値	0	：	正常終了
//-----------------------------------------------------------------------------
int CShinFhyo52::ReadData( int upck )
{
	// 課税標準額に対する消費税額
...
//	memmove( F526B,  pSyzShin->Snd.Sn_5FURIT, MONY_BUF_SIZE );
	memmove( F5212T, (*m_pSnFhyo52Data)->Sn_5FUZTT, MONY_BUF_SIZE );
	memmove( F5212A, (*m_pSnFhyo52Data)->Sn_5FUZKTA, MONY_BUF_SIZE );
	memmove( F5212B, (*m_pSnFhyo52Data)->Sn_5FUZKTB, MONY_BUF_SIZE );
	memmove( F5212C, (*m_pSnFhyo52Data)->Sn_5FUZKTC, MONY_BUF_SIZE );
	...
	memmove( F5213T, (*m_pSnFhyo52Data)->Sn_5FUZT1, MONY_BUF_SIZE );
	memmove( F5213A, (*m_pSnFhyo52Data)->Sn_5FUZK1A, MONY_BUF_SIZE );
	memmove( F5213B, (*m_pSnFhyo52Data)->Sn_5FUZK1B, MONY_BUF_SIZE );
	memmove( F5213C, (*m_pSnFhyo52Data)->Sn_5FUZK1C, MONY_BUF_SIZE );

	F5213c = (*m_pSnFhyo52Data)->Sn_5FUZK1sw;//[Y]
//--> '14.05.17 INS START
...
//<-- '14.05.17 INS END
	...
	memmove( F5214T, (*m_pSnFhyo52Data)->Sn_5FUZT2, MONY_BUF_SIZE );
	memmove( F5214A, (*m_pSnFhyo52Data)->Sn_5FUZK2A, MONY_BUF_SIZE );
	memmove( F5214B, (*m_pSnFhyo52Data)->Sn_5FUZK2B, MONY_BUF_SIZE );
	memmove( F5214C, (*m_pSnFhyo52Data)->Sn_5FUZK2C, MONY_BUF_SIZE );

	F5214c = (*m_pSnFhyo52Data)->Sn_5FUZK2sw;//[Y]
//--> '14.05.17 INS START
...
//<-- '14.05.17 INS END
	...
	memmove( F5215T, (*m_pSnFhyo52Data)->Sn_5FUZT3, MONY_BUF_SIZE );
	memmove( F5215A, (*m_pSnFhyo52Data)->Sn_5FUZK3A, MONY_BUF_SIZE );
	memmove( F5215B, (*m_pSnFhyo52Data)->Sn_5FUZK3B, MONY_BUF_SIZE );
	memmove( F5215C, (*m_pSnFhyo52Data)->Sn_5FUZK3C, MONY_BUF_SIZE );

	F5215c = (*m_pSnFhyo52Data)->Sn_5FUZK3sw;//[Y]
//--> '14.05.17 INS START
...
//<-- '14.05.17 INS END
	...
	memmove( F5216T, (*m_pSnFhyo52Data)->Sn_5FUZT4, MONY_BUF_SIZE );
	memmove( F5216A, (*m_pSnFhyo52Data)->Sn_5FUZK4A, MONY_BUF_SIZE );
	memmove( F5216B, (*m_pSnFhyo52Data)->Sn_5FUZK4B, MONY_BUF_SIZE );
	memmove( F5216C, (*m_pSnFhyo52Data)->Sn_5FUZK4C, MONY_BUF_SIZE );

	F5216c = (*m_pSnFhyo52Data)->Sn_5FUZK4sw;//[Y]
//--> '14.05.17 INS START
...
//<-- '14.05.17 INS END
	...
	memmove( F5217T, (*m_pSnFhyo52Data)->Sn_5FUZT5, MONY_BUF_SIZE );
	memmove( F5217A, (*m_pSnFhyo52Data)->Sn_5FUZK5A, MONY_BUF_SIZE );
	memmove( F5217B, (*m_pSnFhyo52Data)->Sn_5FUZK5B, MONY_BUF_SIZE );
	memmove( F5217C, (*m_pSnFhyo52Data)->Sn_5FUZK5C, MONY_BUF_SIZE );

	F5217c = (*m_pSnFhyo52Data)->Sn_5FUZK5sw;//[Y]
//--> '14.05.17 INS START
...
//<-- '14.05.17 INS END
	...
	F5219c = (*m_pSnFhyo52Data)->Sn_5FSZT19sw;
...
/*-------------*/
	...
	// 20
	memmove( F5220A, (*m_pSnFhyo52Data)->Sn_5FSZT20A, MONY_BUF_SIZE );
	memmove( F5220B, (*m_pSnFhyo52Data)->Sn_5FSZT20B, MONY_BUF_SIZE );
	memmove( F5220C, (*m_pSnFhyo52Data)->Sn_5FSZT20C, MONY_BUF_SIZE );
	memmove( F5220T, (*m_pSnFhyo52Data)->Sn_5FSZT20T, MONY_BUF_SIZE );
	F5220c = (*m_pSnFhyo52Data)->Sn_5FSZT20sw;
	// 21
	memmove( F5221A, (*m_pSnFhyo52Data)->Sn_5FSZT21A, MONY_BUF_SIZE );
	memmove( F5221B, (*m_pSnFhyo52Data)->Sn_5FSZT21B, MONY_BUF_SIZE );
	memmove( F5221C, (*m_pSnFhyo52Data)->Sn_5FSZT21C, MONY_BUF_SIZE );
	memmove( F5221T, (*m_pSnFhyo52Data)->Sn_5FSZT21T, MONY_BUF_SIZE );
	...
	F5218c = (*m_pSnFhyo52Data)->Sn_5FGKsw;
...
/*- '14.03.12_CUT -*/
	...
	memmove( (*m_pSnFhyo52Data)->Sn_5FUZT1, F5213T, MONY_BUF_SIZE );
	memmove( (*m_pSnFhyo52Data)->Sn_5FUZK1A, F5213A, MONY_BUF_SIZE );
	memmove( (*m_pSnFhyo52Data)->Sn_5FUZK1B, F5213B, MONY_BUF_SIZE );
	memmove( (*m_pSnFhyo52Data)->Sn_5FUZK1C, F5213C, MONY_BUF_SIZE );

	(*m_pSnFhyo52Data)->Sn_5FUZK1sw = F5213c;//[Y]
	...
	memmove( (*m_pSnFhyo52Data)->Sn_5FUZT2, F5214T, MONY_BUF_SIZE );
	memmove( (*m_pSnFhyo52Data)->Sn_5FUZK2A, F5214A, MONY_BUF_SIZE );
	memmove( (*m_pSnFhyo52Data)->Sn_5FUZK2B, F5214B, MONY_BUF_SIZE );
	memmove( (*m_pSnFhyo52Data)->Sn_5FUZK2C, F5214C, MONY_BUF_SIZE );

	(*m_pSnFhyo52Data)->Sn_5FUZK2sw = F5214c;//[Y]
	...
	memmove( (*m_pSnFhyo52Data)->Sn_5FUZT3, F5215T, MONY_BUF_SIZE );
	memmove( (*m_pSnFhyo52Data)->Sn_5FUZK3A, F5215A, MONY_BUF_SIZE );
	memmove( (*m_pSnFhyo52Data)->Sn_5FUZK3B, F5215B, MONY_BUF_SIZE );
	memmove( (*m_pSnFhyo52Data)->Sn_5FUZK3C, F5215C, MONY_BUF_SIZE );

	(*m_pSnFhyo52Data)->Sn_5FUZK3sw = F5215c;//[Y]
	...
	memmove( (*m_pSnFhyo52Data)->Sn_5FUZT4, F5216T, MONY_BUF_SIZE );
	memmove( (*m_pSnFhyo52Data)->Sn_5FUZK4A, F5216A, MONY_BUF_SIZE );
	memmove( (*m_pSnFhyo52Data)->Sn_5FUZK4B, F5216B, MONY_BUF_SIZE );
	memmove( (*m_pSnFhyo52Data)->Sn_5FUZK4C, F5216C, MONY_BUF_SIZE );

	(*m_pSnFhyo52Data)->Sn_5FUZK4sw = F5216c;//[Y]
...
//清水追加
	...
	memmove( (*m_pSnFhyo52Data)->Sn_5FUZKTA, F5212A, MONY_BUF_SIZE );
	memmove( (*m_pSnFhyo52Data)->Sn_5FUZKTB, F5212B, MONY_BUF_SIZE );
	memmove( (*m_pSnFhyo52Data)->Sn_5FUZKTC, F5212C, MONY_BUF_SIZE );
	memmove( (*m_pSnFhyo52Data)->Sn_5FUZTT, F5212T, MONY_BUF_SIZE );

	(*m_pSnFhyo52Data)->Sn_5FUZK5sw = F5217c;//[Y]

//
	memmove( (*m_pSnFhyo52Data)->Sn_5FUZT5, F5217T, MONY_BUF_SIZE );
	memmove( (*m_pSnFhyo52Data)->Sn_5FUZK5A, F5217A, MONY_BUF_SIZE );
	memmove( (*m_pSnFhyo52Data)->Sn_5FUZK5B, F5217B, MONY_BUF_SIZE );
	memmove( (*m_pSnFhyo52Data)->Sn_5FUZK5C, F5217C, MONY_BUF_SIZE );

	// 原則計算を適用する場合の控除対象仕入税額
	memmove( (*m_pSnFhyo52Data)->Sn_5FSZTG, F5218T, MONY_BUF_SIZE );
	...
	(*m_pSnFhyo52Data)->Sn_5FSZT19sw = F5219c;
...
//		m_pArith->l_sub( (*m_pSnFhyo40Data)->Sn_1F8A, F525T, F525B );
		...
		memmove( (*m_pSnFhyo40Data)->Sn_1F4A, F5230A, MONY_BUF_SIZE );
		memmove( (*m_pSnFhyo40Data)->Sn_1F4B, F5230B, MONY_BUF_SIZE );
		memmove( (*m_pSnFhyo40Data)->Sn_1F4C, F5230C, MONY_BUF_SIZE );
//--> '14.10.17 INS START
		memmove( (*m_pSnFhyo40Data)->Sn_1F4T, F5230T, MONY_BUF_SIZE );
//<-- '14.10.17 INS END
	}
// これはカット
/*	else{
...
//		if( !pSyzShin->Snh.Sn_TOKUR ){
	...
	// 20
	memmove( (*m_pSnFhyo52Data)->Sn_5FSZT20A, F5220A, MONY_BUF_SIZE );
	memmove( (*m_pSnFhyo52Data)->Sn_5FSZT20B, F5220B, MONY_BUF_SIZE );
	memmove( (*m_pSnFhyo52Data)->Sn_5FSZT20C, F5220C, MONY_BUF_SIZE );
	memmove( (*m_pSnFhyo52Data)->Sn_5FSZT20T, F5220T, MONY_BUF_SIZE );
	(*m_pSnFhyo52Data)->Sn_5FSZT20sw = F5220c;
	// 21
	memmove( (*m_pSnFhyo52Data)->Sn_5FSZT21A, F5221A, MONY_BUF_SIZE );
	memmove( (*m_pSnFhyo52Data)->Sn_5FSZT21B, F5221B, MONY_BUF_SIZE );
	memmove( (*m_pSnFhyo52Data)->Sn_5FSZT21C, F5221C, MONY_BUF_SIZE );
	memmove( (*m_pSnFhyo52Data)->Sn_5FSZT21T, F5221T, MONY_BUF_SIZE );
	...
	(*m_pSnFhyo52Data)->Sn_5FGKsw = F5218c;
...
// 入力項目　色変え
//-----------------------------------------------------------------------------
void CShinFhyo52::ChangeColor( unsigned short id, short index, int sign )
{
	DIAGRAM_ATTRIBUTE	DA;
...
//		Mony	：	
//-----------------------------------------------------------------------------
void CShinFhyo52::dsp_prs( unsigned short Id, short Index, char *Mony )
{
	DIAGRAM_DATA		DiagData;
	DiagData.data_imgdata = NULL;
...
//		Index	：	
//-----------------------------------------------------------------------------
void CShinFhyo52::dsp_cls( unsigned short Id, short Index )
{
	DIAGRAM_DATA		DiagData;
	DiagData.data_imgdata = NULL;
...
//		sign	：	
//-----------------------------------------------------------------------------
void CShinFhyo52::dsp_uws( unsigned short Id, short Index, unsigned short pers, short sign )
{
...
//-----------------------------------------------------------------------------
void CShinFhyo52::GetLinkedData( SH_52_LINKED_INFO *pLinkedInfo )
{
	ASSERT( pLinkedInfo );
	...
	*(pLinkedInfo->pF5218T) = F5218T;
	*(pLinkedInfo->pF5218A) = F5218A;
	*(pLinkedInfo->pF5218B) = F5218B;
	*(pLinkedInfo->pF5218C) = F5218C;
	*(pLinkedInfo->pF5218c) = &F5218c;
	*(pLinkedInfo->pF5219T) = F5219T;
	*(pLinkedInfo->pF5219A) = F5219A;
	*(pLinkedInfo->pF5219B) = F5219B;
	*(pLinkedInfo->pF5219C) = F5219C;
	*(pLinkedInfo->pF5219c) = &F5219c;
...
BEGIN_EVENTSINK_MAP(CShinFhyo52, CSyzBaseDlg)
	ON_EVENT(CShinFhyo52, IDC_ICSDIAGCTRL2, 1, CShinFhyo52::EditONIcsdiagctrl2, VTS_I2)
	ON_EVENT(CShinFhyo52, IDC_ICSDIAGCTRL2, 2, CShinFhyo52::EditOFFIcsdiagctrl2, VTS_I2)
	ON_EVENT(CShinFhyo52, IDC_ICSDIAGCTRL2, 3, CShinFhyo52::TerminationIcsdiagctrl2, VTS_I2 VTS_I2 VTS_I2 VTS_UNKNOWN)
END_EVENTSINK_MAP()

void CShinFhyo52::EditONIcsdiagctrl2(short index)
{
...
//			-1	：	該当なし
//-----------------------------------------------------------------------------
int CShinFhyo52::GetBaseMonyByDiagIdx( short Idx, char **pRtMony )
{
	if( (Idx==ID5213A) || (Idx==ID5214A) || (Idx==ID5215A) || (Idx==ID5216A) || (Idx==ID5217A) ){
		*pRtMony = F526A;
	}
	else if( (Idx==ID5213B) || (Idx==ID5214B) || (Idx==ID5215B) || (Idx==ID5216B) || (Idx==ID5217B) ){
		*pRtMony = F526B;
	}
	else if( (Idx==ID5213C) || (Idx==ID5214C) || (Idx==ID5215C) || (Idx==ID5216C) || (Idx==ID5217C) ){
		*pRtMony = F526C;
	}
	else{
		return -1;
...
//			-1	：	該当なし
//-----------------------------------------------------------------------------
int CShinFhyo52::GetRelInfoByDiagIdx( short Idx, char **pRtMony )
{
	if( Idx == ID526A ){
		*pRtMony = F526A;
	}
...
void CShinFhyo52::EditOFFIcsdiagctrl2(short index)
{
	// TODO: ここにメッセージ ハンドラ コードを追加します。
	DIAGRAM_DATA		DiagData;
	DiagData.data_imgdata = NULL;
...
/*		case ID5212T :	// 12. 事業別課税売上に係る消費税額合計（期間計）
			...
			// 各入力の計算表示
				...
				break;
*/
		case ID5212A :	// 12. 事業別課税売上に係る消費税額合計（3%分）
		case ID5212B :	// 12. 事業別課税売上に係る消費税額合計（4%分）
		case ID5212C :	// 12. 事業別課税売上に係る消費税額合計（6.3%分）
			if( GetRelInfoByDiagIdx(index, &ptmpMony) ){
				break;
			}
			memmove( CkMy, ptmpMony, MONY_BUF_SIZE );
...
/*		case ID5213T :	// 13. 事業別課税売上に係る消費税額･第一種（期間計）
			...
			// 各入力の計算表示
				...
				break;
*/
		case ID5213A :	// 13. 事業別課税売上に係る消費税額･第一種（3%分）
		case ID5213B :	// 13. 事業別課税売上に係る消費税額･第一種（4%分）
		case ID5213C :	// 13. 事業別課税売上に係る消費税額･第一種（6.3%分）
			if( GetRelInfoByDiagIdx(index, &ptmpMony) ){
				break;
			}
			memmove( CkMy, ptmpMony, MONY_BUF_SIZE );
			...
			if( m_pArith->l_cmp(CkMy, ptmpMony) ){
				...
				if( GetBaseMonyByDiagIdx(index, &pBsMony) == 0 ){
					if( m_pArith->l_test(pBsMony) ){
						...
						else if( index == ID5213B ){
							F5213c |= 0x80;
						}
						else if( index == ID5213C ){
							F5213c |= 0x800;
						}
					}
				}
...
/*		case ID5214T :	// 14. 事業別課税売上に係る消費税額･第二種（期間計）
			...
			// 各入力の計算表示
				...
				break;
*/
		case ID5214A :	// 14. 事業別課税売上に係る消費税額･第二種（3%分）
		case ID5214B :	// 14. 事業別課税売上に係る消費税額･第二種（4%分）
		case ID5214C :	// 14. 事業別課税売上に係る消費税額･第二種（6.3%分）
			if( GetRelInfoByDiagIdx(index, &ptmpMony) ){
				break;
			}
			memmove( CkMy, ptmpMony, MONY_BUF_SIZE );
...
/*		case ID5215T :	// 15. 事業別課税売上に係る消費税額･第三種（期間計）
			...
			// 各入力の計算表示
				...
				break;
*/
		case ID5215A :	// 15. 事業別課税売上に係る消費税額･第三種（3%分）
		case ID5215B :	// 15. 事業別課税売上に係る消費税額･第三種（4%分）
		case ID5215C :	// 15. 事業別課税売上に係る消費税額･第三種（6.3%分）
			if( GetRelInfoByDiagIdx(index, &ptmpMony) ){
				break;
			}
			memmove( CkMy, ptmpMony, MONY_BUF_SIZE );
...
/*		case ID5216T :	// 16. 事業別課税売上に係る消費税額･第四種（期間計）
			...
			// 各入力の計算表示
				...
				break;
*/
		case ID5216A :	// 16. 事業別課税売上に係る消費税額･第四種（3%分）
		case ID5216B :	// 16. 事業別課税売上に係る消費税額･第四種（4%分）
		case ID5216C :	// 16. 事業別課税売上に係る消費税額･第四種（6.3%分）
			if( GetRelInfoByDiagIdx(index, &ptmpMony) ){
				break;
			}
			memmove( CkMy, ptmpMony, MONY_BUF_SIZE );
...
/*		case ID5217T :	// 17. 事業別課税売上に係る消費税額･第五種（期間計）
			...
			// 各入力の計算表示
				...
				break;
*/
		case ID5217A :	// 17. 事業別課税売上に係る消費税額･第五種（3%分）
		case ID5217B :	// 17. 事業別課税売上に係る消費税額･第五種（4%分）
		case ID5217C :	// 17. 事業別課税売上に係る消費税額･第五種（6.3%分）
			if( GetRelInfoByDiagIdx(index, &ptmpMony) ){
				break;
			}
			memmove( CkMy, ptmpMony, MONY_BUF_SIZE );
...
void CShinFhyo52::TerminationIcsdiagctrl2(short index, short nChar, short length, LPUNKNOWN data)
{
	// TODO: ここにメッセージ ハンドラ コードを追加します。
	if( nChar == 0 ){
		return;
	...
	if( wTerm == VK_DELETE ){
		...
		switch( index ){
			...
			case ID5213A :	// 13. 事業別課税売上に係る消費税額･第一種（3%分）
				...
				// 各入力の計算表示
				f52calq_all( 1 );
				m_Fhyo52Diag02.SetPosition( ID5213A );
				break;
			...
			case ID5213B :	// 13. 事業別課税売上に係る消費税額･第一種（4%分）
				...
				// 各入力の計算表示
				f52calq_all( 1 );
				m_Fhyo52Diag02.SetPosition( ID5213B );
				break;
			...
			case ID5213C :	// 13. 事業別課税売上に係る消費税額･第一種（6.3%分）
				...
				// 各入力の計算表示
				f52calq_all( 1 );
				m_Fhyo52Diag02.SetPosition( ID5213C );
				break;
...
//　戻り値　：　次のフォーカスインデックス
//-----------------------------------------------------------------------------
int CShinFhyo52::UpDownFocusMoveCheck(int Index , int Move)
{
	int idx = 0;
	int i = 0 , j = 0;
...
// 初期ポジションセット
//-----------------------------------------------------------------------------
void CShinFhyo52::SetItemPosition()
{
	int index;
...
// 返送値	0	：	正常終了
//-----------------------------------------------------------------------------
int CShinFhyo52::ReWriteOnlySkjData()
{
	// １種類の事業の専業者の場合
	memset( (*m_pSnFhyo40Data)->Sn_1F4A, '\0', MONY_BUF_SIZE );
	memset( (*m_pSnFhyo40Data)->Sn_1F4B, '\0', MONY_BUF_SIZE );
