...
// 引数	sw	：
//-----------------------------------------------------------------------------
void CShinFhyo10EX::f1calq_3( int sw )
{
		...
		if( !(F0c&0x08) ){//[Y]
			if( ((*m_pSnHeadData)->Sn_Sign4&0x80) && (((*m_pSnHeadData)->Sn_Sign4&0x01)==0x00) ){
				if( (*m_pSnHeadData)->IsNeedTkkzDisp() ){
					ChangeColor( IDC_ICSDIAGCTRL2, ID11A, 1 );
				}
				else{
					ChangeColor( IDC_ICSDIAGCTRL2, ID11A, 0 );
				}
			}
//			if( (F0c&0x01) || (m_pArith->l_test(F11A)==0) ){
			if( (F0c&0x01) ){
				memset( F11A, '\0', MONY_BUF_SIZE );
				m_pArith->l_add( F11A, F11A, F11_1A );
			}
		}
		...
		if( !(F0c&0x80) ){//[Y]
			if( ((*m_pSnHeadData)->Sn_Sign4&0x80) && (((*m_pSnHeadData)->Sn_Sign4&0x01)==0x00) ){
				if( (*m_pSnHeadData)->IsNeedTkkzDisp() ){
					ChangeColor( IDC_ICSDIAGCTRL2, ID11B, 1 );
				}
				else{
					ChangeColor( IDC_ICSDIAGCTRL2, ID11B, 0 );
				}
			}
//			if( (F0c&0x10) || (m_pArith->l_test(F11B)==0) ){
			if( (F0c&0x10) ){
				memset( F11B, '\0', MONY_BUF_SIZE );
				m_pArith->l_add( F11B, F11B, F11_1B );
			}
		}
		...
		if( !(F0c&0x800) ){//[Y]
			if( ((*m_pSnHeadData)->Sn_Sign4&0x80) && (((*m_pSnHeadData)->Sn_Sign4&0x01)==0x00) ){
				if( (*m_pSnHeadData)->IsNeedTkkzDisp() ){
					ChangeColor( IDC_ICSDIAGCTRL2, ID11C, 1 );
				}
				else{
					ChangeColor( IDC_ICSDIAGCTRL2, ID11C, 0 );
				}
			}
			if( (F0c&0x100) || (m_pArith->l_test(F11C)==0) ){
				memset( F11C, '\0', MONY_BUF_SIZE );
				m_pArith->l_add( F11C, F11_1C, F11_2C );
			}
		}
	}
	...
	if( ((*m_pSnHeadData)->Sn_Sign4&0x80) && (((*m_pSnHeadData)->Sn_Sign4&0x01)==0x00) ){
		if((F0c&0x08) ){//[Y]
			ChangeColor( IDC_ICSDIAGCTRL2, ID11A, 3 );	// 2
		}
		if((F0c&0x80) ){//[Y]
			ChangeColor( IDC_ICSDIAGCTRL2, ID11B, 3 );	// 2
		}
		if((F0c&0x800) ){//[Y]
			ChangeColor( IDC_ICSDIAGCTRL2, ID11C, 3 );	// 2
		}
	}
...
// 引数	sw	：
//-----------------------------------------------------------------------------
void CShinFhyo10EX::f1calq_3_1( int sw )
{
	// 色変更
	if( ((*m_pSnHeadData)->Sn_Sign4&0x80) && (((*m_pSnHeadData)->Sn_Sign4&0x01)==0x00) ){
	}

	m_pArith->l_add( F11_1T, F11_1A, F11_1B );
	m_pArith->l_add( F11_1T, F11_1T, F11_1C );

	if( !sw ){
		dsp_prs( IDC_ICSDIAGCTRL2, ID11_1A, F11_1A );
		dsp_prs( IDC_ICSDIAGCTRL2, ID11_1B, F11_1B );
		dsp_prs( IDC_ICSDIAGCTRL2, ID11_1C, F11_1C );
		dsp_prs( IDC_ICSDIAGCTRL2, ID11_1D, F11_1T );
	}
}
...
// 引数	sw	：
//-----------------------------------------------------------------------------
void CShinFhyo10EX::f1calq_3_2( int sw )
{
	m_pArith->l_add( F11_2T, F11_2A, F11_2B );
	m_pArith->l_add( F11_2T, F11_2T, F11_2C );

	if( !sw ){
		dsp_prs( IDC_ICSDIAGCTRL2, ID11_2C, F11_2C );
		dsp_prs( IDC_ICSDIAGCTRL2, ID11_2D, F11_2T );
	}
}
...
// 引数	sw	：
//-----------------------------------------------------------------------------
void CShinFhyo10EX::f1calq_4( int sw )
{
...
// 引数	sw	：
//-----------------------------------------------------------------------------
void CShinFhyo10EX::f1calq_5( int sw )
{
	char	WORK0[MONY_BUF_SIZE]={0};
...
// 引数	sw	：
//-----------------------------------------------------------------------------
void CShinFhyo10EX::f1calq_5_2( int sw )
{
	char	WORK0[MONY_BUF_SIZE]={0};
...
// 引数	sw	：
//-----------------------------------------------------------------------------
void CShinFhyo10EX::f1calq_6( int sw )
{
...
// 引数	sw	：
//-----------------------------------------------------------------------------
void CShinFhyo10EX::f1calq_78( int sw )
{
...
// 引数	sw	：
//-----------------------------------------------------------------------------
void CShinFhyo10EX::f1calq_9( int sw )
{
	...
	if(!((*m_pSnHeadData)->Sn_Sign4&0x80) ){	//連動の場合集計しない。自動集計値を使用する為
		...
		if( !(F2c&0x08) ){//[Y]
			if( ((*m_pSnHeadData)->Sn_Sign4&0x80) && (((*m_pSnHeadData)->Sn_Sign4&0x01)==0x00) ){
//-- '15.08.21 --
//				ChangeColor( IDC_ICSDIAGCTRL2, ID15A, 0 );	//[Y]
//---------------
				if( (*m_pSnHeadData)->IsNeedTkkzDisp() ){
					ChangeColor( IDC_ICSDIAGCTRL2, ID15A, 1 );
				}
				else{
					ChangeColor( IDC_ICSDIAGCTRL2, ID15A, 0 );
				}
//---------------
			}
			if( (F2c&0x01) || (m_pArith->l_test(F15A)==0) ){
				memset( F15A, '\0', MONY_BUF_SIZE );
				m_pArith->l_add( F15A, F15A, F15_1A );
			}
		}
		...
		if( !(F2c&0x80) ){//[Y]
			if( ((*m_pSnHeadData)->Sn_Sign4&0x80) && (((*m_pSnHeadData)->Sn_Sign4&0x01)==0x00) ){
//-- '15.08.21 --
//				ChangeColor( IDC_ICSDIAGCTRL2, ID15B, 0 );	//[Y]
//---------------
				if( (*m_pSnHeadData)->IsNeedTkkzDisp() ){
					ChangeColor( IDC_ICSDIAGCTRL2, ID15B, 1 );
				}
				else{
					ChangeColor( IDC_ICSDIAGCTRL2, ID15B, 0 );
				}
//---------------
			}
			if( (F2c&0x10) || (m_pArith->l_test(F15B)==0) ){
				memset( F15B, '\0', MONY_BUF_SIZE );
				m_pArith->l_add( F15B, F15B, F15_1B );
			}
		}
		...
		if( !(F2c&0x800) ){//[Y]
			if( ((*m_pSnHeadData)->Sn_Sign4&0x80) && (((*m_pSnHeadData)->Sn_Sign4&0x01)==0x00) ){
//-- '15.08.21 --
//				ChangeColor( IDC_ICSDIAGCTRL2, ID15C, 0 );	//[Y]
//---------------
				if( (*m_pSnHeadData)->IsNeedTkkzDisp() ){
					ChangeColor( IDC_ICSDIAGCTRL2, ID15C, 1 );
				}
				else{
					ChangeColor( IDC_ICSDIAGCTRL2, ID15C, 0 );
				}
//---------------
			}
			if( (F2c&0x100) || (m_pArith->l_test(F15C)==0) ){
				memset( F15C, '\0', MONY_BUF_SIZE );
				m_pArith->l_add( F15C, F15_1C, F15_2C );
			}
		}
	}
	...
	if( ((*m_pSnHeadData)->Sn_Sign4&0x80) && (((*m_pSnHeadData)->Sn_Sign4&0x01)==0x00) ){
		if((F2c&0x08) ){//[Y]
			ChangeColor( IDC_ICSDIAGCTRL2, ID15A, 3 );	// 2
		}
		if((F2c&0x80) ){//[Y]
			ChangeColor( IDC_ICSDIAGCTRL2, ID15B, 3 );	// 2
		}
		if((F2c&0x800) ){//[Y]
			ChangeColor( IDC_ICSDIAGCTRL2, ID15C, 3 );	// 2
		}
	}
...
// 引数	sw	：
//-----------------------------------------------------------------------------
void CShinFhyo10EX::f1calq_9_1( int sw )
{
	m_pArith->l_add( F15_1T, F15_1A, F15_1B );
	m_pArith->l_add( F15_1T, F15_1T, F15_1C );

	if( !sw ){
		dsp_prs( IDC_ICSDIAGCTRL2, ID15_1A, F15_1A );
		dsp_prs( IDC_ICSDIAGCTRL2, ID15_1B, F15_1B );
		dsp_prs( IDC_ICSDIAGCTRL2, ID15_1C, F15_1C );
		dsp_prs( IDC_ICSDIAGCTRL2, ID15_1D, F15_1T );
	}
}
...
// 引数	sw	：
//-----------------------------------------------------------------------------
void CShinFhyo10EX::f1calq_9_2( int sw )
{
	m_pArith->l_add( F15_2T, F15_2A, F15_2B );
	m_pArith->l_add( F15_2T, F15_2T, F15_2C );

	if( !sw ){
		dsp_prs( IDC_ICSDIAGCTRL2, ID15_2C, F15_2C );
		dsp_prs( IDC_ICSDIAGCTRL2, ID15_2D, F15_2T );
	}
}
//-----------------------------------------------------------------------------
// 貸倒れに係る税額
...
// 引数	sw	：
//-----------------------------------------------------------------------------
void CShinFhyo10EX::f1calq_10( int sw )
{
	char	WORK0[MONY_BUF_SIZE]={0};
...
// 引数	sw	：
//-----------------------------------------------------------------------------
void CShinFhyo10EX::f1calq_11( int sw )
{
	char	WORK0[MONY_BUF_SIZE]={0};
...
// 引数	sw	：
//-----------------------------------------------------------------------------
void CShinFhyo10EX::f1calq_1213( int sw )
{
	if( !sw ){
...
// 引数	sw	：
//-----------------------------------------------------------------------------
void CShinFhyo10EX::f1calq_14( int sw )
{
...
// 引数	sw	：
//-----------------------------------------------------------------------------
void CShinFhyo10EX::f1calq_15( int sw )
{
	char	WORK0[MONY_BUF_SIZE]={0};
...
//		sw		：	
//-----------------------------------------------------------------------------
void CShinFhyo10EX::f1calq_all( int atno, int sw )
{
	while( 1 ){
		switch( atno ){
			case	1 :
...
// 引数	sw	：	
//-----------------------------------------------------------------------------
void CShinFhyo10EX::calq_by_OtherChange( int sw )
{
	ReadData( 0 );
	f1calq_all( 1, sw );
	WriteData();
