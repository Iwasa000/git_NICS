...
//-----------------------------------------------------------------------------
void CShinKaniEX::calqx_7( int sw )
{
...
// ˆø”	sw	F	•\Ž¦Ø‘ÖƒXƒCƒbƒ`
//-----------------------------------------------------------------------------
void CShinKaniEX::calqx_89( int sw )
{
...
//-----------------------------------------------------------------------------
void CShinKaniEX::calqx_1112( int sw )
{
...
// ˆø”	sw	F	•\Ž¦Ø‘ÖƒXƒCƒbƒ`
//-----------------------------------------------------------------------------
int CShinKaniEX::calqx_14( int sw )
{
...
// ˆø”	sw	F	•\Ž¦Ø‘ÖƒXƒCƒbƒ`
//-----------------------------------------------------------------------------
void CShinKaniEX::calqx_17( int sw )
{
...
// ˆø”	sw	F	•\Ž¦Ø‘ÖƒXƒCƒbƒ`
//-----------------------------------------------------------------------------
void CShinKaniEX::calqx_18( int sw )
{
...
// ˆø”	sw	F	•\Ž¦Ø‘ÖƒXƒCƒbƒ`
//-----------------------------------------------------------------------------
void CShinKaniEX::calqx_1920( int sw )
{
...
// ˆø”	sw	F	•\Ž¦Ø‘ÖƒXƒCƒbƒ`
//-----------------------------------------------------------------------------
void CShinKaniEX::calqx_2223( int sw )
{
...
// ˆø”	sw	F	•\Ž¦Ø‘ÖƒXƒCƒbƒ`
//-----------------------------------------------------------------------------
int CShinKaniEX::calqx_25( int sw )
{
	// ’†ŠÔŠŽ‰ü³“ú‘OŠJŽn‚Í’n•ûÁ”ïÅ“ü—Í–³‚µ
//	if( !(((*m_pSnHeadData)->Sn_SKKBN&0xff) % 2) && pSyzShin->N_ver != 2 ){
	if( 0 ){
...
// ˆø”	sw	F	•\Ž¦Ø‘ÖƒXƒCƒbƒ`
//-----------------------------------------------------------------------------
void CShinKaniEX::calqx_26( int sw )
{
...
//		sw		F	
//-----------------------------------------------------------------------------
void CShinKaniEX::calqx_all( int atno, int sw )
{
	while( 1 ){
		switch( atno ){
			case	1 :
...
// •Ê•\‚ÌŒvŽZ
//-----------------------------------------------------------------------------
void CShinKaniEX::calqx_otherlists()
{
	if( m_pParent ){
