...
#include "ShinKjnKskIdx.h"

// CShinKjnKsk ダイアログ

//static	char	AMENDK[] = { 0x23, 0x01, 0x01, 0 };	// （個人）平成23年より前の場合に許可

IMPLEMENT_DYNAMIC(CShinKjnKsk, CSyzBaseDlg)

CShinKjnKsk::CShinKjnKsk(CWnd* pParent /*=NULL*/)
	: CSyzBaseDlg(CShinKjnKsk::IDD, pParent)
	, m_pSnHeadData(NULL)
	, m_pSnKskData(NULL)
	, m_pArith(NULL)
	, m_pShinInfo(NULL)
...
CShinKjnKsk::~CShinKjnKsk()
{
}

void CShinKjnKsk::DoDataExchange(CDataExchange* pDX)
{
...
BEGIN_MESSAGE_MAP(CShinKjnKsk, CSyzBaseDlg)
	ON_COMMAND(ID_BUTTON_F2, &CShinKjnKsk::OnButtonF2)
END_MESSAGE_MAP()


// CShinKjnKsk メッセージ ハンドラ

BOOL CShinKjnKsk::OnInitDialog()
{
...
//			-1			：	エラー
//-----------------------------------------------------------------------------
int CShinKjnKsk::InitInfo( CSnHeadData **pSnHeadData, CArithEx *pArith, SYC_SHININFO *pShinInfo, CH26SnKskData **pSnKskData )
{
	ASSERT( pSnHeadData );
	if( pSnHeadData == NULL ){
		return -1;
...
// 引数	mode	：	
//-----------------------------------------------------------------------------
void CShinKjnKsk::DispKsiKjn( int mode/*=0*/ )
{
...
// データ表示
//-----------------------------------------------------------------------------
//void CShinKjnKsk::KsiKjnDispDig1()
void CShinKjnKsk::DispKsiKjnDig1()
{
	DIAGRAM_DATA	data;
	int		i, ln;
	char	buf[128];
...
// データ表示
//-----------------------------------------------------------------------------
//void CShinKjnKsk::KsiKjnDispDig2()
void CShinKjnKsk::DispKsiKjnDig2()
{
	DIAGRAM_DATA	data;
	int		i, idx;
...
// データ表示
//-----------------------------------------------------------------------------
//void CShinKjnKsk::KsiKjnDispDig3()
void CShinKjnKsk::DispKsiKjnDig3()
{
	DIAGRAM_DATA	data;
	int		i;
...
// データ表示
//-----------------------------------------------------------------------------
//void CShinKjnKsk::KsiKjnDispDigZi()
void CShinKjnKsk::DispKsiKjnDigZi()
{
	ASSERT( m_pShinInfo );
...
// 返送値
//-----------------------------------------------------------------------------
//int	CShinKjnKsk::Dig1DataSet(long index, short leng, DIAGRAM_DATA *data, int mode)
int	CShinKjnKsk::DataSetDig1(long index, short leng, DIAGRAM_DATA *data, int mode )
{
	if( index < 0 ){
		return 0;
	}
...
// 返送値	
//-----------------------------------------------------------------------------
//int	CShinKjnKsk::Dig2DataSet( long index, short leng, DIAGRAM_DATA *data, int mode )
int	CShinKjnKsk::DataSetDig2( long index, short leng, DIAGRAM_DATA *data, int mode )
{
	if( index < 0 ){
		return 0;
	}
...
// 返送値	
//-----------------------------------------------------------------------------
//int	CShinKjnKsk::Dig3DataSet( long index, short leng, DIAGRAM_DATA *data, int mode )
int	CShinKjnKsk::DataSetDig3( long index, short leng, DIAGRAM_DATA *data, int mode )
{
	if( index < 0 ){
		return 0;
	}
...
// 返送値
//-----------------------------------------------------------------------------
int CShinKjnKsk::GetTaxationOffice()
{
	DIAGRAM_DATA	dgda;
...
//		mode	：
//-----------------------------------------------------------------------------
int CShinKjnKsk::MoveCurselDiag1( short index, UINT flg, short nChar, int mode/*=0*/ )
{
	short	xpos = index;
	int		sw = 0, cmb = 0;
...
//		mode	：	
//-----------------------------------------------------------------------------
//void CShinKjnKsk::Diag2_Edit( short index, UINT flg, short nChar, int mode )
int CShinKjnKsk::MoveCurselDiag2( short index, UINT flg, short nChar, int mode/*=0*/ )
{
	short	xpos = index;
	int		sw = 0;
...
//		mode	：
//-----------------------------------------------------------------------------
//void CShinKjnKsk::Diag3_Edit( short index, UINT flg, short nChar, int mode )
int CShinKjnKsk::MoveCurselDiag3( short index, UINT flg, short nChar, int mode/*=0*/ )
{
	short	xpos = index;
	int		sw = 0, cmb = 0;
...
BEGIN_EVENTSINK_MAP(CShinKjnKsk, CSyzBaseDlg)
	ON_EVENT(CShinKjnKsk, IDC_ICSDIAGCTRL10, 3, CShinKjnKsk::TerminationIcsdiagctrl10, VTS_I2 VTS_I2 VTS_I2 VTS_UNKNOWN)
	ON_EVENT(CShinKjnKsk, IDC_ICSDIAGCTRL10, 1, CShinKjnKsk::EditONIcsdiagctrl10, VTS_I2)
	ON_EVENT(CShinKjnKsk, IDC_ICSDIAGCTRL10, 2, CShinKjnKsk::EditOFFIcsdiagctrl10, VTS_I2)
	ON_EVENT(CShinKjnKsk, IDC_ICSDIAGCTRL10, 8, CShinKjnKsk::ComboSelIcsdiagctrl10, VTS_I2 VTS_UNKNOWN)
	ON_EVENT(CShinKjnKsk, IDC_ICSDIAGCTRL20, 3, CShinKjnKsk::TerminationIcsdiagctrl20, VTS_I2 VTS_I2 VTS_I2 VTS_UNKNOWN)
	ON_EVENT(CShinKjnKsk, IDC_ICSDIAGCTRL20, 1, CShinKjnKsk::EditONIcsdiagctrl20, VTS_I2)
	ON_EVENT(CShinKjnKsk, IDC_ICSDIAGCTRL20, 2, CShinKjnKsk::EditOFFIcsdiagctrl20, VTS_I2)
	ON_EVENT(CShinKjnKsk, IDC_ICSDIAGCTRL30, 3, CShinKjnKsk::TerminationIcsdiagctrl30, VTS_I2 VTS_I2 VTS_I2 VTS_UNKNOWN)
	ON_EVENT(CShinKjnKsk, IDC_ICSDIAGCTRL30, 1, CShinKjnKsk::EditONIcsdiagctrl30, VTS_I2)
	ON_EVENT(CShinKjnKsk, IDC_ICSDIAGCTRL30, 2, CShinKjnKsk::EditOFFIcsdiagctrl30, VTS_I2)
	ON_EVENT(CShinKjnKsk, IDC_ICSDIAGCTRL30, 8, CShinKjnKsk::ComboSelIcsdiagctrl30, VTS_I2 VTS_UNKNOWN)
	ON_EVENT(CShinKjnKsk, IDC_ICSDIAGCTRL40, 8, CShinKjnKsk::ComboSelIcsdiagctrl40, VTS_I2 VTS_UNKNOWN)
	ON_EVENT(CShinKjnKsk, IDC_ICSDIAGCTRL40, 3, CShinKjnKsk::TerminationIcsdiagctrl40, VTS_I2 VTS_I2 VTS_I2 VTS_UNKNOWN)
	ON_EVENT(CShinKjnKsk, IDC_ICSDIAGCTRL40, 1, CShinKjnKsk::EditONIcsdiagctrl40, VTS_I2)
END_EVENTSINK_MAP()

void CShinKjnKsk::TerminationIcsdiagctrl10(short index, short nChar, short length, LPUNKNOWN data)
{
...
void CShinKjnKsk::EditONIcsdiagctrl10(short index)
{
	// TODO: ここにメッセージ ハンドラ コードを追加します。
	if( m_IsStartEnd ){
		return;
...
void CShinKjnKsk::EditOFFIcsdiagctrl10(short index)
{
	// TODO: ここにメッセージ ハンドラ コードを追加します。
	if( m_IsStartEnd ){
		return;
...
void CShinKjnKsk::ComboSelIcsdiagctrl10(short index, LPUNKNOWN data)
{
	// TODO: ここにメッセージ ハンドラ コードを追加します。
	if( m_IsStartEnd ){
		return;
...
void CShinKjnKsk::TerminationIcsdiagctrl20(short index, short nChar, short length, LPUNKNOWN data)
{
	// TODO: ここにメッセージ ハンドラ コードを追加します。
	if( nChar == 0 ){
		return;
...
void CShinKjnKsk::EditONIcsdiagctrl20(short index)
{
	// TODO: ここにメッセージ ハンドラ コードを追加します。
	if( m_IsStartEnd ){
		return;
...
void CShinKjnKsk::EditOFFIcsdiagctrl20(short index)
{
	// TODO: ここにメッセージ ハンドラ コードを追加します。
	if( m_IsStartEnd ){
		return;
...
void CShinKjnKsk::TerminationIcsdiagctrl30(short index, short nChar, short length, LPUNKNOWN data)
{
	// TODO: ここにメッセージ ハンドラ コードを追加します。
	if( nChar == 0 ){
		return;
...
void CShinKjnKsk::EditONIcsdiagctrl30(short index)
{
	// TODO: ここにメッセージ ハンドラ コードを追加します。
	if( m_IsStartEnd ){
		return;
...
void CShinKjnKsk::EditOFFIcsdiagctrl30(short index)
{
	// TODO: ここにメッセージ ハンドラ コードを追加します。
	if( m_IsStartEnd ){
		return;
...
void CShinKjnKsk::ComboSelIcsdiagctrl30(short index, LPUNKNOWN data)
{
	// TODO: ここにメッセージ ハンドラ コードを追加します。
	if( m_IsStartEnd ){
		return;
...
void CShinKjnKsk::ComboSelIcsdiagctrl40(short index, LPUNKNOWN data)
{
	// TODO: ここにメッセージ ハンドラ コードを追加します。
	if( m_IsStartEnd ){
		return;
...
void CShinKjnKsk::TerminationIcsdiagctrl40(short index, short nChar, short length, LPUNKNOWN data)
{
	// TODO: ここにメッセージ ハンドラ コードを追加します。
	if( nChar == 0 ){
		return;
...
//		index	：
//-----------------------------------------------------------------------------
//void CShinKjnKsk::scrollchk( WORD id, short index )
void CShinKjnKsk::ChkScroll( WORD id, short index )
{
	RECT	drect, wrect;
	long	sz, cnt;
	int		bpos;
...
BOOL CShinKjnKsk::PreTranslateMessage(MSG* pMsg)
{
...
// 初期化（データクリア）
//-----------------------------------------------------------------------------
//void CShinKjnKsk::KsiKjnClear( void )
void CShinKjnKsk::ClearKskKjn()
{
	CString	str;
	int		ans;
...
//-----------------------------------------------------------------------------
void CShinKjnKsk::SetItemPosition( int IndexNo )
{
	int	Index;
	if( IndexNo ){
		Index = IndexNo;
...
//[Y]イベント追加
void CShinKjnKsk::EditONIcsdiagctrl40(short index)
{
	// TODO: ここにメッセージ ハンドラ コードを追加します。
	if( m_IsStartEnd ){
		return;
...
//-----------------------------------------------------------------------------
void CShinKjnKsk::SetKanpuKinyuInput()
{
	// 確定時は全入力不可
	if( ((*m_pSnHeadData)->Sn_Sign4&0x01) ){
		return;
...
//-----------------------------------------------------------------------------
void CShinKjnKsk::MoveFocusInEnd()
{
	// データを確定させる為にフォーカス移動
