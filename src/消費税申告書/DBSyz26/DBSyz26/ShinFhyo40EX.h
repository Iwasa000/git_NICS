...
class CShinFhyo40EX : public CSyzBaseDlg
{
	DECLARE_DYNAMIC(CShinFhyo40EX)

public:
	CShinFhyo40EX(CWnd* pParent = NULL);   // 標準コンストラクタ
	virtual ~CShinFhyo40EX();

// ダイアログ データ
	enum { IDD = IDD_DIALOG_FHY40_EX };
