...
BOOL CShinRefundHjn01::OnInitDialog()
{
	...
	SetDiagControlMap( m_Meisai1Diag.GetDlgCtrlID(), new CDiagCtlTorihiki(m_Meisai1Diag,HOJIN1_LINE_CNT,58), new CSyzDataSet(refundvol, KAZEIU_REC, HOJIN1_LINE_CNT, &refundvol.KPKuck,&refundvol.KPKusg ) );
