...
enum {
	IPPAN01EX2_NUM_HOJIN1			= 104,	// 法人番号１
	IPPAN01EX2_NUM_HOJIN2,					// 法人番号２
	IPPAN01EX2_NUM_HOJIN3,					// 法人番号３
	IPPAN01EX2_NUM_HOJIN4,					// 法人番号４
	IPPAN01EX2_NUM_HOJINHYPHEN1,				// 法人番号ハイフン
	IPPAN01EX2_NUM_HOJINHYPHEN2,				// 法人番号ハイフン
	IPPAN01EX2_NUM_HOJINHYPHEN3,				// 法人番号ハイフン
	IPPAN01EX2_NUM_KOJIN1,					// 個人番号１
	IPPAN01EX2_NUM_KOJIN2,					// 個人番号２
	IPPAN01EX2_NUM_KOJIN3,					// 個人番号３
	IPPAN01EX2_NUM_KOJINHYPHEN1,				// 個人番号ハイフン
	IPPAN01EX2_NUM_KOJINHYPHEN2				// 個人番号ハイフン
};

class CShinIppan01EX2 : public CSyzBaseDlg
{
	DECLARE_DYNAMIC(CShinIppan01EX2)

public:
	CShinIppan01EX2(CWnd* pParent = NULL);   // 標準コンストラクタ
	virtual ~CShinIppan01EX2();

// ダイアログ データ
	enum { IDD = IDD_DIALOG_IPPAN01EX2 };
