...
enum {
	HJNKSKEX2_NUM_HOJIN1			= 56,	// 法人番号１
	HJNKSKEX2_NUM_HOJIN2,					// 法人番号２
	HJNKSKEX2_NUM_HOJIN3,					// 法人番号３
	HJNKSKEX2_NUM_HOJIN4,					// 法人番号４
	HJNKSKEX2_NUM_HOJINHYPHEN1,			// 法人番号ハイフン
	HJNKSKEX2_NUM_HOJINHYPHEN2,			// 法人番号ハイフン
	HJNKSKEX2_NUM_HOJINHYPHEN3,			// 法人番号ハイフン
};


class CShinHjnKskEX2 : public CSyzBaseDlg
{
	DECLARE_DYNAMIC(CShinHjnKskEX2)

public:
	CShinHjnKskEX2(CWnd* pParent = NULL);   // 標準コンストラクタ
	virtual ~CShinHjnKskEX2();

// ダイアログ データ
	enum { IDD = IDD_DIALOG_HJINKSK_EX2 };
