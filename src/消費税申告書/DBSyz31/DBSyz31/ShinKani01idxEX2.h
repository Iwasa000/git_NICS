...
#define ID2WARI	71	// 税額控除に係る経過措置（2割特例）

#define ID4210	72	// 金融機関 銀行名
#define ID4211	74	// 金融機関 支店名
#define ID4212	73	// 金融機関 銀行・金庫等
#define ID4213	75	// 金融機関 本社・支社等
#define ID4214	76	// 金融機関 預金種類
#define ID4215	77	// 金融機関 口座番号

#define ID4310	78	// 郵便局 貯金記号
#define ID4311	79	// 郵便局 貯金番号
#define ID4312	80	// 郵便局 郵便局名

#define ID4410	81	// 還付金融機関選択
#define ID4420	82	// （個人の方）公金受取口座の利用

#define ID4RNO	83	// 税務署整理欄

#define ID4ZI0	43	// 税理士署名押印 事務所名
#define ID4ZI1	44	// 税理士署名押印 氏名
#define ID4ZI2	46	// 税理士署名押印 電話番号
#define ID4ZI3	84	// 税理士法第30条
#define ID4ZI4	85	// 税理士法第33条の2
