...
class CShinIppan01 : public CSyzBaseDlg
{
	DECLARE_DYNAMIC(CShinIppan01)

public:
	CShinIppan01(CWnd* pParent = NULL);   // 標準コンストラクタ
	virtual ~CShinIppan01();

// ダイアログ データ
	enum { IDD = IDD_DIALOG_IPPAN01 };
