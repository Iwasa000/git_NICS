...
enum {
	KANIEX_NUM_HOJIN1			= 106,	// 法人番号１
	KANIEX_NUM_HOJIN2,					// 法人番号２
	KANIEX_NUM_HOJIN3,					// 法人番号３
	KANIEX_NUM_HOJIN4,					// 法人番号４
	KANIEX_NUM_HOJINHYPHEN1,			// 法人番号ハイフン
	KANIEX_NUM_HOJINHYPHEN2,			// 法人番号ハイフン
	KANIEX_NUM_HOJINHYPHEN3,			// 法人番号ハイフン
	KANIEX_NUM_KOJIN1,					// 個人番号１
	KANIEX_NUM_KOJIN2,					// 個人番号２
	KANIEX_NUM_KOJIN3,					// 個人番号３
	KANIEX_NUM_KOJINHYPHEN1,			// 個人番号ハイフン
	KANIEX_NUM_KOJINHYPHEN2				// 個人番号ハイフン
};

class CShinKani01 : public CSyzBaseDlg
{
	DECLARE_DYNAMIC(CShinKani01)

public:
	CShinKani01(CWnd* pParent = NULL);   // 標準コンストラクタ
	virtual ~CShinKani01();
