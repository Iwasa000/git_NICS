...
IMPLEMENT_DYNAMIC(CShinFhyo2_03Ex, CSyzBaseDlg)

extern	HINSTANCE g_hInstance;


CShinFhyo2_03Ex::CShinFhyo2_03Ex(CWnd* pParent /*=nullptr*/)
	: CSyzBaseDlg(CShinFhyo2_03Ex::IDD, pParent)
	, m_pParent ( pParent )
	...
	, m_UwSgn ( TRUE )
{
	...
	//---->20230120
	memset ( F203_27A, '\0', sizeof ( F203_27A ) );
	memset ( F203_27B, '\0', sizeof ( F203_27B ) );
	memset ( F203_27C, '\0', sizeof ( F203_27C ) );
	memset ( F203_28A, '\0', sizeof ( F203_28A ) );
	memset ( F203_28B, '\0', sizeof ( F203_28B ) );
	memset ( F203_28C, '\0', sizeof ( F203_28C ) );
	//<----20230120
	...
	F203_10c = F203_12c = F203_19c = F203_20c = F203_23c = F203_28c = 0;
...
CShinFhyo2_03Ex::~CShinFhyo2_03Ex()
{
}

void CShinFhyo2_03Ex::DoDataExchange(CDataExchange* pDX)
{
...
BEGIN_MESSAGE_MAP(CShinFhyo2_03Ex, CSyzBaseDlg)
	ON_WM_SIZE()
	ON_WM_VSCROLL()
	ON_WM_CTLCOLOR()
	ON_BN_CLICKED(IDC_BUTTON1, &CShinFhyo2_03Ex::OnBnClickedButton1)
	ON_BN_CLICKED(IDC_BUTTON2, &CShinFhyo2_03Ex::OnBnClickedButton2)
END_MESSAGE_MAP()

BEGIN_EVENTSINK_MAP(CShinFhyo2_03Ex, CSyzBaseDlg)
	ON_EVENT(CShinFhyo2_03Ex, IDC_ICSDIAG8CTRL2, 1, CShinFhyo2_03Ex::EditONIcsdiag8ctrl2, VTS_I2)
	ON_EVENT(CShinFhyo2_03Ex, IDC_ICSDIAG8CTRL2, 2, CShinFhyo2_03Ex::EditOFFIcsdiag8ctrl2, VTS_I2)
	ON_EVENT(CShinFhyo2_03Ex, IDC_ICSDIAG8CTRL2, 3, CShinFhyo2_03Ex::TerminationIcsdiag8ctrl2, VTS_I2 VTS_I2 VTS_I2 VTS_UNKNOWN)
	ON_EVENT(CShinFhyo2_03Ex, IDC_ICSDIAG8CTRL2, 9, CShinFhyo2_03Ex::CheckButtonIcsdiag8ctrl2, VTS_I2 VTS_UNKNOWN)
END_EVENTSINK_MAP()
// ShinFhyo2_03 メッセージ ハンドラー


BOOL CShinFhyo2_03Ex::OnInitDialog()
{
...
void CShinFhyo2_03Ex::OnSize(UINT nType, int cx, int cy)
{
...
void CShinFhyo2_03Ex::OnVScroll(UINT nSBCode, UINT nPos, CScrollBar* pScrollBar)
{
...
HBRUSH CShinFhyo2_03Ex::OnCtlColor(CDC* pDC, CWnd* pWnd, UINT nCtlColor)
{
...
BOOL CShinFhyo2_03Ex::PreTranslateMessage(MSG* pMsg)
{
...
void CShinFhyo2_03Ex::EditONIcsdiag8ctrl2(short index)
{
	// TODO: ここにメッセージ ハンドラ コードを追加します。
...
void CShinFhyo2_03Ex::EditOFFIcsdiag8ctrl2(short index)
{
	// TODO: ここにメッセージ ハンドラ コードを追加します。
...
void CShinFhyo2_03Ex::TerminationIcsdiag8ctrl2(short index, short nChar, short length, LPUNKNOWN data)
{
	// TODO: ここにメッセージ ハンドラ コードを追加します。
	if ( nChar == 0 ) {
		return;
...
//---->20230120
		case ID203_28A:
			...
			// 各入力の表示
			f203data_all ( 28 );
			m_Fhyo2_03Diag02.SetPosition ( ID203_28A );
			break;
		...
		case ID203_28B:
			...
			// 各入力の表示
			f203data_all ( 28 );
			m_Fhyo2_03Diag02.SetPosition ( ID203_28B );
			break;
//<----20230120
	...
	if ( pWnd->GetDlgCtrlID() == IDC_BUTTON1 ) {
		nowpos = ID203_16C;	// 14Cのポジションをセット
	}
	else {
...
void CShinFhyo2_03Ex::CheckButtonIcsdiag8ctrl2(short index, LPUNKNOWN data)
{
	// TODO: ここにメッセージ ハンドラ コードを追加します。
...
//			-1			：	エラー
//=========================================================
int CShinFhyo2_03Ex::InitInfo ( CH31SnFhyo2_01Data **pSnFhyo2_01Data, CSnHeadData **pSnHeadData, CArithEx *pArith, SYC_SHININFO *pShinInfo, CH31SnTanaData **pSnTanaData, CSyzSyukei **pSyzSyukei )
{
...
int CShinFhyo2_03Ex::ReadData()
{
	...
	memmove ( F203_27A, ( *m_pSnFhyo2_01Data )->Sn_F201_27D, MONY_BUF_SIZE );
	memmove ( F203_27B, ( *m_pSnFhyo2_01Data )->Sn_F201_27E, MONY_BUF_SIZE );
	memmove ( F203_27C, ( *m_pSnFhyo2_01Data )->Sn_F201_27F, MONY_BUF_SIZE );

	// 12.適格請求書発行事業者～…消費税額とみなされる額
	memmove ( F203_28A, ( *m_pSnFhyo2_01Data )->Sn_F201_28D, MONY_BUF_SIZE );
	memmove ( F203_28B, ( *m_pSnFhyo2_01Data )->Sn_F201_28E, MONY_BUF_SIZE );
	memmove ( F203_28C, ( *m_pSnFhyo2_01Data )->Sn_F201_28F, MONY_BUF_SIZE );
	F203_28c = ( *m_pSnFhyo2_01Data )->Sn_F201_28sw;
	//<----20230120
...
// 読込みデータを集計モジュールへ
//=========================================================
void CShinFhyo2_03Ex::ReadData2()
{
	// 旧税率は全てクリア
	...
	if ( ( *m_pSnHeadData )->Sn_Sign4 & 0x80 ) {
		...
		//---->20230120
		( *m_pSyzSyukei )->SetShinkokuData ( _T( "328302" ), F203_27A );
		( *m_pSyzSyukei )->SetShinkokuData ( _T( "328303" ), F203_27B );

		if ( F203_28c & 0x80 ) {
			( *m_pSyzSyukei )->SetShinkokuData ( _T( "328402" ), F203_28A );
		}
		else {
			( *m_pSyzSyukei )->ResetShinkokuData ( _T( "328402" ) );
		}
		if ( F203_28c & 0x800 ) {
			( *m_pSyzSyukei )->SetShinkokuData ( _T( "328403" ), F203_28B );
		}
		else {
			( *m_pSyzSyukei )->ResetShinkokuData ( _T( "328403" ) );
		}
...
int CShinFhyo2_03Ex::WriteData()
{
	...
	//---->20230120
	// 11.適格請求書発行事業者～…支払い対価の額(税込み)
	memset ( ( *m_pSnFhyo2_01Data )->Sn_F201_27X, '\0', MONY_BUF_SIZE );
	memmove ( ( *m_pSnFhyo2_01Data )->Sn_F201_27D, F203_27A, MONY_BUF_SIZE );
	memmove ( ( *m_pSnFhyo2_01Data )->Sn_F201_27E, F203_27B, MONY_BUF_SIZE );
	memmove ( ( *m_pSnFhyo2_01Data )->Sn_F201_27F, F203_27C, MONY_BUF_SIZE );

	// 12.適格請求書発行事業者～…消費税額とみなされる額
	memset ( ( *m_pSnFhyo2_01Data )->Sn_F201_28X, '\0', MONY_BUF_SIZE );
	memmove ( ( *m_pSnFhyo2_01Data )->Sn_F201_28D, F203_28A, MONY_BUF_SIZE );
	memmove ( ( *m_pSnFhyo2_01Data )->Sn_F201_28E, F203_28B, MONY_BUF_SIZE );
	memmove ( ( *m_pSnFhyo2_01Data )->Sn_F201_28F, F203_28C, MONY_BUF_SIZE );
	( *m_pSnFhyo2_01Data )->Sn_F201_28sw = F203_28c;
	//<----20230120
...
//			0			：	正常終了
//=========================================================
int CShinFhyo2_03Ex::MemoryReget()
{
	// 入力ロック時は集計しない
	...
	for ( int l = 0; l < cnt; l++ ) {
		...
		for ( int m = 0; m < incnt; m++ ) {
			...
			//---->20230120
				...
				memmove ( F203_27A, money[l][m].arith, MONY_BUF_SIZE );
			}
			else if ( money[l][m].code == _T( "328303" ) ) {
				memmove ( F203_27B, money[l][m].arith, MONY_BUF_SIZE );
			}
			else if ( money[l][m].code == _T( "328300" ) ) {
				memmove ( F203_27C, money[l][m].arith, MONY_BUF_SIZE );
			}
			else if ( money[l][m].code == _T( "328402" ) ) {
				memmove ( F203_28A, money[l][m].arith, MONY_BUF_SIZE );
			}
			else if ( money[l][m].code == _T( "328403" ) ) {
				memmove ( F203_28B, money[l][m].arith, MONY_BUF_SIZE );
			}
			else if ( money[l][m].code == _T( "328400" ) ) {
				memmove ( F203_28C, money[l][m].arith, MONY_BUF_SIZE );
			}
			//<----20230120
...
//			0			：	正常終了
//=========================================================
int CShinFhyo2_03Ex::SyukeiDataSet ( int cID )
{
	char val[MONY_BUF_SIZE] = { 0 };
	DIAGRAM_DATA DiagData;
	DiagData.data_imgdata = NULL;
...
//---->20230120
	case ID203_27A:
		memmove ( F203_27A, val, MONY_BUF_SIZE );
		( *m_pSyzSyukei )->SetShinkokuData ( _T( "328302" ), F203_27A );
		break;
	case ID203_27B:
		memmove ( F203_27B, val, MONY_BUF_SIZE );
		( *m_pSyzSyukei )->SetShinkokuData ( _T( "328303" ), F203_27B);
		break;
	case ID203_28A:
		if ( m_pArith->l_cmp ( F203_28A, val ) ) {
			F203_28c |= 0x80;
			memmove ( F203_28A, val, MONY_BUF_SIZE );
			( *m_pSyzSyukei )->SetShinkokuData ( _T( "328402" ), F203_28A );
		}
		break;
	case ID203_28B:
		if ( m_pArith->l_cmp ( F203_28B, val ) ) {
			F203_28c |= 0x800;
			memmove ( F203_28B, val, MONY_BUF_SIZE );
			( *m_pSyzSyukei )->SetShinkokuData ( _T( "328403" ), F203_28B);
		}
		break;
//<----20230120
...
//			0			：	正常終了
//=========================================================
int CShinFhyo2_03Ex::InitDiagAttr()
{
	int cnt = 0;
	...
	while ( 1 ) {
		...
		if ( ( *m_pSnHeadData )->Sn_Sign4 & 0x01 ) {
			...
			if ( ( *m_pSnHeadData )->Sn_Sign4 & 0x80 ) {
				...
				int st = ChkTkkzIdx ( Fhyo2_03[cnt].Index );
				if ( st == 1 ) {
					if ( ( *m_pSnHeadData )->IsNeedTkkzDisp() ) {
						Flg = 1;
					}
...
//============================================================
int CShinFhyo2_03Ex::ChkTkkzIdx ( short idx )
{
	int rSt = 0;
...
// 画面出力
//=========================================================
void CShinFhyo2_03Ex::DispFh2_03()
{
...
//			Index		：	ダイアグラム内インデックス
//=========================================================
void CShinFhyo2_03Ex::dsp_prs ( unsigned short Id, short Index, char *Mony )
{
	DIAGRAM_DATA		DiagData;
	DiagData.data_imgdata = NULL;
...
//			Index		：	ダイアグラム内インデックス
//=========================================================
void CShinFhyo2_03Ex::dsp_cls ( unsigned short Id, short Index )
{
	DIAGRAM_DATA		DiagData;
	DiagData.data_imgdata = NULL;
...
// 課税売上高5億円越えチェック
//=========================================================
void CShinFhyo2_03Ex::CheckOver500Million()
{
	DIAGRAM_ATTRIBUTE DA;
	DIAGRAM_DATA DiagData;
	DiagData.data_imgdata = NULL;
...
//						FF3000　にセットした値
//=========================================================
int CShinFhyo2_03Ex::CheckOver500MillionSub ( int &MilSw, char *pVAL, char *pValCnv )
{
	int		nflg = 0;
	char	flg[MONY_BUF_SIZE] ={ 0 };
	...
	// データクラスにセットしておく
	pView->SetMony( tag, chtag, tmpVAL );
...
//		atno		：		項目番号
//=========================================================
void CShinFhyo2_03Ex::f203data_all ( int atno )
{
	switch( atno ){
	case 0:
	case 1:
...
// 課税売上(税抜き)表示
//=========================================================
void CShinFhyo2_03Ex::f203data_1()
{
...
// 免税売上額
//=========================================================
void CShinFhyo2_03Ex::f203data_2()
{
...
//=========================================================
void CShinFhyo2_03Ex::f203data_3()
{
...
// 課税資産の譲渡等の対価の額
//=========================================================
void CShinFhyo2_03Ex::f203data_4_5()
{
...
// 非課税売上額
//=========================================================
void CShinFhyo2_03Ex::f203data_6()
{
...
// 資産の譲渡等の対価の額
//=========================================================
void CShinFhyo2_03Ex::f203data_7()
{
...
// 課税売上割合
//=========================================================
void CShinFhyo2_03Ex::f203data_8()
{
...
// 課税仕入れに係る支払対価の額(税込み)
//=========================================================
void CShinFhyo2_03Ex::f203data_9()
{
...
// 課税仕入れに係る消費税額
//=========================================================
void CShinFhyo2_03Ex::f203data_10()
{
	if ( ( ( *m_pSnHeadData )->Sn_Sign4 & 0x80 ) && ( ( ( *m_pSnHeadData )->Sn_Sign4 & 0x01 ) == 0x00 ) ) {
...
// 特定課税仕入れに係る支払対価の額
//=========================================================
void CShinFhyo2_03Ex::f203data_11()
{
...
// 特定課税仕入れに係る消費税額
//=========================================================
void CShinFhyo2_03Ex::f203data_12()
{
	if ( ( ( *m_pSnHeadData )->Sn_Sign4 & 0x80 ) && ( ( ( *m_pSnHeadData )->Sn_Sign4 & 0x01 ) == 0x00 ) ) {
		if ( ( *m_pSnHeadData )->IsNeedTkkzDisp() ) {
...
// 課税貨物に係る消費税額
//=========================================================
void CShinFhyo2_03Ex::f203data_13()
{
...
//=========================================================
void CShinFhyo2_03Ex::f203data_14()
{
...
// 課税仕入れ等の税額の合計額
//=========================================================
void CShinFhyo2_03Ex::f203data_15()
{
...
//=========================================================
void CShinFhyo2_03Ex::f203data_16()
{
...
// 15のうち、課税売上げにのみ要するもの
//=========================================================
void CShinFhyo2_03Ex::f203data_17()
{
...
//=========================================================
void CShinFhyo2_03Ex::f203data_18()
{
...
//=========================================================
void CShinFhyo2_03Ex::f203data_19()
{
...
//=========================================================
void CShinFhyo2_03Ex::f203data_20()
{
...
//=========================================================
void CShinFhyo2_03Ex::f203data_21()
{
...
//=========================================================
void CShinFhyo2_03Ex::f203data_22()
{
...
// 控除対象仕入税額がプラスの時
//=========================================================
void CShinFhyo2_03Ex::f203data_23()
{
...
// 控除対象仕入税額がマイナスの時
//=========================================================
void CShinFhyo2_03Ex::f203data_24()
{
...
// 貸倒回収に係る消費税額
//=========================================================
void CShinFhyo2_03Ex::f203data_25()
{
...
//=========================================================
void CShinFhyo2_03Ex::f203data_26()
{
...
//=========================================================
void CShinFhyo2_03Ex::f203data_27()
{
	dsp_prs ( IDC_ICSDIAG8CTRL2, ID203_27A, F203_27A );
	dsp_prs ( IDC_ICSDIAG8CTRL2, ID203_27B, F203_27B );
	dsp_prs ( IDC_ICSDIAG8CTRL2, ID203_27C, F203_27C );
}

//=========================================================
// 適格請求書発行事業者～…消費税額とみなされる額 20230120
//=========================================================
void CShinFhyo2_03Ex::f203data_28()
{
	if ( ( ( *m_pSnHeadData )->Sn_Sign4 & 0x80 ) && ( ( ( *m_pSnHeadData )->Sn_Sign4 & 0x01 ) == 0x00 ) ) {
		ChangeColor ( IDC_ICSDIAG8CTRL2, ID203_28A, ( F203_28c & 0x80 ) ? 3 : 0 );
		ChangeColor ( IDC_ICSDIAG8CTRL2, ID203_28B, ( F203_28c & 0x800 ) ? 3 : 0 );
	}

	dsp_prs ( IDC_ICSDIAG8CTRL2, ID203_28A, F203_28A );
	dsp_prs ( IDC_ICSDIAG8CTRL2, ID203_28B, F203_28B );
	dsp_prs ( IDC_ICSDIAG8CTRL2, ID203_28C, F203_28C );
}

//=========================================================
// 課税売上割合を変更
//=========================================================
void CShinFhyo2_03Ex::Changef203data_8()
{
	// 課税売上割合に準ずる割合を有効
	// 課税売上割合が９５％未満
	if ( ( *m_pSnHeadData )->IsUseSemiUriRatio() || ( F203_8EX < (*m_pSnHeadData)->m_UriRatioBorder ) ) {
...
// 棚卸データの加減算を行う
//=========================================================
void CShinFhyo2_03Ex::TanaDataAdd()
{
...
// 表示金額取得
//=========================================================
void CShinFhyo2_03Ex::GetAllDiagData()
{
	DIAGRAM_DATA DiagData;
	DiagData.data_imgdata = NULL;
	...
	//---->20230120
	// 11.適格請求書発行事業者～…支払い対価の額(税込み)
	diag_getdata ( IDC_ICSDIAG8CTRL2, ID203_27A, ( struct IUnknown* )&DiagData, CIcsdiagctrl );
	memmove ( F203_27A, DiagData.data_val, MONY_BUF_SIZE );
	diag_getdata ( IDC_ICSDIAG8CTRL2, ID203_27B, ( struct IUnknown* )&DiagData, CIcsdiagctrl );
	memmove ( F203_27B, DiagData.data_val, MONY_BUF_SIZE );
	diag_getdata ( IDC_ICSDIAG8CTRL2, ID203_27C, ( struct IUnknown* )&DiagData, CIcsdiagctrl );
	memmove ( F203_27C, DiagData.data_val, MONY_BUF_SIZE );

	// 12.適格請求書発行事業者～…消費税額とみなされる額
	diag_getdata ( IDC_ICSDIAG8CTRL2, ID203_28A, ( struct IUnknown* )&DiagData, CIcsdiagctrl );
	memmove ( F203_28A, DiagData.data_val, MONY_BUF_SIZE );
	diag_getdata ( IDC_ICSDIAG8CTRL2, ID203_28B, ( struct IUnknown* )&DiagData, CIcsdiagctrl );
	memmove ( F203_28B, DiagData.data_val, MONY_BUF_SIZE );
	diag_getdata ( IDC_ICSDIAG8CTRL2, ID203_28C, ( struct IUnknown* )&DiagData, CIcsdiagctrl );
	memmove ( F203_28C, DiagData.data_val, MONY_BUF_SIZE );
	//<----20230120
...
//		計算した課税売上割合
//=========================================================
unsigned short CShinFhyo2_03Ex::GetCalqedKzwari()
{
...
// ボタン表示変更
//=========================================================
void CShinFhyo2_03Ex::ChangeBtnDisp()
{
...
// 初期ポジションセット
//===================================================
void CShinFhyo2_03Ex::SetItemPosition()
{
	int index;
...
//			Move		：	0 = 下方向, 1 = 上方向
//=========================================================
int CShinFhyo2_03Ex::UpDownFocusMoveCheck ( int Index, int Move )
{
	int idx = 0;
	int i = 0, j = 0;
...
//			sign		:		変更サイン
//=========================================================
void CShinFhyo2_03Ex::ModifyDiagInput ( short index, int sign )
{
...
//			sign		:		変更サイン
//=========================================================
void CShinFhyo2_03Ex::ChangeColor ( unsigned short id, short Index, int sign )
{
	DIAGRAM_ATTRIBUTE	DA;
...
// 棚卸調整額入力
//=========================================================
void CShinFhyo2_03Ex::OnBnClickedButton1()
{
...
// 特定収入の簡易計算式表示
//=========================================================
void CShinFhyo2_03Ex::OnBnClickedButton2()
{
	// TODO: ここにコントロール通知ハンドラー コードを追加します。
...
//===================================================
void CShinFhyo2_03Ex::f203calq_spc ( SYZTOSPC_DATA SpcData )
{
	if ( *( m_pShinInfo->pSgSpc ) == 1 ) {
...
//	FALSE		:		なし
//=========================================================
BOOL CShinFhyo2_03Ex::IsManualInputSign()
{
	BOOL ret = FALSE;
	if ( !( ( *m_pSnHeadData )->Sn_Sign4 & 0x80 ) || ( ( *m_pSnHeadData )->Sn_Sign4 & 0x01 ) ) {
		// 連動時、入力ロック中はチェックしない
		...
		if ( ( F203_10c & 0x880 ) || ( F203_12c & 0x800 ) || ( F203_19c & 0x880 ) ||
			 ( F203_20c & 0x880 ) || ( F203_23c & 0x880 ) || ( F203_28c & 0x880 ) ) {	// 20230120
			ret = TRUE;
		}
	}
