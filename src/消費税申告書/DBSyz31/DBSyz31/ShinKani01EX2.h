...
enum {
	KANI01EX2_NUM_HOJIN1			= 103,	// 法人番号１
	KANI01EX2_NUM_HOJIN2,					// 法人番号２
	KANI01EX2_NUM_HOJIN3,					// 法人番号３
	KANI01EX2_NUM_HOJIN4,					// 法人番号４
	KANI01EX2_NUM_HOJINHYPHEN1,			// 法人番号ハイフン
	KANI01EX2_NUM_HOJINHYPHEN2,			// 法人番号ハイフン
	KANI01EX2_NUM_HOJINHYPHEN3,			// 法人番号ハイフン
	KANI01EX2_NUM_KOJIN1,					// 個人番号１
	KANI01EX2_NUM_KOJIN2,					// 個人番号２
	KANI01EX2_NUM_KOJIN3,					// 個人番号３
	KANI01EX2_NUM_KOJINHYPHEN1,			// 個人番号ハイフン
	KANI01EX2_NUM_KOJINHYPHEN2				// 個人番号ハイフン
};

class CShinKani01EX2 : public CSyzBaseDlg
{
	DECLARE_DYNAMIC(CShinKani01EX2)

public:
	CShinKani01EX2(CWnd* pParent = NULL);   // 標準コンストラクタ
	virtual ~CShinKani01EX2();

// ダイアログ データ
	enum { IDD = IDD_DIALOG_KANIEX2 };
...
private:
	...
	char				XM1[MONY_BUF_SIZE],				// 1.  課税標準額
						...
						XM3[MONY_BUF_SIZE],				// 3.  貸倒回収に係る消費税額
						...
						XM23[MONY_BUF_SIZE],			// 23. 中間納付還付譲渡割額
						XM24[MONY_BUF_SIZE],			// 24. 既確定譲渡割額
						XM25[MONY_BUF_SIZE],			// 25. 差引納付譲渡割額
						XM26[MONY_BUF_SIZE];			// 26. 消費税及び地方消費税の合計(納付又は還付)税額

	char				KURI1[MONY_BUF_SIZE],			// 第一種事業 課税売上
						KURI2[MONY_BUF_SIZE],			// 第二種事業 課税売上
						KURI3[MONY_BUF_SIZE],			// 第三種事業 課税売上
						KURI4[MONY_BUF_SIZE],			// 第四種事業 課税売上
						KURI5[MONY_BUF_SIZE],			// 第五種事業 課税売上
						KURI6[MONY_BUF_SIZE];			// 第六種事業 課税売上

	unsigned short		KUP1,							// 第一種事業 課税売上割合
						KUP2,							// 第二種事業 課税売上割合
						KUP3,							// 第三種事業 課税売上割合
						KUP4,							// 第四種事業 課税売上割合
						KUP5,							// 第五種事業 課税売上割合
...
public:
	// 初期情報のセット
	int InitInfo ( CSnHeadData **pSnHeadData, CH31SnHonpyoData **pSnHonpyoData, CArithEx *pArith, SYC_SHININFO *pShinInfo, CSyzSyukei **pSyzSyukei );
	...
	// 簡易本表金額表示
	void Disp_Kanidata ( int atno );

	// 差引納付税額
	void Disp_Kanidata14();

	// 差引納付譲渡割額
	void Disp_Kanidata25();
...
public:
	...
	CIcsdiagctrl m_Kani01Diag01;
	CIcsdiagctrl m_Kani01Diag02;
	CIcsdiagctrl m_Kani01Diag03;
