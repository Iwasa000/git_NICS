...
enum {
	KANI01EX_NUM_HOJIN1			= 103,	// 法人番号１
	KANI01EX_NUM_HOJIN2,					// 法人番号２
	KANI01EX_NUM_HOJIN3,					// 法人番号３
	KANI01EX_NUM_HOJIN4,					// 法人番号４
	KANI01EX_NUM_HOJINHYPHEN1,			// 法人番号ハイフン
	KANI01EX_NUM_HOJINHYPHEN2,			// 法人番号ハイフン
	KANI01EX_NUM_HOJINHYPHEN3,			// 法人番号ハイフン
	KANI01EX_NUM_KOJIN1,					// 個人番号１
	KANI01EX_NUM_KOJIN2,					// 個人番号２
	KANI01EX_NUM_KOJIN3,					// 個人番号３
	KANI01EX_NUM_KOJINHYPHEN1,			// 個人番号ハイフン
	KANI01EX_NUM_KOJINHYPHEN2				// 個人番号ハイフン
};

class CShinKani01EX : public CSyzBaseDlg
{
	DECLARE_DYNAMIC(CShinKani01EX)

public:
	CShinKani01EX(CWnd* pParent = NULL);   // 標準コンストラクタ
	virtual ~CShinKani01EX();

// ダイアログ データ
	enum { IDD = IDD_DIALOG_KANIEX };
