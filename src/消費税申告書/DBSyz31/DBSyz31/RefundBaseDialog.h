...
//	static SN_HEAD*	 snhead;
	...
	static void SetTorihikiRecBuf(REFUNDREC* refunrec_data, int line,int check,int sgn, int rectyp = 0);
...
//	static CDBSyzShinView *pSyzShin;
	...
	//処理判断できないので後日修正yoshida

	// 他表で変更があったので再集計	('15.02.03)
	int calq_by_OtherChange( int sw, CH31SnFhyo2_01Data *pH31SnFhyo2_01Data, EnumIdIcsShRevType shRevType );
