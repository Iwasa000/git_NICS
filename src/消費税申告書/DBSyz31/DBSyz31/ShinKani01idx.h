...
// 基本情報
#define ID2000	72	// 提出年
#define ID2001	73	// 提出月
#define ID2002	74	// 提出日
#define ID2010	75	// 税務署名
#define ID2011	76	// 税務署番号
#define ID2020	77	// 郵便番号
#define ID2030	78	// 納税地 上段
#define ID2031	79	// 納税地 下段
#define ID2040	80	// 電話番号 市外
#define ID2041	81	// 電話番号 市内
#define ID2042	82	// 電話番号 局番
#define ID2050	83	// 名称又は屋号 フリガナ
#define ID2051	84	// 名称又は屋号
#define ID2052	85	// 被合併名
#define ID2060	87	// 代表者又は氏名 フリガナ
#define ID2061	88	// 代表者又は氏名
#define ID2070	89	// 一連番号
#define ID2080	90	// 送付不要
#define ID2081	91	// 所管
#define ID2082	92	// 整理番号

#define ID2100	93	// 課税期間 自年
#define ID2101	94	// 課税期間 自月
#define ID2102	95	// 課税期間 自日
#define ID2110	96	// 課税期間 至年
#define ID2111	97	// 課税期間 至月
#define ID2112	98	// 課税期間 至日

#define ID2120	99	// 確定等

#define ID2130	100	// 中間期間 自年
#define ID2131	101	// 中間期間 自月
#define ID2132	102	// 中間期間 自日
#define ID2140	103	// 中間期間 至年
#define ID2141	104	// 中間期間 至月
#define ID2142	105	// 中間期間 至日
