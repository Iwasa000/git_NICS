...
class CShinRefundKjn02 : public CRefundBaseDialog
{
	DECLARE_DYNAMIC(CShinRefundKjn02)

public:
	CShinRefundKjn02(CWnd* pParent = NULL);   // 標準コンストラクタ
	virtual ~CShinRefundKjn02();

// ダイアログ データ
	enum { IDD = IDD_SYZREFUND_KJ2 };
