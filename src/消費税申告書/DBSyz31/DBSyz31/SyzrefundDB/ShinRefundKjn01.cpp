	...
	: CRefundBaseDialog(CShinRefundKjn01::IDD, pParent)
{
	...
	diagKeyVec.emplace_back(IDC_ICSDIAGCTRL_MEISAI_K1);
	diagKeyVec.emplace_back(IDC_ICSDIAGCTRL_MEISAI_K2);
    //<---- 20230802 修正依頼162932
}
...
BEGIN_MESSAGE_MAP(CShinRefundKjn01, CRefundBaseDialog)
	...
	ON_BN_CLICKED(IDC_BUTTON_UP1, &CShinRefundKjn01::OnBnClickedButtonUp1)
	ON_BN_CLICKED(IDC_BUTTON_DOWN1, &CShinRefundKjn01::OnBnClickedButtonDown1)
	ON_BN_CLICKED(IDC_BUTTON_UP2, &CShinRefundKjn01::OnBnClickedButtonUp2)
	ON_BN_CLICKED(IDC_BUTTON_DOWN2, &CShinRefundKjn01::OnBnClickedButtonDown2)
END_MESSAGE_MAP()
...
BOOL CShinRefundKjn01::OnInitDialog()
{
	...
	SetDiagControlMap( m_Meisai1Diag.GetDlgCtrlID(), new CDiagCtlTorihiki(m_Meisai1Diag,KOJIN1_LINE_CNT,33,6), new CSyzDataSet(refundvol, KAZEIU_REC, KOJIN1_LINE_CNT, &refundvol.KPKuck,&refundvol.KPKusg) );
...
// １行上へ移動 (2020.02.07)
//----------------------------------------------------
void CShinRefundKjn01::OnBnClickedButtonUp1()
{
...
// １行下へ移動 (2020.02.07)
//----------------------------------------------------
void CShinRefundKjn01::OnBnClickedButtonDown1()
{
	// TODO: ここにコントロール通知ハンドラー コードを追加します。
	if (GetCurrentDiag() != &m_Meisai1Diag) {
		GetCurrentDiag()->SetPosition(GetCurrentDiag()->GetPosition());
...
// １行上へ移動 (2020.02.07)
//----------------------------------------------------
void CShinRefundKjn01::OnBnClickedButtonUp2()
{
	// TODO: ここにコントロール通知ハンドラー コードを追加します。
	if (GetCurrentDiag() != &m_Meisai2Diag) {
		GetCurrentDiag()->SetPosition(GetCurrentDiag()->GetPosition());
...
// １行下へ移動 (2020.02.07)
//----------------------------------------------------
void CShinRefundKjn01::OnBnClickedButtonDown2()
{
	// TODO: ここにコントロール通知ハンドラー コードを追加します。
	if (GetCurrentDiag() != &m_Meisai2Diag) {
		GetCurrentDiag()->SetPosition(GetCurrentDiag()->GetPosition());
