...
BEGIN_MESSAGE_MAP(CShinRefundKjn02, CRefundBaseDialog)
	...
	ON_BN_CLICKED(IDC_BUTTON_UP1, &CShinRefundKjn02::OnBnClickedButtonUp1)
	ON_BN_CLICKED(IDC_BUTTON_DOWN1, &CShinRefundKjn02::OnBnClickedButtonDown1)
	ON_BN_CLICKED(IDC_BUTTON_UP2, &CShinRefundKjn02::OnBnClickedButtonUp2)
	ON_BN_CLICKED(IDC_BUTTON_DOWN2, &CShinRefundKjn02::OnBnClickedButtonDown2)
END_MESSAGE_MAP()
...
BOOL CShinRefundKjn02::OnInitDialog()
{
	...
	SetDiagControlMap( m_Meisai3Diag.GetDlgCtrlID(), new CDiagCtlTorihiki(m_Meisai3Diag,KOJIN3_LINE_CNT,33,6), new CSyzDataSet(refundvol, TANAOR_REC, KOJIN3_LINE_CNT, &refundvol.KPTsck,&refundvol.KPTsgn) );
	SetDiagControlMap( m_Meisai4Diag.GetDlgCtrlID(), new CDiagCtlKotei(m_Meisai4Diag,KOJIN4_LINE_CNT,33,5),    new CSyzDataSet(refundvol, KOTEIS_REC, KOJIN4_LINE_CNT, &refundvol.KPKsck,&refundvol.KPKsgn) );
	...
	{	pair<int,CRect> next[] = { pair<int,CRect>( 57,CRect(NO_MOVE,NO_MOVE,NO_MOVE,33)), pair<int,CRect>( 58,CRect(NO_MOVE,NO_MOVE,NO_MOVE,34)),
								   pair<int,CRect>( 59,CRect(NO_MOVE,NO_MOVE,NO_MOVE,34)), pair<int,CRect>( 60,CRect(NO_MOVE,NO_MOVE,NO_MOVE,3)),
								   pair<int,CRect>( 61,CRect(NO_MOVE,NO_MOVE,NO_MOVE,36)), pair<int,CRect>( 62,CRect(NO_MOVE,NO_MOVE,3,37)), };
		pair<int,CRect> prev[] = { pair<int,CRect>( 33,CRect(NO_MOVE,57,NO_MOVE,NO_MOVE)), pair<int,CRect>( 34,CRect(NO_MOVE,58,NO_MOVE,NO_MOVE)),
								   pair<int,CRect>(  3,CRect(62,60,NO_MOVE,NO_MOVE)),	   pair<int,CRect>( 36,CRect(NO_MOVE,61,NO_MOVE,NO_MOVE)),
								   pair<int,CRect>( 37,CRect(NO_MOVE,62,NO_MOVE,NO_MOVE)),};
		SetCrossOver(m_Meisai3Diag,m_Meisai4Diag,next,prev);
	}
	
	{	pair<int,CRect> next[] = { pair<int,CRect>( 53,CRect(NO_MOVE,NO_MOVE,NO_MOVE,1)), pair<int,CRect>( 54,CRect(NO_MOVE,NO_MOVE,NO_MOVE,1)),
								   pair<int,CRect>( 55,CRect(NO_MOVE,NO_MOVE,NO_MOVE,1)), pair<int,CRect>( 56,CRect(NO_MOVE,NO_MOVE,NO_MOVE,1)),
								   pair<int,CRect>( 57,CRect(NO_MOVE,NO_MOVE,1,1)), };
		pair<int,CRect> prev[] = { pair<int,CRect>(  1,CRect(57,53,NO_MOVE,NO_MOVE)),     pair<int,CRect>(  6,CRect(57,53,NO_MOVE,NO_MOVE)),};
...
// １行上へ移動 (2020.02.07)
//----------------------------------------------------
void CShinRefundKjn02::OnBnClickedButtonUp1()
{
...
// １行下へ移動 (2020.02.07)
//----------------------------------------------------
void CShinRefundKjn02::OnBnClickedButtonDown1()
{
	// TODO: ここにコントロール通知ハンドラー コードを追加します。
	if (GetCurrentDiag() != &m_Meisai3Diag) {
		GetCurrentDiag()->SetPosition(GetCurrentDiag()->GetPosition());
...
// １行上へ移動 (2020.02.07)
//----------------------------------------------------
void CShinRefundKjn02::OnBnClickedButtonUp2()
{
	// TODO: ここにコントロール通知ハンドラー コードを追加します。
	if (GetCurrentDiag() != &m_Meisai4Diag) {
		GetCurrentDiag()->SetPosition(GetCurrentDiag()->GetPosition());
...
// １行下へ移動 (2020.02.07)
//----------------------------------------------------
void CShinRefundKjn02::OnBnClickedButtonDown2()
{
	// TODO: ここにコントロール通知ハンドラー コードを追加します。
	if (GetCurrentDiag() != &m_Meisai4Diag) {
		GetCurrentDiag()->SetPosition(GetCurrentDiag()->GetPosition());
