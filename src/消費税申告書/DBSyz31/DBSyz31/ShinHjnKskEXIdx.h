...
#define	DLG2KSS	45		// 6  貸倒れに係る税額(この請求前の金額)
#define	DLG2MDS	49		// 10 中間納付税額(この請求前の金額)
#define	DLG2LKS	54		// 地方消費税　譲渡割額　還付額(前)'14.07.22
#define	DLG2LNS	55		// 地方消費税　譲渡割額　納税額(前)'14.07.22
#define	DLG2VSE	56		// この請求前の額　最後
#define	DLG2VKS	59		// 更正の請求金額　最初
#define	DLG2KSE	64		// 6  貸倒れに係る税額(更正の請求金額)
#define	DLG2MDE	68		// 10 中間納付税額(更正の請求金額)
