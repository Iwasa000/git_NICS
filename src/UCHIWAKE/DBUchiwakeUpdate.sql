...
-- midori 171108 del -->
--		INSERT INTO uc_inf_ver VALUES (1, 2);
...
-- midori 171108 del -->
--		INSERT INTO uc_lst_item_sort VALUES (12, 3, 'Š“¾‚Ìí—Ş', 0, 1, 0, 'KnOrder ASC', 'KnOrder', NULL);
-- midori 171108 del <--
-- midori 171108 add -->
...
BEGIN
	...
	if( @uchiver = 2 ) begin
		...
		DELETE uc_inf_ver WHERE Seq=1
-- midori 171108 del -->
--		INSERT INTO uc_inf_ver VALUES (1, 3);
-- midori 171108 del <--
-- midori 171108 add -->
...
BEGIN
	...
	if( @uchiver = 3 ) begin
		...
		DELETE uc_inf_ver WHERE Seq=1
-- midori 171108 del -->
--		INSERT INTO uc_inf_ver VALUES (1, 4);
-- midori 171108 del <--
-- midori 171108 add -->
...
BEGIN
	...
	if( @uchiver = 4 ) begin
		...
		DELETE uc_inf_ver WHERE Seq=1
-- midori 171108 del -->
--		INSERT INTO uc_inf_ver VALUES (1, 5);
-- midori 171108 del <--
-- midori 171108 add -->
		INSERT INTO uc_inf_ver(Seq,Version) VALUES (1, 5);
-- midori 171108 add <--

		-- Še—l®‚ÉShowKeiZero’Ç‰Á
		...
		-- ’I‰µ‘YA”ƒŠ|‹à‚Ì“à–ó‘—“ŠO“o˜^ƒe[ƒuƒ‹‚Éo—ÍŒ`®‚Ì’Ç‰Á
...
BEGIN
	...
	if( @uchiver = 5 ) begin
		...
		DELETE uc_inf_ver WHERE Seq=1
-- midori 171108 del -->
--		INSERT INTO uc_inf_ver VALUES (1, 6);
-- midori 171108 del <--
-- midori 171108 add -->
...
BEGIN
		...
		DELETE uc_inf_ver WHERE Seq=2
-- midori 171108 del -->
--		INSERT INTO uc_inf_ver VALUES (1, 7);
--		INSERT INTO uc_inf_ver VALUES (2, 2);
-- midori 171108 del <--
-- midori 171108 add -->
...
-- midori UC_0006 del -->
---- midori 171108 del -->
----		INSERT INTO uc_inf_sub_omit VALUES( 16, 4, 'ZŠ', 0, 'V', 8 )
---- midori 171108 del <--
---- midori 171108 add -->
...
-- midori UC_0006 add <--
		...
		-- uc_lst_address ƒJƒi•¶šƒJƒ‰ƒ€’Ç‰Á
...
-- midori UC_0006 del -->
---- midori 171108 del -->
----		INSERT INTO uc_lst_item_sort VALUES(2, 8, '‰È–Ú', 1, 1, 1, 'KnOrder ASC', 'KnOrder', NULL)
---- midori 171108 del <--
---- midori 171108 add -->
--		INSERT INTO uc_lst_item_sort(FormSeq,ItemSeq,ItemName,FgPage,FgSykei,FgItem,OrderStr,FieldSykei,FieldSykei2)
...
-- midori UC_0006 del -->
--		-- uc_ren_main
--		UPDATE uc_inf_main set GeneralConstVal = 0, GeneralVar = 0

--		-- uc_lst_kamoku
--		UPDATE uc_lst_kamoku set KnKana = 'Ä³»ŞÖ·' WHERE KnSeq = 101
--		UPDATE uc_lst_kamoku set KnKana = 'ÌÂ³Ö·İ' WHERE KnSeq = 102
--		UPDATE uc_lst_kamoku set KnKana = 'Ã²·Ö·İ' WHERE KnSeq = 103
--		UPDATE uc_lst_kamoku set KnKana = 'Â³ÁÖ·İ' WHERE KnSeq = 104
--		UPDATE uc_lst_kamoku set KnKana = 'ÂĞÀÃÖ·' WHERE KnSeq = 105
--		UPDATE uc_lst_kamoku set KnKana = 'ÍŞÂÀŞİ' WHERE KnSeq = 106
--		UPDATE uc_lst_kamoku set KnKana = '¹Şİ·İ' WHERE KnSeq = 107
--		UPDATE uc_lst_kamoku set KnKana = '³¹ÄØÃ¶' WHERE KnSeq = 201
--		UPDATE uc_lst_kamoku set KnKana = '³Ø¶¹·İ' WHERE KnSeq = 301
--		UPDATE uc_lst_kamoku set KnKana = 'Ğ¼­³Æ­' WHERE KnSeq = 302
--		UPDATE uc_lst_kamoku set KnKana = '¶İ¾²º³' WHERE KnSeq = 303
--		UPDATE uc_lst_kamoku set KnKana = '¶ØÊŞ×²' WHERE KnSeq = 401
--		UPDATE uc_lst_kamoku set KnKana = 'Ï´ÜÀ¼·' WHERE KnSeq = 402
--		UPDATE uc_lst_kamoku set KnKana = 'Ï´ÊŞ×²' WHERE KnSeq = 403
--		UPDATE uc_lst_kamoku set KnKana = '¶¼Â¹·İ' WHERE KnSeq = 501
--		UPDATE uc_lst_kamoku set KnKana = '¼®³Ëİ' WHERE KnSeq = 601
--		UPDATE uc_lst_kamoku set KnKana = '¾²Ëİ' WHERE KnSeq = 602
--		UPDATE uc_lst_kamoku set KnKana = 'Êİ¾²Ëİ' WHERE KnSeq = 603
--		UPDATE uc_lst_kamoku set KnKana = '¼¶¶ØËİ' WHERE KnSeq = 604
--		UPDATE uc_lst_kamoku set KnKana = '¹Şİ»Ş²' WHERE KnSeq = 605
--		UPDATE uc_lst_kamoku set KnKana = 'Á®¿Ş³Ë' WHERE KnSeq = 606
--		UPDATE uc_lst_kamoku set KnKana = '»·Ş®³¸' WHERE KnSeq = 607
--		UPDATE uc_lst_kamoku set KnKana = 'Ì¸»İÌŞ' WHERE KnSeq = 608
--		UPDATE uc_lst_kamoku set KnKana = 'Ğ¾²º³' WHERE KnSeq = 609
--		UPDATE uc_lst_kamoku set KnKana = 'ÊŞ²ÊŞ²' WHERE KnSeq = 701
--		UPDATE uc_lst_kamoku set KnKana = 'Ïİ·' WHERE KnSeq = 702
--		UPDATE uc_lst_kamoku set KnKana = '¿ÉÀ' WHERE KnSeq = 703
--		UPDATE uc_lst_kamoku set KnKana = '¼Ê×²Ã¶' WHERE KnSeq = 901
--		UPDATE uc_lst_kamoku set KnKana = '¶²¶¹·İ' WHERE KnSeq = 1001
--		UPDATE uc_lst_kamoku set KnKana = 'ĞÊŞ×²·' WHERE KnSeq = 1002
--		UPDATE uc_lst_kamoku set KnKana = 'ĞÊŞ×²Ë' WHERE KnSeq = 1003
--		UPDATE uc_lst_kamoku set KnKana = 'º³¼ŞĞÊ' WHERE KnSeq = 1004
--		UPDATE uc_lst_kamoku set KnKana = '¶Ø³¹·İ' WHERE KnSeq = 1101
--		UPDATE uc_lst_kamoku set KnKana = 'Ï´³¹·İ' WHERE KnSeq = 1102
--		UPDATE uc_lst_kamoku set KnKana = '±½Ş¶Ø·' WHERE KnSeq = 1103
--		UPDATE uc_lst_kamoku set KnKana = '·­³' WHERE KnSeq = 1201
--		UPDATE uc_lst_kamoku set KnKana = 'À²' WHERE KnSeq = 1202
--		UPDATE uc_lst_kamoku set KnKana = 'Î³' WHERE KnSeq = 1203
--		UPDATE uc_lst_kamoku set KnKana = 'Ø' WHERE KnSeq = 1204
--		UPDATE uc_lst_kamoku set KnKana = 'Ê²' WHERE KnSeq = 1205
--		UPDATE uc_lst_kamoku set KnKana = 'Ë' WHERE KnSeq = 1206
--		UPDATE uc_lst_kamoku set KnKana = 'Àİ·¶Ø²' WHERE KnSeq = 1301
--		UPDATE uc_lst_kamoku set KnKana = 'Á®³·¶Ø' WHERE KnSeq = 1302
--		UPDATE uc_lst_kamoku set KnKana = '³Ø±¹Ş' WHERE KnSeq = 1401
--		UPDATE uc_lst_kamoku set KnKana = 'Á­³¶²Ã' WHERE KnSeq = 1402
--		UPDATE uc_lst_kamoku set KnKana = 'Ô¸²İÎ³' WHERE KnSeq = 1701
--		UPDATE uc_lst_kamoku set KnKana = '¼Ş­³·Ş' WHERE KnSeq = 1702
--		UPDATE uc_lst_kamoku set KnKana = '¼Ş­³·Ş' WHERE KnSeq = 1703
--		UPDATE uc_lst_kamoku set KnKana = 'ÁÀŞ²' WHERE KnSeq = 1801
--		UPDATE uc_lst_kamoku set KnKana = 'ÔÁİ' WHERE KnSeq = 1802
--		UPDATE uc_lst_kamoku set KnKana = '»Ş¯¼­³' WHERE KnSeq = 2101
--		UPDATE uc_lst_kamoku set KnKana = '³¹ÄØØ¿' WHERE KnSeq = 2102
--		UPDATE uc_lst_kamoku set KnKana = '³¹ÄØÊ²' WHERE KnSeq = 2103
--		UPDATE uc_lst_kamoku set KnKana = 'ºÃ²¼»İ' WHERE KnSeq = 2104
--		UPDATE uc_lst_kamoku set KnKana = '»Ş¯¿İ¼' WHERE KnSeq = 2201
--		UPDATE uc_lst_kamoku set KnKana = '¼Ê×²Ø¿' WHERE KnSeq = 2202
--		UPDATE uc_lst_kamoku set KnKana = '¶¼ÀŞµÚ' WHERE KnSeq = 2203
--		UPDATE uc_lst_kamoku set KnKana = 'ºÃ²¼»İ' WHERE KnSeq = 2204
		
---- midori 171108 del -->
----		INSERT INTO uc_lst_kamoku VALUES (202, 2, 2, NULL, 'Š„ˆøèŒ`', 0, 1, 'ÜØËŞ·Ã')
---- midori 171108 del <--
---- midori 171108 add -->
...
BEGIN
		...
		if( @uchiver = 7 ) begin
			...
			-- uc_lst_kamoku ‰È–Ú–ˆ‚ÌˆêŠ‡‹àŠzƒJƒ‰ƒ€‚ğ’Ç‰Á
			...
			-- uc_lst_address æˆøæ–ˆ‚ÌˆêŠ‡‹àŠzƒJƒ‰ƒ€‚ğ’Ç‰Á
...
-- midori UC_0006 del -->
---- midori 171108 del -->
--			--INSERT INTO uc_inf_sub VALUES (106, 17, 6, 0, 28, '‡P', '|‚U',   '‚»‚Ì‘¼‰È–Ú‚Ì“à–ó‘‡@|‚U',    NULL, '‚»‚Ì‘¼‰È–Ú‚Ì“à–ó‘‡@|‚U',   NULL, '‚»‚Ì‘¼‰È–Ú‚Ì“à–ó‘‡@|‚U',   0, 0, 0, 0, '¬Œv', '’†Œv', 1, 2, 1, 0, 0, 0, 1, 1, 0, 2, 0, 0, 1, 1, 1, 0, 0, 0);
--			--INSERT INTO uc_inf_sub VALUES (107, 17, 7, 0, 29, '‡P', '|‚V',   '‚»‚Ì‘¼‰È–Ú‚Ì“à–ó‘‡@|‚V',    NULL, '‚»‚Ì‘¼‰È–Ú‚Ì“à–ó‘‡@|‚V',   NULL, '‚»‚Ì‘¼‰È–Ú‚Ì“à–ó‘‡@|‚V',   0, 0, 0, 0, '¬Œv', '’†Œv', 1, 2, 1, 0, 0, 0, 1, 1, 0, 2, 0, 0, 1, 1, 1, 0, 0, 0);
--			--INSERT INTO uc_inf_sub VALUES (108, 17, 8, 0, 30, '‡P', '|‚W',   '‚»‚Ì‘¼‰È–Ú‚Ì“à–ó‘‡@|‚W',    NULL, '‚»‚Ì‘¼‰È–Ú‚Ì“à–ó‘‡@|‚W',   NULL, '‚»‚Ì‘¼‰È–Ú‚Ì“à–ó‘‡@|‚W',   0, 0, 0, 0, '¬Œv', '’†Œv', 1, 2, 1, 0, 0, 0, 1, 1, 0, 2, 0, 0, 1, 1, 1, 0, 0, 0);
--			--INSERT INTO uc_inf_sub VALUES (109, 17, 9, 0, 31, '‡P', '|‚X',   '‚»‚Ì‘¼‰È–Ú‚Ì“à–ó‘‡@|‚X',    NULL, '‚»‚Ì‘¼‰È–Ú‚Ì“à–ó‘‡@|‚X',   NULL, '‚»‚Ì‘¼‰È–Ú‚Ì“à–ó‘‡@|‚X',   0, 0, 0, 0, '¬Œv', '’†Œv', 1, 2, 1, 0, 0, 0, 1, 1, 0, 2, 0, 0, 1, 1, 1, 0, 0, 0);
--			--INSERT INTO uc_inf_sub VALUES (110, 17,10, 0, 32, '‡P', '|‚P‚O', '‚»‚Ì‘¼‰È–Ú‚Ì“à–ó‘‡@|‚P‚O',  NULL, '‚»‚Ì‘¼‰È–Ú‚Ì“à–ó‘‡@|‚P‚O', NULL, '‚»‚Ì‘¼‰È–Ú‚Ì“à–ó‘‡@|‚P‚O', 0, 0, 0, 0, '¬Œv', '’†Œv', 1, 2, 1, 0, 0, 0, 1, 1, 0, 2, 0, 0, 1, 1, 1, 0, 0, 0);
--			--INSERT INTO uc_inf_sub VALUES (111, 17,11, 0, 33, '‡P', '|‚P‚P', '‚»‚Ì‘¼‰È–Ú‚Ì“à–ó‘‡@|‚P‚P', NULL, '‚»‚Ì‘¼‰È–Ú‚Ì“à–ó‘‡@|‚P‚P', NULL, '‚»‚Ì‘¼‰È–Ú‚Ì“à–ó‘‡@|‚P‚P', 0, 0, 0, 0, '¬Œv', '’†Œv', 1, 2, 1, 0, 0, 0, 1, 1, 0, 2, 0, 0, 1, 1, 1, 0, 0, 0);
--			--INSERT INTO uc_inf_sub VALUES (112, 17,12, 0, 34, '‡P', '|‚P‚Q', '‚»‚Ì‘¼‰È–Ú‚Ì“à–ó‘‡@|‚P‚Q',  NULL, '‚»‚Ì‘¼‰È–Ú‚Ì“à–ó‘‡@|‚P‚Q', NULL, '‚»‚Ì‘¼‰È–Ú‚Ì“à–ó‘‡@|‚P‚Q', 0, 0, 0, 0, '¬Œv', '’†Œv', 1, 2, 1, 0, 0, 0, 1, 1, 0, 2, 0, 0, 1, 1, 1, 0, 0, 0);
--			--INSERT INTO uc_inf_sub VALUES (113, 17,13, 0, 35, '‡P', '|‚P‚R', '‚»‚Ì‘¼‰È–Ú‚Ì“à–ó‘‡@|‚P‚R',  NULL, '‚»‚Ì‘¼‰È–Ú‚Ì“à–ó‘‡@|‚P‚R', NULL, '‚»‚Ì‘¼‰È–Ú‚Ì“à–ó‘‡@|‚P‚R', 0, 0, 0, 0, '¬Œv', '’†Œv', 1, 2, 1, 0, 0, 0, 1, 1, 0, 2, 0, 0, 1, 1, 1, 0, 0, 0);
--			--INSERT INTO uc_inf_sub VALUES (114, 17,14, 0, 36, '‡P', '|‚P‚S', '‚»‚Ì‘¼‰È–Ú‚Ì“à–ó‘‡@|‚P‚S',  NULL, '‚»‚Ì‘¼‰È–Ú‚Ì“à–ó‘‡@|‚P‚S', NULL, '‚»‚Ì‘¼‰È–Ú‚Ì“à–ó‘‡@|‚P‚S', 0, 0, 0, 0, '¬Œv', '’†Œv', 1, 2, 1, 0, 0, 0, 1, 1, 0, 2, 0, 0, 1, 1, 1, 0, 0, 0);
--			--INSERT INTO uc_inf_sub VALUES (115, 17,15, 0, 37, '‡P', '|‚P‚T', '‚»‚Ì‘¼‰È–Ú‚Ì“à–ó‘‡@|‚P‚T',  NULL, '‚»‚Ì‘¼‰È–Ú‚Ì“à–ó‘‡@|‚P‚T', NULL, '‚»‚Ì‘¼‰È–Ú‚Ì“à–ó‘‡@|‚P‚T', 0, 0, 0, 0, '¬Œv', '’†Œv', 1, 2, 1, 0, 0, 0, 1, 1, 0, 2, 0, 0, 1, 1, 1, 0, 0, 0);
--			--INSERT INTO uc_inf_sub VALUES (116, 17,16, 0, 38, '‡P', '|‚P‚U', '‚»‚Ì‘¼‰È–Ú‚Ì“à–ó‘‡@|‚P‚U',  NULL, '‚»‚Ì‘¼‰È–Ú‚Ì“à–ó‘‡@|‚P‚U', NULL, '‚»‚Ì‘¼‰È–Ú‚Ì“à–ó‘‡@|‚P‚U', 0, 0, 0, 0, '¬Œv', '’†Œv', 1, 2, 1, 0, 0, 0, 1, 1, 0, 2, 0, 0, 1, 1, 1, 0, 0, 0);
--			--INSERT INTO uc_inf_sub VALUES (117, 17,17, 0, 39, '‡P', '|‚P‚V', '‚»‚Ì‘¼‰È–Ú‚Ì“à–ó‘‡@|‚P‚V',  NULL, '‚»‚Ì‘¼‰È–Ú‚Ì“à–ó‘‡@|‚P‚V', NULL, '‚»‚Ì‘¼‰È–Ú‚Ì“à–ó‘‡@|‚P‚V', 0, 0, 0, 0, '¬Œv', '’†Œv', 1, 2, 1, 0, 0, 0, 1, 1, 0, 2, 0, 0, 1, 1, 1, 0, 0, 0);
--			--INSERT INTO uc_inf_sub VALUES (118, 17,18, 0, 40, '‡P', '|‚P‚W', '‚»‚Ì‘¼‰È–Ú‚Ì“à–ó‘‡@|‚P‚W',  NULL, '‚»‚Ì‘¼‰È–Ú‚Ì“à–ó‘‡@|‚P‚W', NULL, '‚»‚Ì‘¼‰È–Ú‚Ì“à–ó‘‡@|‚P‚W', 0, 0, 0, 0, '¬Œv', '’†Œv', 1, 2, 1, 0, 0, 0, 1, 1, 0, 2, 0, 0, 1, 1, 1, 0, 0, 0);
--			--INSERT INTO uc_inf_sub VALUES (119, 17,19, 0, 41, '‡P', '|‚P‚X', '‚»‚Ì‘¼‰È–Ú‚Ì“à–ó‘‡@|‚P‚X',  NULL, '‚»‚Ì‘¼‰È–Ú‚Ì“à–ó‘‡@|‚P‚X', NULL, '‚»‚Ì‘¼‰È–Ú‚Ì“à–ó‘‡@|‚P‚X', 0, 0, 0, 0, '¬Œv', '’†Œv', 1, 2, 1, 0, 0, 0, 1, 1, 0, 2, 0, 0, 1, 1, 1, 0, 0, 0);
--			--INSERT INTO uc_inf_sub VALUES (120, 17,20, 0, 42, '‡P', '|‚Q‚O', '‚»‚Ì‘¼‰È–Ú‚Ì“à–ó‘‡@|‚Q‚O',  NULL, '‚»‚Ì‘¼‰È–Ú‚Ì“à–ó‘‡@|‚Q‚O', NULL, '‚»‚Ì‘¼‰È–Ú‚Ì“à–ó‘‡@|‚Q‚O', 0, 0, 0, 0, '¬Œv', '’†Œv', 1, 2, 1, 0, 0, 0, 1, 1, 0, 2, 0, 0, 1, 1, 1, 0, 0, 0);

--			--INSERT INTO uc_inf_sub VALUES (206, 18, 6, 0, 48, '‡Q', '|‚U',   '‚»‚Ì‘¼‰È–Ú‚Ì“à–ó‘‡A|‚U',    NULL, '‚»‚Ì‘¼‰È–Ú‚Ì“à–ó‘‡A|‚U',   NULL, '‚»‚Ì‘¼‰È–Ú‚Ì“à–ó‘‡A|‚U',   0, 0, 0, 0, '¬Œv', '’†Œv', 1, 2, 1, 0, 0, 0, 1, 1, 0, 2, 0, 0, 1, 1, 1, 0, 0, 0);
--			--INSERT INTO uc_inf_sub VALUES (207, 18, 7, 0, 49, '‡Q', '|‚V',   '‚»‚Ì‘¼‰È–Ú‚Ì“à–ó‘‡A|‚V',    NULL, '‚»‚Ì‘¼‰È–Ú‚Ì“à–ó‘‡A|‚V',   NULL, '‚»‚Ì‘¼‰È–Ú‚Ì“à–ó‘‡A|‚V',   0, 0, 0, 0, '¬Œv', '’†Œv', 1, 2, 1, 0, 0, 0, 1, 1, 0, 2, 0, 0, 1, 1, 1, 0, 0, 0);
--			--INSERT INTO uc_inf_sub VALUES (208, 18, 8, 0, 50, '‡Q', '|‚W',   '‚»‚Ì‘¼‰È–Ú‚Ì“à–ó‘‡A|‚W',    NULL, '‚»‚Ì‘¼‰È–Ú‚Ì“à–ó‘‡A|‚W',   NULL, '‚»‚Ì‘¼‰È–Ú‚Ì“à–ó‘‡A|‚W',   0, 0, 0, 0, '¬Œv', '’†Œv', 1, 2, 1, 0, 0, 0, 1, 1, 0, 2, 0, 0, 1, 1, 1, 0, 0, 0);
--			--INSERT INTO uc_inf_sub VALUES (209, 18, 9, 0, 51, '‡Q', '|‚X',   '‚»‚Ì‘¼‰È–Ú‚Ì“à–ó‘‡A|‚X',    NULL, '‚»‚Ì‘¼‰È–Ú‚Ì“à–ó‘‡A|‚X',   NULL, '‚»‚Ì‘¼‰È–Ú‚Ì“à–ó‘‡A|‚X',   0, 0, 0, 0, '¬Œv', '’†Œv', 1, 2, 1, 0, 0, 0, 1, 1, 0, 2, 0, 0, 1, 1, 1, 0, 0, 0);
--			--INSERT INTO uc_inf_sub VALUES (210, 18,10, 0, 52, '‡Q', '|‚P‚O', '‚»‚Ì‘¼‰È–Ú‚Ì“à–ó‘‡A|‚P‚O',  NULL, '‚»‚Ì‘¼‰È–Ú‚Ì“à–ó‘‡A|‚P‚O', NULL, '‚»‚Ì‘¼‰È–Ú‚Ì“à–ó‘‡A|‚P‚O', 0, 0, 0, 0, '¬Œv', '’†Œv', 1, 2, 1, 0, 0, 0, 1, 1, 0, 2, 0, 0, 1, 1, 1, 0, 0, 0);
--			--INSERT INTO uc_inf_sub VALUES (211, 18,11, 0, 53, '‡Q', '|‚P‚P', '‚»‚Ì‘¼‰È–Ú‚Ì“à–ó‘‡A|‚P‚P', NULL, '‚»‚Ì‘¼‰È–Ú‚Ì“à–ó‘‡A|‚P‚P', NULL, '‚»‚Ì‘¼‰È–Ú‚Ì“à–ó‘‡A|‚P‚P', 0, 0, 0, 0, '¬Œv', '’†Œv', 1, 2, 1, 0, 0, 0, 1, 1, 0, 2, 0, 0, 1, 1, 1, 0, 0, 0);
--			--INSERT INTO uc_inf_sub VALUES (212, 18,12, 0, 54, '‡Q', '|‚P‚Q', '‚»‚Ì‘¼‰È–Ú‚Ì“à–ó‘‡A|‚P‚Q',  NULL, '‚»‚Ì‘¼‰È–Ú‚Ì“à–ó‘‡A|‚P‚Q', NULL, '‚»‚Ì‘¼‰È–Ú‚Ì“à–ó‘‡A|‚P‚Q', 0, 0, 0, 0, '¬Œv', '’†Œv', 1, 2, 1, 0, 0, 0, 1, 1, 0, 2, 0, 0, 1, 1, 1, 0, 0, 0);
--			--INSERT INTO uc_inf_sub VALUES (213, 18,13, 0, 55, '‡Q', '|‚P‚R', '‚»‚Ì‘¼‰È–Ú‚Ì“à–ó‘‡A|‚P‚R',  NULL, '‚»‚Ì‘¼‰È–Ú‚Ì“à–ó‘‡A|‚P‚R', NULL, '‚»‚Ì‘¼‰È–Ú‚Ì“à–ó‘‡A|‚P‚R', 0, 0, 0, 0, '¬Œv', '’†Œv', 1, 2, 1, 0, 0, 0, 1, 1, 0, 2, 0, 0, 1, 1, 1, 0, 0, 0);
--			--INSERT INTO uc_inf_sub VALUES (214, 18,14, 0, 56, '‡Q', '|‚P‚S', '‚»‚Ì‘¼‰È–Ú‚Ì“à–ó‘‡A|‚P‚S',  NULL, '‚»‚Ì‘¼‰È–Ú‚Ì“à–ó‘‡A|‚P‚S', NULL, '‚»‚Ì‘¼‰È–Ú‚Ì“à–ó‘‡A|‚P‚S', 0, 0, 0, 0, '¬Œv', '’†Œv', 1, 2, 1, 0, 0, 0, 1, 1, 0, 2, 0, 0, 1, 1, 1, 0, 0, 0);
--			--INSERT INTO uc_inf_sub VALUES (215, 18,15, 0, 57, '‡Q', '|‚P‚T', '‚»‚Ì‘¼‰È–Ú‚Ì“à–ó‘‡A|‚P‚T',  NULL, '‚»‚Ì‘¼‰È–Ú‚Ì“à–ó‘‡A|‚P‚T', NULL, '‚»‚Ì‘¼‰È–Ú‚Ì“à–ó‘‡A|‚P‚T', 0, 0, 0, 0, '¬Œv', '’†Œv', 1, 2, 1, 0, 0, 0, 1, 1, 0, 2, 0, 0, 1, 1, 1, 0, 0, 0);
--			--INSERT INTO uc_inf_sub VALUES (216, 18,16, 0, 58, '‡Q', '|‚P‚U', '‚»‚Ì‘¼‰È–Ú‚Ì“à–ó‘‡A|‚P‚U',  NULL, '‚»‚Ì‘¼‰È–Ú‚Ì“à–ó‘‡A|‚P‚U', NULL, '‚»‚Ì‘¼‰È–Ú‚Ì“à–ó‘‡A|‚P‚U', 0, 0, 0, 0, '¬Œv', '’†Œv', 1, 2, 1, 0, 0, 0, 1, 1, 0, 2, 0, 0, 1, 1, 1, 0, 0, 0);
--			--INSERT INTO uc_inf_sub VALUES (217, 18,17, 0, 59, '‡Q', '|‚P‚V', '‚»‚Ì‘¼‰È–Ú‚Ì“à–ó‘‡A|‚P‚V',  NULL, '‚»‚Ì‘¼‰È–Ú‚Ì“à–ó‘‡A|‚P‚V', NULL, '‚»‚Ì‘¼‰È–Ú‚Ì“à–ó‘‡A|‚P‚V', 0, 0, 0, 0, '¬Œv', '’†Œv', 1, 2, 1, 0, 0, 0, 1, 1, 0, 2, 0, 0, 1, 1, 1, 0, 0, 0);
--			--INSERT INTO uc_inf_sub VALUES (218, 18,18, 0, 60, '‡Q', '|‚P‚W', '‚»‚Ì‘¼‰È–Ú‚Ì“à–ó‘‡A|‚P‚W',  NULL, '‚»‚Ì‘¼‰È–Ú‚Ì“à–ó‘‡A|‚P‚W', NULL, '‚»‚Ì‘¼‰È–Ú‚Ì“à–ó‘‡A|‚P‚W', 0, 0, 0, 0, '¬Œv', '’†Œv', 1, 2, 1, 0, 0, 0, 1, 1, 0, 2, 0, 0, 1, 1, 1, 0, 0, 0);
--			--INSERT INTO uc_inf_sub VALUES (219, 18,19, 0, 61, '‡Q', '|‚P‚X', '‚»‚Ì‘¼‰È–Ú‚Ì“à–ó‘‡A|‚P‚X',  NULL, '‚»‚Ì‘¼‰È–Ú‚Ì“à–ó‘‡A|‚P‚X', NULL, '‚»‚Ì‘¼‰È–Ú‚Ì“à–ó‘‡A|‚P‚X', 0, 0, 0, 0, '¬Œv', '’†Œv', 1, 2, 1, 0, 0, 0, 1, 1, 0, 2, 0, 0, 1, 1, 1, 0, 0, 0);
--			--INSERT INTO uc_inf_sub VALUES (220, 18,20, 0, 62, '‡Q', '|‚Q‚O', '‚»‚Ì‘¼‰È–Ú‚Ì“à–ó‘‡A|‚Q‚O',  NULL, '‚»‚Ì‘¼‰È–Ú‚Ì“à–ó‘‡A|‚Q‚O', NULL, '‚»‚Ì‘¼‰È–Ú‚Ì“à–ó‘‡A|‚Q‚O', 0, 0, 0, 0, '¬Œv', '’†Œv', 1, 2, 1, 0, 0, 0, 1, 1, 0, 2, 0, 0, 1, 1, 1, 0, 0, 0);
...
--			---- uc_inf_sub_omit
--			--INSERT INTO uc_inf_sub_omit VALUES (106, 1, '‰È–Ú', 0, 'V', 8);
--			--INSERT INTO uc_inf_sub_omit VALUES (106, 2, '‘Šèæi–¼Ìj', 0, 'V', 8);
--			--INSERT INTO uc_inf_sub_omit VALUES (106, 3, '‘ŠèæiŠİ’nj', 0, 'V', 8);
--			--INSERT INTO uc_inf_sub_omit VALUES (107, 1, '‰È–Ú', 0, 'V', 8);
--			--INSERT INTO uc_inf_sub_omit VALUES (107, 2, '‘Šèæi–¼Ìj', 0, 'V', 8);
--			--INSERT INTO uc_inf_sub_omit VALUES (107, 3, '‘ŠèæiŠİ’nj', 0, 'V', 8);
--			--INSERT INTO uc_inf_sub_omit VALUES (108, 1, '‰È–Ú', 0, 'V', 8);
--			--INSERT INTO uc_inf_sub_omit VALUES (108, 2, '‘Šèæi–¼Ìj', 0, 'V', 8);
--			--INSERT INTO uc_inf_sub_omit VALUES (108, 3, '‘ŠèæiŠİ’nj', 0, 'V', 8);
--			--INSERT INTO uc_inf_sub_omit VALUES (109, 1, '‰È–Ú', 0, 'V', 8);
--			--INSERT INTO uc_inf_sub_omit VALUES (109, 2, '‘Šèæi–¼Ìj', 0, 'V', 8);
--			--INSERT INTO uc_inf_sub_omit VALUES (109, 3, '‘ŠèæiŠİ’nj', 0, 'V', 8);
--			--INSERT INTO uc_inf_sub_omit VALUES (110, 1, '‰È–Ú', 0, 'V', 8);
--			--INSERT INTO uc_inf_sub_omit VALUES (110, 2, '‘Šèæi–¼Ìj', 0, 'V', 8);
--			--INSERT INTO uc_inf_sub_omit VALUES (110, 3, '‘ŠèæiŠİ’nj', 0, 'V', 8);
--			--INSERT INTO uc_inf_sub_omit VALUES (111, 1, '‰È–Ú', 0, 'V', 8);
--			--INSERT INTO uc_inf_sub_omit VALUES (111, 2, '‘Šèæi–¼Ìj', 0, 'V', 8);
--			--INSERT INTO uc_inf_sub_omit VALUES (111, 3, '‘ŠèæiŠİ’nj', 0, 'V', 8);
--			--INSERT INTO uc_inf_sub_omit VALUES (112, 1, '‰È–Ú', 0, 'V', 8);
--			--INSERT INTO uc_inf_sub_omit VALUES (112, 2, '‘Šèæi–¼Ìj', 0, 'V', 8);
--			--INSERT INTO uc_inf_sub_omit VALUES (112, 3, '‘ŠèæiŠİ’nj', 0, 'V', 8);
--			--INSERT INTO uc_inf_sub_omit VALUES (113, 1, '‰È–Ú', 0, 'V', 8);
--			--INSERT INTO uc_inf_sub_omit VALUES (113, 2, '‘Šèæi–¼Ìj', 0, 'V', 8);
--			--INSERT INTO uc_inf_sub_omit VALUES (113, 3, '‘ŠèæiŠİ’nj', 0, 'V', 8);
--			--INSERT INTO uc_inf_sub_omit VALUES (114, 1, '‰È–Ú', 0, 'V', 8);
--			--INSERT INTO uc_inf_sub_omit VALUES (114, 2, '‘Šèæi–¼Ìj', 0, 'V', 8);
--			--INSERT INTO uc_inf_sub_omit VALUES (114, 3, '‘ŠèæiŠİ’nj', 0, 'V', 8);
--			--INSERT INTO uc_inf_sub_omit VALUES (115, 1, '‰È–Ú', 0, 'V', 8);
--			--INSERT INTO uc_inf_sub_omit VALUES (115, 2, '‘Šèæi–¼Ìj', 0, 'V', 8);
--			--INSERT INTO uc_inf_sub_omit VALUES (115, 3, '‘ŠèæiŠİ’nj', 0, 'V', 8);
--			--INSERT INTO uc_inf_sub_omit VALUES (116, 1, '‰È–Ú', 0, 'V', 8);
--			--INSERT INTO uc_inf_sub_omit VALUES (116, 2, '‘Šèæi–¼Ìj', 0, 'V', 8);
--			--INSERT INTO uc_inf_sub_omit VALUES (116, 3, '‘ŠèæiŠİ’nj', 0, 'V', 8);
--			--INSERT INTO uc_inf_sub_omit VALUES (117, 1, '‰È–Ú', 0, 'V', 8);
--			--INSERT INTO uc_inf_sub_omit VALUES (117, 2, '‘Šèæi–¼Ìj', 0, 'V', 8);
--			--INSERT INTO uc_inf_sub_omit VALUES (117, 3, '‘ŠèæiŠİ’nj', 0, 'V', 8);
--			--INSERT INTO uc_inf_sub_omit VALUES (118, 1, '‰È–Ú', 0, 'V', 8);
--			--INSERT INTO uc_inf_sub_omit VALUES (118, 2, '‘Šèæi–¼Ìj', 0, 'V', 8);
--			--INSERT INTO uc_inf_sub_omit VALUES (118, 3, '‘ŠèæiŠİ’nj', 0, 'V', 8);
--			--INSERT INTO uc_inf_sub_omit VALUES (119, 1, '‰È–Ú', 0, 'V', 8);
--			--INSERT INTO uc_inf_sub_omit VALUES (119, 2, '‘Šèæi–¼Ìj', 0, 'V', 8);
--			--INSERT INTO uc_inf_sub_omit VALUES (119, 3, '‘ŠèæiŠİ’nj', 0, 'V', 8);
--			--INSERT INTO uc_inf_sub_omit VALUES (120, 1, '‰È–Ú', 0, 'V', 8);
--			--INSERT INTO uc_inf_sub_omit VALUES (120, 2, '‘Šèæi–¼Ìj', 0, 'V', 8);
--			--INSERT INTO uc_inf_sub_omit VALUES (120, 3, '‘ŠèæiŠİ’nj', 0, 'V', 8);

--			--INSERT INTO uc_inf_sub_omit VALUES (206, 1, '‰È–Ú', 0, 'V', 8);
--			--INSERT INTO uc_inf_sub_omit VALUES (207, 1, '‰È–Ú', 0, 'V', 8);
--			--INSERT INTO uc_inf_sub_omit VALUES (208, 1, '‰È–Ú', 0, 'V', 8);
--			--INSERT INTO uc_inf_sub_omit VALUES (209, 1, '‰È–Ú', 0, 'V', 8);
--			--INSERT INTO uc_inf_sub_omit VALUES (210, 1, '‰È–Ú', 0, 'V', 8);
--			--INSERT INTO uc_inf_sub_omit VALUES (211, 1, '‰È–Ú', 0, 'V', 8);
--			--INSERT INTO uc_inf_sub_omit VALUES (212, 1, '‰È–Ú', 0, 'V', 8);
--			--INSERT INTO uc_inf_sub_omit VALUES (213, 1, '‰È–Ú', 0, 'V', 8);
--			--INSERT INTO uc_inf_sub_omit VALUES (214, 1, '‰È–Ú', 0, 'V', 8);
--			--INSERT INTO uc_inf_sub_omit VALUES (215, 1, '‰È–Ú', 0, 'V', 8);
--			--INSERT INTO uc_inf_sub_omit VALUES (216, 1, '‰È–Ú', 0, 'V', 8);
--			--INSERT INTO uc_inf_sub_omit VALUES (217, 1, '‰È–Ú', 0, 'V', 8);
--			--INSERT INTO uc_inf_sub_omit VALUES (218, 1, '‰È–Ú', 0, 'V', 8);
--			--INSERT INTO uc_inf_sub_omit VALUES (219, 1, '‰È–Ú', 0, 'V', 8);
--			--INSERT INTO uc_inf_sub_omit VALUES (220, 1, '‰È–Ú', 0, 'V', 8);
			
--			---- uc_lst_item_sort
--			--INSERT INTO uc_lst_item_sort VALUES (106, 0, '‚È‚µ', 0, 0, 0, NULL, NULL, NULL);
--			--INSERT INTO uc_lst_item_sort VALUES (106, 1, '‰È–Ú', 1, 1, 1, 'KnOrder ASC', 'KnOrder', NULL);
--			--INSERT INTO uc_lst_item_sort VALUES (106, 2, '‘Šèæi–¼Ìj', 0, 0, 0, '(AdName1 + AdName2) COLLATE Japanese_CS_AS_KS_WS ASC, AdName1 COLLATE Japanese_CS_AS_KS_WS ASC, AdName2 COLLATE Japanese_CS_AS_KS_WS ASC', NULL, NULL);
--			--INSERT INTO uc_lst_item_sort VALUES (106, 3, 'Šú––Œ»İ‚i‘å‚«‚¢‡j', 0, 0, 0, 'Val DESC', NULL, NULL);
--			--INSERT INTO uc_lst_item_sort VALUES (106, 4, 'Šú––Œ»İ‚i¬‚³‚¢‡j', 0, 0, 0, 'Val ASC', NULL, NULL);
--			--INSERT INTO uc_lst_item_sort VALUES (107, 0, '‚È‚µ', 0, 0, 0, NULL, NULL, NULL);
--			--INSERT INTO uc_lst_item_sort VALUES (107, 1, '‰È–Ú', 1, 1, 1, 'KnOrder ASC', 'KnOrder', NULL);
--			--INSERT INTO uc_lst_item_sort VALUES (107, 2, '‘Šèæi–¼Ìj', 0, 0, 0, '(AdName1 + AdName2) COLLATE Japanese_CS_AS_KS_WS ASC, AdName1 COLLATE Japanese_CS_AS_KS_WS ASC, AdName2 COLLATE Japanese_CS_AS_KS_WS ASC', NULL, NULL);
--			--INSERT INTO uc_lst_item_sort VALUES (107, 3, 'Šú––Œ»İ‚i‘å‚«‚¢‡j', 0, 0, 0, 'Val DESC', NULL, NULL);
--			--INSERT INTO uc_lst_item_sort VALUES (107, 4, 'Šú––Œ»İ‚i¬‚³‚¢‡j', 0, 0, 0, 'Val ASC', NULL, NULL);
--			--INSERT INTO uc_lst_item_sort VALUES (108, 0, '‚È‚µ', 0, 0, 0, NULL, NULL, NULL);
--			--INSERT INTO uc_lst_item_sort VALUES (108, 1, '‰È–Ú', 1, 1, 1, 'KnOrder ASC', 'KnOrder', NULL);
--			--INSERT INTO uc_lst_item_sort VALUES (108, 2, '‘Šèæi–¼Ìj', 0, 0, 0, '(AdName1 + AdName2) COLLATE Japanese_CS_AS_KS_WS ASC, AdName1 COLLATE Japanese_CS_AS_KS_WS ASC, AdName2 COLLATE Japanese_CS_AS_KS_WS ASC', NULL, NULL);
--			--INSERT INTO uc_lst_item_sort VALUES (108, 3, 'Šú––Œ»İ‚i‘å‚«‚¢‡j', 0, 0, 0, 'Val DESC', NULL, NULL);
--			--INSERT INTO uc_lst_item_sort VALUES (108, 4, 'Šú––Œ»İ‚i¬‚³‚¢‡j', 0, 0, 0, 'Val ASC', NULL, NULL);
--			--INSERT INTO uc_lst_item_sort VALUES (109, 0, '‚È‚µ', 0, 0, 0, NULL, NULL, NULL);
--			--INSERT INTO uc_lst_item_sort VALUES (109, 1, '‰È–Ú', 1, 1, 1, 'KnOrder ASC', 'KnOrder', NULL);
--			--INSERT INTO uc_lst_item_sort VALUES (109, 2, '‘Šèæi–¼Ìj', 0, 0, 0, '(AdName1 + AdName2) COLLATE Japanese_CS_AS_KS_WS ASC, AdName1 COLLATE Japanese_CS_AS_KS_WS ASC, AdName2 COLLATE Japanese_CS_AS_KS_WS ASC', NULL, NULL);
--			--INSERT INTO uc_lst_item_sort VALUES (109, 3, 'Šú––Œ»İ‚i‘å‚«‚¢‡j', 0, 0, 0, 'Val DESC', NULL, NULL);
--			--INSERT INTO uc_lst_item_sort VALUES (109, 4, 'Šú––Œ»İ‚i¬‚³‚¢‡j', 0, 0, 0, 'Val ASC', NULL, NULL);
--			--INSERT INTO uc_lst_item_sort VALUES (110, 0, '‚È‚µ', 0, 0, 0, NULL, NULL, NULL);
--			--INSERT INTO uc_lst_item_sort VALUES (110, 1, '‰È–Ú', 1, 1, 1, 'KnOrder ASC', 'KnOrder', NULL);
--			--INSERT INTO uc_lst_item_sort VALUES (110, 2, '‘Šèæi–¼Ìj', 0, 0, 0, '(AdName1 + AdName2) COLLATE Japanese_CS_AS_KS_WS ASC, AdName1 COLLATE Japanese_CS_AS_KS_WS ASC, AdName2 COLLATE Japanese_CS_AS_KS_WS ASC', NULL, NULL);
--			--INSERT INTO uc_lst_item_sort VALUES (110, 3, 'Šú––Œ»İ‚i‘å‚«‚¢‡j', 0, 0, 0, 'Val DESC', NULL, NULL);
--			--INSERT INTO uc_lst_item_sort VALUES (110, 4, 'Šú––Œ»İ‚i¬‚³‚¢‡j', 0, 0, 0, 'Val ASC', NULL, NULL);
--			--INSERT INTO uc_lst_item_sort VALUES (111, 0, '‚È‚µ', 0, 0, 0, NULL, NULL, NULL);
--			--INSERT INTO uc_lst_item_sort VALUES (111, 1, '‰È–Ú', 1, 1, 1, 'KnOrder ASC', 'KnOrder', NULL);
--			--INSERT INTO uc_lst_item_sort VALUES (111, 2, '‘Šèæi–¼Ìj', 0, 0, 0, '(AdName1 + AdName2) COLLATE Japanese_CS_AS_KS_WS ASC, AdName1 COLLATE Japanese_CS_AS_KS_WS ASC, AdName2 COLLATE Japanese_CS_AS_KS_WS ASC', NULL, NULL);
--			--INSERT INTO uc_lst_item_sort VALUES (111, 3, 'Šú––Œ»İ‚i‘å‚«‚¢‡j', 0, 0, 0, 'Val DESC', NULL, NULL);
--			--INSERT INTO uc_lst_item_sort VALUES (111, 4, 'Šú––Œ»İ‚i¬‚³‚¢‡j', 0, 0, 0, 'Val ASC', NULL, NULL);
--			--INSERT INTO uc_lst_item_sort VALUES (112, 0, '‚È‚µ', 0, 0, 0, NULL, NULL, NULL);
--			--INSERT INTO uc_lst_item_sort VALUES (112, 1, '‰È–Ú', 1, 1, 1, 'KnOrder ASC', 'KnOrder', NULL);
--			--INSERT INTO uc_lst_item_sort VALUES (112, 2, '‘Šèæi–¼Ìj', 0, 0, 0, '(AdName1 + AdName2) COLLATE Japanese_CS_AS_KS_WS ASC, AdName1 COLLATE Japanese_CS_AS_KS_WS ASC, AdName2 COLLATE Japanese_CS_AS_KS_WS ASC', NULL, NULL);
--			--INSERT INTO uc_lst_item_sort VALUES (112, 3, 'Šú––Œ»İ‚i‘å‚«‚¢‡j', 0, 0, 0, 'Val DESC', NULL, NULL);
--			--INSERT INTO uc_lst_item_sort VALUES (112, 4, 'Šú––Œ»İ‚i¬‚³‚¢‡j', 0, 0, 0, 'Val ASC', NULL, NULL);
--			--INSERT INTO uc_lst_item_sort VALUES (113, 0, '‚È‚µ', 0, 0, 0, NULL, NULL, NULL);
--			--INSERT INTO uc_lst_item_sort VALUES (113, 1, '‰È–Ú', 1, 1, 1, 'KnOrder ASC', 'KnOrder', NULL);
--			--INSERT INTO uc_lst_item_sort VALUES (113, 2, '‘Šèæi–¼Ìj', 0, 0, 0, '(AdName1 + AdName2) COLLATE Japanese_CS_AS_KS_WS ASC, AdName1 COLLATE Japanese_CS_AS_KS_WS ASC, AdName2 COLLATE Japanese_CS_AS_KS_WS ASC', NULL, NULL);
--			--INSERT INTO uc_lst_item_sort VALUES (113, 3, 'Šú––Œ»İ‚i‘å‚«‚¢‡j', 0, 0, 0, 'Val DESC', NULL, NULL);
--			--INSERT INTO uc_lst_item_sort VALUES (113, 4, 'Šú––Œ»İ‚i¬‚³‚¢‡j', 0, 0, 0, 'Val ASC', NULL, NULL);
--			--INSERT INTO uc_lst_item_sort VALUES (114, 0, '‚È‚µ', 0, 0, 0, NULL, NULL, NULL);
--			--INSERT INTO uc_lst_item_sort VALUES (114, 1, '‰È–Ú', 1, 1, 1, 'KnOrder ASC', 'KnOrder', NULL);
--			--INSERT INTO uc_lst_item_sort VALUES (114, 2, '‘Šèæi–¼Ìj', 0, 0, 0, '(AdName1 + AdName2) COLLATE Japanese_CS_AS_KS_WS ASC, AdName1 COLLATE Japanese_CS_AS_KS_WS ASC, AdName2 COLLATE Japanese_CS_AS_KS_WS ASC', NULL, NULL);
--			--INSERT INTO uc_lst_item_sort VALUES (114, 3, 'Šú––Œ»İ‚i‘å‚«‚¢‡j', 0, 0, 0, 'Val DESC', NULL, NULL);
--			--INSERT INTO uc_lst_item_sort VALUES (114, 4, 'Šú––Œ»İ‚i¬‚³‚¢‡j', 0, 0, 0, 'Val ASC', NULL, NULL);
--			--INSERT INTO uc_lst_item_sort VALUES (115, 0, '‚È‚µ', 0, 0, 0, NULL, NULL, NULL);
--			--INSERT INTO uc_lst_item_sort VALUES (115, 1, '‰È–Ú', 1, 1, 1, 'KnOrder ASC', 'KnOrder', NULL);
--			--INSERT INTO uc_lst_item_sort VALUES (115, 2, '‘Šèæi–¼Ìj', 0, 0, 0, '(AdName1 + AdName2) COLLATE Japanese_CS_AS_KS_WS ASC, AdName1 COLLATE Japanese_CS_AS_KS_WS ASC, AdName2 COLLATE Japanese_CS_AS_KS_WS ASC', NULL, NULL);
--			--INSERT INTO uc_lst_item_sort VALUES (115, 3, 'Šú––Œ»İ‚i‘å‚«‚¢‡j', 0, 0, 0, 'Val DESC', NULL, NULL);
--			--INSERT INTO uc_lst_item_sort VALUES (115, 4, 'Šú––Œ»İ‚i¬‚³‚¢‡j', 0, 0, 0, 'Val ASC', NULL, NULL);
--			--INSERT INTO uc_lst_item_sort VALUES (116, 0, '‚È‚µ', 0, 0, 0, NULL, NULL, NULL);
--			--INSERT INTO uc_lst_item_sort VALUES (116, 1, '‰È–Ú', 1, 1, 1, 'KnOrder ASC', 'KnOrder', NULL);
--			--INSERT INTO uc_lst_item_sort VALUES (116, 2, '‘Šèæi–¼Ìj', 0, 0, 0, '(AdName1 + AdName2) COLLATE Japanese_CS_AS_KS_WS ASC, AdName1 COLLATE Japanese_CS_AS_KS_WS ASC, AdName2 COLLATE Japanese_CS_AS_KS_WS ASC', NULL, NULL);
--			--INSERT INTO uc_lst_item_sort VALUES (116, 3, 'Šú––Œ»İ‚i‘å‚«‚¢‡j', 0, 0, 0, 'Val DESC', NULL, NULL);
--			--INSERT INTO uc_lst_item_sort VALUES (116, 4, 'Šú––Œ»İ‚i¬‚³‚¢‡j', 0, 0, 0, 'Val ASC', NULL, NULL);
--			--INSERT INTO uc_lst_item_sort VALUES (117, 0, '‚È‚µ', 0, 0, 0, NULL, NULL, NULL);
--			--INSERT INTO uc_lst_item_sort VALUES (117, 1, '‰È–Ú', 1, 1, 1, 'KnOrder ASC', 'KnOrder', NULL);
--			--INSERT INTO uc_lst_item_sort VALUES (117, 2, '‘Šèæi–¼Ìj', 0, 0, 0, '(AdName1 + AdName2) COLLATE Japanese_CS_AS_KS_WS ASC, AdName1 COLLATE Japanese_CS_AS_KS_WS ASC, AdName2 COLLATE Japanese_CS_AS_KS_WS ASC', NULL, NULL);
--			--INSERT INTO uc_lst_item_sort VALUES (117, 3, 'Šú––Œ»İ‚i‘å‚«‚¢‡j', 0, 0, 0, 'Val DESC', NULL, NULL);
--			--INSERT INTO uc_lst_item_sort VALUES (117, 4, 'Šú––Œ»İ‚i¬‚³‚¢‡j', 0, 0, 0, 'Val ASC', NULL, NULL);
--			--INSERT INTO uc_lst_item_sort VALUES (118, 0, '‚È‚µ', 0, 0, 0, NULL, NULL, NULL);
--			--INSERT INTO uc_lst_item_sort VALUES (118, 1, '‰È–Ú', 1, 1, 1, 'KnOrder ASC', 'KnOrder', NULL);
--			--INSERT INTO uc_lst_item_sort VALUES (118, 2, '‘Šèæi–¼Ìj', 0, 0, 0, '(AdName1 + AdName2) COLLATE Japanese_CS_AS_KS_WS ASC, AdName1 COLLATE Japanese_CS_AS_KS_WS ASC, AdName2 COLLATE Japanese_CS_AS_KS_WS ASC', NULL, NULL);
--			--INSERT INTO uc_lst_item_sort VALUES (118, 3, 'Šú––Œ»İ‚i‘å‚«‚¢‡j', 0, 0, 0, 'Val DESC', NULL, NULL);
--			--INSERT INTO uc_lst_item_sort VALUES (118, 4, 'Šú––Œ»İ‚i¬‚³‚¢‡j', 0, 0, 0, 'Val ASC', NULL, NULL);
--			--INSERT INTO uc_lst_item_sort VALUES (119, 0, '‚È‚µ', 0, 0, 0, NULL, NULL, NULL);
--			--INSERT INTO uc_lst_item_sort VALUES (119, 1, '‰È–Ú', 1, 1, 1, 'KnOrder ASC', 'KnOrder', NULL);
--			--INSERT INTO uc_lst_item_sort VALUES (119, 2, '‘Šèæi–¼Ìj', 0, 0, 0, '(AdName1 + AdName2) COLLATE Japanese_CS_AS_KS_WS ASC, AdName1 COLLATE Japanese_CS_AS_KS_WS ASC, AdName2 COLLATE Japanese_CS_AS_KS_WS ASC', NULL, NULL);
--			--INSERT INTO uc_lst_item_sort VALUES (119, 3, 'Šú––Œ»İ‚i‘å‚«‚¢‡j', 0, 0, 0, 'Val DESC', NULL, NULL);
--			--INSERT INTO uc_lst_item_sort VALUES (119, 4, 'Šú––Œ»İ‚i¬‚³‚¢‡j', 0, 0, 0, 'Val ASC', NULL, NULL);
--			--INSERT INTO uc_lst_item_sort VALUES (120, 0, '‚È‚µ', 0, 0, 0, NULL, NULL, NULL);
--			--INSERT INTO uc_lst_item_sort VALUES (120, 1, '‰È–Ú', 1, 1, 1, 'KnOrder ASC', 'KnOrder', NULL);
--			--INSERT INTO uc_lst_item_sort VALUES (120, 2, '‘Šèæi–¼Ìj', 0, 0, 0, '(AdName1 + AdName2) COLLATE Japanese_CS_AS_KS_WS ASC, AdName1 COLLATE Japanese_CS_AS_KS_WS ASC, AdName2 COLLATE Japanese_CS_AS_KS_WS ASC', NULL, NULL);
--			--INSERT INTO uc_lst_item_sort VALUES (120, 3, 'Šú––Œ»İ‚i‘å‚«‚¢‡j', 0, 0, 0, 'Val DESC', NULL, NULL);
--			--INSERT INTO uc_lst_item_sort VALUES (120, 4, 'Šú––Œ»İ‚i¬‚³‚¢‡j', 0, 0, 0, 'Val ASC', NULL, NULL);

--			--INSERT INTO uc_lst_item_sort VALUES (206, 0, '‚È‚µ', 0, 0, 0, NULL, NULL, NULL);
--			--INSERT INTO uc_lst_item_sort VALUES (206, 1, '‰È–Ú', 1, 1, 1, 'KnOrder ASC', 'KnOrder', NULL);
--			--INSERT INTO uc_lst_item_sort VALUES (206, 2, 'Šú––Œ»İ‚i‘å‚«‚¢‡j', 0, 0, 0, 'Val DESC', NULL, NULL);
--			--INSERT INTO uc_lst_item_sort VALUES (206, 3, 'Šú––Œ»İ‚i¬‚³‚¢‡j', 0, 0, 0, 'Val ASC', NULL, NULL);
--			--INSERT INTO uc_lst_item_sort VALUES (207, 0, '‚È‚µ', 0, 0, 0, NULL, NULL, NULL);
--			--INSERT INTO uc_lst_item_sort VALUES (207, 1, '‰È–Ú', 1, 1, 1, 'KnOrder ASC', 'KnOrder', NULL);
--			--INSERT INTO uc_lst_item_sort VALUES (207, 2, 'Šú––Œ»İ‚i‘å‚«‚¢‡j', 0, 0, 0, 'Val DESC', NULL, NULL);
--			--INSERT INTO uc_lst_item_sort VALUES (207, 3, 'Šú––Œ»İ‚i¬‚³‚¢‡j', 0, 0, 0, 'Val ASC', NULL, NULL);
--			--INSERT INTO uc_lst_item_sort VALUES (208, 0, '‚È‚µ', 0, 0, 0, NULL, NULL, NULL);
--			--INSERT INTO uc_lst_item_sort VALUES (208, 1, '‰È–Ú', 1, 1, 1, 'KnOrder ASC', 'KnOrder', NULL);
--			--INSERT INTO uc_lst_item_sort VALUES (208, 2, 'Šú––Œ»İ‚i‘å‚«‚¢‡j', 0, 0, 0, 'Val DESC', NULL, NULL);
--			--INSERT INTO uc_lst_item_sort VALUES (208, 3, 'Šú––Œ»İ‚i¬‚³‚¢‡j', 0, 0, 0, 'Val ASC', NULL, NULL);
--			--INSERT INTO uc_lst_item_sort VALUES (209, 0, '‚È‚µ', 0, 0, 0, NULL, NULL, NULL);
--			--INSERT INTO uc_lst_item_sort VALUES (209, 1, '‰È–Ú', 1, 1, 1, 'KnOrder ASC', 'KnOrder', NULL);
--			--INSERT INTO uc_lst_item_sort VALUES (209, 2, 'Šú––Œ»İ‚i‘å‚«‚¢‡j', 0, 0, 0, 'Val DESC', NULL, NULL);
--			--INSERT INTO uc_lst_item_sort VALUES (209, 3, 'Šú––Œ»İ‚i¬‚³‚¢‡j', 0, 0, 0, 'Val ASC', NULL, NULL);
--			--INSERT INTO uc_lst_item_sort VALUES (210, 0, '‚È‚µ', 0, 0, 0, NULL, NULL, NULL);
--			--INSERT INTO uc_lst_item_sort VALUES (210, 1, '‰È–Ú', 1, 1, 1, 'KnOrder ASC', 'KnOrder', NULL);
--			--INSERT INTO uc_lst_item_sort VALUES (210, 2, 'Šú––Œ»İ‚i‘å‚«‚¢‡j', 0, 0, 0, 'Val DESC', NULL, NULL);
--			--INSERT INTO uc_lst_item_sort VALUES (210, 3, 'Šú––Œ»İ‚i¬‚³‚¢‡j', 0, 0, 0, 'Val ASC', NULL, NULL);
--			--INSERT INTO uc_lst_item_sort VALUES (211, 0, '‚È‚µ', 0, 0, 0, NULL, NULL, NULL);
--			--INSERT INTO uc_lst_item_sort VALUES (211, 1, '‰È–Ú', 1, 1, 1, 'KnOrder ASC', 'KnOrder', NULL);
--			--INSERT INTO uc_lst_item_sort VALUES (211, 2, 'Šú––Œ»İ‚i‘å‚«‚¢‡j', 0, 0, 0, 'Val DESC', NULL, NULL);
--			--INSERT INTO uc_lst_item_sort VALUES (211, 3, 'Šú––Œ»İ‚i¬‚³‚¢‡j', 0, 0, 0, 'Val ASC', NULL, NULL);
--			--INSERT INTO uc_lst_item_sort VALUES (212, 0, '‚È‚µ', 0, 0, 0, NULL, NULL, NULL);
--			--INSERT INTO uc_lst_item_sort VALUES (212, 1, '‰È–Ú', 1, 1, 1, 'KnOrder ASC', 'KnOrder', NULL);
--			--INSERT INTO uc_lst_item_sort VALUES (212, 2, 'Šú––Œ»İ‚i‘å‚«‚¢‡j', 0, 0, 0, 'Val DESC', NULL, NULL);
--			--INSERT INTO uc_lst_item_sort VALUES (212, 3, 'Šú––Œ»İ‚i¬‚³‚¢‡j', 0, 0, 0, 'Val ASC', NULL, NULL);
--			--INSERT INTO uc_lst_item_sort VALUES (213, 0, '‚È‚µ', 0, 0, 0, NULL, NULL, NULL);
--			--INSERT INTO uc_lst_item_sort VALUES (213, 1, '‰È–Ú', 1, 1, 1, 'KnOrder ASC', 'KnOrder', NULL);
--			--INSERT INTO uc_lst_item_sort VALUES (213, 2, 'Šú––Œ»İ‚i‘å‚«‚¢‡j', 0, 0, 0, 'Val DESC', NULL, NULL);
--			--INSERT INTO uc_lst_item_sort VALUES (213, 3, 'Šú––Œ»İ‚i¬‚³‚¢‡j', 0, 0, 0, 'Val ASC', NULL, NULL);
--			--INSERT INTO uc_lst_item_sort VALUES (214, 0, '‚È‚µ', 0, 0, 0, NULL, NULL, NULL);
--			--INSERT INTO uc_lst_item_sort VALUES (214, 1, '‰È–Ú', 1, 1, 1, 'KnOrder ASC', 'KnOrder', NULL);
--			--INSERT INTO uc_lst_item_sort VALUES (214, 2, 'Šú––Œ»İ‚i‘å‚«‚¢‡j', 0, 0, 0, 'Val DESC', NULL, NULL);
--			--INSERT INTO uc_lst_item_sort VALUES (214, 3, 'Šú––Œ»İ‚i¬‚³‚¢‡j', 0, 0, 0, 'Val ASC', NULL, NULL);
--			--INSERT INTO uc_lst_item_sort VALUES (215, 0, '‚È‚µ', 0, 0, 0, NULL, NULL, NULL);
--			--INSERT INTO uc_lst_item_sort VALUES (215, 1, '‰È–Ú', 1, 1, 1, 'KnOrder ASC', 'KnOrder', NULL);
--			--INSERT INTO uc_lst_item_sort VALUES (215, 2, 'Šú––Œ»İ‚i‘å‚«‚¢‡j', 0, 0, 0, 'Val DESC', NULL, NULL);
--			--INSERT INTO uc_lst_item_sort VALUES (215, 3, 'Šú––Œ»İ‚i¬‚³‚¢‡j', 0, 0, 0, 'Val ASC', NULL, NULL);
--			--INSERT INTO uc_lst_item_sort VALUES (216, 0, '‚È‚µ', 0, 0, 0, NULL, NULL, NULL);
--			--INSERT INTO uc_lst_item_sort VALUES (216, 1, '‰È–Ú', 1, 1, 1, 'KnOrder ASC', 'KnOrder', NULL);
--			--INSERT INTO uc_lst_item_sort VALUES (216, 2, 'Šú––Œ»İ‚i‘å‚«‚¢‡j', 0, 0, 0, 'Val DESC', NULL, NULL);
--			--INSERT INTO uc_lst_item_sort VALUES (216, 3, 'Šú––Œ»İ‚i¬‚³‚¢‡j', 0, 0, 0, 'Val ASC', NULL, NULL);
--			--INSERT INTO uc_lst_item_sort VALUES (217, 0, '‚È‚µ', 0, 0, 0, NULL, NULL, NULL);
--			--INSERT INTO uc_lst_item_sort VALUES (217, 1, '‰È–Ú', 1, 1, 1, 'KnOrder ASC', 'KnOrder', NULL);
--			--INSERT INTO uc_lst_item_sort VALUES (217, 2, 'Šú––Œ»İ‚i‘å‚«‚¢‡j', 0, 0, 0, 'Val DESC', NULL, NULL);
--			--INSERT INTO uc_lst_item_sort VALUES (217, 3, 'Šú––Œ»İ‚i¬‚³‚¢‡j', 0, 0, 0, 'Val ASC', NULL, NULL);
--			--INSERT INTO uc_lst_item_sort VALUES (218, 0, '‚È‚µ', 0, 0, 0, NULL, NULL, NULL);
--			--INSERT INTO uc_lst_item_sort VALUES (218, 1, '‰È–Ú', 1, 1, 1, 'KnOrder ASC', 'KnOrder', NULL);
--			--INSERT INTO uc_lst_item_sort VALUES (218, 2, 'Šú––Œ»İ‚i‘å‚«‚¢‡j', 0, 0, 0, 'Val DESC', NULL, NULL);
--			--INSERT INTO uc_lst_item_sort VALUES (218, 3, 'Šú––Œ»İ‚i¬‚³‚¢‡j', 0, 0, 0, 'Val ASC', NULL, NULL);
--			--INSERT INTO uc_lst_item_sort VALUES (219, 0, '‚È‚µ', 0, 0, 0, NULL, NULL, NULL);
--			--INSERT INTO uc_lst_item_sort VALUES (219, 1, '‰È–Ú', 1, 1, 1, 'KnOrder ASC', 'KnOrder', NULL);
--			--INSERT INTO uc_lst_item_sort VALUES (219, 2, 'Šú––Œ»İ‚i‘å‚«‚¢‡j', 0, 0, 0, 'Val DESC', NULL, NULL);
--			--INSERT INTO uc_lst_item_sort VALUES (219, 3, 'Šú––Œ»İ‚i¬‚³‚¢‡j', 0, 0, 0, 'Val ASC', NULL, NULL);
--			--INSERT INTO uc_lst_item_sort VALUES (220, 0, '‚È‚µ', 0, 0, 0, NULL, NULL, NULL);
--			--INSERT INTO uc_lst_item_sort VALUES (220, 1, '‰È–Ú', 1, 1, 1, 'KnOrder ASC', 'KnOrder', NULL);
--			--INSERT INTO uc_lst_item_sort VALUES (220, 2, 'Šú––Œ»İ‚i‘å‚«‚¢‡j', 0, 0, 0, 'Val DESC', NULL, NULL);
--			--INSERT INTO uc_lst_item_sort VALUES (220, 3, 'Šú––Œ»İ‚i¬‚³‚¢‡j', 0, 0, 0, 'Val ASC', NULL, NULL);
...
--			---- uc_inf_sonota_item
--			--INSERT INTO uc_inf_sonota_item VALUES (206, '€–Ú');
--			--INSERT INTO uc_inf_sonota_item VALUES (207, '€–Ú');
--			--INSERT INTO uc_inf_sonota_item VALUES (208, '€–Ú');
--			--INSERT INTO uc_inf_sonota_item VALUES (209, '€–Ú');
--			--INSERT INTO uc_inf_sonota_item VALUES (210, '€–Ú');
--			--INSERT INTO uc_inf_sonota_item VALUES (211, '€–Ú');
--			--INSERT INTO uc_inf_sonota_item VALUES (212, '€–Ú');
--			--INSERT INTO uc_inf_sonota_item VALUES (213, '€–Ú');
--			--INSERT INTO uc_inf_sonota_item VALUES (214, '€–Ú');
--			--INSERT INTO uc_inf_sonota_item VALUES (215, '€–Ú');
--			--INSERT INTO uc_inf_sonota_item VALUES (216, '€–Ú');
--			--INSERT INTO uc_inf_sonota_item VALUES (217, '€–Ú');
--			--INSERT INTO uc_inf_sonota_item VALUES (218, '€–Ú');
--			--INSERT INTO uc_inf_sonota_item VALUES (219, '€–Ú');
--			--INSERT INTO uc_inf_sonota_item VALUES (220, '€–Ú');
---- midori 171108 del <--
---- midori 171108 add -->
...
-- midori UC_0006 del -->
		...
		--UPDATE uc_lst_kamoku SET IkkatuVal = OpIkkatuVal FROM uc_lst_kamoku INNER JOIN uc_inf_sub as tbl1 ON uc_lst_kamoku.FormSeq = tbl1.FormSeq
		...
		--UPDATE uc_lst_address SET IkkatuVal = OpIkkatuVal FROM uc_lst_address INNER JOIN uc_inf_sub as tbl1 ON tbl1.FormSeq = 5 WHERE GrSeq = 3
		...
		--UPDATE uc_lst_address SET IkkatuVal = OpIkkatuVal FROM uc_lst_address INNER JOIN uc_inf_sub as tbl1 ON tbl1.FormSeq = 9  WHERE GrSeq = 10
-- midori UC_0006 del <--
-- midori UC_0006 add -->
		-- uc_lst_kamoku.IkkatuVal‚É‘Î‰‚·‚é—l®ƒV[ƒPƒ“ƒX‚ÌˆêŠ‡‹àŠz‚ğƒRƒs[‚·‚é
...
BEGIN
		...
		if( @uchiver = 8 ) begin
			...
			-- uc_lst_kamoku ‰È–Úw’è‚Ìo—ÍƒTƒCƒ“ƒJƒ‰ƒ€‚ğ’Ç‰Á
...
-- midori 152387 add -->
			...
			--uc_inf_yokuki —‚ŠúXV‚Éu‹àŠz—“‚ğ‹ó—“‚É‚·‚évƒTƒCƒ“ƒJƒ‰ƒ€‚ğ’Ç‰Á
...
-- midori 152137 add -->
			-- uc_lst_item_sort 50‰¹ƒ\[ƒg—p‚ÌƒJƒ‰ƒ€‚ğ’Ç‰ÁB
...
--			WHERE FormSeq = 13 AND ItemSeq = 2
...
--			      (FormSeq = 21 AND ItemSeq = 1) OR (FormSeq = 22 AND ItemSeq = 1) OR (FormSeq >= 101 AND FormSeq <= 120 AND ItemSeq = 1) OR (FormSeq >= 201 AND FormSeq <= 220 AND ItemSeq = 1)
