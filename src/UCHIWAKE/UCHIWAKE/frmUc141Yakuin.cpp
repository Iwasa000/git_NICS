...
IMPLEMENT_DYNCREATE( CfrmUc141Yakuin, CfrmUc000Common )


BEGIN_MESSAGE_MAP( CfrmUc141Yakuin, CfrmUc000Common )
	ON_WM_SIZE()
...
//	ON_COMMAND( ID_BUTTON_F3, OnButtonF3 )
	...
	ON_COMMAND( ID_PRINTSETUP_MENU, &CfrmUc141Yakuin::OnMenuPrintSetup )
	ON_COMMAND( ID_PRINTALL_MENU, &CfrmUc141Yakuin::OnMenuPrintAll )
	ON_COMMAND( ID_OUTPUTFORM_MENU, &CfrmUc141Yakuin::OnMenuFormTypeSetup )
	ON_COMMAND( ID_SPECIALROW_MENU, &CfrmUc141Yakuin::OnMenuSpecialRow )
//	ON_COMMAND( ID_DISPDIALOG_MENU, &CfrmUc141Yakuin::OnMenuIkkatuKingaku )
	ON_COMMAND( ID_ZEROMONEY_MENU, &CfrmUc141Yakuin::OnMenuZeroMoney )
	ON_COMMAND( ID_ZEROMONEYMOVE_MENU, &CfrmUc141Yakuin::OnMenuZeroMoneyMove )
	ON_COMMAND( ID_AMOUTDIALOG_MENU, &CfrmUc141Yakuin::OnMenuOutKeiSetup )
// midori 160606 add -->
	ON_COMMAND( ID_CLEAR_MENU, &CfrmUc141Yakuin::OnMenuClear )
// midori 160606 add <--
	ON_COMMAND( ID_TITLEMENU, &CfrmUc141Yakuin::OnMenuTitleRestore )
	ON_COMMAND( ID_USER_SETTING_MENU, &CfrmUc141Yakuin::OnMenuOptionSetting )
	ON_COMMAND( ID_COPY_SETTING_INFO_MENU, &CfrmUc141Yakuin::OnMenuCopySettingInfo )
	ON_COMMAND( ID_DELETE_DATA_MENU, &CfrmUc141Yakuin::OnMenuDeleteDataEachYoushiki )
	ON_BN_CLICKED( IDC_PAGEBACK_BUTTON1, &CfrmUc141Yakuin::OnPageBack )
	ON_BN_CLICKED( IDC_PAGENEXT_BUTTON1, &CfrmUc141Yakuin::OnPageNext )
	ON_BN_CLICKED( IDC_PAGENEW_BUTTON1, &CfrmUc141Yakuin::OnPageNew )
	ON_BN_CLICKED( IDC_PAGEINSERT_BUTTON1, &CfrmUc141Yakuin::OnPageInsert )
	ON_BN_CLICKED( IDC_ROWCOPY_BUTTON1, &CfrmUc141Yakuin::OnRowCopy )
	ON_BN_CLICKED( IDC_ROWPASTE_BUTTON1, &CfrmUc141Yakuin::OnRowPaste )
	ON_BN_CLICKED( IDC_ROWINSERT_BUTTON1, &CfrmUc141Yakuin::OnRowInsert )
	ON_BN_CLICKED( IDC_YOUSHIKINEXT_BUTTON1, &CfrmUc141Yakuin::OnMoveYoushikiNext )
	ON_BN_CLICKED( IDC_YOUSHIKIBACK_BUTTON1, &CfrmUc141Yakuin::OnMoveYoushikiBack )
//	ON_UPDATE_COMMAND_UI( ID_BUTTON_F1, &CfrmUc141Yakuin::OnUpdateButtonF1 )
//	ON_UPDATE_COMMAND_UI( ID_BUTTON_F3, &CfrmUc141Yakuin::OnUpdateButtonF3 )
	ON_UPDATE_COMMAND_UI( ID_BUTTON_F6, &CfrmUc141Yakuin::OnUpdateButtonF6 )
	ON_UPDATE_COMMAND_UI( ID_BUTTON_F7, &CfrmUc141Yakuin::OnUpdateButtonF7 )
	ON_UPDATE_COMMAND_UI( ID_BUTTON_F8, &CfrmUc141Yakuin::OnUpdateButtonF8 )
	ON_UPDATE_COMMAND_UI( ID_BUTTON_F9, &CfrmUc141Yakuin::OnUpdateButtonF9 )
	ON_UPDATE_COMMAND_UI( ID_BUTTON_F11, &CfrmUc141Yakuin::OnUpdateButtonF11 )
	ON_UPDATE_COMMAND_UI( ID_BUTTON_F12, &CfrmUc141Yakuin::OnUpdateButtonF12 )
	ON_UPDATE_COMMAND_UI( ID_BUTTON_HOME, &CfrmUc141Yakuin::OnUpdateButtonHome )
//	ON_UPDATE_COMMAND_UI( ID_DISPDIALOG_MENU, &CfrmUc141Yakuin::OnUpdateMenuIkkatuKingaku )
// midori 160612 add -->
	ON_UPDATE_COMMAND_UI( ID_CLEAR_MENU, &CfrmUc141Yakuin::OnUpdateMenuClear )
// midori 160612 add <--
	ON_UPDATE_COMMAND_UI( ID_ZEROMONEY_MENU, &CfrmUc141Yakuin::OnUpdateMenuZeroMoney )
// midori 160612 add -->
	ON_UPDATE_COMMAND_UI( ID_ZEROMONEYMOVE_MENU, &CfrmUc141Yakuin::OnUpdateMenuZeroMoneyMove)
// midori 160612 add <--
	ON_UPDATE_COMMAND_UI(ID_SPECIALROW_MENU, &CfrmUc141Yakuin::OnUpdateMenuSpecialRow)
// midori 160612 add -->
	ON_UPDATE_COMMAND_UI( ID_TITLEMENU, &CfrmUc141Yakuin::OnUpdateMenuTitleRestore )
	ON_UPDATE_COMMAND_UI( ID_DELETE_DATA_MENU, &CfrmUc141Yakuin::OnUpdateMenuDeleteDataEachYoushiki )
// midori 160612 add <--
	ON_MESSAGE(WM_USER_REDRAWVIEW, OnUserReDrawView)		// 修正No.162446 add
END_MESSAGE_MAP()


CfrmUc141Yakuin::CfrmUc141Yakuin()
	: CfrmUc000Common( CfrmUc141Yakuin::IDD )
{
...
CfrmUc141Yakuin::~CfrmUc141Yakuin()
{
	...
	TRACE(_T("***** CfrmUc141Yakuin::~CfrmUc141Yakuin\n"));

	//m_pDiag = NULL;
	//m_pTitleDiag = NULL;
}

void CfrmUc141Yakuin::DoDataExchange( CDataExchange* pDX )
{
...
void CfrmUc141Yakuin::OnInitialUpdate()
{
...
#ifdef _DEBUG
void CfrmUc141Yakuin::AssertValid() const
{
	CfrmUc000Common::AssertValid();
}

#ifndef _WIN32_WCE
void CfrmUc141Yakuin::Dump( CDumpContext& dc ) const
{
...
BEGIN_EVENTSINK_MAP( CfrmUc141Yakuin, CfrmUc000Common )
	ON_EVENT( CfrmUc141Yakuin, IDC_YOUSHIKIDIAG1, 3, CfrmUc141Yakuin::TerminationYoushikidiag1, VTS_I2 VTS_I2 VTS_I2 VTS_UNKNOWN )
	ON_EVENT( CfrmUc141Yakuin, IDC_YOUSHIKIDIAG1, 2, CfrmUc141Yakuin::EditOFFYoushikidiag1, VTS_I2 )
	ON_EVENT( CfrmUc141Yakuin, IDC_YOUSHIKIDIAG1, 1, CfrmUc141Yakuin::EditONYoushikidiag1, VTS_I2 )
// midori 151405 add -->
	ON_EVENT(CfrmUc141Yakuin, IDC_YOUSHIKIDIAG1, 12, CfrmUc141Yakuin::VScrollYoushikidiag1, VTS_I2)
// midori 151405 add <--

	ON_EVENT( CfrmUc141Yakuin, IDC_YOUSHIKIDIAG2, 3, CfrmUc141Yakuin::TerminationYoushikidiag1, VTS_I2 VTS_I2 VTS_I2 VTS_UNKNOWN )
	ON_EVENT( CfrmUc141Yakuin, IDC_YOUSHIKIDIAG2, 2, CfrmUc141Yakuin::EditOFFYoushikidiag1, VTS_I2 )
	ON_EVENT( CfrmUc141Yakuin, IDC_YOUSHIKIDIAG2, 1, CfrmUc141Yakuin::EditONYoushikidiag1, VTS_I2 )
// midori 151405 add -->
	ON_EVENT(CfrmUc141Yakuin, IDC_YOUSHIKIDIAG2, 12, CfrmUc141Yakuin::VScrollYoushikidiag1, VTS_I2)
// midori 151405 add <--

	ON_EVENT( CfrmUc141Yakuin, IDC_YOUSHIKIDIAG3, 3, CfrmUc141Yakuin::TerminationYoushikidiag1, VTS_I2 VTS_I2 VTS_I2 VTS_UNKNOWN )
	ON_EVENT( CfrmUc141Yakuin, IDC_YOUSHIKIDIAG3, 2, CfrmUc141Yakuin::EditOFFYoushikidiag1, VTS_I2 )
	ON_EVENT( CfrmUc141Yakuin, IDC_YOUSHIKIDIAG3, 1, CfrmUc141Yakuin::EditONYoushikidiag1, VTS_I2 )
// midori 151405 add -->
	ON_EVENT(CfrmUc141Yakuin, IDC_YOUSHIKIDIAG3, 12, CfrmUc141Yakuin::VScrollYoushikidiag1, VTS_I2)
// midori 151405 add <--

	ON_EVENT( CfrmUc141Yakuin, IDC_YOUSHIKIDIAG4, 3, CfrmUc141Yakuin::TerminationYoushikidiag1, VTS_I2 VTS_I2 VTS_I2 VTS_UNKNOWN )
	ON_EVENT( CfrmUc141Yakuin, IDC_YOUSHIKIDIAG4, 2, CfrmUc141Yakuin::EditOFFYoushikidiag1, VTS_I2 )
	ON_EVENT( CfrmUc141Yakuin, IDC_YOUSHIKIDIAG4, 1, CfrmUc141Yakuin::EditONYoushikidiag1, VTS_I2 )
// midori 151405 add -->
	ON_EVENT(CfrmUc141Yakuin, IDC_YOUSHIKIDIAG4, 12, CfrmUc141Yakuin::VScrollYoushikidiag1, VTS_I2)
// midori 151405 add <--

	ON_EVENT( CfrmUc141Yakuin, IDC_TITLEDIAG1, 3, CfrmUc141Yakuin::TerminationTitlediag1, VTS_I2 VTS_I2 VTS_I2 VTS_UNKNOWN )
	ON_EVENT( CfrmUc141Yakuin, IDC_TITLEDIAG1, 2, CfrmUc141Yakuin::EditOFFTitlediag1, VTS_I2 )
	ON_EVENT( CfrmUc141Yakuin, IDC_TITLEDIAG1, 1, CfrmUc141Yakuin::EditONTitlediag1, VTS_I2 )
	ON_EVENT( CfrmUc141Yakuin, IDC_TITLEDIAG1, 6, CfrmUc141Yakuin::FocusTitlediag1, VTS_NONE )

	ON_EVENT( CfrmUc141Yakuin, IDC_PAGEDIAG1, 3, CfrmUc141Yakuin::TerminationPagediag1, VTS_I2 VTS_I2 VTS_I2 VTS_UNKNOWN )
	ON_EVENT( CfrmUc141Yakuin, IDC_PAGEDIAG1, 2, CfrmUc141Yakuin::EditOFFPagediag1, VTS_I2 )
	ON_EVENT( CfrmUc141Yakuin, IDC_PAGEDIAG1, 1, CfrmUc141Yakuin::EditONPagediag1, VTS_I2 )
	ON_EVENT( CfrmUc141Yakuin, IDC_PAGEDIAG1, 6, CfrmUc141Yakuin::FocusPagediag1, VTS_NONE )
END_EVENTSINK_MAP()

//********************************************************************************
//	初期処理
//********************************************************************************
BOOL	CfrmUc141Yakuin::virStartJob()
{
	// 初期値設定
...
//	共通データの初期値設定
//********************************************************************************
void	CfrmUc141Yakuin::virSetInitialUchiwakeInfo()
{
	// 「役員報酬」の固有データ
...
// 【戻値】    なし
//**************************************************
void	CfrmUc141Yakuin::virSetInitialDiag()
{
...
//	帳表固有変数の初期値設定
//********************************************************************************
void	CfrmUc141Yakuin::virSetInitialValue()
{
	// 1ページ分のローカルバッファをクリア
	RecBufClearAllData();
...
//	帳表コントロールの初期化（データ領域）
//********************************************************************************
BOOL	CfrmUc141Yakuin::InitialControlDataArea()
{
	int		intMax;
	int		i;
...
//********************************************************************************
BOOL	CfrmUc141Yakuin::InitialControlDataAreaHide( CICSDiag* pDiag )
{
	int		intMax;
	int		i;
...
//********************************************************************************
BOOL	CfrmUc141Yakuin::InitialControlComboBox()
{
...
//********************************************************************************
void	CfrmUc141Yakuin::InitialControlTotalArea()
{
int		nKeiType;			//	計の種別
	int		nDataRow;			//	データ行属性
...
//		→表示していない方のDiag(通常 or 個別)の設定に使用する
//********************************************************************************
void	CfrmUc141Yakuin::InitialControlTotalAreaHide( CICSDiag* pDiag )
{
	int intIndex = 0;
...
//	RET	なし
//********************************************************************************
void	CfrmUc141Yakuin::InitialControlSpecialRow( int intRow, int intFgFunc )
{
	DIAGRAM_DATA	diadata;	// ICSDIAG構造体
...
//	【戻値】	なし
//**************************************************
void CfrmUc141Yakuin::virInitialControlFgInputCell( int nRow, int nFgFunc, BYTE bFgInput )
{	
	int		nRowFirst;	//	行開始位置
	int		nBackPos;	//	背景位置
	int		nDataPos;	//	データ位置
...
//	帳表タイトル情報の表示
//********************************************************************************
void	CfrmUc141Yakuin::virUpdateControlTitle()
{
//	int		intMax;
...
//	帳表ページ情報の表示
//********************************************************************************
void	CfrmUc141Yakuin::UpdateControlPage()
{
	BOOL	bBack = TRUE;
	BOOL	bNext = TRUE;
...
//	帳表データの表示（１ページ分）
//********************************************************************************
BOOL	CfrmUc141Yakuin::virUpdateControlTblData()
{
// midori 18-0887 add -->
	int					inpsw=0;
	int					nCtlIndex=0;
...
//	保管件数の表示
//********************************************************************************
BOOL CfrmUc141Yakuin::virUpdateControlTblData2()
{
	int					hcnt=0;
	CString				cs=_T("");
...
//		RET		なし
//********************************************************************************
void	CfrmUc141Yakuin::UpdateControlRowData( CdbUc141Yakuin* prmDbRec ) {
	DIAGRAM_DATA	diadata;	// ICSDiag構造体
	int				intCell;	// 保存フィールド
...
//		RET		なし
//********************************************************************************
void	CfrmUc141Yakuin::UpdateControlRowTotal( CdbUc141Yakuin* prmDbRec ) {
...
//		RET		なし
//********************************************************************************
void	CfrmUc141Yakuin::virFncCellCopyProc( CdbUc000Common* rsData )
{
	CdbUc141Yakuin*	rs;
	int					intCol;	// 現在の列
...
//********************************************************************************
int	CfrmUc141Yakuin::virFncReferenceGetType(int intCol, int* intGrSeq, long* lngItemSeq, int* intAdd1, int* intAdd2, int* intAdd1Col, int* intAdd2Col, REFERENCE_INFO* pudReference)
{
	int		intRefType = 0;
...
//		RET		なし
//********************************************************************************
void	CfrmUc141Yakuin::virFncReferenceSetICSData(CdlgAddressSearch* dlgAddd)
{
	int			intIndex;
...
//		RET		なし
//********************************************************************************
void	CfrmUc141Yakuin::virFncReferenceSetICSData(CdlgYakuZokuSelect* dlgZokuYaku, int type)
{
	int			intIndex;
...
//	その他イベント処理
//********************************************************************************
BOOL	CfrmUc141Yakuin::PreTranslateMessage( MSG* pMsg )
{	
//	int				intID;
...
// 頁コントロールのフォーカス設定
void	CfrmUc141Yakuin::FocusPagediag1()
{
...
// 頁コントロールのゲットフォーカス
void	CfrmUc141Yakuin::EditONPagediag1( short index )
{
// midori 151405 add -->
	// スクロールフラグをクリアする
	nG_MScroll = 0;
...
// 頁コントロールのロストフォーカス
void	CfrmUc141Yakuin::EditOFFPagediag1( short index )
{
// midori 155028 add -->
...
// 頁コントロールのキー操作
void	CfrmUc141Yakuin::TerminationPagediag1( short index, short nChar, short length, LPUNKNOWN data )
{
	int nMaxDataCol = 0;
	// カレント頁の合計行の種別を取得
...
// タイトルコントロールのフォーカス設定
void	CfrmUc141Yakuin::FocusTitlediag1()
{
//マウスクリックでキャレットが表示できないためコメントとする
//	// ボタンからTabキー移動した場合に必要
//	m_TitleDiag.SetPosition( 0 );
...
// タイトルコントロールのゲットフォーカス
void	CfrmUc141Yakuin::EditONTitlediag1( short index )
{
// midori 151405 add -->
	// スクロールフラグをクリアする
	nG_MScroll = 0;
...
// タイトルコントロールのロストフォーカス
void	CfrmUc141Yakuin::EditOFFTitlediag1 (short index )
{
// midori 151405 add -->
	m_Titlefocus = 0;
// midori 151405 add <--
...
//	タイトル更新
void CfrmUc141Yakuin::virUpdateTitle()
{
...
// タイトルコントロールのキーイベント
void	CfrmUc141Yakuin::TerminationTitlediag1( short index, short nChar, short length, LPUNKNOWN data )
{
	// フォーカス移動
	switch ( nChar ) {
	case VK_RETURN:
...
void	CfrmUc141Yakuin::EditONYoushikidiag1( short index )
{
...
// データコントロールのロストフォーカス
void	CfrmUc141Yakuin::EditOFFYoushikidiag1( short index )
{
	if( m_EndView != FALSE )	return;
...
//	入力確定
void CfrmUc141Yakuin::virInputDecisionEditOFF()
{
	// フォーカスフラグOFF
...
// 預貯金データコントロールのキーイベント
void	CfrmUc141Yakuin::TerminationYoushikidiag1( short index, short nChar, short length, LPUNKNOWN data )
{
	//--------------------------------------------------------------------------------
	//	キー操作仕様
...
// midori 151405 add -->
void CfrmUc141Yakuin::VScrollYoushikidiag1(short mode)
{
...
//********************************************************************************
int	CfrmUc141Yakuin::GetFocusPosition( int nChar )
{
	int		intRow;				// カレント行番号
	int		intCol;				// カレント列番号
...
//********************************************************************************
int	CfrmUc141Yakuin::GetTotalRowIndex( int nCharOrg, int intIndex, int intNext )
{
...
/**********************************************************************
	...
	戻値
		int		成功/失敗
				FUNCTION_OK
***********************************************************************/
int	CfrmUc141Yakuin::RecBufSetData( CdbUc141Yakuin* prmDbRec )
{
...
/**********************************************************************
	...
	戻値
		int		成功/失敗
				FUNCTION_OK
***********************************************************************/
int	CfrmUc141Yakuin::RecBufClearAllData()
{
...
/**********************************************************************
	...
	戻値
		int		成功/失敗
				FUNCTION_OK
***********************************************************************/
int	CfrmUc141Yakuin::RecBufClearData( P_REC_UC_141_YAKUIN inRecData )
{
...
/**********************************************************************
	...
	戻値
		int				成功(更新あり)/成功(更新なし)/失敗
						...
						FUNCTION_NG		: 失敗
***********************************************************************/
int	CfrmUc141Yakuin::virRecBufSaveData( int inPage, int inRow )
{
...
***********************************************************************/
int	CfrmUc141Yakuin::virRecBufSaveDataForPasteInsert( int inPage, int inRow )
{
...
***********************************************************************/
int	CfrmUc141Yakuin::virRecBufSaveDataForPaste( int inPage, int inRow )
{
	///////////////////////////////////////////////////////////////
	// 登録処理呼び出し
	return RecBufSaveDataSub( inPage, inRow, &m_CopyData );
...
/**********************************************************************
	...
	戻値
			int					成功(更新あり)/成功(更新なし)/失敗
								...
								FUNCTION_NG		: 失敗
***********************************************************************/
int	CfrmUc141Yakuin::RecBufSaveDataSub( 
							int inPage,
							int inRow,
...
//********************************************************************************
CdbUc000Common*	CfrmUc141Yakuin::virGetDataTableObject()
{
	// 「役員報酬」テーブルのオブジェクトを生成し、ポインタを返す
...
//	RET	なし
//********************************************************************************
void	CfrmUc141Yakuin::virRowButtonCopyProc()
{
...
//	RET	なし
//********************************************************************************
void	CfrmUc141Yakuin::virGetCurrentInfo( CURRENT_INFO* uCurInfo )
{
...
//	【戻値】	なし
//**************************************************
void CfrmUc141Yakuin::CheckFgInput()
{
...
//	【戻値】	なし
//**************************************************
void CfrmUc141Yakuin::SetAutoCalc()
{
...
//	【戻値】	自動計算結果文字列
//**************************************************
CString CfrmUc141Yakuin::GetAutoCalc( int nRow , CString strVal1 , CString strVal2 , CString strVal3 , CString strVal4 , CString strVal5 )
{
	CString		szRet;		//	戻値
	int			nIndex;		//	インデックス
...
//	【戻値】	加算結果
//**************************************************
CString CfrmUc141Yakuin::GetAddVal( CString szVal1, CString szVal2, CString szVal3, CString szVal4, CString szVal5 )
{
	CString		szRet;			//	戻値
...
//	【戻値】	なし
//**************************************************
void CfrmUc141Yakuin::virOnUpdateButtonF6(BOOL* bFncEnable)
{
/*
	int		nCol;	//	列格納
...
//********************************************************************************
int	CfrmUc141Yakuin::virUpdateRelationTblChengeFormType()
{
...
//		RET		なし
//********************************************************************************
int	CfrmUc141Yakuin::UpdateTbl141ChangeFormType()
{
	// 初期値設定
...
//	【戻値】	なし
//**************************************************
void CfrmUc141Yakuin::SetInputMode( int nRow, long nMode )
{
...
//	【戻値】	なし
//**************************************************
void CfrmUc141Yakuin::SetDiagBackColor()
{
...
//	【戻値】	期末現在高
//**************************************************
/*CString CfrmUc141Yakuin::CheckOutsideValue( CICSDiag* pDiag, int nIndex )
{
	CString			szBuf;	//	バッファ
	CString			szRet;	//	戻値
...
//				FALSE		…	0
//**************************************************
/*BOOL CfrmUc141Yakuin::CheckOutsideValue( CICSDiag* pDiag, int nIndex, int nCol )
{
	BOOL			fRet = FALSE;	//	
	CString			szRet;			//	戻値
...
//				FALSE		…	0
//**************************************************
/*BOOL CfrmUc141Yakuin::CheckOutsideValueSub( CICSDiag* pDiag, int nIndex )
{
	BOOL			fRet;
	DIAGRAM_DATA	udData;
...
//***************************************************************************
BOOL CfrmUc141Yakuin::virEndProc(void)
{
	TRACE(_T("***** CfrmUc141Yakuin::virEndProc\n"));
...
// midori 151405 add -->
int CfrmUc141Yakuin::CursorControl(short nChar, int sw)
{
	int				rv=0;
	int				intCol=0;
	int				pos=0;
...
// 修正No.162446 add -->
LRESULT CfrmUc141Yakuin::OnUserReDrawView(WPARAM wParam, LPARAM lParam)
{
	virUpdateControlTblData();
	CmnDiagSetFocus(m_pDiag, 1, 1);
