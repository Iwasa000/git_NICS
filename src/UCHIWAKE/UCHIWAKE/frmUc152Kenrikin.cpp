�要

		// 金額欄：桁数初期化
// No.200903 del -->
		//CmnDiagSetAttrDigit( m_pDiag, i + ID_COL_152_VAL - 1, ID_VAL_152_DATA );	// 支払金額
// No.200903 del <--
// No.200903 add -->
		if(bG_Kanso == TRUE)	len = ID_VAL_152_K_DATA;
		else					len = ID_VAL_152_DATA;
		CmnDiagSetAttrDigit( m_pDiag, i + ID_COL_152_VAL - 1, len );	// 期末現在高
// No.200903 add <--
	...
	// 半角/全角設定
	CmnDiagSetAttrColZenHan( m_pDiag , ID_COL_152_ADNAME1 );		// 支払先の名称1
	CmnDiagSetAttrColZenHan( m_pDiag , ID_COL_152_ADADD1 );		// 支払先の所在地1
	CmnDiagSetAttrColZenHan( m_pDiag , ID_COL_152_ADADD2 );		// 支払先の所在地2
	CmnDiagSetAttrColZenHan( m_pDiag , ID_COL_152_NAIYOU );		// 権利金等の内容
	CmnDiagSetAttrColZenHan( m_pDiag , ID_COL_152_TEKI );		// 摘要
...
//********************************************************************************
BOOL	CfrmUc152Kenrikin::InitialControlDataAreaHide( CICSDiag* pDiag )
{
	int		intMax;
	int		i;
// No.200903 add -->
...
// No.200903 add <--
	...
	for ( i = m_uInfo.intCtlStartIndex; i < intMax; i += m_uInfo.intColMax ) {
		...
		// 漢字入力欄の初期化
		CmnDiagSetAttrInpmax( pDiag, i + ID_COL_152_ADNAME1    - 1, MAX_KETA_152_ADNAME1 );	// 支払先の名称
		CmnDiagSetAttrInpmax( pDiag, i + ID_COL_152_ADADD1    - 1, MAX_KETA_152_ADADD1 );		// 支払先の所在地1
		CmnDiagSetAttrInpmax( pDiag, i + ID_COL_152_ADADD2    - 1, MAX_KETA_152_ADADD2 );		// 支払先の所在地2
		CmnDiagSetAttrInpmax( pDiag, i + ID_COL_152_SPDATE    - 1, MAX_KETA_152_SPDATE );		// 支払年月日
		CmnDiagSetAttrInpmax( pDiag, i + ID_COL_152_NAIYOU    - 1, MAX_KETA_152_NAIYOU );		// 権利金等の内容
		CmnDiagSetAttrInpmax( pDiag, i + ID_COL_152_TEKI    - 1, MAX_KETA_152_TEKI );			// 摘要

		// 金額欄：桁数初期化
// No.200903 del -->
		//CmnDiagSetAttrDigit( pDiag, i + ID_COL_152_VAL - 1, ID_VAL_152_DATA );	// 支払金額
// No.200903 del <--
// No.200903 add -->
		if(bG_Kanso == TRUE)	len = ID_VAL_152_K_DATA;
		else					len = ID_VAL_152_DATA;
		CmnDiagSetAttrDigit( pDiag, i + ID_COL_152_VAL - 1, len );	// 支払金額
// No.200903 add <--
	}
...
//********************************************************************************
void	CfrmUc152Kenrikin::InitialControlTotalArea()
{
	int		nKeiType;			//	計の種別
...
// midori 152166 add <--
	...
	m_pDiagKei->ModifyItem(ID_COL_152_KEI1_VAL, intKeiRow);
	m_pDiagKei->ModifyItem(ID_COL_152_KEI2_VAL, intKeiRow);
	...
	//m_pDiag->ModifyItem( CmnGetControlTotalIndex( 1, ID_COL_152_ADNAME1 ), nKeiRow[0] );
	//m_pDiag->ModifyItem( CmnGetControlTotalIndex( 2, ID_COL_152_ADNAME1 ), nKeiRow[1] );
	
// No.200903 del -->
	//// 合計行の金額欄は、金額欄 + 1桁
	//CmnDiagSetAttrDigit( m_pDiagKei, ID_COL_152_KEI1_VAL, ID_VAL_152_TOTAL );
	//CmnDiagSetAttrDigit( m_pDiagKei, ID_COL_152_KEI2_VAL, ID_VAL_152_TOTAL );
	////CmnDiagSetAttrDigit( m_pDiag, CmnGetControlTotalIndex( 1, ID_COL_152_VAL ), ID_VAL_152_TOTAL );
	////CmnDiagSetAttrDigit( m_pDiag, CmnGetControlTotalIndex( 2, ID_COL_152_VAL ), ID_VAL_152_TOTAL );
// No.200903 del <--
}
...
//		→表示していない方のDiag(通常 or 個別)の設定に使用する
//********************************************************************************
void	CfrmUc152Kenrikin::InitialControlTotalAreaHide( CICSDiag* pDiag )
{
	int intIndex = 0;
	...
	// 合計行の金額欄は、金額欄 + 1桁
	intIndex = m_intT1StartIndexHide + m_uInfo.intCtlStartIndex + ID_COL_152_VAL - 1;
	CmnDiagSetAttrDigit( pDiag, intIndex, ID_VAL_152_TOTAL );

	intIndex = m_intT2StartIndexHide + m_uInfo.intCtlStartIndex + ID_COL_152_VAL - 1;
	CmnDiagSetAttrDigit( pDiag, intIndex, ID_VAL_152_TOTAL );
}
...
//	RET	なし
//********************************************************************************
void	CfrmUc152Kenrikin::InitialControlSpecialRow( int intRow, int intFgFunc )
{
	...
	case ID_FGFUNC_IKKATUAUTO:		// 一括集計金額行（自動）
		// 桁数を設定
		CmnDiagSetAttrDigit( m_pDiag, CmnGetControlIndex( intRow , ID_COL_152_VAL ), ID_VAL_152_TOTAL );
		break;
	}
...
//	帳表タイトル情報の表示
//********************************************************************************
void	CfrmUc152Kenrikin::virUpdateControlTitle()
{
//	int		intMax;
	DIAGRAM_ATTRIBUTE diaatt;
...
//	帳表ページ情報の表示
//********************************************************************************
void	CfrmUc152Kenrikin::UpdateControlPage()
{
	BOOL	bBack = TRUE;
	BOOL	bNext = TRUE;
...
//	帳表データの表示（１ページ分）
//********************************************************************************
BOOL	CfrmUc152Kenrikin::virUpdateControlTblData()
{
	// ダイアログ切替
	if( m_pDiag != NULL ){
		virSetInitialDiag();
...
// No.200601 add -->
		...
		if(bG_Kanso == TRUE) {
			...
			// 権利金等の内容
			CmnInitialControlFgStringCell( m_pDiag, dbRec.m_NumRow, ID_COL_152_NAIYOU, dbRec.m_FgFunc, UC_152_NAIYOU_LEN, dbRec.m_Naiyou);
			// 摘要
			CmnInitialControlFgStringCell( m_pDiag, dbRec.m_NumRow, ID_COL_152_TEKI, dbRec.m_FgFunc, UC_152_TEKI_LEN, dbRec.m_Teki);
		}
// No.200601 add <--
...
//	保管件数の表示
//********************************************************************************
BOOL CfrmUc152Kenrikin::virUpdateControlTblData2()
{
	int					hcnt=0;
	CString				cs=_T("");
...
//		RET		なし
//********************************************************************************
void	CfrmUc152Kenrikin::UpdateControlRowData( CdbUc152Kenrikin* prmDbRec ) {
	DIAGRAM_DATA	diadata;	// ICSDiag構造体
	int				intCell;	// 保存フィールド
	...
	// 読込み対象セル取得
	intCell = CmnGetControlIndex( prmDbRec->m_NumRow, ID_COL_152_ADNAME1 );
...
//		RET		なし
//********************************************************************************
void	CfrmUc152Kenrikin::UpdateControlRowTotal( CdbUc152Kenrikin* prmDbRec )
{
	int		intTotalType;
	...
	// 頁計/累計の名称表示
	if ( intRowName > 0 ) {
		//CmnDiagSetString( m_pDiag, CmnGetControlTotalIndex( intRowName, ID_COL_152_ADNAME1 ), prmDbRec->m_KeiStr, 0 );
		CmnDiagSetString( m_pDiagKei, CmnGetKeiDiagIndex( intRowName, ID_COL_152_KEI1_MEISYO ), prmDbRec->m_KeiStr, 1 );
	}
	// 頁計/累計の金額表示
	if ( intRowVal > 0 ) {
		//CmnDiagSetKingaku( m_pDiag, CmnGetControlTotalIndex( intRowName, ID_COL_152_VAL ), prmDbRec->m_Val );
		CmnDiagSetKingaku( m_pDiagKei, CmnGetKeiDiagIndex( intRowVal, ID_COL_152_KEI1_VAL ), prmDbRec->m_Val );
	}
}
...
//		RET		なし
//********************************************************************************
void	CfrmUc152Kenrikin::virFncCellCopyProc( CdbUc000Common* rsData )
{
	CdbUc152Kenrikin*	rs;
	int					intCol;	// 現在の列
...
//********************************************************************************
int	CfrmUc152Kenrikin::virFncReferenceGetType(int intCol, int* intGrSeq, long* lngItemSeq, int* intAdd1, int* intAdd2, int* intAdd1Col, int* intAdd2Col, REFERENCE_INFO* pudReference)
{
	...
	case ID_COL_152_ADADD2:
		...
		*intAdd1 = 20 * 2;			// Byte指定
		*intAdd2 = 20 * 2;			// Byte指定
		*intAdd1Col = ID_COL_152_ADADD1;
		*intAdd2Col = ID_COL_152_ADADD2;
		break;
...
//		RET		なし
//********************************************************************************
void	CfrmUc152Kenrikin::virFncReferenceSetICSData(CdlgAddressSearch* dlgAddd)
{
	int			intIndex;
	...
	case ID_COL_152_ADADD2:
		//	支払の所在地１
		intIndex = CmnGetControlIndex( m_uInfo.intCurRow, ID_COL_152_ADADD1 );
		CmnDiagSetString( m_pDiag, intIndex, dlgAddd->m_AdAdd1, 0 );
		//	支払先のの所在地２
		intIndex = CmnGetControlIndex( m_uInfo.intCurRow, ID_COL_152_ADADD2 );
...
// 修正No.157633_元号日付 add -->
void CfrmUc152Kenrikin::virActivateFrame(UINT nState, CFrameWnd* pDeactivateFrame)
{
	int		index = 0;
	...
	if(pWnd != NULL)	{
		if(m_DataKakutei == FALSE)	{
			if(bG_Kanso == TRUE && m_uInfo.intCurCol == ID_COL_152_SPDATE)	{
...
//	その他イベント処理
//********************************************************************************
BOOL	CfrmUc152Kenrikin::PreTranslateMessage( MSG* pMsg )
{
//	int				intID;
...
/*
		...
		case VK_TAB:
			...
			if ((intID == IDC_PAGEBACK_BUTTON1) && (CmnCheckShiftKey() == TRUE)) {
				...
				CmnDiagSetFocus(m_pDiag, m_uInfo.intRowMax, ID_COL_152_TEKI);
				return 1;
			}
			break;
*/
...
// 頁コントロールのフォーカス設定
void	CfrmUc152Kenrikin::FocusPagediag1()
{
...
// 頁コントロールのゲットフォーカス
void	CfrmUc152Kenrikin::EditONPagediag1( short index )
{
// midori 151405 add -->
	// スクロールフラグをクリアする
	nG_MScroll = 0;
...
// midori 151405 add <--
	...
	// 1行登録
//	if( CmnGetControlCol() != ID_COL_152_VAL ){
...
// 頁コントロールのロストフォーカス
void	CfrmUc152Kenrikin::EditOFFPagediag1( short index )
{
// midori 155028 add -->
...
// 頁コントロールのキー操作
void	CfrmUc152Kenrikin::TerminationPagediag1( short index, short nChar, short length, LPUNKNOWN data )
{
	int nMaxDataCol = 0;
	// カレント頁の合計行の種別を取得
...
// midori 160612 cor <--
			...
			//CmnDiagSetFocus(m_pDiag, m_uInfo.intRowMax, ID_COL_152_TEKI);
			CmnDiagSetFocus(m_pDiag, nMaxDataCol, ID_COL_152_TEKI);
		}
		break;
	case VK_DOWN:
		// タイトルコントロールへ移動
...
// タイトルコントロールのフォーカス設定
void	CfrmUc152Kenrikin::FocusTitlediag1()
{
//マウスクリックでキャレットが表示できないためコメントとする
//	// ボタンからTabキー移動した場合に必要
//	m_TitleDiag.SetPosition( 0 );
...
// タイトルコントロールのゲットフォーカス
void	CfrmUc152Kenrikin::EditONTitlediag1( short index )
{
// midori 151405 add -->
	// スクロールフラグをクリアする
	nG_MScroll = 0;
...
// タイトルコントロールのロストフォーカス
void	CfrmUc152Kenrikin::EditOFFTitlediag1 (short index )
{
// midori 151405 add -->
	m_Titlefocus = 0;
// midori 151405 add <--
...
//	タイトル更新
void CfrmUc152Kenrikin::virUpdateTitle()
{
...
// タイトルコントロールのキーイベント
void	CfrmUc152Kenrikin::TerminationTitlediag1( short index, short nChar, short length, LPUNKNOWN data )
{
	// フォーカス移動
	switch ( nChar ) {
	case VK_RETURN:
...
void	CfrmUc152Kenrikin::EditONYoushikidiag1( short index )
{
...
// 修正No.157633_元号日付 add -->
	if(bG_Kanso == TRUE)	{
		...
		if(m_uInfo.intCurCol == ID_COL_152_SPDATE)	m_uInfo.EditSign = 1;
		else										m_uInfo.EditSign = -1;
	}
// 修正No.157633_元号日付 add <--

	switch (m_uInfo.intCurCol) {
	case ID_COL_152_SPDATE:	// 支払年月日
// midori 200101 del -->
		//// 日付の値を取得
...
// データコントロールのロストフォーカス
void	CfrmUc152Kenrikin::EditOFFYoushikidiag1( short index )
{
	if( m_EndView != FALSE )	return;
...
//	入力確定
void CfrmUc152Kenrikin::virInputDecisionEditOFF()
{
	// フォーカスフラグOFF
...
// 権利金データコントロールのキーイベント
void	CfrmUc152Kenrikin::TerminationYoushikidiag1( short index, short nChar, short length, LPUNKNOWN data )
{
	//--------------------------------------------------------------------------------
	//	キー操作仕様
...
// midori 151405 add -->
void CfrmUc152Kenrikin::VScrollYoushikidiag1(short mode)
{
...
//********************************************************************************
int	CfrmUc152Kenrikin::GetFocusPosition( int nChar )
{
	int		intRow;				// カレント行番号
	int		intCol;				// カレント列番号
	...
	else if ( intCol == ID_COL_152_ADADD1 ) {
		// カレント列が「支払先の所在地1」の場合
	...
	else if ( intCol == ID_COL_152_ADADD2 ) {
		// カレント列が「支払先の所在地2」の場合
		intVector[0] = m_uInfo.intCurCtlIndex - 1;						// ↑
		intVector[1] = m_uInfo.intCurCtlIndex + 1;						// →
	...
	else if ( intCol == ID_COL_152_TEKI ) {
		// カレント列が「摘要」の場合
...
//********************************************************************************
int	CfrmUc152Kenrikin::GetTotalRowIndex( int nCharOrg, int intIndex, int intNext )
{
	...
	if ( nNowRow <= nBorder[0] ){
		...
		if (( intNext > CmnGetControlIndex( m_uInfo.intRowMax, ID_COL_152_TEKI ) ) && ( nCharOrg == VK_TAB )){
			return( -2 );
		}
		//	データ行を超えた？かつ計行あり？
		else if (( nNextRow > nBorder[0] ) && ( nBorder[1] > 0 )){
			//	計行に移動
			//nRet = CmnGetControlIndex( ( nBorder[1] + 2 ), ID_COL_152_ADNAME1 );
			if (nCharOrg == VK_TAB) {
				return -2;
			}
		}
	...
	//	現在、頁計に居る
		...
		case VK_UP:			// ↑：23行目のデータ行の支店名項目へ移動
			nRet = CmnGetControlIndex( nBorder[0], ID_COL_152_ADADD2 );
			break;
		case VK_LEFT:		// ←/Shift+Tab：23行目のデータ行の摘要項目へ移動
			nRet = CmnGetControlIndex( nBorder[0], ID_COL_152_TEKI );
			break;
		default:			// →/↓/Return/Tab：25行目の合計行②へ移動
			...
			//	累計なし
				...
				nRet = CmnGetControlIndex( ( nBorder[2] + 2 ), ID_COL_152_ADNAME1 );
			}
			break;
		}
	}
...
//********************************************************************************
int	CfrmUc152Kenrikin::virTblSortSubSortProc( CdlgSort* pCdlgSort, CdbUc000Common* rsData )
{
	CdbUc152Kenrikin*	rs;
	CString				strFilter;
	CString				strSort;
...
/**********************************************************************
	...
	戻値
		int		成功/失敗
				FUNCTION_OK
***********************************************************************/
int	CfrmUc152Kenrikin::RecBufSetData( CdbUc152Kenrikin* prmDbRec )
{
...
/**********************************************************************
	...
	戻値
		int		成功/失敗
				FUNCTION_OK
***********************************************************************/
int	CfrmUc152Kenrikin::RecBufClearAllData()
{
...
/**********************************************************************
	...
	戻値
		int		成功/失敗
				FUNCTION_OK
***********************************************************************/
int	CfrmUc152Kenrikin::RecBufClearData( P_REC_UC_152_KENRIKIN inRecData )
{
...
/**********************************************************************
	...
	戻値
		int				成功(更新あり)/成功(更新なし)/失敗
						...
						FUNCTION_NG		: 失敗
***********************************************************************/
int	CfrmUc152Kenrikin::virRecBufSaveData( int inPage, int inRow )
{
	...
	// 支払先の名称1
	intIndex = CmnGetControlIndex( inRow, ID_COL_152_ADNAME1 );
	tmpSaveData.m_AdName1 = m_clsFunc.DiagGetString( m_pDiag, intIndex );

	// 支払先の所在地1
	intIndex = CmnGetControlIndex( inRow, ID_COL_152_ADADD1 );
	tmpSaveData.m_AdAdd1 = m_clsFunc.DiagGetString( m_pDiag, intIndex );

	// 支払先の所在地2
	intIndex = CmnGetControlIndex( inRow, ID_COL_152_ADADD2 );
	tmpSaveData.m_AdAdd2 = m_clsFunc.DiagGetString( m_pDiag, intIndex );

	// 支払年月日
	intIndex = CmnGetControlIndex( inRow, ID_COL_152_SPDATE );
// midori 200101 del -->
...
// midori 200101 add <--
	...
	// 支払金額
	intIndex = CmnGetControlIndex( inRow, ID_COL_152_VAL );
	tmpSaveData.m_Val = CmnDiagGetKingaku( m_pDiag, intIndex );

	// 権利金等の内容
	intIndex = CmnGetControlIndex( inRow, ID_COL_152_NAIYOU );
	tmpSaveData.m_Naiyou = m_clsFunc.DiagGetString( m_pDiag, intIndex );

	// 摘要
	intIndex = CmnGetControlIndex( inRow, ID_COL_152_TEKI );
...
***********************************************************************/
int	CfrmUc152Kenrikin::virRecBufSaveDataForPasteInsert( int inPage, int inRow )
{
...
***********************************************************************/
int	CfrmUc152Kenrikin::virRecBufSaveDataForPaste( int inPage, int inRow )
{
	///////////////////////////////////////////////////////////////
	// 登録処理呼び出し
	return RecBufSaveDataSub( inPage, inRow, &m_CopyData );
...
/**********************************************************************
	...
	戻値
			int					成功(更新あり)/成功(更新なし)/失敗
								...
								FUNCTION_NG		: 失敗
***********************************************************************/
int	CfrmUc152Kenrikin::RecBufSaveDataSub( 
							int inPage,
							int inRow,
...
/*
	CString	tmp_AdName1;	// 画面上のデータ格納用(支払先の名称1)
	CString	tmp_AdAdd1;	// 画面上のデータ格納用(支払先の所在地1)
	CString	tmp_AdAdd2;	// 画面上のデータ格納用(支払先の所在地2)
	long	tmp_SpDate;	// 画面上のデータ格納用(支払年月日)
	CString	tmp_Val;	// 画面上のデータ格納用(支払金額)
	CString	tmp_Naiyou;	// 画面上のデータ格納用(権利金等の内容)
...
//	// 変更があったかのフラグ（変更あり:TRUE、なし:FALSE)
	...
	if ( udtTemp.m_FgFunc <= ID_FGFUNC_DATA ) {	// データ行 または、空行なら
		...
		if ( ( udtTemp.m_AdName1 == "" )		// 画面上のデータ格納用(支払先の名称1)
...
//********************************************************************************
CdbUc000Common*	CfrmUc152Kenrikin::virGetDataTableObject()
{
	// 「権利金」テーブルのオブジェクトを生成し、ポインタを返す
...
//	RET	なし
//********************************************************************************
void	CfrmUc152Kenrikin::virRowButtonCopyProc()
{
...
//	RET	なし
//********************************************************************************
void	CfrmUc152Kenrikin::virGetCurrentInfo( CURRENT_INFO* uCurInfo )
{
...
//********************************************************************************
int	CfrmUc152Kenrikin::virUpdateRelationTblChengeFormType()
{
...
//		RET		BOOL		TRUE:正常終了，FALSE:エラー
//********************************************************************************
BOOL CfrmUc152Kenrikin::virUpdateRelationTblChengeFormTypeSave()
{
	CfrmUc151Tidaiyatin	pfrm151;
	CfrmUc153Kougyou	pfrm153;
	BOOL				ret=FALSE;
...
//		RET		なし
//********************************************************************************
int	CfrmUc152Kenrikin::UpdateTbl152ChangeFormType()
{
	// 初期値設定
...
//	【戻値】	なし
//**************************************************
void CfrmUc152Kenrikin::SetInputMode( int nRow, long nMode )
{
	m_pDiag->ModifyItem( CmnGetControlIndex( nRow, ID_COL_152_ADNAME1 ), nMode );	//	支払先の名称	
	m_pDiag->ModifyItem( CmnGetControlIndex( nRow, ID_COL_152_ADADD1 ), nMode );	//	支払先の所在地（上段）
	m_pDiag->ModifyItem( CmnGetControlIndex( nRow, ID_COL_152_ADADD2 ), nMode );	//	支払先の所在地（下段）
	m_pDiag->ModifyItem( CmnGetControlIndex( nRow, ID_COL_152_SPDATE ), nMode );	//	支払年月日
	m_pDiag->ModifyItem( CmnGetControlIndex( nRow, ID_COL_152_VAL ), nMode );		//	支払金額
	m_pDiag->ModifyItem( CmnGetControlIndex( nRow, ID_COL_152_NAIYOU ), nMode );	//	権利金等の内容
	m_pDiag->ModifyItem( CmnGetControlIndex( nRow, ID_COL_152_TEKI ), nMode );		//	摘要
}
...
//	【戻値】	なし
//**************************************************
void CfrmUc152Kenrikin::SetDiagBackColor()
{
...
//***************************************************************************
BOOL CfrmUc152Kenrikin::virEndProc(void)
{
	TRACE(_T("***** CfrmUc152Kenrikin::virEndProc\n"));
...
// midori 151405 add -->
int CfrmUc152Kenrikin::CursorControl(short nChar, int sw)
{
	int				rv=0;
	int				intCol=0;
	int				pos=0;
...
// ------------------------------------------------------------------------------------------------------------------------
void CfrmUc152Kenrikin::TitleColorChg(void)
{
...
// 修正No.157626 add <--
	...
	// 権利金等の内容
// 修正No.157628 del -->
	//strSQL.Format(_T("select max(oversgn) from (select CASE when len(Replace(isnull(Naiyou,''),CHAR(13)+CHAR(10),'')) > %d then 1 else 0 end as oversgn from uc_152_kenrikin where FgShow=%d) tbl1"),UC_152_NAIYOU_LEN,ID_FGSHOW_OFF);
// 修正No.157628 del <--
// 修正No.157628 add -->
...
// 修正No.157628 add <--
	...
	// 摘要
// 修正No.157628 del -->
	//strSQL.Format(_T("select max(oversgn) from (select CASE when len(Replace(isnull(Teki,''),CHAR(13)+CHAR(10),'')) > %d then 1 else 0 end as oversgn from uc_152_kenrikin where FgShow=%d) tbl1"),UC_152_TEKI_LEN,ID_FGSHOW_OFF);
// 修正No.157628 del <--
// 修正No.157628 add -->
	strSQL.Format(_T("select max(oversgn) from (select CASE when len(%s) > %d then 1 else 0 end as oversgn from uc_152_kenrikin where FgShow=%d) tbl1"),
...
// 修正No.157628 add <--
	...
	// 項目タイトル(ヘッダ部)の再設定
// 修正No.157626 del -->
	//CmnHeadDiagSetTitle(&m_HeadDiag,4,_T("権利金等の内容(30)"),nCharOver[0]);
	//CmnHeadDiagSetTitle(&m_HeadDiag,5,_T("摘    要(40)"),nCharOver[1]);
// 修正No.157626 del <--
// 修正No.157626 add -->
	if(nCharOver[0] == 1)	CmnHeadDiagSetTitle(&m_HeadDiag,4,_T("権利金等の内容(30)"),1);
	else					CmnHeadDiagSetTitle(&m_HeadDiag,4,_T("権利金等の内容"),0);

	if(nCharOver[1] == 1)	CmnHeadDiagSetTitle(&m_HeadDiag,5,_T("摘  要(40)"),1);
...
// --------------------------------------------------------------------------------------------------------
void CfrmUc152Kenrikin::Date_ChkAndSet(short index, int col, short sign)
{
	short			sv_sel=0;
	int				sv_index=0;
	int				day=0,gen=0;
	...
	if(col != ID_COL_152_SPDATE)	return;
	...
	if(sign == 1)	{
		if(col == ID_COL_152_SPDATE)	{		// 支払年月日
...
// 修正No.162446 add -->
LRESULT CfrmUc152Kenrikin::OnUserReDrawView(WPARAM wParam, LPARAM lParam)
{
	virUpdateControlTblData();
	CmnDiagSetFocus(m_pDiag, 1, 1);
