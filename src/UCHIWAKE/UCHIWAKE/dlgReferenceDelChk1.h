...
class CdlgReferenceDelChk1 : public ICSDialog
{
	DECLARE_DYNAMIC(CdlgReferenceDelChk1)

public:
	CdlgReferenceDelChk1(CWnd* pParent = NULL);				// 標準コンストラクター
	CdlgReferenceDelChk1(UINT id, CWnd* pParent = NULL);	// コンストラクタ
	virtual ~CdlgReferenceDelChk1();						// デストラクタ

//// ダイアログ データ
//#ifdef AFX_DESIGN_TIME
	enum { IDD = IDD_DIALOG_REFERENCE_DELCHK1 };
//#endif
...
public:
	...
	CStatic				m_stcMsg5;
	CStatic				m_stcMsg6;
	CStatic				m_stcMsg7;	// 修正No.162360,162361 add
	CStatic				m_stcMsg8;	// 修正No.162360,162361 add
	CStatic				m_stcMsg9;	// 修正No.162389 add
	CStatic				m_stcMsg10;	// 修正No.162435 add
...
//						CString sName1, CString sName2, CString sName3, CArray<int,int> &cDelseq );						// 修正No.162360,162361 del
						CString sName1, CString sName2, CString sName3, CString sName4, CArray<int,int> &cDelseq );		// 修正No.162360,162361 add
