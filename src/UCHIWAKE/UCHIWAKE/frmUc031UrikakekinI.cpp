...
IMPLEMENT_DYNCREATE( CfrmUc031UrikakekinI, CfrmUc000Common )


BEGIN_MESSAGE_MAP( CfrmUc031UrikakekinI, CfrmUc000Common )
	ON_WM_SIZE()
	...
	ON_COMMAND( ID_PRINTSETUP_MENU, &CfrmUc031UrikakekinI::OnMenuPrintSetup )
	ON_COMMAND( ID_PRINTALL_MENU, &CfrmUc031UrikakekinI::OnMenuPrintAll )
	ON_COMMAND( ID_SPECIALROW_MENU, &CfrmUc031UrikakekinI::OnMenuSpecialRow )
	ON_COMMAND( ID_SORT_MENU, &CfrmUc031UrikakekinI::OnMenuSort )
	ON_COMMAND(ID_IKKATUADD_MENU, &CfrmUc031UrikakekinI::OnIkkatuAddMenu)
	ON_COMMAND( ID_DISPDIALOG_MENU, &CfrmUc031UrikakekinI::OnMenuIkkatuKingaku )
	ON_COMMAND( ID_ZEROMONEY_MENU, &CfrmUc031UrikakekinI::OnMenuZeroMoney )
	ON_COMMAND( ID_ZEROMONEYMOVE_MENU, &CfrmUc031UrikakekinI::OnMenuZeroMoneyMove )
	ON_COMMAND( ID_AMOUTDIALOG_MENU, &CfrmUc031UrikakekinI::OnMenuOutKeiSetup )
	ON_COMMAND( ID_CLEAR_MENU, &CfrmUc031UrikakekinI::OnMenuClear )
	ON_COMMAND( ID_RENDO_MENU, &CfrmUc031UrikakekinI::OnMenuZaimuRendo )
	ON_COMMAND( ID_TITLEMENU, &CfrmUc031UrikakekinI::OnMenuTitleRestore )
	ON_COMMAND( ID_USER_SETTING_MENU, &CfrmUc031UrikakekinI::OnMenuOptionSetting )
	ON_COMMAND( ID_COPY_SETTING_INFO_MENU, &CfrmUc031UrikakekinI::OnMenuCopySettingInfo )
	ON_COMMAND( ID_DELETE_DATA_MENU, &CfrmUc031UrikakekinI::OnMenuDeleteDataEachYoushiki )
	ON_BN_CLICKED( IDC_PAGEBACK_BUTTON1, &CfrmUc031UrikakekinI::OnPageBack )
	ON_BN_CLICKED( IDC_PAGENEXT_BUTTON1, &CfrmUc031UrikakekinI::OnPageNext )
	ON_BN_CLICKED( IDC_PAGENEW_BUTTON1, &CfrmUc031UrikakekinI::OnPageNew )
	ON_BN_CLICKED( IDC_PAGEINSERT_BUTTON1, &CfrmUc031UrikakekinI::OnPageInsert )
	ON_BN_CLICKED( IDC_ROWCOPY_BUTTON1, &CfrmUc031UrikakekinI::OnRowCopy )
	ON_BN_CLICKED( IDC_ROWPASTE_BUTTON1, &CfrmUc031UrikakekinI::OnRowPaste )
	ON_BN_CLICKED( IDC_ROWINSERT_BUTTON1, &CfrmUc031UrikakekinI::OnRowInsert )
	ON_BN_CLICKED( IDC_YOUSHIKINEXT_BUTTON1, &CfrmUc031UrikakekinI::OnMoveYoushikiNext )
	ON_BN_CLICKED( IDC_YOUSHIKIBACK_BUTTON1, &CfrmUc031UrikakekinI::OnMoveYoushikiBack )
	ON_UPDATE_COMMAND_UI( ID_BUTTON_F6, &CfrmUc031UrikakekinI::OnUpdateButtonF6 )
	ON_UPDATE_COMMAND_UI( ID_BUTTON_F7, &CfrmUc031UrikakekinI::OnUpdateButtonF7 )
	ON_UPDATE_COMMAND_UI( ID_BUTTON_F8, &CfrmUc031UrikakekinI::OnUpdateButtonF8 )
	ON_UPDATE_COMMAND_UI( ID_BUTTON_F9, &CfrmUc031UrikakekinI::OnUpdateButtonF9 )
	ON_UPDATE_COMMAND_UI( ID_BUTTON_F11, &CfrmUc031UrikakekinI::OnUpdateButtonF11 )
	ON_UPDATE_COMMAND_UI( ID_BUTTON_F12, &CfrmUc031UrikakekinI::OnUpdateButtonF12 )
	ON_UPDATE_COMMAND_UI( ID_BUTTON_HOME, &CfrmUc031UrikakekinI::OnUpdateButtonHome )
	ON_UPDATE_COMMAND_UI( ID_IKKATUADD_MENU, &CfrmUc031UrikakekinI::OnUpdateIkkatuaddMenu)
	ON_UPDATE_COMMAND_UI( ID_DISPDIALOG_MENU, &CfrmUc031UrikakekinI::OnUpdateMenuIkkatuKingaku )
	ON_UPDATE_COMMAND_UI( ID_SORT_MENU, &CfrmUc031UrikakekinI::OnUpdateMenuSort )
	ON_UPDATE_COMMAND_UI( ID_CLEAR_MENU, &CfrmUc031UrikakekinI::OnUpdateMenuClear )
	ON_UPDATE_COMMAND_UI( ID_ZEROMONEY_MENU, &CfrmUc031UrikakekinI::OnUpdateMenuZeroMoney )
	ON_UPDATE_COMMAND_UI( ID_ZEROMONEYMOVE_MENU, &CfrmUc031UrikakekinI::OnUpdateMenuZeroMoneyMove)
	ON_UPDATE_COMMAND_UI( ID_RENDO_MENU, &CfrmUc031UrikakekinI::OnUpdateMenuZaimuRendo )
	ON_UPDATE_COMMAND_UI(ID_SPECIALROW_MENU, &CfrmUc031UrikakekinI::OnUpdateMenuSpecialRow)
	ON_UPDATE_COMMAND_UI( ID_TITLEMENU, &CfrmUc031UrikakekinI::OnUpdateMenuTitleRestore )
	ON_UPDATE_COMMAND_UI( ID_DELETE_DATA_MENU, &CfrmUc031UrikakekinI::OnUpdateMenuDeleteDataEachYoushiki )
	ON_MESSAGE(WM_USER_REDRAWVIEW, OnUserReDrawView)
END_MESSAGE_MAP()


CfrmUc031UrikakekinI::CfrmUc031UrikakekinI()
	: CfrmUc000Common( CfrmUc031UrikakekinI::IDD )
{
...
CfrmUc031UrikakekinI::~CfrmUc031UrikakekinI()
{
	...
	TRACE(_T("***** CfrmUc031UrikakekinI::~CfrmUc031UrikakekinI\n"));

	//m_pDiag = NULL;
	//m_pTitleDiag = NULL;
}

void CfrmUc031UrikakekinI::DoDataExchange( CDataExchange* pDX )
{
...
void CfrmUc031UrikakekinI::OnInitialUpdate()
{
...
#ifdef _DEBUG
void CfrmUc031UrikakekinI::AssertValid() const
{
	CfrmUc000Common::AssertValid();
}

#ifndef _WIN32_WCE
void CfrmUc031UrikakekinI::Dump( CDumpContext& dc ) const
{
...
BEGIN_EVENTSINK_MAP( CfrmUc031UrikakekinI, CfrmUc000Common )
	ON_EVENT( CfrmUc031UrikakekinI, IDC_YOUSHIKIDIAG1, 3, CfrmUc031UrikakekinI::TerminationYoushikidiag1, VTS_I2 VTS_I2 VTS_I2 VTS_UNKNOWN )
	ON_EVENT( CfrmUc031UrikakekinI, IDC_YOUSHIKIDIAG1, 2, CfrmUc031UrikakekinI::EditOFFYoushikidiag1, VTS_I2 )
	ON_EVENT( CfrmUc031UrikakekinI, IDC_YOUSHIKIDIAG1, 1, CfrmUc031UrikakekinI::EditONYoushikidiag1, VTS_I2 )
	ON_EVENT( CfrmUc031UrikakekinI, IDC_YOUSHIKIDIAG1, 12, CfrmUc031UrikakekinI::VScrollYoushikidiag1, VTS_I2)
	ON_EVENT( CfrmUc031UrikakekinI, IDC_YOUSHIKIDIAG1, 8, CfrmUc031UrikakekinI::ComboSelYoushikidiag1, VTS_I2 VTS_UNKNOWN)

	ON_EVENT( CfrmUc031UrikakekinI, IDC_YOUSHIKIDIAG2, 3, CfrmUc031UrikakekinI::TerminationYoushikidiag1, VTS_I2 VTS_I2 VTS_I2 VTS_UNKNOWN )
	ON_EVENT( CfrmUc031UrikakekinI, IDC_YOUSHIKIDIAG2, 2, CfrmUc031UrikakekinI::EditOFFYoushikidiag1, VTS_I2 )
	ON_EVENT( CfrmUc031UrikakekinI, IDC_YOUSHIKIDIAG2, 1, CfrmUc031UrikakekinI::EditONYoushikidiag1, VTS_I2 )
	ON_EVENT( CfrmUc031UrikakekinI, IDC_YOUSHIKIDIAG2, 12, CfrmUc031UrikakekinI::VScrollYoushikidiag1, VTS_I2)
	ON_EVENT( CfrmUc031UrikakekinI, IDC_YOUSHIKIDIAG2, 8, CfrmUc031UrikakekinI::ComboSelYoushikidiag1, VTS_I2 VTS_UNKNOWN)

	ON_EVENT( CfrmUc031UrikakekinI, IDC_TITLEDIAG1, 3, CfrmUc031UrikakekinI::TerminationTitlediag1, VTS_I2 VTS_I2 VTS_I2 VTS_UNKNOWN )
	ON_EVENT( CfrmUc031UrikakekinI, IDC_TITLEDIAG1, 2, CfrmUc031UrikakekinI::EditOFFTitlediag1, VTS_I2 )
	ON_EVENT( CfrmUc031UrikakekinI, IDC_TITLEDIAG1, 1, CfrmUc031UrikakekinI::EditONTitlediag1, VTS_I2 )
	ON_EVENT( CfrmUc031UrikakekinI, IDC_TITLEDIAG1, 6, CfrmUc031UrikakekinI::FocusTitlediag1, VTS_NONE )

	ON_EVENT( CfrmUc031UrikakekinI, IDC_PAGEDIAG1, 3, CfrmUc031UrikakekinI::TerminationPagediag1, VTS_I2 VTS_I2 VTS_I2 VTS_UNKNOWN )
	ON_EVENT( CfrmUc031UrikakekinI, IDC_PAGEDIAG1, 2, CfrmUc031UrikakekinI::EditOFFPagediag1, VTS_I2 )
	ON_EVENT( CfrmUc031UrikakekinI, IDC_PAGEDIAG1, 1, CfrmUc031UrikakekinI::EditONPagediag1, VTS_I2 )
	ON_EVENT( CfrmUc031UrikakekinI, IDC_PAGEDIAG1, 6, CfrmUc031UrikakekinI::FocusPagediag1, VTS_NONE )
END_EVENTSINK_MAP()

//********************************************************************************
//	初期処理
//********************************************************************************
BOOL	CfrmUc031UrikakekinI::virStartJob()
{
	// 初期値設定
...
//	共通データの初期値設定
//********************************************************************************
void	CfrmUc031UrikakekinI::virSetInitialUchiwakeInfo()
{
	// 「売掛金」の固有データ
	m_uInfo.intOutKeiDialog = AM_TYPE_ALL;					// 計設定ダイアログのボタン指定
	m_uInfo.intRowMax = ID_ROWKOBETU_031;					// １頁内の合計行を含む全体の行数
	m_uInfo.intRowMaxData = ID_ROWKOBETU_031 - 1;			// １頁内のデータ行数（合計行は含まず）
	m_uInfo.intColMax = ID_COLMAX_031I;						// １行内のコントロール個数
	m_uInfo.intColMaxData = ID_COLMAXDATA_031I;				// １行内の列数
	m_uInfo.intCtlStartIndex = ID_CTLSTARTINDEX_031I;		// １行目の入力項目の先頭インデックス番号
	m_uInfo.intT1StartIndex = ID_T1STARTNORMAL_031I;		// 合計行①の先頭インデックス番号
	m_uInfo.intT2StartIndex = ID_T2STARTNORMAL_031I;		// 合計行②の入力項目の先頭インデックス番号
	m_uInfo.intCursolDefPos = ID_COL_031I_KNSEQ;			// カーソル移動時の初期位置（タイトルから↓，合計から↑で使用）
	m_uInfo.intCursolKeiPos = ID_COL_031I_KNSEQ;			// 合計行のカーソル移動位置（カーソル移動で使用）

	m_uInfo.intFormSeq = ID_FORMNO_031;						// 様式シーケンス番号
	m_uInfo.intFormNo = 3;									// 様式番号（uc_inf_sub）
	m_uInfo.intFormNo2 = 1;									// 様式番号枝番（uc_inf_sub）

	m_uInfo.intRowNormal = ID_ROWNORMAL_031;				// 通常時：１頁内の合計行を含む全体の行数
	m_uInfo.intRowKobetu = ID_ROWKOBETU_031;				// 個別時：１頁内の合計行を含む全体の行数
	m_uInfo.intT1StartNormal = ID_T1STARTNORMAL_031I;		// 通常時：合計行①の先頭インデックス
	m_uInfo.intT2StartNormal = ID_T2STARTNORMAL_031I;		// 通常時：合計行②の先頭インデックス
	m_uInfo.intT1StartKobetu = ID_T1STARTKOBETU_031I;		// 個別時：合計行①の先頭インデックス
	m_uInfo.intT2StartKobetu = ID_T2STARTKOBETU_031I;		// 個別時：合計行②の先頭インデックス
	m_uInfo.intRowKei = ID_ROWKEI_031;						// 帳表固定の合計行数（1:合計あり，0:なし）
	m_uInfo.intKei1StartIndex = ID_COL_031I_KEI1_MEISYO;	// 計ダイアグラム1行目の先頭インデックス
	m_uInfo.intKei2StartIndex = ID_COL_031I_KEI2_MEISYO;	// 計ダイアグラム2行目の先頭インデックス

	// 集計処理の設定
	m_uInfo.uCalcInfo.intMaxCount = ID_CALC_031_MAX;		// 集計フィールド件数
	m_uInfo.uCalcInfo.strField[0] = ID_CALC_031_FIELD1;		// 集計フィールド名称1
}
...
//	【戻値】	なし
//**************************************************
void CfrmUc031UrikakekinI::virSetInitialDiag()
{	
	// オブジェクト未生成時は処理を抜ける
	...
	//	コンボボックスの属性取得
	nIndex = CmnGetControlIndex( 1, ID_COL_031I_KNSEQ );
...
//	帳表固有変数の初期値設定
//********************************************************************************
void	CfrmUc031UrikakekinI::virSetInitialValue()
{
	// 1ページ分のローカルバッファをクリア
	RecBufClearAllData();
...
//	帳表コントロールの初期化（データ領域）
//********************************************************************************
BOOL	CfrmUc031UrikakekinI::InitialControlDataArea()
{
	int		intMax;
	int		i;
	int		len=0;
	...
	for ( i = m_uInfo.intCtlStartIndex; i < intMax; i += m_uInfo.intColMax ) {
		// ComboBox：クリア
		CmnDiagSetString(m_pDiag, i + ID_COL_031I_KNSEQ   - 1, "", 0);	// 科目
		CmnDiagSetString(m_pDiag, i + ID_COL_031I_INVONOT - 1, "", 0);	// 登録番号(T選択)
		
		// 漢字入力欄の初期化
		CmnDiagSetAttrInpmax( m_pDiag, i + ID_COL_031I_ADNAME1 - 1, MAX_KETA_031_ADNAME1 );		//	名称１
		CmnDiagSetAttrInpmax( m_pDiag, i + ID_COL_031I_ADADD1  - 1, MAX_KETA_031_ADADD1 );		//	住所１
		CmnDiagSetAttrInpmax( m_pDiag, i + ID_COL_031I_ADADD2  - 1, MAX_KETA_031_ADADD2 );		//	住所２
		CmnDiagSetAttrInpmax( m_pDiag, i + ID_COL_031I_TEKI    - 1, MAX_KETA_031_TEKI );		//	摘要
		
		// 金額欄：桁数初期化
		len = ID_VAL_031_K_DATA;
		CmnDiagSetAttrDigit( m_pDiag, i + ID_COL_031I_VAL - 1, len );	// 期末現在高
	...
	// 半角/全角設定
	CmnDiagSetAttrColZenHan( m_pDiag , ID_COL_031I_ADNAME1 );	// 名称1(氏名)
	CmnDiagSetAttrColZenHan( m_pDiag , ID_COL_031I_ADADD1 );	// 所在地1(住所)
	CmnDiagSetAttrColZenHan( m_pDiag , ID_COL_031I_ADADD2 );	// 所在地2(住所)
	CmnDiagSetAttrColZenHan( m_pDiag , ID_COL_031I_TEKI );		// 摘要
...
//********************************************************************************
BOOL	CfrmUc031UrikakekinI::InitialControlComboBox()
{
	DIAGRAM_DATA	diadata;		// ICSDIAG構造体（科目）
	DIAGRAM_DATA	diadata2;		// ICSDIAG構造体（科目）
	int				intTotalType;
	int				intMax;
	int				intIndex;		// 科目
	int				intIndex2;		// T選択
	...
	for(i = 1; i <= intMax; i++) {
		...
		// 科目
		intIndex = CmnGetControlIndex(i, ID_COL_031I_KNSEQ);
		// T選択
		intIndex2 = CmnGetControlIndex(i, ID_COL_031I_INVONOT);
...
//********************************************************************************
void	CfrmUc031UrikakekinI::InitialControlTotalArea()
{
	int		nKeiType;			//	計の種別
	int		nDataRow;			//	データ行属性
	...
	if(flg2 == 1)	{
		// 一括自動行の科目を入力可能にする
		m_pDiag->ModifyItem( CmnGetControlIndex( (nDataRowPos+1), ID_COL_031I_KNSEQ ), (DIAG_MDFY_EDIT | DIAG_MDFY_OPAQUE) );
	}
	...
	m_pDiagKei->ModifyItem(ID_COL_031I_KEI1_VAL, intKeiRow);
	m_pDiagKei->ModifyItem(ID_COL_031I_KEI2_VAL, intKeiRow);
}
...
//	RET	なし
//********************************************************************************
void	CfrmUc031UrikakekinI::InitialControlSpecialRow( int intRow, int intFgFunc )
{
	int				len=0;
	int				nIndex;		//	インデックス
	...
	switch ( intFgFunc ) {
		...
		case ID_FGFUNC_PAGEKEI:			//	累計
			// 桁数を設定
			len = ID_VAL_031_K_TOTAL;
			CmnDiagSetAttrDigit(m_pDiag, CmnGetControlIndex(intRow, ID_COL_031I_VAL), len);
			break;
	}
	...
	switch (intFgFunc) {
		...
		case ID_FGFUNC_IKKATUAUTO:		// 一括集計金額行（自動）
			...
			if(intFgFunc != ID_FGFUNC_IKKATUAUTO) {
				...
				m_pDiag->ModifyItem(CmnGetControlIndex(intRow, ID_COL_031I_KNSEQ), DIAG_MDFY_NODROPDOWN);
				// 「登録番号(T選択)」はComboBoxのため、DropDown不可とする
				m_pDiag->ModifyItem(CmnGetControlIndex(intRow, ID_COL_031I_INVONOT), DIAG_MDFY_NODROPDOWN);

				// ComboBoxの選択項目クリア
				m_clsFunc.DiagInit(&diadata);
				diadata.text_combo = _T("\r\n");
				m_pDiag->SetData(CmnGetControlIndex(intRow, ID_COL_031I_KNSEQ), (LPUNKNOWN)&diadata);
				m_pDiag->SetData(CmnGetControlIndex(intRow, ID_COL_031I_INVONOT), (LPUNKNOWN)&diadata);
			}
...
// 改良No.21-0086,21-0529 cor <--
				...
				if(intFgFunc == ID_FGFUNC_IKKATUAUTO)	{
					//	科目
					m_pDiag->ModifyItem(CmnGetControlIndex(intRow, ID_COL_031I_KNSEQ), DIAG_MDFY_INPUT);
				}
			}
			break;
...
//	帳表タイトル情報の表示
//********************************************************************************
void	CfrmUc031UrikakekinI::virUpdateControlTitle()
{
...
//	帳表ページ情報の表示
//********************************************************************************
void	CfrmUc031UrikakekinI::UpdateControlPage()
{
	BOOL	bBack = TRUE;
	BOOL	bNext = TRUE;
...
//	帳表データの表示（１ページ分）
//********************************************************************************
BOOL	CfrmUc031UrikakekinI::virUpdateControlTblData()
{
	int len = 0;
	...
	CdbUc031Urikakekin	dbRec( m_pDB );
	...
	// 頁計、累計行の桁数をセットする
	len = ID_VAL_031_K_TOTAL;
	CmnDiagSetAttrDigit( m_pDiagKei, ID_COL_031I_KEI1_VAL, len );
	CmnDiagSetAttrDigit( m_pDiagKei, ID_COL_031I_KEI2_VAL, len );
	...
	while ( !dbRec.IsEOF() ) {		// ファイル終端まで
		...
		// 科目
		CmnInitialControlFgStringCell( m_pDiag, dbRec.m_NumRow, ID_COL_031I_KNSEQ, dbRec.m_FgFunc, UC_KAMOKU_LEN, dbRec.m_KnName);
		// 摘要
		CmnInitialControlFgStringCell( m_pDiag, dbRec.m_NumRow, ID_COL_031I_TEKI, dbRec.m_FgFunc, UC_031_TEKI_LEN, dbRec.m_Teki);
...
//	保管件数の表示
//********************************************************************************
BOOL CfrmUc031UrikakekinI::virUpdateControlTblData2()
{
	int					hcnt=0;
	CString				cs=_T("");
...
//		IN		CdbUc031Urikakekin*	「売掛金」
//		RET		なし
//********************************************************************************
void	CfrmUc031UrikakekinI::UpdateControlRowData( CdbUc031Urikakekin* prmDbRec ) {
	...
	m_clsFunc.DiagInit( &diadata );
	// 読込み対象セル取得
	intCell = CmnGetControlIndex( prmDbRec->m_NumRow, ID_COL_031I_KNSEQ );
...
//********************************************************************************
//	帳表データの１行表示（累計，頁計行）
//		IN		CdbUc031Urikakekin*	「売掛金」テーブル情報
//		RET		なし
//********************************************************************************
void	CfrmUc031UrikakekinI::UpdateControlRowTotal( CdbUc031Urikakekin* prmDbRec ) {
	...
	// 頁計/累計の名称表示
	if ( intRowName > 0 ) {
		CmnDiagSetString( m_pDiagKei, CmnGetKeiDiagIndex( intRowName, ID_COL_031I_KEI1_MEISYO ), prmDbRec->m_KeiStr, 1 );
	}
	// 頁計/累計の金額表示
	if ( intRowVal > 0 ) {
		CmnDiagSetKingaku( m_pDiagKei, CmnGetKeiDiagIndex( intRowVal, ID_COL_031I_KEI1_VAL ), prmDbRec->m_Val );
	}
}
...
//		RET		なし
//********************************************************************************
void	CfrmUc031UrikakekinI::virFncCellCopyProc( CdbUc000Common* rsData )
{
	CdbUc031Urikakekin*	rs;
	int					intCol;	// 現在の列
	int					ind1,ind2;
	CString				cs1,cs2;

	rs = (CdbUc031Urikakekin*)rsData;
	...
	switch(intCol) {
		// 科目
		case ID_COL_031I_KNSEQ:
			CmnDiagSetCombo2(m_pDiag, m_uInfo.intCurCtlIndex, rs->m_KnOrder);
			break;
		// 登録番号（T選択）
		case ID_COL_031I_INVONOT:
		// 登録番号（法人番号）
		case ID_COL_031I_INVONO:
			if(intCol == ID_COL_031I_INVONOT) {
...
//********************************************************************************
int	CfrmUc031UrikakekinI::virFncReferenceGetType(int intCol, int* intGrSeq, long* lngItemSeq, int* intAdd1, int* intAdd2, int* intAdd1Col, int* intAdd2Col, REFERENCE_INFO* pudReference )
{
	int				intRefType;
	...
	switch (intCol) {
		...
		case ID_COL_031I_ADADD2:
			...
			*intAdd1 = MAX_KETA_031_ADADD1 * 2;			// Byte指定
			*intAdd2 = MAX_KETA_031_ADADD2 * 2;			// Byte指定
			*intAdd1Col = ID_COL_031I_ADADD1;
			*intAdd2Col = ID_COL_031I_ADADD2;
			break;
...
//		RET		なし
//********************************************************************************
void	CfrmUc031UrikakekinI::virFncReferenceSetData( CdlgReference* dlgRef, int intRefType, int intCol )
{
	int			nCurRow;	//	カレント行
	int			nCurCol;	//	カレント列
	int			nPos;		//	位置
	...
	case ID_DLGTYPE_ADDRESS:
		...
		if(intCol == ID_COL_031I_INVONOT)	{
			//	現在行の取引先の名称１の位置を算出
			nPos = ((nCurRow - 1) * m_uInfo.intColMax) + (m_uInfo.intCtlStartIndex + (ID_COL_031I_INVONOT - 1));
		...
		else if(intCol == ID_COL_031I_INVONO)	{
			//	現在行の取引先の名称１の位置を算出
			nPos = ((nCurRow - 1) * m_uInfo.intColMax) + (m_uInfo.intCtlStartIndex + (ID_COL_031I_INVONO - 1));
		...
		else if(intCol == ID_COL_031I_ADNAME1) {
			//	現在行の取引先の名称１の位置を算出
			nPos = ((nCurRow - 1) * m_uInfo.intColMax) + (m_uInfo.intCtlStartIndex + (ID_COL_031I_ADNAME1 - 1));
...
//		RET		なし
//********************************************************************************
void	CfrmUc031UrikakekinI::virFncReferenceUpdateTbl( int intRefType, int nRefMode/*=0*/ )
{
	switch (intRefType) {
...
//		RET		なし
//********************************************************************************
void	CfrmUc031UrikakekinI::virFncReferenceSetICSData(CdlgAddressSearch* dlgAddd)
{
	int			intIndex;

	// 相手先の所在地1(住所)
	intIndex = CmnGetControlIndex( m_uInfo.intCurRow, ID_COL_031I_ADADD1 );
	CmnDiagSetString( m_pDiag, intIndex, dlgAddd->m_AdAdd1, 0 );

	// 相手先の所在地2(住所)
	intIndex = CmnGetControlIndex( m_uInfo.intCurRow, ID_COL_031I_ADADD2 );
	CmnDiagSetString( m_pDiag, intIndex, dlgAddd->m_AdAdd2, 0 );
}

void CfrmUc031UrikakekinI::virActivateFrameK(UINT nState, CFrameWnd* pDeactivateFrame)
{
	int		index = 0;
	...
	if(pWnd != NULL)	{
		if(m_DataKakutei == FALSE)	{
			if(m_uInfo.intCurCol == ID_COL_031I_KNSEQ)	{
				virKamokuAddCancel();
			}
		}
	}
...
void CfrmUc031UrikakekinI::virKamokuAddCancel()
{
	...
	// 科目列なら
	if(m_uInfo.intCurCol == ID_COL_031I_KNSEQ && m_F9OnSw != TRUE)	{
		DIAGRAM_DATA	diadata;
		m_pDiag->GetData(m_uInfo.intCurCtlIndex,(LPUNKNOWN)&diadata);
		// 【新規作成】が選択されていれば
		if(diadata.data_combo > m_CmbCnt)	{
			// 前回の値に戻す
			CmnDiagSetCombo(m_pDiag,CmnGetControlIndex(m_uInfo.intCurRow,ID_COL_031I_KNSEQ),m_uInfo.OldCombo);
		}
	}
}
...
//	その他イベント処理
//********************************************************************************
BOOL	CfrmUc031UrikakekinI::PreTranslateMessage( MSG* pMsg )
{
//	int				intID;
...
// 修正No.168362 add <--
						...
						//if(intCol == ID_COL_031I_KNSEQ)	{
						if(intCol == ID_COL_031I_KNSEQ || intCol == ID_COL_031I_INVONOT)	{
							rv=1;
						}
// 修正No.168362 add -->
					} 
// 修正No.168362 add <--
			...
			case VK_RIGHT:
				if(nG_MScroll == 1)	{
					...
					intCol = CmnGetControlCol();
					if(intCol == ID_COL_031I_KNSEQ && (pMsg->wParam == VK_LEFT || pMsg->wParam == VK_RIGHT))	{
...
// 頁コントロールのフォーカス設定
void	CfrmUc031UrikakekinI::FocusPagediag1()
{
}

// 頁コントロールのゲットフォーカス
void	CfrmUc031UrikakekinI::EditONPagediag1( short index )
{
// 修正No.168443 add -->
	// ---- 登録番号一覧関連 ----->
	if(pZmSel && pZmSel->IsDisplay() != FALSE) {
...
// 頁コントロールのロストフォーカス
void	CfrmUc031UrikakekinI::EditOFFPagediag1( short index )
{
...
// 頁コントロールのキー操作
void	CfrmUc031UrikakekinI::TerminationPagediag1( short index, short nChar, short length, LPUNKNOWN data )
{
	int nMaxDataCol = 0;
	// カレント頁の合計行の種別を取得
	...
	switch ( nChar ) {
		...
		case VK_TAB:
			...
			if ( CmnCheckShiftKey() == FALSE ) {
				...
				CmnDiagSetFocus(m_pDiag, nMaxDataCol, ID_COL_031I_TEKI);
			}
			break;
		case VK_DOWN:
			// タイトルコントロールへ移動
...
// タイトルコントロールのフォーカス設定
void	CfrmUc031UrikakekinI::FocusTitlediag1()
{
}

// タイトルコントロールのゲットフォーカス
void	CfrmUc031UrikakekinI::EditONTitlediag1( short index )
{
// 修正No.168443 add -->
	// ---- 登録番号一覧関連 ----->
	if(pZmSel && pZmSel->IsDisplay() != FALSE) {
...
// タイトルコントロールのロストフォーカス
void	CfrmUc031UrikakekinI::EditOFFTitlediag1 (short index )
{
	m_Titlefocus = 0;
	virUpdateTitle();
}
...
//	タイトル更新
void CfrmUc031UrikakekinI::virUpdateTitle()
{
...
// タイトルコントロールのキーイベント
void	CfrmUc031UrikakekinI::TerminationTitlediag1( short index, short nChar, short length, LPUNKNOWN data )
{
	// フォーカス移動
	switch ( nChar ) {
		case VK_RETURN:
...
//********************************************************************************
//	「売掛金」データコントロール処理（EditON，EditOFF，Terminationイベント）
//********************************************************************************

// 「売掛金」データコントロールのゲットフォーカス
void	CfrmUc031UrikakekinI::EditONYoushikidiag1( short index )
{
	DIAGRAM_DATA	diadata;
	...
	switch (m_uInfo.intCurCol) {
		...
		case ID_COL_031I_INVONOT:	// 登録番号(T選択)
			// コンボボックスのオフセット値取得
			m_pDiag->GetData(m_uInfo.intCurCtlIndex, (LPUNKNOWN)&diadata);
			m_uInfo.OldCombo = diadata.data_combo;
			break;
	...
	if (( m_uInfo.OldRow > 0 ) ) {
		if ( m_uInfo.OldPage == m_uInfo.intCurPage && m_uInfo.OldPage > 0 ) {
			...
			BOOL adadd1_to_adadd2 = IsSaveMoveReference(ID_COL_031I_ADADD1, ID_COL_031I_ADADD2);
			// [Home]キー押下の住所検索ダイアログの戻り（フォーカスをセットしている）は保存しない（改良依頼No15-1613）
			BOOL adadd1_to_adadd1 = IsSaveMoveReference(ID_COL_031I_ADADD1, ID_COL_031I_ADADD1);	// 所在地1(住所)→所在地1(住所)
			BOOL adadd2_to_adadd2 = IsSaveMoveReference(ID_COL_031I_ADADD2, ID_COL_031I_ADADD2);	// 所在地2(住所)→所在地2(住所)　所在地2から住所が長すぎる場合、ここがFALSEになる
			// T選択⇔登録番号は保存しない
			BOOL tsel_to_invno = IsSaveMoveReference(ID_COL_031I_INVONOT, ID_COL_031I_INVONO);
			// データ保存
	...
	if(m_uInfo.intCurCol == ID_COL_031I_INVONO && m_EndSyorityu == 0)	{
// 修正No.168377 del -->
...
// 修正No.168377 add -->
		// 登録番号のT選択の値を取得
		int pos = CmnGetControlIndex(m_uInfo.intCurRow, ID_COL_031I_INVONOT);
...
// データコントロールのロストフォーカス
void	CfrmUc031UrikakekinI::EditOFFYoushikidiag1( short index )
{
	if(m_EndView != FALSE)	return;

// 修正No.168443 add -->
	// ---- 登録番号一覧関連 ----->
	if(m_uInfo.intCurCol != ID_COL_031I_INVONO) {
		if(pZmSel && pZmSel->IsDisplay() != FALSE) {
			pZmSel->DialogOFF();
		}
	}
...
// 修正No.168443 del -->
	//// ---- 登録番号一覧関連 ----->
	//if(pZmSel && m_uInfo.intCurCol != ID_COL_031I_INVONO) {
	...
	//		//// カーソル移動処理
	//		//CmnDiagSetFocus( m_pDiag, m_uInfo.intCurRow, ID_COL_031I_INVONO );
	//	}
	//}
// 修正No.168443 del <--
// 修正No.168443 add -->
...
//	入力確定
void CfrmUc031UrikakekinI::virInputDecisionEditOFF()
{
	// フォーカスフラグOFF
...
// 預貯金データコントロールのキーイベント
void	CfrmUc031UrikakekinI::TerminationYoushikidiag1( short index, short nChar, short length, LPUNKNOWN data )
{
	//--------------------------------------------------------------------------------
	//	キー操作仕様
...
void CfrmUc031UrikakekinI::VScrollYoushikidiag1(short mode)
{
	int		sign = 0;	// 修正No.168420 add
...
//********************************************************************************
int	CfrmUc031UrikakekinI::GetFocusPosition( int nChar )
{
	int		intRow;					// カレント行番号
	int		intCol;					// カレント列番号
	...
	else if ( intCol == ID_COL_031I_ADADD1 ){
		// カレント列が「住所１」の場合
	...
	else if ( intCol == ID_COL_031I_ADADD2 ){
		// カレント列が「住所２」の場合
	...
	else if ( intCol == ID_COL_031I_TEKI ){
		// カレント列が「摘要」の場合
	...
	switch (nChar) {
		...
		case VK_RETURN:	// Enterキーでカーソルを下に移動するモード対応
			if(m_ReturnMoveDown) {
				if(intCol == ID_COL_031I_INVONOT)	intNext = intVector[1];			//	カレント列が「登録番号(T表示)」欄の場合「→」キーと同じ
		...
		case VK_TAB:
			if (CmnCheckShiftKey() == FALSE) {
				...
				// それ以外は「←」キーと同じ
				if ((intRow <= 1) && (intCol == ID_COL_031I_KNSEQ)) {
					return -1;
				}
...
//********************************************************************************
int	CfrmUc031UrikakekinI::GetTotalRowIndex( int nCharOrg, int intIndex, int intNext )
{
	...
	//	現在、頁計に居る
		...
		switch ( nCharTemp ){
			case VK_UP:			// ↑：23行目のデータ行の支店名項目へ移動
				nRet = CmnGetControlIndex( nBorder[0], ID_COL_031I_ADNAME1 );
				break;
			case VK_LEFT:		// ←/Shift+Tab：23行目のデータ行の摘要項目へ移動
				nRet = CmnGetControlIndex( nBorder[0], ID_COL_031I_TEKI );
				break;
			default:			// →/↓/Return/Tab：25行目の合計行②へ移動
				...
				//	累計あり
					...
					nRet = CmnGetControlIndex( ( nBorder[2] + 1 ), ID_COL_031I_KNSEQ );
				}
				break;
		}
	}
	//	現在、累計に居る場合
		...
		switch ( nCharTemp ){
			...
			case VK_LEFT:		// ←/Shift+Tab：24行目の合計行① or 24行目のデータ行の摘要項目へ移動
				nRet = CmnGetControlIndex( ( nBorder[1] + 1 ), ID_COL_031I_KNSEQ );
				break;
			default:			// →/↓：移動できない
				// 例外処理：最終項目で"Tab"は別コントロールへ移動
				// それ以外は「→」キーと同じ
...
//		RET		なし
//********************************************************************************
void	CfrmUc031UrikakekinI::virTblEditIkkatuLine( int nType, CdbUc000Common* rsData,
...
//********************************************************************************
int	CfrmUc031UrikakekinI::virTblSortSubSortProc( CdlgSort* pCdlgSort, CdbUc000Common* rsData )
{
	CdbUc031Urikakekin*	rs;
	CString				strFilter;
	CString				strSort;
...
/**********************************************************************
	RecBufSetData(CdbUc031Urikakekin* prmDbRec)
		ローカルのレコードバッファに、1行分のデータを格納する

	引数
		CdbUc031Urikakekin*	prmDbRec	レコードセット(データがあること）
	戻値
		int		成功/失敗
				FUNCTION_OK
***********************************************************************/
int	CfrmUc031UrikakekinI::RecBufSetData( CdbUc031Urikakekin* prmDbRec )
{
...
/**********************************************************************
	...
	戻値
		int		成功/失敗
				FUNCTION_OK
***********************************************************************/
int	CfrmUc031UrikakekinI::RecBufClearAllData()
{
...
/**********************************************************************
	...
	引数
		P_REC_UC_031_URIKAKEKIN inRecData レコードへのポインタ
	戻値
		int		成功/失敗
				FUNCTION_OK
***********************************************************************/
int	CfrmUc031UrikakekinI::RecBufClearData( P_REC_UC_031_URIKAKEKIN inRecData )
{
	inRecData->m_Seq			= 0;
...
/**********************************************************************
	...
	戻値
		int				成功(更新あり)/成功(更新なし)/失敗
						...
						FUNCTION_NG		: 失敗
***********************************************************************/
int	CfrmUc031UrikakekinI::virRecBufSaveData( int inPage, int inRow )
{
	REC_UC_031_URIKAKEKIN	tmpSaveData;	// 画面データ1レコード格納用
	...
	// 科目
	intIndex = CmnGetControlIndex( inRow, ID_COL_031I_KNSEQ );
	...
	// 登録番号（T選択）
	intIndex = CmnGetControlIndex(inRow, ID_COL_031I_INVONOT);
	m_pDiag->GetData(intIndex, (LPUNKNOWN)&diadata);
	tsel = diadata.data_combo;

	// 登録番号（法人番号）
	intIndex = CmnGetControlIndex(inRow, ID_COL_031I_INVONO);
...
// 修正No.168534,168539 add <--
	...
	intIndex = CmnGetControlIndex( inRow, ID_COL_031I_ADNAME1 );
	...
	if ( tmpSaveData.m_AdName2.IsEmpty() ){
		if(m_uInfo.intCurCol == ID_COL_031I_ADNAME1 && m_uInfo.intCurRow != m_uInfo.OldRow){	// 各カラムごとにvirRecBufSaveData()がコールされるようになり、かつタイミングがEditOffからEditOnに移ったことによりCmnDiagSetString()でカレットが末尾から先頭に移ってしまう為、制御
			CmnDiagSetString( m_pDiag, intIndex, tmpSaveData.m_AdName1, 0 );
		}
	}

	// 所在地1(住所)
	intIndex = CmnGetControlIndex( inRow, ID_COL_031I_ADADD1 );
	tmpSaveData.m_AdAdd1 = m_clsFunc.DiagGetString( m_pDiag, intIndex );

	// 所在地2(住所)
	intIndex = CmnGetControlIndex( inRow, ID_COL_031I_ADADD2 );
	tmpSaveData.m_AdAdd2 = m_clsFunc.DiagGetString( m_pDiag, intIndex );

	// 期末現在高
	intIndex = CmnGetControlIndex( inRow, ID_COL_031I_VAL );
	tmpSaveData.m_Val = CmnDiagGetKingaku( m_pDiag, intIndex );

	// 摘要
	intIndex = CmnGetControlIndex( inRow, ID_COL_031I_TEKI );
...
***********************************************************************/
int	CfrmUc031UrikakekinI::virRecBufSaveDataForPasteInsert( int inPage, int inRow )
{
...
***********************************************************************/
int	CfrmUc031UrikakekinI::virRecBufSaveDataForPaste( int inPage, int inRow )
{
	///////////////////////////////////////////////////////////////
	// 登録処理呼び出し
	return RecBufSaveDataSub( inPage, inRow, &m_CopyData );
...
/**********************************************************************
	...
	戻値
			int					成功(更新あり)/成功(更新なし)/失敗
								...
								FUNCTION_NG		: 失敗
***********************************************************************/
int	CfrmUc031UrikakekinI::RecBufSaveDataSub( 
							int inPage,
							int inRow,
							P_REC_UC_031_URIKAKEKIN inSaveData )
{
	REC_UC_031_URIKAKEKIN	udTemp;			// 画面上のデータ格納用
	CString					cst;
	...
	// テーブルアクセスクラス
	CdbUc031Urikakekin	mfcRec( m_pDB );
...
// 修正No.168534,168539 del <--
// 修正No.168534,168539 add -->
		if((udTemp.m_FgFunc == ID_FGFUNC_DATA) && (ufgAd == TRUE))	{	// 変更ありの場合	// 修正No.168443 add
// 修正No.168534,168539 add <--
			CdbUcLstAddress		rsAdd(m_pDB);
...
//********************************************************************************
CdbUc000Common*	CfrmUc031UrikakekinI::virGetDataTableObject()
{
	// 「売掛金」テーブルのオブジェクトを生成し、ポインタを返す
	return (CdbUc000Common*)( new CdbUc031Urikakekin( m_pDB ) );
}
...
//	RET	なし
//********************************************************************************
void	CfrmUc031UrikakekinI::virRowButtonCopyProc()
{
...
//	RET	なし
//********************************************************************************
void	CfrmUc031UrikakekinI::virTblGetKamokuInfo( CdbUc000Common* rsData, SORTKAMOKU_INFO* uKamoku )
{
	CdbUc031Urikakekin*	rs = (CdbUc031Urikakekin*)rsData;
...
//	RET	なし
//********************************************************************************
void	CfrmUc031UrikakekinI::virGetCurrentInfo( CURRENT_INFO* uCurInfo )
{
...
//	【戻値】	なし
//**************************************************
void CfrmUc031UrikakekinI::SetInputMode( int nRow, long nMode )
{
	m_pDiag->ModifyItem( CmnGetControlIndex( nRow, ID_COL_031I_KNSEQ ), nMode );	//	科目（※科目がエディットボックスに変更された際に必要）
	m_pDiag->ModifyItem( CmnGetControlIndex( nRow, ID_COL_031I_INVONOT ), nMode );	//	登録番号（T選択）
	m_pDiag->ModifyItem( CmnGetControlIndex( nRow, ID_COL_031I_INVONO ), nMode );	//	登録番号
	m_pDiag->ModifyItem( CmnGetControlIndex( nRow, ID_COL_031I_ADNAME1 ), nMode );	//	名称（上段）
	m_pDiag->ModifyItem( CmnGetControlIndex( nRow, ID_COL_031I_ADADD1 ), nMode );	//	所在地（上段）
	m_pDiag->ModifyItem( CmnGetControlIndex( nRow, ID_COL_031I_ADADD2 ), nMode );	//	所在地（下段）
	m_pDiag->ModifyItem( CmnGetControlIndex( nRow, ID_COL_031I_VAL ), nMode );		//	期末現在高
	m_pDiag->ModifyItem( CmnGetControlIndex( nRow, ID_COL_031I_TEKI ), nMode );		//	摘要
}
...
//	【戻値】	なし
//**************************************************
void CfrmUc031UrikakekinI::SetDiagBackColor()
{
...
//		RET		なし					
//********************************************************************************
void CfrmUc031UrikakekinI::virRendoCreateData(CdbUc000Common* rsData, RENTEMP_INFO* uRenInfo)
{
	CString			strTemp;
	...
	if(sw != 0)	{
		m_clsFunc.StrDivisionEx( uRenInfo->strAdName , &strArry , ( MAX_KETA_031_ADNAME1 / 2 ) , 2 );
		if(sw == 1)	{
...
//		RET		なし					
//********************************************************************************
void CfrmUc031UrikakekinI::virRendoUpdateData(CdbUc000Common* rsData, RENTEMP_INFO* uRenInfo)
{
	CdbUc031Urikakekin*	rs = (CdbUc031Urikakekin*)rsData;
...
//***************************************************************************
BOOL CfrmUc031UrikakekinI::virEndProc(void)
{
	TRACE(_T("***** CfrmUc031UrikakekinI::virEndProc\n"));
...
void CfrmUc031UrikakekinI::ComboNew(short index)
{
	short			sv_sel=0;
...
int CfrmUc031UrikakekinI::CursorControl(short nChar, int sw)
{
	int				rv=0;
	int				intCol=0;
	int				pos=0;
	...
	if((nChar == VK_TAB && (key & 0x80) == 0x80) || (nChar == VK_LEFT) || (nChar == VK_RIGHT)) {
		...
		if(intCol == ID_COL_031I_INVONOT)	{	// 登録番号(T選択)
			m_pDiag->ComboDropDown(m_uInfo.intCurCtlIndex, FALSE);
			CmnDiagSetCombo(m_pDiag, m_uInfo.intCurCtlIndex, m_uInfo.OldCombo);
		}
	}
...
void CfrmUc031UrikakekinI::ComboSelYoushikidiag1(short index, LPUNKNOWN data)
{
...
// ------------------------------------------------------------------------------------------------------------------------
void CfrmUc031UrikakekinI::TitleColorChg(void)
{
	int					nCharOver[2]={0};		// 電子申告の文字数を超えたかどうかのサイン		1:電子申告の文字数を超えた
												// 様式③		[0]:科目(10文字)	[1]:摘要(50文字)
	CRecordset			rs(m_pDB);
	CString				strSQL=_T("");
	CString				strData=_T("");

	// 科目
	strSQL.Format(_T("select max(oversgn) from (select CASE when len(%s) > %d then 1 else 0 end as oversgn from uc_031_urikakekin where FgShow=%d) tbl1"),
	...
	// 摘要
	strSQL.Format(_T("select max(oversgn) from (select CASE when len(%s) > %d then 1 else 0 end as oversgn from uc_031_urikakekin where FgShow=%d) tbl1"),
		MakeReplaceSent(_T("Teki")),UC_031_TEKI_LEN,ID_FGSHOW_OFF);
	rs.Open( CRecordset::forwardOnly, strSQL);
	rs.GetFieldValue((short)0, strData);
	rs.Close();
	nCharOver[1] = 0;
	...
	if(nCharOver[1] == 1)	CmnHeadDiagSetTitle(&m_HeadDiag,6,_T("摘      要(50)"),1);
...
LRESULT CfrmUc031UrikakekinI::OnUserReDrawView(WPARAM wParam, LPARAM lParam)
{
	virUpdateControlTblData();
	CmnDiagSetFocus(m_pDiag, 1, 1);
...
//		RET		なし
// --------------------------------------------------------------------------------------------------------
void CfrmUc031UrikakekinI::virDiagGetHjnData(CDatabase* pDB, HJN_REC_NEW* phjnRec)
{
	int				nPage,nRow;
	int				intIndex;	// 対象行の各インデックス
	int				tsel=0;
	...
	// 登録番号（法人番号）
	cst.Empty();
	intIndex = CmnGetControlIndex(nRow, ID_COL_031I_INVONO);
	...
	// 名称1(氏名)
	intIndex = CmnGetControlIndex(nRow, ID_COL_031I_ADNAME1);
	m_clsFunc.StrDivision(m_clsFunc.DiagGetString(m_pDiag, intIndex), &strArray, 2, FALSE, TRUE);
	cst.Empty();
	...
	// 所在地1(住所)
	intIndex = CmnGetControlIndex(nRow, ID_COL_031I_ADADD1);
	cst = m_clsFunc.DiagGetString(m_pDiag, intIndex);
	cst.TrimRight();
	if(cst.IsEmpty() == FALSE)	{
		memset(buf, 0, sizeof(buf));
	...
	// 所在地2(住所)
	intIndex = CmnGetControlIndex(nRow, ID_COL_031I_ADADD2);
	cst = m_clsFunc.DiagGetString(m_pDiag, intIndex);
	cst.TrimRight();
	if(cst.IsEmpty() == FALSE) {
		memset(buf, 0, sizeof(buf));
...
//		RET		なし
// --------------------------------------------------------------------------------------------------------
void	CfrmUc031UrikakekinI::virDiagSetHjnData(int pSw, CString rtInvNo, CString rtName, CString rtAdrs1, CString rtAdrs2, CString rtKana)
{
	int					ret = 0;
	int					intIndex;
...
// 修正No.168361,168369,168371,168378 del <--
		// 登録番号（T選択）
		intIndex = CmnGetControlIndex(m_uInfo.intCurRow, ID_COL_031I_INVONOT);
		CmnDiagSetCombo3(m_pDiag, intIndex, strInvoNo);

		// 登録番号
		InvoNoSplit(strInvoNo, &cs1, &cs2);
		intIndex = CmnGetControlIndex(m_uInfo.intCurRow, ID_COL_031I_INVONO);
...
// --------------------------------------------------------------------------------------------------------
// --------------------------------------------------------------------------------------------------------
int CfrmUc031UrikakekinI::virCallChkInvoiceNum(int pSw, int inPage, int inRow)
{
...
//				CString		pInvno	登録番号
// --------------------------------------------------------------------------------------------------------
int CfrmUc031UrikakekinI::ChkInvoiceNum(CDatabase* pDB, int pSw, int inPage, int inRow,
										  CString pInvno/*=""*/, CString pName/*=""*/, CString pAdrs1/*=""*/, CString pAdrs2/*=""*/)
{
	int					intIndex;			// 対象行の各インデックス
	int					tsel=0;
	int					ret=0;
	//int					flg = 0;			// 修正No.168443 add
...
// 修正No.168361,168369,168371,168378 del -->
	...
	//		DIAGRAM_DATA	ddata;
	//		ddata.data_combo = 0;
	//		m_pDiag->SetData(CmnGetControlIndex(inRow, ID_COL_031I_INVONOT), (LPUNKNOWN)&ddata);
	//		ddata.data_edit.Empty();
	//		m_pDiag->DataClear(CmnGetControlIndex(inRow, ID_COL_031I_INVONO), TRUE);
	//		// エラーメッセージを表示
...
// 修正No.168443 add <--
			...
			if(pZmSel && pZmSel->IsDisplay() != FALSE && cst.GetLength() < 3) {
				...
				if(tmpzd.errflg != -1) {
					...
					m_pDiag->SetData(CmnGetControlIndex(inRow, ID_COL_031I_INVONO), (LPUNKNOWN)&ddata);
					// 再描画
					m_pDiag->Refresh();
...
// 修正No.168425,168443 add -->
					if(pSw == 3 || m_EndSyorityu == 1)	{
						...
						m_uInfo.intCurCol = ID_COL_031I_INVONO;
