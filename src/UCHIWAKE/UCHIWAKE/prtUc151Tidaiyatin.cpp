...
// FileName		: prtUc151Tidaiyatin.cpp
//
// ■印刷関連 動作定義
//
//**************************************************************************************************
...
int CprtUc151Tidaiyatin::GetDbDataSheet(int nPage, CprtJobFunction* parent, const PRT_OPTION& po, int nFormSeq/*=0*/)
{
	int rv = 0;
...
int CprtUc151Tidaiyatin::GetDbDataSheetNew(int nPage, CprtJobFunction* parent, const PRT_OPTION& po, int nFormSeq/*=0*/)
{
	int				nCurRow = 0;
...
// インボイス登録番号追加対応_23/10/25 del <--
// インボイス登録番号追加対応_23/10/25 add -->
int CprtUc151Tidaiyatin::GetDbDataSheetOld(int nPage, CprtJobFunction* parent, const PRT_OPTION& po, int nFormSeq/*=0*/)
// インボイス登録番号追加対応_23/10/25 add <--
{
	int				nCurRow			= 0;
	int				nVisualPage		= nPage;
...
CprtUc151Tidaiyatin::CprtUc151Tidaiyatin(CDatabase* pdb)
{
	m_pDB		= pdb;
...
CprtUc151Tidaiyatin::~CprtUc151Tidaiyatin(void)
{
}

CprtJobFunction* CprtUc151Tidaiyatin::virGetPrintObject(void)
{
	return (CprtJobFunction*)(new CprtUc151Tidaiyatin(m_pDB));
}