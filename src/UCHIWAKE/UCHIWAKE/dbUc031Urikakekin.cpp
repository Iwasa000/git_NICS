// dbUc031Urikakekin.cpp : インプリメンテーション ファイル
//
...
IMPLEMENT_DYNAMIC(CdbUc031Urikakekin, CdbUc000Common)

CdbUc031Urikakekin::CdbUc031Urikakekin(CDatabase* pdb)
	: CdbUc000Common(pdb)
{
	//{{AFX_FIELD_INIT(CdbUc031Urikakekin)
	m_Seq = 0;
	m_NumPage = 0;
	m_NumRow = 0;
	m_FgFunc = 0;
...
// midori 152137 add <--
	...
	m_lo_TableName = STR_TBL_NAME_031;			// テーブル名を記述
}


CString CdbUc031Urikakekin::GetDefaultSQL()
{
	return _T("[dbo].[uc_031_urikakekin]");
}

void CdbUc031Urikakekin::DoFieldExchange(CFieldExchange* pFX)
{
	//{{AFX_FIELD_MAP(CdbUc031Urikakekin)
...
/////////////////////////////////////////////////////////////////////////////
// CdbUc031Urikakekin 診断

#ifdef _DEBUG
void CdbUc031Urikakekin::AssertValid() const
{
	CRecordset::AssertValid();
}

void CdbUc031Urikakekin::Dump(CDumpContext& dc) const
{
	CRecordset::Dump(dc);
}
#endif //_DEBUG
...
/**********************************************************************
	...
	戻値
			int					DB_ERR_OK (0)     ：成功
								DB_ERR_OK (0) 以外：失敗
***********************************************************************/
int CdbUc031Urikakekin::CreateNewRecord()
{
...
//								DB_ERR_OK (0) 以外：失敗
//***********************************************************************/
//int CdbUc031Urikakekin::CreateNewRecord2(int pNumPage,int pNumRow)
// 157153 del <--
// 157153 add -->
// ------------------------------------------------------------------------------------------------
//	CreateNewRecord2()
...
//
// ------------------------------------------------------------------------------------------------
int CdbUc031Urikakekin::CreateNewRecord2(int pNumPage,int pNumRow,int pNullSw)
// 157153 add <--
{
	CRecordset	rs(m_lo_pdb);
	CString		SqlStr;
...
//								DB_ERR_OK (0) 以外：失敗
//***********************************************************************/
//int CdbUc031Urikakekin::UpdateYokukiZeroClear()
//{
...
/**********************************************************************
	...
	戻値
			int					DB_ERR_OK (0)     ：成功
								DB_ERR_OK (0) 以外：失敗
***********************************************************************/
int CdbUc031Urikakekin::UpdateYokukiZeroClear( int pSw )
{
// midori 152388 add -->
	CString	cs=_T("");
// midori 152388 add <--
...
/**********************************************************************
	...
	戻値
			int						正の数：行数
									...
									0     ：行なし
***********************************************************************/
int CdbUc031Urikakekin::GetKnNameFirstRow(int inPage, CString* pstrKnName, CString strTable)
{
...
***********************************************************************/
long CdbUc031Urikakekin::GetColumnSortAddressBank(BYTE ItemSeq)
{
...
***********************************************************************/
// virtual
int CdbUc031Urikakekin::UpdateDataTableWork()
{
...
***********************************************************************/
// virtual
int CdbUc031Urikakekin::GetSortIkkatuOrder()
{
	return m_KnOrder;
}