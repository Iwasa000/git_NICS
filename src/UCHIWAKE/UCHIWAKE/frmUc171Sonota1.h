...
// midori 170504 del <--
#define	ID_COLMAX_171			11		// １行内のコントロール個数
#define	ID_COLMAXDATA_171		6		// １行内の入力コントロール数
#define	ID_CTLSTARTINDEX_171	5		// １行目の入力項目の先頭インデックス番号
#define ID_T1STARTNORMAL_171	286		// 通常時：合計行①の先頭インデックス番号
#define ID_T2STARTNORMAL_171	297		// 通常時：合計行②の先頭インデックス番号
#define ID_T1STARTKOBETU_171	286		// 個別時：合計行①の先頭インデックス番号
#define ID_T2STARTKOBETU_171	297		// 個別時：合計行②の先頭インデックス番号
...
typedef enum {
	ID_COL_171_KNORDER = 1,				// 1	科目
	ID_COL_171_ADNAME1,					// 2	名称1
	ID_COL_171_ADADD1,					// 3	所在地1
	ID_COL_171_ADADD2,					// 4	所在地2
	ID_COL_171_VAL,						// 5	期末現在高
	ID_COL_171_TEKI,					// 6	摘要
} EnumIdFormCol171;
...
#define ID_COL_171_KEI1_MEISYO	0				// 計ダイアログ1行目の計名称（計or合計、頁計、累計）
// midori 152503 del -->
//#define ID_COL_171_KEI1_VAL		3				// 計ダイアログ1行目の期末現在高
//#define ID_COL_171_KEI2_MEISYO	7				// 計ダイアログ2行目の計名称（計or合計、頁計、累計）
//#define ID_COL_171_KEI2_VAL		10				// 計ダイアログ2行目の期末現在高
// midori 152503 del <--
// midori 152503 add -->
#define ID_COL_171_KEI1_VAL		4				// 計ダイアログ1行目の期末現在高
#define ID_COL_171_KEI2_MEISYO	8				// 計ダイアログ2行目の計名称（計or合計、頁計、累計）
#define ID_COL_171_KEI2_VAL		12				// 計ダイアログ2行目の期末現在高
// midori 152503 add <--
...
class CfrmUc171Sonota1: public CfrmUc000Common
{
	DECLARE_DYNCREATE( CfrmUc171Sonota1 )

public:
	CfrmUc171Sonota1();
	virtual	~CfrmUc171Sonota1();
