// dbUc042Kasituke.h : ヘッダー ファイル
//

#ifndef	_DB_UC_042_KASITUKE_H_
#define	_DB_UC_042_KASITUKE_H_

#include "dbUc000Common.h"

/////////////////////////////////////////////////////////////////////////////
// CdbUc042Kasituke レコードセット

class CdbUc042Kasituke : public CdbUc000Common
{
public:
...
// midori 160606 cor <--
	...
	CdbUc042Kasituke(CDatabase* pDatabase = NULL);
	DECLARE_DYNAMIC(CdbUc042Kasituke)

// フィールド/パラメータ データ
	//{{AFX_FIELD(CdbUc042Kasituke, CRecordset)
	long	m_AdSeq;
	long	m_AdOrder;
	CString	m_AdName1;
	CString	m_AdName2;
