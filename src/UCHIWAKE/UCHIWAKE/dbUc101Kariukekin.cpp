// dbUc101Kariukekin.cpp : インプリメンテーション ファイル
//
...
IMPLEMENT_DYNAMIC(CdbUc101Kariukekin, CdbUc000Common)

CdbUc101Kariukekin::CdbUc101Kariukekin(CDatabase* pdb)
	: CdbUc000Common(pdb)
{
	//{{AFX_FIELD_INIT(CdbUc101Kariukekin)
	m_Seq = 0;
	m_NumPage = 0;
	m_NumRow = 0;
	m_FgFunc = 0;
...
// midori 152137 add <--
	...
	m_lo_TableName = STR_TBL_NAME_101;			// テーブル名を記述
}


CString CdbUc101Kariukekin::GetDefaultSQL()
{
	return _T("[dbo].[uc_101_kariukekin]");
}

void CdbUc101Kariukekin::DoFieldExchange(CFieldExchange* pFX)
{
	//{{AFX_FIELD_MAP(CdbUc101Kariukekin)
...
/////////////////////////////////////////////////////////////////////////////
// CdbUc101Kariukekin 診断

#ifdef _DEBUG
void CdbUc101Kariukekin::AssertValid() const
{
	CRecordset::AssertValid();
}

void CdbUc101Kariukekin::Dump(CDumpContext& dc) const
{
	CRecordset::Dump(dc);
}
#endif //_DEBUG
...
/**********************************************************************
	...
	戻値
			int					DB_ERR_OK (0)     ：成功
								DB_ERR_OK (0) 以外：失敗
***********************************************************************/
int CdbUc101Kariukekin::CreateNewRecord()
{
...
//								DB_ERR_OK (0) 以外：失敗
//***********************************************************************/
//int CdbUc101Kariukekin::CreateNewRecord2(int pNumPage,int pNumRow)
// 157153 del <--
// 157153 add -->
// ------------------------------------------------------------------------------------------------
//	CreateNewRecord2()
...
//
// ------------------------------------------------------------------------------------------------
int CdbUc101Kariukekin::CreateNewRecord2(int pNumPage,int pNumRow,int pNullSw)
// 157153 add <--
{
	CRecordset	rs(m_lo_pdb);
	CString		SqlStr;
...
//								DB_ERR_OK (0) 以外：失敗
//***********************************************************************/
//int CdbUc101Kariukekin::UpdateYokukiZeroClear()
//{
...
/**********************************************************************
	...
	戻値
			int					DB_ERR_OK (0)     ：成功
								DB_ERR_OK (0) 以外：失敗
***********************************************************************/
int CdbUc101Kariukekin::UpdateYokukiZeroClear( int pSw )
{
// midori 152388 add -->
	CString	cs=_T("");
// midori 152388 add <--
...
// midori 152388 add -->
	if(pSw != 0)	{
		...
		cs += _T(" AND AdAdd1 IS NULL AND AdAdd2 IS NULL AND Kankei IS NULL");
		cs += _T(" AND Val IS NULL AND Naiyou IS NULL");
...
/**********************************************************************
	...
	戻値
			int						正の数：行数
									...
									0     ：行なし
***********************************************************************/
int CdbUc101Kariukekin::GetKnNameFirstRow(int inPage, CString* pstrKnName, CString strTable)
{
...
***********************************************************************/
long CdbUc101Kariukekin::GetColumnSortAddressBank(BYTE ItemSeq)
{
...
***********************************************************************/
// virtual
int CdbUc101Kariukekin::UpdateDataTableWork()
{
...
***********************************************************************/
// virtual
int CdbUc101Kariukekin::GetSortIkkatuOrder()
{
	return m_KnOrder;
}