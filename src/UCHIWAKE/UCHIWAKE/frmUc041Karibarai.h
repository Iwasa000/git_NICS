...
#define	ID_COLMAX_041			13		// １行内のコントロール個数
#define	ID_COLMAXDATA_041		7		// １行内の入力コントロール数
#define	ID_CTLSTARTINDEX_041	6		// １行目の入力項目の先頭インデックス番号
#define	ID_T1STARTNORMAL_041	143		// 合計行①の先頭インデックス番号（通常）
#define	ID_T2STARTNORMAL_041	156		// 合計行②の先頭インデックス番号（通常）
#define	ID_T1STARTKOBETU_041	377		// 合計行①の先頭インデックス番号（個別）
#define	ID_T2STARTKOBETU_041	390		// 合計行②の先頭インデックス番号（個別）
...
typedef enum {
	ID_COL_041_ADSEQ = 1,				// 1	科目
	ID_COL_041_ADNAME1,					// 2	名称1(氏名)
	ID_COL_041_ADADD1,					// 3	所在地1(住所)
	ID_COL_041_ADADD2,					// 4	所在地2(住所)
	ID_COL_041_KANKEI,					// 5	法人・代表者との関係
	ID_COL_041_VAL,						// 6	期末現在高
	ID_COL_041_NAIYOU,					// 7	取引の内容
} EnumIdFormCol041;
...
#define ID_COL_041_KEI1_MEISYO	0				// 計ダイアログ1行目の計名称（計or合計、頁計、累計）
// midori 152503 del -->
//#define ID_COL_041_KEI1_VAL		4				// 計ダイアログ1行目の期末現在高
//#define ID_COL_041_KEI2_MEISYO	6				// 計ダイアログ2行目の計名称（計or合計、頁計、累計）
//#define ID_COL_041_KEI2_VAL		10				// 計ダイアログ2行目の期末現在高
// midori 152503 del <--
// midori 152503 add -->
#define ID_COL_041_KEI1_VAL		5				// 計ダイアログ1行目の期末現在高
#define ID_COL_041_KEI2_MEISYO	7				// 計ダイアログ2行目の計名称（計or合計、頁計、累計）
#define ID_COL_041_KEI2_VAL		12				// 計ダイアログ2行目の期末現在高
// midori 152503 add <--
...
class CfrmUc041Karibarai: public CfrmUc000Common
{
	DECLARE_DYNCREATE( CfrmUc041Karibarai )

public:
	CfrmUc041Karibarai();
	virtual	~CfrmUc041Karibarai();
	void	virSetInitialValue();
// midori 152770 del -->
//	int		UpdateTbl041ChangeFormType();
// midori 152770 del <--
// midori 152770 add -->
