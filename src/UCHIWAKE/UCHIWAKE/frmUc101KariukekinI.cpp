...
//--------------------------------------------------
//	frmUc101KariukekinI.cpp
//--------------------------------------------------

#include "stdafx.h"
#include "UCHIWAKE.h"
#include "frmUc101Kariukekin.h"
#include "frmUc102Gensen.h"			// 通常/個別切り替えにて"⑩-2"データ更新が必要
...
IMPLEMENT_DYNCREATE( CfrmUc101KariukekinI, CfrmUc000Common )


BEGIN_MESSAGE_MAP( CfrmUc101KariukekinI, CfrmUc000Common )
	ON_WM_SIZE()
	...
	ON_COMMAND( ID_PRINTSETUP_MENU, &CfrmUc101KariukekinI::OnMenuPrintSetup )
	ON_COMMAND( ID_PRINTALL_MENU, &CfrmUc101KariukekinI::OnMenuPrintAll )
	ON_COMMAND( ID_OUTPUTFORM_MENU, &CfrmUc101KariukekinI::OnMenuFormTypeSetup )
	ON_COMMAND( ID_SPECIALROW_MENU, &CfrmUc101KariukekinI::OnMenuSpecialRow )
	ON_COMMAND( ID_SORT_MENU, &CfrmUc101KariukekinI::OnMenuSort )
	ON_COMMAND(ID_IKKATUADD_MENU, &CfrmUc101KariukekinI::OnIkkatuAddMenu)
	ON_COMMAND( ID_DISPDIALOG_MENU, &CfrmUc101KariukekinI::OnMenuIkkatuKingaku )
	ON_COMMAND( ID_ZEROMONEY_MENU, &CfrmUc101KariukekinI::OnMenuZeroMoney )
	ON_COMMAND( ID_ZEROMONEYMOVE_MENU, &CfrmUc101KariukekinI::OnMenuZeroMoneyMove )
	ON_COMMAND( ID_AMOUTDIALOG_MENU, &CfrmUc101KariukekinI::OnMenuOutKeiSetup )
	ON_COMMAND( ID_CLEAR_MENU, &CfrmUc101KariukekinI::OnMenuClear )
	ON_COMMAND( ID_RENDO_MENU, &CfrmUc101KariukekinI::OnMenuZaimuRendo )
	ON_COMMAND( ID_TITLEMENU, &CfrmUc101KariukekinI::OnMenuTitleRestore )
	ON_COMMAND( ID_USER_SETTING_MENU, &CfrmUc101KariukekinI::OnMenuOptionSetting )
	ON_COMMAND( ID_COPY_SETTING_INFO_MENU, &CfrmUc101KariukekinI::OnMenuCopySettingInfo )
	ON_COMMAND( ID_DELETE_DATA_MENU, &CfrmUc101KariukekinI::OnMenuDeleteDataEachYoushiki )
	ON_BN_CLICKED( IDC_PAGEBACK_BUTTON1, &CfrmUc101KariukekinI::OnPageBack )
	ON_BN_CLICKED( IDC_PAGENEXT_BUTTON1, &CfrmUc101KariukekinI::OnPageNext )
	ON_BN_CLICKED( IDC_PAGENEW_BUTTON1, &CfrmUc101KariukekinI::OnPageNew )
	ON_BN_CLICKED( IDC_PAGEINSERT_BUTTON1, &CfrmUc101KariukekinI::OnPageInsert )
	ON_BN_CLICKED( IDC_ROWCOPY_BUTTON1, &CfrmUc101KariukekinI::OnRowCopy )
	ON_BN_CLICKED( IDC_ROWPASTE_BUTTON1, &CfrmUc101KariukekinI::OnRowPaste )
	ON_BN_CLICKED( IDC_ROWINSERT_BUTTON1, &CfrmUc101KariukekinI::OnRowInsert )
	ON_BN_CLICKED( IDC_YOUSHIKINEXT_BUTTON1, &CfrmUc101KariukekinI::OnMoveYoushikiNext )
	ON_BN_CLICKED( IDC_YOUSHIKIBACK_BUTTON1, &CfrmUc101KariukekinI::OnMoveYoushikiBack )
	ON_UPDATE_COMMAND_UI( ID_BUTTON_F6, &CfrmUc101KariukekinI::OnUpdateButtonF6 )
	ON_UPDATE_COMMAND_UI( ID_BUTTON_F7, &CfrmUc101KariukekinI::OnUpdateButtonF7 )
	ON_UPDATE_COMMAND_UI( ID_BUTTON_F8, &CfrmUc101KariukekinI::OnUpdateButtonF8 )
	ON_UPDATE_COMMAND_UI( ID_BUTTON_F9, &CfrmUc101KariukekinI::OnUpdateButtonF9 )
	ON_UPDATE_COMMAND_UI( ID_BUTTON_F11, &CfrmUc101KariukekinI::OnUpdateButtonF11 )
	ON_UPDATE_COMMAND_UI( ID_BUTTON_F12, &CfrmUc101KariukekinI::OnUpdateButtonF12 )
	ON_UPDATE_COMMAND_UI( ID_BUTTON_HOME, &CfrmUc101KariukekinI::OnUpdateButtonHome )
	ON_UPDATE_COMMAND_UI( ID_IKKATUADD_MENU, &CfrmUc101KariukekinI::OnUpdateIkkatuaddMenu)
	ON_UPDATE_COMMAND_UI( ID_DISPDIALOG_MENU, &CfrmUc101KariukekinI::OnUpdateMenuIkkatuKingaku )
	ON_UPDATE_COMMAND_UI( ID_SORT_MENU, &CfrmUc101KariukekinI::OnUpdateMenuSort )
	ON_UPDATE_COMMAND_UI( ID_CLEAR_MENU, &CfrmUc101KariukekinI::OnUpdateMenuClear )
	ON_UPDATE_COMMAND_UI( ID_ZEROMONEY_MENU, &CfrmUc101KariukekinI::OnUpdateMenuZeroMoney )
	ON_UPDATE_COMMAND_UI( ID_ZEROMONEYMOVE_MENU, &CfrmUc101KariukekinI::OnUpdateMenuZeroMoneyMove)
	ON_UPDATE_COMMAND_UI( ID_RENDO_MENU, &CfrmUc101KariukekinI::OnUpdateMenuZaimuRendo )
	ON_UPDATE_COMMAND_UI(ID_SPECIALROW_MENU, &CfrmUc101KariukekinI::OnUpdateMenuSpecialRow)
	ON_UPDATE_COMMAND_UI( ID_TITLEMENU, &CfrmUc101KariukekinI::OnUpdateMenuTitleRestore )
	ON_UPDATE_COMMAND_UI( ID_DELETE_DATA_MENU, &CfrmUc101KariukekinI::OnUpdateMenuDeleteDataEachYoushiki )
	ON_MESSAGE(WM_USER_REDRAWVIEW, OnUserReDrawView)
END_MESSAGE_MAP()


CfrmUc101KariukekinI::CfrmUc101KariukekinI()
	: CfrmUc000Common( CfrmUc101KariukekinI::IDD )
{
...
CfrmUc101KariukekinI::~CfrmUc101KariukekinI()
{
	...
	TRACE(_T("***** CfrmUc101KariukekinI::~CfrmUc101KariukekinI\n"));

	//m_pDiag = NULL;
	//m_pTitleDiag = NULL;
}

void CfrmUc101KariukekinI::DoDataExchange( CDataExchange* pDX )
{
	CfrmUc000Common::DoDataExchange( pDX );
	DDX_Control( pDX, IDC_YOUSHIKIDIAG1, m_DiagNormal );	// 計1行
	DDX_Control( pDX, IDC_YOUSHIKIDIAG3, m_DiagNormal2 );	// 計2行
	DDX_Control( pDX, IDC_YOUSHIKIDIAG4, m_DiagNormal3 );	// 計0行
	DDX_Control( pDX, IDC_YOUSHIKIDIAG2, m_DiagKobetu );	// 計1行 
	DDX_Control( pDX, IDC_YOUSHIKIDIAG5, m_DiagKobetu2 );	// 計2行
	DDX_Control( pDX, IDC_YOUSHIKIDIAG6, m_DiagKobetu3 );	// 計3行
...
void CfrmUc101KariukekinI::OnInitialUpdate()
{
...
#ifdef _DEBUG
void CfrmUc101KariukekinI::AssertValid() const
{
	CfrmUc000Common::AssertValid();
}

#ifndef _WIN32_WCE
void CfrmUc101KariukekinI::Dump( CDumpContext& dc ) const
{
...
BEGIN_EVENTSINK_MAP( CfrmUc101KariukekinI, CfrmUc000Common )
	ON_EVENT( CfrmUc101KariukekinI, IDC_YOUSHIKIDIAG1, 3, CfrmUc101KariukekinI::TerminationYoushikidiag1, VTS_I2 VTS_I2 VTS_I2 VTS_UNKNOWN )
	ON_EVENT( CfrmUc101KariukekinI, IDC_YOUSHIKIDIAG1, 2, CfrmUc101KariukekinI::EditOFFYoushikidiag1, VTS_I2 )
	ON_EVENT( CfrmUc101KariukekinI, IDC_YOUSHIKIDIAG1, 1, CfrmUc101KariukekinI::EditONYoushikidiag1, VTS_I2 )
	ON_EVENT(CfrmUc101KariukekinI, IDC_YOUSHIKIDIAG1, 12, CfrmUc101KariukekinI::VScrollYoushikidiag1, VTS_I2)
	ON_EVENT(CfrmUc101KariukekinI, IDC_YOUSHIKIDIAG1, 8, CfrmUc101KariukekinI::ComboSelYoushikidiag1, VTS_I2 VTS_UNKNOWN)

	ON_EVENT( CfrmUc101KariukekinI, IDC_YOUSHIKIDIAG2, 3, CfrmUc101KariukekinI::TerminationYoushikidiag1, VTS_I2 VTS_I2 VTS_I2 VTS_UNKNOWN )
	ON_EVENT( CfrmUc101KariukekinI, IDC_YOUSHIKIDIAG2, 2, CfrmUc101KariukekinI::EditOFFYoushikidiag1, VTS_I2 )
	ON_EVENT( CfrmUc101KariukekinI, IDC_YOUSHIKIDIAG2, 1, CfrmUc101KariukekinI::EditONYoushikidiag1, VTS_I2 )
	ON_EVENT(CfrmUc101KariukekinI, IDC_YOUSHIKIDIAG2, 12, CfrmUc101KariukekinI::VScrollYoushikidiag1, VTS_I2)
	ON_EVENT(CfrmUc101KariukekinI, IDC_YOUSHIKIDIAG2, 8, CfrmUc101KariukekinI::ComboSelYoushikidiag1, VTS_I2 VTS_UNKNOWN)

	ON_EVENT( CfrmUc101KariukekinI, IDC_YOUSHIKIDIAG3, 3, CfrmUc101KariukekinI::TerminationYoushikidiag1, VTS_I2 VTS_I2 VTS_I2 VTS_UNKNOWN )
	ON_EVENT( CfrmUc101KariukekinI, IDC_YOUSHIKIDIAG3, 2, CfrmUc101KariukekinI::EditOFFYoushikidiag1, VTS_I2 )
	ON_EVENT( CfrmUc101KariukekinI, IDC_YOUSHIKIDIAG3, 1, CfrmUc101KariukekinI::EditONYoushikidiag1, VTS_I2 )
	ON_EVENT(CfrmUc101KariukekinI, IDC_YOUSHIKIDIAG3, 12, CfrmUc101KariukekinI::VScrollYoushikidiag1, VTS_I2)
	ON_EVENT(CfrmUc101KariukekinI, IDC_YOUSHIKIDIAG3, 8, CfrmUc101KariukekinI::ComboSelYoushikidiag1, VTS_I2 VTS_UNKNOWN)

	ON_EVENT( CfrmUc101KariukekinI, IDC_YOUSHIKIDIAG4, 3, CfrmUc101KariukekinI::TerminationYoushikidiag1, VTS_I2 VTS_I2 VTS_I2 VTS_UNKNOWN )
	ON_EVENT( CfrmUc101KariukekinI, IDC_YOUSHIKIDIAG4, 2, CfrmUc101KariukekinI::EditOFFYoushikidiag1, VTS_I2 )
	ON_EVENT( CfrmUc101KariukekinI, IDC_YOUSHIKIDIAG4, 1, CfrmUc101KariukekinI::EditONYoushikidiag1, VTS_I2 )
	ON_EVENT(CfrmUc101KariukekinI, IDC_YOUSHIKIDIAG4, 12, CfrmUc101KariukekinI::VScrollYoushikidiag1, VTS_I2)
	ON_EVENT(CfrmUc101KariukekinI, IDC_YOUSHIKIDIAG4, 8, CfrmUc101KariukekinI::ComboSelYoushikidiag1, VTS_I2 VTS_UNKNOWN)

	ON_EVENT( CfrmUc101KariukekinI, IDC_YOUSHIKIDIAG5, 3, CfrmUc101KariukekinI::TerminationYoushikidiag1, VTS_I2 VTS_I2 VTS_I2 VTS_UNKNOWN )
	ON_EVENT( CfrmUc101KariukekinI, IDC_YOUSHIKIDIAG5, 2, CfrmUc101KariukekinI::EditOFFYoushikidiag1, VTS_I2 )
	ON_EVENT( CfrmUc101KariukekinI, IDC_YOUSHIKIDIAG5, 1, CfrmUc101KariukekinI::EditONYoushikidiag1, VTS_I2 )
	ON_EVENT(CfrmUc101KariukekinI, IDC_YOUSHIKIDIAG5, 12, CfrmUc101KariukekinI::VScrollYoushikidiag1, VTS_I2)
	ON_EVENT(CfrmUc101KariukekinI, IDC_YOUSHIKIDIAG5, 8, CfrmUc101KariukekinI::ComboSelYoushikidiag1, VTS_I2 VTS_UNKNOWN)

	ON_EVENT( CfrmUc101KariukekinI, IDC_YOUSHIKIDIAG6, 3, CfrmUc101KariukekinI::TerminationYoushikidiag1, VTS_I2 VTS_I2 VTS_I2 VTS_UNKNOWN )
	ON_EVENT( CfrmUc101KariukekinI, IDC_YOUSHIKIDIAG6, 2, CfrmUc101KariukekinI::EditOFFYoushikidiag1, VTS_I2 )
	ON_EVENT( CfrmUc101KariukekinI, IDC_YOUSHIKIDIAG6, 1, CfrmUc101KariukekinI::EditONYoushikidiag1, VTS_I2 )
	ON_EVENT(CfrmUc101KariukekinI, IDC_YOUSHIKIDIAG6, 12, CfrmUc101KariukekinI::VScrollYoushikidiag1, VTS_I2)
	ON_EVENT(CfrmUc101KariukekinI, IDC_YOUSHIKIDIAG6, 8, CfrmUc101KariukekinI::ComboSelYoushikidiag1, VTS_I2 VTS_UNKNOWN)

	ON_EVENT( CfrmUc101KariukekinI, IDC_TITLEDIAG1, 3, CfrmUc101KariukekinI::TerminationTitlediag1, VTS_I2 VTS_I2 VTS_I2 VTS_UNKNOWN )
	ON_EVENT( CfrmUc101KariukekinI, IDC_TITLEDIAG1, 2, CfrmUc101KariukekinI::EditOFFTitlediag1, VTS_I2 )
	ON_EVENT( CfrmUc101KariukekinI, IDC_TITLEDIAG1, 1, CfrmUc101KariukekinI::EditONTitlediag1, VTS_I2 )
	ON_EVENT( CfrmUc101KariukekinI, IDC_TITLEDIAG1, 6, CfrmUc101KariukekinI::FocusTitlediag1, VTS_NONE )

	ON_EVENT( CfrmUc101KariukekinI, IDC_PAGEDIAG1, 3, CfrmUc101KariukekinI::TerminationPagediag1, VTS_I2 VTS_I2 VTS_I2 VTS_UNKNOWN )
	ON_EVENT( CfrmUc101KariukekinI, IDC_PAGEDIAG1, 2, CfrmUc101KariukekinI::EditOFFPagediag1, VTS_I2 )
	ON_EVENT( CfrmUc101KariukekinI, IDC_PAGEDIAG1, 1, CfrmUc101KariukekinI::EditONPagediag1, VTS_I2 )
	ON_EVENT( CfrmUc101KariukekinI, IDC_PAGEDIAG1, 6, CfrmUc101KariukekinI::FocusPagediag1, VTS_NONE )
END_EVENTSINK_MAP()

//********************************************************************************
//	初期処理
//********************************************************************************
BOOL	CfrmUc101KariukekinI::virStartJob()
{
	// 初期値設定
...
//	共通データの初期値設定
//********************************************************************************
void	CfrmUc101KariukekinI::virSetInitialUchiwakeInfo()
{
	// 「仮受金」の固有データ
	m_uInfo.intOutKeiDialog = AM_TYPE_ALL;				// 計設定ダイアログのボタン指定
	m_uInfo.intRowMax = ID_ROWKOBETU_101;				// １頁内の合計行を含む全体の行数
	m_uInfo.intRowMaxData = ID_ROWKOBETU_101 - 1;		// １頁内のデータ行数（合計行は含まず）
	m_uInfo.intColMax = ID_COLMAX_101I;					// １行内のコントロール個数
	m_uInfo.intColMaxData = ID_COLMAXDATA_101I;			// １行内の列数
	m_uInfo.intCtlStartIndex = ID_CTLSTARTINDEX_101I;	// １行目の入力項目の先頭インデックス番号
	m_uInfo.intT1StartIndex = ID_T1STARTNORMAL_101I;	// 合計行①の先頭インデックス番号
	m_uInfo.intT2StartIndex = ID_T2STARTNORMAL_101I;	// 合計行②の入力項目の先頭インデックス番号
	m_uInfo.intCursolDefPos = ID_COL_101I_INVONO;		// カーソル移動時の初期位置（タイトルから↓，合計から↑で使用）
	m_uInfo.intCursolKeiPos = ID_COL_101I_KNSEQ;		// 合計行のカーソル移動位置（カーソル移動で使用）

	m_uInfo.intFormSeq = ID_FORMNO_101;					// 様式シーケンス番号
	m_uInfo.intFormNo = 10;								// 様式番号（uc_inf_sub）
	m_uInfo.intFormNo2 = 1;								// 様式番号枝番（uc_inf_sub）

	m_uInfo.intRowNormal = ID_ROWNORMAL_101;			// 通常時：１頁内の合計行を含む全体の行数
	m_uInfo.intRowKobetu = ID_ROWKOBETU_101;			// 個別時：１頁内の合計行を含む全体の行数
	m_uInfo.intT1StartNormal = ID_T1STARTNORMAL_101I;	//	通常時：合計行①の先頭インデックス
	m_uInfo.intT2StartNormal = ID_T2STARTNORMAL_101I;	//	通常時：合計行②の先頭インデックス
	m_uInfo.intT1StartKobetu = ID_T1STARTKOBETU_101I;	//	個別時：合計行①の先頭インデックス
	m_uInfo.intT2StartKobetu = ID_T2STARTKOBETU_101I;	//	個別時：合計行②の先頭インデックス
	m_uInfo.intRowKei = ID_ROWKEI_101;					// 帳表固定の合計行数（1:合計あり，0:なし）
	m_uInfo.intKei1StartIndex = ID_COL_101I_KEI1_MEISYO;	// 計ダイアグラム1行目の先頭インデックス
	m_uInfo.intKei2StartIndex = ID_COL_101I_KEI2_MEISYO;	// 計ダイアグラム2行目の先頭インデックス

	// 集計処理の設定
	m_uInfo.uCalcInfo.intMaxCount = ID_CALC_101_MAX;		// 集計フィールド件数
	m_uInfo.uCalcInfo.strField[0] = ID_CALC_101_FIELD1;		// 集計フィールド名称1
}
...
//	【戻値】	なし
//**************************************************
void CfrmUc101KariukekinI::virSetInitialDiag()
{	
	int		nIndex;
	...
	//	コンボボックスの属性取得
	nIndex = CmnGetControlIndex( 1, ID_COL_101I_KNSEQ );
...
//	帳表固有変数の初期値設定
//********************************************************************************
void	CfrmUc101KariukekinI::virSetInitialValue()
{
	// 1ページ分のローカルバッファをクリア
	RecBufClearAllData();
...
//	帳表コントロールの初期化（データ領域）
//********************************************************************************
BOOL	CfrmUc101KariukekinI::InitialControlDataArea()
{
	int		intMax;
	int		i;
	int		len=0;
	...
	for ( i = m_uInfo.intCtlStartIndex; i < intMax; i += m_uInfo.intColMax ) {
		// ComboBox：クリア
		CmnDiagSetString(m_pDiag, i + ID_COL_101I_KNSEQ - 1, "", 0);	// 科目
		CmnDiagSetString(m_pDiag, i + ID_COL_101I_INVONOT - 1, "", 0);	// 登録番号(T選択)
		
		// 漢字入力欄の初期化
		CmnDiagSetAttrInpmax( m_pDiag, i + ID_COL_101I_ADNAME1 - 1, MAX_KETA_101_ADNAME1 );			//	名称１
		CmnDiagSetAttrInpmax( m_pDiag, i + ID_COL_101I_ADADD1  - 1, MAX_KETA_101_ADADD1 );			//	住所１
		CmnDiagSetAttrInpmax( m_pDiag, i + ID_COL_101I_ADADD2  - 1, MAX_KETA_101_ADADD2 );			//	住所２
		CmnDiagSetAttrInpmax( m_pDiag, i + ID_COL_101I_KANKEI  - 1, MAX_KETA_101_KANKEI );			//	法人・代表者との関係
		CmnDiagSetAttrInpmax( m_pDiag, i + ID_COL_101I_NAIYOU  - 1, MAX_KETA_101_NAIYOU );			//	摘要

		// 金額欄：桁数初期化
		len = ID_VAL_101_K_DATA;
		CmnDiagSetAttrDigit( m_pDiag, i + ID_COL_101I_VAL - 1, len );	// 金額
	...
	// 半角/全角設定
	CmnDiagSetAttrColZenHan( m_pDiag , ID_COL_101I_ADNAME1 );	// 名称1
	CmnDiagSetAttrColZenHan( m_pDiag , ID_COL_101I_ADADD1 );	// 所在地1
	CmnDiagSetAttrColZenHan( m_pDiag , ID_COL_101I_ADADD2 );	// 所在地2
	CmnDiagSetAttrColZenHan( m_pDiag , ID_COL_101I_KANKEI );	// 法人・代表者との関係
	CmnDiagSetAttrColZenHan( m_pDiag , ID_COL_101I_NAIYOU );	// 取引の内容
...
//********************************************************************************
BOOL	CfrmUc101KariukekinI::InitialControlDataAreaHide( CICSDiag* pDiag )
{
	int		intMax;
	int		i;
	int		len=0;
	...
	for ( i = m_uInfo.intCtlStartIndex; i < intMax; i += m_uInfo.intColMax ) {
		// ComboBox：クリア
		CmnDiagSetString( pDiag, i + ID_COL_101I_KNSEQ - 1, "", 0 );	// 科目
		
		// 漢字入力欄の初期化
		CmnDiagSetAttrInpmax( pDiag, i + ID_COL_101I_ADNAME1 - 1, MAX_KETA_101_ADNAME1 );		//	名称１
		CmnDiagSetAttrInpmax( pDiag, i + ID_COL_101I_ADADD1  - 1, MAX_KETA_101_ADADD1 );		//	住所１
		CmnDiagSetAttrInpmax( pDiag, i + ID_COL_101I_ADADD2  - 1, MAX_KETA_101_ADADD2 );		//	住所２
		CmnDiagSetAttrInpmax( pDiag, i + ID_COL_101I_KANKEI  - 1, MAX_KETA_101_KANKEI );		//	法人・代表者との関係
		CmnDiagSetAttrInpmax( pDiag, i + ID_COL_101I_NAIYOU  - 1, MAX_KETA_101_NAIYOU );		//	摘要

		// 金額欄：桁数初期化
		len = ID_VAL_101_K_DATA;
		CmnDiagSetAttrDigit( pDiag, i + ID_COL_101I_VAL - 1, len );				// 金額
	}
...
//********************************************************************************
BOOL	CfrmUc101KariukekinI::InitialControlComboBox()
{
	...
	for(i = 1; i <= intMax; i++) {
		...
		// 科目
		intIndex = CmnGetControlIndex(i, ID_COL_101I_KNSEQ);
		// T選択
		intIndex2 = CmnGetControlIndex(i, ID_COL_101I_INVONOT);
...
//********************************************************************************
void	CfrmUc101KariukekinI::InitialControlTotalArea()
{
	int		nKeiType;			//	計の種別
	...
	if(flg2[0] == 1)	{
		// 一括自動行の科目を入力可能にする
		m_pDiag->ModifyItem( CmnGetControlIndex( (nDataRowPos[0]+1), ID_COL_101I_KNSEQ ), (DIAG_MDFY_EDIT | DIAG_MDFY_OPAQUE) );
	}
	if(flg2[1] == 1)	{
		// 一括自動行の科目を入力可能にする
		m_pDiag->ModifyItem( CmnGetControlIndex( (nDataRowPos[1]+1), ID_COL_101I_KNSEQ ), (DIAG_MDFY_EDIT | DIAG_MDFY_OPAQUE) );
	}
...
//		→表示していない方のDiag(通常 or 個別)の設定に使用する
//********************************************************************************
void	CfrmUc101KariukekinI::InitialControlTotalAreaHide( CICSDiag* pDiag )
{
	int intIndex = 0;
	...
	// 合計行の金額欄は、金額欄 + 1桁
	intIndex = m_intT1StartIndexHide + m_uInfo.intCtlStartIndex + ID_COL_101I_VAL - 1;
	CmnDiagSetAttrDigit( pDiag, intIndex, ID_VAL_101_TOTAL );

	intIndex = m_intT2StartIndexHide + m_uInfo.intCtlStartIndex + ID_COL_101I_VAL - 1;
	CmnDiagSetAttrDigit( pDiag, intIndex, ID_VAL_101_TOTAL );
}
...
//	RET	なし
//********************************************************************************
void	CfrmUc101KariukekinI::InitialControlSpecialRow( int intRow, int intFgFunc )
{
	int				nIndex;		//	インデックス
	...
	switch ( intFgFunc ) {
		...
		case ID_FGFUNC_IKKATUAUTO:		// 一括集計金額行（自動）
			// 桁数を設定
			CmnDiagSetAttrDigit( m_pDiag, CmnGetControlIndex( intRow , ID_COL_101I_VAL ), ID_VAL_101_TOTAL );
			break;
	}
	...
	switch (intFgFunc) {
		...
		case ID_FGFUNC_IKKATUAUTO:		// 一括集計金額行（自動）
			...
			if ( intFgFunc != ID_FGFUNC_IKKATUAUTO ){
				...
				m_pDiag->ModifyItem(CmnGetControlIndex(intRow, ID_COL_101I_KNSEQ), DIAG_MDFY_NODROPDOWN);
				// 「登録番号(T選択)」はComboBoxのため、DropDown不可とする
				m_pDiag->ModifyItem(CmnGetControlIndex(intRow, ID_COL_101I_INVONOT), DIAG_MDFY_NODROPDOWN);

				// ComboBoxの選択項目クリア
				m_clsFunc.DiagInit( &diadata );
				diadata.text_combo = _T( "\r\n" );
				m_pDiag->SetData(CmnGetControlIndex(intRow, ID_COL_101I_KNSEQ), (LPUNKNOWN)&diadata);
				m_pDiag->SetData(CmnGetControlIndex(intRow, ID_COL_101I_INVONOT), (LPUNKNOWN)&diadata);
			}
...
// 改良No.21-0086,21-0529 cor <--
				...
				if (intFgFunc == ID_FGFUNC_IKKATUAUTO ){
					//	科目
					m_pDiag->ModifyItem( CmnGetControlIndex( intRow, ID_COL_101I_KNSEQ ), DIAG_MDFY_INPUT );
				}
			}
...
//	帳表タイトル情報の表示
//********************************************************************************
void	CfrmUc101KariukekinI::virUpdateControlTitle()
{
	...
	// ---------------------------------------------------
	m_clsFunc.DiagSetString(&m_HeadDiag, 7, ID_DIAGDATA_DISP, _T("摘要"));
}

//********************************************************************************
//	帳表ページ情報の表示
//********************************************************************************
void	CfrmUc101KariukekinI::UpdateControlPage()
{
	BOOL	bBack = TRUE;
	BOOL	bNext = TRUE;
...
//	帳表データの表示（１ページ分）
//********************************************************************************
BOOL	CfrmUc101KariukekinI::virUpdateControlTblData()
{
	// ダイアログ切替
	if( m_pDiag != NULL ){
		virSetInitialDiag();
	...
	CdbUc101Kariukekin	dbRec( m_pDB );
	...
	// 頁計、累計行の桁数をセットする
	CmnDiagSetAttrDigit( m_pDiagKei, ID_COL_101I_KEI1_VAL, ID_VAL_101_TOTAL );
	CmnDiagSetAttrDigit( m_pDiagKei, ID_COL_101I_KEI1_VAL, ID_VAL_101_TOTAL );
	...
	while ( !dbRec.IsEOF() ) {		// ファイル終端まで
		...
		// 科目
		CmnInitialControlFgStringCell( m_pDiag, dbRec.m_NumRow, ID_COL_101I_KNSEQ, dbRec.m_FgFunc, UC_KAMOKU_LEN, dbRec.m_KnName);
		// 法人・代表者との関係
		CmnInitialControlFgStringCell( m_pDiag, dbRec.m_NumRow, ID_COL_101I_KANKEI, dbRec.m_FgFunc, UC_101_KANKEI_LEN, dbRec.m_Kankei);
...
//	保管件数の表示
//********************************************************************************
BOOL CfrmUc101KariukekinI::virUpdateControlTblData2()
{
	int					hcnt=0;
	CString				cs=_T("");
...
//		IN		CdbUc101Kariukekin*	「仮受金」
//		RET		なし
//********************************************************************************
void	CfrmUc101KariukekinI::UpdateControlRowData( CdbUc101Kariukekin* prmDbRec ) {
	...
	m_clsFunc.DiagInit( &diadata );
	// 読込み対象セル取得
	intCell = CmnGetControlIndex( prmDbRec->m_NumRow, ID_COL_101I_KNSEQ );
...
//********************************************************************************
//	帳表データの１行表示（累計，頁計行）
//		IN		CdbUc101Kariukekin*	「仮受金」テーブル情報
//		RET		なし
//********************************************************************************
void	CfrmUc101KariukekinI::UpdateControlRowTotal( CdbUc101Kariukekin* prmDbRec ) {
	...
	// 頁計/累計の名称表示
	if (intRowName > 0) {
		CmnDiagSetString( m_pDiagKei, CmnGetKeiDiagIndex( intRowName, ID_COL_101I_KEI1_MEISYO ), prmDbRec->m_KeiStr, 1 );
	}
	// 頁計/累計の金額表示
	if (intRowKingaku > 0) {
		CmnDiagSetKingaku( m_pDiagKei, CmnGetKeiDiagIndex( intRowKingaku, ID_COL_101I_KEI1_VAL ), prmDbRec->m_Val );
	}
}
...
//		RET		なし
//********************************************************************************
void	CfrmUc101KariukekinI::virFncCellCopyProc( CdbUc000Common* rsData )
{
	CdbUc101Kariukekin*	rs;
	int					intCol;	// 現在の列
	int					ind1,ind2;
	CString				cs1,cs2;

	rs = (CdbUc101Kariukekin*)rsData;
	...
	switch( intCol ){
		// 科目
		case ID_COL_101I_KNSEQ:
			CmnDiagSetCombo2( m_pDiag, m_uInfo.intCurCtlIndex, rs->m_KnOrder );
			break;
		// 登録番号（T選択）
		case ID_COL_101I_INVONOT:
		// 登録番号
		case ID_COL_101I_INVONO:
			if(intCol == ID_COL_101I_INVONOT) {
...
//********************************************************************************
int	CfrmUc101KariukekinI::virFncReferenceGetType(int intCol, int* intGrSeq, long* lngItemSeq, int* intAdd1, int* intAdd2, int* intAdd1Col, int* intAdd2Col, REFERENCE_INFO* pudReference)
{
int				intRefType;
	...
	switch (intCol) {
		...
		case ID_COL_101I_ADADD2:
			...
			*intAdd1 = MAX_KETA_101_ADADD1 * 2;			// Byte指定
			*intAdd2 = MAX_KETA_101_ADADD2 * 2;			// Byte指定
			*intAdd1Col = ID_COL_101I_ADADD1;
			*intAdd2Col = ID_COL_101I_ADADD2;
			break;
...
//		RET		なし
//********************************************************************************
void	CfrmUc101KariukekinI::virFncReferenceSetData( CdlgReference* dlgRef, int intRefType, int intCol )
{
	int			nCurRow;		//	カレント行
	int			nCurCol;		//	カレント列
	int			nPos;			//	位置
	...
	switch (intRefType) {
		...
		case ID_DLGTYPE_ADDRESS:
			...
			if(intCol == ID_COL_101I_INVONOT) {
				//	現在行の取引先の名称１の位置を算出
				nPos = ((nCurRow - 1) * m_uInfo.intColMax) + (m_uInfo.intCtlStartIndex + (ID_COL_101I_INVONOT - 1));
			...
			else if(intCol == ID_COL_101I_INVONO) {
				//	現在行の取引先の名称１の位置を算出
				nPos = ((nCurRow - 1) * m_uInfo.intColMax) + (m_uInfo.intCtlStartIndex + (ID_COL_101I_INVONO - 1));
			...
			else if(intCol == ID_COL_101I_ADNAME1) {
				//	現在行の取引先の名称１の位置を算出
				nPos = ((nCurRow - 1) * m_uInfo.intColMax) + (m_uInfo.intCtlStartIndex + (ID_COL_101I_ADNAME1 - 1));
...
//		RET		なし
//********************************************************************************
void	CfrmUc101KariukekinI::virFncReferenceUpdateTbl( int intRefType, int nRefMode/*=0*/ )
{
	switch (intRefType) {
		// 科目
		case ID_DLGTYPE_KAMOKU:
...
//		RET		なし
//********************************************************************************
void	CfrmUc101KariukekinI::virFncReferenceSetICSData(CdlgAddressSearch* dlgAddd)
{
	int			intIndex;

	// 売却(買入)先の所在地1(住所)
	intIndex = CmnGetControlIndex( m_uInfo.intCurRow, ID_COL_101I_ADADD1 );
	CmnDiagSetString( m_pDiag, intIndex, dlgAddd->m_AdAdd1, 0 );

	// 売却(買入)先の所在地2(住所)
	intIndex = CmnGetControlIndex( m_uInfo.intCurRow, ID_COL_101I_ADADD2 );
	CmnDiagSetString( m_pDiag, intIndex, dlgAddd->m_AdAdd2, 0 );
}

void CfrmUc101KariukekinI::virActivateFrameK(UINT nState, CFrameWnd* pDeactivateFrame)
{
	int		index = 0;
	...
	if(pWnd != NULL)	{
		if(m_DataKakutei == FALSE)	{
			if(m_uInfo.intCurCol == ID_COL_101I_KNSEQ)	{
				virKamokuAddCancel();
			}
		}
	}
...
void CfrmUc101KariukekinI::virKamokuAddCancel()
{
	...
	// 科目列なら
	if(m_uInfo.intCurCol == ID_COL_101I_KNSEQ && m_F9OnSw != TRUE)	{
		DIAGRAM_DATA	diadata;
		m_pDiag->GetData(m_uInfo.intCurCtlIndex,(LPUNKNOWN)&diadata);
		// 【新規作成】が選択されていれば
		if(diadata.data_combo > m_CmbCnt)	{
			// 前回の値に戻す
			CmnDiagSetCombo(m_pDiag,CmnGetControlIndex(m_uInfo.intCurRow,ID_COL_101I_KNSEQ),m_uInfo.OldCombo);
		}
	}
}
...
//	その他イベント処理
//********************************************************************************
BOOL	CfrmUc101KariukekinI::PreTranslateMessage( MSG* pMsg )
{
	...
	int				rv=0;
	int				nbf=0;
	int				intTotalType=0;		// カレント頁の合計行の種別を取得
	int				intRet=0;
	int				id=0;
...
// 修正No.168362 add <--
						...
						intTotalType = CmnGetControlTotalType();
						// オフ
						if(intTotalType == ID_OUTKEI_OFF)			nbf = 11;
						// 頁計
						else if(intTotalType == ID_OUTKEI_PAGEKEI)	nbf = 10;
						// 累計
						else if(intTotalType == ID_OUTKEI_RUIKEI)	nbf = 10;
						// 頁計と累計
						else if(intTotalType == ID_OUTKEI_BOTH)		nbf = 9;

						// Scroll＋フォーカス移動先を取得
						if (pMsg->wParam == VK_PRIOR) {
							// PageUpの場合：Scroll＋フォーカス移動（行－１１）
							m_pDiag->ScrollPos(SB_PAGEUP , 0);
							intMoveRow = intMoveRow - nbf;
							if (intMoveRow < 1) {
								blnMove = FALSE;					// 移動しない
							}
						}
						...
						if(intCol == ID_COL_101I_KNSEQ || intCol == ID_COL_101I_INVONOT)	{
							rv=1;
						}
// 修正No.168362 add -->
					} 
// 修正No.168362 add <--
			...
			case VK_RIGHT:
				if(nG_MScroll == 1)	{
					...
					intCol = CmnGetControlCol();
					if(intCol == ID_COL_101I_KNSEQ && (pMsg->wParam == VK_LEFT || pMsg->wParam == VK_RIGHT))	{
...
// 頁コントロールのフォーカス設定
void	CfrmUc101KariukekinI::FocusPagediag1()
{
}

// 頁コントロールのゲットフォーカス
void	CfrmUc101KariukekinI::EditONPagediag1( short index )
{
// 修正No.168443 add -->
	// ---- 登録番号一覧関連 ----->
	if(pZmSel && pZmSel->IsDisplay() != FALSE) {
...
// 頁コントロールのロストフォーカス
void	CfrmUc101KariukekinI::EditOFFPagediag1( short index )
{
...
// 頁コントロールのキー操作
void	CfrmUc101KariukekinI::TerminationPagediag1( short index, short nChar, short length, LPUNKNOWN data )
{
	int nMaxDataCol = 0;
	// カレント頁の合計行の種別を取得
	...
	switch ( nChar ) {
		...
		case VK_TAB:
			...
			if ( CmnCheckShiftKey() == FALSE ) {
				...
				CmnDiagSetFocus(m_pDiag, nMaxDataCol, ID_COL_101I_NAIYOU);
			}
			break;
		case VK_DOWN:
			// タイトルコントロールへ移動
...
// タイトルコントロールのフォーカス設定
void	CfrmUc101KariukekinI::FocusTitlediag1()
{
}

// タイトルコントロールのゲットフォーカス
void	CfrmUc101KariukekinI::EditONTitlediag1( short index )
{
// 修正No.168443 add -->
	// ---- 登録番号一覧関連 ----->
	if(pZmSel && pZmSel->IsDisplay() != FALSE) {
...
// タイトルコントロールのロストフォーカス
void	CfrmUc101KariukekinI::EditOFFTitlediag1 (short index )
{
	m_Titlefocus = 0;
	virUpdateTitle();
}
...
//	タイトル更新
void CfrmUc101KariukekinI::virUpdateTitle()
{
...
// タイトルコントロールのキーイベント
void	CfrmUc101KariukekinI::TerminationTitlediag1( short index, short nChar, short length, LPUNKNOWN data )
{
	// フォーカス移動
	switch ( nChar ) {
		case VK_RETURN:
...
//********************************************************************************
//	「仮受金」データコントロール処理（EditON，EditOFF，Terminationイベント）
//********************************************************************************

// 「仮受金」データコントロールのゲットフォーカス
void	CfrmUc101KariukekinI::EditONYoushikidiag1( short index )
{
	DIAGRAM_DATA	diadata;
	...
	switch (m_uInfo.intCurCol) {
		...
		case ID_COL_101I_INVONOT:	// 登録番号(T選択)
			// コンボボックスのオフセット値取得
			m_pDiag->GetData(m_uInfo.intCurCtlIndex, (LPUNKNOWN)&diadata);
			m_uInfo.OldCombo = diadata.data_combo;
			break;
	...
	if ( ( m_uInfo.OldRow > 0 ) ) {
		if ( m_uInfo.OldPage == m_uInfo.intCurPage && m_uInfo.OldPage > 0 ) {
			...
			BOOL adadd1_to_adadd2 = IsSaveMoveReference(ID_COL_101I_ADADD1, ID_COL_101I_ADADD2);
			// [Home]キー押下の住所検索ダイアログの戻り（フォーカスをセットしている）は保存しない（改良依頼No15-1613）
			BOOL adadd1_to_adadd1 = IsSaveMoveReference(ID_COL_101I_ADADD1, ID_COL_101I_ADADD1);	// 所在地1(住所)→所在地1(住所)
			BOOL adadd2_to_adadd2 = IsSaveMoveReference(ID_COL_101I_ADADD2, ID_COL_101I_ADADD2);	// 所在地2(住所)→所在地2(住所)　所在地2から住所が長すぎる場合、ここがFALSEになる
			// T選択⇔登録番号は保存しない
			BOOL tsel_to_invno = IsSaveMoveReference(ID_COL_101I_INVONOT, ID_COL_101I_INVONO);
	...
	if(m_uInfo.intCurCol == ID_COL_101I_INVONO && m_EndSyorityu == 0)	{
// 修正No.168377 del -->
...
// 修正No.168377 add -->
		// 登録番号のT選択の値を取得
		int pos = CmnGetControlIndex(m_uInfo.intCurRow, ID_COL_101I_INVONOT);
...
// データコントロールのロストフォーカス
void	CfrmUc101KariukekinI::EditOFFYoushikidiag1( short index )
{
	if( m_EndView != FALSE )	return;

// 修正No.168443 add -->
	// ---- 登録番号一覧関連 ----->
	if(m_uInfo.intCurCol != ID_COL_101I_INVONO) {
		if(pZmSel && pZmSel->IsDisplay() != FALSE) {
			pZmSel->DialogOFF();
		}
	}
...
// 修正No.168443 del -->
	...
	//		//// カーソル移動処理
	//		//CmnDiagSetFocus( m_pDiag, m_uInfo.intCurRow, ID_COL_101I_INVONO );
	//	}
	//}

	//// ---- 登録番号一覧関連 ----->
	//if(pZmSel && m_uInfo.intCurCol != ID_COL_101I_INVONO) {
...
//	入力確定
void CfrmUc101KariukekinI::virInputDecisionEditOFF()
{
	// フォーカスフラグOFF
...
// 預貯金データコントロールのキーイベント
void	CfrmUc101KariukekinI::TerminationYoushikidiag1( short index, short nChar, short length, LPUNKNOWN data )
{
	//--------------------------------------------------------------------------------
	//	キー操作仕様
...
void CfrmUc101KariukekinI::VScrollYoushikidiag1(short mode)
{
// 修正No.168430 del -->
...
//********************************************************************************
int	CfrmUc101KariukekinI::GetFocusPosition( int nChar )
{
	int		intRow;					// カレント行番号
	int		intCol;					// カレント列番号
	...
	else if ( intCol == ID_COL_101I_ADADD1 ){
		// カレント列が「住所１」の場合
	...
	else if ( intCol == ID_COL_101I_ADADD2 ){
		// カレント列が「住所２」の場合
	...
	else if ( intCol == ID_COL_101I_NAIYOU ){
		// カレント列が「取引の内容」の場合
		intVector[0] = m_uInfo.intCurCtlIndex - m_uInfo.intColMax;		// ↑
	...
	case VK_RETURN:	// Enterキーでカーソルを下に移動するモード対応
		if(m_ReturnMoveDown) {
			if(intCol == ID_COL_101I_INVONOT)	intNext = intVector[1];			//	カレント列が「登録番号(T表示)」欄の場合「→」キーと同じ
	...
	case VK_TAB:
		if (CmnCheckShiftKey() == FALSE) {
			...
			// それ以外は「←」キーと同じ
			if ((intRow <= 1) && (intCol == ID_COL_101I_KNSEQ)) {
				return -1;
			}
...
//********************************************************************************
int	CfrmUc101KariukekinI::GetTotalRowIndex( int nCharOrg, int intIndex, int intNext )
{
	...
	if ( nNowRow <= nBorder[0] ){
		...
		if (( intNext > CmnGetControlIndex( m_uInfo.intRowMax, ID_COL_101I_NAIYOU ) ) && ( nCharOrg == VK_TAB )){
			return( -2 );
		}
		//	データ行を超えた？かつ計行あり？
	...
	//	現在、頁計に居る
		...
		switch ( nCharTemp ){
			case VK_UP:			// ↑：23行目のデータ行の支店名項目へ移動
				nRet = CmnGetControlIndex( nBorder[0], ID_COL_101I_ADNAME1 );
				break;
			case VK_LEFT:		// ←/Shift+Tab：23行目のデータ行の摘要項目へ移動
				nRet = CmnGetControlIndex( nBorder[0], ID_COL_101I_NAIYOU );
				break;
			default:			// →/↓/Return/Tab：25行目の合計行②へ移動
				...
				//	累計なし
					...
					nRet = CmnGetControlIndex( ( nBorder[2] + 2 ), ID_COL_101I_KNSEQ );
				}
				break;
		}
	}
	//	現在、累計に居る場合
		...
		switch ( nCharTemp ){
			...
			case VK_LEFT:		// ←/Shift+Tab：24行目の合計行① or 24行目のデータ行の摘要項目へ移動
				nRet = CmnGetControlIndex( ( nBorder[1] + 2 ), ID_COL_101I_KNSEQ );
				break;
			default:			// →/↓：移動できない
				// 例外処理：最終項目で"Tab"は別コントロールへ移動
				// それ以外は「→」キーと同じ
...
//		RET		なし
//********************************************************************************
void	CfrmUc101KariukekinI::virTblEditIkkatuLine( int nType, CdbUc000Common* rsData,
									CString strName, CALCKEI_INFO uCalcKei, SORTKAMOKU_INFO uKamoku )
{
	CdbUc101Kariukekin*	mfcRec = (CdbUc101Kariukekin*)rsData;
...
//********************************************************************************
int	CfrmUc101KariukekinI::virTblSortSubSortProc( CdlgSort* pCdlgSort, CdbUc000Common* rsData )
{
	CdbUc101Kariukekin*	rs;
	CString				strFilter;
	CString				strSort;
...
/**********************************************************************
	RecBufSetData(CdbUc101Kariukekin* prmDbRec)
		ローカルのレコードバッファに、1行分のデータを格納する

	引数
		CdbUc101Kariukekin*	prmDbRec	レコードセット(データがあること）
	戻値
		int		成功/失敗
				FUNCTION_OK
***********************************************************************/
int	CfrmUc101KariukekinI::RecBufSetData( CdbUc101Kariukekin* prmDbRec )
{
...
/**********************************************************************
	...
	戻値
		int		成功/失敗
				FUNCTION_OK
***********************************************************************/
int	CfrmUc101KariukekinI::RecBufClearAllData()
{
...
/**********************************************************************
	...
	引数
		P_REC_UC_101_KARIUKEKIN inRecData レコードへのポインタ
	戻値
		int		成功/失敗
				FUNCTION_OK
***********************************************************************/
int	CfrmUc101KariukekinI::RecBufClearData( P_REC_UC_101_KARIUKEKIN inRecData )
{
	inRecData->m_Seq = 0;
...
/**********************************************************************
	...
	戻値
		int				成功(更新あり)/成功(更新なし)/失敗
						...
						FUNCTION_NG		: 失敗
***********************************************************************/
int	CfrmUc101KariukekinI::virRecBufSaveData( int inPage, int inRow )
{
	REC_UC_101_KARIUKEKIN	tmpSaveData;	// 画面データ1レコード格納用
	...
	// 科目
	intIndex = CmnGetControlIndex( inRow, ID_COL_101I_KNSEQ );
	...
	// 登録番号（T選択）
	intIndex = CmnGetControlIndex(inRow, ID_COL_101I_INVONOT);
	m_pDiag->GetData(intIndex, (LPUNKNOWN)&diadata);
	tsel = diadata.data_combo;

	// 登録番号（法人番号）
	intIndex = CmnGetControlIndex(inRow, ID_COL_101I_INVONO);
...
// 修正No.168534,168539 add <--
	...
	intIndex = CmnGetControlIndex( inRow, ID_COL_101I_ADNAME1 );
	...
	if ( tmpSaveData.m_AdName2.IsEmpty() ){
		if(m_uInfo.intCurCol == ID_COL_101I_ADNAME1 && m_uInfo.intCurRow != m_uInfo.OldRow){	// 各カラムごとにvirRecBufSaveData()がコールされるようになり、かつタイミングがEditOffからEditOnに移ったことによりCmnDiagSetString()でカレットが末尾から先頭に移ってしまう為、制御
			CmnDiagSetString( m_pDiag, intIndex, tmpSaveData.m_AdName1, 0 );
		}
	}

	// 所在地1
	intIndex = CmnGetControlIndex( inRow, ID_COL_101I_ADADD1 );
	tmpSaveData.m_AdAdd1 = m_clsFunc.DiagGetString( m_pDiag, intIndex );

	// 所在地2
	intIndex = CmnGetControlIndex( inRow, ID_COL_101I_ADADD2 );
	tmpSaveData.m_AdAdd2 = m_clsFunc.DiagGetString( m_pDiag, intIndex );

	// 法人・代表者との関係
	intIndex = CmnGetControlIndex( inRow, ID_COL_101I_KANKEI );
	tmpSaveData.m_Kankei = m_clsFunc.DiagGetString( m_pDiag, intIndex );

	// 金額
	intIndex = CmnGetControlIndex( inRow, ID_COL_101I_VAL );
	tmpSaveData.m_Val = CmnDiagGetKingaku( m_pDiag, intIndex );

	// 取引の内容
	intIndex = CmnGetControlIndex( inRow, ID_COL_101I_NAIYOU );
...
***********************************************************************/
int	CfrmUc101KariukekinI::virRecBufSaveDataForPasteInsert( int inPage, int inRow )
{
...
***********************************************************************/
int	CfrmUc101KariukekinI::virRecBufSaveDataForPaste( int inPage, int inRow )
{
	///////////////////////////////////////////////////////////////
	// 登録処理呼び出し
	return RecBufSaveDataSub( inPage, inRow, &m_CopyData );
...
/**********************************************************************
	...
	戻値
			int					成功(更新あり)/成功(更新なし)/失敗
								...
								FUNCTION_NG		: 失敗
***********************************************************************/
int	CfrmUc101KariukekinI::RecBufSaveDataSub( 
							int inPage,
							int inRow,
							P_REC_UC_101_KARIUKEKIN inSaveData )
{
	REC_UC_101_KARIUKEKIN	udTemp;		//	画面上のデータ格納用
	CString					cst;
	...
	// テーブルアクセスクラス
	CdbUc101Kariukekin	mfcRec( m_pDB );
	...
	//	(10) 特殊行フラグ(基本的には、空行/データ行のチェックになるはず) 
...
// 修正No.168534,168539 add -->
		if((udTemp.m_FgFunc == ID_FGFUNC_DATA) && (m_InvnoErrFlg == 0 && ufgInvNo == TRUE)) {	// 変更ありの場合
			...
			if(m_RegAutoRef)	udTemp.m_AdSeq = rsAdd.CheckAdSeqEntry_Inv(udTemp.m_AdSeq, udTemp.m_AdName1, udTemp.m_AdName2, udTemp.m_AdAdd1, udTemp.m_AdAdd2, udTemp.m_InvNo, ID_ADDRESSGR_URI, FALSE, TRUE, 0);
			else				udTemp.m_AdSeq = rsAdd.GetSeqFromAdName_Inv(ID_ADDRESSGR_URI, udTemp.m_AdName1, udTemp.m_AdName2, udTemp.m_AdAdd1, udTemp.m_AdAdd2, udTemp.m_InvNo);
...
// 修正No.168534,168539 add <--
			...
			if(m_RegAutoRef)	udTemp.m_AdSeq = rsAdd.CheckEntry_Inv(udTemp.m_AdName1, udTemp.m_AdName2, udTemp.m_AdAdd1, udTemp.m_AdAdd2, udTemp.m_InvNo, ID_ADDRESSGR_URI, TRUE);
			else				udTemp.m_AdSeq = rsAdd.GetSeqFromAdName_Inv(ID_ADDRESSGR_URI, udTemp.m_AdName1, udTemp.m_AdName2, udTemp.m_AdAdd1, udTemp.m_AdAdd2, udTemp.m_InvNo);
...
//********************************************************************************
//	「仮受金」テーブルのオブジェクトを生成し、ポインタを返す
//********************************************************************************
CdbUc000Common*	CfrmUc101KariukekinI::virGetDataTableObject()
{
	// 「仮受金」テーブルのオブジェクトを生成し、ポインタを返す
	return (CdbUc000Common*)( new CdbUc101Kariukekin( m_pDB ) );
}
...
//	RET	なし
//********************************************************************************
void	CfrmUc101KariukekinI::virRowButtonCopyProc()
{
...
//	RET	なし
//********************************************************************************
void	CfrmUc101KariukekinI::virTblGetKamokuInfo( CdbUc000Common* rsData, SORTKAMOKU_INFO* uKamoku )
{
	CdbUc101Kariukekin*	rs = (CdbUc101Kariukekin*)rsData;
...
//	RET	なし
//********************************************************************************
void	CfrmUc101KariukekinI::virGetCurrentInfo( CURRENT_INFO* uCurInfo )
{
...
//********************************************************************************
int	CfrmUc101KariukekinI::virUpdateRelationTblChengeFormType()
{
	// ⑩-1で通常/個別を変更した場合、⑩-2の頁構成の更新が必要となる
	CfrmUc102Gensen		pfrm102;
	int intRet = pfrm102.UpdateTbl102ChangeFormType(m_uInfoSv);
...
//		RET		BOOL		TRUE:正常終了，FALSE:エラー
//********************************************************************************
BOOL CfrmUc101KariukekinI::virUpdateRelationTblChengeFormTypeSave()
{
	// ⑩-1で通常/個別を変更した場合、⑩-2のm_uInfoを保存する
	CfrmUc102Gensen		pfrm102;
	BOOL				ret=FALSE;

	ret = pfrm102.CmnSetInitialUchiwakeInfo(ID_FORMNO_102);

	m_uInfoSv = pfrm102.m_uInfo;
...
//		RET		なし
//********************************************************************************
int	CfrmUc101KariukekinI::UpdateTbl101ChangeFormType(UCHIWAKE_INFO pInfoSv)
{
	// データ無しならデータ更新しない
	...
	// 初期値設定
	CmnSetInitialUchiwakeInfo(ID_FORMNO_101);	// 共通データ
	virSetInitialValue();						// 帳表固有データ
...
//	【戻値】	なし
//**************************************************
void CfrmUc101KariukekinI::SetInputMode( int nRow, long nMode )
{
	m_pDiag->ModifyItem( CmnGetControlIndex( nRow, ID_COL_101I_KNSEQ ), nMode );	//　科目
	m_pDiag->ModifyItem( CmnGetControlIndex( nRow, ID_COL_101I_INVONOT ), nMode );	//	登録番号（T選択）
	m_pDiag->ModifyItem( CmnGetControlIndex( nRow, ID_COL_101I_INVONO), nMode );	//	登録番号
	m_pDiag->ModifyItem( CmnGetControlIndex( nRow, ID_COL_101I_ADNAME1 ), nMode );	//　名称（上段）
	m_pDiag->ModifyItem( CmnGetControlIndex( nRow, ID_COL_101I_ADADD1 ), nMode );	//　所在地（上段）
	m_pDiag->ModifyItem( CmnGetControlIndex( nRow, ID_COL_101I_ADADD2 ), nMode );	//	所在地（下段）
	m_pDiag->ModifyItem( CmnGetControlIndex( nRow, ID_COL_101I_KANKEI ), nMode );	//	法人・代表者との関係
	m_pDiag->ModifyItem( CmnGetControlIndex( nRow, ID_COL_101I_VAL ), nMode );		//	期末現在高
	m_pDiag->ModifyItem( CmnGetControlIndex( nRow, ID_COL_101I_NAIYOU ), nMode );	//	取引の内容
}
...
//	【戻値】	なし
//**************************************************
void CfrmUc101KariukekinI::SetDiagBackColor()
{
...
//		RET		なし					
//********************************************************************************
void CfrmUc101KariukekinI::virRendoCreateData(CdbUc000Common* rsData, RENTEMP_INFO* uRenInfo)
{
	CString			strTemp;
	...
	if(sw != 0)	{
		m_clsFunc.StrDivisionEx( uRenInfo->strAdName , &strArry , ( MAX_KETA_101_ADNAME1 / 2 ) , 2 );
		if(sw == 1)	{
			intSeq = rsLstAdd.CheckEntryRen_Inv(strArry.GetAt(0), strArry.GetAt(1) , _T("") , _T(""), uRenInfo->strAdKana, uRenInfo->strInvNo, ID_ADDRESSGR_URI, TRUE);
			if (intSeq > 0) {
...
//		RET		なし					
//********************************************************************************
void CfrmUc101KariukekinI::virRendoUpdateData(CdbUc000Common* rsData, RENTEMP_INFO* uRenInfo)
{
	CdbUc101Kariukekin*	rs = (CdbUc101Kariukekin*)rsData;
...
//***************************************************************************
BOOL CfrmUc101KariukekinI::virEndProc(void)
{
	TRACE(_T("***** CfrmUc101KariukekinI::virEndProc\n"));
...
void CfrmUc101KariukekinI::ComboNew(short index)
{
	short			sv_sel=0;
...
int CfrmUc101KariukekinI::CursorControl(short nChar, int sw)
{
	int				rv=0;
	int				intCol=0;
	int				pos=0;
	...
	if((nChar == VK_TAB && (key & 0x80) == 0x80) || (nChar == VK_LEFT) || (nChar == VK_RIGHT)) {
		...
		if(intCol == ID_COL_101I_INVONOT)	{	// 登録番号(T選択)
			m_pDiag->ComboDropDown(m_uInfo.intCurCtlIndex, FALSE);
			CmnDiagSetCombo(m_pDiag, m_uInfo.intCurCtlIndex, m_uInfo.OldCombo);
		}
	}
...
void CfrmUc101KariukekinI::ComboSelYoushikidiag1(short index, LPUNKNOWN data)
{
...
// ------------------------------------------------------------------------------------------------------------------------
void CfrmUc101KariukekinI::TitleColorChg(void)
{
	int					nCharOver[2]={0};		// 電子申告の文字数を超えたかどうかのサイン		1:電子申告の文字数を超えた
												// 様式⑩－１	[0]:科目(10文字)	[1]:相手先 法人・代表者との関係(10)
	...
	// 科目
	strSQL.Format(_T("select max(oversgn) from (select CASE when len(%s) > %d then 1 else 0 end as oversgn from uc_101_kariukekin where FgShow=%d) tbl1"),
	...
	// 法人・代表者との関係
	strSQL.Format(_T("select max(oversgn) from (select CASE when len(%s) > %d then 1 else 0 end as oversgn from uc_101_kariukekin where FgShow=%d) tbl1"),
		MakeReplaceSent(_T("Kankei")),UC_101_KANKEI_LEN,ID_FGSHOW_OFF);
	rs.Open( CRecordset::forwardOnly, strSQL);
	rs.GetFieldValue((short)0, strData);
	rs.Close();
	nCharOver[1] = 0;
	...
	if(nCharOver[1] == 1)	CmnHeadDiagSetTitle(&m_HeadDiag,5,_T("法人・代表　　\r\n者との関係(10)"),1);
	else					CmnHeadDiagSetTitle(&m_HeadDiag,5,_T("法人・代表\r\n者との関係"),0);
	...
	nFontSize = 100;
	try	{
		m_HeadDiag.ChangeFontSize(5, nFontSize);
	}
	catch(CException* e){
		e->Delete();
	}
...
LRESULT CfrmUc101KariukekinI::OnUserReDrawView(WPARAM wParam, LPARAM lParam)
{
	virUpdateControlTblData();
	CmnDiagSetFocus(m_pDiag, 1, 1);
...
//		RET		なし
// --------------------------------------------------------------------------------------------------------
void CfrmUc101KariukekinI::virDiagGetHjnData(CDatabase* pDB, HJN_REC_NEW* phjnRec)
{
	int				nPage,nRow;
	int				intIndex;	// 対象行の各インデックス
	int				tsel=0;
	...
	// 登録番号（法人番号）
	cst.Empty();
	intIndex = CmnGetControlIndex(nRow, ID_COL_101I_INVONO);
	...
	// 名称1(氏名)
	intIndex = CmnGetControlIndex(nRow, ID_COL_101I_ADNAME1);
	m_clsFunc.StrDivision(m_clsFunc.DiagGetString(m_pDiag, intIndex), &strArray, 2, FALSE, TRUE);
	cst.Empty();
	...
	// 所在地1(住所)
	intIndex = CmnGetControlIndex(nRow, ID_COL_101I_ADADD1);
	cst = m_clsFunc.DiagGetString(m_pDiag, intIndex);
	cst.TrimRight();
	if(cst.IsEmpty() == FALSE)	{
		memset(buf, 0, sizeof(buf));
	...
	// 所在地2(住所)
	intIndex = CmnGetControlIndex(nRow, ID_COL_101I_ADADD2);
	cst = m_clsFunc.DiagGetString(m_pDiag, intIndex);
	cst.TrimRight();
	if(cst.IsEmpty() == FALSE) {
		memset(buf, 0, sizeof(buf));
...
//		RET		なし
// --------------------------------------------------------------------------------------------------------
void	CfrmUc101KariukekinI::virDiagSetHjnData(int pSw, CString rtInvNo, CString rtName, CString rtAdrs1, CString rtAdrs2, CString rtKana)
{
	int					ret = 0;
	int					intIndex;
...
// 修正No.168361,168369,168371,168378 del <--
		// 登録番号（T選択）
		intIndex = CmnGetControlIndex(m_uInfo.intCurRow, ID_COL_101I_INVONOT);
		CmnDiagSetCombo3(m_pDiag, intIndex, strInvoNo);

		// 登録番号
		InvoNoSplit(strInvoNo, &cs1, &cs2);
		intIndex = CmnGetControlIndex(m_uInfo.intCurRow, ID_COL_101I_INVONO);
...
// --------------------------------------------------------------------------------------------------------
// --------------------------------------------------------------------------------------------------------
int CfrmUc101KariukekinI::virCallChkInvoiceNum(int pSw, int inPage, int inRow)
{
...
//				CString		pInvno	登録番号
// --------------------------------------------------------------------------------------------------------
int CfrmUc101KariukekinI::ChkInvoiceNum(CDatabase* pDB, int pSw, int inPage, int inRow, 
...
// 修正No.168361,168369,168371,168378 del -->
	...
	//		DIAGRAM_DATA	ddata;
	//		ddata.data_combo = 0;
	//		m_pDiag->SetData(CmnGetControlIndex(inRow, ID_COL_101I_INVONOT), (LPUNKNOWN)&ddata);
	//		ddata.data_edit.Empty();
	//		m_pDiag->DataClear(CmnGetControlIndex(inRow, ID_COL_101I_INVONO), TRUE);
	//		// エラーメッセージを表示
...
// 修正No.168443 add <--
			...
			if(pZmSel && pZmSel->IsDisplay() != FALSE && cst.GetLength() < 3) {
				...
				if(tmpzd.errflg != -1) {
					...
					m_pDiag->SetData(CmnGetControlIndex(inRow, ID_COL_101I_INVONO), (LPUNKNOWN)&ddata);
					// 再描画
					m_pDiag->Refresh();
...
// 修正No.168425,168443 add -->
					if(pSw == 3 || m_EndSyorityu == 1)	{
						...
						m_uInfo.intCurCol = ID_COL_101I_INVONO;
