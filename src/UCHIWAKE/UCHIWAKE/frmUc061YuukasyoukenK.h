...
//#define	ID_ROWKOBETU_061	16		// 個別時：１頁内の合計行を含む全体の行数
//#define	ID_ROWKEI_061	1		// 帳表固定の合計行数（1:合計あり，0:なし）
#define	ID_COLMAX_061K			35		// １行内のコントロール個数
#define	ID_COLMAXDATA_061K		16		// １行内の入力コントロール数
#define	ID_CTLSTARTINDEX_061K	13		// １行目の入力項目の先頭インデックス番号
#define ID_T1STARTNORMAL_061K	525		// 通常時：合計行①の先頭インデックス番号
#define ID_T2STARTNORMAL_061K	560		// 通常時：合計行②の先頭インデックス番号
#define ID_T1STARTKOBETU_061K	525		// 個別時：合計行①の先頭インデックス番号
#define ID_T2STARTKOBETU_061K	560		// 個別時：合計行②の先頭インデックス番号
...
//	「有価証券」の内訳書列番号（帳表入力画面で使用）
typedef enum {
	ID_COL_061K_KUBUN = 1,	// 1	区分
	ID_COL_061K_SYURUI,		// 2	種類
	ID_COL_061K_MEIGARA,	// 3	銘柄
	ID_COL_061K_SUURYOU,	// 4	数量
	ID_COL_061K_TANNI,		// 5	単位
	ID_COL_061K_VAL,		// 6	金額(1)
	ID_COL_061K_VAL2,		// 7	金額(2)
	ID_COL_061K_SPDATE,		// 8	異動年月日
	ID_COL_061K_RIYUU,		// 9	異動事由
	ID_COL_061K_SUURYOU2,	// 10	数量2
	ID_COL_061K_TANNI2,		// 11	単位2
	ID_COL_061K_VAL3,		// 12	金額
	ID_COL_061K_ADNAME1,	// 13	売却(買入)先の名称1(氏名)
	ID_COL_061K_ADADD1,		// 14	売却(買入)先の所在地1(住所)
	ID_COL_061K_ADADD2,		// 15	売却(買入)先の所在地2(住所)
	ID_COL_061K_TEKI,		// 16	摘要
} EnumIdFormCol061K;
...
////////////////////////////////////////////////////////////////////
////	「有価証券」の内訳書_計ダイアグラムの入力インデックス
//#define ID_COL_061K_KEI1_MEISYO	0				// 計ダイアログ1行目の計名称（計or合計、頁計、累計）
//#define ID_COL_061K_KEI1_VAL2	3				// 計ダイアログ1行目の金額１
//#define ID_COL_061K_KEI1_VAL3	7				// 計ダイアログ1行目の金額２
//#define ID_COL_061K_KEI2_MEISYO	15				// 計ダイアログ2行目の計名称（計or合計、頁計、累計）
//#define ID_COL_061K_KEI2_VAL2	18				// 計ダイアログ2行目の金額１
//#define ID_COL_061K_KEI2_VAL3	22				// 計ダイアログ2行目の金額２

// midori kanso_0318 add <--

class CfrmUc061YuukasyoukenK: public CfrmUc000Common
{
	DECLARE_DYNCREATE( CfrmUc061YuukasyoukenK )

public:
	CfrmUc061YuukasyoukenK();
	virtual	~CfrmUc061YuukasyoukenK();
