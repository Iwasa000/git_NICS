...
IMPLEMENT_DYNCREATE( CfrmUc081SiharaitegataK, CfrmUc000Common )


BEGIN_MESSAGE_MAP( CfrmUc081SiharaitegataK, CfrmUc000Common )
	ON_WM_SIZE()
...
//	ON_COMMAND( ID_BUTTON_F3, OnButtonF3 )
	...
	ON_COMMAND( ID_PRINTSETUP_MENU, &CfrmUc081SiharaitegataK::OnMenuPrintSetup )
	ON_COMMAND( ID_PRINTALL_MENU, &CfrmUc081SiharaitegataK::OnMenuPrintAll )
	//ON_COMMAND( ID_OUTPUTFORM_MENU, &CfrmUc081SiharaitegataK::OnMenuFormTypeSetup )
	ON_COMMAND( ID_SPECIALROW_MENU, &CfrmUc081SiharaitegataK::OnMenuSpecialRow )
	ON_COMMAND( ID_SORT_MENU, &CfrmUc081SiharaitegataK::OnMenuSort )
	ON_COMMAND(ID_IKKATUADD_MENU, &CfrmUc081SiharaitegataK::OnIkkatuAddMenu)
	ON_COMMAND( ID_DISPDIALOG_MENU, &CfrmUc081SiharaitegataK::OnMenuIkkatuKingaku )
	ON_COMMAND( ID_ZEROMONEY_MENU, &CfrmUc081SiharaitegataK::OnMenuZeroMoney )
	ON_COMMAND( ID_ZEROMONEYMOVE_MENU, &CfrmUc081SiharaitegataK::OnMenuZeroMoneyMove )
	ON_COMMAND( ID_AMOUTDIALOG_MENU, &CfrmUc081SiharaitegataK::OnMenuOutKeiSetup )
// midori 160606 add -->
	ON_COMMAND( ID_CLEAR_MENU, &CfrmUc081SiharaitegataK::OnMenuClear )
// midori 160606 add <--
	ON_COMMAND( ID_RENDO_MENU, &CfrmUc081SiharaitegataK::OnMenuZaimuRendo )
	ON_COMMAND( ID_TITLEMENU, &CfrmUc081SiharaitegataK::OnMenuTitleRestore )
	ON_COMMAND( ID_USER_SETTING_MENU, &CfrmUc081SiharaitegataK::OnMenuOptionSetting )
	ON_COMMAND( ID_COPY_SETTING_INFO_MENU, &CfrmUc081SiharaitegataK::OnMenuCopySettingInfo )
	ON_COMMAND( ID_DELETE_DATA_MENU, &CfrmUc081SiharaitegataK::OnMenuDeleteDataEachYoushiki )
	ON_BN_CLICKED( IDC_PAGEBACK_BUTTON1, &CfrmUc081SiharaitegataK::OnPageBack )
	ON_BN_CLICKED( IDC_PAGENEXT_BUTTON1, &CfrmUc081SiharaitegataK::OnPageNext )
	ON_BN_CLICKED( IDC_PAGENEW_BUTTON1, &CfrmUc081SiharaitegataK::OnPageNew )
	ON_BN_CLICKED( IDC_PAGEINSERT_BUTTON1, &CfrmUc081SiharaitegataK::OnPageInsert )
	ON_BN_CLICKED( IDC_ROWCOPY_BUTTON1, &CfrmUc081SiharaitegataK::OnRowCopy )
	ON_BN_CLICKED( IDC_ROWPASTE_BUTTON1, &CfrmUc081SiharaitegataK::OnRowPaste )
	ON_BN_CLICKED( IDC_ROWINSERT_BUTTON1, &CfrmUc081SiharaitegataK::OnRowInsert )
	ON_BN_CLICKED( IDC_YOUSHIKINEXT_BUTTON1, &CfrmUc081SiharaitegataK::OnMoveYoushikiNext )
	ON_BN_CLICKED( IDC_YOUSHIKIBACK_BUTTON1, &CfrmUc081SiharaitegataK::OnMoveYoushikiBack )
//	ON_UPDATE_COMMAND_UI( ID_BUTTON_F1, &CfrmUc081SiharaitegataK::OnUpdateButtonF1 )
//	ON_UPDATE_COMMAND_UI( ID_BUTTON_F3, &CfrmUc081SiharaitegataK::OnUpdateButtonF3 )
	ON_UPDATE_COMMAND_UI( ID_BUTTON_F6, &CfrmUc081SiharaitegataK::OnUpdateButtonF6 )
	ON_UPDATE_COMMAND_UI( ID_BUTTON_F7, &CfrmUc081SiharaitegataK::OnUpdateButtonF7 )
	ON_UPDATE_COMMAND_UI( ID_BUTTON_F8, &CfrmUc081SiharaitegataK::OnUpdateButtonF8 )
	ON_UPDATE_COMMAND_UI( ID_BUTTON_F9, &CfrmUc081SiharaitegataK::OnUpdateButtonF9 )
	ON_UPDATE_COMMAND_UI( ID_BUTTON_F11, &CfrmUc081SiharaitegataK::OnUpdateButtonF11 )
	ON_UPDATE_COMMAND_UI( ID_BUTTON_F12, &CfrmUc081SiharaitegataK::OnUpdateButtonF12 )
	ON_UPDATE_COMMAND_UI( ID_BUTTON_HOME, &CfrmUc081SiharaitegataK::OnUpdateButtonHome )
	ON_UPDATE_COMMAND_UI( ID_IKKATUADD_MENU, &CfrmUc081SiharaitegataK::OnUpdateIkkatuaddMenu)
	ON_UPDATE_COMMAND_UI( ID_DISPDIALOG_MENU, &CfrmUc081SiharaitegataK::OnUpdateMenuIkkatuKingaku )
// midori 160612 add -->
	ON_UPDATE_COMMAND_UI( ID_SORT_MENU, &CfrmUc081SiharaitegataK::OnUpdateMenuSort )
	ON_UPDATE_COMMAND_UI( ID_CLEAR_MENU, &CfrmUc081SiharaitegataK::OnUpdateMenuClear )
// midori 160612 add <--
	ON_UPDATE_COMMAND_UI( ID_ZEROMONEY_MENU, &CfrmUc081SiharaitegataK::OnUpdateMenuZeroMoney )
// midori 160612 add -->
	ON_UPDATE_COMMAND_UI( ID_ZEROMONEYMOVE_MENU, &CfrmUc081SiharaitegataK::OnUpdateMenuZeroMoneyMove)
// midori 160612 add <--
	ON_UPDATE_COMMAND_UI( ID_RENDO_MENU, &CfrmUc081SiharaitegataK::OnUpdateMenuZaimuRendo )
	ON_UPDATE_COMMAND_UI(ID_SPECIALROW_MENU, &CfrmUc081SiharaitegataK::OnUpdateMenuSpecialRow)
// midori 160612 add -->
	ON_UPDATE_COMMAND_UI( ID_TITLEMENU, &CfrmUc081SiharaitegataK::OnUpdateMenuTitleRestore )
	ON_UPDATE_COMMAND_UI( ID_DELETE_DATA_MENU, &CfrmUc081SiharaitegataK::OnUpdateMenuDeleteDataEachYoushiki )
// midori 160612 add <--
	ON_MESSAGE(WM_USER_REDRAWVIEW, OnUserReDrawView)		// 修正No.162446 add
END_MESSAGE_MAP()


CfrmUc081SiharaitegataK::CfrmUc081SiharaitegataK()
	: CfrmUc000Common( CfrmUc081SiharaitegataK::IDD )
{
...
CfrmUc081SiharaitegataK::~CfrmUc081SiharaitegataK()
{
	...
	TRACE(_T("***** CfrmUc081SiharaitegataK::~CfrmUc081SiharaitegataK\n"));

	//m_pDiag = NULL;
	//m_pTitleDiag = NULL;
}

void CfrmUc081SiharaitegataK::DoDataExchange( CDataExchange* pDX )
{
...
void CfrmUc081SiharaitegataK::OnInitialUpdate()
{
...
#ifdef _DEBUG
void CfrmUc081SiharaitegataK::AssertValid() const
{
	CfrmUc000Common::AssertValid();
}

#ifndef _WIN32_WCE
void CfrmUc081SiharaitegataK::Dump( CDumpContext& dc ) const
{
...
BEGIN_EVENTSINK_MAP( CfrmUc081SiharaitegataK, CfrmUc000Common )
	ON_EVENT( CfrmUc081SiharaitegataK, IDC_YOUSHIKIDIAG1, 3, CfrmUc081SiharaitegataK::TerminationYoushikidiag1, VTS_I2 VTS_I2 VTS_I2 VTS_UNKNOWN )
	ON_EVENT( CfrmUc081SiharaitegataK, IDC_YOUSHIKIDIAG1, 2, CfrmUc081SiharaitegataK::EditOFFYoushikidiag1, VTS_I2 )
	ON_EVENT( CfrmUc081SiharaitegataK, IDC_YOUSHIKIDIAG1, 1, CfrmUc081SiharaitegataK::EditONYoushikidiag1, VTS_I2 )
// midori 151405 add -->
	ON_EVENT(CfrmUc081SiharaitegataK, IDC_YOUSHIKIDIAG1, 12, CfrmUc081SiharaitegataK::VScrollYoushikidiag1, VTS_I2)
// midori 151405 add <--

	ON_EVENT( CfrmUc081SiharaitegataK, IDC_YOUSHIKIDIAG2, 3, CfrmUc081SiharaitegataK::TerminationYoushikidiag1, VTS_I2 VTS_I2 VTS_I2 VTS_UNKNOWN )
	ON_EVENT( CfrmUc081SiharaitegataK, IDC_YOUSHIKIDIAG2, 2, CfrmUc081SiharaitegataK::EditOFFYoushikidiag1, VTS_I2 )
	ON_EVENT( CfrmUc081SiharaitegataK, IDC_YOUSHIKIDIAG2, 1, CfrmUc081SiharaitegataK::EditONYoushikidiag1, VTS_I2 )
// midori 151405 add -->
	ON_EVENT(CfrmUc081SiharaitegataK, IDC_YOUSHIKIDIAG2, 12, CfrmUc081SiharaitegataK::VScrollYoushikidiag1, VTS_I2)
// midori 151405 add <--

	ON_EVENT( CfrmUc081SiharaitegataK, IDC_TITLEDIAG1, 3, CfrmUc081SiharaitegataK::TerminationTitlediag1, VTS_I2 VTS_I2 VTS_I2 VTS_UNKNOWN )
	ON_EVENT( CfrmUc081SiharaitegataK, IDC_TITLEDIAG1, 2, CfrmUc081SiharaitegataK::EditOFFTitlediag1, VTS_I2 )
	ON_EVENT( CfrmUc081SiharaitegataK, IDC_TITLEDIAG1, 1, CfrmUc081SiharaitegataK::EditONTitlediag1, VTS_I2 )
	ON_EVENT( CfrmUc081SiharaitegataK, IDC_TITLEDIAG1, 6, CfrmUc081SiharaitegataK::FocusTitlediag1, VTS_NONE )

	ON_EVENT( CfrmUc081SiharaitegataK, IDC_PAGEDIAG1, 3, CfrmUc081SiharaitegataK::TerminationPagediag1, VTS_I2 VTS_I2 VTS_I2 VTS_UNKNOWN )
	ON_EVENT( CfrmUc081SiharaitegataK, IDC_PAGEDIAG1, 2, CfrmUc081SiharaitegataK::EditOFFPagediag1, VTS_I2 )
	ON_EVENT( CfrmUc081SiharaitegataK, IDC_PAGEDIAG1, 1, CfrmUc081SiharaitegataK::EditONPagediag1, VTS_I2 )
	ON_EVENT( CfrmUc081SiharaitegataK, IDC_PAGEDIAG1, 6, CfrmUc081SiharaitegataK::FocusPagediag1, VTS_NONE )
END_EVENTSINK_MAP()

//********************************************************************************
//	初期処理
//********************************************************************************
BOOL	CfrmUc081SiharaitegataK::virStartJob()
{
	// 初期値設定
...
//	共通データの初期値設定
//********************************************************************************
void	CfrmUc081SiharaitegataK::virSetInitialUchiwakeInfo()
{
	// 「支払手形」の固有データ
	...
	m_uInfo.intColMax = ID_COLMAX_081K;				// １行内のコントロール個数
	m_uInfo.intColMaxData = ID_COLMAXDATA_081K;		// １行内の列数
	m_uInfo.intCtlStartIndex = ID_CTLSTARTINDEX_081K;// １行目の入力項目の先頭インデックス番号
	m_uInfo.intT1StartIndex = ID_T1STARTNORMAL_081K;	// 合計行①の先頭インデックス番号
	m_uInfo.intT2StartIndex = ID_T2STARTNORMAL_081K;	// 合計行②の入力項目の先頭インデックス番号
	...
	m_uInfo.intT1StartNormal = ID_T1STARTNORMAL_081K;	// 通常時：合計行①の先頭インデックス
	m_uInfo.intT2StartNormal = ID_T2STARTNORMAL_081K;	// 通常時：合計行②の先頭インデックス
	m_uInfo.intT1StartKobetu = ID_T1STARTKOBETU_081K;	// 個別時：合計行①の先頭インデックス
	m_uInfo.intT2StartKobetu = ID_T2STARTKOBETU_081K;	// 個別時：合計行②の先頭インデックス
	m_uInfo.intRowKei = ID_ROWKEI_081;					// 帳表固定の合計行数（1:合計あり，0:なし）
	m_uInfo.intKei1StartIndex = ID_COL_081K_KEI1_MEISYO;	// 計ダイアグラム1行目の先頭インデックス
	m_uInfo.intKei2StartIndex = ID_COL_081K_KEI2_MEISYO;	// 計ダイアグラム2行目の先頭インデックス
...
// 【戻値】    なし
//**************************************************
void	CfrmUc081SiharaitegataK::virSetInitialDiag()
{
	// オブジェクト未生成時は処理を抜ける
...
//	帳表固有変数の初期値設定
//********************************************************************************
void	CfrmUc081SiharaitegataK::virSetInitialValue()
{
	// 1ページ分のローカルバッファをクリア
	RecBufClearAllData();
...
//	帳表コントロールの初期化（データ領域）
//********************************************************************************
BOOL	CfrmUc081SiharaitegataK::InitialControlDataArea()
{
	int		intMax;
	int		i;
// midori 200101 add -->
...
// midori 200101 add -->
		...
		// 振出年月日
		m_pDiag->GetAttribute((i + ID_COL_081_SPDATE - 1),(LPUNKNOWN)&diaatt);
		diaatt.attr_dayattr = 15;
		m_pDiag->SetAttribute((i + ID_COL_081_SPDATE - 1),(LPUNKNOWN)&diaatt,TRUE);
		// 支払期日
		m_pDiag->GetAttribute((i + ID_COL_081_PMDATE - 1),(LPUNKNOWN)&diaatt);
		diaatt.attr_dayattr = 15;
		m_pDiag->SetAttribute((i + ID_COL_081_PMDATE - 1),(LPUNKNOWN)&diaatt,TRUE);
// midori 200101 add <--
...
// No.200903 del <--
// No.200903 add -->
		CmnDiagSetAttrDigit( m_pDiag, i + ID_COL_081_VAL - 1, ID_VAL_081_K_DATA );	// 金額
// No.200903 add <--
...
//********************************************************************************
BOOL	CfrmUc081SiharaitegataK::InitialControlComboBox()
{
	// コンボボックスを初期化する関数です。
	return TRUE;
}
...
//********************************************************************************
void	CfrmUc081SiharaitegataK::InitialControlTotalArea()
{
	int		nKeiType;			//	計の種別
	int		nDataRow;			//	データ行属性
...
// midori 152166 add <--
	...
	m_pDiagKei->ModifyItem(ID_COL_081K_KEI1_VAL, intKeiRow);
	m_pDiagKei->ModifyItem(ID_COL_081K_KEI2_VAL, intKeiRow);
...
// No.200903 del -->
	//// 合計行の金額欄は、金額欄 + 1桁
	//CmnDiagSetAttrDigit( m_pDiagKei, ID_COL_081K_KEI1_VAL, ID_VAL_081_TOTAL );
	//CmnDiagSetAttrDigit( m_pDiagKei, ID_COL_081K_KEI2_VAL, ID_VAL_081_TOTAL );
...
// No.200903 add -->
	// 合計行の金額欄は、13桁
	CmnDiagSetAttrDigit( m_pDiagKei, ID_COL_081K_KEI1_VAL, ID_VAL_081_K_TOTAL );
	CmnDiagSetAttrDigit( m_pDiagKei, ID_COL_081K_KEI2_VAL, ID_VAL_081_K_TOTAL );
// No.200903 add <--
}
...
//	RET	なし
//********************************************************************************
void	CfrmUc081SiharaitegataK::InitialControlSpecialRow( int intRow, int intFgFunc )
{
...
// No.200903 del <--
// No.200903 add -->
		CmnDiagSetAttrDigit( m_pDiag, CmnGetControlIndex( intRow , ID_COL_081_VAL ), ID_VAL_081_K_TOTAL );
// No.200903 add <--
		break;
	}
...
//	帳表タイトル情報の表示
//********************************************************************************
void	CfrmUc081SiharaitegataK::virUpdateControlTitle()
{
//	int		intMax;
	DIAGRAM_ATTRIBUTE diaatt;
...
//	帳表ページ情報の表示
//********************************************************************************
void	CfrmUc081SiharaitegataK::UpdateControlPage()
{
	BOOL	bBack = TRUE;
	BOOL	bNext = TRUE;
...
//	帳表データの表示（１ページ分）
//********************************************************************************
BOOL	CfrmUc081SiharaitegataK::virUpdateControlTblData()
{
	// ダイアログ切替
	if( m_pDiag != NULL ){
		virSetInitialDiag();
...
// No.200601 add -->
		...
		// 支払銀行名称
		CmnInitialControlFgStringCell( m_pDiag, dbRec.m_NumRow, ID_COL_081_BKNAME1, dbRec.m_FgFunc, UC_BANK_LEN, dbRec.m_BkName1);
		// 支払銀行支店名
		CmnInitialControlFgStringCell( m_pDiag, dbRec.m_NumRow, ID_COL_081_BKNAME2, dbRec.m_FgFunc, UC_BANK_LEN, dbRec.m_BkName2);
		// 摘要
		CmnInitialControlFgStringCell( m_pDiag, dbRec.m_NumRow, ID_COL_081_TEKI, dbRec.m_FgFunc, UC_081_TEKI_LEN, dbRec.m_Teki);
// No.200601 add <--
...
// midori 190301 add -->
	...
	CmnDiagSetAttrEditFormat(m_pDiag,ID_COL_081_ADNAME1,MAX_KETA_081_ADNAME1,2,_T("10,10"));	// 支払先
	CmnDiagSetAttrEditFormat(m_pDiag,ID_COL_081_TEKI,MAX_KETA_081_TEKI,3,_T("15,15,10"));		// 摘要
	...
	CmnDiagSetAttrDisableHide(&m_DiagKei2,23,2);
// midori 190301 add <--
...
//	保管件数の表示
//********************************************************************************
BOOL CfrmUc081SiharaitegataK::virUpdateControlTblData2()
{
	int					hcnt=0;
	CString				cs=_T("");
...
//		RET		なし
//********************************************************************************
void	CfrmUc081SiharaitegataK::UpdateControlRowData( CdbUc081Siharaitegata* prmDbRec ) {
	DIAGRAM_DATA	diadata;	// ICSDiag構造体
	int				intCell;	// 保存フィールド
...
//		RET		なし
//********************************************************************************
void	CfrmUc081SiharaitegataK::UpdateControlRowTotal( CdbUc081Siharaitegata* prmDbRec )
{
	int		intTotalType;
	...
	if ( intRowName > 0 ) {
		...
		CmnDiagSetString( m_pDiagKei, CmnGetKeiDiagIndex( intRowName, ID_COL_081K_KEI1_MEISYO ), prmDbRec->m_KeiStr, 1 );
	}
	// 頁計/累計の金額表示
	if ( intRowVal > 0 ) {
		//CmnDiagSetKingaku( m_pDiag, CmnGetControlTotalIndex( intRowName, ID_COL_081_VAL ), prmDbRec->m_Val );
		CmnDiagSetKingaku( m_pDiagKei, CmnGetKeiDiagIndex( intRowVal, ID_COL_081K_KEI1_VAL ), prmDbRec->m_Val );
	}
}
...
//		RET		なし
//********************************************************************************
void	CfrmUc081SiharaitegataK::virFncCellCopyProc( CdbUc000Common* rsData )
{
...
//********************************************************************************
int	CfrmUc081SiharaitegataK::virFncReferenceGetType(int intCol, int* intGrSeq, long* lngItemSeq, int* intAdd1, int* intAdd2, int* intAdd1Col, int* intAdd2Col, REFERENCE_INFO* pudReference)
{
	int		intRefType;
...
//		RET		なし
//********************************************************************************
void	CfrmUc081SiharaitegataK::virFncReferenceSetData( CdlgReference* dlgRef, int intRefType, int intCol )
{
	switch ( intRefType ) {
...
//		RET		なし
//********************************************************************************
void	CfrmUc081SiharaitegataK::virFncReferenceUpdateTbl( int intRefType, int nRefMode/*=0*/ )
{
...
// 修正No.157633_元号日付 add -->
void CfrmUc081SiharaitegataK::virActivateFrame(UINT nState, CFrameWnd* pDeactivateFrame)
{
	int		index = 0;
		...
		if(m_DataKakutei == FALSE)	{
			if(m_uInfo.intCurCol == ID_COL_081_SPDATE || m_uInfo.intCurCol == ID_COL_081_PMDATE)	{
				if(m_uInfo.EditSign == 1)	{
					m_uInfo.EditSign = -1;
					m_uInfo.GenListSw = 0;
					if(m_uInfo.intCurCol == ID_COL_081_SPDATE)	{
						m_uInfo.OldDate[0] = 0;
...
//	その他イベント処理
//********************************************************************************
BOOL	CfrmUc081SiharaitegataK::PreTranslateMessage( MSG* pMsg )
{
//	int				intID;
...
// midori 155866 add -->
				intCol = CmnGetControlCol();
				if (intCol == ID_COL_081_SPDATE || intCol == ID_COL_081_PMDATE) {
					rv = 1;
				}
// midori 155866 add <--
// midori 152390 add -->
...
// 頁コントロールのフォーカス設定
void	CfrmUc081SiharaitegataK::FocusPagediag1()
{
...
// 頁コントロールのゲットフォーカス
void	CfrmUc081SiharaitegataK::EditONPagediag1( short index )
{
// midori 151405 add -->
	// スクロールフラグをクリアする
	nG_MScroll = 0;
...
// 頁コントロールのロストフォーカス
void	CfrmUc081SiharaitegataK::EditOFFPagediag1( short index )
{
// midori 155028 add -->
...
// 頁コントロールのキー操作
void	CfrmUc081SiharaitegataK::TerminationPagediag1( short index, short nChar, short length, LPUNKNOWN data )
{
	int nMaxDataCol = 0;
	// カレント頁の合計行の種別を取得
...
// タイトルコントロールのフォーカス設定
void	CfrmUc081SiharaitegataK::FocusTitlediag1()
{
//マウスクリックでキャレットが表示できないためコメントとする
//	// ボタンからTabキー移動した場合に必要
//	m_TitleDiag.SetPosition( 0 );
...
// タイトルコントロールのゲットフォーカス
void	CfrmUc081SiharaitegataK::EditONTitlediag1( short index )
{
// midori 151405 add -->
	// スクロールフラグをクリアする
	nG_MScroll = 0;
...
// タイトルコントロールのロストフォーカス
void	CfrmUc081SiharaitegataK::EditOFFTitlediag1 (short index )
{
// midori 151405 add -->
	m_Titlefocus = 0;
// midori 151405 add <--
...
//	タイトル更新
void CfrmUc081SiharaitegataK::virUpdateTitle()
{
...
// タイトルコントロールのキーイベント
void	CfrmUc081SiharaitegataK::TerminationTitlediag1( short index, short nChar, short length, LPUNKNOWN data )
{
	// フォーカス移動
	switch ( nChar ) {
	case VK_RETURN:
...
void	CfrmUc081SiharaitegataK::EditONYoushikidiag1( short index )
{
...
// 修正No.157633_元号日付 add -->
	...
	if(m_uInfo.intCurCol == ID_COL_081_SPDATE || m_uInfo.intCurCol == ID_COL_081_PMDATE)	m_uInfo.EditSign = 1;
...
// データコントロールのロストフォーカス
void	CfrmUc081SiharaitegataK::EditOFFYoushikidiag1( short index )
{
	if( m_EndView != FALSE )	return;
...
//	入力確定
void CfrmUc081SiharaitegataK::virInputDecisionEditOFF()
{
	// フォーカスフラグOFF
...
// 預貯金データコントロールのキーイベント
void	CfrmUc081SiharaitegataK::TerminationYoushikidiag1( short index, short nChar, short length, LPUNKNOWN data )
{
	//--------------------------------------------------------------------------------
	//	キー操作仕様
...
// midori 151405 add -->
void CfrmUc081SiharaitegataK::VScrollYoushikidiag1(short mode)
{
...
//********************************************************************************
int	CfrmUc081SiharaitegataK::GetFocusPosition( int nChar )
{
	int		intRow;				// カレント行番号
	int		intCol;				// カレント列番号
...
//********************************************************************************
int	CfrmUc081SiharaitegataK::GetTotalRowIndex( int nCharOrg, int intIndex, int intNext )
{
...
//		RET		なし
//********************************************************************************
void	CfrmUc081SiharaitegataK::virTblEditIkkatuLine( int nType, CdbUc000Common* rsData,
...
//********************************************************************************
int	CfrmUc081SiharaitegataK::virTblSortSubSortProc( CdlgSort* pCdlgSort, CdbUc000Common* rsData )
{
	CdbUc081Siharaitegata*	rs;
	CString				strFilter;
	CString				strSort;
...
/**********************************************************************
	...
	戻値
		int		成功/失敗
				FUNCTION_OK
***********************************************************************/
int	CfrmUc081SiharaitegataK::RecBufSetData( CdbUc081Siharaitegata* prmDbRec )
{
...
/**********************************************************************
	...
	戻値
		int		成功/失敗
				FUNCTION_OK
***********************************************************************/
int	CfrmUc081SiharaitegataK::RecBufClearAllData()
{
...
/**********************************************************************
	...
	戻値
		int		成功/失敗
				FUNCTION_OK
***********************************************************************/
int	CfrmUc081SiharaitegataK::RecBufClearData( P_REC_UC_081_SIHARAITEGATA inRecData )
{
...
/**********************************************************************
	...
	戻値
		int				成功(更新あり)/成功(更新なし)/失敗
						...
						FUNCTION_NG		: 失敗
***********************************************************************/
int	CfrmUc081SiharaitegataK::virRecBufSaveData( int inPage, int inRow )
{
...
***********************************************************************/
int	CfrmUc081SiharaitegataK::virRecBufSaveDataForPasteInsert( int inPage, int inRow )
{
...
***********************************************************************/
int	CfrmUc081SiharaitegataK::virRecBufSaveDataForPaste( int inPage, int inRow )
{
	///////////////////////////////////////////////////////////////
	// 登録処理呼び出し
	return RecBufSaveDataSub( inPage, inRow, &m_CopyData );
...
/**********************************************************************
	...
	戻値
			int					成功(更新あり)/成功(更新なし)/失敗
								...
								FUNCTION_NG		: 失敗
***********************************************************************/
int	CfrmUc081SiharaitegataK::RecBufSaveDataSub( 
							int inPage,
							int inRow,
...
//********************************************************************************
CdbUc000Common*	CfrmUc081SiharaitegataK::virGetDataTableObject()
{
	// 「支払手形」テーブルのオブジェクトを生成し、ポインタを返す
...
//	RET	なし
//********************************************************************************
void	CfrmUc081SiharaitegataK::virRowButtonCopyProc()
{
...
//	RET	なし
//********************************************************************************
void	CfrmUc081SiharaitegataK::virGetCurrentInfo( CURRENT_INFO* uCurInfo )
{
...
//	【戻値】	なし
//**************************************************
void CfrmUc081SiharaitegataK::SetInputMode( int nRow, long nMode )
{
...
//	【戻値】	なし
//**************************************************
void CfrmUc081SiharaitegataK::SetDiagBackColor()
{
...
//		RET		なし					
//********************************************************************************
void CfrmUc081SiharaitegataK::virRendoCreateData(CdbUc000Common* rsData, RENTEMP_INFO* uRenInfo)
{
	CString			strTemp;
...
//		RET		なし					
//********************************************************************************
void CfrmUc081SiharaitegataK::virRendoUpdateData(CdbUc000Common* rsData, RENTEMP_INFO* uRenInfo)
{
	CdbUc081Siharaitegata*	rs = (CdbUc081Siharaitegata*)rsData;
...
//***************************************************************************
BOOL CfrmUc081SiharaitegataK::virEndProc(void)
{
	TRACE(_T("***** CfrmUc081SiharaitegataK::virEndProc\n"));
...
// midori 151405 add -->
int CfrmUc081SiharaitegataK::CursorControl(short nChar, int sw)
{
	int				rv=0;
	int				intCol=0;
	int				pos=0;
...
// ------------------------------------------------------------------------------------------------------------------------
void CfrmUc081SiharaitegataK::BankCellChg(int nRow,int nCol)
{
	int				sign=0;
	int				index=0;
	int				nCharOver=0;
...
// 修正No.157626 add <--
	...
	if(nCol != ID_COL_081_BKNAME1 && nCol != ID_COL_081_BKNAME2)	{
		return;
	}
	// 画面から名称を取得
...
// 修正No.157628 add <--
			//strSQL2.Format(_T("from uc_081_siharaitegata where FgShow=%d AND NumPage <> %d AND NumRow <> %d) tbl1 "),ID_FGSHOW_OFF,m_ReadData[nRow].m_NumPage,nRow);
...
// 修正No.157626 del -->
	//if(nCol == ID_COL_081_BKNAME1)	CmnHeadDiagSetTitle(&m_HeadDiag, 4, _T("名    称(11)"), nCharOver);
	//else								CmnHeadDiagSetTitle(&m_HeadDiag, 5, _T("支  店  名(11)"), nCharOver);
// 修正No.157626 del <--
// 修正No.157626 add -->
	if(nCol == ID_COL_081_BKNAME1)	{
		if(nCharOver == 1)	CmnHeadDiagSetTitle(&m_HeadDiag, 4, _T("名    称(11)"), 1);
		else				CmnHeadDiagSetTitle(&m_HeadDiag, 4, _T("名　　称"), 0);
	}
	else	{
		if(nCharOver == 1)	CmnHeadDiagSetTitle(&m_HeadDiag, 5, _T("支  店  名(11)"), 1);
		else				CmnHeadDiagSetTitle(&m_HeadDiag, 5, _T("支　店　名"), 0);
	}

	// 欄外ガイドの表示のために他の項目が電子申告の文字数をオーバーしていないかどうか確認する

	// 支払銀行名称
	if(nCol == ID_COL_081_BKNAME2)	{
...
// ------------------------------------------------------------------------------------------------------------------------
// 文言間違いによる修正22/12/01
//void CfrmUc081SiharaitegataK::TatleColorChg(void)
void CfrmUc081SiharaitegataK::TitleColorChg(void)
{
	...
	// 支払銀行名称
// 修正No.157628 del -->
	//strSQL.Format(_T("select max(oversgn) from (select CASE when len(Replace(isnull(BkName1,''),CHAR(13)+CHAR(10),'')) > %d then 1 else 0 end as oversgn from uc_081_siharaitegata where FgShow=%d) tbl1"),UC_BANK_LEN,ID_FGSHOW_OFF);
// 修正No.157628 del <--
// 修正No.157628 add -->
	strSQL.Format(_T("select max(oversgn) from (select CASE when len(%s) > %d then 1 else 0 end as oversgn from uc_081_siharaitegata where FgShow=%d) tbl1"),
		MakeReplaceSent(_T("BkName1")),UC_BANK_LEN,ID_FGSHOW_OFF);
// 修正No.157628 add <--
	...
	// 支払銀行支店名
// 修正No.157628 del -->
	//strSQL.Format(_T("select max(oversgn) from (select CASE when len(Replace(isnull(BkName2,''),CHAR(13)+CHAR(10),'')) > %d then 1 else 0 end as oversgn from uc_081_siharaitegata where FgShow=%d) tbl1"),UC_BANK_LEN,ID_FGSHOW_OFF);
// 修正No.157628 del <--
// 修正No.157628 add -->
	strSQL.Format(_T("select max(oversgn) from (select CASE when len(%s) > %d then 1 else 0 end as oversgn from uc_081_siharaitegata where FgShow=%d) tbl1"),
		MakeReplaceSent(_T("BkName2")),UC_BANK_LEN,ID_FGSHOW_OFF);
// 修正No.157628 add <--
	...
	// 摘要
// 修正No.157628 del -->
	//strSQL.Format(_T("select max(oversgn) from (select CASE when len(Replace(isnull(Teki,''),CHAR(13)+CHAR(10),'')) > %d then 1 else 0 end as oversgn from uc_081_siharaitegata where FgShow=%d) tbl1"),UC_081_TEKI_LEN,ID_FGSHOW_OFF);
// 修正No.157628 del <--
// 修正No.157628 add -->
	strSQL.Format(_T("select max(oversgn) from (select CASE when len(%s) > %d then 1 else 0 end as oversgn from uc_081_siharaitegata where FgShow=%d) tbl1"),
		MakeReplaceSent(_T("Teki")),UC_081_TEKI_LEN,ID_FGSHOW_OFF);
// 修正No.157628 add <--
	...
	// 項目タイトル(ヘッダ部)の再設定
// 修正No.157626 del -->
	//CmnHeadDiagSetTitle(&m_HeadDiag,4,_T("名    称(11)"),nCharOver[0]);
	//CmnHeadDiagSetTitle(&m_HeadDiag,5,_T("支  店  名(11)"),nCharOver[1]);
	//CmnHeadDiagSetTitle(&m_HeadDiag,7,_T("摘      要(50)"),nCharOver[2]);
// 修正No.157626 del <--
// 修正No.157626 add -->
	if(nCharOver[0] == 1)	CmnHeadDiagSetTitle(&m_HeadDiag,4,_T("名    称(11)"),1);
	else					CmnHeadDiagSetTitle(&m_HeadDiag,4,_T("名　　称"),0);

	if(nCharOver[1] == 1)	CmnHeadDiagSetTitle(&m_HeadDiag,5,_T("支  店  名(11)"),1);
	else					CmnHeadDiagSetTitle(&m_HeadDiag,5,_T("支　店　名"),0);

	if(nCharOver[2] == 1)	CmnHeadDiagSetTitle(&m_HeadDiag,7,_T("摘      要(50)"),1);
...
// --------------------------------------------------------------------------------------------------------
void CfrmUc081SiharaitegataK::Date_ChkAndSet(short index, int col, short sign)
{
	short			sv_sel=0;
	int				sv_index=0;
	int				day=0,gen=0;
	...
	if(col != ID_COL_081_SPDATE && col != ID_COL_081_PMDATE)	return;
	...
	if(sign == 1)	{
		if(col == ID_COL_081_SPDATE)	{		// 振出年月日
		...
		else if(col == ID_COL_081_PMDATE)	{	// 支払期日
...
//		RET		int					取引先コード
//********************************************************************************
int CfrmUc081SiharaitegataK::virTblSortGetTorihikisakiCode( CdbUc000Common* rsData )
{
	int						ret=0;
	CdbUc081Siharaitegata*	rs = (CdbUc081Siharaitegata*)rsData;
	ret = rs->m_AdOrder;
...
//		RET		CString				取引先名称
//********************************************************************************
CString CfrmUc081SiharaitegataK::virTblSortGetTorihikisakiName( CdbUc000Common* rsData )
{
	CString					ret=_T("");
...
// 修正No.162446 add -->
LRESULT CfrmUc081SiharaitegataK::OnUserReDrawView(WPARAM wParam, LPARAM lParam)
{
	virUpdateControlTblData();
	CmnDiagSetFocus(m_pDiag, 1, 1);
