...
// midori 152503 del <--
// midori 152503 add -->
#define ID_COL_011_KEI1_KIMATU  4				// 計ダイアログ1行目の期末現在高
#define ID_COL_011_KEI2_MEISYO	6				// 計ダイアログ2行目の計名称（計or合計、頁計、累計）
#define ID_COL_011_KEI2_KIMATU 10				// 計ダイアログ2行目の期末現在高
// midori 152503 add <--

//////////////////////////////////////////////////////////////////
//	1レコード分の構造体
typedef struct tagRecUc011yotyokin
{
	long	m_Seq;
	int		m_NumPage;
	BYTE	m_NumRow;
...
class CfrmUc011Yotyokin: public CfrmUc000Common
{
	DECLARE_DYNCREATE(CfrmUc011Yotyokin)

public:
	CfrmUc011Yotyokin();
	virtual	~CfrmUc011Yotyokin();
...
// midori 161108 add <--
	...
	int		virFncReferenceGetType(int intCol, int* intGrSeq, long* lngItemSeq, int* intAdd1, int* intAdd2, int* intAdd1Col, int* intAdd2Col, REFERENCE_INFO* pudReference = 0);		// F11:参照
