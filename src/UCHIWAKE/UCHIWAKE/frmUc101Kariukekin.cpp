...
IMPLEMENT_DYNCREATE( CfrmUc101Kariukekin, CfrmUc000Common )


BEGIN_MESSAGE_MAP( CfrmUc101Kariukekin, CfrmUc000Common )
	ON_WM_SIZE()
...
//	ON_COMMAND( ID_BUTTON_F3, OnButtonF3 )
	...
	ON_COMMAND( ID_PRINTSETUP_MENU, &CfrmUc101Kariukekin::OnMenuPrintSetup )
	ON_COMMAND( ID_PRINTALL_MENU, &CfrmUc101Kariukekin::OnMenuPrintAll )
	ON_COMMAND( ID_OUTPUTFORM_MENU, &CfrmUc101Kariukekin::OnMenuFormTypeSetup )
	ON_COMMAND( ID_SPECIALROW_MENU, &CfrmUc101Kariukekin::OnMenuSpecialRow )
	ON_COMMAND( ID_SORT_MENU, &CfrmUc101Kariukekin::OnMenuSort )
	ON_COMMAND(ID_IKKATUADD_MENU, &CfrmUc101Kariukekin::OnIkkatuAddMenu)
	ON_COMMAND( ID_DISPDIALOG_MENU, &CfrmUc101Kariukekin::OnMenuIkkatuKingaku )
	ON_COMMAND( ID_ZEROMONEY_MENU, &CfrmUc101Kariukekin::OnMenuZeroMoney )
	ON_COMMAND( ID_ZEROMONEYMOVE_MENU, &CfrmUc101Kariukekin::OnMenuZeroMoneyMove )
	ON_COMMAND( ID_AMOUTDIALOG_MENU, &CfrmUc101Kariukekin::OnMenuOutKeiSetup )
// midori 160606 add -->
	ON_COMMAND( ID_CLEAR_MENU, &CfrmUc101Kariukekin::OnMenuClear )
// midori 160606 add <--
	ON_COMMAND( ID_RENDO_MENU, &CfrmUc101Kariukekin::OnMenuZaimuRendo )
	ON_COMMAND( ID_TITLEMENU, &CfrmUc101Kariukekin::OnMenuTitleRestore )
	ON_COMMAND( ID_USER_SETTING_MENU, &CfrmUc101Kariukekin::OnMenuOptionSetting )
	ON_COMMAND( ID_COPY_SETTING_INFO_MENU, &CfrmUc101Kariukekin::OnMenuCopySettingInfo )
	ON_COMMAND( ID_DELETE_DATA_MENU, &CfrmUc101Kariukekin::OnMenuDeleteDataEachYoushiki )
	ON_BN_CLICKED( IDC_PAGEBACK_BUTTON1, &CfrmUc101Kariukekin::OnPageBack )
	ON_BN_CLICKED( IDC_PAGENEXT_BUTTON1, &CfrmUc101Kariukekin::OnPageNext )
	ON_BN_CLICKED( IDC_PAGENEW_BUTTON1, &CfrmUc101Kariukekin::OnPageNew )
	ON_BN_CLICKED( IDC_PAGEINSERT_BUTTON1, &CfrmUc101Kariukekin::OnPageInsert )
	ON_BN_CLICKED( IDC_ROWCOPY_BUTTON1, &CfrmUc101Kariukekin::OnRowCopy )
	ON_BN_CLICKED( IDC_ROWPASTE_BUTTON1, &CfrmUc101Kariukekin::OnRowPaste )
	ON_BN_CLICKED( IDC_ROWINSERT_BUTTON1, &CfrmUc101Kariukekin::OnRowInsert )
	ON_BN_CLICKED( IDC_YOUSHIKINEXT_BUTTON1, &CfrmUc101Kariukekin::OnMoveYoushikiNext )
	ON_BN_CLICKED( IDC_YOUSHIKIBACK_BUTTON1, &CfrmUc101Kariukekin::OnMoveYoushikiBack )
//	ON_UPDATE_COMMAND_UI( ID_BUTTON_F1, &CfrmUc101Kariukekin::OnUpdateButtonF1 )
//	ON_UPDATE_COMMAND_UI( ID_BUTTON_F3, &CfrmUc101Kariukekin::OnUpdateButtonF3 )
	ON_UPDATE_COMMAND_UI( ID_BUTTON_F6, &CfrmUc101Kariukekin::OnUpdateButtonF6 )
	ON_UPDATE_COMMAND_UI( ID_BUTTON_F7, &CfrmUc101Kariukekin::OnUpdateButtonF7 )
	ON_UPDATE_COMMAND_UI( ID_BUTTON_F8, &CfrmUc101Kariukekin::OnUpdateButtonF8 )
	ON_UPDATE_COMMAND_UI( ID_BUTTON_F9, &CfrmUc101Kariukekin::OnUpdateButtonF9 )
	ON_UPDATE_COMMAND_UI( ID_BUTTON_F11, &CfrmUc101Kariukekin::OnUpdateButtonF11 )
	ON_UPDATE_COMMAND_UI( ID_BUTTON_F12, &CfrmUc101Kariukekin::OnUpdateButtonF12 )
	ON_UPDATE_COMMAND_UI( ID_BUTTON_HOME, &CfrmUc101Kariukekin::OnUpdateButtonHome )
	ON_UPDATE_COMMAND_UI( ID_IKKATUADD_MENU, &CfrmUc101Kariukekin::OnUpdateIkkatuaddMenu)
	ON_UPDATE_COMMAND_UI( ID_DISPDIALOG_MENU, &CfrmUc101Kariukekin::OnUpdateMenuIkkatuKingaku )
// midori 160612 add -->
	ON_UPDATE_COMMAND_UI( ID_SORT_MENU, &CfrmUc101Kariukekin::OnUpdateMenuSort )
	ON_UPDATE_COMMAND_UI( ID_CLEAR_MENU, &CfrmUc101Kariukekin::OnUpdateMenuClear )
// midori 160612 add <--
	ON_UPDATE_COMMAND_UI( ID_ZEROMONEY_MENU, &CfrmUc101Kariukekin::OnUpdateMenuZeroMoney )
// midori 160612 add -->
	ON_UPDATE_COMMAND_UI( ID_ZEROMONEYMOVE_MENU, &CfrmUc101Kariukekin::OnUpdateMenuZeroMoneyMove)
// midori 160612 add <--
	ON_UPDATE_COMMAND_UI( ID_RENDO_MENU, &CfrmUc101Kariukekin::OnUpdateMenuZaimuRendo )
	ON_UPDATE_COMMAND_UI(ID_SPECIALROW_MENU, &CfrmUc101Kariukekin::OnUpdateMenuSpecialRow)
// midori 160612 add -->
	ON_UPDATE_COMMAND_UI( ID_TITLEMENU, &CfrmUc101Kariukekin::OnUpdateMenuTitleRestore )
	ON_UPDATE_COMMAND_UI( ID_DELETE_DATA_MENU, &CfrmUc101Kariukekin::OnUpdateMenuDeleteDataEachYoushiki )
// midori 160612 add <--
	ON_MESSAGE(WM_USER_REDRAWVIEW, OnUserReDrawView)		// 修正No.162446 add
END_MESSAGE_MAP()


CfrmUc101Kariukekin::CfrmUc101Kariukekin()
	: CfrmUc000Common( CfrmUc101Kariukekin::IDD )
{
...
CfrmUc101Kariukekin::~CfrmUc101Kariukekin()
{
	...
	TRACE(_T("***** CfrmUc101Kariukekin::~CfrmUc101Kariukekin\n"));

	//m_pDiag = NULL;
	//m_pTitleDiag = NULL;
}

void CfrmUc101Kariukekin::DoDataExchange( CDataExchange* pDX )
{
...
void CfrmUc101Kariukekin::OnInitialUpdate()
{
...
#ifdef _DEBUG
void CfrmUc101Kariukekin::AssertValid() const
{
	CfrmUc000Common::AssertValid();
}

#ifndef _WIN32_WCE
void CfrmUc101Kariukekin::Dump( CDumpContext& dc ) const
{
...
BEGIN_EVENTSINK_MAP( CfrmUc101Kariukekin, CfrmUc000Common )
	ON_EVENT( CfrmUc101Kariukekin, IDC_YOUSHIKIDIAG1, 3, CfrmUc101Kariukekin::TerminationYoushikidiag1, VTS_I2 VTS_I2 VTS_I2 VTS_UNKNOWN )
	ON_EVENT( CfrmUc101Kariukekin, IDC_YOUSHIKIDIAG1, 2, CfrmUc101Kariukekin::EditOFFYoushikidiag1, VTS_I2 )
	ON_EVENT( CfrmUc101Kariukekin, IDC_YOUSHIKIDIAG1, 1, CfrmUc101Kariukekin::EditONYoushikidiag1, VTS_I2 )
// midori 151405 add -->
	ON_EVENT(CfrmUc101Kariukekin, IDC_YOUSHIKIDIAG1, 12, CfrmUc101Kariukekin::VScrollYoushikidiag1, VTS_I2)
// midori 151405 add <--
// midori 152134 add -->
	ON_EVENT(CfrmUc101Kariukekin, IDC_YOUSHIKIDIAG1, 8, CfrmUc101Kariukekin::ComboSelYoushikidiag1, VTS_I2 VTS_UNKNOWN)
// midori 152134 add <--

	ON_EVENT( CfrmUc101Kariukekin, IDC_YOUSHIKIDIAG2, 3, CfrmUc101Kariukekin::TerminationYoushikidiag1, VTS_I2 VTS_I2 VTS_I2 VTS_UNKNOWN )
	ON_EVENT( CfrmUc101Kariukekin, IDC_YOUSHIKIDIAG2, 2, CfrmUc101Kariukekin::EditOFFYoushikidiag1, VTS_I2 )
	ON_EVENT( CfrmUc101Kariukekin, IDC_YOUSHIKIDIAG2, 1, CfrmUc101Kariukekin::EditONYoushikidiag1, VTS_I2 )
// midori 151405 add -->
	ON_EVENT(CfrmUc101Kariukekin, IDC_YOUSHIKIDIAG2, 12, CfrmUc101Kariukekin::VScrollYoushikidiag1, VTS_I2)
// midori 151405 add <--
// midori 152134 add -->
	ON_EVENT(CfrmUc101Kariukekin, IDC_YOUSHIKIDIAG2, 8, CfrmUc101Kariukekin::ComboSelYoushikidiag1, VTS_I2 VTS_UNKNOWN)
// midori 152134 add <--

	ON_EVENT( CfrmUc101Kariukekin, IDC_YOUSHIKIDIAG3, 3, CfrmUc101Kariukekin::TerminationYoushikidiag1, VTS_I2 VTS_I2 VTS_I2 VTS_UNKNOWN )
	ON_EVENT( CfrmUc101Kariukekin, IDC_YOUSHIKIDIAG3, 2, CfrmUc101Kariukekin::EditOFFYoushikidiag1, VTS_I2 )
	ON_EVENT( CfrmUc101Kariukekin, IDC_YOUSHIKIDIAG3, 1, CfrmUc101Kariukekin::EditONYoushikidiag1, VTS_I2 )
// midori 151405 add -->
	ON_EVENT(CfrmUc101Kariukekin, IDC_YOUSHIKIDIAG3, 12, CfrmUc101Kariukekin::VScrollYoushikidiag1, VTS_I2)
// midori 151405 add <--
// midori 152134 add -->
	ON_EVENT(CfrmUc101Kariukekin, IDC_YOUSHIKIDIAG3, 8, CfrmUc101Kariukekin::ComboSelYoushikidiag1, VTS_I2 VTS_UNKNOWN)
// midori 152134 add <--

	ON_EVENT( CfrmUc101Kariukekin, IDC_YOUSHIKIDIAG4, 3, CfrmUc101Kariukekin::TerminationYoushikidiag1, VTS_I2 VTS_I2 VTS_I2 VTS_UNKNOWN )
	ON_EVENT( CfrmUc101Kariukekin, IDC_YOUSHIKIDIAG4, 2, CfrmUc101Kariukekin::EditOFFYoushikidiag1, VTS_I2 )
	ON_EVENT( CfrmUc101Kariukekin, IDC_YOUSHIKIDIAG4, 1, CfrmUc101Kariukekin::EditONYoushikidiag1, VTS_I2 )
// midori 151405 add -->
	ON_EVENT(CfrmUc101Kariukekin, IDC_YOUSHIKIDIAG4, 12, CfrmUc101Kariukekin::VScrollYoushikidiag1, VTS_I2)
// midori 151405 add <--
// midori 152134 add -->
	ON_EVENT(CfrmUc101Kariukekin, IDC_YOUSHIKIDIAG4, 8, CfrmUc101Kariukekin::ComboSelYoushikidiag1, VTS_I2 VTS_UNKNOWN)
// midori 152134 add <--

	ON_EVENT( CfrmUc101Kariukekin, IDC_YOUSHIKIDIAG5, 3, CfrmUc101Kariukekin::TerminationYoushikidiag1, VTS_I2 VTS_I2 VTS_I2 VTS_UNKNOWN )
	ON_EVENT( CfrmUc101Kariukekin, IDC_YOUSHIKIDIAG5, 2, CfrmUc101Kariukekin::EditOFFYoushikidiag1, VTS_I2 )
	ON_EVENT( CfrmUc101Kariukekin, IDC_YOUSHIKIDIAG5, 1, CfrmUc101Kariukekin::EditONYoushikidiag1, VTS_I2 )
// midori 151405 add -->
	ON_EVENT(CfrmUc101Kariukekin, IDC_YOUSHIKIDIAG5, 12, CfrmUc101Kariukekin::VScrollYoushikidiag1, VTS_I2)
// midori 151405 add <--
// midori 152134 add -->
	ON_EVENT(CfrmUc101Kariukekin, IDC_YOUSHIKIDIAG5, 8, CfrmUc101Kariukekin::ComboSelYoushikidiag1, VTS_I2 VTS_UNKNOWN)
// midori 152134 add <--

	ON_EVENT( CfrmUc101Kariukekin, IDC_YOUSHIKIDIAG6, 3, CfrmUc101Kariukekin::TerminationYoushikidiag1, VTS_I2 VTS_I2 VTS_I2 VTS_UNKNOWN )
	ON_EVENT( CfrmUc101Kariukekin, IDC_YOUSHIKIDIAG6, 2, CfrmUc101Kariukekin::EditOFFYoushikidiag1, VTS_I2 )
	ON_EVENT( CfrmUc101Kariukekin, IDC_YOUSHIKIDIAG6, 1, CfrmUc101Kariukekin::EditONYoushikidiag1, VTS_I2 )
// midori 151405 add -->
	ON_EVENT(CfrmUc101Kariukekin, IDC_YOUSHIKIDIAG6, 12, CfrmUc101Kariukekin::VScrollYoushikidiag1, VTS_I2)
// midori 151405 add <--
// midori 152134 add -->
	ON_EVENT(CfrmUc101Kariukekin, IDC_YOUSHIKIDIAG6, 8, CfrmUc101Kariukekin::ComboSelYoushikidiag1, VTS_I2 VTS_UNKNOWN)
// midori 152134 add <--

	ON_EVENT( CfrmUc101Kariukekin, IDC_TITLEDIAG1, 3, CfrmUc101Kariukekin::TerminationTitlediag1, VTS_I2 VTS_I2 VTS_I2 VTS_UNKNOWN )
	ON_EVENT( CfrmUc101Kariukekin, IDC_TITLEDIAG1, 2, CfrmUc101Kariukekin::EditOFFTitlediag1, VTS_I2 )
	ON_EVENT( CfrmUc101Kariukekin, IDC_TITLEDIAG1, 1, CfrmUc101Kariukekin::EditONTitlediag1, VTS_I2 )
	ON_EVENT( CfrmUc101Kariukekin, IDC_TITLEDIAG1, 6, CfrmUc101Kariukekin::FocusTitlediag1, VTS_NONE )

	ON_EVENT( CfrmUc101Kariukekin, IDC_PAGEDIAG1, 3, CfrmUc101Kariukekin::TerminationPagediag1, VTS_I2 VTS_I2 VTS_I2 VTS_UNKNOWN )
	ON_EVENT( CfrmUc101Kariukekin, IDC_PAGEDIAG1, 2, CfrmUc101Kariukekin::EditOFFPagediag1, VTS_I2 )
	ON_EVENT( CfrmUc101Kariukekin, IDC_PAGEDIAG1, 1, CfrmUc101Kariukekin::EditONPagediag1, VTS_I2 )
	ON_EVENT( CfrmUc101Kariukekin, IDC_PAGEDIAG1, 6, CfrmUc101Kariukekin::FocusPagediag1, VTS_NONE )
END_EVENTSINK_MAP()

//********************************************************************************
//	初期処理
//********************************************************************************
BOOL	CfrmUc101Kariukekin::virStartJob()
{
	// 初期値設定
...
//	共通データの初期値設定
//********************************************************************************
void	CfrmUc101Kariukekin::virSetInitialUchiwakeInfo()
{
	// 「仮受金」の固有データ
	...
	m_uInfo.intColMax = ID_COLMAX_101;				// １行内のコントロール個数
	m_uInfo.intColMaxData = ID_COLMAXDATA_101;		// １行内の列数
	m_uInfo.intCtlStartIndex = ID_CTLSTARTINDEX_101;// １行目の入力項目の先頭インデックス番号
	m_uInfo.intT1StartIndex = ID_T1STARTNORMAL_101;	// 合計行①の先頭インデックス番号
	m_uInfo.intT2StartIndex = ID_T2STARTNORMAL_101;	// 合計行②の入力項目の先頭インデックス番号
	m_uInfo.intCursolDefPos = ID_COL_101_ADNAME1;	// カーソル移動時の初期位置（タイトルから↓，合計から↑で使用）
	m_uInfo.intCursolKeiPos = ID_COL_101_KNSEQ;		// 合計行のカーソル移動位置（カーソル移動で使用）
	...
	m_uInfo.intT1StartNormal = ID_T1STARTNORMAL_101;	//	通常時：合計行①の先頭インデックス
	m_uInfo.intT2StartNormal = ID_T2STARTNORMAL_101;	//	通常時：合計行②の先頭インデックス
	m_uInfo.intT1StartKobetu = ID_T1STARTKOBETU_101;	//	個別時：合計行①の先頭インデックス
	m_uInfo.intT2StartKobetu = ID_T2STARTKOBETU_101;	//	個別時：合計行②の先頭インデックス
	m_uInfo.intRowKei = ID_ROWKEI_101;				// 帳表固定の合計行数（1:合計あり，0:なし）
	m_uInfo.intKei1StartIndex = ID_COL_101_KEI1_MEISYO;	// 計ダイアグラム1行目の先頭インデックス
	m_uInfo.intKei2StartIndex = ID_COL_101_KEI2_MEISYO;	// 計ダイアグラム2行目の先頭インデックス
...
//	【戻値】	なし
//**************************************************
void CfrmUc101Kariukekin::virSetInitialDiag()
{	
	int		nIndex;
	...
	//	コンボボックスの属性取得
	nIndex = CmnGetControlIndex( 1, ID_COL_101_KNSEQ );
...
//	帳表固有変数の初期値設定
//********************************************************************************
void	CfrmUc101Kariukekin::virSetInitialValue()
{
	// 1ページ分のローカルバッファをクリア
	RecBufClearAllData();
...
//	帳表コントロールの初期化（データ領域）
//********************************************************************************
BOOL	CfrmUc101Kariukekin::InitialControlDataArea()
{
	int		intMax;
	int		i;
// No.200903 add -->
...
// No.200903 add <--
	...
	for ( i = m_uInfo.intCtlStartIndex; i < intMax; i += m_uInfo.intColMax ) {
		// ComboBox：クリア
		CmnDiagSetString( m_pDiag, i + ID_COL_101_KNSEQ - 1, "", 0 );	// 科目
		
		// 漢字入力欄の初期化
		CmnDiagSetAttrInpmax( m_pDiag, i + ID_COL_101_ADNAME1    - 1, MAX_KETA_101_ADNAME1 );		//	名称１
		CmnDiagSetAttrInpmax( m_pDiag, i + ID_COL_101_ADADD1    - 1, MAX_KETA_101_ADADD1 );			//	住所１
		CmnDiagSetAttrInpmax( m_pDiag, i + ID_COL_101_ADADD2    - 1, MAX_KETA_101_ADADD2 );			//	住所２
		CmnDiagSetAttrInpmax( m_pDiag, i + ID_COL_101_KANKEI    - 1, MAX_KETA_101_KANKEI );			//	法人・代表者との関係
		CmnDiagSetAttrInpmax( m_pDiag, i + ID_COL_101_NAIYOU    - 1, MAX_KETA_101_NAIYOU );			//	摘要

		// 金額欄：桁数初期化
// No.200903 del -->
		//CmnDiagSetAttrDigit( m_pDiag, i + ID_COL_101_VAL - 1, ID_VAL_101_DATA );	// 金額
// No.200903 del <--
// No.200903 add -->
		if(bG_Kanso == TRUE)	len = ID_VAL_101_K_DATA;
		else					len = ID_VAL_101_DATA;
		CmnDiagSetAttrDigit( m_pDiag, i + ID_COL_101_VAL - 1, len );	// 金額
// No.200903 add <--
	...
	// 半角/全角設定
	CmnDiagSetAttrColZenHan( m_pDiag , ID_COL_101_ADNAME1 );	// 名称1
	CmnDiagSetAttrColZenHan( m_pDiag , ID_COL_101_ADADD1 );		// 所在地1
	CmnDiagSetAttrColZenHan( m_pDiag , ID_COL_101_ADADD2 );		// 所在地2
	CmnDiagSetAttrColZenHan( m_pDiag , ID_COL_101_KANKEI );		// 法人・代表者との関係
	CmnDiagSetAttrColZenHan( m_pDiag , ID_COL_101_NAIYOU );		// 取引の内容
...
//********************************************************************************
BOOL	CfrmUc101Kariukekin::InitialControlDataAreaHide( CICSDiag* pDiag )
{
	int		intMax;
	int		i;
// No.200903 add -->
...
// No.200903 add <--
	...
	for ( i = m_uInfo.intCtlStartIndex; i < intMax; i += m_uInfo.intColMax ) {
		// ComboBox：クリア
		CmnDiagSetString( pDiag, i + ID_COL_101_KNSEQ - 1, "", 0 );	// 科目
		
		// 漢字入力欄の初期化
		CmnDiagSetAttrInpmax( pDiag, i + ID_COL_101_ADNAME1    - 1, MAX_KETA_101_ADNAME1 );		//	名称１
		CmnDiagSetAttrInpmax( pDiag, i + ID_COL_101_ADADD1    - 1, MAX_KETA_101_ADADD1 );			//	住所１
		CmnDiagSetAttrInpmax( pDiag, i + ID_COL_101_ADADD2    - 1, MAX_KETA_101_ADADD2 );			//	住所２
		CmnDiagSetAttrInpmax( pDiag, i + ID_COL_101_KANKEI    - 1, MAX_KETA_101_KANKEI );			//	法人・代表者との関係
		CmnDiagSetAttrInpmax( pDiag, i + ID_COL_101_NAIYOU    - 1, MAX_KETA_101_NAIYOU );			//	摘要

		// 金額欄：桁数初期化
// No.200903 del -->
		//CmnDiagSetAttrDigit( pDiag, i + ID_COL_101_VAL - 1, ID_VAL_101_DATA );	// 金額
// No.200903 del <--
// No.200903 add -->
		if(bG_Kanso == TRUE)	len = ID_VAL_101_K_DATA;
		else					len = ID_VAL_101_DATA;
		CmnDiagSetAttrDigit( pDiag, i + ID_COL_101_VAL - 1, len );				// 金額
// No.200903 add <--
	}
...
//********************************************************************************
BOOL	CfrmUc101Kariukekin::InitialControlComboBox()
{
	...
	for ( i = 1; i <= intMax; i++ ) {
		...
		intIndex = CmnGetControlIndex( i, ID_COL_101_KNSEQ );
...
//********************************************************************************
void	CfrmUc101Kariukekin::InitialControlTotalArea()
{
	int		nKeiType;			//	計の種別
...
// 修正No.157898 add -->
	if(flg2[0] == 1)	{
		// 一括自動行の科目を入力可能にする
		m_pDiag->ModifyItem( CmnGetControlIndex( (nDataRowPos[0]+1), ID_COL_101_KNSEQ ), (DIAG_MDFY_EDIT | DIAG_MDFY_OPAQUE) );
	}
	if(flg2[1] == 1)	{
		// 一括自動行の科目を入力可能にする
		m_pDiag->ModifyItem( CmnGetControlIndex( (nDataRowPos[1]+1), ID_COL_101_KNSEQ ), (DIAG_MDFY_EDIT | DIAG_MDFY_OPAQUE) );
	}
// 修正No.157898 add <--
...
// midori 152166 add <--
	...
	//m_pDiag->ModifyItem( CmnGetControlTotalIndex( 1, ID_COL_101_KNSEQ ), nKeiRow[0] );
	//m_pDiag->ModifyItem( CmnGetControlTotalIndex( 2, ID_COL_101_KNSEQ ), nKeiRow[1] );
	
// No.200903 del -->
	//// 合計行の金額欄は、金額欄 + 1桁
	//CmnDiagSetAttrDigit( m_pDiagKei, ID_COL_101_KEI1_VAL, ID_VAL_041_TOTAL );
	//CmnDiagSetAttrDigit( m_pDiagKei, ID_COL_101_KEI1_VAL, ID_VAL_041_TOTAL );
	////CmnDiagSetAttrDigit( m_pDiag, CmnGetControlTotalIndex( 1, ID_COL_101_VAL ), ID_VAL_101_TOTAL );
	////CmnDiagSetAttrDigit( m_pDiag, CmnGetControlTotalIndex( 2, ID_COL_101_VAL ), ID_VAL_101_TOTAL );
// No.200903 del <--
}
...
//		→表示していない方のDiag(通常 or 個別)の設定に使用する
//********************************************************************************
void	CfrmUc101Kariukekin::InitialControlTotalAreaHide( CICSDiag* pDiag )
{
	int intIndex = 0;
	...
	// 合計行の金額欄は、金額欄 + 1桁
	intIndex = m_intT1StartIndexHide + m_uInfo.intCtlStartIndex + ID_COL_101_VAL - 1;
	CmnDiagSetAttrDigit( pDiag, intIndex, ID_VAL_101_TOTAL );

	intIndex = m_intT2StartIndexHide + m_uInfo.intCtlStartIndex + ID_COL_101_VAL - 1;
	CmnDiagSetAttrDigit( pDiag, intIndex, ID_VAL_101_TOTAL );
}
...
//	RET	なし
//********************************************************************************
void	CfrmUc101Kariukekin::InitialControlSpecialRow( int intRow, int intFgFunc )
{
	DIAGRAM_DATA	diadata;	// ICSDIAG構造体
	...
	case ID_FGFUNC_IKKATUAUTO:		// 一括集計金額行（自動）
		// 桁数を設定
		CmnDiagSetAttrDigit( m_pDiag, CmnGetControlIndex( intRow , ID_COL_101_VAL ), ID_VAL_101_TOTAL );
		break;
	}
	...
	case ID_FGFUNC_IKKATUAUTO:		// 一括集計金額行（自動）
		...
		if ( intFgFunc != ID_FGFUNC_IKKATUAUTO ){
			...
			m_pDiag->ModifyItem( CmnGetControlIndex( intRow, ID_COL_101_KNSEQ ), DIAG_MDFY_NODROPDOWN );

			// ComboBoxの選択項目クリア
			m_clsFunc.DiagInit( &diadata );
			diadata.text_combo = _T( "\r\n" );
			m_pDiag->SetData( CmnGetControlIndex( intRow, ID_COL_101_KNSEQ ), (LPUNKNOWN)&diadata );
		}
...
// 改良No.21-0086,21-0529 cor <--
			...
			if (intFgFunc == ID_FGFUNC_IKKATUAUTO ){
				//	科目
				m_pDiag->ModifyItem( CmnGetControlIndex( intRow, ID_COL_101_KNSEQ ), DIAG_MDFY_INPUT );
			}
		}
// No.200905 add <--
...
//	帳表タイトル情報の表示
//********************************************************************************
void	CfrmUc101Kariukekin::virUpdateControlTitle()
{
...
//	帳表ページ情報の表示
//********************************************************************************
void	CfrmUc101Kariukekin::UpdateControlPage()
{
	BOOL	bBack = TRUE;
	BOOL	bNext = TRUE;
...
//	帳表データの表示（１ページ分）
//********************************************************************************
BOOL	CfrmUc101Kariukekin::virUpdateControlTblData()
{
	// ダイアログ切替
	if( m_pDiag != NULL ){
		virSetInitialDiag();
...
// No.200903 add -->
	// 頁計、累計行の桁数をセットする
	CmnDiagSetAttrDigit( m_pDiagKei, ID_COL_101_KEI1_VAL, ID_VAL_101_TOTAL );
	CmnDiagSetAttrDigit( m_pDiagKei, ID_COL_101_KEI1_VAL, ID_VAL_101_TOTAL );
// No.200903 add <--
...
// No.200601 add -->
		...
		if(bG_Kanso == TRUE) {
			...
			// 科目
			CmnInitialControlFgStringCell( m_pDiag, dbRec.m_NumRow, ID_COL_101_KNSEQ, dbRec.m_FgFunc, UC_KAMOKU_LEN, dbRec.m_KnName);
			// 法人・代表者との関係
			CmnInitialControlFgStringCell( m_pDiag, dbRec.m_NumRow, ID_COL_101_KANKEI, dbRec.m_FgFunc, UC_101_KANKEI_LEN, dbRec.m_Kankei);
		}
// No.200601 add <--
...
//	保管件数の表示
//********************************************************************************
BOOL CfrmUc101Kariukekin::virUpdateControlTblData2()
{
	int					hcnt=0;
	CString				cs=_T("");
...
//		RET		なし
//********************************************************************************
void	CfrmUc101Kariukekin::UpdateControlRowData( CdbUc101Kariukekin* prmDbRec ) {
	...
	m_clsFunc.DiagInit( &diadata );
	// 読込み対象セル取得
	intCell = CmnGetControlIndex( prmDbRec->m_NumRow, ID_COL_101_KNSEQ );
...
//		RET		なし
//********************************************************************************
void	CfrmUc101Kariukekin::UpdateControlRowTotal( CdbUc101Kariukekin* prmDbRec ) {
	...
	// 頁計/累計の名称表示
	if (intRowName > 0) {
		CmnDiagSetString( m_pDiagKei, CmnGetKeiDiagIndex( intRowName, ID_COL_101_KEI1_MEISYO ), prmDbRec->m_KeiStr, 1 );
	}
	// 頁計/累計の金額表示
	if (intRowKingaku > 0) {
		CmnDiagSetKingaku( m_pDiagKei, CmnGetKeiDiagIndex( intRowKingaku, ID_COL_101_KEI1_VAL ), prmDbRec->m_Val );
	}
}
...
//		RET		なし
//********************************************************************************
void	CfrmUc101Kariukekin::virFncCellCopyProc( CdbUc000Common* rsData )
{
...
//********************************************************************************
int	CfrmUc101Kariukekin::virFncReferenceGetType(int intCol, int* intGrSeq, long* lngItemSeq, int* intAdd1, int* intAdd2, int* intAdd1Col, int* intAdd2Col, REFERENCE_INFO* pudReference)
{
int				intRefType;
	...
	//case ID_COL_101_ADADD2:
		...
		*lngItemSeq = m_ReadData[m_uInfo.intCurRow].m_AdSeq;
		// 住所欄なら住所１、２の列番号取得
		//if ( intCol != ID_COL_101_ADNAME1 ){
		//	*intAdd1Col = ID_COL_101_ADADD1;
		//	*intAdd2Col = ID_COL_101_ADADD2;
		//}
		break;
...
//		RET		なし
//********************************************************************************
void	CfrmUc101Kariukekin::virFncReferenceSetData( CdlgReference* dlgRef, int intRefType, int intCol )
{
	int		nCurRow;	//	カレント行
	int		nCurCol;	//	カレント列
	int		nPos;		//	位置
...
// midori 152137 add <--
	...
	case ID_DLGTYPE_ADDRESS:
		...
		//	現在行の取引先の名称１の位置を算出
		nPos = (( nCurRow - 1 ) * m_uInfo.intColMax ) + ( m_uInfo.intCtlStartIndex + ( ID_COL_101_ADNAME1 - 1 ));
...
//		RET		なし
//********************************************************************************
void	CfrmUc101Kariukekin::virFncReferenceUpdateTbl( int intRefType, int nRefMode/*=0*/ )
{
	switch (intRefType) {
...
//@			rsKmk.UpdateDataTable(TBL_NAME_101, m_uInfo.intFormSeq);
...
//@			mfcRec.UpdateDataTable( TBL_NAME_101 );
...
//		RET		なし
//********************************************************************************
void	CfrmUc101Kariukekin::virFncReferenceSetICSData(CdlgAddressSearch* dlgAddd)
{
	int			intIndex;

	// 売却(買入)先の所在地1(住所)
	intIndex = CmnGetControlIndex( m_uInfo.intCurRow, ID_COL_101_ADADD1 );
	CmnDiagSetString( m_pDiag, intIndex, dlgAddd->m_AdAdd1, 0 );

	// 売却(買入)先の所在地2(住所)
	intIndex = CmnGetControlIndex( m_uInfo.intCurRow, ID_COL_101_ADADD2 );
	CmnDiagSetString( m_pDiag, intIndex, dlgAddd->m_AdAdd2, 0 );
}

// 要通知案件修正 21/07/09 add -->
void CfrmUc101Kariukekin::virActivateFrameK(UINT nState, CFrameWnd* pDeactivateFrame)
{
	int		index = 0;
	...
	if(pWnd != NULL)	{
		if(m_DataKakutei == FALSE)	{
			if(m_uInfo.intCurCol == ID_COL_101_KNSEQ)	{
				virKamokuAddCancel();
			}
		}
	}
...
void CfrmUc101Kariukekin::virKamokuAddCancel()
{
	...
	// 科目列なら
	if(m_uInfo.intCurCol == ID_COL_101_KNSEQ && m_F9OnSw != TRUE)	{
		DIAGRAM_DATA	diadata;
		m_pDiag->GetData(m_uInfo.intCurCtlIndex,(LPUNKNOWN)&diadata);
		// 【新規作成】が選択されていれば
		if(diadata.data_combo > m_CmbCnt)	{
			// 前回の値に戻す
			CmnDiagSetCombo(m_pDiag,CmnGetControlIndex(m_uInfo.intCurRow,ID_COL_101_KNSEQ),m_uInfo.OldCombo);
		}
	}
}
// 要通知案件修正 21/07/09 add <--
...
//	その他イベント処理
//********************************************************************************
BOOL	CfrmUc101Kariukekin::PreTranslateMessage( MSG* pMsg )
{
//	int				intID;
...
//				if ((CmnGetControlCol() != ID_COL_101_KNSEQ) || (CmnCheckTotalRow() == TRUE )){
// midori 160611 del <--
				// カレントインデックスを保存
...
//				//}
//// ---------------------
//				if(CmnGetControlCol() == ID_COL_101_KNSEQ)	{
//					rv=1;
//				}
//// midori 160611 cor <--
// midori 152134 17/10/07 del <--
...
/*
		...
		case VK_TAB:
			...
			if ((intID == IDC_PAGEBACK_BUTTON1) && (CmnCheckShiftKey() == TRUE)) {
				...
				CmnDiagSetFocus(m_pDiag, m_uInfo.intRowMax, ID_COL_101_NAIYOU);
				return 1;
			}
			break;
*/
...
// 修正No.158259 add -->
				...
				intCol = CmnGetControlCol();
				if(intCol == ID_COL_101_KNSEQ && (pMsg->wParam == VK_LEFT || pMsg->wParam == VK_RIGHT))	{
...
// 頁コントロールのフォーカス設定
void	CfrmUc101Kariukekin::FocusPagediag1()
{
...
// 頁コントロールのゲットフォーカス
void	CfrmUc101Kariukekin::EditONPagediag1( short index )
{
// midori 151405 add -->
	// スクロールフラグをクリアする
	nG_MScroll = 0;
...
// midori 151405 add <--
	...
	// 1行登録
//	if( CmnGetControlCol() != ID_COL_101_VAL ){
...
// 頁コントロールのロストフォーカス
void	CfrmUc101Kariukekin::EditOFFPagediag1( short index )
{
// midori 155028 add -->
...
// 頁コントロールのキー操作
void	CfrmUc101Kariukekin::TerminationPagediag1( short index, short nChar, short length, LPUNKNOWN data )
{
	int nMaxDataCol = 0;
	// カレント頁の合計行の種別を取得
...
// midori 160612 cor <--
			...
			//CmnDiagSetFocus(m_pDiag, m_uInfo.intRowMax, ID_COL_101_NAIYOU);
			CmnDiagSetFocus(m_pDiag, nMaxDataCol, ID_COL_101_NAIYOU);
		}
		break;
	case VK_DOWN:
		// タイトルコントロールへ移動
...
// タイトルコントロールのフォーカス設定
void	CfrmUc101Kariukekin::FocusTitlediag1()
{
//マウスクリックでキャレットが表示できないためコメントとする
//	// ボタンからTabキー移動した場合に必要
//	m_TitleDiag.SetPosition( 0 );
...
// タイトルコントロールのゲットフォーカス
void	CfrmUc101Kariukekin::EditONTitlediag1( short index )
{
// midori 151405 add -->
	// スクロールフラグをクリアする
	nG_MScroll = 0;
...
// タイトルコントロールのロストフォーカス
void	CfrmUc101Kariukekin::EditOFFTitlediag1 (short index )
{
// midori 151405 add -->
	m_Titlefocus = 0;
// midori 151405 add <--
...
//	タイトル更新
void CfrmUc101Kariukekin::virUpdateTitle()
{
...
// タイトルコントロールのキーイベント
void	CfrmUc101Kariukekin::TerminationTitlediag1( short index, short nChar, short length, LPUNKNOWN data )
{
	// フォーカス移動
	switch ( nChar ) {
	case VK_RETURN:
...
void	CfrmUc101Kariukekin::EditONYoushikidiag1( short index )
{
	DIAGRAM_DATA	diadata;
...
//			if( CmnGetControlCol() != ID_COL_101_VAL ){
			...
			BOOL adadd1_to_adadd2 = IsSaveMoveReference(ID_COL_101_ADADD1, ID_COL_101_ADADD2);
			// [Home]キー押下の住所検索ダイアログの戻り（フォーカスをセットしている）は保存しない（改良依頼No15-1613）
			BOOL adadd1_to_adadd1 = IsSaveMoveReference(ID_COL_101_ADADD1, ID_COL_101_ADADD1);	// 所在地1(住所)→所在地1(住所)
			BOOL adadd2_to_adadd2 = IsSaveMoveReference(ID_COL_101_ADADD2, ID_COL_101_ADADD2);	// 所在地2(住所)→所在地2(住所)　所在地2から住所が長すぎる場合、ここがFALSEになる
...
// データコントロールのロストフォーカス
void	CfrmUc101Kariukekin::EditOFFYoushikidiag1( short index )
{
	if( m_EndView != FALSE )	return;
...
//	入力確定
void CfrmUc101Kariukekin::virInputDecisionEditOFF()
{
	// フォーカスフラグOFF
...
//		//CString hoge;
//		//BOOL iscolumn = m_isF6 == FALSE && !(current_column == ID_COL_101_ADADD1);
//		//hoge.Format("iscolumn = %d\n", iscolumn);
//		//TRACE(hoge);
//		if(m_isF6 == FALSE && !(current_column == ID_COL_101_ADADD1)){
...
// 預貯金データコントロールのキーイベント
void	CfrmUc101Kariukekin::TerminationYoushikidiag1( short index, short nChar, short length, LPUNKNOWN data )
{
	//--------------------------------------------------------------------------------
	//	キー操作仕様
...
// midori 151405 add -->
void CfrmUc101Kariukekin::VScrollYoushikidiag1(short mode)
{
...
//********************************************************************************
int	CfrmUc101Kariukekin::GetFocusPosition( int nChar )
{
	int		intRow;					// カレント行番号
	int		intCol;					// カレント列番号
	...
	else if ( intCol == ID_COL_101_ADNAME1 ){
		// カレント列が「名称１」の場合
	...
	else if ( intCol == ID_COL_101_ADADD1 ){
		// カレント列が「住所１」の場合
	...
	else if ( intCol == ID_COL_101_ADADD2 ){
		// カレント列が「住所２」の場合
	...
	else if ( intCol == ID_COL_101_NAIYOU ){
		// カレント列が「取引の内容」の場合
		intVector[0] = m_uInfo.intCurCtlIndex - m_uInfo.intColMax;		// ↑
	...
	case VK_TAB:
		if (CmnCheckShiftKey() == FALSE) {
			...
			// それ以外は「←」キーと同じ
			if ((intRow <= 1) && (intCol == ID_COL_101_KNSEQ)) {
				return -1;
			}
...
//********************************************************************************
int	CfrmUc101Kariukekin::GetTotalRowIndex( int nCharOrg, int intIndex, int intNext )
{
	...
	if ( nNowRow <= nBorder[0] ){
		...
		if (( intNext > CmnGetControlIndex( m_uInfo.intRowMax, ID_COL_101_NAIYOU ) ) && ( nCharOrg == VK_TAB )){
			return( -2 );
		}
		//	データ行を超えた？かつ計行あり？
		else if (( nNextRow > nBorder[0] ) && ( nBorder[1] > 0 )){
			//	計行に移動
			//nRet = CmnGetControlIndex( ( nBorder[1] + 2 ), ID_COL_101_KNSEQ );
			if (nCharOrg == VK_TAB) {
				return -2;
			}
		}
	...
	//	現在、頁計に居る
		...
		case VK_UP:			// ↑：23行目のデータ行の支店名項目へ移動
			nRet = CmnGetControlIndex( nBorder[0], ID_COL_101_ADNAME1 );
			break;
		case VK_LEFT:		// ←/Shift+Tab：23行目のデータ行の摘要項目へ移動
			nRet = CmnGetControlIndex( nBorder[0], ID_COL_101_NAIYOU );
			break;
		default:			// →/↓/Return/Tab：25行目の合計行②へ移動
			...
			//	累計なし
				...
				nRet = CmnGetControlIndex( ( nBorder[2] + 2 ), ID_COL_101_KNSEQ );
			}
			break;
		}
	}
...
//		RET		なし
//********************************************************************************
void	CfrmUc101Kariukekin::virTblEditIkkatuLine( int nType, CdbUc000Common* rsData,
...
//********************************************************************************
int	CfrmUc101Kariukekin::virTblSortSubSortProc( CdlgSort* pCdlgSort, CdbUc000Common* rsData )
{
	CdbUc101Kariukekin*	rs;
	CString				strFilter;
	CString				strSort;
...
/**********************************************************************
	...
	戻値
		int		成功/失敗
				FUNCTION_OK
***********************************************************************/
int	CfrmUc101Kariukekin::RecBufSetData( CdbUc101Kariukekin* prmDbRec )
{
...
/**********************************************************************
	...
	戻値
		int		成功/失敗
				FUNCTION_OK
***********************************************************************/
int	CfrmUc101Kariukekin::RecBufClearAllData()
{
...
/**********************************************************************
	...
	戻値
		int		成功/失敗
				FUNCTION_OK
***********************************************************************/
int	CfrmUc101Kariukekin::RecBufClearData( P_REC_UC_101_KARIUKEKIN inRecData )
{
	inRecData->m_Seq = 0;
...
/**********************************************************************
	...
	戻値
		int				成功(更新あり)/成功(更新なし)/失敗
						...
						FUNCTION_NG		: 失敗
***********************************************************************/
int	CfrmUc101Kariukekin::virRecBufSaveData( int inPage, int inRow )
{
	...
	// 科目
	intIndex = CmnGetControlIndex( inRow, ID_COL_101_KNSEQ );
...
// midori 152137 add <--
	...
	intIndex = CmnGetControlIndex( inRow, ID_COL_101_ADNAME1 );
// 158138 del -->
...
// 158138 add <--
	...
	if ( tmpSaveData.m_AdName2.IsEmpty() ){
		if(m_uInfo.intCurCol == ID_COL_101_ADNAME1 && m_uInfo.intCurRow != m_uInfo.OldRow){	// 各カラムごとにvirRecBufSaveData()がコールされるようになり、かつタイミングがEditOffからEditOnに移ったことによりCmnDiagSetString()でカレットが末尾から先頭に移ってしまう為、制御（修正依頼No150489）
			CmnDiagSetString( m_pDiag, intIndex, tmpSaveData.m_AdName1, 0 );
		}
	}

	// 所在地1
	intIndex = CmnGetControlIndex( inRow, ID_COL_101_ADADD1 );
	tmpSaveData.m_AdAdd1 = m_clsFunc.DiagGetString( m_pDiag, intIndex );

	// 所在地2
	intIndex = CmnGetControlIndex( inRow, ID_COL_101_ADADD2 );
	tmpSaveData.m_AdAdd2 = m_clsFunc.DiagGetString( m_pDiag, intIndex );

	// 法人・代表者との関係
	intIndex = CmnGetControlIndex( inRow, ID_COL_101_KANKEI );
	tmpSaveData.m_Kankei = m_clsFunc.DiagGetString( m_pDiag, intIndex );

	// 金額
	intIndex = CmnGetControlIndex( inRow, ID_COL_101_VAL );
	tmpSaveData.m_Val = CmnDiagGetKingaku( m_pDiag, intIndex );

	// 取引の内容
	intIndex = CmnGetControlIndex( inRow, ID_COL_101_NAIYOU );
...
***********************************************************************/
int	CfrmUc101Kariukekin::virRecBufSaveDataForPasteInsert( int inPage, int inRow )
{
...
***********************************************************************/
int	CfrmUc101Kariukekin::virRecBufSaveDataForPaste( int inPage, int inRow )
{
	///////////////////////////////////////////////////////////////
	// 登録処理呼び出し
	return RecBufSaveDataSub( inPage, inRow, &m_CopyData );
...
/**********************************************************************
	...
	戻値
			int					成功(更新あり)/成功(更新なし)/失敗
								...
								FUNCTION_NG		: 失敗
***********************************************************************/
int	CfrmUc101Kariukekin::RecBufSaveDataSub( 
							int inPage,
							int inRow,
...
// midori 152137 add <--
		...
		if ((udTemp.m_FgFunc == ID_FGFUNC_DATA) && (ufgAd == TRUE)) {	// 変更ありの場合
			...
			if(m_RegAutoRef)	udTemp.m_AdSeq = rsAdd.CheckEntry(udTemp.m_AdName1, udTemp.m_AdName2, udTemp.m_AdAdd1, udTemp.m_AdAdd2, ID_ADDRESSGR_URI, TRUE);
			else				udTemp.m_AdSeq = rsAdd.GetSeqFromAdName(ID_ADDRESSGR_URI, udTemp.m_AdName1, udTemp.m_AdName2, udTemp.m_AdAdd1, udTemp.m_AdAdd2);
...
//********************************************************************************
CdbUc000Common*	CfrmUc101Kariukekin::virGetDataTableObject()
{
	// 「仮受金」テーブルのオブジェクトを生成し、ポインタを返す
...
//	RET	なし
//********************************************************************************
void	CfrmUc101Kariukekin::virRowButtonCopyProc()
{
...
//	RET	なし
//********************************************************************************
void	CfrmUc101Kariukekin::virTblGetKamokuInfo( CdbUc000Common* rsData, SORTKAMOKU_INFO* uKamoku )
{
...
//	RET	なし
//********************************************************************************
void	CfrmUc101Kariukekin::virGetCurrentInfo( CURRENT_INFO* uCurInfo )
{
...
//********************************************************************************
int	CfrmUc101Kariukekin::virUpdateRelationTblChengeFormType()
{
	// ⑩-1で通常/個別を変更した場合、⑩-2の頁構成の更新が必要となる
	CfrmUc102Gensen		pfrm102;
// midori 152770 del -->
//	int intRet = pfrm102.UpdateTbl102ChangeFormType();
// midori 152770 del <--
// midori 152770 add -->
...
//		RET		BOOL		TRUE:正常終了，FALSE:エラー
//********************************************************************************
BOOL CfrmUc101Kariukekin::virUpdateRelationTblChengeFormTypeSave()
{
...
////		RET		なし
////********************************************************************************
//int	CfrmUc101Kariukekin::UpdateTbl101ChangeFormType()
//{
//	// 初期値設定
...
//		RET		なし
//********************************************************************************
int	CfrmUc101Kariukekin::UpdateTbl101ChangeFormType(UCHIWAKE_INFO pInfoSv)
{
	// データ無しならデータ更新しない
...
//	【戻値】	なし
//**************************************************
void CfrmUc101Kariukekin::SetInputMode( int nRow, long nMode )
{
	m_pDiag->ModifyItem( CmnGetControlIndex( nRow, ID_COL_101_KNSEQ ), nMode );		//　科目
	m_pDiag->ModifyItem( CmnGetControlIndex( nRow, ID_COL_101_ADNAME1 ), nMode );	//　名称（上段）
	m_pDiag->ModifyItem( CmnGetControlIndex( nRow, ID_COL_101_ADADD1 ), nMode );	//　所在地（上段）
	m_pDiag->ModifyItem( CmnGetControlIndex( nRow, ID_COL_101_ADADD2 ), nMode );	//	所在地（下段）
	m_pDiag->ModifyItem( CmnGetControlIndex( nRow, ID_COL_101_KANKEI ), nMode );	//	法人・代表者との関係
	m_pDiag->ModifyItem( CmnGetControlIndex( nRow, ID_COL_101_VAL ), nMode );		//	期末現在高
	m_pDiag->ModifyItem( CmnGetControlIndex( nRow, ID_COL_101_NAIYOU ), nMode );	//	取引の内容
}
...
//	【戻値】	なし
//**************************************************
void CfrmUc101Kariukekin::SetDiagBackColor()
{
...
//		RET		なし					
//********************************************************************************
void CfrmUc101Kariukekin::virRendoCreateData(CdbUc000Common* rsData, RENTEMP_INFO* uRenInfo)
{
	CString			strTemp;
...
//		RET		なし					
//********************************************************************************
void CfrmUc101Kariukekin::virRendoUpdateData(CdbUc000Common* rsData, RENTEMP_INFO* uRenInfo)
{
	CdbUc101Kariukekin*	rs = (CdbUc101Kariukekin*)rsData;
...
//***************************************************************************
BOOL CfrmUc101Kariukekin::virEndProc(void)
{
	TRACE(_T("***** CfrmUc101Kariukekin::virEndProc\n"));
...
// midori 161106 add -->
void CfrmUc101Kariukekin::ComboNew(short index)
{
	short			sv_sel=0;
// midori 152201 add -->
...
// midori 151405 add -->
int CfrmUc101Kariukekin::CursorControl(short nChar, int sw)
{
	int				rv=0;
	int				intCol=0;
	int				pos=0;
...
// midori 152134 add -->
void CfrmUc101Kariukekin::ComboSelYoushikidiag1(short index, LPUNKNOWN data)
{
// 要通知案件修正 21/07/09 del -->
...
// ------------------------------------------------------------------------------------------------------------------------
void CfrmUc101Kariukekin::TitleColorChg(void)
{
	...
	// 科目
// 修正No.157628 del -->
	//strSQL.Format(_T("select max(oversgn) from (select CASE when len(Replace(isnull(KnName,''),CHAR(13)+CHAR(10),'')) > %d then 1 else 0 end as oversgn from uc_101_kariukekin where FgShow=%d) tbl1"),UC_KAMOKU_LEN,ID_FGSHOW_OFF);
// 修正No.157628 del <--
// 修正No.157628 add -->
...
// 修正No.157628 add <--
	...
	// 法人・代表者との関係
// 修正No.157628 del -->
	//strSQL.Format(_T("select max(oversgn) from (select CASE when len(Replace(isnull(Kankei,''),CHAR(13)+CHAR(10),'')) > %d then 1 else 0 end as oversgn from uc_101_kariukekin where FgShow=%d) tbl1"),UC_101_KANKEI_LEN,ID_FGSHOW_OFF);
// 修正No.157628 del <--
// 修正No.157628 add -->
	strSQL.Format(_T("select max(oversgn) from (select CASE when len(%s) > %d then 1 else 0 end as oversgn from uc_101_kariukekin where FgShow=%d) tbl1"),
...
// 修正No.162446 add -->
LRESULT CfrmUc101Kariukekin::OnUserReDrawView(WPARAM wParam, LPARAM lParam)
{
	virUpdateControlTblData();
	CmnDiagSetFocus(m_pDiag, 1, 1);
