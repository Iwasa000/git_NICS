...
// FileName		:  prtUc041Karibarai.cpp
//
// ■印刷関連 動作定義
//
//**************************************************************************************************
...
int CprtUc041Karibarai::GetDbDataSheet(int nPage, CprtJobFunction* parent, const PRT_OPTION& po, int nFormSeq/*=0*/)
{
	int rv = 0;
...
int CprtUc041Karibarai::GetDbDataSheetNew(int nPage, CprtJobFunction* parent, const PRT_OPTION& po, int nFormSeq/*=0*/)
{
	int				nCurRow = 0;
...
// インボイス登録番号追加対応_23/10/25 del <--
// インボイス登録番号追加対応_23/10/25 add -->
int CprtUc041Karibarai::GetDbDataSheetOld(int nPage, CprtJobFunction* parent, const PRT_OPTION& po, int nFormSeq/*=0*/)
// インボイス登録番号追加対応_23/10/25 add <--
{
	int				nCurRow			= 0;
	int				nVisualPage		= nPage;			//見かけ上のページ数
...
CprtUc041Karibarai::CprtUc041Karibarai(CDatabase* pdb)
{
	m_pDB		= pdb;
...
CprtUc041Karibarai::~CprtUc041Karibarai(void)
{
}

CprtJobFunction* CprtUc041Karibarai::virGetPrintObject(void)
{
	return (CprtJobFunction*)(new CprtUc041Karibarai(m_pDB));
}