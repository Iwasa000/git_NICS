...
IMPLEMENT_DYNCREATE( CfrmUc021UketoritegataK, CfrmUc000Common )


BEGIN_MESSAGE_MAP( CfrmUc021UketoritegataK, CfrmUc000Common )
	ON_WM_SIZE()
...
//	ON_COMMAND( ID_BUTTON_F3, OnButtonF3 )
	...
	ON_COMMAND( ID_PRINTSETUP_MENU, &CfrmUc021UketoritegataK::OnMenuPrintSetup )
	ON_COMMAND( ID_PRINTALL_MENU, &CfrmUc021UketoritegataK::OnMenuPrintAll )
//	ON_COMMAND( ID_OUTPUTFORM_MENU, &CfrmUc021UketoritegataK::OnMenuFormTypeSetup )
	ON_COMMAND( ID_SPECIALROW_MENU, &CfrmUc021UketoritegataK::OnMenuSpecialRow )
	ON_COMMAND( ID_SORT_MENU, &CfrmUc021UketoritegataK::OnMenuSort )
	ON_COMMAND( ID_IKKATUADD_MENU, &CfrmUc021UketoritegataK::OnIkkatuAddMenu)
	ON_COMMAND( ID_DISPDIALOG_MENU, &CfrmUc021UketoritegataK::OnMenuIkkatuKingaku )
	ON_COMMAND( ID_ZEROMONEY_MENU, &CfrmUc021UketoritegataK::OnMenuZeroMoney )
	ON_COMMAND( ID_ZEROMONEYMOVE_MENU, &CfrmUc021UketoritegataK::OnMenuZeroMoneyMove )
	ON_COMMAND( ID_AMOUTDIALOG_MENU, &CfrmUc021UketoritegataK::OnMenuOutKeiSetup )
// midori 160606 add -->
	ON_COMMAND( ID_CLEAR_MENU, &CfrmUc021UketoritegataK::OnMenuClear )
// midori 160606 add <--
	ON_COMMAND( ID_RENDO_MENU, &CfrmUc021UketoritegataK::OnMenuZaimuRendo )
	ON_COMMAND( ID_TITLEMENU, &CfrmUc021UketoritegataK::OnMenuTitleRestore )
	ON_COMMAND( ID_USER_SETTING_MENU, &CfrmUc021UketoritegataK::OnMenuOptionSetting )
	ON_COMMAND( ID_COPY_SETTING_INFO_MENU, &CfrmUc021UketoritegataK::OnMenuCopySettingInfo )
	ON_COMMAND( ID_DELETE_DATA_MENU, &CfrmUc021UketoritegataK::OnMenuDeleteDataEachYoushiki )
	ON_BN_CLICKED( IDC_PAGEBACK_BUTTON1, &CfrmUc021UketoritegataK::OnPageBack )
	ON_BN_CLICKED( IDC_PAGENEXT_BUTTON1, &CfrmUc021UketoritegataK::OnPageNext )
	ON_BN_CLICKED( IDC_PAGENEW_BUTTON1, &CfrmUc021UketoritegataK::OnPageNew )
	ON_BN_CLICKED( IDC_PAGEINSERT_BUTTON1, &CfrmUc021UketoritegataK::OnPageInsert )
	ON_BN_CLICKED( IDC_ROWCOPY_BUTTON1, &CfrmUc021UketoritegataK::OnRowCopy )
	ON_BN_CLICKED( IDC_ROWPASTE_BUTTON1, &CfrmUc021UketoritegataK::OnRowPaste )
	ON_BN_CLICKED( IDC_ROWINSERT_BUTTON1, &CfrmUc021UketoritegataK::OnRowInsert )
	ON_BN_CLICKED( IDC_YOUSHIKINEXT_BUTTON1, &CfrmUc021UketoritegataK::OnMoveYoushikiNext )
	ON_BN_CLICKED( IDC_YOUSHIKIBACK_BUTTON1, &CfrmUc021UketoritegataK::OnMoveYoushikiBack )
//	ON_UPDATE_COMMAND_UI( ID_BUTTON_F1, &CfrmUc021UketoritegataK::OnUpdateButtonF1 )
//	ON_UPDATE_COMMAND_UI( ID_BUTTON_F3, &CfrmUc021UketoritegataK::OnUpdateButtonF3 )
	ON_UPDATE_COMMAND_UI( ID_BUTTON_F6, &CfrmUc021UketoritegataK::OnUpdateButtonF6 )
	ON_UPDATE_COMMAND_UI( ID_BUTTON_F7, &CfrmUc021UketoritegataK::OnUpdateButtonF7 )
	ON_UPDATE_COMMAND_UI( ID_BUTTON_F8, &CfrmUc021UketoritegataK::OnUpdateButtonF8 )
	ON_UPDATE_COMMAND_UI( ID_BUTTON_F9, &CfrmUc021UketoritegataK::OnUpdateButtonF9 )
	ON_UPDATE_COMMAND_UI( ID_BUTTON_F11, &CfrmUc021UketoritegataK::OnUpdateButtonF11 )
	ON_UPDATE_COMMAND_UI( ID_BUTTON_F12, &CfrmUc021UketoritegataK::OnUpdateButtonF12 )
	ON_UPDATE_COMMAND_UI( ID_BUTTON_HOME, &CfrmUc021UketoritegataK::OnUpdateButtonHome )
	ON_UPDATE_COMMAND_UI(ID_IKKATUADD_MENU, &CfrmUc000Common::OnUpdateIkkatuaddMenu)
	ON_UPDATE_COMMAND_UI( ID_DISPDIALOG_MENU, &CfrmUc021UketoritegataK::OnUpdateMenuIkkatuKingaku )
// midori 160612 add -->
	ON_UPDATE_COMMAND_UI( ID_SORT_MENU, &CfrmUc021UketoritegataK::OnUpdateMenuSort )
	ON_UPDATE_COMMAND_UI( ID_CLEAR_MENU, &CfrmUc021UketoritegataK::OnUpdateMenuClear )
// midori 160612 add <--
	ON_UPDATE_COMMAND_UI( ID_ZEROMONEY_MENU, &CfrmUc021UketoritegataK::OnUpdateMenuZeroMoney )
// midori 160612 add -->
	ON_UPDATE_COMMAND_UI( ID_ZEROMONEYMOVE_MENU, &CfrmUc021UketoritegataK::OnUpdateMenuZeroMoneyMove)
// midori 160612 add <--
	ON_UPDATE_COMMAND_UI( ID_RENDO_MENU, &CfrmUc021UketoritegataK::OnUpdateMenuZaimuRendo )
	ON_UPDATE_COMMAND_UI(ID_SPECIALROW_MENU, &CfrmUc021UketoritegataK::OnUpdateMenuSpecialRow)
// midori 160612 add -->
	ON_UPDATE_COMMAND_UI( ID_TITLEMENU, &CfrmUc021UketoritegataK::OnUpdateMenuTitleRestore )
	ON_UPDATE_COMMAND_UI( ID_DELETE_DATA_MENU, &CfrmUc021UketoritegataK::OnUpdateMenuDeleteDataEachYoushiki )
// midori 160612 add <--
	ON_MESSAGE(WM_USER_REDRAWVIEW, OnUserReDrawView)		// 修正No.162446 add
END_MESSAGE_MAP()


CfrmUc021UketoritegataK::CfrmUc021UketoritegataK()
	: CfrmUc000Common( CfrmUc021UketoritegataK::IDD )
{
...
CfrmUc021UketoritegataK::~CfrmUc021UketoritegataK()
{
	...
	TRACE(_T("***** CfrmUc021UketoritegataK::~CfrmUc021UketoritegataK\n"));

	//m_pDiag = NULL;
	//m_pTitleDiag = NULL;
}

void CfrmUc021UketoritegataK::DoDataExchange( CDataExchange* pDX )
{
...
void CfrmUc021UketoritegataK::OnInitialUpdate()
{
...
#ifdef _DEBUG
void CfrmUc021UketoritegataK::AssertValid() const
{
	CfrmUc000Common::AssertValid();
}

#ifndef _WIN32_WCE
void CfrmUc021UketoritegataK::Dump( CDumpContext& dc ) const
{
...
BEGIN_EVENTSINK_MAP( CfrmUc021UketoritegataK, CfrmUc000Common )
	ON_EVENT( CfrmUc021UketoritegataK, IDC_YOUSHIKIDIAG1, 3, CfrmUc021UketoritegataK::TerminationYoushikidiag1, VTS_I2 VTS_I2 VTS_I2 VTS_UNKNOWN )
	ON_EVENT( CfrmUc021UketoritegataK, IDC_YOUSHIKIDIAG1, 2, CfrmUc021UketoritegataK::EditOFFYoushikidiag1, VTS_I2 )
	ON_EVENT( CfrmUc021UketoritegataK, IDC_YOUSHIKIDIAG1, 1, CfrmUc021UketoritegataK::EditONYoushikidiag1, VTS_I2 )
// midori 151405 add -->
	ON_EVENT(CfrmUc021UketoritegataK, IDC_YOUSHIKIDIAG1, 12, CfrmUc021UketoritegataK::VScrollYoushikidiag1, VTS_I2)
// midori 151405 add <--
// midori 152134 add -->
	ON_EVENT(CfrmUc021UketoritegataK, IDC_YOUSHIKIDIAG1, 8, CfrmUc021UketoritegataK::ComboSelYoushikidiag1, VTS_I2 VTS_UNKNOWN)
// midori 152134 add <--

	ON_EVENT( CfrmUc021UketoritegataK, IDC_YOUSHIKIDIAG2, 3, CfrmUc021UketoritegataK::TerminationYoushikidiag1, VTS_I2 VTS_I2 VTS_I2 VTS_UNKNOWN )
	ON_EVENT( CfrmUc021UketoritegataK, IDC_YOUSHIKIDIAG2, 2, CfrmUc021UketoritegataK::EditOFFYoushikidiag1, VTS_I2 )
	ON_EVENT( CfrmUc021UketoritegataK, IDC_YOUSHIKIDIAG2, 1, CfrmUc021UketoritegataK::EditONYoushikidiag1, VTS_I2 )
// midori 151405 add -->
	ON_EVENT(CfrmUc021UketoritegataK, IDC_YOUSHIKIDIAG2, 12, CfrmUc021UketoritegataK::VScrollYoushikidiag1, VTS_I2)
// midori 151405 add <--
// midori 152134 add -->
	ON_EVENT(CfrmUc021UketoritegataK, IDC_YOUSHIKIDIAG2, 8, CfrmUc021UketoritegataK::ComboSelYoushikidiag1, VTS_I2 VTS_UNKNOWN)
// midori 152134 add <--

	ON_EVENT( CfrmUc021UketoritegataK, IDC_TITLEDIAG1, 3, CfrmUc021UketoritegataK::TerminationTitlediag1, VTS_I2 VTS_I2 VTS_I2 VTS_UNKNOWN )
	ON_EVENT( CfrmUc021UketoritegataK, IDC_TITLEDIAG1, 2, CfrmUc021UketoritegataK::EditOFFTitlediag1, VTS_I2 )
	ON_EVENT( CfrmUc021UketoritegataK, IDC_TITLEDIAG1, 1, CfrmUc021UketoritegataK::EditONTitlediag1, VTS_I2 )
	ON_EVENT( CfrmUc021UketoritegataK, IDC_TITLEDIAG1, 6, CfrmUc021UketoritegataK::FocusTitlediag1, VTS_NONE )

	ON_EVENT( CfrmUc021UketoritegataK, IDC_PAGEDIAG1, 3, CfrmUc021UketoritegataK::TerminationPagediag1, VTS_I2 VTS_I2 VTS_I2 VTS_UNKNOWN )
	ON_EVENT( CfrmUc021UketoritegataK, IDC_PAGEDIAG1, 2, CfrmUc021UketoritegataK::EditOFFPagediag1, VTS_I2 )
	ON_EVENT( CfrmUc021UketoritegataK, IDC_PAGEDIAG1, 1, CfrmUc021UketoritegataK::EditONPagediag1, VTS_I2 )
	ON_EVENT( CfrmUc021UketoritegataK, IDC_PAGEDIAG1, 6, CfrmUc021UketoritegataK::FocusPagediag1, VTS_NONE )
END_EVENTSINK_MAP()

//********************************************************************************
//	初期処理
//********************************************************************************
BOOL	CfrmUc021UketoritegataK::virStartJob()
{
	// 初期値設定
...
//	共通データの初期値設定
//********************************************************************************
void	CfrmUc021UketoritegataK::virSetInitialUchiwakeInfo()
{
	// 「受取手形」の固有データ
	...
	m_uInfo.intColMax = ID_COLMAX_021K;				// １行内のコントロール個数
	m_uInfo.intColMaxData = ID_COLMAXDATA_021;		// １行内の列数
	m_uInfo.intCtlStartIndex = ID_CTLSTARTINDEX_021;// １行目の入力項目の先頭インデックス番号
	m_uInfo.intT1StartIndex = ID_T1STARTNORMAL_021K;	// 合計行①の先頭インデックス番号
	m_uInfo.intT2StartIndex = ID_T2STARTNORMAL_021K;	// 合計行②の入力項目の先頭インデックス番号
	m_uInfo.intCursolDefPos = ID_COL_021_KAMOKU;	// カーソル移動時の初期位置（タイトルから↓，合計から↑で使用）
	m_uInfo.intCursolKeiPos = ID_COL_021_KAMOKU;	// 合計行のカーソル移動位置（カーソル移動で使用）
	...
	m_uInfo.intT1StartNormal = ID_T1STARTNORMAL_021K;	// 通常時：合計行①の先頭インデックス
	m_uInfo.intT2StartNormal = ID_T2STARTNORMAL_021K;	// 通常時：合計行②の先頭インデックス
	m_uInfo.intT1StartKobetu = ID_T1STARTKOBETU_021K;	// 個別時：合計行①の先頭インデックス
	m_uInfo.intT2StartKobetu = ID_T2STARTKOBETU_021K;	// 個別時：合計行②の先頭インデックス
	m_uInfo.intRowKei = ID_ROWKEI_021;				// 帳表固定の合計行数（1:合xxx1計あり，0:なし）
	m_uInfo.intKei1StartIndex = ID_COL_021K_KEI1_MEISYO;	// 計ダイアグラム1行目の先頭インデックス
	m_uInfo.intKei2StartIndex = ID_COL_021K_KEI2_MEISYO;	// 計ダイアグラム2行目の先頭インデックス
...
// 【戻値】    なし
//**************************************************
void	CfrmUc021UketoritegataK::virSetInitialDiag()
{
	int		nIndex;
	...
	//	コンボボックスの属性取得
	nIndex = CmnGetControlIndex( 1, ID_COL_021_KAMOKU );
...
//	帳表固有変数の初期値設定
//********************************************************************************
void	CfrmUc021UketoritegataK::virSetInitialValue()
{
	// 1ページ分のローカルバッファをクリア
	RecBufClearAllData();
...
//	帳表コントロールの初期化（データ領域）
//********************************************************************************
BOOL	CfrmUc021UketoritegataK::InitialControlDataArea()
{
	int		intMax;
	int		i;
// midori 200101 add -->
...
// midori 200101 add -->
		...
		m_pDiag->GetAttribute((i + ID_COL_021_SPDATE - 1),(LPUNKNOWN)&diaatt);
		diaatt.attr_dayattr = 15;
		m_pDiag->SetAttribute((i + ID_COL_021_SPDATE - 1),(LPUNKNOWN)&diaatt,TRUE);
		m_pDiag->GetAttribute((i + ID_COL_021_PMDATE - 1),(LPUNKNOWN)&diaatt);
		diaatt.attr_dayattr = 15;
		m_pDiag->SetAttribute((i + ID_COL_021_PMDATE - 1),(LPUNKNOWN)&diaatt,TRUE);
// midori 200101 add <--

		// ComboBox：クリア
		CmnDiagSetString( m_pDiag, i + ID_COL_021_KAMOKU - 1, "", 0 );	// 科目

		// 漢字入力欄の初期化
		CmnDiagSetAttrInpmax( m_pDiag, i + ID_COL_021_ADNAME1  - 1, MAX_KETA_021_ADNAME1 );		// 振出人1
		CmnDiagSetAttrInpmax( m_pDiag, i + ID_COL_021_SPDATE   - 1, MAX_KETA_021_SPDATE );		// 振出年月日
		CmnDiagSetAttrInpmax( m_pDiag, i + ID_COL_021_PMDATE   - 1, MAX_KETA_021_PMDATE );		// 支払期日
		CmnDiagSetAttrInpmax( m_pDiag, i + ID_COL_021_BKNAME1  - 1, MAX_KETA_021_BKNAME1 );		// 支払銀行名
		CmnDiagSetAttrInpmax( m_pDiag, i + ID_COL_021_BKNAME2  - 1, MAX_KETA_021_BKNAME2 );		// 支払銀行名(支店名)
		CmnDiagSetAttrInpmax( m_pDiag, i + ID_COL_021_BK2NAME1 - 1, MAX_KETA_021_BK2NAME1 );	// 割引銀行名等
		CmnDiagSetAttrInpmax( m_pDiag, i + ID_COL_021_BK2NAME2 - 1, MAX_KETA_021_BK2NAME2 );	// 割引銀行名等(支店名)
		CmnDiagSetAttrInpmax( m_pDiag, i + ID_COL_021_TEKI     - 1, MAX_KETA_021_TEKI );		// 摘要

		// 金額欄：桁数初期化
// No.200903 del -->
		//CmnDiagSetAttrDigit( m_pDiag, i + ID_COL_021_VAL - 1, ID_VAL_021_DATA );	// 金額
// No.200903 del <--
// No.200903 add -->
		CmnDiagSetAttrDigit( m_pDiag, i + ID_COL_021_VAL - 1, ID_VAL_021_K_DATA );	// 金額
// No.200903 add <--
	...
	// 半角/全角設定
	CmnDiagSetAttrColZenHan( m_pDiag , ID_COL_021_ADNAME1 );	// 振出人1
	CmnDiagSetAttrColZenHan( m_pDiag , ID_COL_021_SPDATE );		// 振出年月日
	CmnDiagSetAttrColZenHan( m_pDiag , ID_COL_021_PMDATE );		// 支払期日
	CmnDiagSetAttrColZenHan( m_pDiag , ID_COL_021_BKNAME1 );	// 支払銀行名
	CmnDiagSetAttrColZenHan( m_pDiag , ID_COL_021_BKNAME2 );	// 支払銀行名（支店名）
	CmnDiagSetAttrColZenHan( m_pDiag , ID_COL_021_BK2NAME1 );	// 割引銀行名等
	CmnDiagSetAttrColZenHan( m_pDiag , ID_COL_021_BK2NAME2 );	// 割引銀行名等（支店名）
	CmnDiagSetAttrColZenHan( m_pDiag , ID_COL_021_TEKI );		// 摘要
...
//********************************************************************************
BOOL	CfrmUc021UketoritegataK::InitialControlComboBox()
{
	// コンボボックスを初期化する関数です。
	...
	for ( i = 1; i <= intMax; i++ ) {
		...
		intIndex = CmnGetControlIndex( i, ID_COL_021_KAMOKU );
...
//********************************************************************************
void	CfrmUc021UketoritegataK::InitialControlTotalArea()
{
	int		nKeiType;			//	計の種別
	int		nDataRow;			//	データ行属性
...
// midori 156968_2 add -->
	if (flg == 1) {
		// 科目行、小計行の名称を入力可能にする
		m_pDiag->ModifyItem( CmnGetControlIndex( (nDataRowPos+1), ID_COL_021_ADNAME1 ), (DIAG_MDFY_EDIT | DIAG_MDFY_OPAQUE) );
		// 入力可能の場合、カーソルポジションの移動は行わないようにする
		if((intIndex == CmnGetControlIndex( (nDataRowPos+1), ID_COL_021_ADNAME1 )))		nSw=0;
	}
// midori 156968_2 add <--
// 修正No.157898 add -->
	else if(flg2 == 1)	{
		// 一括自動行の科目を入力可能にする
		m_pDiag->ModifyItem( CmnGetControlIndex( (nDataRowPos+1), ID_COL_021_KAMOKU ), (DIAG_MDFY_EDIT | DIAG_MDFY_OPAQUE) );
	}
// 修正No.157898 add <--
...
// midori 152166 add <--
	...
	m_pDiagKei->ModifyItem(ID_COL_021K_KEI1_VAL, intKeiRow);
	m_pDiagKei->ModifyItem(ID_COL_021K_KEI2_VAL, intKeiRow);
...
// No.200903 del -->
	//// 合計行の金額欄は、金額欄 + 1桁
	//CmnDiagSetAttrDigit( m_pDiagKei, ID_COL_021K_KEI1_VAL, ID_VAL_021_TOTAL );
	//CmnDiagSetAttrDigit( m_pDiagKei, ID_COL_021K_KEI2_VAL, ID_VAL_021_TOTAL );
// No.200903 del <--
// No.200903 add -->
	// 合計行の金額欄は、13桁
	CmnDiagSetAttrDigit( m_pDiagKei, ID_COL_021K_KEI1_VAL, ID_VAL_021_K_TOTAL );
	CmnDiagSetAttrDigit( m_pDiagKei, ID_COL_021K_KEI2_VAL, ID_VAL_021_K_TOTAL );
// No.200903 add <--
}
...
//	RET	なし
//********************************************************************************
void	CfrmUc021UketoritegataK::InitialControlSpecialRow( int intRow, int intFgFunc )
{
	DIAGRAM_DATA	diadata;	// ICSDIAG構造体
	...
	case ID_FGFUNC_IKKATUAUTO:		// 一括集計金額行（自動）
		// 桁数を設定
// No.200903 del -->
		//CmnDiagSetAttrDigit( m_pDiag, CmnGetControlIndex( intRow , ID_COL_021_VAL ), ID_VAL_021_TOTAL );
// No.200903 del <--
// No.200903 add -->
		CmnDiagSetAttrDigit( m_pDiag, CmnGetControlIndex( intRow , ID_COL_021_VAL ), ID_VAL_021_K_TOTAL );
// No.200903 add <--
		break;
	}
...
// midori 190505 add <--
		...
		if ( intFgFunc != ID_FGFUNC_IKKATUAUTO ){
			...
			m_pDiag->ModifyItem( CmnGetControlIndex( intRow, ID_COL_021_KAMOKU ), DIAG_MDFY_NODROPDOWN );
...
// midori 156189,156190,156191 del <--
			...
			m_pDiag->SetData( CmnGetControlIndex( intRow, ID_COL_021_KAMOKU ), (LPUNKNOWN)&diadata );
// midori 156189,156190,156191 del -->
//// midori 190505 add -->
//			}
//// midori 190505 add <--
...
// midori 157046 add <--
				//	振出人
				m_pDiag->ModifyItem( CmnGetControlIndex( intRow, ID_COL_021_ADNAME1 ), DIAG_MDFY_INPUT );
			}
			// 小計の場合、26文字編集可能にする
// midori 157046 del -->
...
// midori 157046 add <--
				//	振出人
				CmnDiagSetAttrInpmax( m_pDiag, CmnGetControlIndex( intRow, ID_COL_021_ADNAME1 ), MAX_KETA_021_SYOKEI );
			}
// No.200905 add -->
			// 一括集計金額（自動）行の場合、科目のみ入力可能とする
			if (intFgFunc == ID_FGFUNC_IKKATUAUTO ){
				//	科目
				m_pDiag->ModifyItem( CmnGetControlIndex( intRow, ID_COL_021_KAMOKU ), DIAG_MDFY_INPUT );
			}
// No.200905 add <--
		}
// midori 156189,156190,156191 add <--
...
//	帳表タイトル情報の表示
//********************************************************************************
void	CfrmUc021UketoritegataK::virUpdateControlTitle()
{
//	int		intMax;
	DIAGRAM_ATTRIBUTE diaatt;
...
//	帳表ページ情報の表示
//********************************************************************************
void	CfrmUc021UketoritegataK::UpdateControlPage()
{
	BOOL	bBack = TRUE;
	BOOL	bNext = TRUE;
...
//	帳表データの表示（１ページ分）
//********************************************************************************
BOOL	CfrmUc021UketoritegataK::virUpdateControlTblData()
{
// 157154 add -->
	int sw=0;
// 157154 add <--
...
// No.200601 add -->
		...
		// 支払銀行名称
		CmnInitialControlFgStringCell( m_pDiag, dbRec.m_NumRow, ID_COL_021_BKNAME1, dbRec.m_FgFunc, UC_BANK_LEN, dbRec.m_BkName1);
		// 支払銀行支店名
		CmnInitialControlFgStringCell( m_pDiag, dbRec.m_NumRow, ID_COL_021_BKNAME2, dbRec.m_FgFunc, UC_BANK_LEN, dbRec.m_BkName2);
		// 割引銀行名および支店名等
		// 割引銀行名 + 支店名で判断する
		cst = dbRec.m_Bk2Name1 + dbRec.m_Bk2Name2;
		CmnInitialControlFgStringCell( m_pDiag, dbRec.m_NumRow, ID_COL_021_BK2NAME1, dbRec.m_FgFunc, (UC_BANK_LEN*2), cst);
		CmnInitialControlFgStringCell( m_pDiag, dbRec.m_NumRow, ID_COL_021_BK2NAME2, dbRec.m_FgFunc, (UC_BANK_LEN*2), cst);
		// 摘要
		CmnInitialControlFgStringCell( m_pDiag, dbRec.m_NumRow, ID_COL_021_TEKI, dbRec.m_FgFunc, UC_021_TEKI_LEN,dbRec.m_Teki );
// No.200601 add <--
...
// midori 190301 add -->
	...
	CmnDiagSetAttrEditFormat(m_pDiag,ID_COL_021_TEKI,MAX_KETA_021_TEKI,3,_T("11,11,10"));	// 摘要

	// [計行] 支払銀行支店名を非表示にする
	CmnDiagSetAttrDisableHide(&m_DiagKei1,4,2);
	CmnDiagSetAttrDisableHide(&m_DiagKei1,12,2);
	CmnDiagSetAttrDisableHide(&m_DiagKei2,4,2);
...
//	保管件数の表示
//********************************************************************************
BOOL CfrmUc021UketoritegataK::virUpdateControlTblData2()
{
	int					hcnt=0;
	CString				cs=_T("");
...
////		RET		なし
////********************************************************************************
//void	CfrmUc021UketoritegataK::UpdateControlRowData( CdbUc021Uketoritegata* prmDbRec ) {
// 157154 del <--
// 157154 add -->
// ---------------------------------------------------------------------------------------------------------------
//	帳表データの１行表示（空行，データ行，特殊行）
...
//		RET		なし
// ---------------------------------------------------------------------------------------------------------------
void	CfrmUc021UketoritegataK::UpdateControlRowData( CdbUc021Uketoritegata* prmDbRec, int pSw ) {
// 157154 add <--
...
// midori 191002 add <--
	...
	// 読込み対象セル取得
	intCell = CmnGetControlIndex( prmDbRec->m_NumRow, ID_COL_021_KAMOKU );
...
//		RET		なし
//********************************************************************************
void	CfrmUc021UketoritegataK::UpdateControlRowTotal( CdbUc021Uketoritegata* prmDbRec )
{
	int		intTotalType;
	...
	// 頁計/累計の名称表示
	if ( intRowName > 0 ) {
		//CmnDiagSetString( m_pDiag, CmnGetControlTotalIndex( intRowName, ID_COL_021_ADNAME1 ), prmDbRec->m_KeiStr, 0 );
		CmnDiagSetString( m_pDiagKei, CmnGetKeiDiagIndex( intRowName, ID_COL_021K_KEI1_MEISYO ), prmDbRec->m_KeiStr, 1 );
	}
	// 頁計/累計の金額表示
	if ( intRowVal > 0 ) {
		//CmnDiagSetKingaku( m_pDiag, CmnGetControlTotalIndex( intRowName, ID_COL_021_VAL ), prmDbRec->m_Val );
		CmnDiagSetKingaku( m_pDiagKei, CmnGetKeiDiagIndex( intRowVal, ID_COL_021K_KEI1_VAL ), prmDbRec->m_Val );
	}
}
...
//		RET		なし
//********************************************************************************
void	CfrmUc021UketoritegataK::virFncCellCopyProc( CdbUc000Common* rsData )
{
...
//********************************************************************************
int	CfrmUc021UketoritegataK::virFncReferenceGetType(int intCol, int* intGrSeq, long* lngItemSeq, int* intAdd1, int* intAdd2, int* intAdd1Col, int* intAdd2Col, REFERENCE_INFO* pudReference)
{
	int		intRefType;
...
//		RET		なし
//********************************************************************************
void	CfrmUc021UketoritegataK::virFncReferenceSetData( CdlgReference* dlgRef, int intRefType, int intCol )
{
	switch ( intRefType ) {
...
//		RET		なし
//********************************************************************************
void	CfrmUc021UketoritegataK::virFncReferenceUpdateTbl( int intRefType, int nRefMode/*=0*/ )
{
...
// 修正No.157633_元号日付 add -->
void CfrmUc021UketoritegataK::virActivateFrame(UINT nState, CFrameWnd* pDeactivateFrame)
{
	int		index = 0;
		...
		if(m_DataKakutei == FALSE)	{
			if(m_uInfo.intCurCol == ID_COL_021_SPDATE || m_uInfo.intCurCol == ID_COL_021_PMDATE)	{
				if(m_uInfo.EditSign == 1)	{
					m_uInfo.EditSign = -1;
					m_uInfo.GenListSw = 0;
					if(m_uInfo.intCurCol == ID_COL_021_SPDATE) {
						m_uInfo.OldDate[0] = 0;
...
void CfrmUc021UketoritegataK::virActivateFrameK(UINT nState, CFrameWnd* pDeactivateFrame)
{
	int		index = 0;
	CWnd*	pWnd = this->GetFocus();
	...
	if(pWnd != NULL)	{
		if(m_DataKakutei == FALSE)	{
			if(m_uInfo.intCurCol == ID_COL_021_KAMOKU)	{
				virKamokuAddCancel();
			}
		}
	}
...
void CfrmUc021UketoritegataK::virKamokuAddCancel()
{
	...
	// 科目列なら
	if(m_uInfo.intCurCol == ID_COL_021_KAMOKU && m_F9OnSw != TRUE)	{
		DIAGRAM_DATA	diadata;
		m_pDiag->GetData(m_uInfo.intCurCtlIndex,(LPUNKNOWN)&diadata);
		// 【新規作成】が選択されていれば
		if(diadata.data_combo > m_CmbCnt)	{
			// 前回の値に戻す
			CmnDiagSetCombo(m_pDiag,CmnGetControlIndex(m_uInfo.intCurRow,ID_COL_021_KAMOKU),m_uInfo.OldCombo);
		}
	}
}
// 要通知案件修正 21/07/09 add <--
...
//	その他イベント処理
//********************************************************************************
BOOL	CfrmUc021UketoritegataK::PreTranslateMessage( MSG* pMsg )
{
//	int				intID;
...
//				if ((CmnGetControlCol() != ID_COL_021_KAMOKU) || (CmnCheckTotalRow() == TRUE )){
// midori 160611 del <--
				// カレントインデックスを保存
...
//				//}
//// ---------------------
//				if(CmnGetControlCol() == ID_COL_021_KAMOKU)	{
//					rv=1;
//				}
//// midori 160611 cor <--
// midori 152134 17/10/07 del <--
...
// midori 155866 del <--
// midori 155866 add -->
				if(intCol == ID_COL_021_KAMOKU || intCol == ID_COL_021_SPDATE || intCol == ID_COL_021_PMDATE)	{
// midori 155866 add <--
					rv=1;
				}
// midori 152134 17/10/07 add <--
...
/*
		...
		case VK_TAB:
			...
			if ((intID == IDC_PAGEBACK_BUTTON1) && (CmnCheckShiftKey() == TRUE)) {
				...
				CmnDiagSetFocus(m_pDiag, m_uInfo.intRowMax, ID_COL_021_ADNAME1);
				return 1;
			}
			break;
*/
...
// midori 155866 add <--
				intCol = CmnGetControlCol();
				if(intCol == ID_COL_021_SPDATE || intCol == ID_COL_021_PMDATE) {
// 修正No.157633_元号日付 add -->
					if(pMsg->wParam == VK_UP || pMsg->wParam == VK_DOWN)	{
						if(intCol == ID_COL_021_SPDATE)	{
...
// 修正No.158259 add -->
				else if(intCol == ID_COL_021_KAMOKU)	{
...
// 頁コントロールのフォーカス設定
void	CfrmUc021UketoritegataK::FocusPagediag1()
{
...
// 頁コントロールのゲットフォーカス
void	CfrmUc021UketoritegataK::EditONPagediag1( short index )
{
// midori 151405 add -->
	// スクロールフラグをクリアする
	nG_MScroll = 0;
...
// midori 151405 add <--
	...
	// 1行登録
//	if( CmnGetControlCol() != ID_COL_021_VAL ){
...
// 頁コントロールのロストフォーカス
void	CfrmUc021UketoritegataK::EditOFFPagediag1( short index )
{
// midori 155028 add -->
...
// 頁コントロールのキー操作
void	CfrmUc021UketoritegataK::TerminationPagediag1( short index, short nChar, short length, LPUNKNOWN data )
{
	int nMaxDataCol = 0;
	// カレント頁の合計行の種別を取得
...
// midori 160612 cor <--
			...
			//CmnDiagSetFocus(m_pDiag, m_uInfo.intRowMax, ID_COL_021_ADNAME1);
			CmnDiagSetFocus(m_pDiag, nMaxDataCol, ID_COL_021_TEKI);
		}
		break;
	case VK_DOWN:
		// タイトルコントロールへ移動
...
// タイトルコントロールのフォーカス設定
void	CfrmUc021UketoritegataK::FocusTitlediag1()
{
//マウスクリックでキャレットが表示できないためコメントとする
//	// ボタンからTabキー移動した場合に必要
//	m_TitleDiag.SetPosition( 0 );
...
// タイトルコントロールのゲットフォーカス
void	CfrmUc021UketoritegataK::EditONTitlediag1( short index )
{
// midori 151405 add -->
	// スクロールフラグをクリアする
	nG_MScroll = 0;
...
// タイトルコントロールのロストフォーカス
void	CfrmUc021UketoritegataK::EditOFFTitlediag1 (short index )
{
// midori 151405 add -->
	m_Titlefocus = 0;
// midori 151405 add <--
...
//	タイトルの更新
void CfrmUc021UketoritegataK::virUpdateTitle()
{
...
// タイトルコントロールのキーイベント
void	CfrmUc021UketoritegataK::TerminationTitlediag1( short index, short nChar, short length, LPUNKNOWN data )
{
	// フォーカス移動
	switch ( nChar ) {
	case VK_RETURN:
...
void	CfrmUc021UketoritegataK::EditONYoushikidiag1( short index )
{
	DIAGRAM_DATA	diadata;
	int				intRet = -1;
...
// 修正No.157633_元号日付 add -->
	...
	if(m_uInfo.intCurCol == ID_COL_021_SPDATE || m_uInfo.intCurCol == ID_COL_021_PMDATE)	m_uInfo.EditSign = 1;
	else																					m_uInfo.EditSign = -1;
// 修正No.157633_元号日付 add <--

	switch (m_uInfo.intCurCol) {
	case ID_COL_021_KAMOKU:	// 科目
		// コンボボックスのオフセット値取得
		m_pDiag->GetData( m_uInfo.intCurCtlIndex , (LPUNKNOWN)&diadata );
...
// 修正No.157633_元号日付 add <--
	...
	if ( /*( m_uInfo.OldRow != CmnGetControlRow() ) &&*/ ( m_uInfo.OldRow > 0 ) ) {
		if ( m_uInfo.OldPage == m_uInfo.intCurPage && m_uInfo.OldPage > 0 ) {
			//if( CmnGetControlCol() != ID_COL_021_VAL ){
			BOOL isSaveBk1 = IsSaveMoveReference(ID_COL_021_BKNAME1, ID_COL_021_BKNAME2);		// 支払銀行名
			BOOL isSaveBk2 = IsSaveMoveReference(ID_COL_021_BK2NAME1, ID_COL_021_BK2NAME2);		// 割引銀行名
...
// データコントロールのロストフォーカス
void	CfrmUc021UketoritegataK::EditOFFYoushikidiag1( short index )
{
	if( m_EndView != FALSE )	return;
...
//	入力確定
void CfrmUc021UketoritegataK::virInputDecisionEditOFF()
{
	// フォーカスフラグOFF
...
// 預貯金データコントロールのキーイベント
void	CfrmUc021UketoritegataK::TerminationYoushikidiag1( short index, short nChar, short length, LPUNKNOWN data )
{
	//--------------------------------------------------------------------------------
	//	キー操作仕様
...
// 改良No.21-0086,21-0529 cor -->
			//if( KamokuRowEnableSgn(m_pDB,1) == 1 && intCol == ID_COL_021_ADNAME1 ){
// ------------------------------
			if(KamokuRowEnableSgn(m_pDB, 1, m_uInfo.intFormSeq) == 1 && intCol == ID_COL_021_ADNAME1)	{
// 改良No.21-0086,21-0529 cor <--
...
// 修正No.157633_元号日付 add -->
			...
			else if(intCol == ID_COL_021_PMDATE)	{
				m_uInfo.OldDate[1] = 0;
				m_uInfo.OldGengo[1] = 0;
			}
...
// midori 151405 add -->
void CfrmUc021UketoritegataK::VScrollYoushikidiag1(short mode)
{
...
//********************************************************************************
int	CfrmUc021UketoritegataK::GetFocusPosition( int nChar )
{
	int		intRow;				// カレント行番号
	int		intCol;				// カレント列番号
...
// midori 190301 del -->
	//intRowChange = m_uInfo.intCtlStartIndex + 1 + 4/*列分割の線の数*/;	// ここの値は検討が必要
// midori 190301 del <--
// midori 190301 add -->
	intRowChange = m_uInfo.intCtlStartIndex + 1 + 2/*列分割の線の数*/;	// ここの値は検討が必要
// midori 190301 add <--
...
// midori 190301 del -->
	...
	//}
	//else if ( intCol == ID_COL_021_ADNAME1 ) {
	//	// カレント列が「振出人:1行目」の場合
	...
	//}
	//else if (( intCol == ID_COL_021_SPDATE  ) || 
	//		 ( intCol == ID_COL_021_BKNAME1 ) ||
	//		 ( intCol == ID_COL_021_BK2NAME1)) {
	...
	//}
	//else if (( intCol == ID_COL_021_PMDATE  ) ||
	//		 ( intCol == ID_COL_021_BKNAME2 ) ||
	//		 ( intCol == ID_COL_021_BK2NAME2 )) {
	...
	//	intVector[3] = m_uInfo.intCurCtlIndex - 1;							// ←
	//}
	//else if ( intCol == ID_COL_021_TEKI ) {
	//	// カレント列が「摘要」の場合
...
// midori 190301 add -->
	...
	else if ( intCol == ID_COL_021_BK2NAME1 )	{
		// カレント列が「割引銀行名」の場合
		intVector[0] = m_uInfo.intCurCtlIndex - m_uInfo.intColMax + 1;		// ↑
		intVector[1] = m_uInfo.intCurCtlIndex + 1;							// →
		intVector[2] = m_uInfo.intCurCtlIndex + 1;							// ↓
	...
	else if ( intCol == ID_COL_021_BK2NAME2 )	{
...
//********************************************************************************
int	CfrmUc021UketoritegataK::GetTotalRowIndex( int nCharOrg, int intIndex, int intNext )
{
	...
	//	現在、頁計に居る
		...
		case VK_UP:			// ↑：23行目のデータ行の支店名項目へ移動
			nRet = CmnGetControlIndex( nBorder[0], ID_COL_021_ADNAME1 );
			break;
		case VK_LEFT:		// ←/Shift+Tab：23行目のデータ行の摘要項目へ移動
			nRet = CmnGetControlIndex( nBorder[0], ID_COL_021_TEKI );
			break;
		default:			// →/↓/Return/Tab：25行目の合計行②へ移動
			...
			//	累計あり
				...
				nRet = CmnGetControlIndex( ( nBorder[2] + 1 ), ID_COL_021_ADNAME1 );
			}
			break;
		}
	}
	//	現在、累計に居る場合
		...
		case VK_LEFT:		// ←/Shift+Tab：24行目の合計行① or 24行目のデータ行の摘要項目へ移動
			nRet = CmnGetControlIndex( ( nBorder[1] + 1 ), ID_COL_021_ADNAME1 );
			break;
		default:			// →/↓：移動できない
			// 例外処理：最終項目で"Tab"は別コントロールへ移動
			// それ以外は「→」キーと同じ
...
//		RET		なし
//********************************************************************************
void	CfrmUc021UketoritegataK::virTblEditIkkatuLine( int nType, CdbUc000Common* rsData,
...
//		RET		なし
//********************************************************************************
void	CfrmUc021UketoritegataK::virTblEditKamokuLine( CdbUc000Common* rsData, int pPage, int pRow, CString strName )
{
...
//		RET		なし
//********************************************************************************
CString CfrmUc021UketoritegataK::virTblSortGetKamokuName( CdbUc000Common* rsData )
{
	CString					ret=_T("");
	CdbUc021Uketoritegata*	rs = (CdbUc021Uketoritegata*)rsData;
	ret = rs->m_KnName;
...
//		RET		int					取引先コード
//********************************************************************************
int CfrmUc021UketoritegataK::virTblSortGetTorihikisakiCode( CdbUc000Common* rsData )
{
	int						ret=0;
	CdbUc021Uketoritegata*	rs = (CdbUc021Uketoritegata*)rsData;
	ret = rs->m_AdOrder;
...
//		RET		CString				取引先名称
//********************************************************************************
CString CfrmUc021UketoritegataK::virTblSortGetTorihikisakiName( CdbUc000Common* rsData )
{
	CString					ret=_T("");
...
//		RET		int					取引先コード
//********************************************************************************
int CfrmUc021UketoritegataK::virTblSortGetKamokuCode( CdbUc000Common* rsData )
{
	int						ret=0;
	CdbUc021Uketoritegata*	rs = (CdbUc021Uketoritegata*)rsData;
	ret = rs->m_KnOrder;
...
//********************************************************************************
int	CfrmUc021UketoritegataK::virTblSortSubSortProc( CdlgSort* pCdlgSort, CdbUc000Common* rsData )
{
	CdbUc021Uketoritegata*	rs;
	CString				strFilter;
	CString				strSort;
	...
	CdbUcLstKamoku	rsKmk( m_pDB );
//@	rsKmk.UpdateDataTable(TBL_NAME_031, m_uInfo.intFormSeq);
...
/**********************************************************************
	...
	戻値
		int		成功/失敗
				FUNCTION_OK
***********************************************************************/
int	CfrmUc021UketoritegataK::RecBufSetData( CdbUc021Uketoritegata* prmDbRec )
{
...
/**********************************************************************
	...
	戻値
		int		成功/失敗
				FUNCTION_OK
***********************************************************************/
int	CfrmUc021UketoritegataK::RecBufClearAllData()
{
...
/**********************************************************************
	...
	戻値
		int		成功/失敗
				FUNCTION_OK
***********************************************************************/
int	CfrmUc021UketoritegataK::RecBufClearData( P_REC_UC_021_UKETORITEGATE inRecData )
{
...
/**********************************************************************
	...
	戻値
		int				成功(更新あり)/成功(更新なし)/失敗
						...
						FUNCTION_NG		: 失敗
***********************************************************************/
int	CfrmUc021UketoritegataK::virRecBufSaveData( int inPage, int inRow )
{
	...
	// 科目
	intIndex = CmnGetControlIndex( inRow, ID_COL_021_KAMOKU );
...
// midori 152137 add <--
	...
	intIndex = CmnGetControlIndex( inRow, ID_COL_021_ADNAME1 );
// midori 156189,156190,156191 del -->
	...
	//	if(m_uInfo.intCurCol == ID_COL_021_ADNAME1 && m_uInfo.intCurRow != m_uInfo.OldRow){	// 各カラムごとにvirRecBufSaveData()がコールされるようになり、かつタイミングがEditOffからEditOnに移ったことによりCmnDiagSetString()でカレットが末尾から先頭に移ってしまう為、制御（修正依頼No150489）
...
// midori 156189,156190,156191 add <--
	...
	// 振出年月日
	intIndex = CmnGetControlIndex( inRow, ID_COL_021_SPDATE );
// midori 200101 del -->
...
// midori 200101 add <--
	...
	// 支払期日
	intIndex = CmnGetControlIndex( inRow, ID_COL_021_PMDATE );
// midori 200101 del -->
...
// midori 200101 add <--
	...
	// 支払銀行名
	intIndex = CmnGetControlIndex( inRow, ID_COL_021_BKNAME1 );
	tmpSaveData.m_BkName1 = m_clsFunc.DiagGetString( m_pDiag, intIndex );

	// 支払銀行名（支店名）
	intIndex = CmnGetControlIndex( inRow, ID_COL_021_BKNAME2 );
	tmpSaveData.m_BkName2 = m_clsFunc.DiagGetString( m_pDiag, intIndex );

	// 金額
	intIndex = CmnGetControlIndex( inRow, ID_COL_021_VAL );
	tmpSaveData.m_Val = CmnDiagGetKingaku( m_pDiag, intIndex );

	// 割引銀行名等
	intIndex = CmnGetControlIndex( inRow, ID_COL_021_BK2NAME1 );
	tmpSaveData.m_Bk2Name1 = m_clsFunc.DiagGetString( m_pDiag, intIndex );

	// 割引銀行名等（支店名）
	intIndex = CmnGetControlIndex( inRow, ID_COL_021_BK2NAME2 );
	tmpSaveData.m_Bk2Name2 = m_clsFunc.DiagGetString( m_pDiag, intIndex );

	// 摘要
	intIndex = CmnGetControlIndex( inRow, ID_COL_021_TEKI );
...
***********************************************************************/
int	CfrmUc021UketoritegataK::virRecBufSaveDataForPasteInsert( int inPage, int inRow )
{
...
***********************************************************************/
int	CfrmUc021UketoritegataK::virRecBufSaveDataForPaste( int inPage, int inRow )
{
	///////////////////////////////////////////////////////////////
	// 登録処理呼び出し
	return RecBufSaveDataSub( inPage, inRow, &m_CopyData );
...
/**********************************************************************
	...
	戻値
			int					成功(更新あり)/成功(更新なし)/失敗
								...
								FUNCTION_NG		: 失敗
***********************************************************************/
int	CfrmUc021UketoritegataK::RecBufSaveDataSub( 
							int inPage,
							int inRow,
...
// midori 156189,156190,156191 add <--
/*	CString	tmp_AdName1;	// 画面上のデータ格納用(振出人1)
	CString	tmp_AdName2;	// 画面上のデータ格納用(振出人2)
	long	tmp_SpDate;	// 画面上のデータ格納用(振出年月日)
	long	tmp_PmDate;	// 画面上のデータ格納用(支払期日)
	CString	tmp_BkName1;	// 画面上のデータ格納用(支払銀行名)
	CString	tmp_BkName2;	// 画面上のデータ格納用(支払銀行名（支店名）)
	CString	tmp_Val;	// 画面上のデータ格納用(金額)
	CString	tmp_Bk2Name1;	// 画面上のデータ格納用(割引銀行名等)
	CString	tmp_Bk2Name2;	// 画面上のデータ格納用(割引銀行名等（支店名）)
...
// midori 190504 del -->
	...
	//udtTemp.m_AdName1 = inSaveData->m_AdName1;	// (振出人1)
	//udtTemp.m_AdName2 = inSaveData->m_AdName2;	// (振出人2)
	...
	//udtTemp.m_Bk2Name1 = inSaveData->m_Bk2Name1;// (割引銀行名等)
	//udtTemp.m_Bk2Name2 = inSaveData->m_Bk2Name2;// (割引銀行名等（支店名）)
...
// midori 152137 add <--
		...
		if((udtTemp.m_FgFunc == ID_FGFUNC_DATA) && (ufgAdName == TRUE))		{	// 変更ありの場合
			...
			if(m_RegAutoRef)	udtTemp.m_AdSeq = rsAdd.CheckEntryAddNone(udtTemp.m_AdName1, udtTemp.m_AdName2, "", "", ID_ADDRESSGR_URI, FALSE, TRUE);	// 修正No.162362 del
			//if(m_RegAutoRef)	udtTemp.m_AdSeq = rsAdd.CheckEntry(udtTemp.m_AdName1, udtTemp.m_AdName2, "", "", ID_ADDRESSGR_URI, TRUE);				// 修正No.162362 add
			else				udtTemp.m_AdSeq = rsAdd.GetSeqFromAdName(ID_ADDRESSGR_URI, udtTemp.m_AdName1, udtTemp.m_AdName2);
...
//********************************************************************************
CdbUc000Common*	CfrmUc021UketoritegataK::virGetDataTableObject()
{
	// 「受取手形」テーブルのオブジェクトを生成し、ポインタを返す
...
//	RET	なし
//********************************************************************************
void	CfrmUc021UketoritegataK::virRowButtonCopyProc()
{
...
//	RET	なし
//********************************************************************************
void	CfrmUc021UketoritegataK::virGetCurrentInfo( CURRENT_INFO* uCurInfo )
{
...
//	【戻値】	なし
//**************************************************
void CfrmUc021UketoritegataK::SetInputMode( int nRow, long nMode )
{
	m_pDiag->ModifyItem( CmnGetControlIndex( nRow, ID_COL_021_KAMOKU ), nMode );	//	科目
	m_pDiag->ModifyItem( CmnGetControlIndex( nRow, ID_COL_021_ADNAME1 ), nMode );	//	振出人（上段）
	m_pDiag->ModifyItem( CmnGetControlIndex( nRow, ID_COL_021_SPDATE ), nMode );	//	振出年月日
	m_pDiag->ModifyItem( CmnGetControlIndex( nRow, ID_COL_021_PMDATE ), nMode );	//	支払期日
	m_pDiag->ModifyItem( CmnGetControlIndex( nRow, ID_COL_021_BKNAME1 ), nMode );	//	支払銀行名
	m_pDiag->ModifyItem( CmnGetControlIndex( nRow, ID_COL_021_BKNAME2 ), nMode );	//	支払支店名
	m_pDiag->ModifyItem( CmnGetControlIndex( nRow, ID_COL_021_VAL ), nMode );		//	金額
	m_pDiag->ModifyItem( CmnGetControlIndex( nRow, ID_COL_021_BK2NAME1 ), nMode );	//	割引銀行名
	m_pDiag->ModifyItem( CmnGetControlIndex( nRow, ID_COL_021_BK2NAME2 ), nMode );	//	割引支店名
	m_pDiag->ModifyItem( CmnGetControlIndex( nRow, ID_COL_021_TEKI ), nMode );		//	摘要
}
...
//	【戻値】	なし
//**************************************************
void CfrmUc021UketoritegataK::SetDiagBackColor()
{
...
//		RET		なし					
//********************************************************************************
void CfrmUc021UketoritegataK::virRendoCreateData(CdbUc000Common* rsData, RENTEMP_INFO* uRenInfo)
{
	CString			strTemp;
...
// midori 152153 del -->
	...
	//intSeq = rsLstAdd.CheckEntryAddNone( strArry.GetAt(0), strArry.GetAt(1) , _T("") , _T("") , ID_ADDRESSGR_URI , FALSE, TRUE);
	//if (intSeq > 0) {
...
//		RET		なし					
//********************************************************************************
void CfrmUc021UketoritegataK::virRendoUpdateData(CdbUc000Common* rsData, RENTEMP_INFO* uRenInfo)
{
	CdbUc021Uketoritegata*	rs = (CdbUc021Uketoritegata*)rsData;
...
//***************************************************************************
BOOL CfrmUc021UketoritegataK::virEndProc(void)
{
	TRACE(_T("***** CfrmUc021UketoritegataK::virEndProc\n"));
...
// 2012/06/29追加
//********************************************************************************
void CfrmUc021UketoritegataK::virTblGetKamokuInfo( CdbUc000Common* rsData, SORTKAMOKU_INFO* uKamoku )
{
	CdbUc021Uketoritegata*	rs = (CdbUc021Uketoritegata*)rsData;
...
// midori 161106 add -->
void CfrmUc021UketoritegataK::ComboNew(short index)
{
	short			sv_sel=0;
// midori 152201 add -->
...
// midori 151405 add -->
int CfrmUc021UketoritegataK::CursorControl(short nChar, int sw)
{
	int				rv=0;
	int				intCol=0;
	int				pos=0;
...
// midori 152134 add -->
void CfrmUc021UketoritegataK::ComboSelYoushikidiag1(short index, LPUNKNOWN data)
{
// 要通知案件修正 21/07/09 del -->
...
// ------------------------------------------------------------------------------------------------------------------------
void CfrmUc021UketoritegataK::BankCellChg(int nRow,int nCol)
{
	int				sign=0;
	int				index=0;
	int				nCharOver=0;
...
// 修正No.157626 add <--
	...
	if(nCol != ID_COL_021_BKNAME1 && nCol != ID_COL_021_BKNAME2)	{
		return;
	}
	// 画面から名称を取得
...
// 修正No.157628 add <--
			//strSQL2.Format(_T("from uc_021_uketoritegata where FgShow=%d AND NumPage <> %d AND NumRow <> %d) tbl1 "),ID_FGSHOW_OFF,m_ReadData[nRow].m_NumPage,nRow);
...
// 修正No.157626 del -->
	//if(nCol == ID_COL_021_BKNAME1)	CmnHeadDiagSetTitle(&m_HeadDiag, 5, _T("名    称(11)"), nCharOver);
	//else								CmnHeadDiagSetTitle(&m_HeadDiag, 6, _T("支  店  名(11)"), nCharOver);
// 修正No.157626 del <--
// 修正No.157626 add -->
	if(nCol == ID_COL_021_BKNAME1)	{
...
// ------------------------------------------------------------------------------------------------------------------------
void CfrmUc021UketoritegataK::TitleColorChg(void)
{
	...
	// 支払銀行名称
// 修正No.157628 del -->
	//strSQL.Format(_T("select max(oversgn) from (select CASE when len(Replace(isnull(BkName1,''),CHAR(13)+CHAR(10),'')) > %d then 1 else 0 end as oversgn from uc_021_uketoritegata where FgShow=%d) tbl1"),UC_BANK_LEN,ID_FGSHOW_OFF);
// 修正No.157628 del <--
// 修正No.157628 add -->
	strSQL.Format(_T("select max(oversgn) from (select CASE when len(%s) > %d then 1 else 0 end as oversgn from uc_021_uketoritegata where FgShow=%d) tbl1"),
		MakeReplaceSent(_T("BkName1")),UC_BANK_LEN,ID_FGSHOW_OFF);
// 修正No.157628 add <--
	...
	// 支払銀行支店名
// 修正No.157628 del -->
	//strSQL.Format(_T("select max(oversgn) from (select CASE when len(Replace(isnull(BkName2,''),CHAR(13)+CHAR(10),'')) > %d then 1 else 0 end as oversgn from uc_021_uketoritegata where FgShow=%d) tbl1"),UC_BANK_LEN,ID_FGSHOW_OFF);
// 修正No.157628 del <--
// 修正No.157628 add -->
	strSQL.Format(_T("select max(oversgn) from (select CASE when len(%s) > %d then 1 else 0 end as oversgn from uc_021_uketoritegata where FgShow=%d) tbl1"),
		MakeReplaceSent(_T("BkName2")),UC_BANK_LEN,ID_FGSHOW_OFF);
// 修正No.157628 add <--
	...
	// 割引銀行名および支店名等
// 修正No.157628 del -->
	//strSQL.Format(_T("select max(oversgn) from (select CASE when len(Replace(isnull(Bk2Name1,'') + isnull(Bk2Name2,''),CHAR(13)+CHAR(10),'')) > %d then 1 else 0 end as oversgn from uc_021_uketoritegata where FgShow=%d) tbl1"),(UC_BANK_LEN*2),ID_FGSHOW_OFF);
// 修正No.157628 del <--
// 修正No.157628 add -->
	strSQL.Format(_T("select max(oversgn) from (select CASE when len(%s) > %d then 1 else 0 end as oversgn from uc_021_uketoritegata where FgShow=%d) tbl1"),
		MakeReplaceSent2(_T("Bk2Name1"),_T("Bk2Name2")),(UC_BANK_LEN*2),ID_FGSHOW_OFF);
// 修正No.157628 add <--
	...
	// 摘要
// 修正No.157628 del -->
	//strSQL.Format(_T("select max(oversgn) from (select CASE when len(Replace(isnull(Teki,''),CHAR(13)+CHAR(10),'')) > %d then 1 else 0 end as oversgn from uc_021_uketoritegata where FgShow=%d) tbl1"),UC_021_TEKI_LEN,ID_FGSHOW_OFF);
// 修正No.157628 del <--
// 修正No.157628 add -->
	strSQL.Format(_T("select max(oversgn) from (select CASE when len(%s) > %d then 1 else 0 end as oversgn from uc_021_uketoritegata where FgShow=%d) tbl1"),
		MakeReplaceSent(_T("Teki")),UC_021_TEKI_LEN,ID_FGSHOW_OFF);
// 修正No.157628 add <--
	...
	// 項目タイトル(ヘッダ部)の再設定
// 修正No.157626 del -->
	//CmnHeadDiagSetTitle(&m_HeadDiag,5,_T("名    称(11)"),nCharOver[0]);
	//CmnHeadDiagSetTitle(&m_HeadDiag,6,_T("支  店  名(11)"),nCharOver[1]);
	////CmnHeadDiagSetTitle(&m_HeadDiag,8,_T("割引銀行名及び\r\n支店名等(22)"),nCharOver[2]);
	//CmnHeadDiagSetTitle(&m_HeadDiag,8,_T("割引銀行名\r\n及び支店名等\r\n(22)"),nCharOver[2]);
	//CmnHeadDiagSetTitle(&m_HeadDiag,9,_T("摘      要(50)"),nCharOver[3]);
// 修正No.157626 del <--
// 修正No.157626 add -->
...
// --------------------------------------------------------------------------------------------------------
void CfrmUc021UketoritegataK::Date_ChkAndSet(short index, int col, short sign)
{
	short			sv_sel=0;
	int				sv_index=0;
	int				day=0,gen=0;
	...
	if(m_DataKakutei == TRUE)									return;
	if(col != ID_COL_021_SPDATE && col != ID_COL_021_PMDATE)	return;
	...
	if(sign == 1)	{
		if(col == ID_COL_021_SPDATE)	{		// 振出年月日
		...
		else if(col == ID_COL_021_PMDATE)	{		// 支払期日
...
// 修正No.162446 add -->
LRESULT CfrmUc021UketoritegataK::OnUserReDrawView(WPARAM wParam, LPARAM lParam)
{
	virUpdateControlTblData();
	CmnDiagSetFocus(m_pDiag, 1, 1);
