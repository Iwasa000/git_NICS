...
IMPLEMENT_DYNCREATE( CfrmUc171Sonota1I, CfrmUc000Common )


BEGIN_MESSAGE_MAP( CfrmUc171Sonota1I, CfrmUc000Common )
	ON_WM_SIZE()
	...
	ON_COMMAND( ID_PRINTSETUP_MENU, &CfrmUc171Sonota1I::OnMenuPrintSetup )
	ON_COMMAND( ID_PRINTALL_MENU, &CfrmUc171Sonota1I::OnMenuPrintAll )
	ON_COMMAND( ID_SPECIALROW_MENU, &CfrmUc171Sonota1I::OnMenuSpecialRow )
	ON_COMMAND( ID_SORT_MENU, &CfrmUc171Sonota1I::OnMenuSort )
	ON_COMMAND(ID_IKKATUADD_MENU, &CfrmUc171Sonota1I::OnIkkatuAddMenu)
	ON_COMMAND( ID_DISPDIALOG_MENU, &CfrmUc171Sonota1I::OnMenuIkkatuKingaku )
	ON_COMMAND( ID_ZEROMONEY_MENU, &CfrmUc171Sonota1I::OnMenuZeroMoney )
	ON_COMMAND( ID_ZEROMONEYMOVE_MENU, &CfrmUc171Sonota1I::OnMenuZeroMoneyMove )
	ON_COMMAND( ID_AMOUTDIALOG_MENU, &CfrmUc171Sonota1I::OnMenuOutKeiSetup )
	ON_COMMAND( ID_CLEAR_MENU, &CfrmUc171Sonota1I::OnMenuClear )
	ON_COMMAND( ID_RENDO_MENU, &CfrmUc171Sonota1I::OnMenuZaimuRendo )
	ON_COMMAND( ID_TITLEMENU, &CfrmUc171Sonota1I::OnMenuTitleRestore )
	ON_COMMAND( ID_USER_SETTING_MENU, &CfrmUc171Sonota1I::OnMenuOptionSetting )
	ON_COMMAND( ID_COPY_SETTING_INFO_MENU, &CfrmUc171Sonota1I::OnMenuCopySettingInfo )
	ON_COMMAND( ID_DELETE_DATA_MENU, &CfrmUc171Sonota1I::OnMenuDeleteDataEachYoushiki )
	ON_BN_CLICKED( IDC_PAGEBACK_BUTTON1, &CfrmUc171Sonota1I::OnPageBack )
	ON_BN_CLICKED( IDC_PAGENEXT_BUTTON1, &CfrmUc171Sonota1I::OnPageNext )
	ON_BN_CLICKED( IDC_PAGENEW_BUTTON1, &CfrmUc171Sonota1I::OnPageNew )
	ON_BN_CLICKED( IDC_PAGEINSERT_BUTTON1, &CfrmUc171Sonota1I::OnPageInsert )
	ON_BN_CLICKED( IDC_ROWCOPY_BUTTON1, &CfrmUc171Sonota1I::OnRowCopy )
	ON_BN_CLICKED( IDC_ROWPASTE_BUTTON1, &CfrmUc171Sonota1I::OnRowPaste )
	ON_BN_CLICKED( IDC_ROWINSERT_BUTTON1, &CfrmUc171Sonota1I::OnRowInsert )
	ON_BN_CLICKED( IDC_YOUSHIKINEXT_BUTTON1, &CfrmUc171Sonota1I::OnMoveYoushikiNext )
	ON_BN_CLICKED( IDC_YOUSHIKIBACK_BUTTON1, &CfrmUc171Sonota1I::OnMoveYoushikiBack )
	ON_UPDATE_COMMAND_UI( ID_BUTTON_F6, &CfrmUc171Sonota1I::OnUpdateButtonF6 )
	ON_UPDATE_COMMAND_UI( ID_BUTTON_F7, &CfrmUc171Sonota1I::OnUpdateButtonF7 )
	ON_UPDATE_COMMAND_UI( ID_BUTTON_F8, &CfrmUc171Sonota1I::OnUpdateButtonF8 )
	ON_UPDATE_COMMAND_UI( ID_BUTTON_F9, &CfrmUc171Sonota1I::OnUpdateButtonF9 )
	ON_UPDATE_COMMAND_UI( ID_BUTTON_F11, &CfrmUc171Sonota1I::OnUpdateButtonF11 )
	ON_UPDATE_COMMAND_UI( ID_BUTTON_F12, &CfrmUc171Sonota1I::OnUpdateButtonF12 )
	ON_UPDATE_COMMAND_UI( ID_BUTTON_HOME, &CfrmUc171Sonota1I::OnUpdateButtonHome )
	ON_UPDATE_COMMAND_UI( ID_IKKATUADD_MENU, &CfrmUc171Sonota1I::OnUpdateIkkatuaddMenu)
	ON_UPDATE_COMMAND_UI( ID_DISPDIALOG_MENU, &CfrmUc171Sonota1I::OnUpdateMenuIkkatuKingaku )
	ON_UPDATE_COMMAND_UI( ID_SORT_MENU, &CfrmUc171Sonota1I::OnUpdateMenuSort )
	ON_UPDATE_COMMAND_UI( ID_CLEAR_MENU, &CfrmUc171Sonota1I::OnUpdateMenuClear )
	ON_UPDATE_COMMAND_UI( ID_ZEROMONEY_MENU, &CfrmUc171Sonota1I::OnUpdateMenuZeroMoney )
	ON_UPDATE_COMMAND_UI( ID_ZEROMONEYMOVE_MENU, &CfrmUc171Sonota1I::OnUpdateMenuZeroMoneyMove)
	ON_UPDATE_COMMAND_UI( ID_RENDO_MENU, &CfrmUc171Sonota1I::OnUpdateMenuZaimuRendo )
	ON_UPDATE_COMMAND_UI(ID_SPECIALROW_MENU, &CfrmUc171Sonota1I::OnUpdateMenuSpecialRow)
	ON_UPDATE_COMMAND_UI( ID_TITLEMENU, &CfrmUc171Sonota1I::OnUpdateMenuTitleRestore )
	ON_UPDATE_COMMAND_UI( ID_DELETE_DATA_MENU, &CfrmUc171Sonota1I::OnUpdateMenuDeleteDataEachYoushiki )
	ON_MESSAGE(WM_USER_REDRAWVIEW, OnUserReDrawView)
END_MESSAGE_MAP()


CfrmUc171Sonota1I::CfrmUc171Sonota1I()
	: CfrmUc000Common( CfrmUc171Sonota1I::IDD )
{
...
CfrmUc171Sonota1I::~CfrmUc171Sonota1I()
{
	...
	TRACE(_T("***** CfrmUc171Sonota1I::~CfrmUc171Sonota1I\n"));

}

void CfrmUc171Sonota1I::DoDataExchange( CDataExchange* pDX )
{
...
void CfrmUc171Sonota1I::OnInitialUpdate()
{
...
#ifdef _DEBUG
void CfrmUc171Sonota1I::AssertValid() const
{
	CfrmUc000Common::AssertValid();
}

#ifndef _WIN32_WCE
void CfrmUc171Sonota1I::Dump( CDumpContext& dc ) const
{
...
BEGIN_EVENTSINK_MAP( CfrmUc171Sonota1I, CfrmUc000Common )
	ON_EVENT( CfrmUc171Sonota1I, IDC_YOUSHIKIDIAG1, 3, CfrmUc171Sonota1I::TerminationYoushikidiag1, VTS_I2 VTS_I2 VTS_I2 VTS_UNKNOWN )
	ON_EVENT( CfrmUc171Sonota1I, IDC_YOUSHIKIDIAG1, 2, CfrmUc171Sonota1I::EditOFFYoushikidiag1, VTS_I2 )
	ON_EVENT( CfrmUc171Sonota1I, IDC_YOUSHIKIDIAG1, 1, CfrmUc171Sonota1I::EditONYoushikidiag1, VTS_I2 )
	ON_EVENT(CfrmUc171Sonota1I, IDC_YOUSHIKIDIAG1, 12, CfrmUc171Sonota1I::VScrollYoushikidiag1, VTS_I2)
	ON_EVENT(CfrmUc171Sonota1I, IDC_YOUSHIKIDIAG1, 8, CfrmUc171Sonota1I::ComboSelYoushikidiag1, VTS_I2 VTS_UNKNOWN)

	ON_EVENT( CfrmUc171Sonota1I, IDC_YOUSHIKIDIAG2, 3, CfrmUc171Sonota1I::TerminationYoushikidiag1, VTS_I2 VTS_I2 VTS_I2 VTS_UNKNOWN )
	ON_EVENT( CfrmUc171Sonota1I, IDC_YOUSHIKIDIAG2, 2, CfrmUc171Sonota1I::EditOFFYoushikidiag1, VTS_I2 )
	ON_EVENT( CfrmUc171Sonota1I, IDC_YOUSHIKIDIAG2, 1, CfrmUc171Sonota1I::EditONYoushikidiag1, VTS_I2 )
	ON_EVENT(CfrmUc171Sonota1I, IDC_YOUSHIKIDIAG2, 12, CfrmUc171Sonota1I::VScrollYoushikidiag1, VTS_I2)
	ON_EVENT(CfrmUc171Sonota1I, IDC_YOUSHIKIDIAG2, 8, CfrmUc171Sonota1I::ComboSelYoushikidiag1, VTS_I2 VTS_UNKNOWN)

	ON_EVENT( CfrmUc171Sonota1I, IDC_TITLEDIAG1, 3, CfrmUc171Sonota1I::TerminationTitlediag1, VTS_I2 VTS_I2 VTS_I2 VTS_UNKNOWN )
	ON_EVENT( CfrmUc171Sonota1I, IDC_TITLEDIAG1, 2, CfrmUc171Sonota1I::EditOFFTitlediag1, VTS_I2 )
	ON_EVENT( CfrmUc171Sonota1I, IDC_TITLEDIAG1, 1, CfrmUc171Sonota1I::EditONTitlediag1, VTS_I2 )
	ON_EVENT( CfrmUc171Sonota1I, IDC_TITLEDIAG1, 6, CfrmUc171Sonota1I::FocusTitlediag1, VTS_NONE )

	ON_EVENT( CfrmUc171Sonota1I, IDC_PAGEDIAG1, 3, CfrmUc171Sonota1I::TerminationPagediag1, VTS_I2 VTS_I2 VTS_I2 VTS_UNKNOWN )
	ON_EVENT( CfrmUc171Sonota1I, IDC_PAGEDIAG1, 2, CfrmUc171Sonota1I::EditOFFPagediag1, VTS_I2 )
	ON_EVENT( CfrmUc171Sonota1I, IDC_PAGEDIAG1, 1, CfrmUc171Sonota1I::EditONPagediag1, VTS_I2 )
	ON_EVENT( CfrmUc171Sonota1I, IDC_PAGEDIAG1, 6, CfrmUc171Sonota1I::FocusPagediag1, VTS_NONE )
END_EVENTSINK_MAP()

//********************************************************************************
//	初期処理
//********************************************************************************
BOOL	CfrmUc171Sonota1I::virStartJob()
{
	// 初期値設定
...
//	共通データの初期値設定
//********************************************************************************
void	CfrmUc171Sonota1I::virSetInitialUchiwakeInfo()
{
	// 「その他1」の固有データ
	m_uInfo.intOutKeiDialog = AM_TYPE_ALL;				// 計設定ダイアログのボタン指定
	m_uInfo.intRowMax = ID_ROWKOBETU_171;				// １頁内の合計行を含む全体の行数
	m_uInfo.intRowMaxData = ID_ROWKOBETU_171 - 1;		// １頁内のデータ行数（合計行は含まず）
	m_uInfo.intColMax = ID_COLMAX_171I;					// １行内のコントロール個数
	m_uInfo.intColMaxData = ID_COLMAXDATA_171I;			// １行内の列数
	m_uInfo.intCtlStartIndex = ID_CTLSTARTINDEX_171I;	// １行目の入力項目の先頭インデックス番号
	m_uInfo.intT1StartIndex = ID_T1STARTNORMAL_171I;	// 合計行①の先頭インデックス番号
	m_uInfo.intT2StartIndex = ID_T2STARTNORMAL_171I;	// 合計行②の入力項目の先頭インデックス番号
	m_uInfo.intCursolDefPos = ID_COL_171I_INVONO;		// カーソル移動時の初期位置（タイトルから↓，合計から↑で使用）
	m_uInfo.intCursolKeiPos = ID_COL_171I_KNORDER;		// 合計行のカーソル移動位置（カーソル移動で使用）

	m_uInfo.intFormNo = 17;								// 様式番号（uc_inf_sub）
	m_uInfo.intFormNo2 = 1;								// 様式番号枝番（uc_inf_sub）

	m_uInfo.intRowNormal = ID_ROWNORMAL_171;			// 通常時：１頁内の合計行を含む全体の行数
	m_uInfo.intRowKobetu = ID_ROWKOBETU_171;			// 個別時：１頁内の合計行を含む全体の行数
	m_uInfo.intT1StartNormal = ID_T1STARTNORMAL_171I;	// 通常時：合計行①の先頭インデックス
	m_uInfo.intT2StartNormal = ID_T2STARTNORMAL_171I;	// 通常時：合計行②の先頭インデックス
	m_uInfo.intT1StartKobetu = ID_T1STARTKOBETU_171I;	// 個別時：合計行①の先頭インデックス
	m_uInfo.intT2StartKobetu = ID_T2STARTKOBETU_171I;	// 個別時：合計行②の先頭インデックス
	m_uInfo.intRowKei = ID_ROWKEI_171;					// 帳表固定の合計行数（1:合計あり，0:なし）
	m_uInfo.intKei1StartIndex = ID_COL_171I_KEI1_MEISYO;	// 計ダイアグラム1行目の先頭インデックス
	m_uInfo.intKei2StartIndex = ID_COL_171I_KEI2_MEISYO;	// 計ダイアグラム2行目の先頭インデックス

	// 集計処理の設定
	m_uInfo.uCalcInfo.intMaxCount = ID_CALC_171_MAX;		// 集計フィールド件数
	m_uInfo.uCalcInfo.strField[0] = ID_CALC_171_FIELD1;		// 集計フィールド名称1
}
...
// 【戻値】    なし
//**************************************************
void	CfrmUc171Sonota1I::virSetInitialDiag()
{
	int     nIndex;
	...
	// コンボボックスの属性取得
	nIndex = CmnGetControlIndex( 1, ID_COL_171I_KNORDER );
...
//	帳表固有変数の初期値設定
//********************************************************************************
void	CfrmUc171Sonota1I::virSetInitialValue()
{
	// 1ページ分のローカルバッファをクリア
	RecBufClearAllData();
...
//	帳表コントロールの初期化（データ領域）
//********************************************************************************
BOOL	CfrmUc171Sonota1I::InitialControlDataArea()
{
	int		intMax;
	int		i;
	int		len=0;
	...
	for ( i = m_uInfo.intCtlStartIndex; i < intMax; i += m_uInfo.intColMax ) {
		// ComboBox：クリア
		CmnDiagSetString(m_pDiag, i + ID_COL_171I_KNORDER - 1, "", 0);	// 科目
		CmnDiagSetString(m_pDiag, i + ID_COL_171I_INVONOT - 1, "", 0);	// 登録番号(T選択)
		
		// 漢字入力欄の初期化
		CmnDiagSetAttrInpmax( m_pDiag, i + ID_COL_171I_ADNAME1 - 1, MAX_KETA_171_ADNAME1 );		//	名称(氏名)
		CmnDiagSetAttrInpmax( m_pDiag, i + ID_COL_171I_ADADD1  - 1, MAX_KETA_171_ADADD1 );		//	所在地(住所)上段
		CmnDiagSetAttrInpmax( m_pDiag, i + ID_COL_171I_ADADD2  - 1, MAX_KETA_171_ADADD2 );		//	所在地(住所)下段
		CmnDiagSetAttrInpmax( m_pDiag, i + ID_COL_171I_TEKI    - 1, MAX_KETA_171_TEKI );		//	摘要

		// 金額欄：桁数初期化
		len = ID_VAL_171_K_DATA;
		CmnDiagSetAttrDigit( m_pDiag, i + ID_COL_171I_VAL - 1, len );	// 期末現在高
	...
	// 半角/全角設定
	CmnDiagSetAttrColZenHan( m_pDiag , ID_COL_171I_ADNAME1 );	// 名称(氏名)
	CmnDiagSetAttrColZenHan( m_pDiag , ID_COL_171I_ADADD1 );	// 所在地(住所)上段
	CmnDiagSetAttrColZenHan( m_pDiag , ID_COL_171I_ADADD2 );	// 所在地(住所)上段
	CmnDiagSetAttrColZenHan( m_pDiag , ID_COL_171I_TEKI );		// 摘要
...
//********************************************************************************
BOOL	CfrmUc171Sonota1I::InitialControlComboBox()
{
...
//	int				nFontSize = 100;
	...
	for(i = 1; i <= intMax; i++) {
		...
		// 科目
		intIndex = CmnGetControlIndex(i, ID_COL_171I_KNORDER);
		// T選択
		intIndex2 = CmnGetControlIndex(i, ID_COL_171I_INVONOT);
...
//********************************************************************************
void	CfrmUc171Sonota1I::InitialControlTotalArea()
{
	int		nKeiType;			//	計の種別
	int		nDataRow;			//	データ行属性
	...
	if(flg2 == 1)	{
		// 一括自動行の科目を入力可能にする
		m_pDiag->ModifyItem( CmnGetControlIndex( (nDataRowPos+1), ID_COL_171I_KNORDER ), (DIAG_MDFY_EDIT | DIAG_MDFY_OPAQUE) );
	}
	...
	m_pDiagKei->ModifyItem(ID_COL_171I_KEI1_VAL, intKeiRow);
	m_pDiagKei->ModifyItem(ID_COL_171I_KEI2_VAL, intKeiRow);
}
...
//	RET	なし
//********************************************************************************
void	CfrmUc171Sonota1I::InitialControlSpecialRow( int intRow, int intFgFunc )
{
	int				len=0;
	int				nIndex;		//	インデックス
	...
	case ID_FGFUNC_IKKATUAUTO:		// 一括集計金額行（自動）
		// 桁数を設定
		len = ID_VAL_171_K_TOTAL;
		CmnDiagSetAttrDigit( m_pDiag, CmnGetControlIndex( intRow , ID_COL_171I_VAL ), len );
		break;
	}
	...
	switch (intFgFunc) {
		...
		case ID_FGFUNC_IKKATUAUTO:		// 一括集計金額行（自動）
			...
			if(intFgFunc != ID_FGFUNC_IKKATUAUTO) {
				...
				m_pDiag->ModifyItem(CmnGetControlIndex(intRow, ID_COL_171I_KNORDER), DIAG_MDFY_NODROPDOWN);
				// 「登録番号(T選択)」はComboBoxのため、DropDown不可とする
				m_pDiag->ModifyItem(CmnGetControlIndex(intRow, ID_COL_171I_INVONOT), DIAG_MDFY_NODROPDOWN);

				// ComboBoxの選択項目クリア
				m_clsFunc.DiagInit(&diadata);
				diadata.text_combo = _T("\r\n");
				m_pDiag->SetData(CmnGetControlIndex(intRow, ID_COL_171I_KNORDER), (LPUNKNOWN)&diadata);
				m_pDiag->SetData(CmnGetControlIndex(intRow, ID_COL_171I_INVONOT), (LPUNKNOWN)&diadata);
			}
...
// 改良No.21-0086,21-0529 cor <--
				...
				if (intFgFunc == ID_FGFUNC_IKKATUAUTO ){
					//	科目
					m_pDiag->ModifyItem( CmnGetControlIndex( intRow, ID_COL_171I_KNORDER ), DIAG_MDFY_INPUT );
				}
			}
...
//	帳表タイトル情報の表示
//********************************************************************************
void	CfrmUc171Sonota1I::virUpdateControlTitle()
{
...
//	帳表ページ情報の表示
//********************************************************************************
void	CfrmUc171Sonota1I::UpdateControlPage()
{
	BOOL	bBack = TRUE;
	BOOL	bNext = TRUE;
...
//	帳表データの表示（１ページ分）
//********************************************************************************
BOOL	CfrmUc171Sonota1I::virUpdateControlTblData()
{
	int len = 0;
	...
	CdbUc171Sonota1	dbRec( m_pDB, m_uInfo.intFormSeq );
	...
	// 頁計、累計行の桁数をセットする
	len = ID_VAL_171_K_TOTAL;
	CmnDiagSetAttrDigit( m_pDiagKei, ID_COL_171I_KEI1_VAL, len );
	CmnDiagSetAttrDigit( m_pDiagKei, ID_COL_171I_KEI2_VAL, len );
...
//	保管件数の表示
//********************************************************************************
BOOL CfrmUc171Sonota1I::virUpdateControlTblData2()
{
	int					hcnt=0;
	CString				cs=_T("");
...
//		IN		CdbUc171Sonota1*	「その他1」
//		RET		なし
//********************************************************************************
void	CfrmUc171Sonota1I::UpdateControlRowData( CdbUc171Sonota1* prmDbRec ) {
	...
	// 読込み対象セル取得
	intCell = CmnGetControlIndex( prmDbRec->m_NumRow, ID_COL_171I_KNORDER );
...
//********************************************************************************
//	帳表データの１行表示（累計，頁計行）
//		IN		CdbUc171Sonota1*	「その他1」テーブル情報
//		RET		なし
//********************************************************************************
void	CfrmUc171Sonota1I::UpdateControlRowTotal( CdbUc171Sonota1* prmDbRec )
{
	int		intTotalType;
	...
	case ID_OUTKEI_OFF:
		...
		if ( ( prmDbRec->m_FgFunc == ID_FGFUNC_PAGEKEI ) || ( prmDbRec->m_FgFunc == ID_FGFUNC_RUIKEI ) ) {
			if(m_uInfo.intOutKei != ID_OUTKEI_OFF)	intRowName = 2;
		}
		break;
	...
	// 頁計/累計の名称表示
	if ( intRowName > 0 ) {
		CmnDiagSetString( m_pDiagKei, CmnGetKeiDiagIndex( intRowName, ID_COL_171I_KEI1_MEISYO ), prmDbRec->m_KeiStr, 1 );
	}
	// 頁計/累計の金額表示
	if ( intRowVal > 0 ) {
		CmnDiagSetKingaku( m_pDiagKei, CmnGetKeiDiagIndex( intRowVal, ID_COL_171I_KEI1_VAL ), prmDbRec->m_Val );
	}
}
...
//		RET		なし
//********************************************************************************
void	CfrmUc171Sonota1I::virFncCellCopyProc( CdbUc000Common* rsData )
{
	CdbUc171Sonota1*	rs;
	int					intCol;	// 現在の列
	int					ind1,ind2;
	...
	switch(intCol) {
		// 科目
		case ID_COL_171I_KNORDER:
			CmnDiagSetCombo2(m_pDiag, m_uInfo.intCurCtlIndex, rs->m_KnOrder);
			break;
		// 登録番号（T選択）
		case ID_COL_171I_INVONOT:
		// 登録番号
		case ID_COL_171I_INVONO:
			if(intCol == ID_COL_171I_INVONOT) {
...
//********************************************************************************
int	CfrmUc171Sonota1I::virFncReferenceGetType(int intCol, int* intGrSeq, long* lngItemSeq, int* intAdd1, int* intAdd2, int* intAdd1Col, int* intAdd2Col, REFERENCE_INFO* pudReference)
{
int				intRefType;
	...
	switch (intCol) {
		...
		case ID_COL_171I_ADADD2:
			...
			*intAdd1 = 40;
			*intAdd2 = 40;
			*intAdd1Col = ID_COL_171I_ADADD1;
			*intAdd2Col = ID_COL_171I_ADADD2;
			break;
...
//		RET		なし
//********************************************************************************
void	CfrmUc171Sonota1I::virFncReferenceSetData( CdlgReference* dlgRef, int intRefType, int intCol )
{
	switch (intRefType) {
		// 種類
...
//********************************************************************************
//	【F9:参照】参照ダイアログで選択された内容を表示
//		IN		CdlgAddressSearch*	住所ダイアログ情報
//		RET		なし
//********************************************************************************
void CfrmUc171Sonota1I::virFncReferenceSetICSData(CdlgAddressSearch* dlgAddd)
{
	int		nCurRow;	//	カレント行
	int		nCurCol;	//	カレント列
	int		nPos;		//	位置
	...
	//	現在行の取引先の名称１の位置を算出
	nPos = (( nCurRow - 1 ) * m_uInfo.intColMax ) + ( m_uInfo.intCtlStartIndex + ( ID_COL_171I_ADADD1 - 1 ));
	
	//	選択内容を表示
	CmnDiagSetString( m_pDiag, nPos, dlgAddd->m_AdAdd1, 0 );		//	住所１
	CmnDiagSetString( m_pDiag, nPos + 1, dlgAddd->m_AdAdd2, 0 );	//	住所２
}
...
//		RET		なし
//********************************************************************************
void	CfrmUc171Sonota1I::virFncReferenceUpdateTbl( int intRefType, int nRefMode/*=0*/ )
{
	switch (intRefType) {
		// 科目
		case ID_DLGTYPE_KAMOKU:
...
void CfrmUc171Sonota1I::virActivateFrameK(UINT nState, CFrameWnd* pDeactivateFrame)
{
	int		index = 0;
	...
	if(pWnd != NULL)	{
		if(m_DataKakutei == FALSE)	{
			if(m_uInfo.intCurCol == ID_COL_171I_KNORDER)	{
				virKamokuAddCancel();
			}
		}
	}
...
void CfrmUc171Sonota1I::virKamokuAddCancel()
{
	...
	// 科目列なら
	if(m_uInfo.intCurCol == ID_COL_171I_KNORDER && m_F9OnSw != TRUE)	{
		DIAGRAM_DATA	diadata;
		m_pDiag->GetData(m_uInfo.intCurCtlIndex,(LPUNKNOWN)&diadata);
		// 【新規作成】が選択されていれば
		if(diadata.data_combo > m_CmbCnt)	{
			// 前回の値に戻す
			CmnDiagSetCombo(m_pDiag,CmnGetControlIndex(m_uInfo.intCurRow,ID_COL_171I_KNORDER),m_uInfo.OldCombo);
		}
	}
}
...
//	その他イベント処理
//********************************************************************************
BOOL	CfrmUc171Sonota1I::PreTranslateMessage( MSG* pMsg )
{
...
// 修正No.168362 add <--
						...
						if(intCol == ID_COL_171I_KNORDER || intCol == ID_COL_171I_INVONOT)	{
							rv=1;
						}
// 修正No.168362 add -->
					} 
// 修正No.168362 add <--
			...
			case VK_RIGHT:
				if(nG_MScroll == 1)	{
					...
					intCol = CmnGetControlCol();
					if(intCol == ID_COL_171I_KNORDER && (pMsg->wParam == VK_LEFT || pMsg->wParam == VK_RIGHT))	{
...
// 頁コントロールのフォーカス設定
void	CfrmUc171Sonota1I::FocusPagediag1()
{
}

// 頁コントロールのゲットフォーカス
void	CfrmUc171Sonota1I::EditONPagediag1( short index )
{
// 修正No.168443 add -->
	// ---- 登録番号一覧関連 ----->
	if(pZmSel && pZmSel->IsDisplay() != FALSE) {
...
// 頁コントロールのロストフォーカス
void	CfrmUc171Sonota1I::EditOFFPagediag1( short index )
{
...
// 頁コントロールのキー操作
void	CfrmUc171Sonota1I::TerminationPagediag1( short index, short nChar, short length, LPUNKNOWN data )
{
	int nMaxDataCol = 0;
	// カレント頁の合計行の種別を取得
	...
	case VK_TAB:
		...
		if ( CmnCheckShiftKey() == FALSE ) {
			...
			CmnDiagSetFocus(m_pDiag, nMaxDataCol, ID_COL_171I_TEKI);
		}
		break;
...
// タイトルコントロールのフォーカス設定
void	CfrmUc171Sonota1I::FocusTitlediag1()
{
}

// タイトルコントロールのゲットフォーカス
void	CfrmUc171Sonota1I::EditONTitlediag1( short index )
{
// 修正No.168443 add -->
	// ---- 登録番号一覧関連 ----->
	if(pZmSel && pZmSel->IsDisplay() != FALSE) {
...
// タイトルコントロールのロストフォーカス
void	CfrmUc171Sonota1I::EditOFFTitlediag1 (short index )
{
	m_Titlefocus = 0;
	virUpdateTitle();
}
...
//	タイトル更新
void CfrmUc171Sonota1I::virUpdateTitle()
{
...
// タイトルコントロールのキーイベント
void	CfrmUc171Sonota1I::TerminationTitlediag1( short index, short nChar, short length, LPUNKNOWN data )
{
	// フォーカス移動
	switch ( nChar ) {
	case VK_RETURN:
...
//********************************************************************************
//	「その他1」データコントロール処理（EditON，EditOFF，Terminationイベント）
//********************************************************************************

// 「その他1」データコントロールのゲットフォーカス
void	CfrmUc171Sonota1I::EditONYoushikidiag1( short index )
{
	DIAGRAM_DATA	diadata;
	...
	switch(m_uInfo.intCurCol) {
		...
		case ID_COL_171I_INVONOT:	// 登録番号(T選択)
			// コンボボックスのオフセット値取得
			m_pDiag->GetData(m_uInfo.intCurCtlIndex, (LPUNKNOWN)&diadata);
			m_uInfo.OldCombo = diadata.data_combo;
			break;
	...
	if ( ( m_uInfo.OldRow > 0 ) ) {
		if ( m_uInfo.OldPage == m_uInfo.intCurPage && m_uInfo.OldPage > 0 ) {
			...
			BOOL adadd1_to_adadd2 = IsSaveMoveReference(ID_COL_171I_ADADD1, ID_COL_171I_ADADD2);
			// [Home]キー押下の住所検索ダイアログの戻り（フォーカスをセットしている）は保存しない（改良依頼No15-1613）
			BOOL adadd1_to_adadd1 = IsSaveMoveReference(ID_COL_171I_ADADD1, ID_COL_171I_ADADD1);	// 所在地1(住所)→所在地1(住所)
			BOOL adadd2_to_adadd2 = IsSaveMoveReference(ID_COL_171I_ADADD2, ID_COL_171I_ADADD2);	// 所在地2(住所)→所在地2(住所)　所在地2から住所が長すぎる場合、ここがFALSEになる
			// T選択⇔登録番号は保存しない
			BOOL tsel_to_invno = IsSaveMoveReference(ID_COL_171I_INVONOT, ID_COL_171I_INVONO);
	...
	if(m_uInfo.intCurCol == ID_COL_171I_INVONO && m_EndSyorityu == 0)	{
// 修正No.168377 del -->
...
// 修正No.168377 add -->
		// 登録番号のT選択の値を取得
		int pos = CmnGetControlIndex(m_uInfo.intCurRow, ID_COL_171I_INVONOT);
...
// データコントロールのロストフォーカス
void	CfrmUc171Sonota1I::EditOFFYoushikidiag1( short index )
{
	if( m_EndView != FALSE )	return;

// 修正No.168443 add -->
	// ---- 登録番号一覧関連 ----->
	if(m_uInfo.intCurCol != ID_COL_171I_INVONO) {
		if(pZmSel && pZmSel->IsDisplay() != FALSE) {
			pZmSel->DialogOFF();
		}
	}
...
// 修正No.168443 del -->
	...
	//		//// カーソル移動処理
	//		//CmnDiagSetFocus( m_pDiag, m_uInfo.intCurRow, ID_COL_171I_INVONO );
	//	}
	//}

	//// ---- 登録番号一覧関連 ----->
	//if(pZmSel && m_uInfo.intCurCol != ID_COL_171I_INVONO) {
...
//	入力確定
void CfrmUc171Sonota1I::virInputDecisionEditOFF()
{
	// フォーカスフラグOFF
...
// 預貯金データコントロールのキーイベント
void	CfrmUc171Sonota1I::TerminationYoushikidiag1( short index, short nChar, short length, LPUNKNOWN data )
{
	//--------------------------------------------------------------------------------
	//	キー操作仕様
...
void CfrmUc171Sonota1I::VScrollYoushikidiag1(short mode)
{
// 修正No.168430 del -->
...
//********************************************************************************
int	CfrmUc171Sonota1I::GetFocusPosition( int nChar )
{
	int		intRow;					// カレント行番号
	int		intCol;					// カレント列番号
	...
	else if ( intCol == ID_COL_171I_ADNAME1 ){
		// カレント列が「名称(氏名)」の場合
	...
	case VK_RETURN:	// Enterキーでカーソルを下に移動するモード対応
		if(m_ReturnMoveDown) {
			if(intCol == ID_COL_171I_INVONOT)	intNext = intVector[1];			//	カレント列が「登録番号(T表示)」欄の場合「→」キーと同じ
	...
	case VK_TAB:
		if (CmnCheckShiftKey() == FALSE) {
			...
			// それ以外は「←」キーと同じ
			if ((intRow <= 1) && (intCol == ID_COL_171I_KNORDER)) {
				return -1;
			}
...
//********************************************************************************
int	CfrmUc171Sonota1I::GetTotalRowIndex( int nCharOrg, int intIndex, int intNext )
{
	...
	//	現在、頁計に居る
		...
		switch ( nCharTemp ){
			case VK_UP:			// ↑：23行目のデータ行の支店名項目へ移動
				nRet = CmnGetControlIndex( nBorder[0], ID_COL_171I_ADNAME1 );
				break;
			case VK_LEFT:		// ←/Shift+Tab：23行目のデータ行の摘要項目へ移動
				nRet = CmnGetControlIndex( nBorder[0], ID_COL_171I_TEKI );
				break;
			default:			// →/↓/Return/Tab：25行目の合計行②へ移動
				...
				//	累計あり
					...
					nRet = CmnGetControlIndex( ( nBorder[2] + 1 ), ID_COL_171I_KNORDER );
				}
				break;
		}
	}
	//	現在、累計に居る場合
		...
		switch ( nCharTemp ){
			...
			case VK_LEFT:		// ←/Shift+Tab：24行目の合計行① or 24行目のデータ行の摘要項目へ移動
				nRet = CmnGetControlIndex( ( nBorder[1] + 1 ), ID_COL_171I_KNORDER );
				break;
			default:			// →/↓：移動できない
				// 例外処理：最終項目で"Tab"は別コントロールへ移動
				// それ以外は「→」キーと同じ
...
//		RET		なし
//********************************************************************************
void	CfrmUc171Sonota1I::virTblEditIkkatuLine( int nType, CdbUc000Common* rsData,
									CString strName, CALCKEI_INFO uCalcKei, SORTKAMOKU_INFO uKamoku )
{
	CdbUc171Sonota1*	mfcRec = (CdbUc171Sonota1*)rsData;

	switch (nType) {
		case	0:
			// ソートの一括集計処理 ･･･ 科目の無い帳表はいらない
			mfcRec->m_AdName1 = strName;				// 名称：名称１
...
//********************************************************************************
int	CfrmUc171Sonota1I::virTblSortSubSortProc( CdlgSort* pCdlgSort, CdbUc000Common* rsData )
{
	CdbUc171Sonota1*	rs;
	CString				strFilter;
	CString				strSort;
...
/**********************************************************************
	RecBufSetData(CdbUc171Sonota1* prmDbRec)
		ローカルのレコードバッファに、1行分のデータを格納する

	引数
		CdbUc171Sonota1*	prmDbRec	レコードセット(データがあること）
	戻値
		int		成功/失敗
				FUNCTION_OK
***********************************************************************/
int	CfrmUc171Sonota1I::RecBufSetData( CdbUc171Sonota1* prmDbRec )
{
	...
	m_ReadData[trgRow].m_FormSeq = prmDbRec->m_FormSeq;		// 様式シーケンス番号
	...
	m_ReadData[trgRow].m_AdSeq = prmDbRec->m_AdSeq;			// 相手先：取引先（シーケンス番号）
	m_ReadData[trgRow].m_AdOrder = prmDbRec->m_AdOrder;		// 相手先：取引先（並び順）
...
/**********************************************************************
	...
	戻値
		int		成功/失敗
				FUNCTION_OK
***********************************************************************/
int	CfrmUc171Sonota1I::RecBufClearAllData()
{
...
/**********************************************************************
	...
	引数
		P_REC_UC_171_SONOTA1 inRecData レコードへのポインタ
	戻値
		int		成功/失敗
				FUNCTION_OK
***********************************************************************/
int	CfrmUc171Sonota1I::RecBufClearData( P_REC_UC_171_SONOTA1 inRecData )
{
	...
	inRecData->m_FormSeq = 0;		// 様式シーケンス番号
	inRecData->m_KnSeq = 0;			// 科目（シーケンス番号）
	inRecData->m_KnOrder = 0;		// 科目（並び順）
	inRecData->m_KnName = _T("");	// 科目（名称）
	inRecData->m_AdSeq = 0;			// 相手先：取引先（シーケンス番号）
	inRecData->m_AdOrder = 0;		// 相手先：取引先（並び順）
...
/**********************************************************************
	...
	戻値
		int				成功(更新あり)/成功(更新なし)/失敗
						...
						FUNCTION_NG		: 失敗
***********************************************************************/
int	CfrmUc171Sonota1I::virRecBufSaveData( int inPage, int inRow )
{
	REC_UC_171_SONOTA1	tmpSaveData;	// 画面データ1レコード格納用
	...
	// 科目
	intIndex = CmnGetControlIndex( inRow, ID_COL_171I_KNORDER );
	...
	// 登録番号（T選択）
	intIndex = CmnGetControlIndex(inRow, ID_COL_171I_INVONOT);
	m_pDiag->GetData(intIndex, (LPUNKNOWN)&diadata);
	tsel = diadata.data_combo;

	// 登録番号（法人番号）
	intIndex = CmnGetControlIndex(inRow, ID_COL_171I_INVONO);
	...
	intIndex = CmnGetControlIndex( inRow, ID_COL_171I_ADNAME1 );
	...
	if ( tmpSaveData.m_AdName2.IsEmpty() ){
		if(m_uInfo.intCurCol == ID_COL_162_ADNAME1 && m_uInfo.intCurRow != m_uInfo.OldRow){	// 各カラムごとにvirRecBufSaveData()がコールされるようになり、かつタイミングがEditOffからEditOnに移ったことによりCmnDiagSetString()でカレットが末尾から先頭に移ってしまう為、制御
			CmnDiagSetString( m_pDiag, intIndex, tmpSaveData.m_AdName1, 0 );
		}
	}

	// 所在地(住所)上段
	intIndex = CmnGetControlIndex( inRow, ID_COL_171I_ADADD1 );
	tmpSaveData.m_AdAdd1 = m_clsFunc.DiagGetString( m_pDiag, intIndex );

	// 所在地(住所)下段
	intIndex = CmnGetControlIndex( inRow, ID_COL_171I_ADADD2 );
	tmpSaveData.m_AdAdd2 = m_clsFunc.DiagGetString( m_pDiag, intIndex );

	// 期末現在高
	intIndex = CmnGetControlIndex( inRow, ID_COL_171I_VAL );
	tmpSaveData.m_Val = CmnDiagGetKingaku( m_pDiag, intIndex );

	// 摘要
	intIndex = CmnGetControlIndex( inRow, ID_COL_171I_TEKI );
...
***********************************************************************/
int	CfrmUc171Sonota1I::virRecBufSaveDataForPasteInsert( int inPage, int inRow )
{
...
***********************************************************************/
int	CfrmUc171Sonota1I::virRecBufSaveDataForPaste( int inPage, int inRow )
{
	///////////////////////////////////////////////////////////////
	// 登録処理呼び出し
	return RecBufSaveDataSub( inPage, inRow, &m_CopyData );
...
/**********************************************************************
	...
	戻値
			int					成功(更新あり)/成功(更新なし)/失敗
								...
								FUNCTION_NG		: 失敗
***********************************************************************/
int	CfrmUc171Sonota1I::RecBufSaveDataSub( 
							int inPage,
							int inRow,
							P_REC_UC_171_SONOTA1 inSaveData )
{
	REC_UC_171_SONOTA1	udTemp;			//	画面上のデータ格納用
	CString				cst;
	...
	// テーブルアクセスクラス
	CdbUc171Sonota1	mfcRec( m_pDB, m_uInfo.intFormSeq );
...
//********************************************************************************
//	「その他1」テーブルのオブジェクトを生成し、ポインタを返す
//********************************************************************************
CdbUc000Common*	CfrmUc171Sonota1I::virGetDataTableObject()
{
	// 「その他1」テーブルのオブジェクトを生成し、ポインタを返す
	return (CdbUc000Common*)( new CdbUc171Sonota1( m_pDB, m_uInfo.intFormSeq ) );
}
...
//	RET	なし
//********************************************************************************
void	CfrmUc171Sonota1I::virRowButtonCopyProc()
{
...
//	RET	なし
//********************************************************************************
void	CfrmUc171Sonota1I::virTblGetKamokuInfo( CdbUc000Common* rsData, SORTKAMOKU_INFO* uKamoku )
{
	CdbUc171Sonota1*	rs = (CdbUc171Sonota1*)rsData;
...
//	RET	なし
//********************************************************************************
void	CfrmUc171Sonota1I::virGetCurrentInfo( CURRENT_INFO* uCurInfo )
{
...
//	【戻値】	なし
//**************************************************
void CfrmUc171Sonota1I::SetInputMode( int nRow, long nMode )
{
	m_pDiag->ModifyItem( CmnGetControlIndex( nRow, ID_COL_171I_KNORDER ), nMode );	//	科目
	m_pDiag->ModifyItem( CmnGetControlIndex( nRow, ID_COL_171I_INVONOT ), nMode );	//	登録番号（T選択）
	m_pDiag->ModifyItem( CmnGetControlIndex( nRow, ID_COL_171I_INVONO ), nMode );	//	登録番号
	m_pDiag->ModifyItem( CmnGetControlIndex( nRow, ID_COL_171I_ADNAME1 ), nMode );	//	名称（氏名）
	m_pDiag->ModifyItem( CmnGetControlIndex( nRow, ID_COL_171I_ADADD1 ), nMode );	//	所在地（上段）
	m_pDiag->ModifyItem( CmnGetControlIndex( nRow, ID_COL_171I_ADADD2 ), nMode );	//	所在地（下段）
	m_pDiag->ModifyItem( CmnGetControlIndex( nRow, ID_COL_171I_VAL ), nMode );		//	期末現在高
	m_pDiag->ModifyItem( CmnGetControlIndex( nRow, ID_COL_171I_TEKI ), nMode );		//	摘要
}
...
//	【戻値】	なし
//**************************************************
void CfrmUc171Sonota1I::SetDiagBackColor()
{
...
//		RET		なし					
//********************************************************************************
void CfrmUc171Sonota1I::virRendoCreateData(CdbUc000Common* rsData, RENTEMP_INFO* uRenInfo)
{
	CString			strTemp;
	...
	if(sw != 0)	{
		m_clsFunc.StrDivisionEx( uRenInfo->strAdName , &strArry , ( MAX_KETA_171_ADNAME1 / 2 ) , 2 );
...
//		RET		なし					
//********************************************************************************
void CfrmUc171Sonota1I::virRendoUpdateData(CdbUc000Common* rsData, RENTEMP_INFO* uRenInfo)
{
	CdbUc171Sonota1*	rs = (CdbUc171Sonota1*)rsData;
...
//***************************************************************************
BOOL CfrmUc171Sonota1I::virEndProc(void)
{
	TRACE(_T("***** CfrmUc171Sonota1I::virEndProc\n"));
...
void CfrmUc171Sonota1I::ComboNew(short index)
{
	short			sv_sel=0;
...
int CfrmUc171Sonota1I::CursorControl(short nChar, int sw)
{
	int				rv=0;
	int				intCol=0;
	int				pos=0;
	...
	if((nChar == VK_TAB && (key & 0x80) == 0x80) || (nChar == VK_LEFT) || (nChar == VK_RIGHT)) {
		...
		if(intCol == ID_COL_171I_INVONOT)	{	// 登録番号(T選択)
			m_pDiag->ComboDropDown(m_uInfo.intCurCtlIndex, FALSE);
			CmnDiagSetCombo(m_pDiag, m_uInfo.intCurCtlIndex, m_uInfo.OldCombo);
		}
	}
...
void CfrmUc171Sonota1I::ComboSelYoushikidiag1(short index, LPUNKNOWN data)
{
...
LRESULT CfrmUc171Sonota1I::OnUserReDrawView(WPARAM wParam, LPARAM lParam)
{
	virUpdateControlTblData();
	CmnDiagSetFocus(m_pDiag, 1, 1);
...
//		RET		なし
// --------------------------------------------------------------------------------------------------------
void CfrmUc171Sonota1I::virDiagGetHjnData(CDatabase* pDB, HJN_REC_NEW* phjnRec)
{
	int				nPage,nRow;
	int				intIndex;	// 対象行の各インデックス
	int				tsel=0;
	...
	// 登録番号（法人番号）
	cst.Empty();
	intIndex = CmnGetControlIndex(nRow, ID_COL_171I_INVONO);
	...
	// 名称1(氏名)
	intIndex = CmnGetControlIndex(nRow, ID_COL_171I_ADNAME1);
	...
	// 所在地1(住所)
	intIndex = CmnGetControlIndex(nRow, ID_COL_171I_ADADD1);
	cst = m_clsFunc.DiagGetString(m_pDiag, intIndex);
	cst.TrimRight();
	if(cst.IsEmpty() == FALSE)	{
		memset(buf, 0, sizeof(buf));
	...
	// 所在地2(住所)
	intIndex = CmnGetControlIndex(nRow, ID_COL_171I_ADADD2);
	cst = m_clsFunc.DiagGetString(m_pDiag, intIndex);
	cst.TrimRight();
	if(cst.IsEmpty() == FALSE) {
		memset(buf, 0, sizeof(buf));
...
//		RET		なし
// --------------------------------------------------------------------------------------------------------
void	CfrmUc171Sonota1I::virDiagSetHjnData(int pSw, CString rtInvNo, CString rtName, CString rtAdrs1, CString rtAdrs2, CString rtKana)
{
	int					ret = 0;
	int					intIndex;
...
// 修正No.168361,168369,168371,168378 del <--
		// 登録番号（T選択）
		intIndex = CmnGetControlIndex(m_uInfo.intCurRow, ID_COL_171I_INVONOT);
		CmnDiagSetCombo3(m_pDiag, intIndex, strInvoNo);

		// 登録番号
		InvoNoSplit(strInvoNo, &cs1, &cs2);
		intIndex = CmnGetControlIndex(m_uInfo.intCurRow, ID_COL_171I_INVONO);
...
// --------------------------------------------------------------------------------------------------------
// --------------------------------------------------------------------------------------------------------
int CfrmUc171Sonota1I::virCallChkInvoiceNum(int pSw, int inPage, int inRow)
{
...
//				CString		pInvno	登録番号
// --------------------------------------------------------------------------------------------------------
int CfrmUc171Sonota1I::ChkInvoiceNum(CDatabase* pDB, int pSw, int inPage, int inRow,
...
// 修正No.168361,168369,168371,168378 del -->
	...
	//		DIAGRAM_DATA	ddata;
	//		ddata.data_combo = 0;
	//		m_pDiag->SetData(CmnGetControlIndex(inRow, ID_COL_171I_INVONOT), (LPUNKNOWN)&ddata);
	//		ddata.data_edit.Empty();
	//		m_pDiag->DataClear(CmnGetControlIndex(inRow, ID_COL_171I_INVONO), TRUE);
	//		// エラーメッセージを表示
...
// 修正No.168443 add <--
			...
			if(pZmSel && pZmSel->IsDisplay() != FALSE && cst.GetLength() < 3) {
				...
				if(tmpzd.errflg != -1) {
					...
					m_pDiag->SetData(CmnGetControlIndex(inRow, ID_COL_171I_INVONO), (LPUNKNOWN)&ddata);
					// 再描画
					m_pDiag->Refresh();
...
// 修正No.168425,168443 add -->
					if(pSw == 3 || m_EndSyorityu == 1)	{
						...
						m_uInfo.intCurCol = ID_COL_171I_INVONO;
