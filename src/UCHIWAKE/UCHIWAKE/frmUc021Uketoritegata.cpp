...
IMPLEMENT_DYNCREATE( CfrmUc021Uketoritegata, CfrmUc000Common )


BEGIN_MESSAGE_MAP( CfrmUc021Uketoritegata, CfrmUc000Common )
	ON_WM_SIZE()
...
//	ON_COMMAND( ID_BUTTON_F3, OnButtonF3 )
	...
	ON_COMMAND( ID_PRINTSETUP_MENU, &CfrmUc021Uketoritegata::OnMenuPrintSetup )
	ON_COMMAND( ID_PRINTALL_MENU, &CfrmUc021Uketoritegata::OnMenuPrintAll )
//	ON_COMMAND( ID_OUTPUTFORM_MENU, &CfrmUc021Uketoritegata::OnMenuFormTypeSetup )
	ON_COMMAND( ID_SPECIALROW_MENU, &CfrmUc021Uketoritegata::OnMenuSpecialRow )
	ON_COMMAND( ID_SORT_MENU, &CfrmUc021Uketoritegata::OnMenuSort )
	ON_COMMAND(ID_IKKATUADD_MENU, &CfrmUc021Uketoritegata::OnIkkatuAddMenu)
	ON_COMMAND( ID_DISPDIALOG_MENU, &CfrmUc021Uketoritegata::OnMenuIkkatuKingaku )
	ON_COMMAND( ID_ZEROMONEY_MENU, &CfrmUc021Uketoritegata::OnMenuZeroMoney )
	ON_COMMAND( ID_ZEROMONEYMOVE_MENU, &CfrmUc021Uketoritegata::OnMenuZeroMoneyMove )
	ON_COMMAND( ID_AMOUTDIALOG_MENU, &CfrmUc021Uketoritegata::OnMenuOutKeiSetup )
// midori 160606 add -->
	ON_COMMAND( ID_CLEAR_MENU, &CfrmUc021Uketoritegata::OnMenuClear )
// midori 160606 add <--
	ON_COMMAND( ID_RENDO_MENU, &CfrmUc021Uketoritegata::OnMenuZaimuRendo )
	ON_COMMAND( ID_TITLEMENU, &CfrmUc021Uketoritegata::OnMenuTitleRestore )
	ON_COMMAND( ID_USER_SETTING_MENU, &CfrmUc021Uketoritegata::OnMenuOptionSetting )
	ON_COMMAND( ID_COPY_SETTING_INFO_MENU, &CfrmUc021Uketoritegata::OnMenuCopySettingInfo )
	ON_COMMAND( ID_DELETE_DATA_MENU, &CfrmUc021Uketoritegata::OnMenuDeleteDataEachYoushiki )
	ON_BN_CLICKED( IDC_PAGEBACK_BUTTON1, &CfrmUc021Uketoritegata::OnPageBack )
	ON_BN_CLICKED( IDC_PAGENEXT_BUTTON1, &CfrmUc021Uketoritegata::OnPageNext )
	ON_BN_CLICKED( IDC_PAGENEW_BUTTON1, &CfrmUc021Uketoritegata::OnPageNew )
	ON_BN_CLICKED( IDC_PAGEINSERT_BUTTON1, &CfrmUc021Uketoritegata::OnPageInsert )
	ON_BN_CLICKED( IDC_ROWCOPY_BUTTON1, &CfrmUc021Uketoritegata::OnRowCopy )
	ON_BN_CLICKED( IDC_ROWPASTE_BUTTON1, &CfrmUc021Uketoritegata::OnRowPaste )
	ON_BN_CLICKED( IDC_ROWINSERT_BUTTON1, &CfrmUc021Uketoritegata::OnRowInsert )
	ON_BN_CLICKED( IDC_YOUSHIKINEXT_BUTTON1, &CfrmUc021Uketoritegata::OnMoveYoushikiNext )
	ON_BN_CLICKED( IDC_YOUSHIKIBACK_BUTTON1, &CfrmUc021Uketoritegata::OnMoveYoushikiBack )
//	ON_UPDATE_COMMAND_UI( ID_BUTTON_F1, &CfrmUc021Uketoritegata::OnUpdateButtonF1 )
//	ON_UPDATE_COMMAND_UI( ID_BUTTON_F3, &CfrmUc021Uketoritegata::OnUpdateButtonF3 )
	ON_UPDATE_COMMAND_UI( ID_BUTTON_F6, &CfrmUc021Uketoritegata::OnUpdateButtonF6 )
	ON_UPDATE_COMMAND_UI( ID_BUTTON_F7, &CfrmUc021Uketoritegata::OnUpdateButtonF7 )
	ON_UPDATE_COMMAND_UI( ID_BUTTON_F8, &CfrmUc021Uketoritegata::OnUpdateButtonF8 )
	ON_UPDATE_COMMAND_UI( ID_BUTTON_F9, &CfrmUc021Uketoritegata::OnUpdateButtonF9 )
	ON_UPDATE_COMMAND_UI( ID_BUTTON_F11, &CfrmUc021Uketoritegata::OnUpdateButtonF11 )
	ON_UPDATE_COMMAND_UI( ID_BUTTON_F12, &CfrmUc021Uketoritegata::OnUpdateButtonF12 )
	ON_UPDATE_COMMAND_UI( ID_BUTTON_HOME, &CfrmUc021Uketoritegata::OnUpdateButtonHome )
	ON_UPDATE_COMMAND_UI(ID_IKKATUADD_MENU, &CfrmUc000Common::OnUpdateIkkatuaddMenu)
	ON_UPDATE_COMMAND_UI( ID_DISPDIALOG_MENU, &CfrmUc021Uketoritegata::OnUpdateMenuIkkatuKingaku )
// midori 160612 add -->
	ON_UPDATE_COMMAND_UI( ID_SORT_MENU, &CfrmUc021Uketoritegata::OnUpdateMenuSort )
	ON_UPDATE_COMMAND_UI( ID_CLEAR_MENU, &CfrmUc021Uketoritegata::OnUpdateMenuClear )
// midori 160612 add <--
	ON_UPDATE_COMMAND_UI( ID_ZEROMONEY_MENU, &CfrmUc021Uketoritegata::OnUpdateMenuZeroMoney )
// midori 160612 add -->
	ON_UPDATE_COMMAND_UI( ID_ZEROMONEYMOVE_MENU, &CfrmUc021Uketoritegata::OnUpdateMenuZeroMoneyMove)
// midori 160612 add <--
	ON_UPDATE_COMMAND_UI( ID_RENDO_MENU, &CfrmUc021Uketoritegata::OnUpdateMenuZaimuRendo )
	ON_UPDATE_COMMAND_UI(ID_SPECIALROW_MENU, &CfrmUc021Uketoritegata::OnUpdateMenuSpecialRow)
// midori 160612 add -->
	ON_UPDATE_COMMAND_UI( ID_TITLEMENU, &CfrmUc021Uketoritegata::OnUpdateMenuTitleRestore )
	ON_UPDATE_COMMAND_UI( ID_DELETE_DATA_MENU, &CfrmUc021Uketoritegata::OnUpdateMenuDeleteDataEachYoushiki )
// midori 160612 add <--
	ON_MESSAGE(WM_USER_REDRAWVIEW, OnUserReDrawView)		// 修正No.162446 add
END_MESSAGE_MAP()

CfrmUc021Uketoritegata::CfrmUc021Uketoritegata()
	: CfrmUc000Common( CfrmUc021Uketoritegata::IDD )
{
...
CfrmUc021Uketoritegata::~CfrmUc021Uketoritegata()
{
	...
	TRACE(_T("***** CfrmUc021Uketoritegata::~CfrmUc021Uketoritegata\n"));

	//m_pDiag = NULL;
	//m_pTitleDiag = NULL;
}

void CfrmUc021Uketoritegata::DoDataExchange( CDataExchange* pDX )
{
...
void CfrmUc021Uketoritegata::OnInitialUpdate()
{
...
#ifdef _DEBUG
void CfrmUc021Uketoritegata::AssertValid() const
{
	CfrmUc000Common::AssertValid();
}

#ifndef _WIN32_WCE
void CfrmUc021Uketoritegata::Dump( CDumpContext& dc ) const
{
...
BEGIN_EVENTSINK_MAP( CfrmUc021Uketoritegata, CfrmUc000Common )
	ON_EVENT( CfrmUc021Uketoritegata, IDC_YOUSHIKIDIAG1, 3, CfrmUc021Uketoritegata::TerminationYoushikidiag1, VTS_I2 VTS_I2 VTS_I2 VTS_UNKNOWN )
	ON_EVENT( CfrmUc021Uketoritegata, IDC_YOUSHIKIDIAG1, 2, CfrmUc021Uketoritegata::EditOFFYoushikidiag1, VTS_I2 )
	ON_EVENT( CfrmUc021Uketoritegata, IDC_YOUSHIKIDIAG1, 1, CfrmUc021Uketoritegata::EditONYoushikidiag1, VTS_I2 )
// midori 151405 add -->
	ON_EVENT(CfrmUc021Uketoritegata, IDC_YOUSHIKIDIAG1, 12, CfrmUc021Uketoritegata::VScrollYoushikidiag1, VTS_I2)
// midori 151405 add <--
// midori 152134 add -->
	ON_EVENT(CfrmUc021Uketoritegata, IDC_YOUSHIKIDIAG1, 8, CfrmUc021Uketoritegata::ComboSelYoushikidiag1, VTS_I2 VTS_UNKNOWN)
// midori 152134 add <--

	ON_EVENT( CfrmUc021Uketoritegata, IDC_YOUSHIKIDIAG2, 3, CfrmUc021Uketoritegata::TerminationYoushikidiag1, VTS_I2 VTS_I2 VTS_I2 VTS_UNKNOWN )
	ON_EVENT( CfrmUc021Uketoritegata, IDC_YOUSHIKIDIAG2, 2, CfrmUc021Uketoritegata::EditOFFYoushikidiag1, VTS_I2 )
	ON_EVENT( CfrmUc021Uketoritegata, IDC_YOUSHIKIDIAG2, 1, CfrmUc021Uketoritegata::EditONYoushikidiag1, VTS_I2 )
// midori 151405 add -->
	ON_EVENT(CfrmUc021Uketoritegata, IDC_YOUSHIKIDIAG2, 12, CfrmUc021Uketoritegata::VScrollYoushikidiag1, VTS_I2)
// midori 151405 add <--
// midori 152134 add -->
	ON_EVENT(CfrmUc021Uketoritegata, IDC_YOUSHIKIDIAG2, 8, CfrmUc021Uketoritegata::ComboSelYoushikidiag1, VTS_I2 VTS_UNKNOWN)
// midori 152134 add <--

	ON_EVENT( CfrmUc021Uketoritegata, IDC_TITLEDIAG1, 3, CfrmUc021Uketoritegata::TerminationTitlediag1, VTS_I2 VTS_I2 VTS_I2 VTS_UNKNOWN )
	ON_EVENT( CfrmUc021Uketoritegata, IDC_TITLEDIAG1, 2, CfrmUc021Uketoritegata::EditOFFTitlediag1, VTS_I2 )
	ON_EVENT( CfrmUc021Uketoritegata, IDC_TITLEDIAG1, 1, CfrmUc021Uketoritegata::EditONTitlediag1, VTS_I2 )
	ON_EVENT( CfrmUc021Uketoritegata, IDC_TITLEDIAG1, 6, CfrmUc021Uketoritegata::FocusTitlediag1, VTS_NONE )

	ON_EVENT( CfrmUc021Uketoritegata, IDC_PAGEDIAG1, 3, CfrmUc021Uketoritegata::TerminationPagediag1, VTS_I2 VTS_I2 VTS_I2 VTS_UNKNOWN )
	ON_EVENT( CfrmUc021Uketoritegata, IDC_PAGEDIAG1, 2, CfrmUc021Uketoritegata::EditOFFPagediag1, VTS_I2 )
	ON_EVENT( CfrmUc021Uketoritegata, IDC_PAGEDIAG1, 1, CfrmUc021Uketoritegata::EditONPagediag1, VTS_I2 )
	ON_EVENT( CfrmUc021Uketoritegata, IDC_PAGEDIAG1, 6, CfrmUc021Uketoritegata::FocusPagediag1, VTS_NONE )
END_EVENTSINK_MAP()

//********************************************************************************
//	初期処理
//********************************************************************************
BOOL	CfrmUc021Uketoritegata::virStartJob()
{
	// 初期値設定
...
//	共通データの初期値設定
//********************************************************************************
void	CfrmUc021Uketoritegata::virSetInitialUchiwakeInfo()
{
	// 「受取手形」の固有データ
	...
	m_uInfo.intColMax = ID_COLMAX_021;				// １行内のコントロール個数
	m_uInfo.intColMaxData = ID_COLMAXDATA_021;		// １行内の列数
	m_uInfo.intCtlStartIndex = ID_CTLSTARTINDEX_021;// １行目の入力項目の先頭インデックス番号
	m_uInfo.intT1StartIndex = ID_T1STARTNORMAL_021;	// 合計行①の先頭インデックス番号
	m_uInfo.intT2StartIndex = ID_T2STARTNORMAL_021;	// 合計行②の入力項目の先頭インデックス番号
	...
	m_uInfo.intT1StartNormal = ID_T1STARTNORMAL_021;	// 通常時：合計行①の先頭インデックス
	m_uInfo.intT2StartNormal = ID_T2STARTNORMAL_021;	// 通常時：合計行②の先頭インデックス
	m_uInfo.intT1StartKobetu = ID_T1STARTKOBETU_021;	// 個別時：合計行①の先頭インデックス
	m_uInfo.intT2StartKobetu = ID_T2STARTKOBETU_021;	// 個別時：合計行②の先頭インデックス
	m_uInfo.intRowKei = ID_ROWKEI_021;				// 帳表固定の合計行数（1:合xxx1計あり，0:なし）
	m_uInfo.intKei1StartIndex = ID_COL_021_KEI1_MEISYO;	// 計ダイアグラム1行目の先頭インデックス
	m_uInfo.intKei2StartIndex = ID_COL_021_KEI2_MEISYO;	// 計ダイアグラム2行目の先頭インデックス
...
// 【戻値】    なし
//**************************************************
void	CfrmUc021Uketoritegata::virSetInitialDiag()
{
	int		nIndex;
...
//	帳表固有変数の初期値設定
//********************************************************************************
void	CfrmUc021Uketoritegata::virSetInitialValue()
{
	// 1ページ分のローカルバッファをクリア
	RecBufClearAllData();
...
//	帳表コントロールの初期化（データ領域）
//********************************************************************************
BOOL	CfrmUc021Uketoritegata::InitialControlDataArea()
{
	int		intMax;
	int		i;
...
//********************************************************************************
BOOL	CfrmUc021Uketoritegata::InitialControlComboBox()
{
	// コンボボックスを初期化する関数です。
...
//********************************************************************************
void	CfrmUc021Uketoritegata::InitialControlTotalArea()
{
	int		nKeiType;			//	計の種別
	int		nDataRow;			//	データ行属性
...
// midori 152166 add <--
	...
	m_pDiagKei->ModifyItem(ID_COL_021_KEI1_VAL, intKeiRow);
	m_pDiagKei->ModifyItem(ID_COL_021_KEI2_VAL, intKeiRow);
	...
	// 合計行の金額欄は、金額欄 + 1桁
	CmnDiagSetAttrDigit( m_pDiagKei, ID_COL_021_KEI1_VAL, ID_VAL_021_TOTAL );
	CmnDiagSetAttrDigit( m_pDiagKei, ID_COL_021_KEI2_VAL, ID_VAL_021_TOTAL );
}
...
//	RET	なし
//********************************************************************************
void	CfrmUc021Uketoritegata::InitialControlSpecialRow( int intRow, int intFgFunc )
{
	DIAGRAM_DATA	diadata;	// ICSDIAG構造体
...
//	帳表タイトル情報の表示
//********************************************************************************
void	CfrmUc021Uketoritegata::virUpdateControlTitle()
{
//	int		intMax;
...
//	帳表ページ情報の表示
//********************************************************************************
void	CfrmUc021Uketoritegata::UpdateControlPage()
{
	BOOL	bBack = TRUE;
	BOOL	bNext = TRUE;
...
//	帳表データの表示（１ページ分）
//********************************************************************************
BOOL	CfrmUc021Uketoritegata::virUpdateControlTblData()
{
	// ダイアログ切替
	if( m_pDiag != NULL ){
		virSetInitialDiag();
...
//	保管件数の表示
//********************************************************************************
BOOL CfrmUc021Uketoritegata::virUpdateControlTblData2()
{
	int					hcnt=0;
	CString				cs=_T("");
...
//		RET		なし
//********************************************************************************
void	CfrmUc021Uketoritegata::UpdateControlRowData( CdbUc021Uketoritegata* prmDbRec ) {
	DIAGRAM_DATA	diadata;	// ICSDiag構造体
	int				intCell;	// 保存フィールド
// midori 150917 add -->
	CStringArray	csa;
...
//		RET		なし
//********************************************************************************
void	CfrmUc021Uketoritegata::UpdateControlRowTotal( CdbUc021Uketoritegata* prmDbRec )
{
	int		intTotalType;
	...
	if ( intRowName > 0 ) {
		...
		CmnDiagSetString( m_pDiagKei, CmnGetKeiDiagIndex( intRowName, ID_COL_021_KEI1_MEISYO ), prmDbRec->m_KeiStr, 1 );
	}
	// 頁計/累計の金額表示
	if ( intRowVal > 0 ) {
		//CmnDiagSetKingaku( m_pDiag, CmnGetControlTotalIndex( intRowName, ID_COL_021_VAL ), prmDbRec->m_Val );
		CmnDiagSetKingaku( m_pDiagKei, CmnGetKeiDiagIndex( intRowVal, ID_COL_021_KEI1_VAL ), prmDbRec->m_Val );
	}
}
...
//		RET		なし
//********************************************************************************
void	CfrmUc021Uketoritegata::virFncCellCopyProc( CdbUc000Common* rsData )
{
...
//********************************************************************************
int	CfrmUc021Uketoritegata::virFncReferenceGetType(int intCol, int* intGrSeq, long* lngItemSeq, int* intAdd1, int* intAdd2, int* intAdd1Col, int* intAdd2Col, REFERENCE_INFO* pudReference)
{
	int		intRefType;
...
//		RET		なし
//********************************************************************************
void	CfrmUc021Uketoritegata::virFncReferenceSetData( CdlgReference* dlgRef, int intRefType, int intCol )
{
	switch ( intRefType ) {
...
//		RET		なし
//********************************************************************************
void	CfrmUc021Uketoritegata::virFncReferenceUpdateTbl( int intRefType, int nRefMode/*=0*/ )
{
...
void CfrmUc021Uketoritegata::virActivateFrameK(UINT nState, CFrameWnd* pDeactivateFrame)
{
	int		index = 0;
...
void CfrmUc021Uketoritegata::virKamokuAddCancel()
{
...
//	その他イベント処理
//********************************************************************************
BOOL	CfrmUc021Uketoritegata::PreTranslateMessage( MSG* pMsg )
{
//	int				intID;
...
// 修正No.158259 add -->
				...
				intCol = CmnGetControlCol();
				if(intCol == ID_COL_021_KAMOKU && (pMsg->wParam == VK_LEFT || pMsg->wParam == VK_RIGHT))	{
...
// 頁コントロールのフォーカス設定
void	CfrmUc021Uketoritegata::FocusPagediag1()
{
...
// 頁コントロールのゲットフォーカス
void	CfrmUc021Uketoritegata::EditONPagediag1( short index )
{
// midori 151405 add -->
	// スクロールフラグをクリアする
	nG_MScroll = 0;
...
// 頁コントロールのロストフォーカス
void	CfrmUc021Uketoritegata::EditOFFPagediag1( short index )
{
// midori 155028 add -->
...
// 頁コントロールのキー操作
void	CfrmUc021Uketoritegata::TerminationPagediag1( short index, short nChar, short length, LPUNKNOWN data )
{
	int nMaxDataCol = 0;
	// カレント頁の合計行の種別を取得
...
// タイトルコントロールのフォーカス設定
void	CfrmUc021Uketoritegata::FocusTitlediag1()
{
//マウスクリックでキャレットが表示できないためコメントとする
//	// ボタンからTabキー移動した場合に必要
//	m_TitleDiag.SetPosition( 0 );
...
// タイトルコントロールのゲットフォーカス
void	CfrmUc021Uketoritegata::EditONTitlediag1( short index )
{
// midori 151405 add -->
	// スクロールフラグをクリアする
	nG_MScroll = 0;
...
// タイトルコントロールのロストフォーカス
void	CfrmUc021Uketoritegata::EditOFFTitlediag1 (short index )
{
// midori 151405 add -->
	m_Titlefocus = 0;
// midori 151405 add <--
...
//	タイトルの更新
void CfrmUc021Uketoritegata::virUpdateTitle()
{
...
// タイトルコントロールのキーイベント
void	CfrmUc021Uketoritegata::TerminationTitlediag1( short index, short nChar, short length, LPUNKNOWN data )
{
	// フォーカス移動
	switch ( nChar ) {
	case VK_RETURN:
...
void	CfrmUc021Uketoritegata::EditONYoushikidiag1( short index )
{
	DIAGRAM_DATA	diadata;
	int				intRet = -1;
...
// データコントロールのロストフォーカス
void	CfrmUc021Uketoritegata::EditOFFYoushikidiag1( short index )
{
	if( m_EndView != FALSE )	return;
...
//	入力確定
void CfrmUc021Uketoritegata::virInputDecisionEditOFF()
{
	// フォーカスフラグOFF
...
// 預貯金データコントロールのキーイベント
void	CfrmUc021Uketoritegata::TerminationYoushikidiag1( short index, short nChar, short length, LPUNKNOWN data )
{
	//--------------------------------------------------------------------------------
	//	キー操作仕様
...
// midori 151405 add -->
void CfrmUc021Uketoritegata::VScrollYoushikidiag1(short mode)
{
...
//********************************************************************************
int	CfrmUc021Uketoritegata::GetFocusPosition( int nChar )
{
	int		intRow;				// カレント行番号
	int		intCol;				// カレント列番号
...
//********************************************************************************
int	CfrmUc021Uketoritegata::GetTotalRowIndex( int nCharOrg, int intIndex, int intNext )
{
...
//		RET		なし
//********************************************************************************
void	CfrmUc021Uketoritegata::virTblEditIkkatuLine( int nType, CdbUc000Common* rsData,
...
////		RET		なし
////********************************************************************************
//void	CfrmUc021Uketoritegata::virTblEditKamokuLine( CdbUc000Common* rsData, int pPage, int pRow )
//{
//	CALCKEI_INFO			calcKei;
//	CdbUc000Common*			lsData;
//	CdbUc021Uketoritegata*	rs = (CdbUc021Uketoritegata*)rsData;
//
//	// 特殊行挿入の科目行選択時
//	lsData = virGetDataTableObject();
//
//	// 追加した行の1行下のデータを取得
//	lsData->RequeryPageRowAfterRecord(pPage, pRow);
//
//	CdbUc021Uketoritegata*	rs2 = (CdbUc021Uketoritegata*)lsData;
//	
...
//		RET		int					取引先コード
//********************************************************************************
int CfrmUc021Uketoritegata::virTblSortGetTorihikisakiCode( CdbUc000Common* rsData )
{
	int						ret=0;
	CdbUc021Uketoritegata*	rs = (CdbUc021Uketoritegata*)rsData;
	ret = rs->m_AdOrder;
...
//		RET		CString				取引先名称
//********************************************************************************
CString CfrmUc021Uketoritegata::virTblSortGetTorihikisakiName( CdbUc000Common* rsData )
{
	CString					ret=_T("");
...
//		RET		int					取引先コード
//********************************************************************************
int CfrmUc021Uketoritegata::virTblSortGetKamokuCode( CdbUc000Common* rsData )
{
	int						ret=0;
	CdbUc021Uketoritegata*	rs = (CdbUc021Uketoritegata*)rsData;
	ret = rs->m_KnOrder;
...
//********************************************************************************
int	CfrmUc021Uketoritegata::virTblSortSubSortProc( CdlgSort* pCdlgSort, CdbUc000Common* rsData )
{
	CdbUc021Uketoritegata*	rs;
	CString				strFilter;
	CString				strSort;
...
/**********************************************************************
	...
	戻値
		int		成功/失敗
				FUNCTION_OK
***********************************************************************/
int	CfrmUc021Uketoritegata::RecBufSetData( CdbUc021Uketoritegata* prmDbRec )
{
...
/**********************************************************************
	...
	戻値
		int		成功/失敗
				FUNCTION_OK
***********************************************************************/
int	CfrmUc021Uketoritegata::RecBufClearAllData()
{
...
/**********************************************************************
	...
	戻値
		int		成功/失敗
				FUNCTION_OK
***********************************************************************/
int	CfrmUc021Uketoritegata::RecBufClearData( P_REC_UC_021_UKETORITEGATE inRecData )
{
...
/**********************************************************************
	...
	戻値
		int				成功(更新あり)/成功(更新なし)/失敗
						...
						FUNCTION_NG		: 失敗
***********************************************************************/
int	CfrmUc021Uketoritegata::virRecBufSaveData( int inPage, int inRow )
{
...
***********************************************************************/
int	CfrmUc021Uketoritegata::virRecBufSaveDataForPasteInsert( int inPage, int inRow )
{
...
***********************************************************************/
int	CfrmUc021Uketoritegata::virRecBufSaveDataForPaste( int inPage, int inRow )
{
	///////////////////////////////////////////////////////////////
	// 登録処理呼び出し
	return RecBufSaveDataSub( inPage, inRow, &m_CopyData );
...
/**********************************************************************
	...
	戻値
			int					成功(更新あり)/成功(更新なし)/失敗
								...
								FUNCTION_NG		: 失敗
***********************************************************************/
int	CfrmUc021Uketoritegata::RecBufSaveDataSub( 
							int inPage,
							int inRow,
...
// midori 152137 add <--
		...
		if ((udtTemp.m_FgFunc == ID_FGFUNC_DATA) && (ufgAdName == TRUE)) {	// 変更ありの場合
			...
			if(m_RegAutoRef)	udtTemp.m_AdSeq = rsAdd.CheckEntryAddNone( udtTemp.m_AdName1, udtTemp.m_AdName2, "", "", ID_ADDRESSGR_URI, FALSE, TRUE);
...
//********************************************************************************
CdbUc000Common*	CfrmUc021Uketoritegata::virGetDataTableObject()
{
	// 「受取手形」テーブルのオブジェクトを生成し、ポインタを返す
...
//	RET	なし
//********************************************************************************
void	CfrmUc021Uketoritegata::virRowButtonCopyProc()
{
...
//	RET	なし
//********************************************************************************
void	CfrmUc021Uketoritegata::virGetCurrentInfo( CURRENT_INFO* uCurInfo )
{
...
//	【戻値】	なし
//**************************************************
void CfrmUc021Uketoritegata::SetInputMode( int nRow, long nMode )
{
...
//	【戻値】	なし
//**************************************************
void CfrmUc021Uketoritegata::SetDiagBackColor()
{
...
//		RET		なし					
//********************************************************************************
void CfrmUc021Uketoritegata::virRendoCreateData(CdbUc000Common* rsData, RENTEMP_INFO* uRenInfo)
{
	CString			strTemp;
...
//		RET		なし					
//********************************************************************************
void CfrmUc021Uketoritegata::virRendoUpdateData(CdbUc000Common* rsData, RENTEMP_INFO* uRenInfo)
{
	CdbUc021Uketoritegata*	rs = (CdbUc021Uketoritegata*)rsData;
...
//***************************************************************************
BOOL CfrmUc021Uketoritegata::virEndProc(void)
{
	TRACE(_T("***** CfrmUc021Uketoritegata::virEndProc\n"));
...
// 2012/06/29追加
//********************************************************************************
void CfrmUc021Uketoritegata::virTblGetKamokuInfo( CdbUc000Common* rsData, SORTKAMOKU_INFO* uKamoku )
{
	CdbUc021Uketoritegata*	rs = (CdbUc021Uketoritegata*)rsData;
...
// midori 161106 add -->
void CfrmUc021Uketoritegata::ComboNew(short index)
{
	short			sv_sel=0;
// midori 152201 add -->
...
// midori 151405 add -->
int CfrmUc021Uketoritegata::CursorControl(short nChar, int sw)
{
	int				rv=0;
	int				intCol=0;
	int				pos=0;
...
// midori 152134 add -->
void CfrmUc021Uketoritegata::ComboSelYoushikidiag1(short index, LPUNKNOWN data)
{
// 要通知案件修正 21/07/09 del -->
...
// 修正No.162446 add -->
LRESULT CfrmUc021Uketoritegata::OnUserReDrawView(WPARAM wParam, LPARAM lParam)
{
	virUpdateControlTblData();
	CmnDiagSetFocus(m_pDiag, 1, 1);
