// dbUc162Zatuson.h : ヘッダー ファイル
//

#ifndef	_DB_UC_162_ZATUSON_H_
#define	_DB_UC_162_ZATUSON_H_

#include "dbUc000Common.h"

/////////////////////////////////////////////////////////////////////////////
// CdbUc162Zatuson レコードセット

class CdbUc162Zatuson : public CdbUc000Common
{
public:
...
// midori 160606 cor <--
	...
	CdbUc162Zatuson(CDatabase* pDatabase = NULL);
	DECLARE_DYNAMIC(CdbUc162Zatuson)

// フィールド/パラメータ データ
	//{{AFX_FIELD(CdbUc162Zatuson, CRecordset)
	long	m_KnSeq;
	long	m_KnOrder;
	CString	m_KnName;
	CString	m_Naiyou;
