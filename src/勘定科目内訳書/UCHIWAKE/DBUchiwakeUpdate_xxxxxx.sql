...
BEGIN
		...
		if( @uchiver = 10 ) begin
			...
			-- Še—l®‚ÉƒCƒ“ƒ{ƒCƒX“o˜^”Ô†ƒJƒ‰ƒ€‚ğ’Ç‰Á
			-- uc_021_uketoritegata (Table update)
			...
			-- uc_lst_address‚ÉƒCƒ“ƒ{ƒCƒX“o˜^”Ô†ƒJƒ‰ƒ€‚ğ’Ç‰Á
			...
			-- uc_lst_item_sort Še—l®‚Ìƒ\[ƒg‚É"“o˜^”Ô†"‚ğ’Ç‰Á
			declare @udcount int;
			-- —l®‚Q
			set @udcount = 0;
			...
			IF(@udcount = 0)
				...
				VALUES(2, 9, '“o˜^”Ô†', 1, 1, 0, 'Invno ASC', NULL, NULL, NULL)
			...
			IF(@udcount = 0)
				INSERT INTO uc_lst_item_sort(FormSeq,ItemSeq,ItemName,FgPage,FgSykei,FgItem,OrderStr,FieldSykei,FieldSykei2,OrderStr2)
				VALUES(3, 5, '“o˜^”Ô†', 0, 1, 0, 'Invno ASC', NULL, NULL, NULL)
			...
			IF(@udcount = 0)
				INSERT INTO uc_lst_item_sort(FormSeq,ItemSeq,ItemName,FgPage,FgSykei,FgItem,OrderStr,FieldSykei,FieldSykei2,OrderStr2)
				VALUES(4, 5, '“o˜^”Ô†', 0, 1, 0, 'Invno ASC', NULL, NULL, NULL)
			...
			IF(@udcount = 0)
				INSERT INTO uc_lst_item_sort(FormSeq,ItemSeq,ItemName,FgPage,FgSykei,FgItem,OrderStr,FieldSykei,FieldSykei2,OrderStr2)
				VALUES(5, 4, '“o˜^”Ô†', 0, 1, 0, 'Invno ASC', NULL, NULL, NULL)
			...
			IF(@udcount = 0)
				INSERT INTO uc_lst_item_sort(FormSeq,ItemSeq,ItemName,FgPage,FgSykei,FgItem,OrderStr,FieldSykei,FieldSykei2,OrderStr2)
				VALUES(8, 7, '“o˜^”Ô†', 0, 0, 0, 'Invno ASC', NULL, NULL, NULL)
			...
			IF(@udcount = 0)
				INSERT INTO uc_lst_item_sort(FormSeq,ItemSeq,ItemName,FgPage,FgSykei,FgItem,OrderStr,FieldSykei,FieldSykei2,OrderStr2)
				VALUES(9, 8, '“o˜^”Ô†', 1, 1, 0, 'Invno ASC', NULL, NULL, NULL)
			...
			IF(@udcount = 0)
				INSERT INTO uc_lst_item_sort(FormSeq,ItemSeq,ItemName,FgPage,FgSykei,FgItem,OrderStr,FieldSykei,FieldSykei2,OrderStr2)
				VALUES(10, 5, '“o˜^”Ô†', 0, 1, 0, 'Invno ASC', NULL, NULL, NULL)
			...
			IF(@udcount = 0)
				INSERT INTO uc_lst_item_sort(FormSeq,ItemSeq,ItemName,FgPage,FgSykei,FgItem,OrderStr,FieldSykei,FieldSykei2,OrderStr2)
				VALUES(11, 5, '“o˜^”Ô†', 0, 1, 0, 'Invno ASC', NULL, NULL, NULL)
			...
			IF(@udcount = 0)
				INSERT INTO uc_lst_item_sort(FormSeq,ItemSeq,ItemName,FgPage,FgSykei,FgItem,OrderStr,FieldSykei,FieldSykei2,OrderStr2)
				VALUES(14, 8, '“o˜^”Ô†', 0, 0, 0, 'Invno ASC', NULL, NULL, NULL)
			...
			IF(@udcount = 0)
				INSERT INTO uc_lst_item_sort(FormSeq,ItemSeq,ItemName,FgPage,FgSykei,FgItem,OrderStr,FieldSykei,FieldSykei2,OrderStr2)
				VALUES(18, 5, '“o˜^”Ô†', 0, 0, 0, 'Invno ASC', NULL, NULL, NULL)
			...
			IF(@udcount = 0)
				INSERT INTO uc_lst_item_sort(FormSeq,ItemSeq,ItemName,FgPage,FgSykei,FgItem,OrderStr,FieldSykei,FieldSykei2,OrderStr2)
				VALUES(19, 6, '“o˜^”Ô†', 0, 0, 0, 'Invno ASC', NULL, NULL, NULL)
			...
			IF(@udcount = 0)
				INSERT INTO uc_lst_item_sort(FormSeq,ItemSeq,ItemName,FgPage,FgSykei,FgItem,OrderStr,FieldSykei,FieldSykei2,OrderStr2)
				VALUES(20, 5, '“o˜^”Ô†', 0, 0, 0, 'Invno ASC', NULL, NULL, NULL)
			...
			IF(@udcount = 0)
				INSERT INTO uc_lst_item_sort(FormSeq,ItemSeq,ItemName,FgPage,FgSykei,FgItem,OrderStr,FieldSykei,FieldSykei2,OrderStr2)
				VALUES(21, 6, '“o˜^”Ô†', 0, 1, 0, 'Invno ASC', NULL, NULL, NULL)
			...
			IF(@udcount = 0)
				INSERT INTO uc_lst_item_sort(FormSeq,ItemSeq,ItemName,FgPage,FgSykei,FgItem,OrderStr,FieldSykei,FieldSykei2,OrderStr2)
				VALUES(22, 6, '“o˜^”Ô†', 0, 1, 0, 'Invno ASC', NULL, NULL, NULL)
			...
			IF(@udcount = 0) begin
				INSERT INTO uc_lst_item_sort(FormSeq,ItemSeq,ItemName,FgPage,FgSykei,FgItem,OrderStr,FieldSykei,FieldSykei2,OrderStr2)
				VALUES(101, 5, '“o˜^”Ô†', 0, 0, 0, 'Invno ASC', NULL, NULL, NULL)
				INSERT INTO uc_lst_item_sort(FormSeq,ItemSeq,ItemName,FgPage,FgSykei,FgItem,OrderStr,FieldSykei,FieldSykei2,OrderStr2)
				VALUES(102, 5, '“o˜^”Ô†', 0, 0, 0, 'Invno ASC', NULL, NULL, NULL)
				INSERT INTO uc_lst_item_sort(FormSeq,ItemSeq,ItemName,FgPage,FgSykei,FgItem,OrderStr,FieldSykei,FieldSykei2,OrderStr2)
				VALUES(103, 5, '“o˜^”Ô†', 0, 0, 0, 'Invno ASC', NULL, NULL, NULL)
				INSERT INTO uc_lst_item_sort(FormSeq,ItemSeq,ItemName,FgPage,FgSykei,FgItem,OrderStr,FieldSykei,FieldSykei2,OrderStr2)
				VALUES(104, 5, '“o˜^”Ô†', 0, 0, 0, 'Invno ASC', NULL, NULL, NULL)
				INSERT INTO uc_lst_item_sort(FormSeq,ItemSeq,ItemName,FgPage,FgSykei,FgItem,OrderStr,FieldSykei,FieldSykei2,OrderStr2)
				VALUES(105, 5, '“o˜^”Ô†', 0, 0, 0, 'Invno ASC', NULL, NULL, NULL)
				INSERT INTO uc_lst_item_sort(FormSeq,ItemSeq,ItemName,FgPage,FgSykei,FgItem,OrderStr,FieldSykei,FieldSykei2,OrderStr2)
				VALUES(106, 5, '“o˜^”Ô†', 0, 0, 0, 'Invno ASC', NULL, NULL, NULL)
				INSERT INTO uc_lst_item_sort(FormSeq,ItemSeq,ItemName,FgPage,FgSykei,FgItem,OrderStr,FieldSykei,FieldSykei2,OrderStr2)
				VALUES(107, 5, '“o˜^”Ô†', 0, 0, 0, 'Invno ASC', NULL, NULL, NULL)
				INSERT INTO uc_lst_item_sort(FormSeq,ItemSeq,ItemName,FgPage,FgSykei,FgItem,OrderStr,FieldSykei,FieldSykei2,OrderStr2)
				VALUES(108, 5, '“o˜^”Ô†', 0, 0, 0, 'Invno ASC', NULL, NULL, NULL)
				INSERT INTO uc_lst_item_sort(FormSeq,ItemSeq,ItemName,FgPage,FgSykei,FgItem,OrderStr,FieldSykei,FieldSykei2,OrderStr2)
				VALUES(109, 5, '“o˜^”Ô†', 0, 0, 0, 'Invno ASC', NULL, NULL, NULL)
				INSERT INTO uc_lst_item_sort(FormSeq,ItemSeq,ItemName,FgPage,FgSykei,FgItem,OrderStr,FieldSykei,FieldSykei2,OrderStr2)
				VALUES(110, 5, '“o˜^”Ô†', 0, 0, 0, 'Invno ASC', NULL, NULL, NULL)
				INSERT INTO uc_lst_item_sort(FormSeq,ItemSeq,ItemName,FgPage,FgSykei,FgItem,OrderStr,FieldSykei,FieldSykei2,OrderStr2)
				VALUES(111, 5, '“o˜^”Ô†', 0, 0, 0, 'Invno ASC', NULL, NULL, NULL)
				INSERT INTO uc_lst_item_sort(FormSeq,ItemSeq,ItemName,FgPage,FgSykei,FgItem,OrderStr,FieldSykei,FieldSykei2,OrderStr2)
				VALUES(112, 5, '“o˜^”Ô†', 0, 0, 0, 'Invno ASC', NULL, NULL, NULL)
				INSERT INTO uc_lst_item_sort(FormSeq,ItemSeq,ItemName,FgPage,FgSykei,FgItem,OrderStr,FieldSykei,FieldSykei2,OrderStr2)
				VALUES(113, 5, '“o˜^”Ô†', 0, 0, 0, 'Invno ASC', NULL, NULL, NULL)
				INSERT INTO uc_lst_item_sort(FormSeq,ItemSeq,ItemName,FgPage,FgSykei,FgItem,OrderStr,FieldSykei,FieldSykei2,OrderStr2)
				VALUES(114, 5, '“o˜^”Ô†', 0, 0, 0, 'Invno ASC', NULL, NULL, NULL)
				INSERT INTO uc_lst_item_sort(FormSeq,ItemSeq,ItemName,FgPage,FgSykei,FgItem,OrderStr,FieldSykei,FieldSykei2,OrderStr2)
				VALUES(115, 5, '“o˜^”Ô†', 0, 0, 0, 'Invno ASC', NULL, NULL, NULL)
				INSERT INTO uc_lst_item_sort(FormSeq,ItemSeq,ItemName,FgPage,FgSykei,FgItem,OrderStr,FieldSykei,FieldSykei2,OrderStr2)
				VALUES(116, 5, '“o˜^”Ô†', 0, 0, 0, 'Invno ASC', NULL, NULL, NULL)
				INSERT INTO uc_lst_item_sort(FormSeq,ItemSeq,ItemName,FgPage,FgSykei,FgItem,OrderStr,FieldSykei,FieldSykei2,OrderStr2)
				VALUES(117, 5, '“o˜^”Ô†', 0, 0, 0, 'Invno ASC', NULL, NULL, NULL)
				INSERT INTO uc_lst_item_sort(FormSeq,ItemSeq,ItemName,FgPage,FgSykei,FgItem,OrderStr,FieldSykei,FieldSykei2,OrderStr2)
				VALUES(118, 5, '“o˜^”Ô†', 0, 0, 0, 'Invno ASC', NULL, NULL, NULL)
				INSERT INTO uc_lst_item_sort(FormSeq,ItemSeq,ItemName,FgPage,FgSykei,FgItem,OrderStr,FieldSykei,FieldSykei2,OrderStr2)
				VALUES(119, 5, '“o˜^”Ô†', 0, 0, 0, 'Invno ASC', NULL, NULL, NULL)
				INSERT INTO uc_lst_item_sort(FormSeq,ItemSeq,ItemName,FgPage,FgSykei,FgItem,OrderStr,FieldSykei,FieldSykei2,OrderStr2)
				VALUES(120, 5, '“o˜^”Ô†', 0, 0, 0, 'Invno ASC', NULL, NULL, NULL)
			end
...
BEGIN
		...
		if( @uchiver = 10 ) begin
			-- vtbl
			DELETE vtbl WHERE type=1001 AND objname='DBUchiwake'
			INSERT INTO vtbl (type, objname, vers) VALUES (1001, 'DBUchiwake', 11)
