
		CmnDiagSetAttrInpmax( m_pDiag, i + ID_COL_121I_AD2ADD2 - 1, MAX_KETA_121_AD2ADD2 );		//	商品の所在地２
		CmnDiagSetAttrInpmax( m_pDiag, i + ID_COL_121I_HDNAME  - 1, MAX_KETA_121_HDNAME );		//	地目
		CmnDiagSetAttrInpmax( m_pDiag, i + ID_COL_121I_SPDATE  - 1, MAX_KETA_121_SPDATE );		//	売上年月
		CmnDiagSetAttrInpmax( m_pDiag, i + ID_COL_121I_ADNAME1 - 1, MAX_KETA_121_ADNAME1 );		//	氏名
		CmnDiagSetAttrInpmax( m_pDiag, i + ID_COL_121I_ADADD1  - 1, MAX_KETA_121_ADADD1 );		//	住所１
		CmnDiagSetAttrInpmax( m_pDiag, i + ID_COL_121I_ADADD2  - 1, MAX_KETA_121_ADADD2 );		//	住所２
		CmnDiagSetAttrInpmax( m_pDiag, i + ID_COL_121I_SPDATE3 - 1, MAX_KETA_121_SPDATE3 );		//	売上商品の取得年（年）
		
		// 金額欄：桁数初期化
		len = ID_VAL_121_K_DATA;
		CmnDiagSetAttrDigit( m_pDiag, i + ID_COL_121I_VAL - 1, len );							// 売上金額

		len = ID_VAL2_121_K_DATA;
		CmnDiagSetAttrDigit( m_pDiag, i + ID_COL_121I_VAL2 - 1, len );							// (仲介手数料)

		// 小数点付き数値の設定
		len = 8;
		CmnDiagSetAttrDigit( m_pDiag, i + ID_COL_121I_AREA - 1, len, TRUE, TRUE, 2 );			// 総面積
		CmnDiagSetAttrDigit( m_pDiag, i + ID_COL_121I_AREA2 - 1, len, TRUE, TRUE, 2 );			// 売上面積
	...
	// 半角/全角設定
	CmnDiagSetAttrColZenHan( m_pDiag , ID_COL_121I_KUBUN );		// 区分
	CmnDiagSetAttrColZenHan( m_pDiag , ID_COL_121I_AD2ADD1 );	// 商品の所在地1
	CmnDiagSetAttrColZenHan( m_pDiag , ID_COL_121I_AD2ADD2 );	// 商品の所在地2	
	CmnDiagSetAttrColZenHan( m_pDiag , ID_COL_121I_HDNAME );	// 地目
	CmnDiagSetAttrColZenHan( m_pDiag , ID_COL_121I_ADNAME1 );	// 氏名1
	CmnDiagSetAttrColZenHan( m_pDiag , ID_COL_121I_ADADD1 );	// 住所1
	CmnDiagSetAttrColZenHan( m_pDiag , ID_COL_121I_ADADD2 );	// 住所2
...
BOOL	CfrmUc121TotiuriageI::InitialControlComboBox()
{
	...
	// T選択コンボ
	diadata3.text_combo = _T("T\r\n \r\n");

	// 全行設定
	for(i = 1; i <= intMax; i++) {
		// 対象コントロールのインデックス番号を取得
		// 元号コンボ
		intIndex = CmnGetControlIndex(i, ID_COL_121I_SPDATE2);
		// 区分コンボ
		intIndex2 = CmnGetControlIndex(i, ID_COL_121I_KUBUN);
		// T選択
		intIndex3 = CmnGetControlIndex(i, ID_COL_121I_INVONOT);
		...
		// T選択
		m_pDiag->ModifyItem(intIndex3, DIAG_MDFY_NODROPDOWN);
		m_pDiag->SetData(intIndex3, (LPUNKNOWN)&diadata3);

		// フォントサイズ設定
		if(m_EndView == FALSE && m_ChangeFont != FALSE && m_ImportMode == FALSE) {
			// T選択
			//m_pDiag->ChangeFontSize(intIndex2, m_TselFSize);		// 修正No.168450 del
			m_pDiag->ChangeFontSize(intIndex3, m_TselFSize);		// 修正No.168450 add
		}
	}
	m_ChangeFont = FALSE;
...
//********************************************************************************
void	CfrmUc121TotiuriageI::InitialControlTotalArea()
{
	int		nKeiType;			//	計の種別
	...
	m_pDiagKei->ModifyItem(ID_COL_121I_KEI1_VAL, intKeiRow);
	m_pDiagKei->ModifyItem(ID_COL_121I_KEI2_VAL, intKeiRow);
	m_pDiagKei->ModifyItem(ID_COL_121I_KEI1_VAL2, intKeiRow);
	m_pDiagKei->ModifyItem(ID_COL_121I_KEI2_VAL2, intKeiRow);
}
...
//	RET	なし
//********************************************************************************
void	CfrmUc121TotiuriageI::InitialControlSpecialRow( int intRow, int intFgFunc )
{
	int				len=0;
	int				nIndex;		//	インデックス
	...
	switch ( intFgFunc ) {
		...
		case ID_FGFUNC_IKKATUAUTO:		// 一括集計金額行（自動）
			// 桁数を設定
			len = ID_VAL_121_K_TOTAL;
			CmnDiagSetAttrDigit( m_pDiag, CmnGetControlIndex( intRow , ID_COL_121I_VAL ), len );

			len = ID_VAL2_121_K_TOTAL;
			CmnDiagSetAttrDigit( m_pDiag, CmnGetControlIndex( intRow , ID_COL_121I_VAL2 ), len );
			break;
	}
	...
	switch (intFgFunc) {
		...
		case ID_FGFUNC_IKKATUAUTO:		// 一括集計金額行（自動）		
			...
			if(intFgFunc != ID_FGFUNC_IKKATUAUTO)	{
				...
				m_pDiag->ModifyItem(CmnGetControlIndex(intRow, ID_COL_121I_KUBUN), DIAG_MDFY_NODROPDOWN);
				// 「登録番号(T選択)」はComboBoxのため、DropDown不可とする
				m_pDiag->ModifyItem(CmnGetControlIndex(intRow, ID_COL_121I_INVONOT), DIAG_MDFY_NODROPDOWN);
				// 「売上商品の取得年」はComboBoxのため、DropDown不可とする
				m_pDiag->ModifyItem(CmnGetControlIndex(intRow, ID_COL_121I_SPDATE2), DIAG_MDFY_NODROPDOWN);

				// ComboBoxの選択項目クリア
				m_clsFunc.DiagInit(&diadata);
				diadata.text_combo = _T("\r\n");
				m_pDiag->SetData(CmnGetControlIndex(intRow, ID_COL_121I_KUBUN), (LPUNKNOWN)&diadata);
				m_pDiag->SetData(CmnGetControlIndex(intRow, ID_COL_121I_INVONOT), (LPUNKNOWN)&diadata);
				m_pDiag->SetData(CmnGetControlIndex(intRow, ID_COL_121I_SPDATE2), (LPUNKNOWN)&diadata);
			}
...
//	帳表タイトル情報の表示
//********************************************************************************
void	CfrmUc121TotiuriageI::virUpdateControlTitle()
{
//	int		intMax;
	DIAGRAM_ATTRIBUTE diaatt;
...
//	帳表ページ情報の表示
//********************************************************************************
void	CfrmUc121TotiuriageI::UpdateControlPage()
{
	BOOL	bBack = TRUE;
	BOOL	bNext = TRUE;
...
//	帳表データの表示（１ページ分）
//********************************************************************************
BOOL	CfrmUc121TotiuriageI::virUpdateControlTblData()
{
	int len = 0;
	...
	// 頁計、累計行の桁数をセットする
	len = ID_VAL_121_K_TOTAL;
	CmnDiagSetAttrDigit( m_pDiagKei, ID_COL_121I_KEI1_VAL, len );
	CmnDiagSetAttrDigit( m_pDiagKei, ID_COL_121I_KEI1_VAL, len );

	len = ID_VAL2_121_K_TOTAL;
	CmnDiagSetAttrDigit( m_pDiagKei, ID_COL_121I_KEI1_VAL2, len );
	CmnDiagSetAttrDigit( m_pDiagKei, ID_COL_121I_KEI1_VAL2, len );
	...
	while ( !dbRec.IsEOF() ) {		// ファイル終端まで
		...
		CmnInitialControlFgStringCell( m_pDiag, dbRec.m_NumRow, ID_COL_121I_HDNAME, dbRec.m_FgFunc, UC_121_HDNAME_LEN, dbRec.m_HdName);
...
//	保管件数の表示
//********************************************************************************
BOOL CfrmUc121TotiuriageI::virUpdateControlTblData2()
{
	int					hcnt=0;
	CString				cs=_T("");
...
//		RET		なし
//********************************************************************************
void	CfrmUc121TotiuriageI::UpdateControlRowData( CdbUc121Totiuriage* prmDbRec ) {
	DIAGRAM_DATA	diadata;	// ICSDiag構造体
	int				intCell;	// 保存フィールド
	int				nIndex = 0;
	CString			cs1, cs2, cst;
	...
	// 読込み対象セル取得
	intCell = CmnGetControlIndex( prmDbRec->m_NumRow, ID_COL_121I_KUBUN );
...
//		RET		なし
//********************************************************************************
void	CfrmUc121TotiuriageI::UpdateControlRowTotal( CdbUc121Totiuriage* prmDbRec )
{
	int		intTotalType;
	...
	// 頁計/累計の名称表示
	if ( intRowName > 0 ) {
		CmnDiagSetString( m_pDiagKei, CmnGetKeiDiagIndex( intRowName, ID_COL_121I_KEI1_MEISYO-1 ), prmDbRec->m_KeiStr, 1 );
	}
	// 頁計/累計の金額表示
	if ( intRowVal > 0 ) {
		CmnDiagSetKingaku( m_pDiagKei, CmnGetKeiDiagIndex( intRowVal, ID_COL_121I_KEI1_VAL-1 ), prmDbRec->m_Val );
	}
	if ( intRowVal2 > 0 ) {
		CmnDiagSetKingaku( m_pDiagKei, CmnGetKeiDiagIndex( intRowVal2, ID_COL_121I_KEI1_VAL2-1 ), prmDbRec->m_Val2 );
	}
}
...
//		RET		なし
//********************************************************************************
void	CfrmUc121TotiuriageI::virFncCellCopyProc( CdbUc000Common* rsData )
{
	...
	switch( intCol ){
		...
		// 売上商品の取得年(元号)
		case ID_COL_121I_SPDATE2:
		// 売上商品の取得年(年)
		case ID_COL_121I_SPDATE3:		
			//	売上商品の取得年(元号)？
			if ( intCol == ID_COL_121I_SPDATE2 ){
				nIndex[0] = m_uInfo.intCurCtlIndex;
				nIndex[1] = m_uInfo.intCurCtlIndex + 1;
			}
			// 売上商品の取得年(年)
...
//********************************************************************************
int	CfrmUc121TotiuriageI::virFncReferenceGetType(int intCol, int* intGrSeq, long* lngItemSeq, int* intAdd1, int* intAdd2, int* intAdd1Col ,int* intAdd2Col, REFERENCE_INFO* pudReference)
{
	int		intRefType = 0;
	...
	switch ( intCol ) {
		...
		case ID_COL_121I_AD2ADD2:
			...
			*intAdd1 = 15 * 2;			// Byte指定
			*intAdd2 = 15 * 2;			// Byte指定
			*intAdd1Col = ID_COL_121I_AD2ADD1;
			*intAdd2Col = ID_COL_121I_AD2ADD2;
			break;
		...
		case ID_COL_121I_ADADD2:
			...
			*intAdd1 = 20 * 2;			// Byte指定
			*intAdd2 = 20 * 2;			// Byte指定
			*intAdd1Col = ID_COL_121I_ADADD1;
			*intAdd2Col = ID_COL_121I_ADADD2;
			break;
...
//		RET		なし
//********************************************************************************
void CfrmUc121TotiuriageI::virFncReferenceSetData( CdlgReference* dlgRef, int intRefType, int intCol )
{
...
//		RET		なし
//********************************************************************************
void CfrmUc121TotiuriageI::virFncReferenceUpdateTbl( int intRefType, int nRefMode/*=0*/ )
{
	switch (intRefType) {
		// 区分
		case ID_DLGTYPE_KAMOKU:
...
//		RET		なし
//********************************************************************************
void	CfrmUc121TotiuriageI::virFncReferenceSetICSData(CdlgAddressSearch* dlgAddd)
{
	int			intIndex;
	...
	switch ( m_uInfo.intCurCol ) {
		...
		case ID_COL_121I_AD2ADD2:
			//	商品の所在地１
			intIndex = CmnGetControlIndex( m_uInfo.intCurRow, ID_COL_121I_AD2ADD1 );
			CmnDiagSetString( m_pDiag, intIndex, dlgAddd->m_AdAdd1, 0 );
			//	商品の所在地２
			intIndex = CmnGetControlIndex( m_uInfo.intCurRow, ID_COL_121I_AD2ADD2 );
		...
		case ID_COL_121I_ADADD2:
			//	住所１
			intIndex = CmnGetControlIndex( m_uInfo.intCurRow, ID_COL_121I_ADADD1 );
			CmnDiagSetString( m_pDiag, intIndex, dlgAddd->m_AdAdd1, 0 );
			//	住所２
			intIndex = CmnGetControlIndex( m_uInfo.intCurRow, ID_COL_121I_ADADD2 );
			CmnDiagSetString( m_pDiag, intIndex, dlgAddd->m_AdAdd2, 0 );
			break;
	}
}

void CfrmUc121TotiuriageI::virActivateFrame(UINT nState, CFrameWnd* pDeactivateFrame)
{
	int		index = 0;
	...
	if(pWnd != NULL)	{
		if(m_DataKakutei == FALSE)	{
			if(m_uInfo.intCurCol == ID_COL_121I_SPDATE)	{
...
void CfrmUc121TotiuriageI::virActivateFrameK(UINT nState, CFrameWnd* pDeactivateFrame)
{
	int		index = 0;
	CWnd*	pWnd = this->GetFocus();
	...
	if(pWnd != NULL)	{
		if(m_DataKakutei == FALSE)	{
			if(m_uInfo.intCurCol == ID_COL_121I_KUBUN)	{
				virKamokuAddCancel();
			}
		}
	}
...
void CfrmUc121TotiuriageI::virKamokuAddCancel()
{
	...
	// 科目列なら
	if(m_uInfo.intCurCol == ID_COL_121I_KUBUN && m_F9OnSw != TRUE)	{
		DIAGRAM_DATA	diadata;
		m_pDiag->GetData(m_uInfo.intCurCtlIndex,(LPUNKNOWN)&diadata);
		// 【新規作成】が選択されていれば
		if(diadata.data_combo > m_CmbCnt)	{
			// 前回の値に戻す
			CmnDiagSetCombo(m_pDiag,CmnGetControlIndex(m_uInfo.intCurRow,ID_COL_121I_KUBUN),m_uInfo.OldCombo);
		}
	}
}
...
//	その他イベント処理
//********************************************************************************
BOOL	CfrmUc121TotiuriageI::PreTranslateMessage( MSG* pMsg )
{
...
// 修正No.168362 add <--
						...
						if(intCol == ID_COL_121I_SPDATE2 || intCol == ID_COL_121I_KUBUN ||
						   intCol == ID_COL_121I_SPDATE || intCol == ID_COL_121I_INVONOT)	{
							rv=1;
						}
// 修正No.168362 add -->
					} 
// 修正No.168362 add <--
			...
			case VK_RIGHT:
				if(nG_MScroll == 1)	{
					...
					else if(intCol == ID_COL_121I_KUBUN)	{
...
// 頁コントロールのフォーカス設定
void	CfrmUc121TotiuriageI::FocusPagediag1()
{
}

// 頁コントロールのゲットフォーカス
void	CfrmUc121TotiuriageI::EditONPagediag1( short index )
{
// 修正No.168443 add -->
	// ---- 登録番号一覧関連 ----->
	if(pZmSel && pZmSel->IsDisplay() != FALSE) {
...
// 頁コントロールのロストフォーカス
void	CfrmUc121TotiuriageI::EditOFFPagediag1( short index )
{
...
// 頁コントロールのキー操作
void	CfrmUc121TotiuriageI::TerminationPagediag1( short index, short nChar, short length, LPUNKNOWN data )
{
	int nMaxDataCol = 0;
	// カレント頁の合計行の種別を取得
	...
	switch ( nChar ) {
		...
		case VK_TAB:
			...
			if ( CmnCheckShiftKey() == FALSE ) {
				...
				CmnDiagSetFocus(m_pDiag, nMaxDataCol, ID_COL_121I_SPDATE3);
			}
			break;
		case VK_DOWN:
			// タイトルコントロールへ移動
...
// タイトルコントロールのフォーカス設定
void	CfrmUc121TotiuriageI::FocusTitlediag1()
{
}

// タイトルコントロールのゲットフォーカス
void	CfrmUc121TotiuriageI::EditONTitlediag1( short index )
{
// 修正No.168443 add -->
	// ---- 登録番号一覧関連 ----->
	if(pZmSel && pZmSel->IsDisplay() != FALSE) {
...
// タイトルコントロールのロストフォーカス
void	CfrmUc121TotiuriageI::EditOFFTitlediag1 (short index )
{
	m_Titlefocus = 0;
	virUpdateTitle();
}
...
//	タイトル更新
void CfrmUc121TotiuriageI::virUpdateTitle()
{
...
// タイトルコントロールのキーイベント
void	CfrmUc121TotiuriageI::TerminationTitlediag1( short index, short nChar, short length, LPUNKNOWN data )
{
	// フォーカス移動
	switch ( nChar ) {
		case VK_RETURN:
...
void	CfrmUc121TotiuriageI::EditONYoushikidiag1( short index )
{
	...
	if(m_uInfo.intCurCol == ID_COL_121I_SPDATE)	m_uInfo.EditSign = 1;
	else										m_uInfo.EditSign = -1;

	switch (m_uInfo.intCurCol) {
		case ID_COL_121I_KUBUN:	// 区分
			m_pDiag->GetData( m_uInfo.intCurCtlIndex , (LPUNKNOWN)&diadata );
			if(diadata.data_combo <= m_CmbCnt)	{
		...
		case ID_COL_121I_INVONOT:	// 登録番号(T選択)
			// コンボボックスのオフセット値取得
			m_pDiag->GetData(m_uInfo.intCurCtlIndex, (LPUNKNOWN)&diadata);
			m_uInfo.OldCombo = diadata.data_combo;
			break;

		case ID_COL_121I_SPDATE2:	// 売上商品の取得年(元号)
			// コンボボックスのオフセット値取得
			m_pDiag->GetData( m_uInfo.intCurCtlIndex , (LPUNKNOWN)&diadata );
			m_uInfo.OldCombo = diadata.data_combo;
			break;

		case ID_COL_121I_SPDATE3:	// 売上商品の取得年(和暦)
			// 「元号」コンボ→「和暦」エディットの順で移動された?
			if ( ( m_nOldCol == ID_COL_121I_SPDATE2 ) && ( m_uInfo.OldRow == m_uInfo.intCurRow ) ){
				// コンボ値再セット
	...
	if ( ( m_uInfo.OldRow > 0 ) ) {
		if ( m_uInfo.OldPage == m_uInfo.intCurPage && m_uInfo.OldPage > 0 ) {
			// T選択⇔登録番号は保存しない
			BOOL tsel_to_invno = IsSaveMoveReference(ID_COL_121I_INVONOT, ID_COL_121I_INVONO);
	...
	if(m_uInfo.intCurCol == ID_COL_121I_INVONO && m_EndSyorityu == 0)	{
// 修正No.168377 del -->
...
// 修正No.168377 add -->
		// 登録番号のT選択の値を取得
		int pos = CmnGetControlIndex(m_uInfo.intCurRow, ID_COL_121I_INVONOT);
...
// データコントロールのロストフォーカス
void	CfrmUc121TotiuriageI::EditOFFYoushikidiag1( short index )
{
	if( m_EndView != FALSE )	return;

// 修正No.168443 add -->
	// ---- 登録番号一覧関連 ----->
	if(m_uInfo.intCurCol != ID_COL_121I_INVONO) {
		if(pZmSel && pZmSel->IsDisplay() != FALSE) {
			pZmSel->DialogOFF();
		}
	}
...
// 修正No.168443 del -->
	...
	//		//// カーソル移動処理
	//		//CmnDiagSetFocus( m_pDiag, m_uInfo.intCurRow, ID_COL_121I_INVONO );
	//	}
	//}

	//// ---- 登録番号一覧関連 ----->
	//if(pZmSel && m_uInfo.intCurCol != ID_COL_121I_INVONO) {
...
//	入力確定
void CfrmUc121TotiuriageI::virInputDecisionEditOFF()
{
	int		index;
	DIAGRAM_DATA diadata;
	...
	//	列が売上商品の取得年(年)？
	if ( CmnGetControlCol() == ID_COL_121I_SPDATE2 ){
		// 旧データ保存
		m_pDiag->GetData( m_uInfo.intCurCtlIndex , (LPUNKNOWN)&diadata );
	...
	else if ( CmnGetControlCol() == ID_COL_121I_SPDATE3 ){
		// 旧データ保存
		m_pDiag->GetData( m_uInfo.intCurCtlIndex , (LPUNKNOWN)&diadata );
...
// 預貯金データコントロールのキーイベント
void	CfrmUc121TotiuriageI::TerminationYoushikidiag1( short index, short nChar, short length, LPUNKNOWN data )
{
	//--------------------------------------------------------------------------------
	//	キー操作仕様
...
void CfrmUc121TotiuriageI::VScrollYoushikidiag1(short mode)
{
// 修正No.168430 del -->
...
//********************************************************************************
int	CfrmUc121TotiuriageI::GetFocusPosition( int nChar )
{
	int		intRow;				// カレント行番号
	int		intCol;				// カレント列番号
	...
	if ( CmnCheckTotalRow() == FALSE ){
		...
		if(intCol == ID_COL_121I_KUBUN || intCol == ID_COL_121I_SPDATE2 || intCol == ID_COL_121I_INVONOT)	{
	...
	else if ( intCol == ID_COL_121I_AD2ADD1 ) {
		// カレント列が「商品の所在地1」の場合
	...
	else if (( intCol == ID_COL_121I_AD2ADD2 ) ||
		( intCol == ID_COL_121I_ADADD1 )){
	...
	else if (( intCol == ID_COL_121I_HDNAME ) ||
		( intCol == ID_COL_121I_ADADD2 )) {
		// カレント列が「地目」,「住所2」の場合
		intVector[0] = m_uInfo.intCurCtlIndex - 1;						// ↑
		intVector[1] = m_uInfo.intCurCtlIndex + 1;						// →
	...
	else if ( intCol == ID_COL_121I_AREA ) {
		// カレント列が「総面積」の場合
	...
	else if ( intCol == ID_COL_121I_ADNAME1 ) {
		// カレント列が「氏名」の場合
		intVector[0] = m_uInfo.intCurCtlIndex - m_uInfo.intColMax + 2;	// ↑
		intVector[1] = m_uInfo.intCurCtlIndex + 1;						// →
		intVector[2] = m_uInfo.intCurCtlIndex + 1;						// ↓
	...
	else if ( intCol == ID_COL_121I_VAL ) {
		// カレント列が「売上金額1」の場合
	...
	else if ( intCol == ID_COL_121I_VAL2 ) {
		// カレント列が「売上金額2」の場合
		intVector[0] = m_uInfo.intCurCtlIndex - 1;						// ↑
		intVector[1] = m_uInfo.intCurCtlIndex + 1;						// →
	...
	else if ( intCol == ID_COL_121I_SPDATE3 ) {
	...
	case VK_RETURN:	// Enterキーでカーソルを下に移動するモード対応
		if(m_ReturnMoveDown)	{
			if(intCol == ID_COL_121I_SPDATE2)			intNext = intVector[1];			//	売上商品の取得年は元号と年で１セットの為、下移動モードでも元号からは年へ移動する
			else if(intCol == ID_COL_121I_HDNAME)		intNext = intVector[1];			//	カレント列が「地目」の場合「→」キーと同じ
			else if(intCol == ID_COL_121I_INVONOT)		intNext = intVector[1];			//	カレント列が「登録番号(T表示)」欄の場合「→」キーと同じ
...
//********************************************************************************
int	CfrmUc121TotiuriageI::GetTotalRowIndex( int nCharOrg, int intIndex, int intNext )
{
	...
	if ( nNowRow <= nBorder[0] ){		
		...
		if (( intNext > CmnGetControlIndex( m_uInfo.intRowMax, ID_COL_121I_SPDATE3 ) ) && ( nCharOrg == VK_TAB )){
			return( -2 );
		}
		//	データ行を超えた？かつ計行あり？
...
//********************************************************************************
int	CfrmUc121TotiuriageI::virTblSortSubSortProc( CdlgSort* pCdlgSort, CdbUc000Common* rsData )
{
	CdbUc121Totiuriage*	rs;
	CString				strFilter;
	CString				strSort;
...
/**********************************************************************
	...
	戻値
		int		成功/失敗
				FUNCTION_OK
***********************************************************************/
int	CfrmUc121TotiuriageI::RecBufSetData( CdbUc121Totiuriage* prmDbRec )
{
...
/**********************************************************************
	...
	戻値
		int		成功/失敗
				FUNCTION_OK
***********************************************************************/
int	CfrmUc121TotiuriageI::RecBufClearAllData()
{
...
/**********************************************************************
	...
	戻値
		int		成功/失敗
				FUNCTION_OK
***********************************************************************/
int	CfrmUc121TotiuriageI::RecBufClearData( P_REC_UC_121_TOTIURIAGE inRecData )
{
...
/**********************************************************************
	...
	戻値
		int				成功(更新あり)/成功(更新なし)/失敗
						...
						FUNCTION_NG		: 失敗
***********************************************************************/
int	CfrmUc121TotiuriageI::virRecBufSaveData( int inPage, int inRow )
{
	...
	// 区分
	intIndex = CmnGetControlIndex( inRow, ID_COL_121I_KUBUN );
	...
	// 商品の所在地1
	intIndex = CmnGetControlIndex( inRow, ID_COL_121I_AD2ADD1 );
	tmpSaveData.m_Ad2Add1 = m_clsFunc.DiagGetString( m_pDiag, intIndex );

	// 商品の所在地2
	intIndex = CmnGetControlIndex( inRow, ID_COL_121I_AD2ADD2 );
	tmpSaveData.m_Ad2Add2 = m_clsFunc.DiagGetString( m_pDiag, intIndex );

	// 地目
	intIndex = CmnGetControlIndex( inRow, ID_COL_121I_HDNAME );
	tmpSaveData.m_HdName = m_clsFunc.DiagGetString( m_pDiag, intIndex );

	// 総面積
	intIndex = CmnGetControlIndex( inRow, ID_COL_121I_AREA );
	tmpSaveData.m_Area = CmnDiagGetKingaku( m_pDiag, intIndex );

	// 売上年月
	intIndex = CmnGetControlIndex( inRow, ID_COL_121I_SPDATE );
	tmpSaveData.m_SpDate = CmnDiagGetDateGWM( m_pDiag, intIndex, m_ReadData[inRow].m_SpDate );

	// 登録番号（T選択）
	intIndex = CmnGetControlIndex(inRow, ID_COL_121I_INVONOT);
	m_pDiag->GetData(intIndex, (LPUNKNOWN)&diadata);
	tsel = diadata.data_combo;

	// 登録番号（法人番号）
	intIndex = CmnGetControlIndex(inRow, ID_COL_121I_INVONO);
	...
	// 氏名1
	intIndex = CmnGetControlIndex( inRow, ID_COL_121I_ADNAME1 );
	tmpSaveData.m_AdName1 = m_clsFunc.DiagGetString( m_pDiag, intIndex );

	// 住所1
	intIndex = CmnGetControlIndex( inRow, ID_COL_121I_ADADD1 );
	tmpSaveData.m_AdAdd1 = m_clsFunc.DiagGetString( m_pDiag, intIndex );

	// 住所2
	intIndex = CmnGetControlIndex( inRow, ID_COL_121I_ADADD2 );
	tmpSaveData.m_AdAdd2 = m_clsFunc.DiagGetString( m_pDiag, intIndex );

	// 売上面積
	intIndex = CmnGetControlIndex( inRow, ID_COL_121I_AREA2 );
	tmpSaveData.m_Area2 = CmnDiagGetKingaku( m_pDiag, intIndex );

	// 売上金額
	intIndex = CmnGetControlIndex( inRow, ID_COL_121I_VAL );
	tmpSaveData.m_Val = CmnDiagGetKingaku( m_pDiag, intIndex );

	// 売上金額
	intIndex = CmnGetControlIndex( inRow, ID_COL_121I_VAL2 );
	...
	//	元号コンボボックスの値を取得
	intIndex = CmnGetControlIndex( inRow, ID_COL_121I_SPDATE2 );
	m_pDiag->GetData( intIndex , (LPUNKNOWN)&diadata );
	...
	//	和暦テキストの値を取得
	intIndex = CmnGetControlIndex( inRow, ID_COL_121I_SPDATE3 );
	m_pDiag->GetData( intIndex , (LPUNKNOWN)&diadata );	
...
***********************************************************************/
int	CfrmUc121TotiuriageI::virRecBufSaveDataForPasteInsert( int inPage, int inRow )
{
...
***********************************************************************/
int	CfrmUc121TotiuriageI::virRecBufSaveDataForPaste( int inPage, int inRow )
{
	///////////////////////////////////////////////////////////////
	// 登録処理呼び出し
	return RecBufSaveDataSub( inPage, inRow, &m_CopyData );
...
/**********************************************************************
	...
	戻値
			int					成功(更新あり)/成功(更新なし)/失敗
								...
								FUNCTION_NG		: 失敗
***********************************************************************/
int	CfrmUc121TotiuriageI::RecBufSaveDataSub( 
							int inPage,
							int inRow,
							P_REC_UC_121_TOTIURIAGE inSaveData )
{
	...
	//(15) 特殊行フラグ(基本的には、空行/データ行のチェックになるはず)
...
//********************************************************************************
CdbUc000Common*	CfrmUc121TotiuriageI::virGetDataTableObject()
{
	// 「土地売上」テーブルのオブジェクトを生成し、ポインタを返す
...
//	RET	なし
//********************************************************************************
void	CfrmUc121TotiuriageI::virRowButtonCopyProc()
{
...
//	RET	なし
//********************************************************************************
void	CfrmUc121TotiuriageI::virTblGetKamokuInfo( CdbUc000Common* rsData, SORTKAMOKU_INFO* uKamoku )
{
...
//	RET	なし
//********************************************************************************
void	CfrmUc121TotiuriageI::virGetCurrentInfo( CURRENT_INFO* uCurInfo )
{
...
//	【戻値】	なし
//**************************************************
void CfrmUc121TotiuriageI::ConvertSpDate2( int nIndex )
{
	// 売上商品の取得年
	char			cGengou = 0;		//	元号
	char			cWareki = 0;		//	和暦
...
//	【戻値】	なし
//**************************************************
void CfrmUc121TotiuriageI::SetInputMode( int nRow, long nMode )
{
	m_pDiag->ModifyItem( CmnGetControlIndex( nRow, ID_COL_121I_KUBUN ), nMode );	//	区分
	m_pDiag->ModifyItem( CmnGetControlIndex( nRow, ID_COL_121I_AD2ADD1 ), nMode );	//	商品の所在地（上段）
	m_pDiag->ModifyItem( CmnGetControlIndex( nRow, ID_COL_121I_AD2ADD2 ), nMode );	//	商品の所在地（下段）
	m_pDiag->ModifyItem( CmnGetControlIndex( nRow, ID_COL_121I_HDNAME ), nMode );	//	地目
	m_pDiag->ModifyItem( CmnGetControlIndex( nRow, ID_COL_121I_AREA ), nMode );		//	総面積
	m_pDiag->ModifyItem( CmnGetControlIndex( nRow, ID_COL_121I_SPDATE ), nMode );	//	売上年月
	m_pDiag->ModifyItem( CmnGetControlIndex( nRow, ID_COL_121I_INVONOT ), nMode );	//	登録番号（T選択）
	m_pDiag->ModifyItem( CmnGetControlIndex( nRow, ID_COL_121I_INVONO), nMode);		//	登録番号
	m_pDiag->ModifyItem( CmnGetControlIndex( nRow, ID_COL_121I_ADNAME1 ), nMode );	//	氏名
	m_pDiag->ModifyItem( CmnGetControlIndex( nRow, ID_COL_121I_ADADD1 ), nMode );	//	住所（上段）
	m_pDiag->ModifyItem( CmnGetControlIndex( nRow, ID_COL_121I_ADADD2 ), nMode );	//	住所（下段）
	m_pDiag->ModifyItem( CmnGetControlIndex( nRow, ID_COL_121I_AREA2 ), nMode );	//	売上面積
	m_pDiag->ModifyItem( CmnGetControlIndex( nRow, ID_COL_121I_VAL ), nMode );		//	売上金額（上段）
	m_pDiag->ModifyItem( CmnGetControlIndex( nRow, ID_COL_121I_VAL2 ), nMode );		//	売上金額（下段）
	m_pDiag->ModifyItem( CmnGetControlIndex( nRow, ID_COL_121I_SPDATE2 ), nMode );	//	売上商品の取得年（元号）
	m_pDiag->ModifyItem( CmnGetControlIndex( nRow, ID_COL_121I_SPDATE3 ), nMode );	//	売上商品の取得年（年）
}
...
//	【戻値】	なし
//**************************************************
void CfrmUc121TotiuriageI::SetDiagBackColor()
{
...
//***************************************************************************
BOOL CfrmUc121TotiuriageI::virEndProc(void)
{
	TRACE(_T("***** CfrmUc121TotiuriageI::virEndProc\n"));
...
void CfrmUc121TotiuriageI::ComboNew(short index)
{
	short			sv_sel=0;
...
int CfrmUc121TotiuriageI::CursorControl(short nChar, int sw)
{
	int				rv=0;
	int				intCol=0;
	int				pos=0;
	...
	// 例外処理：売上商品の取得年でShift+Tab、F2キー、←/→キーが押下された場合は値を元に戻す
	if((nChar == VK_TAB && (key & 0x80) == 0x80) || nChar == VK_LEFT || nChar == VK_RIGHT)	{
		...
		switch(intCol)	{
			case ID_COL_121I_INVONOT:	// 登録番号(T選択)
				...
				CmnDiagSetCombo(m_pDiag, m_uInfo.intCurCtlIndex, m_uInfo.OldCombo);
				break;
			case ID_COL_121I_SPDATE2:	// 売上商品の取得年
				m_pDiag->ComboDropDown(m_uInfo.intCurCtlIndex, FALSE);
				CmnDiagSetCombo(m_pDiag, m_uInfo.intCurCtlIndex, m_uInfo.OldCombo);
				break;
			default:
...
void CfrmUc121TotiuriageI::ComboSelYoushikidiag1(short index, LPUNKNOWN data)
{
...
// ------------------------------------------------------------------------------------------------------------------------
void CfrmUc121TotiuriageI::TitleColorChg(void)
{
...
// --------------------------------------------------------------------------------------------------------
void CfrmUc121TotiuriageI::Date_ChkAndSet(short index, int col, short sign)
{
	short			sv_sel=0;
	int				sv_index=0;
	int				day=0,gen=0;
	...
	if(m_DataKakutei == TRUE)		return;
	if(col != ID_COL_121I_SPDATE)	return;
	...
	if(sign == 1)	{
		if(col == ID_COL_121I_SPDATE)	{		// 売上年月
...
LRESULT CfrmUc121TotiuriageI::OnUserReDrawView(WPARAM wParam, LPARAM lParam)
{
	virUpdateControlTblData();
	CmnDiagSetFocus(m_pDiag, 1, 1);
...
//		RET		なし
// --------------------------------------------------------------------------------------------------------
void CfrmUc121TotiuriageI::virDiagGetHjnData(CDatabase* pDB, HJN_REC_NEW* phjnRec)
{
	int				nPage,nRow;
	int				intIndex;	// 対象行の各インデックス
	int				tsel=0;
	...
	// 登録番号（法人番号）
	cst.Empty();
	intIndex = CmnGetControlIndex(nRow, ID_COL_121I_INVONO);
	...
	// 名称1(氏名)
	intIndex = CmnGetControlIndex(nRow, ID_COL_121I_ADNAME1);
	...
	// 所在地1(住所)
	intIndex = CmnGetControlIndex(nRow, ID_COL_121I_ADADD1);
	cst = m_clsFunc.DiagGetString(m_pDiag, intIndex);
	cst.TrimRight();
	if(cst.IsEmpty() == FALSE)	{
		memset(buf, 0, sizeof(buf));
	...
	// 所在地2(住所)
	intIndex = CmnGetControlIndex(nRow, ID_COL_121I_ADADD2);
	cst = m_clsFunc.DiagGetString(m_pDiag, intIndex);
	cst.TrimRight();
	if(cst.IsEmpty() == FALSE) {
		memset(buf, 0, sizeof(buf));
...
//		RET		なし
// --------------------------------------------------------------------------------------------------------
void	CfrmUc121TotiuriageI::virDiagSetHjnData(int pSw, CString rtInvNo, CString rtName, CString rtAdrs1, CString rtAdrs2, CString rtKana)
{
	int					ret = 0;
	int					intIndex;
...
// 修正No.168361,168369,168371,168378 del <--
		// 登録番号（T選択）
		intIndex = CmnGetControlIndex(m_uInfo.intCurRow, ID_COL_121I_INVONOT);
		CmnDiagSetCombo3(m_pDiag, intIndex, strInvoNo);

		// 登録番号
		InvoNoSplit(strInvoNo, &cs1, &cs2);
		intIndex = CmnGetControlIndex(m_uInfo.intCurRow, ID_COL_121I_INVONO);
...
// --------------------------------------------------------------------------------------------------------
// --------------------------------------------------------------------------------------------------------
int CfrmUc121TotiuriageI::virCallChkInvoiceNum(int pSw, int inPage, int inRow)
{
...
//				CString		pInvno	登録番号
// --------------------------------------------------------------------------------------------------------
int CfrmUc121TotiuriageI::ChkInvoiceNum(CDatabase* pDB, int pSw, int inPage, int inRow,
...
// 修正No.168361,168369,168371,168378 del -->
	...
	//		DIAGRAM_DATA	ddata;
	//		ddata.data_combo = 0;
	//		m_pDiag->SetData(CmnGetControlIndex(inRow, ID_COL_121I_INVONOT), (LPUNKNOWN)&ddata);
	//		ddata.data_edit.Empty();
	//		m_pDiag->DataClear(CmnGetControlIndex(inRow, ID_COL_121I_INVONO), TRUE);
	//		// エラーメッセージを表示
...
// 修正No.168443 add <--
			...
			if(pZmSel && pZmSel->IsDisplay() != FALSE && cst.GetLength() < 3) {
				...
				if(tmpzd.errflg != -1) {
					...
					m_pDiag->SetData(CmnGetControlIndex(inRow, ID_COL_121I_INVONO), (LPUNKNOWN)&ddata);
					// 再描画
					m_pDiag->Refresh();
...
// 修正No.168425,168443 add -->
					if(pSw == 3 || m_EndSyorityu == 1)	{
						...
						m_uInfo.intCurCol = ID_COL_121I_INVONO;
