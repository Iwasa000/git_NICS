// dbUc161Zatueki.cpp : インプリメンテーション ファイル
//
...
IMPLEMENT_DYNAMIC(CdbUc161Zatueki, CdbUc000Common)

CdbUc161Zatueki::CdbUc161Zatueki(CDatabase* pdb)
	: CdbUc000Common(pdb)
{
	//{{AFX_FIELD_INIT(CdbUc161Zatueki)
	m_Seq = 0;
	m_NumPage = 0;
	m_NumRow = 0;
	m_FgFunc = 0;
...
// midori 152137 add <--
	...
	m_lo_TableName = STR_TBL_NAME_161;			// テーブル名を記述
}


CString CdbUc161Zatueki::GetDefaultSQL()
{
	return _T("[dbo].[uc_161_zatueki]");
}

void CdbUc161Zatueki::DoFieldExchange(CFieldExchange* pFX)
{
	//{{AFX_FIELD_MAP(CdbUc161Zatueki)
...
#ifdef _DEBUG
void CdbUc161Zatueki::AssertValid() const
{
	CRecordset::AssertValid();
}

void CdbUc161Zatueki::Dump(CDumpContext& dc) const
{
	CRecordset::Dump(dc);
}
#endif //_DEBUG
...
/**********************************************************************
	...
	戻値
			int					DB_ERR_OK (0)     ：成功
								DB_ERR_OK (0) 以外：失敗
***********************************************************************/
int CdbUc161Zatueki::CreateNewRecord()
{
...
//								DB_ERR_OK (0) 以外：失敗
//***********************************************************************/
//int CdbUc161Zatueki::CreateNewRecord2(int pNumPage,int pNumRow)
// 157153 del <--
// 157153 add -->
// ------------------------------------------------------------------------------------------------
//	CreateNewRecord2()
...
//
// ------------------------------------------------------------------------------------------------
int CdbUc161Zatueki::CreateNewRecord2(int pNumPage,int pNumRow,int pNullSw)
// 157153 add <--
{
	CRecordset	rs(m_lo_pdb);
	CString		SqlStr;
...
//								DB_ERR_OK (0) 以外：失敗
//***********************************************************************/
//int CdbUc161Zatueki::UpdateYokukiZeroClear()
//{
...
/**********************************************************************
	...
	戻値
			int					DB_ERR_OK (0)     ：成功
								DB_ERR_OK (0) 以外：失敗
***********************************************************************/
int CdbUc161Zatueki::UpdateYokukiZeroClear( int pSw )
{
// midori 152388 add -->
	CString	cs=_T("");
// midori 152388 add <--
...
/**********************************************************************
	...
	戻値
			int						正の数：行数
									...
									0     ：行なし
***********************************************************************/
int CdbUc161Zatueki::GetKnNameFirstRow(int inPage, CString* pstrKnName, CString strTable)
{
...
***********************************************************************/
// virtual
int CdbUc161Zatueki::UpdateDataTableWork()
{
...
***********************************************************************/
long CdbUc161Zatueki::GetColumnSortAddressBank(BYTE ItemSeq)
{
...
***********************************************************************/
// virtual
int CdbUc161Zatueki::GetSortIkkatuOrder()
{
	return m_KnOrder;
}