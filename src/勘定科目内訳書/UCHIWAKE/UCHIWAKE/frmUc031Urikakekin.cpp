...
IMPLEMENT_DYNCREATE( CfrmUc031Urikakekin, CfrmUc000Common )


BEGIN_MESSAGE_MAP( CfrmUc031Urikakekin, CfrmUc000Common )
	ON_WM_SIZE()
...
//	ON_COMMAND( ID_BUTTON_F3, OnButtonF3 )
	...
	ON_COMMAND( ID_PRINTSETUP_MENU, &CfrmUc031Urikakekin::OnMenuPrintSetup )
	ON_COMMAND( ID_PRINTALL_MENU, &CfrmUc031Urikakekin::OnMenuPrintAll )
//	ON_COMMAND( ID_OUTPUTFORM_MENU, &CfrmUc031Urikakekin::OnMenuFormTypeSetup )
	ON_COMMAND( ID_SPECIALROW_MENU, &CfrmUc031Urikakekin::OnMenuSpecialRow )
	ON_COMMAND( ID_SORT_MENU, &CfrmUc031Urikakekin::OnMenuSort )
	ON_COMMAND(ID_IKKATUADD_MENU, &CfrmUc031Urikakekin::OnIkkatuAddMenu)
	ON_COMMAND( ID_DISPDIALOG_MENU, &CfrmUc031Urikakekin::OnMenuIkkatuKingaku )
	ON_COMMAND( ID_ZEROMONEY_MENU, &CfrmUc031Urikakekin::OnMenuZeroMoney )
	ON_COMMAND( ID_ZEROMONEYMOVE_MENU, &CfrmUc031Urikakekin::OnMenuZeroMoneyMove )
	ON_COMMAND( ID_AMOUTDIALOG_MENU, &CfrmUc031Urikakekin::OnMenuOutKeiSetup )
// midori 160606 add -->
	ON_COMMAND( ID_CLEAR_MENU, &CfrmUc031Urikakekin::OnMenuClear )
// midori 160606 add <--
	ON_COMMAND( ID_RENDO_MENU, &CfrmUc031Urikakekin::OnMenuZaimuRendo )
	ON_COMMAND( ID_TITLEMENU, &CfrmUc031Urikakekin::OnMenuTitleRestore )
	ON_COMMAND( ID_USER_SETTING_MENU, &CfrmUc031Urikakekin::OnMenuOptionSetting )
	ON_COMMAND( ID_COPY_SETTING_INFO_MENU, &CfrmUc031Urikakekin::OnMenuCopySettingInfo )
	ON_COMMAND( ID_DELETE_DATA_MENU, &CfrmUc031Urikakekin::OnMenuDeleteDataEachYoushiki )
	ON_BN_CLICKED( IDC_PAGEBACK_BUTTON1, &CfrmUc031Urikakekin::OnPageBack )
	ON_BN_CLICKED( IDC_PAGENEXT_BUTTON1, &CfrmUc031Urikakekin::OnPageNext )
	ON_BN_CLICKED( IDC_PAGENEW_BUTTON1, &CfrmUc031Urikakekin::OnPageNew )
	ON_BN_CLICKED( IDC_PAGEINSERT_BUTTON1, &CfrmUc031Urikakekin::OnPageInsert )
	ON_BN_CLICKED( IDC_ROWCOPY_BUTTON1, &CfrmUc031Urikakekin::OnRowCopy )
	ON_BN_CLICKED( IDC_ROWPASTE_BUTTON1, &CfrmUc031Urikakekin::OnRowPaste )
	ON_BN_CLICKED( IDC_ROWINSERT_BUTTON1, &CfrmUc031Urikakekin::OnRowInsert )
	ON_BN_CLICKED( IDC_YOUSHIKINEXT_BUTTON1, &CfrmUc031Urikakekin::OnMoveYoushikiNext )
	ON_BN_CLICKED( IDC_YOUSHIKIBACK_BUTTON1, &CfrmUc031Urikakekin::OnMoveYoushikiBack )
//	ON_UPDATE_COMMAND_UI( ID_BUTTON_F1, &CfrmUc031Urikakekin::OnUpdateButtonF1 )
//	ON_UPDATE_COMMAND_UI( ID_BUTTON_F3, &CfrmUc031Urikakekin::OnUpdateButtonF3 )
	ON_UPDATE_COMMAND_UI( ID_BUTTON_F6, &CfrmUc031Urikakekin::OnUpdateButtonF6 )
	ON_UPDATE_COMMAND_UI( ID_BUTTON_F7, &CfrmUc031Urikakekin::OnUpdateButtonF7 )
	ON_UPDATE_COMMAND_UI( ID_BUTTON_F8, &CfrmUc031Urikakekin::OnUpdateButtonF8 )
	ON_UPDATE_COMMAND_UI( ID_BUTTON_F9, &CfrmUc031Urikakekin::OnUpdateButtonF9 )
	ON_UPDATE_COMMAND_UI( ID_BUTTON_F11, &CfrmUc031Urikakekin::OnUpdateButtonF11 )
	ON_UPDATE_COMMAND_UI( ID_BUTTON_F12, &CfrmUc031Urikakekin::OnUpdateButtonF12 )
	ON_UPDATE_COMMAND_UI( ID_BUTTON_HOME, &CfrmUc031Urikakekin::OnUpdateButtonHome )
	ON_UPDATE_COMMAND_UI( ID_IKKATUADD_MENU, &CfrmUc031Urikakekin::OnUpdateIkkatuaddMenu)
	ON_UPDATE_COMMAND_UI( ID_DISPDIALOG_MENU, &CfrmUc031Urikakekin::OnUpdateMenuIkkatuKingaku )
// midori 160612 add -->
	ON_UPDATE_COMMAND_UI( ID_SORT_MENU, &CfrmUc031Urikakekin::OnUpdateMenuSort )
	ON_UPDATE_COMMAND_UI( ID_CLEAR_MENU, &CfrmUc031Urikakekin::OnUpdateMenuClear )
// midori 160612 add <--
	ON_UPDATE_COMMAND_UI( ID_ZEROMONEY_MENU, &CfrmUc031Urikakekin::OnUpdateMenuZeroMoney )
// midori 160612 add -->
	ON_UPDATE_COMMAND_UI( ID_ZEROMONEYMOVE_MENU, &CfrmUc031Urikakekin::OnUpdateMenuZeroMoneyMove)
// midori 160612 add <--
	ON_UPDATE_COMMAND_UI( ID_RENDO_MENU, &CfrmUc031Urikakekin::OnUpdateMenuZaimuRendo )
	ON_UPDATE_COMMAND_UI(ID_SPECIALROW_MENU, &CfrmUc031Urikakekin::OnUpdateMenuSpecialRow)
// midori 160612 add -->
	ON_UPDATE_COMMAND_UI( ID_TITLEMENU, &CfrmUc031Urikakekin::OnUpdateMenuTitleRestore )
	ON_UPDATE_COMMAND_UI( ID_DELETE_DATA_MENU, &CfrmUc031Urikakekin::OnUpdateMenuDeleteDataEachYoushiki )
// midori 160612 add <--
	ON_MESSAGE(WM_USER_REDRAWVIEW, OnUserReDrawView)		// 修正No.162446 add
END_MESSAGE_MAP()


CfrmUc031Urikakekin::CfrmUc031Urikakekin()
	: CfrmUc000Common( CfrmUc031Urikakekin::IDD )
{
...
CfrmUc031Urikakekin::~CfrmUc031Urikakekin()
{
	...
	TRACE(_T("***** CfrmUc031Urikakekin::~CfrmUc031Urikakekin\n"));

	//m_pDiag = NULL;
	//m_pTitleDiag = NULL;
}

void CfrmUc031Urikakekin::DoDataExchange( CDataExchange* pDX )
{
...
void CfrmUc031Urikakekin::OnInitialUpdate()
{
...
#ifdef _DEBUG
void CfrmUc031Urikakekin::AssertValid() const
{
	CfrmUc000Common::AssertValid();
}

#ifndef _WIN32_WCE
void CfrmUc031Urikakekin::Dump( CDumpContext& dc ) const
{
...
BEGIN_EVENTSINK_MAP( CfrmUc031Urikakekin, CfrmUc000Common )
	ON_EVENT( CfrmUc031Urikakekin, IDC_YOUSHIKIDIAG1, 3, CfrmUc031Urikakekin::TerminationYoushikidiag1, VTS_I2 VTS_I2 VTS_I2 VTS_UNKNOWN )
	ON_EVENT( CfrmUc031Urikakekin, IDC_YOUSHIKIDIAG1, 2, CfrmUc031Urikakekin::EditOFFYoushikidiag1, VTS_I2 )
	ON_EVENT( CfrmUc031Urikakekin, IDC_YOUSHIKIDIAG1, 1, CfrmUc031Urikakekin::EditONYoushikidiag1, VTS_I2 )
// midori 151405 add -->
	ON_EVENT(CfrmUc031Urikakekin, IDC_YOUSHIKIDIAG1, 12, CfrmUc031Urikakekin::VScrollYoushikidiag1, VTS_I2)
// midori 151405 add <--
// midori 152134 add -->
	ON_EVENT(CfrmUc031Urikakekin, IDC_YOUSHIKIDIAG1, 8, CfrmUc031Urikakekin::ComboSelYoushikidiag1, VTS_I2 VTS_UNKNOWN)
// midori 152134 add <--

	ON_EVENT( CfrmUc031Urikakekin, IDC_YOUSHIKIDIAG2, 3, CfrmUc031Urikakekin::TerminationYoushikidiag1, VTS_I2 VTS_I2 VTS_I2 VTS_UNKNOWN )
	ON_EVENT( CfrmUc031Urikakekin, IDC_YOUSHIKIDIAG2, 2, CfrmUc031Urikakekin::EditOFFYoushikidiag1, VTS_I2 )
	ON_EVENT( CfrmUc031Urikakekin, IDC_YOUSHIKIDIAG2, 1, CfrmUc031Urikakekin::EditONYoushikidiag1, VTS_I2 )
// midori 151405 add -->
	ON_EVENT(CfrmUc031Urikakekin, IDC_YOUSHIKIDIAG2, 12, CfrmUc031Urikakekin::VScrollYoushikidiag1, VTS_I2)
// midori 151405 add <--
// midori 152134 add -->
	ON_EVENT(CfrmUc031Urikakekin, IDC_YOUSHIKIDIAG2, 8, CfrmUc031Urikakekin::ComboSelYoushikidiag1, VTS_I2 VTS_UNKNOWN)
// midori 152134 add <--

	ON_EVENT( CfrmUc031Urikakekin, IDC_TITLEDIAG1, 3, CfrmUc031Urikakekin::TerminationTitlediag1, VTS_I2 VTS_I2 VTS_I2 VTS_UNKNOWN )
	ON_EVENT( CfrmUc031Urikakekin, IDC_TITLEDIAG1, 2, CfrmUc031Urikakekin::EditOFFTitlediag1, VTS_I2 )
	ON_EVENT( CfrmUc031Urikakekin, IDC_TITLEDIAG1, 1, CfrmUc031Urikakekin::EditONTitlediag1, VTS_I2 )
	ON_EVENT( CfrmUc031Urikakekin, IDC_TITLEDIAG1, 6, CfrmUc031Urikakekin::FocusTitlediag1, VTS_NONE )

	ON_EVENT( CfrmUc031Urikakekin, IDC_PAGEDIAG1, 3, CfrmUc031Urikakekin::TerminationPagediag1, VTS_I2 VTS_I2 VTS_I2 VTS_UNKNOWN )
	ON_EVENT( CfrmUc031Urikakekin, IDC_PAGEDIAG1, 2, CfrmUc031Urikakekin::EditOFFPagediag1, VTS_I2 )
	ON_EVENT( CfrmUc031Urikakekin, IDC_PAGEDIAG1, 1, CfrmUc031Urikakekin::EditONPagediag1, VTS_I2 )
	ON_EVENT( CfrmUc031Urikakekin, IDC_PAGEDIAG1, 6, CfrmUc031Urikakekin::FocusPagediag1, VTS_NONE )
END_EVENTSINK_MAP()

//********************************************************************************
//	初期処理
//********************************************************************************
BOOL	CfrmUc031Urikakekin::virStartJob()
{
	// 初期値設定
...
//	共通データの初期値設定
//********************************************************************************
void	CfrmUc031Urikakekin::virSetInitialUchiwakeInfo()
{
	// 「売掛金」の固有データ
	...
	m_uInfo.intColMax = ID_COLMAX_031;				// １行内のコントロール個数
	m_uInfo.intColMaxData = ID_COLMAXDATA_031;		// １行内の列数
	m_uInfo.intCtlStartIndex = ID_CTLSTARTINDEX_031;// １行目の入力項目の先頭インデックス番号
	m_uInfo.intT1StartIndex = ID_T1STARTNORMAL_031;	// 合計行①の先頭インデックス番号
	m_uInfo.intT2StartIndex = ID_T2STARTNORMAL_031;	// 合計行②の入力項目の先頭インデックス番号
	m_uInfo.intCursolDefPos = ID_COL_031_ADNAME1;	// カーソル移動時の初期位置（タイトルから↓，合計から↑で使用）
	m_uInfo.intCursolKeiPos = ID_COL_031_KNSEQ;		// 合計行のカーソル移動位置（カーソル移動で使用）
	...
	m_uInfo.intT1StartNormal = ID_T1STARTNORMAL_031;// 通常時：合計行①の先頭インデックス
	m_uInfo.intT2StartNormal = ID_T2STARTNORMAL_031;// 通常時：合計行②の先頭インデックス
	m_uInfo.intT1StartKobetu = ID_T1STARTKOBETU_031;// 個別時：合計行①の先頭インデックス
	m_uInfo.intT2StartKobetu = ID_T2STARTKOBETU_031;// 個別時：合計行②の先頭インデックス
	m_uInfo.intRowKei = ID_ROWKEI_031;				// 帳表固定の合計行数（1:合計あり，0:なし）
	m_uInfo.intKei1StartIndex = ID_COL_031_KEI1_MEISYO;	// 計ダイアグラム1行目の先頭インデックス
	m_uInfo.intKei2StartIndex = ID_COL_031_KEI2_MEISYO;	// 計ダイアグラム2行目の先頭インデックス
...
//	【戻値】	なし
//**************************************************
void CfrmUc031Urikakekin::virSetInitialDiag()
{	
	// オブジェクト未生成時は処理を抜ける
	...
	//	コンボボックスの属性取得
	nIndex = CmnGetControlIndex( 1, ID_COL_031_KNSEQ );
...
//	帳表固有変数の初期値設定
//********************************************************************************
void	CfrmUc031Urikakekin::virSetInitialValue()
{
	// 1ページ分のローカルバッファをクリア
	RecBufClearAllData();
...
//	帳表コントロールの初期化（データ領域）
//********************************************************************************
BOOL	CfrmUc031Urikakekin::InitialControlDataArea()
{
	int		intMax;
	int		i;
// No.200903 add -->
...
// No.200903 add <--
	...
	for ( i = m_uInfo.intCtlStartIndex; i < intMax; i += m_uInfo.intColMax ) {
		// ComboBox：クリア
		CmnDiagSetString( m_pDiag, i + ID_COL_031_KNSEQ - 1, "", 0 );	// 科目
		
		// 漢字入力欄の初期化
		CmnDiagSetAttrInpmax( m_pDiag, i + ID_COL_031_ADNAME1    - 1, MAX_KETA_031_ADNAME1 );		//	名称１
		CmnDiagSetAttrInpmax( m_pDiag, i + ID_COL_031_ADADD1    - 1, MAX_KETA_031_ADADD1 );			//	住所１
		CmnDiagSetAttrInpmax( m_pDiag, i + ID_COL_031_ADADD2    - 1, MAX_KETA_031_ADADD2 );			//	住所２
		CmnDiagSetAttrInpmax( m_pDiag, i + ID_COL_031_TEKI    - 1, MAX_KETA_031_TEKI );				//	摘要
		
		// 金額欄：桁数初期化
// No.200903 del -->
		//CmnDiagSetAttrDigit( m_pDiag, i + ID_COL_031_VAL - 1, ID_VAL_031_DATA );	// 期末現在高
// No.200903 del <--
// No.200903 add -->
		if(bG_Kanso == TRUE)	len = ID_VAL_031_K_DATA;
		else					len = ID_VAL_031_DATA;
		CmnDiagSetAttrDigit( m_pDiag, i + ID_COL_031_VAL - 1, len );	// 期末現在高
// No.200903 add <--
	...
	// 半角/全角設定
	CmnDiagSetAttrColZenHan( m_pDiag , ID_COL_031_ADNAME1 );		// 名称1(氏名)
	CmnDiagSetAttrColZenHan( m_pDiag , ID_COL_031_ADADD1 );		// 所在地1(住所)
	CmnDiagSetAttrColZenHan( m_pDiag , ID_COL_031_ADADD2 );		// 所在地2(住所)
	CmnDiagSetAttrColZenHan( m_pDiag , ID_COL_031_TEKI );		// 摘要
...
//********************************************************************************
BOOL	CfrmUc031Urikakekin::InitialControlComboBox()
{
	...
	for ( i = 1; i <= intMax; i++ ) {
		...
		intIndex = CmnGetControlIndex( i, ID_COL_031_KNSEQ );
...
//********************************************************************************
void	CfrmUc031Urikakekin::InitialControlTotalArea()
{
	int		nKeiType;			//	計の種別
	int		nDataRow;			//	データ行属性
...
// 修正No.157898 add -->
	if(flg2 == 1)	{
		// 一括自動行の科目を入力可能にする
		m_pDiag->ModifyItem( CmnGetControlIndex( (nDataRowPos+1), ID_COL_031_KNSEQ ), (DIAG_MDFY_EDIT | DIAG_MDFY_OPAQUE) );
	}
// 修正No.157898 add <--
...
// midori 152166 add <--
	...
	m_pDiagKei->ModifyItem(ID_COL_031_KEI1_VAL, intKeiRow);
	m_pDiagKei->ModifyItem(ID_COL_031_KEI2_VAL, intKeiRow);
	...
	//m_pDiag->ModifyItem( CmnGetControlTotalIndex( 1, ID_COL_031_KNSEQ ), nKeiRow[0] );
	//m_pDiag->ModifyItem( CmnGetControlTotalIndex( 2, ID_COL_031_KNSEQ ), nKeiRow[1] );
	
// No.200903 del -->
	//// 合計行の金額欄は、金額欄 + 1桁
	//CmnDiagSetAttrDigit( m_pDiagKei, ID_COL_031_KEI1_VAL, ID_VAL_031_TOTAL );
	//CmnDiagSetAttrDigit( m_pDiagKei, ID_COL_031_KEI2_VAL, ID_VAL_031_TOTAL );
	////CmnDiagSetAttrDigit( m_pDiag, CmnGetControlTotalIndex( 1, ID_COL_031_VAL ), ID_VAL_031_TOTAL );
	////CmnDiagSetAttrDigit( m_pDiag, CmnGetControlTotalIndex( 2, ID_COL_031_VAL ), ID_VAL_031_TOTAL );
// No.200903 del <--
}
...
//	RET	なし
//********************************************************************************
void	CfrmUc031Urikakekin::InitialControlSpecialRow( int intRow, int intFgFunc )
{
// No.200903 add -->
	int				len=0;
// No.200903 add <--
...
// No.200903 add <--
		// 桁数を設定
// No.200903 del -->
		//CmnDiagSetAttrDigit( m_pDiag, CmnGetControlIndex( intRow , ID_COL_031_VAL ), ID_VAL_031_TOTAL );
// No.200903 del <--
// No.200903 add -->
		if(bG_Kanso == TRUE)	len = ID_VAL_031_K_TOTAL;
		else					len = ID_VAL_031_TOTAL;
		CmnDiagSetAttrDigit(m_pDiag, CmnGetControlIndex(intRow, ID_COL_031_VAL), len);
// No.200903 add <--
		break;
	}
	...
	case ID_FGFUNC_IKKATUAUTO:		// 一括集計金額行（自動）
		...
		if ( intFgFunc != ID_FGFUNC_IKKATUAUTO ){
			...
			m_pDiag->ModifyItem( CmnGetControlIndex( intRow, ID_COL_031_KNSEQ ), DIAG_MDFY_NODROPDOWN );

			// ComboBoxの選択項目クリア
			m_clsFunc.DiagInit( &diadata );
			diadata.text_combo = _T( "\r\n" );
			m_pDiag->SetData( CmnGetControlIndex( intRow, ID_COL_031_KNSEQ ), (LPUNKNOWN)&diadata );
		}
...
// 改良No.21-0086,21-0529 cor <--
			...
			if (intFgFunc == ID_FGFUNC_IKKATUAUTO ){
				//	科目
				m_pDiag->ModifyItem( CmnGetControlIndex( intRow, ID_COL_031_KNSEQ ), DIAG_MDFY_INPUT );
			}
		}
// No.200905 add <--
...
//	帳表タイトル情報の表示
//********************************************************************************
void	CfrmUc031Urikakekin::virUpdateControlTitle()
{
...
//	帳表ページ情報の表示
//********************************************************************************
void	CfrmUc031Urikakekin::UpdateControlPage()
{
	BOOL	bBack = TRUE;
	BOOL	bNext = TRUE;
...
//	帳表データの表示（１ページ分）
//********************************************************************************
BOOL	CfrmUc031Urikakekin::virUpdateControlTblData()
{
// No.200903 add -->
	int len = 0;
// No.200903 add <--
...
// No.200903 add -->
	...
	CmnDiagSetAttrDigit( m_pDiagKei, ID_COL_031_KEI1_VAL, len );
	CmnDiagSetAttrDigit( m_pDiagKei, ID_COL_031_KEI2_VAL, len );
// No.200903 add <--
...
// No.200601 add -->
		...
		if(bG_Kanso == TRUE) {
			...
			// 科目
			CmnInitialControlFgStringCell( m_pDiag, dbRec.m_NumRow, ID_COL_031_KNSEQ, dbRec.m_FgFunc, UC_KAMOKU_LEN, dbRec.m_KnName);
			// 摘要
			CmnInitialControlFgStringCell( m_pDiag, dbRec.m_NumRow, ID_COL_031_TEKI, dbRec.m_FgFunc, UC_031_TEKI_LEN, dbRec.m_Teki);
		}
// No.200601 add <--
...
//	保管件数の表示
//********************************************************************************
BOOL CfrmUc031Urikakekin::virUpdateControlTblData2()
{
	int					hcnt=0;
	CString				cs=_T("");
...
//		RET		なし
//********************************************************************************
void	CfrmUc031Urikakekin::UpdateControlRowData( CdbUc031Urikakekin* prmDbRec ) {
	...
	m_clsFunc.DiagInit( &diadata );
	// 読込み対象セル取得
	intCell = CmnGetControlIndex( prmDbRec->m_NumRow, ID_COL_031_KNSEQ );
...
//		RET		なし
//********************************************************************************
void	CfrmUc031Urikakekin::UpdateControlRowTotal( CdbUc031Urikakekin* prmDbRec ) {
	...
	// 頁計/累計の名称表示
	if ( intRowName > 0 ) {
		//CmnDiagSetString( m_pDiag, CmnGetControlTotalIndex( intRowName, ID_COL_031_KNSEQ ), prmDbRec->m_KeiStr, 0 );
		CmnDiagSetString( m_pDiagKei, CmnGetKeiDiagIndex( intRowName, ID_COL_031_KEI1_MEISYO ), prmDbRec->m_KeiStr, 1 );
	}
	// 頁計/累計の金額表示
	if ( intRowVal > 0 ) {
		//CmnDiagSetKingaku( m_pDiag, CmnGetControlTotalIndex( intRowName, ID_COL_031_VAL ), prmDbRec->m_Val );
		CmnDiagSetKingaku( m_pDiagKei, CmnGetKeiDiagIndex( intRowVal, ID_COL_031_KEI1_VAL ), prmDbRec->m_Val );
	}
}
...
//		RET		なし
//********************************************************************************
void	CfrmUc031Urikakekin::virFncCellCopyProc( CdbUc000Common* rsData )
{
...
//********************************************************************************
int	CfrmUc031Urikakekin::virFncReferenceGetType(int intCol, int* intGrSeq, long* lngItemSeq, int* intAdd1, int* intAdd2, int* intAdd1Col, int* intAdd2Col, REFERENCE_INFO* pudReference )
{
	int				intRefType;
	...
	//case ID_COL_031_ADADD2:
		...
		*lngItemSeq = m_ReadData[m_uInfo.intCurRow].m_AdSeq;
		// 住所欄なら住所１、２の列番号取得
		//if ( intCol != ID_COL_031_ADNAME1 ){
		//	*intAdd1Col = ID_COL_031_ADADD1;
		//	*intAdd2Col = ID_COL_031_ADADD2;
		//}
		break;
	...
	case ID_COL_031_ADADD2:
		...
		*intAdd1 = MAX_KETA_031_ADADD1/*20*/ * 2;			// Byte指定
		*intAdd2 = MAX_KETA_031_ADADD2/*20*/ * 2;			// Byte指定
		*intAdd1Col = ID_COL_031_ADADD1;
		*intAdd2Col = ID_COL_031_ADADD2;
		break;
...
//		RET		なし
//********************************************************************************
void	CfrmUc031Urikakekin::virFncReferenceSetData( CdlgReference* dlgRef, int intRefType, int intCol )
{
	int		nCurRow;	//	カレント行
	int		nCurCol;	//	カレント列
	int		nPos;		//	位置
...
// midori 152137 add <--
	...
	case ID_DLGTYPE_ADDRESS:
		...
		//	現在行の取引先の名称１の位置を算出
		nPos = (( nCurRow - 1 ) * m_uInfo.intColMax ) + ( m_uInfo.intCtlStartIndex + ( ID_COL_031_ADNAME1 - 1 ));
...
//		RET		なし
//********************************************************************************
void	CfrmUc031Urikakekin::virFncReferenceUpdateTbl( int intRefType, int nRefMode/*=0*/ )
{
	switch (intRefType) {
...
//@			mfcRec.UpdateDataTable( TBL_NAME_031 );
...
//		RET		なし
//********************************************************************************
void	CfrmUc031Urikakekin::virFncReferenceSetICSData(CdlgAddressSearch* dlgAddd)
{
	int			intIndex;

	// 相手先の所在地1(住所)
	intIndex = CmnGetControlIndex( m_uInfo.intCurRow, ID_COL_031_ADADD1 );
	CmnDiagSetString( m_pDiag, intIndex, dlgAddd->m_AdAdd1, 0 );

	// 相手先の所在地2(住所)
	intIndex = CmnGetControlIndex( m_uInfo.intCurRow, ID_COL_031_ADADD2 );
	CmnDiagSetString( m_pDiag, intIndex, dlgAddd->m_AdAdd2, 0 );
}

// 要通知案件修正 21/07/09 add -->
void CfrmUc031Urikakekin::virActivateFrameK(UINT nState, CFrameWnd* pDeactivateFrame)
{
	int		index = 0;
	...
	if(pWnd != NULL)	{
		if(m_DataKakutei == FALSE)	{
			if(m_uInfo.intCurCol == ID_COL_031_KNSEQ)	{
				virKamokuAddCancel();
			}
		}
	}
...
void CfrmUc031Urikakekin::virKamokuAddCancel()
{
	...
	// 科目列なら
	if(m_uInfo.intCurCol == ID_COL_031_KNSEQ && m_F9OnSw != TRUE)	{
		DIAGRAM_DATA	diadata;
		m_pDiag->GetData(m_uInfo.intCurCtlIndex,(LPUNKNOWN)&diadata);
		// 【新規作成】が選択されていれば
		if(diadata.data_combo > m_CmbCnt)	{
			// 前回の値に戻す
			CmnDiagSetCombo(m_pDiag,CmnGetControlIndex(m_uInfo.intCurRow,ID_COL_031_KNSEQ),m_uInfo.OldCombo);
		}
	}
}
// 要通知案件修正 21/07/09 add <--
...
//	その他イベント処理
//********************************************************************************
BOOL	CfrmUc031Urikakekin::PreTranslateMessage( MSG* pMsg )
{
//	int				intID;
...
//				if ((CmnGetControlCol() != ID_COL_031_KNSEQ) || (CmnCheckTotalRow() == TRUE )){
// midori 160611 del <--
				// カレントインデックスを保存
...
//				//}
//// ---------------------
//				if(CmnGetControlCol() == ID_COL_031_KNSEQ)	{
//					rv=1;
//				}
//// midori 160611 cor <--
// midori 152134 17/10/07 del <--
...
/*
		...
		case VK_TAB:
			...
			if ((intID == IDC_PAGEBACK_BUTTON1) && (CmnCheckShiftKey() == TRUE)) {
				...
				CmnDiagSetFocus(m_pDiag, m_uInfo.intRowMax, ID_COL_031_KNSEQ);
				return 1;
			}
			break;
*/
...
// 修正No.158259 add -->
				...
				intCol = CmnGetControlCol();
				if(intCol == ID_COL_031_KNSEQ && (pMsg->wParam == VK_LEFT || pMsg->wParam == VK_RIGHT))	{
...
// 頁コントロールのフォーカス設定
void	CfrmUc031Urikakekin::FocusPagediag1()
{
...
// 頁コントロールのゲットフォーカス
void	CfrmUc031Urikakekin::EditONPagediag1( short index )
{
// midori 151405 add -->
	// スクロールフラグをクリアする
	nG_MScroll = 0;
...
// midori 151405 add <--
	...
	// 1行登録
//	if( CmnGetControlCol() != ID_COL_031_VAL ){
...
// 頁コントロールのロストフォーカス
void	CfrmUc031Urikakekin::EditOFFPagediag1( short index )
{
// midori 155028 add -->
...
// 頁コントロールのキー操作
void	CfrmUc031Urikakekin::TerminationPagediag1( short index, short nChar, short length, LPUNKNOWN data )
{
	int nMaxDataCol = 0;
	// カレント頁の合計行の種別を取得
...
// midori 160612 cor <--
			...
			//CmnDiagSetFocus(m_pDiag, m_uInfo.intRowMax, ID_COL_031_KNSEQ);
			CmnDiagSetFocus(m_pDiag, nMaxDataCol, ID_COL_031_TEKI);
		}
		break;
	case VK_DOWN:
		// タイトルコントロールへ移動
...
// タイトルコントロールのフォーカス設定
void	CfrmUc031Urikakekin::FocusTitlediag1()
{
//マウスクリックでキャレットが表示できないためコメントとする
//	// ボタンからTabキー移動した場合に必要
//	m_TitleDiag.SetPosition( 0 );
...
// タイトルコントロールのゲットフォーカス
void	CfrmUc031Urikakekin::EditONTitlediag1( short index )
{
// midori 151405 add -->
	// スクロールフラグをクリアする
	nG_MScroll = 0;
...
// タイトルコントロールのロストフォーカス
void	CfrmUc031Urikakekin::EditOFFTitlediag1 (short index )
{
// midori 151405 add -->
	m_Titlefocus = 0;
// midori 151405 add <--
...
//	タイトル更新
void CfrmUc031Urikakekin::virUpdateTitle()
{
...
// タイトルコントロールのキーイベント
void	CfrmUc031Urikakekin::TerminationTitlediag1( short index, short nChar, short length, LPUNKNOWN data )
{
	// フォーカス移動
	switch ( nChar ) {
	case VK_RETURN:
...
void	CfrmUc031Urikakekin::EditONYoushikidiag1( short index )
{
	DIAGRAM_DATA	diadata;
...
//			if( CmnGetControlCol() != ID_COL_031_VAL ){
			...
			BOOL adadd1_to_adadd2 = IsSaveMoveReference(ID_COL_031_ADADD1, ID_COL_031_ADADD2);
			// [Home]キー押下の住所検索ダイアログの戻り（フォーカスをセットしている）は保存しない（改良依頼No15-1613）
			BOOL adadd1_to_adadd1 = IsSaveMoveReference(ID_COL_031_ADADD1, ID_COL_031_ADADD1);	// 所在地1(住所)→所在地1(住所)
			BOOL adadd2_to_adadd2 = IsSaveMoveReference(ID_COL_031_ADADD2, ID_COL_031_ADADD2);	// 所在地2(住所)→所在地2(住所)　所在地2から住所が長すぎる場合、ここがFALSEになる
...
// データコントロールのロストフォーカス
void	CfrmUc031Urikakekin::EditOFFYoushikidiag1( short index )
{
	if( m_EndView != FALSE )	return;
...
//	入力確定
void CfrmUc031Urikakekin::virInputDecisionEditOFF()
{
	// フォーカスフラグOFF
...
//		if(m_isF6 == FALSE && !(current_column == ID_COL_031_ADADD1)){
...
// 預貯金データコントロールのキーイベント
void	CfrmUc031Urikakekin::TerminationYoushikidiag1( short index, short nChar, short length, LPUNKNOWN data )
{
	//--------------------------------------------------------------------------------
	//	キー操作仕様
...
// midori 151405 add -->
void CfrmUc031Urikakekin::VScrollYoushikidiag1(short mode)
{
...
//********************************************************************************
int	CfrmUc031Urikakekin::GetFocusPosition( int nChar )
{
	int		intRow;					// カレント行番号
	int		intCol;					// カレント列番号
	...
	else if ( intCol == ID_COL_031_ADNAME1 ){
		// カレント列が「名称１」の場合
	...
	else if ( intCol == ID_COL_031_ADADD1 ){
		// カレント列が「住所１」の場合
	...
	else if ( intCol == ID_COL_031_ADADD2 ){
		// カレント列が「住所２」の場合
	...
	else if ( intCol == ID_COL_031_TEKI ){
		// カレント列が「取引の内容」の場合
		intVector[0] = m_uInfo.intCurCtlIndex - m_uInfo.intColMax;		// ↑
	...
	case VK_TAB:
		if (CmnCheckShiftKey() == FALSE) {
			...
			// それ以外は「←」キーと同じ
			if ((intRow <= 1) && (intCol == ID_COL_031_KNSEQ)) {
				return -1;
			}
...
//********************************************************************************
int	CfrmUc031Urikakekin::GetTotalRowIndex( int nCharOrg, int intIndex, int intNext )
{
	...
	if ( nNowRow <= nBorder[0] ){
		...
		if ( nNextRow > nBorder[0] ){
			//	計行に移動
			//nRet = CmnGetControlIndex( ( nBorder[1] + 1 ), ID_COL_031_KNSEQ );
			if (nCharOrg == VK_TAB) {
				return -2;
			}
		}
	...
	//	現在、頁計に居る
		...
		case VK_UP:			// ↑：23行目のデータ行の支店名項目へ移動
			nRet = CmnGetControlIndex( nBorder[0], ID_COL_031_ADNAME1 );
			break;
		case VK_LEFT:		// ←/Shift+Tab：23行目のデータ行の摘要項目へ移動
			nRet = CmnGetControlIndex( nBorder[0], ID_COL_031_TEKI );
			break;
		default:			// →/↓/Return/Tab：25行目の合計行②へ移動
			...
			//	累計あり
				...
				nRet = CmnGetControlIndex( ( nBorder[2] + 1 ), ID_COL_031_KNSEQ );
			}
			break;
		}
	}
...
//		RET		なし
//********************************************************************************
void	CfrmUc031Urikakekin::virTblEditIkkatuLine( int nType, CdbUc000Common* rsData,
...
//********************************************************************************
int	CfrmUc031Urikakekin::virTblSortSubSortProc( CdlgSort* pCdlgSort, CdbUc000Common* rsData )
{
	CdbUc031Urikakekin*	rs;
	CString				strFilter;
	CString				strSort;
...
/**********************************************************************
	...
	戻値
		int		成功/失敗
				FUNCTION_OK
***********************************************************************/
int	CfrmUc031Urikakekin::RecBufSetData( CdbUc031Urikakekin* prmDbRec )
{
...
/**********************************************************************
	...
	戻値
		int		成功/失敗
				FUNCTION_OK
***********************************************************************/
int	CfrmUc031Urikakekin::RecBufClearAllData()
{
...
/**********************************************************************
	...
	戻値
		int		成功/失敗
				FUNCTION_OK
***********************************************************************/
int	CfrmUc031Urikakekin::RecBufClearData( P_REC_UC_031_URIKAKEKIN inRecData )
{
	inRecData->m_Seq = 0;
...
/**********************************************************************
	...
	戻値
		int				成功(更新あり)/成功(更新なし)/失敗
						...
						FUNCTION_NG		: 失敗
***********************************************************************/
int	CfrmUc031Urikakekin::virRecBufSaveData( int inPage, int inRow )
{
	...
	// 科目
	intIndex = CmnGetControlIndex( inRow, ID_COL_031_KNSEQ );
...
// midori 152137 add <--
	...
	intIndex = CmnGetControlIndex( inRow, ID_COL_031_ADNAME1 );
// 158138 del -->
...
// 158138 add <--
	...
	if ( tmpSaveData.m_AdName2.IsEmpty() ){
		if(m_uInfo.intCurCol == ID_COL_031_ADNAME1 && m_uInfo.intCurRow != m_uInfo.OldRow){	// 各カラムごとにvirRecBufSaveData()がコールされるようになり、かつタイミングがEditOffからEditOnに移ったことによりCmnDiagSetString()でカレットが末尾から先頭に移ってしまう為、制御（修正依頼No150489）
			CmnDiagSetString( m_pDiag, intIndex, tmpSaveData.m_AdName1, 0 );
		}
	}

	// 所在地1(住所)
	intIndex = CmnGetControlIndex( inRow, ID_COL_031_ADADD1 );
	tmpSaveData.m_AdAdd1 = m_clsFunc.DiagGetString( m_pDiag, intIndex );

	// 所在地2(住所)
	intIndex = CmnGetControlIndex( inRow, ID_COL_031_ADADD2 );
	tmpSaveData.m_AdAdd2 = m_clsFunc.DiagGetString( m_pDiag, intIndex );

	// 期末現在高
	intIndex = CmnGetControlIndex( inRow, ID_COL_031_VAL );
	tmpSaveData.m_Val = CmnDiagGetKingaku( m_pDiag, intIndex );

	// 摘要
	intIndex = CmnGetControlIndex( inRow, ID_COL_031_TEKI );
...
***********************************************************************/
int	CfrmUc031Urikakekin::virRecBufSaveDataForPasteInsert( int inPage, int inRow )
{
...
***********************************************************************/
int	CfrmUc031Urikakekin::virRecBufSaveDataForPaste( int inPage, int inRow )
{
	///////////////////////////////////////////////////////////////
	// 登録処理呼び出し
	return RecBufSaveDataSub( inPage, inRow, &m_CopyData );
...
/**********************************************************************
	...
	戻値
			int					成功(更新あり)/成功(更新なし)/失敗
								...
								FUNCTION_NG		: 失敗
***********************************************************************/
int	CfrmUc031Urikakekin::RecBufSaveDataSub( 
							int inPage,
							int inRow,
...
//********************************************************************************
CdbUc000Common*	CfrmUc031Urikakekin::virGetDataTableObject()
{
	// 「売掛金」テーブルのオブジェクトを生成し、ポインタを返す
...
//	RET	なし
//********************************************************************************
void	CfrmUc031Urikakekin::virRowButtonCopyProc()
{
...
//	RET	なし
//********************************************************************************
void	CfrmUc031Urikakekin::virTblGetKamokuInfo( CdbUc000Common* rsData, SORTKAMOKU_INFO* uKamoku )
{
...
//	RET	なし
//********************************************************************************
void	CfrmUc031Urikakekin::virGetCurrentInfo( CURRENT_INFO* uCurInfo )
{
...
//	【戻値】	なし
//**************************************************
void CfrmUc031Urikakekin::SetInputMode( int nRow, long nMode )
{
	m_pDiag->ModifyItem( CmnGetControlIndex( nRow, ID_COL_031_KNSEQ ), nMode );		//	科目（※科目がエディットボックスに変更された際に必要）
	m_pDiag->ModifyItem( CmnGetControlIndex( nRow, ID_COL_031_ADNAME1 ), nMode );	//	名称（上段）
	m_pDiag->ModifyItem( CmnGetControlIndex( nRow, ID_COL_031_ADADD1 ), nMode );	//	所在地（上段）
	m_pDiag->ModifyItem( CmnGetControlIndex( nRow, ID_COL_031_ADADD2 ), nMode );	//	所在地（下段）
	m_pDiag->ModifyItem( CmnGetControlIndex( nRow, ID_COL_031_VAL ), nMode );		//	期末現在高
	m_pDiag->ModifyItem( CmnGetControlIndex( nRow, ID_COL_031_TEKI ), nMode );		//	摘要
}
...
//	【戻値】	なし
//**************************************************
void CfrmUc031Urikakekin::SetDiagBackColor()
{
...
//		RET		なし					
//********************************************************************************
void CfrmUc031Urikakekin::virRendoCreateData(CdbUc000Common* rsData, RENTEMP_INFO* uRenInfo)
{
	CString			strTemp;
...
//		RET		なし					
//********************************************************************************
void CfrmUc031Urikakekin::virRendoUpdateData(CdbUc000Common* rsData, RENTEMP_INFO* uRenInfo)
{
	CdbUc031Urikakekin*	rs = (CdbUc031Urikakekin*)rsData;
...
//***************************************************************************
BOOL CfrmUc031Urikakekin::virEndProc(void)
{
	TRACE(_T("***** CfrmUc031Urikakekin::virEndProc\n"));
...
// midori 161106 add -->
void CfrmUc031Urikakekin::ComboNew(short index)
{
	short			sv_sel=0;
// midori 152201 add -->
...
// midori 151405 add -->
int CfrmUc031Urikakekin::CursorControl(short nChar, int sw)
{
	int				rv=0;
	int				intCol=0;
	int				pos=0;
...
// midori 152134 add -->
void CfrmUc031Urikakekin::ComboSelYoushikidiag1(short index, LPUNKNOWN data)
{
// 要通知案件修正 21/07/09 del -->
...
// ------------------------------------------------------------------------------------------------------------------------
void CfrmUc031Urikakekin::TitleColorChg(void)
{
	...
	// 科目
// 修正No.157628 del -->
	//strSQL.Format(_T("select max(oversgn) from (select CASE when len(Replace(isnull(KnName,''),CHAR(13)+CHAR(10),'')) > %d then 1 else 0 end as oversgn from uc_031_urikakekin where FgShow=%d) tbl1"),UC_KAMOKU_LEN,ID_FGSHOW_OFF);
// 修正No.157628 del <--
// 修正No.157628 add -->
...
// 修正No.157628 add <--
	...
	// 摘要
// 修正No.157628 del -->
	//strSQL.Format(_T("select max(oversgn) from (select CASE when len(Replace(isnull(Teki,''),CHAR(13)+CHAR(10),'')) > %d then 1 else 0 end as oversgn from uc_031_urikakekin where FgShow=%d) tbl1"),UC_031_TEKI_LEN,ID_FGSHOW_OFF);
// 修正No.157628 del <--
// 修正No.157628 add -->
	strSQL.Format(_T("select max(oversgn) from (select CASE when len(%s) > %d then 1 else 0 end as oversgn from uc_031_urikakekin where FgShow=%d) tbl1"),
...
// 修正No.157626 del -->
	...
	//CmnHeadDiagSetTitle(&m_HeadDiag,5,_T("摘      要(50)"),nCharOver[1]);
// 修正No.157626 del <--
// 修正No.157626 add -->
	if(nCharOver[0] == 1)	CmnHeadDiagSetTitle(&m_HeadDiag,0,_T("科  目(10)"),1);
	else					CmnHeadDiagSetTitle(&m_HeadDiag,0,_T("科　目"),0);

	if(nCharOver[1] == 1)	CmnHeadDiagSetTitle(&m_HeadDiag,5,_T("摘      要(50)"),1);
...
// 修正No.162446 add -->
LRESULT CfrmUc031Urikakekin::OnUserReDrawView(WPARAM wParam, LPARAM lParam)
{
	virUpdateControlTblData();
	CmnDiagSetFocus(m_pDiag, 1, 1);
