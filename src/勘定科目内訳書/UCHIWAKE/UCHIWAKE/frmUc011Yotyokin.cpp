...
IMPLEMENT_DYNCREATE(CfrmUc011Yotyokin, CfrmUc000Common)


BEGIN_MESSAGE_MAP(CfrmUc011Yotyokin, CfrmUc000Common)
	ON_WM_SIZE()
...
//	ON_COMMAND(ID_BUTTON_F3, OnButtonF3)
	...
	ON_COMMAND(ID_PRINTSETUP_MENU, &CfrmUc011Yotyokin::OnMenuPrintSetup)
	ON_COMMAND(ID_PRINTALL_MENU, &CfrmUc011Yotyokin::OnMenuPrintAll)
//	ON_COMMAND(ID_OUTPUTFORM_MENU, &CfrmUc011Yotyokin::OnMenuFormTypeSetup)		// ①預貯金は実行不可
//	ON_COMMAND(ID_DISPDIALOG_MENU, &CfrmUc011Yotyokin::OnMenuIkkatuKingaku)		// ①預貯金は実行不可
	ON_COMMAND( ID_SPECIALROW_MENU, &CfrmUc011Yotyokin::OnMenuSpecialRow )
	ON_COMMAND( ID_SORT_MENU, &CfrmUc011Yotyokin::OnMenuSort )
	ON_COMMAND(ID_ZEROMONEY_MENU, &CfrmUc011Yotyokin::OnMenuZeroMoney)
	ON_COMMAND(ID_ZEROMONEYMOVE_MENU, &CfrmUc011Yotyokin::OnMenuZeroMoneyMove)
	ON_COMMAND(ID_AMOUTDIALOG_MENU, &CfrmUc011Yotyokin::OnMenuOutKeiSetup)
// midori 160606 add -->
	ON_COMMAND(ID_CLEAR_MENU, &CfrmUc011Yotyokin::OnMenuClear)
// midori 160606 add <--
	ON_COMMAND( ID_RENDO_MENU, &CfrmUc011Yotyokin::OnMenuZaimuRendo )
	ON_COMMAND( ID_TITLEMENU, &CfrmUc011Yotyokin::OnMenuTitleRestore )
	ON_COMMAND( ID_USER_SETTING_MENU, &CfrmUc011Yotyokin::OnMenuOptionSetting )
	ON_COMMAND( ID_COPY_SETTING_INFO_MENU, &CfrmUc011Yotyokin::OnMenuCopySettingInfo )
	ON_COMMAND( ID_DELETE_DATA_MENU, &CfrmUc011Yotyokin::OnMenuDeleteDataEachYoushiki )
	ON_BN_CLICKED(IDC_PAGEBACK_BUTTON1, &CfrmUc011Yotyokin::OnPageBack)
	ON_BN_CLICKED(IDC_PAGENEXT_BUTTON1, &CfrmUc011Yotyokin::OnPageNext)
	ON_BN_CLICKED(IDC_PAGENEW_BUTTON1, &CfrmUc011Yotyokin::OnPageNew)
	ON_BN_CLICKED(IDC_PAGEINSERT_BUTTON1, &CfrmUc011Yotyokin::OnPageInsert)
	ON_BN_CLICKED(IDC_ROWCOPY_BUTTON1, &CfrmUc011Yotyokin::OnRowCopy)
	ON_BN_CLICKED(IDC_ROWPASTE_BUTTON1, &CfrmUc011Yotyokin::OnRowPaste)
	ON_BN_CLICKED(IDC_ROWINSERT_BUTTON1, &CfrmUc011Yotyokin::OnRowInsert)
	ON_BN_CLICKED( IDC_YOUSHIKINEXT_BUTTON1, &CfrmUc011Yotyokin::OnMoveYoushikiNext )
	ON_BN_CLICKED( IDC_YOUSHIKIBACK_BUTTON1, &CfrmUc011Yotyokin::OnMoveYoushikiBack )	
//	ON_UPDATE_COMMAND_UI(ID_BUTTON_F1, &CfrmUc011Yotyokin::OnUpdateButtonF1)
//	ON_UPDATE_COMMAND_UI(ID_BUTTON_F3, &CfrmUc011Yotyokin::OnUpdateButtonF3)
	ON_UPDATE_COMMAND_UI(ID_BUTTON_F6, &CfrmUc011Yotyokin::OnUpdateButtonF6)
	ON_UPDATE_COMMAND_UI(ID_BUTTON_F7, &CfrmUc011Yotyokin::OnUpdateButtonF7)
	ON_UPDATE_COMMAND_UI(ID_BUTTON_F8, &CfrmUc011Yotyokin::OnUpdateButtonF8)
	ON_UPDATE_COMMAND_UI(ID_BUTTON_F9, &CfrmUc011Yotyokin::OnUpdateButtonF9)
	ON_UPDATE_COMMAND_UI(ID_BUTTON_F11, &CfrmUc011Yotyokin::OnUpdateButtonF11)
	ON_UPDATE_COMMAND_UI(ID_BUTTON_F12, &CfrmUc011Yotyokin::OnUpdateButtonF12)
	ON_UPDATE_COMMAND_UI( ID_BUTTON_HOME, &CfrmUc011Yotyokin::OnUpdateButtonHome )
//	ON_UPDATE_COMMAND_UI(IDC_ROWDELETE_BUTTON1, &CfrmUc011Yotyokin::OnUpdateButtOnMoveYoushikiBack)
//	ON_UPDATE_COMMAND_UI(IDC_ROWNULLINSERT_BUTTON1, &CfrmUc011Yotyokin::OnUpdateButtonNullInsert)
//	ON_UPDATE_COMMAND_UI(ID_DISPDIALOG_MENU, &CfrmUc011Yotyokin::OnUpdateMenuIkkatuKingaku)
// midori 160612 add -->
	ON_UPDATE_COMMAND_UI( ID_SORT_MENU, &CfrmUc011Yotyokin::OnUpdateMenuSort )
	ON_UPDATE_COMMAND_UI( ID_CLEAR_MENU, &CfrmUc011Yotyokin::OnUpdateMenuClear )
// midori 160612 add <--
	ON_UPDATE_COMMAND_UI(ID_ZEROMONEY_MENU, &CfrmUc011Yotyokin::OnUpdateMenuZeroMoney)
// midori 160612 add -->
	ON_UPDATE_COMMAND_UI( ID_ZEROMONEYMOVE_MENU, &CfrmUc011Yotyokin::OnUpdateMenuZeroMoneyMove)
// midori 160612 add <--
	ON_UPDATE_COMMAND_UI( ID_RENDO_MENU, &CfrmUc011Yotyokin::OnUpdateMenuZaimuRendo )
	ON_UPDATE_COMMAND_UI(ID_SPECIALROW_MENU, &CfrmUc011Yotyokin::OnUpdateMenuSpecialRow)
// midori 160612 add -->
	ON_UPDATE_COMMAND_UI( ID_TITLEMENU, &CfrmUc011Yotyokin::OnUpdateMenuTitleRestore )
	ON_UPDATE_COMMAND_UI( ID_DELETE_DATA_MENU, &CfrmUc011Yotyokin::OnUpdateMenuDeleteDataEachYoushiki )
// midori 160612 add <--
	ON_MESSAGE(WM_USER_REDRAWVIEW, OnUserReDrawView)		// 修正No.162446 add
END_MESSAGE_MAP()


CfrmUc011Yotyokin::CfrmUc011Yotyokin()
	: CfrmUc000Common(CfrmUc011Yotyokin::IDD)
{
...
CfrmUc011Yotyokin::~CfrmUc011Yotyokin()
{
	...
	TRACE(_T("***** CfrmUc011Yotyokin::~CfrmUc011Yotyokin\n"));

	//m_pDiag = NULL;
	//m_pTitleDiag = NULL;
}

void CfrmUc011Yotyokin::DoDataExchange(CDataExchange* pDX)
{
...
void CfrmUc011Yotyokin::OnInitialUpdate()
{
...
#ifdef _DEBUG
void CfrmUc011Yotyokin::AssertValid() const
{
	CfrmUc000Common::AssertValid();
}

#ifndef _WIN32_WCE
void CfrmUc011Yotyokin::Dump(CDumpContext& dc) const
{
...
BEGIN_EVENTSINK_MAP(CfrmUc011Yotyokin, CfrmUc000Common)
	ON_EVENT(CfrmUc011Yotyokin, IDC_YOUSHIKIDIAG1, 3, CfrmUc011Yotyokin::TerminationYoushikidiag1, VTS_I2 VTS_I2 VTS_I2 VTS_UNKNOWN)
	ON_EVENT(CfrmUc011Yotyokin, IDC_YOUSHIKIDIAG1, 2, CfrmUc011Yotyokin::EditOFFYoushikidiag1, VTS_I2)
	ON_EVENT(CfrmUc011Yotyokin, IDC_YOUSHIKIDIAG1, 1, CfrmUc011Yotyokin::EditONYoushikidiag1, VTS_I2)
// midori 151405 add -->
	ON_EVENT(CfrmUc011Yotyokin, IDC_YOUSHIKIDIAG1, 12, CfrmUc011Yotyokin::VScrollYoushikidiag1, VTS_I2)
// midori 151405 add <--
// midori 152134 add -->
	ON_EVENT(CfrmUc011Yotyokin, IDC_YOUSHIKIDIAG1, 8, CfrmUc011Yotyokin::ComboSelYoushikidiag1, VTS_I2 VTS_UNKNOWN)
// midori 152134 add <--

	ON_EVENT(CfrmUc011Yotyokin, IDC_YOUSHIKIDIAG2, 3, CfrmUc011Yotyokin::TerminationYoushikidiag1, VTS_I2 VTS_I2 VTS_I2 VTS_UNKNOWN)
	ON_EVENT(CfrmUc011Yotyokin, IDC_YOUSHIKIDIAG2, 2, CfrmUc011Yotyokin::EditOFFYoushikidiag1, VTS_I2)
	ON_EVENT(CfrmUc011Yotyokin, IDC_YOUSHIKIDIAG2, 1, CfrmUc011Yotyokin::EditONYoushikidiag1, VTS_I2)
// midori 151405 add -->
	ON_EVENT(CfrmUc011Yotyokin, IDC_YOUSHIKIDIAG2, 12, CfrmUc011Yotyokin::VScrollYoushikidiag1, VTS_I2)
// midori 151405 add <--
// midori 152134 add -->
	ON_EVENT(CfrmUc011Yotyokin, IDC_YOUSHIKIDIAG2, 8, CfrmUc011Yotyokin::ComboSelYoushikidiag1, VTS_I2 VTS_UNKNOWN)
// midori 152134 add <--

	ON_EVENT(CfrmUc011Yotyokin, IDC_TITLEDIAG1, 3, CfrmUc011Yotyokin::TerminationTitlediag1, VTS_I2 VTS_I2 VTS_I2 VTS_UNKNOWN)
	ON_EVENT(CfrmUc011Yotyokin, IDC_TITLEDIAG1, 2, CfrmUc011Yotyokin::EditOFFTitlediag1, VTS_I2)
	ON_EVENT(CfrmUc011Yotyokin, IDC_TITLEDIAG1, 1, CfrmUc011Yotyokin::EditONTitlediag1, VTS_I2)
	ON_EVENT(CfrmUc011Yotyokin, IDC_TITLEDIAG1, 6, CfrmUc011Yotyokin::FocusTitlediag1, VTS_NONE)

	ON_EVENT(CfrmUc011Yotyokin, IDC_PAGEDIAG1, 3, CfrmUc011Yotyokin::TerminationPagediag1, VTS_I2 VTS_I2 VTS_I2 VTS_UNKNOWN)
	ON_EVENT(CfrmUc011Yotyokin, IDC_PAGEDIAG1, 2, CfrmUc011Yotyokin::EditOFFPagediag1, VTS_I2)
	ON_EVENT(CfrmUc011Yotyokin, IDC_PAGEDIAG1, 1, CfrmUc011Yotyokin::EditONPagediag1, VTS_I2)
	ON_EVENT(CfrmUc011Yotyokin, IDC_PAGEDIAG1, 6, CfrmUc011Yotyokin::FocusPagediag1, VTS_NONE)
END_EVENTSINK_MAP()

//********************************************************************************
//	預貯金等の内訳書：初期処理
//********************************************************************************
BOOL CfrmUc011Yotyokin::virStartJob()
{
	// 初期値設定
...
//	共通データの初期値設定
//********************************************************************************
void CfrmUc011Yotyokin::virSetInitialUchiwakeInfo()
{
	// 預貯金の固有データ
	...
	m_uInfo.intColMax = ID_COLMAX_011;				// １行内のコントロール個数	（預貯金=13）
	m_uInfo.intColMaxData = ID_COLMAXDATA_011;		// １行内の列数				（預貯金=6）
	m_uInfo.intCtlStartIndex = ID_CTLSTARTINDEX_011;// １行目の入力項目の先頭インデックス番号
	m_uInfo.intT1StartIndex = ID_T1STARTNORMAL_011;	// 合計行①の先頭インデックス番号
	m_uInfo.intT2StartIndex = ID_T2STARTNORMAL_011;	// 合計行②の入力項目の先頭インデックス番号
	...
	m_uInfo.intT1StartNormal = ID_T1STARTNORMAL_011;// 通常時：合計行①の先頭インデックス
	m_uInfo.intT2StartNormal = ID_T2STARTNORMAL_011;// 通常時：合計行②の先頭インデックス
	m_uInfo.intT1StartKobetu = ID_T1STARTKOBETU_011;// 個別時：合計行①の先頭インデックス
	m_uInfo.intT2StartKobetu = ID_T2STARTKOBETU_011;// 個別時：合計行②の先頭インデックス
	...
	m_uInfo.intKei2StartIndex = ID_COL_011_KEI2_MEISYO;	// 計ダイアグラム2行目の先頭インデックス
...
// 【戻値】    なし
//**************************************************
void	CfrmUc011Yotyokin::virSetInitialDiag()
{
	int     nIndex;
...
//	帳表固有変数の初期値設定
//********************************************************************************
void CfrmUc011Yotyokin::virSetInitialValue()
{
	// 1ページ分のローカルバッファをクリア
	RecBufClearAllData();
...
//	帳表コントロールの初期化（データ領域）
//********************************************************************************
BOOL CfrmUc011Yotyokin::InitialControlDataArea()
{
	int			intMax;
	int			i;
...
//********************************************************************************
BOOL CfrmUc011Yotyokin::InitialControlComboBox()
{
...
//********************************************************************************
void CfrmUc011Yotyokin::InitialControlTotalArea()
{
...
// midori 152166 add <--
	...
	m_pDiagKei->ModifyItem(ID_COL_011_KEI1_KIMATU, intKeiRow);
	m_pDiagKei->ModifyItem(ID_COL_011_KEI2_KIMATU, intKeiRow);
	...
	// 合計行の金額欄は、12桁固定とする
	CmnDiagSetAttrDigit(m_pDiagKei, ID_COL_011_KEI1_KIMATU, ID_VAL_011_TOTAL);
	CmnDiagSetAttrDigit(m_pDiagKei, ID_COL_011_KEI2_KIMATU, ID_VAL_011_TOTAL);
}
...
//		RET		なし
//********************************************************************************
void CfrmUc011Yotyokin::InitialControlSpecialRow(int intRow, int intFgFunc)
{
	DIAGRAM_DATA	diadata;			// ICSDIAG構造体
...
//	帳表タイトル情報の表示
//********************************************************************************
void CfrmUc011Yotyokin::virUpdateControlTitle()
{
//	int				intMax;
...
//	帳表ページ情報の表示
//********************************************************************************
void CfrmUc011Yotyokin::UpdateControlPage()
{
	BOOL			bBack = TRUE;
	BOOL			bNext = TRUE;
...
//	帳表データの表示（１ページ分）
//********************************************************************************
BOOL CfrmUc011Yotyokin::virUpdateControlTblData()
{
	// ダイアログ切替
	if( m_pDiag != NULL ){
		virSetInitialDiag();
...
//	保管件数の表示
//********************************************************************************
BOOL CfrmUc011Yotyokin::virUpdateControlTblData2()
{
	int					hcnt=0;
	CString				cs=_T("");
...
//		RET		なし
//********************************************************************************
void CfrmUc011Yotyokin::UpdateControlRowData( CdbUc011Yotyokin* Yotyokin ){
...
//		RET		なし
//********************************************************************************
void CfrmUc011Yotyokin::UpdateControlRowTotal( CdbUc011Yotyokin* Yotyokin ){
	...
	// 頁計/累計の金額表示
	if (intRowKingaku > 0) {
		CmnDiagSetKingaku( m_pDiagKei, CmnGetKeiDiagIndex( intRowKingaku, ID_COL_011_KEI1_KIMATU ), Yotyokin->m_Val );
	}
}
...
//		RET		なし
//********************************************************************************
void CfrmUc011Yotyokin::virFncCellCopyProc( CdbUc000Common* rsData )
{
	CdbUc011Yotyokin*	rs;
	int					intCol;		// 現在の列
...
//********************************************************************************
int CfrmUc011Yotyokin::virFncReferenceGetType(int intCol, int* intGrSeq, long* lngItemSeq, int* intAdd1, int* intAdd2, int* intAdd1Col, int* intAdd2Col, REFERENCE_INFO* pudReference)
{
	int				intRefType;
...
//		RET		なし
//********************************************************************************
void CfrmUc011Yotyokin::virFncReferenceSetData(CdlgReference* dlgRef, int intRefType, int intCol)
{
	switch (intRefType) {
...
/****** //---- Debug Start ----
void CfrmUc011Yotyokin::virFncReferenceSetICSData(CdlgAddressSearch* dlgAddd)
{
...
//		RET		なし
//********************************************************************************
void CfrmUc011Yotyokin::virFncReferenceUpdateTbl(int intRefType, int nRefMode/*=0*/)
{
	switch (intRefType) {
	// 金融機関名
	case ID_DLGTYPE_BANK:
...
void CfrmUc011Yotyokin::OnSize(UINT nType, int cx, int cy)
{
...
// ウィンドウ消去
BOOL CfrmUc011Yotyokin::DestroyWindow() 
{
...
/*BOOL CfrmUc011Yotyokin::OnInitDialog() 
{
...
void CfrmUc011Yotyokin::virActivateFrameK(UINT nState, CFrameWnd* pDeactivateFrame)
{
	int		index = 0;
...
void CfrmUc011Yotyokin::virKamokuAddCancel()
{
...
BOOL CfrmUc011Yotyokin::PreTranslateMessage(MSG* pMsg)
{
//	int				intID;
...
// 頁コントロールのフォーカス設定
void CfrmUc011Yotyokin::FocusPagediag1() 
{
...
// 頁コントロールのゲットフォーカス
void CfrmUc011Yotyokin::EditONPagediag1(short index)
{
// midori 151405 add -->
	// スクロールフラグをクリアする
	nG_MScroll = 0;
...
// 頁コントロールのロストフォーカス
void CfrmUc011Yotyokin::EditOFFPagediag1(short index)
{
// midori 155028 add -->
...
// 頁コントロールのキー操作
void CfrmUc011Yotyokin::TerminationPagediag1(short index, short nChar, short length, LPUNKNOWN data)
{
	int nMaxDataCol = 0;
	// カレント頁の合計行の種別を取得
...
// タイトルコントロールのフォーカス設定
void CfrmUc011Yotyokin::FocusTitlediag1() 
{
//マウスクリックでキャレットが表示できないためコメントとする
//	// ボタンからTabキー移動した場合に必要
//	m_TitleDiag.SetPosition(0);
...
// タイトルコントロールのゲットフォーカス
void CfrmUc011Yotyokin::EditONTitlediag1( short index )
{
// midori 151405 add -->
	// スクロールフラグをクリアする
	nG_MScroll = 0;
...
// タイトルコントロールのロストフォーカス
void CfrmUc011Yotyokin::EditOFFTitlediag1(short index)
{
// midori 151405 add -->
	m_Titlefocus = 0;
// midori 151405 add <--
...
//	タイトルの更新
void CfrmUc011Yotyokin::virUpdateTitle()
{
...
// タイトルコントロールのキーイベント
void CfrmUc011Yotyokin::TerminationTitlediag1(short index, short nChar, short length, LPUNKNOWN data) 
{
	// フォーカス移動
	switch (nChar) {
	case VK_RETURN:
...
void CfrmUc011Yotyokin::EditONYoushikidiag1(short index) 
{
	DIAGRAM_DATA diadata;
...
// データコントロールのロストフォーカス
void CfrmUc011Yotyokin::EditOFFYoushikidiag1(short index) 
{
...
//	入力確定
void CfrmUc011Yotyokin::virInputDecisionEditOFF()
{
	// フォーカスフラグOFF
...
// 預貯金データコントロールのキーイベント
void CfrmUc011Yotyokin::TerminationYoushikidiag1(short index, short nChar, short length, LPUNKNOWN data) 
{
	//--------------------------------------------------------------------------------
	//	キー操作仕様
...
// midori 151405 add -->
void CfrmUc011Yotyokin::VScrollYoushikidiag1(short mode)
{
...
//********************************************************************************
int	CfrmUc011Yotyokin::GetFocusPosition(int nChar)
{
	int		intRow;					// カレント行番号
	int		intCol;					// カレント列番号
...
//********************************************************************************
int CfrmUc011Yotyokin::GetTotalRowIndex(int nCharOrg ,int intIndex ,int intNext)
{
...
//********************************************************************************
int CfrmUc011Yotyokin::virTblSortSubSortProc(CdlgSort* pCdlgSort, CdbUc000Common* rsData)
{
	CdbUc011Yotyokin*	rs;
	CString				strFilter;
	CString				strSort;
...
/**********************************************************************
	...
	戻値
			int					成功/失敗
								FUNCTION_OK
***********************************************************************/
int CfrmUc011Yotyokin::RecBufSetData(CdbUc011Yotyokin* Yotyokin)
{
...
/**********************************************************************
	...
	戻値
			int					成功/失敗
								FUNCTION_OK
***********************************************************************/
int CfrmUc011Yotyokin::RecBufClearAllData()
{
...
/**********************************************************************
	...
	戻値
			int					成功/失敗
								FUNCTION_OK
***********************************************************************/
int CfrmUc011Yotyokin::RecBufClearData( P_REC_UC_011_YOTYOKIN inRecData )
{
	inRecData->m_Seq		= 0;
...
/**********************************************************************
	...
	戻値
			int					成功(更新あり)/成功(更新なし)/失敗
								...
								FUNCTION_NG		: 失敗
***********************************************************************/
int CfrmUc011Yotyokin::virRecBufSaveData(int inPage, int inRow)
{
...
***********************************************************************/
int CfrmUc011Yotyokin::virRecBufSaveDataForPasteInsert(int inPage, int inRow)
{
...
***********************************************************************/
int CfrmUc011Yotyokin::virRecBufSaveDataForPaste(int inPage, int inRow)
{
	///////////////////////////////////////////////////////////////
	// 登録処理呼び出し
	return	RecBufSaveDataSub( inPage, inRow, &m_CopyData );
...
/**********************************************************************
	...
	戻値
			int					成功(更新あり)/成功(更新なし)/失敗
								...
								FUNCTION_NG		: 失敗
***********************************************************************/
int CfrmUc011Yotyokin::RecBufSaveDataSub(
							int inPage, 
							int inRow,  
...
//
CdbUc000Common* CfrmUc011Yotyokin::virGetDataTableObject()
{
...
//		RET		なし
//********************************************************************************
void CfrmUc011Yotyokin::virRowButtonCopyProc()
{
...
//		RET		なし
//********************************************************************************
void CfrmUc011Yotyokin::virTblGetKamokuInfo(CdbUc000Common* rsData, SORTKAMOKU_INFO* uKamoku)
{
...
//		RET		なし
//********************************************************************************
void CfrmUc011Yotyokin::virGetCurrentInfo(CURRENT_INFO* uCurInfo)
{
...
//	【戻値】	なし
//**************************************************
void CfrmUc011Yotyokin::SetInputMode( int nRow, long nMode )
{
...
//	【戻値】	なし
//**************************************************
void CfrmUc011Yotyokin::SetDiagBackColor()
{
...
//		RET		なし					
//********************************************************************************
void CfrmUc011Yotyokin::virRendoCreateData(CdbUc000Common* rsData, RENTEMP_INFO* uRenInfo)
{
	CString			strTemp;
...
//		RET		なし					
//********************************************************************************
void CfrmUc011Yotyokin::virRendoUpdateData(CdbUc000Common* rsData, RENTEMP_INFO* uRenInfo)
{
	CdbUc011Yotyokin*	rs = (CdbUc011Yotyokin*)rsData;
...
//***************************************************************************
BOOL CfrmUc011Yotyokin::virEndProc(void)
{
	TRACE(_T("***** CfrmUc011Yotyokin::virEndProc\n"));
...
// midori 161106 add -->
void CfrmUc011Yotyokin::ComboNew(short index)
{
	short			sv_sel=0;
// midori 152201 add -->
...
// midori 151405 add -->
int CfrmUc011Yotyokin::CursorControl(short nChar, int sw)
{
	int				rv=0;
	int				intCol=0;
	int				pos=0;
...
// midori 152134 add -->
void CfrmUc011Yotyokin::ComboSelYoushikidiag1(short index, LPUNKNOWN data)
{
// 要通知案件修正 21/07/09 del -->
...
// 修正No.162446 add -->
LRESULT CfrmUc011Yotyokin::OnUserReDrawView(WPARAM wParam, LPARAM lParam)
{
	virUpdateControlTblData();
	CmnDiagSetFocus(m_pDiag, 1, 1);
