// dbUc152Kenrikin.h : ヘッダー ファイル
//

#ifndef	_DB_UC_152_KENRIKIN_H_
#define	_DB_UC_152_KENRIKIN_H_

#include "dbUc000Common.h"

/////////////////////////////////////////////////////////////////////////////
// CdbUc152Kenrikin レコードセット

class CdbUc152Kenrikin : public CdbUc000Common
{
public:
...
// 157153 add <--
	...
	CdbUc152Kenrikin(CDatabase* pDatabase = NULL);
	DECLARE_DYNAMIC(CdbUc152Kenrikin)

// フィールド/パラメータ データ
	//{{AFX_FIELD(CdbUc152Kenrikin, CRecordset)
	long	m_AdSeq;
	long	m_AdOrder;
	CString	m_AdName1;
	CString	m_AdName2;
