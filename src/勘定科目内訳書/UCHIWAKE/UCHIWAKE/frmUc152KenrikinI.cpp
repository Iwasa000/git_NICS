...
IMPLEMENT_DYNCREATE( CfrmUc152KenrikinI, CfrmUc000Common )


BEGIN_MESSAGE_MAP( CfrmUc152KenrikinI, CfrmUc000Common )
	ON_WM_SIZE()
	...
	ON_COMMAND( ID_PRINTSETUP_MENU, &CfrmUc152KenrikinI::OnMenuPrintSetup )
	ON_COMMAND( ID_PRINTALL_MENU, &CfrmUc152KenrikinI::OnMenuPrintAll )
	ON_COMMAND( ID_OUTPUTFORM_MENU, &CfrmUc152KenrikinI::OnMenuFormTypeSetup )
	ON_COMMAND( ID_SPECIALROW_MENU, &CfrmUc152KenrikinI::OnMenuSpecialRow )
	ON_COMMAND( ID_SORT_MENU, &CfrmUc152KenrikinI::OnMenuSort )
	ON_COMMAND( ID_ZEROMONEY_MENU, &CfrmUc152KenrikinI::OnMenuZeroMoney )
	ON_COMMAND( ID_ZEROMONEYMOVE_MENU, &CfrmUc152KenrikinI::OnMenuZeroMoneyMove )
	ON_COMMAND( ID_AMOUTDIALOG_MENU, &CfrmUc152KenrikinI::OnMenuOutKeiSetup )
	ON_COMMAND( ID_CLEAR_MENU, &CfrmUc152KenrikinI::OnMenuClear )
	ON_COMMAND( ID_TITLEMENU, &CfrmUc152KenrikinI::OnMenuTitleRestore )
	ON_COMMAND( ID_USER_SETTING_MENU, &CfrmUc152KenrikinI::OnMenuOptionSetting )
	ON_COMMAND( ID_COPY_SETTING_INFO_MENU, &CfrmUc152KenrikinI::OnMenuCopySettingInfo )
	ON_COMMAND( ID_DELETE_DATA_MENU, &CfrmUc152KenrikinI::OnMenuDeleteDataEachYoushiki )
	ON_BN_CLICKED( IDC_PAGEBACK_BUTTON1, &CfrmUc152KenrikinI::OnPageBack )
	ON_BN_CLICKED( IDC_PAGENEXT_BUTTON1, &CfrmUc152KenrikinI::OnPageNext )
	ON_BN_CLICKED( IDC_PAGENEW_BUTTON1, &CfrmUc152KenrikinI::OnPageNew )
	ON_BN_CLICKED( IDC_PAGEINSERT_BUTTON1, &CfrmUc152KenrikinI::OnPageInsert )
	ON_BN_CLICKED( IDC_ROWCOPY_BUTTON1, &CfrmUc152KenrikinI::OnRowCopy )
	ON_BN_CLICKED( IDC_ROWPASTE_BUTTON1, &CfrmUc152KenrikinI::OnRowPaste )
	ON_BN_CLICKED( IDC_ROWINSERT_BUTTON1, &CfrmUc152KenrikinI::OnRowInsert )
	ON_BN_CLICKED( IDC_YOUSHIKINEXT_BUTTON1, &CfrmUc152KenrikinI::OnMoveYoushikiNext )
	ON_BN_CLICKED( IDC_YOUSHIKIBACK_BUTTON1, &CfrmUc152KenrikinI::OnMoveYoushikiBack )
	ON_UPDATE_COMMAND_UI( ID_BUTTON_F6, &CfrmUc152KenrikinI::OnUpdateButtonF6 )
	ON_UPDATE_COMMAND_UI( ID_BUTTON_F7, &CfrmUc152KenrikinI::OnUpdateButtonF7 )
	ON_UPDATE_COMMAND_UI( ID_BUTTON_F8, &CfrmUc152KenrikinI::OnUpdateButtonF8 )
	ON_UPDATE_COMMAND_UI( ID_BUTTON_F9, &CfrmUc152KenrikinI::OnUpdateButtonF9 )
	ON_UPDATE_COMMAND_UI( ID_BUTTON_F11, &CfrmUc152KenrikinI::OnUpdateButtonF11 )
	ON_UPDATE_COMMAND_UI( ID_BUTTON_F12, &CfrmUc152KenrikinI::OnUpdateButtonF12 )
	ON_UPDATE_COMMAND_UI( ID_BUTTON_HOME, &CfrmUc152KenrikinI::OnUpdateButtonHome )
	ON_UPDATE_COMMAND_UI( ID_SORT_MENU, &CfrmUc152KenrikinI::OnUpdateMenuSort )
	ON_UPDATE_COMMAND_UI( ID_CLEAR_MENU, &CfrmUc152KenrikinI::OnUpdateMenuClear )
	ON_UPDATE_COMMAND_UI( ID_ZEROMONEY_MENU, &CfrmUc152KenrikinI::OnUpdateMenuZeroMoney )
	ON_UPDATE_COMMAND_UI( ID_ZEROMONEYMOVE_MENU, &CfrmUc152KenrikinI::OnUpdateMenuZeroMoneyMove)
	ON_UPDATE_COMMAND_UI(ID_SPECIALROW_MENU, &CfrmUc152KenrikinI::OnUpdateMenuSpecialRow)
	ON_UPDATE_COMMAND_UI( ID_TITLEMENU, &CfrmUc152KenrikinI::OnUpdateMenuTitleRestore )
	ON_UPDATE_COMMAND_UI( ID_DELETE_DATA_MENU, &CfrmUc152KenrikinI::OnUpdateMenuDeleteDataEachYoushiki )
	ON_MESSAGE(WM_USER_REDRAWVIEW, OnUserReDrawView)
END_MESSAGE_MAP()


CfrmUc152KenrikinI::CfrmUc152KenrikinI()
	: CfrmUc000Common( CfrmUc152KenrikinI::IDD )
{
...
CfrmUc152KenrikinI::~CfrmUc152KenrikinI()
{
	...
	TRACE(_T("***** CfrmUc152KenrikinI::~CfrmUc152KenrikinI\n"));

	//m_pDiag = NULL;
	//m_pTitleDiag = NULL;
}

void CfrmUc152KenrikinI::DoDataExchange( CDataExchange* pDX )
{
	...
	DDX_Control( pDX, IDC_YOUSHIKIDIAG_KEI1, m_DiagKeiKobetu );
	DDX_Control( pDX, IDC_YOUSHIKIDIAG_KEI2, m_DiagKeiKobetu2 );
	DDX_Control( pDX, IDC_YOUSHIKIDIAG_KEI3, m_DiagKeiNormal );
...
void CfrmUc152KenrikinI::OnInitialUpdate()
{
...
#ifdef _DEBUG
void CfrmUc152KenrikinI::AssertValid() const
{
	CfrmUc000Common::AssertValid();
}

#ifndef _WIN32_WCE
void CfrmUc152KenrikinI::Dump( CDumpContext& dc ) const
{
...
BEGIN_EVENTSINK_MAP( CfrmUc152KenrikinI, CfrmUc000Common )
	ON_EVENT( CfrmUc152KenrikinI, IDC_YOUSHIKIDIAG1, 3, CfrmUc152KenrikinI::TerminationYoushikidiag1, VTS_I2 VTS_I2 VTS_I2 VTS_UNKNOWN )
	ON_EVENT( CfrmUc152KenrikinI, IDC_YOUSHIKIDIAG1, 2, CfrmUc152KenrikinI::EditOFFYoushikidiag1, VTS_I2 )
	ON_EVENT( CfrmUc152KenrikinI, IDC_YOUSHIKIDIAG1, 1, CfrmUc152KenrikinI::EditONYoushikidiag1, VTS_I2 )
	ON_EVENT(CfrmUc152KenrikinI, IDC_YOUSHIKIDIAG1, 12, CfrmUc152KenrikinI::VScrollYoushikidiag1, VTS_I2)

	ON_EVENT( CfrmUc152KenrikinI, IDC_YOUSHIKIDIAG2, 3, CfrmUc152KenrikinI::TerminationYoushikidiag1, VTS_I2 VTS_I2 VTS_I2 VTS_UNKNOWN )
	ON_EVENT( CfrmUc152KenrikinI, IDC_YOUSHIKIDIAG2, 2, CfrmUc152KenrikinI::EditOFFYoushikidiag1, VTS_I2 )
	ON_EVENT( CfrmUc152KenrikinI, IDC_YOUSHIKIDIAG2, 1, CfrmUc152KenrikinI::EditONYoushikidiag1, VTS_I2 )
	ON_EVENT(CfrmUc152KenrikinI, IDC_YOUSHIKIDIAG2, 12, CfrmUc152KenrikinI::VScrollYoushikidiag1, VTS_I2)

	ON_EVENT( CfrmUc152KenrikinI, IDC_YOUSHIKIDIAG3, 3, CfrmUc152KenrikinI::TerminationYoushikidiag1, VTS_I2 VTS_I2 VTS_I2 VTS_UNKNOWN )
	ON_EVENT( CfrmUc152KenrikinI, IDC_YOUSHIKIDIAG3, 2, CfrmUc152KenrikinI::EditOFFYoushikidiag1, VTS_I2 )
	ON_EVENT( CfrmUc152KenrikinI, IDC_YOUSHIKIDIAG3, 1, CfrmUc152KenrikinI::EditONYoushikidiag1, VTS_I2 )
	ON_EVENT(CfrmUc152KenrikinI, IDC_YOUSHIKIDIAG3, 12, CfrmUc152KenrikinI::VScrollYoushikidiag1, VTS_I2)

	ON_EVENT( CfrmUc152KenrikinI, IDC_YOUSHIKIDIAG4, 3, CfrmUc152KenrikinI::TerminationYoushikidiag1, VTS_I2 VTS_I2 VTS_I2 VTS_UNKNOWN )
	ON_EVENT( CfrmUc152KenrikinI, IDC_YOUSHIKIDIAG4, 2, CfrmUc152KenrikinI::EditOFFYoushikidiag1, VTS_I2 )
	ON_EVENT( CfrmUc152KenrikinI, IDC_YOUSHIKIDIAG4, 1, CfrmUc152KenrikinI::EditONYoushikidiag1, VTS_I2 )
	ON_EVENT(CfrmUc152KenrikinI, IDC_YOUSHIKIDIAG4, 12, CfrmUc152KenrikinI::VScrollYoushikidiag1, VTS_I2)

	ON_EVENT( CfrmUc152KenrikinI, IDC_YOUSHIKIDIAG5, 3, CfrmUc152KenrikinI::TerminationYoushikidiag1, VTS_I2 VTS_I2 VTS_I2 VTS_UNKNOWN )
	ON_EVENT( CfrmUc152KenrikinI, IDC_YOUSHIKIDIAG5, 2, CfrmUc152KenrikinI::EditOFFYoushikidiag1, VTS_I2 )
	ON_EVENT( CfrmUc152KenrikinI, IDC_YOUSHIKIDIAG5, 1, CfrmUc152KenrikinI::EditONYoushikidiag1, VTS_I2 )
	ON_EVENT(CfrmUc152KenrikinI, IDC_YOUSHIKIDIAG5, 12, CfrmUc152KenrikinI::VScrollYoushikidiag1, VTS_I2)

	ON_EVENT( CfrmUc152KenrikinI, IDC_YOUSHIKIDIAG6, 3, CfrmUc152KenrikinI::TerminationYoushikidiag1, VTS_I2 VTS_I2 VTS_I2 VTS_UNKNOWN )
	ON_EVENT( CfrmUc152KenrikinI, IDC_YOUSHIKIDIAG6, 2, CfrmUc152KenrikinI::EditOFFYoushikidiag1, VTS_I2 )
	ON_EVENT( CfrmUc152KenrikinI, IDC_YOUSHIKIDIAG6, 1, CfrmUc152KenrikinI::EditONYoushikidiag1, VTS_I2 )
	ON_EVENT(CfrmUc152KenrikinI, IDC_YOUSHIKIDIAG6, 12, CfrmUc152KenrikinI::VScrollYoushikidiag1, VTS_I2)

	ON_EVENT( CfrmUc152KenrikinI, IDC_TITLEDIAG1, 3, CfrmUc152KenrikinI::TerminationTitlediag1, VTS_I2 VTS_I2 VTS_I2 VTS_UNKNOWN )
	ON_EVENT( CfrmUc152KenrikinI, IDC_TITLEDIAG1, 2, CfrmUc152KenrikinI::EditOFFTitlediag1, VTS_I2 )
	ON_EVENT( CfrmUc152KenrikinI, IDC_TITLEDIAG1, 1, CfrmUc152KenrikinI::EditONTitlediag1, VTS_I2 )
	ON_EVENT( CfrmUc152KenrikinI, IDC_TITLEDIAG1, 6, CfrmUc152KenrikinI::FocusTitlediag1, VTS_NONE )

	ON_EVENT( CfrmUc152KenrikinI, IDC_PAGEDIAG1, 3, CfrmUc152KenrikinI::TerminationPagediag1, VTS_I2 VTS_I2 VTS_I2 VTS_UNKNOWN )
	ON_EVENT( CfrmUc152KenrikinI, IDC_PAGEDIAG1, 2, CfrmUc152KenrikinI::EditOFFPagediag1, VTS_I2 )
	ON_EVENT( CfrmUc152KenrikinI, IDC_PAGEDIAG1, 1, CfrmUc152KenrikinI::EditONPagediag1, VTS_I2 )
	ON_EVENT( CfrmUc152KenrikinI, IDC_PAGEDIAG1, 6, CfrmUc152KenrikinI::FocusPagediag1, VTS_NONE )
END_EVENTSINK_MAP()

//********************************************************************************
//	初期処理
//********************************************************************************
BOOL	CfrmUc152KenrikinI::virStartJob()
{
	// 初期値設定
...
//	共通データの初期値設定
//********************************************************************************
void	CfrmUc152KenrikinI::virSetInitialUchiwakeInfo()
{
	// 「権利金」の固有データ
	m_uInfo.intOutKeiDialog = AM_TYPE_ALL;				// 計設定ダイアログのボタン指定
	m_uInfo.intRowMax = ID_ROWKOBETU_152;				// １頁内の合計行を含む全体の行数
	m_uInfo.intRowMaxData = ID_ROWKOBETU_152 - 1;		// １頁内のデータ行数（合計行は含まず）
	m_uInfo.intColMax = ID_COLMAX_152I;					// １行内のコントロール個数
	m_uInfo.intColMaxData = ID_COLMAXDATA_152I;			// １行内の列数
	m_uInfo.intCtlStartIndex = ID_CTLSTARTINDEX_152I;	// １行目の入力項目の先頭インデックス番号
	m_uInfo.intT1StartIndex = ID_T1STARTNORMAL_152I;	// 合計行①の先頭インデックス番号
	m_uInfo.intT2StartIndex = ID_T2STARTNORMAL_152I;	// 合計行②の入力項目の先頭インデックス番号
	m_uInfo.intCursolDefPos = ID_COL_152I_INVONOT;		// カーソル移動時の初期位置（タイトルから↓，合計から↑で使用）
	m_uInfo.intCursolKeiPos = ID_COL_152I_INVONOT;		// 合計行のカーソル移動位置（カーソル移動で使用）

	m_uInfo.intFormSeq = ID_FORMNO_152;					// 様式シーケンス番号
	m_uInfo.intFormNo = 15;								// 様式番号（uc_inf_sub）
	m_uInfo.intFormNo2 = 2;								// 様式番号枝番（uc_inf_sub）

	m_uInfo.intRowNormal = ID_ROWNORMAL_152;			// 通常時：１頁内の合計行を含む全体の行数
	m_uInfo.intRowKobetu = ID_ROWKOBETU_152;			// 個別時：１頁内の合計行を含む全体の行数
	m_uInfo.intT1StartNormal = ID_T1STARTNORMAL_152I;	// 通常時：合計行①の先頭インデックス
	m_uInfo.intT2StartNormal = ID_T2STARTNORMAL_152I;	// 通常時：合計行②の先頭インデックス
	m_uInfo.intT1StartKobetu = ID_T1STARTKOBETU_152I;	// 個別時：合計行①の先頭インデックス
	m_uInfo.intT2StartKobetu = ID_T2STARTKOBETU_152I;	// 個別時：合計行②の先頭インデックス
	m_uInfo.intRowKei = ID_ROWKEI_152;					// 帳表固定の合計行数（1:合計あり，0:なし）
	m_uInfo.intKei1StartIndex = ID_COL_152I_KEI1_MEISYO;	// 計ダイアグラム1行目の先頭インデックス
	m_uInfo.intKei2StartIndex = ID_COL_152I_KEI2_MEISYO;	// 計ダイアグラム2行目の先頭インデックス

	// 集計処理の設定
	m_uInfo.uCalcInfo.intMaxCount = ID_CALC_152_MAX;		// 集計フィールド件数
	m_uInfo.uCalcInfo.strField[0] = ID_CALC_152_FIELD1;		// 集計フィールド名称1
...
// 【戻値】    なし
//**************************************************
void	CfrmUc152KenrikinI::virSetInitialDiag()
{
	...
	switch ( m_uInfo.intFormType ) {
		...
		case ID_FORMTYPE_KOBETU:
			...
			m_DiagKeiNormal.ShowWindow( FALSE );
			...
			m_pDiagKei = CmnGetDiagType( &m_DiagKeiKobetu, &m_DiagKeiKobetu2 );
...
//	帳表固有変数の初期値設定
//********************************************************************************
void	CfrmUc152KenrikinI::virSetInitialValue()
{
	// 1ページ分のローカルバッファをクリア
	RecBufClearAllData();
...
//	帳表コントロールの初期化（データ領域）
//********************************************************************************
BOOL	CfrmUc152KenrikinI::InitialControlDataArea()
{
	int		intMax;
	int		i;
	int		len=0;
	...
	for ( i = m_uInfo.intCtlStartIndex; i < intMax; i += m_uInfo.intColMax ) {
		...
		// 支払年月日
		m_pDiag->GetAttribute((i + ID_COL_152I_SPDATE - 1),(LPUNKNOWN)&diaatt);
		diaatt.attr_dayattr = 15;
		m_pDiag->SetAttribute((i + ID_COL_152I_SPDATE - 1),(LPUNKNOWN)&diaatt,TRUE);

		// ComboBox：クリア
		CmnDiagSetString(m_pDiag, i + ID_COL_152I_INVONOT - 1, "", 0);	// 登録番号(T選択)

		// 漢字入力欄の初期化
		CmnDiagSetAttrInpmax( m_pDiag, i + ID_COL_152I_ADNAME1 - 1, MAX_KETA_152_ADNAME1 );		// 支払先の名称
		CmnDiagSetAttrInpmax( m_pDiag, i + ID_COL_152I_ADADD1  - 1, MAX_KETA_152_ADADD1 );		// 支払先の所在地1
		CmnDiagSetAttrInpmax( m_pDiag, i + ID_COL_152I_ADADD2  - 1, MAX_KETA_152_ADADD2 );		// 支払先の所在地2
		CmnDiagSetAttrInpmax( m_pDiag, i + ID_COL_152I_SPDATE  - 1, MAX_KETA_152_SPDATE );		// 支払年月日
		CmnDiagSetAttrInpmax( m_pDiag, i + ID_COL_152I_NAIYOU  - 1, MAX_KETA_152_NAIYOU );		// 権利金等の内容
		CmnDiagSetAttrInpmax( m_pDiag, i + ID_COL_152I_TEKI    - 1, MAX_KETA_152_TEKI );		// 摘要

		// 金額欄：桁数初期化
		len = ID_VAL_152_K_DATA;
		CmnDiagSetAttrDigit( m_pDiag, i + ID_COL_152I_VAL - 1, len );	// 期末現在高
	...
	// 半角/全角設定
	CmnDiagSetAttrColZenHan( m_pDiag , ID_COL_152I_ADNAME1 );		// 支払先の名称1
	CmnDiagSetAttrColZenHan( m_pDiag , ID_COL_152I_ADADD1 );		// 支払先の所在地1
	CmnDiagSetAttrColZenHan( m_pDiag , ID_COL_152I_ADADD2 );		// 支払先の所在地2
	CmnDiagSetAttrColZenHan( m_pDiag , ID_COL_152I_NAIYOU );		// 権利金等の内容
	CmnDiagSetAttrColZenHan( m_pDiag , ID_COL_152I_TEKI );			// 摘要
...
//********************************************************************************
BOOL	CfrmUc152KenrikinI::InitialControlComboBox()
{
	...
	for(i = 1; i <= intMax; i++) {
		...
		intIndex = CmnGetControlIndex(i, ID_COL_152I_INVONOT);
...
//********************************************************************************
BOOL	CfrmUc152KenrikinI::InitialControlDataAreaHide( CICSDiag* pDiag )
{
	int		intMax;
	int		i;
	int		len=0;
	...
	for ( i = m_uInfo.intCtlStartIndex; i < intMax; i += m_uInfo.intColMax ) {
		...
		// 漢字入力欄の初期化
		CmnDiagSetAttrInpmax( pDiag, i + ID_COL_152I_ADNAME1 - 1, MAX_KETA_152_ADNAME1 );	// 支払先の名称
		CmnDiagSetAttrInpmax( pDiag, i + ID_COL_152I_ADADD1  - 1, MAX_KETA_152_ADADD1 );	// 支払先の所在地1
		CmnDiagSetAttrInpmax( pDiag, i + ID_COL_152I_ADADD2  - 1, MAX_KETA_152_ADADD2 );	// 支払先の所在地2
		CmnDiagSetAttrInpmax( pDiag, i + ID_COL_152I_SPDATE  - 1, MAX_KETA_152_SPDATE );	// 支払年月日
		CmnDiagSetAttrInpmax( pDiag, i + ID_COL_152I_NAIYOU  - 1, MAX_KETA_152_NAIYOU );	// 権利金等の内容
		CmnDiagSetAttrInpmax( pDiag, i + ID_COL_152I_TEKI    - 1, MAX_KETA_152_TEKI );		// 摘要

		// 金額欄：桁数初期化
		//if(bG_Kanso == TRUE)	len = ID_VAL_152_K_DATA;
		//else					len = ID_VAL_152_DATA;
		len = ID_VAL_152_K_DATA;
		CmnDiagSetAttrDigit( pDiag, i + ID_COL_152I_VAL - 1, len );	// 支払金額
	}
...
//********************************************************************************
void	CfrmUc152KenrikinI::InitialControlTotalArea()
{
	int		nKeiType;			//	計の種別
	...
	m_pDiagKei->ModifyItem(ID_COL_152I_KEI1_VAL, intKeiRow);
	m_pDiagKei->ModifyItem(ID_COL_152I_KEI2_VAL, intKeiRow);
}
...
//		→表示していない方のDiag(通常 or 個別)の設定に使用する
//********************************************************************************
void	CfrmUc152KenrikinI::InitialControlTotalAreaHide( CICSDiag* pDiag )
{
	int intIndex = 0;
	...
	// 合計行の金額欄は、金額欄 + 1桁
	intIndex = m_intT1StartIndexHide + m_uInfo.intCtlStartIndex + ID_COL_152I_VAL - 1;
	CmnDiagSetAttrDigit( pDiag, intIndex, ID_VAL_152_TOTAL );

	intIndex = m_intT2StartIndexHide + m_uInfo.intCtlStartIndex + ID_COL_152I_VAL - 1;
	CmnDiagSetAttrDigit( pDiag, intIndex, ID_VAL_152_TOTAL );
}
...
//	RET	なし
//********************************************************************************
void	CfrmUc152KenrikinI::InitialControlSpecialRow( int intRow, int intFgFunc )
{
	int				nIndex;		// インデックス
	DIAGRAM_DATA	diadata;	// ICSDIAG構造体
	...
	switch ( intFgFunc ) {
		...
		case ID_FGFUNC_IKKATUAUTO:		// 一括集計金額行（自動）
			// 桁数を設定
			CmnDiagSetAttrDigit( m_pDiag, CmnGetControlIndex( intRow , ID_COL_152I_VAL ), ID_VAL_152_TOTAL );
			break;
	}
	...
	switch (intFgFunc) {
		...
		case ID_FGFUNC_IKKATUAUTO:		// 一括集計金額行（自動）
			...
			if(intFgFunc != ID_FGFUNC_IKKATUAUTO) {
				...
				m_pDiag->ModifyItem(CmnGetControlIndex(intRow, ID_COL_152I_INVONOT), DIAG_MDFY_NODROPDOWN);

				// ComboBoxの選択項目クリア
				m_clsFunc.DiagInit(&diadata);
				diadata.text_combo = _T("\r\n");
				m_pDiag->SetData(CmnGetControlIndex(intRow, ID_COL_152I_INVONOT), (LPUNKNOWN)&diadata);
			}
...
//	帳表タイトル情報の表示
//********************************************************************************
void	CfrmUc152KenrikinI::virUpdateControlTitle()
{
	DIAGRAM_ATTRIBUTE diaatt;
...
//	帳表ページ情報の表示
//********************************************************************************
void	CfrmUc152KenrikinI::UpdateControlPage()
{
	BOOL	bBack = TRUE;
	BOOL	bNext = TRUE;
...
//	帳表データの表示（１ページ分）
//********************************************************************************
BOOL	CfrmUc152KenrikinI::virUpdateControlTblData()
{
	// ダイアログ切替
	if( m_pDiag != NULL ){
		virSetInitialDiag();
	...
	CmnDiagSetAttrDigit( m_pDiagKei, ID_COL_152I_KEI1_VAL, ID_VAL_152_TOTAL );
	CmnDiagSetAttrDigit( m_pDiagKei, ID_COL_152I_KEI2_VAL, ID_VAL_152_TOTAL );
	...
	while ( !dbRec.IsEOF() ) {		// ファイル終端まで
		...
		// 権利金等の内容
		CmnInitialControlFgStringCell( m_pDiag, dbRec.m_NumRow, ID_COL_152I_NAIYOU, dbRec.m_FgFunc, UC_152_NAIYOU_LEN, dbRec.m_Naiyou);
		// 摘要
		CmnInitialControlFgStringCell( m_pDiag, dbRec.m_NumRow, ID_COL_152I_TEKI, dbRec.m_FgFunc, UC_152_TEKI_LEN, dbRec.m_Teki);
...
//	保管件数の表示
//********************************************************************************
BOOL CfrmUc152KenrikinI::virUpdateControlTblData2()
{
	int					hcnt=0;
	CString				cs=_T("");
...
//		IN		CdbUc152Kenrikin*	「権利金」
//		RET		なし
//********************************************************************************
void	CfrmUc152KenrikinI::UpdateControlRowData( CdbUc152Kenrikin* prmDbRec ) {
	DIAGRAM_DATA		diadata;		// ICSDiag構造体
	int					intCell;		// 保存フィールド
	CString				cs1, cs2, cst;
	...
	// 読込み対象セル取得
	intCell = CmnGetControlIndex( prmDbRec->m_NumRow, ID_COL_152I_INVONOT );
...
//********************************************************************************
//	帳表データの１行表示（累計，頁計行）
//		IN		CdbUc152Kenrikin*	「権利金」テーブル情報
//		RET		なし
//********************************************************************************
void	CfrmUc152KenrikinI::UpdateControlRowTotal( CdbUc152Kenrikin* prmDbRec )
{
	int		intTotalType;
	...
	// 頁計/累計の名称表示
	if ( intRowName > 0 ) {
		CmnDiagSetString( m_pDiagKei, CmnGetKeiDiagIndex( intRowName, ID_COL_152I_KEI1_MEISYO ), prmDbRec->m_KeiStr, 1 );
	}
	// 頁計/累計の金額表示
	if ( intRowVal > 0 ) {
		CmnDiagSetKingaku( m_pDiagKei, CmnGetKeiDiagIndex( intRowVal, ID_COL_152I_KEI1_VAL ), prmDbRec->m_Val );
	}
}
...
//		RET		なし
//********************************************************************************
void	CfrmUc152KenrikinI::virFncCellCopyProc( CdbUc000Common* rsData )
{
	CdbUc152Kenrikin*	rs;
	int					intCol;	// 現在の列
	int					ind1,ind2;
	...
	switch( intCol ){
		// 登録番号（T選択）
		case ID_COL_152I_INVONOT:
		// 登録番号
		case ID_COL_152I_INVONO:
			if(intCol == ID_COL_152I_INVONOT) {
...
//********************************************************************************
int	CfrmUc152KenrikinI::virFncReferenceGetType(int intCol, int* intGrSeq, long* lngItemSeq, int* intAdd1, int* intAdd2, int* intAdd1Col, int* intAdd2Col, REFERENCE_INFO* pudReference)
{
	...
	switch ( intCol ) {
		...
		case ID_COL_152I_ADADD2:
			...
			*intAdd1 = 20 * 2;			// Byte指定
			*intAdd2 = 20 * 2;			// Byte指定
			*intAdd1Col = ID_COL_152I_ADADD1;
			*intAdd2Col = ID_COL_152I_ADADD2;
			break;
...
//		RET		なし
//********************************************************************************
void	CfrmUc152KenrikinI::virFncReferenceSetICSData(CdlgAddressSearch* dlgAddd)
{
	int			intIndex;
	...
	switch ( m_uInfo.intCurCol ) {
		...
		case ID_COL_152I_ADADD2:
			//	支払の所在地１
			intIndex = CmnGetControlIndex( m_uInfo.intCurRow, ID_COL_152I_ADADD1 );
			CmnDiagSetString( m_pDiag, intIndex, dlgAddd->m_AdAdd1, 0 );
			//	支払先のの所在地２
			intIndex = CmnGetControlIndex( m_uInfo.intCurRow, ID_COL_152I_ADADD2 );
			CmnDiagSetString( m_pDiag, intIndex, dlgAddd->m_AdAdd2, 0 );
			break;
	}
}

void CfrmUc152KenrikinI::virActivateFrame(UINT nState, CFrameWnd* pDeactivateFrame)
{
	int		index = 0;
	...
	if(pWnd != NULL)	{
		if(m_DataKakutei == FALSE)	{
			if(m_uInfo.intCurCol == ID_COL_152I_SPDATE)	{
...
//	その他イベント処理
//********************************************************************************
BOOL	CfrmUc152KenrikinI::PreTranslateMessage( MSG* pMsg )
{
...
// 修正No.168362 add <--
						...
						intCol = CmnGetControlCol();
						if(intCol == ID_COL_152I_SPDATE || intCol == ID_COL_152I_INVONOT) {
							rv = 1;
						}
// 修正No.168362 add -->
					} 
...
// 頁コントロールのフォーカス設定
void	CfrmUc152KenrikinI::FocusPagediag1()
{
}

// 頁コントロールのゲットフォーカス
void	CfrmUc152KenrikinI::EditONPagediag1( short index )
{
// 修正No.168443 add -->
	// ---- 登録番号一覧関連 ----->
	if(pZmSel && pZmSel->IsDisplay() != FALSE) {
...
// 頁コントロールのロストフォーカス
void	CfrmUc152KenrikinI::EditOFFPagediag1( short index )
{
...
// 頁コントロールのキー操作
void	CfrmUc152KenrikinI::TerminationPagediag1( short index, short nChar, short length, LPUNKNOWN data )
{
	int nMaxDataCol = 0;
	// カレント頁の合計行の種別を取得
	...
	switch ( nChar ) {
		...
		case VK_TAB:
			...
			if ( CmnCheckShiftKey() == FALSE ) {
				...
				CmnDiagSetFocus(m_pDiag, nMaxDataCol, ID_COL_152I_TEKI);
			}
			break;
		case VK_DOWN:
			// タイトルコントロールへ移動
...
// タイトルコントロールのフォーカス設定
void	CfrmUc152KenrikinI::FocusTitlediag1()
{
...
// タイトルコントロールのゲットフォーカス
void	CfrmUc152KenrikinI::EditONTitlediag1( short index )
{
// 修正No.168443 add -->
	// ---- 登録番号一覧関連 ----->
	if(pZmSel && pZmSel->IsDisplay() != FALSE) {
...
// タイトルコントロールのロストフォーカス
void	CfrmUc152KenrikinI::EditOFFTitlediag1 (short index )
{
	m_Titlefocus = 0;
	virUpdateTitle();
}
...
//	タイトル更新
void CfrmUc152KenrikinI::virUpdateTitle()
{
...
// タイトルコントロールのキーイベント
void	CfrmUc152KenrikinI::TerminationTitlediag1( short index, short nChar, short length, LPUNKNOWN data )
{
	// フォーカス移動
	switch ( nChar ) {
		case VK_RETURN:
...
//********************************************************************************
//	「権利金」データコントロール処理（EditON，EditOFF，Terminationイベント）
//********************************************************************************

// 「権利金」データコントロールのゲットフォーカス
void	CfrmUc152KenrikinI::EditONYoushikidiag1( short index )
{
	...
	if(m_uInfo.intCurCol == ID_COL_152I_SPDATE)	m_uInfo.EditSign = 1;
	else										m_uInfo.EditSign = -1;

	switch (m_uInfo.intCurCol) {
		case ID_COL_152I_SPDATE:	// 支払年月日
		...
		case ID_COL_152I_INVONOT:	// 登録番号(T選択)
			// コンボボックスのオフセット値取得
	...
	if ( ( m_uInfo.OldRow > 0 ) ) {
		if ( m_uInfo.OldPage == m_uInfo.intCurPage && m_uInfo.OldPage > 0 ) {
			// T選択⇔登録番号は保存しない
			BOOL tsel_to_invno = IsSaveMoveReference(ID_COL_152I_INVONOT, ID_COL_152I_INVONO);
	...
	if(m_uInfo.intCurCol == ID_COL_152I_INVONO && m_EndSyorityu == 0)	{
// 修正No.168377 del -->
...
// 修正No.168377 add -->
		// 登録番号のT選択の値を取得
		int pos = CmnGetControlIndex(m_uInfo.intCurRow, ID_COL_152I_INVONOT);
...
// データコントロールのロストフォーカス
void	CfrmUc152KenrikinI::EditOFFYoushikidiag1( short index )
{
	if( m_EndView != FALSE )	return;

// 修正No.168443 add -->
	// ---- 登録番号一覧関連 ----->
	if(m_uInfo.intCurCol != ID_COL_152I_INVONO) {
		if(pZmSel && pZmSel->IsDisplay() != FALSE) {
			pZmSel->DialogOFF();
		}
	}
...
// 修正No.168443 del -->
	...
	//		//// カーソル移動処理
	//		//CmnDiagSetFocus( m_pDiag, m_uInfo.intCurRow, ID_COL_152I_INVONO );
	//	}
	//}

	//// ---- 登録番号一覧関連 ----->
	//if(pZmSel && m_uInfo.intCurCol != ID_COL_152I_INVONO) {
...
//	入力確定
void CfrmUc152KenrikinI::virInputDecisionEditOFF()
{
	// フォーカスフラグOFF
...
// 権利金データコントロールのキーイベント
void	CfrmUc152KenrikinI::TerminationYoushikidiag1( short index, short nChar, short length, LPUNKNOWN data )
{
	//--------------------------------------------------------------------------------
	//	キー操作仕様
...
void CfrmUc152KenrikinI::VScrollYoushikidiag1(short mode)
{
// 修正No.168430 del -->
...
//********************************************************************************
int	CfrmUc152KenrikinI::GetFocusPosition( int nChar )
{
	int		intRow;				// カレント行番号
	int		intCol;				// カレント列番号
	...
	// 行をまたぐ場合のインデックス増減数（摘要→次の行の支払先の名称）
	...
	else if(intCol == ID_COL_152I_ADNAME1) {
		// カレント列が「支払先の名称」の場合
		intVector[0] = m_uInfo.intCurCtlIndex - m_uInfo.intColMax + 2;	// ↑
		intVector[1] = m_uInfo.intCurCtlIndex + 1;						// →
		intVector[2] = m_uInfo.intCurCtlIndex + 1;						// ↓
	...
	else if(intCol == ID_COL_152I_ADADD1)	{
		// カレント列が「支払先の所在地1」の場合
	...
	else if(intCol == ID_COL_152I_ADADD2)	{
		// カレント列が「支払先の所在地2」の場合
		intVector[0] = m_uInfo.intCurCtlIndex - 1;						// ↑
		intVector[1] = m_uInfo.intCurCtlIndex + 1;						// →
	...
	else if(intCol == ID_COL_152I_TEKI)	{
		// カレント列が「摘要」の場合
	...
	switch ( nChar ) {
		...
		case VK_RETURN:	// Enterキーでカーソルを下に移動するモード対応
			if(m_ReturnMoveDown) {
				if(intCol == ID_COL_152I_INVONOT)	intNext = intVector[1];			//	カレント列が「登録番号(T表示)」欄の場合「→」キーと同じ
...
//********************************************************************************
int	CfrmUc152KenrikinI::GetTotalRowIndex( int nCharOrg, int intIndex, int intNext )
{
	...
	if ( nNowRow <= nBorder[0] ){		
		...
		if (( intNext > CmnGetControlIndex( m_uInfo.intRowMax, ID_COL_152I_TEKI ) ) && ( nCharOrg == VK_TAB )){
			return( -2 );
		}
		//	データ行を超えた？かつ計行あり？
	...
	//	現在、頁計に居る
		...
		case VK_UP:			// ↑：23行目のデータ行の支店名項目へ移動
			nRet = CmnGetControlIndex( nBorder[0], ID_COL_152I_ADADD2 );
			break;

		case VK_LEFT:		// ←/Shift+Tab：23行目のデータ行の摘要項目へ移動
			nRet = CmnGetControlIndex( nBorder[0], ID_COL_152I_TEKI );
			break;
		...
		default:			// →/↓/Return/Tab：25行目の合計行②へ移動
			...
			//	累計なし
				...
				nRet = CmnGetControlIndex( ( nBorder[2] + 2 ), ID_COL_152I_ADNAME1 );
			}
			break;
		}
	}
	//	現在、累計に居る場合
		...
		case VK_LEFT:		// ←/Shift+Tab：24行目の合計行① or 24行目のデータ行の摘要項目へ移動
			nRet = CmnGetControlIndex( ( nBorder[1] + 2 ), ID_COL_152I_ADNAME1 );
			break;
...
//********************************************************************************
int	CfrmUc152KenrikinI::virTblSortSubSortProc( CdlgSort* pCdlgSort, CdbUc000Common* rsData )
{
	CdbUc152Kenrikin*	rs;
	CString				strFilter;
	CString				strSort;
...
/**********************************************************************
	RecBufSetData(CdbUc152Kenrikin* prmDbRec)
		ローカルのレコードバッファに、1行分のデータを格納する

	引数
		CdbUc152Kenrikin*	prmDbRec	レコードセット(データがあること）
	戻値
		int		成功/失敗
				FUNCTION_OK
***********************************************************************/
int	CfrmUc152KenrikinI::RecBufSetData( CdbUc152Kenrikin* prmDbRec )
{
	...
	m_ReadData[trgRow].m_SpDate = prmDbRec->m_SpDate;		// 支払年月日
	m_ReadData[trgRow].m_Val = prmDbRec->m_Val;				// 支払金額
	m_ReadData[trgRow].m_Naiyou = prmDbRec->m_Naiyou;		// 権利金等の内容
...
/**********************************************************************
	...
	戻値
		int		成功/失敗
				FUNCTION_OK
***********************************************************************/
int	CfrmUc152KenrikinI::RecBufClearAllData()
{
...
/**********************************************************************
	...
	引数
		P_REC_UC_152_KENRIKIN inRecData レコードへのポインタ
	戻値
		int		成功/失敗
				FUNCTION_OK
***********************************************************************/
int	CfrmUc152KenrikinI::RecBufClearData( P_REC_UC_152_KENRIKIN inRecData )
{
	...
	inRecData->m_SpDate = 0;		// 支払年月日
	inRecData->m_Val = _T("");		// 支払金額
	inRecData->m_Naiyou = _T("");	// 権利金等の内容
...
/**********************************************************************
	...
	戻値
		int				成功(更新あり)/成功(更新なし)/失敗
						...
						FUNCTION_NG		: 失敗
***********************************************************************/
int	CfrmUc152KenrikinI::virRecBufSaveData( int inPage, int inRow )
{
	REC_UC_152_KENRIKIN	tmpSaveData;	// 画面データ1レコード格納用
	BOOL	blnSpDate = FALSE;			// 「支払年月日」入力更新フラグ
	...
	// 登録番号（T選択）
	intIndex = CmnGetControlIndex(inRow, ID_COL_152I_INVONOT);
	m_pDiag->GetData(intIndex, (LPUNKNOWN)&diadata);
	tsel = diadata.data_combo;

	// 登録番号（法人番号）
	intIndex = CmnGetControlIndex(inRow, ID_COL_152I_INVONO);
	...
	// 支払先の名称1
	intIndex = CmnGetControlIndex( inRow, ID_COL_152I_ADNAME1 );
	tmpSaveData.m_AdName1 = m_clsFunc.DiagGetString( m_pDiag, intIndex );

	// 支払先の所在地1
	intIndex = CmnGetControlIndex( inRow, ID_COL_152I_ADADD1 );
	tmpSaveData.m_AdAdd1 = m_clsFunc.DiagGetString( m_pDiag, intIndex );

	// 支払先の所在地2
	intIndex = CmnGetControlIndex( inRow, ID_COL_152I_ADADD2 );
	tmpSaveData.m_AdAdd2 = m_clsFunc.DiagGetString( m_pDiag, intIndex );

	// 支払年月日
	intIndex = CmnGetControlIndex( inRow, ID_COL_152I_SPDATE );
	...
	// 支払金額
	intIndex = CmnGetControlIndex( inRow, ID_COL_152I_VAL );
	tmpSaveData.m_Val = CmnDiagGetKingaku( m_pDiag, intIndex );

	// 権利金等の内容
	intIndex = CmnGetControlIndex( inRow, ID_COL_152I_NAIYOU );
	tmpSaveData.m_Naiyou = m_clsFunc.DiagGetString( m_pDiag, intIndex );

	// 摘要
	intIndex = CmnGetControlIndex( inRow, ID_COL_152I_TEKI );
...
***********************************************************************/
int	CfrmUc152KenrikinI::virRecBufSaveDataForPasteInsert( int inPage, int inRow )
{
...
***********************************************************************/
int	CfrmUc152KenrikinI::virRecBufSaveDataForPaste( int inPage, int inRow )
{
	///////////////////////////////////////////////////////////////
	// 登録処理呼び出し
	return RecBufSaveDataSub( inPage, inRow, &m_CopyData );
...
/**********************************************************************
	...
	戻値
			int					成功(更新あり)/成功(更新なし)/失敗
								...
								FUNCTION_NG		: 失敗
***********************************************************************/
int	CfrmUc152KenrikinI::RecBufSaveDataSub( 
							int inPage,
							int inRow,
							P_REC_UC_152_KENRIKIN inSaveData )
{

	REC_UC_152_KENRIKIN		udtTemp;
	CString					cst;
	...
	BOOL	ufgSpDate = FALSE;	// 変更確認フラグ(支払年月日)
	BOOL	ufgVal	= FALSE;	// 変更確認フラグ(支払金額)
	BOOL	ufgNaiyou = FALSE;	// 変更確認フラグ(権利金等の内容)
	...
	if ( udtTemp.m_FgFunc <= ID_FGFUNC_DATA ) {	// データ行 または、空行なら
		...
		if ( (udtTemp.m_InvNo == "" )		// 画面上のデータ格納用(登録番号)
		  ...
		  && ( udtTemp.m_SpDate == 0 )		// 画面上のデータ格納用(支払年月日)
		  && ( udtTemp.m_Val == "" )		// 画面上のデータ格納用(支払金額)
		  && ( udtTemp.m_Naiyou == "" )		// 画面上のデータ格納用(権利金等の内容)
...
//********************************************************************************
//	「権利金」テーブルのオブジェクトを生成し、ポインタを返す
//********************************************************************************
CdbUc000Common*	CfrmUc152KenrikinI::virGetDataTableObject()
{
	// 「権利金」テーブルのオブジェクトを生成し、ポインタを返す
	return (CdbUc000Common*)( new CdbUc152Kenrikin( m_pDB ) );
}
...
//	RET	なし
//********************************************************************************
void	CfrmUc152KenrikinI::virRowButtonCopyProc()
{
...
//	RET	なし
//********************************************************************************
void	CfrmUc152KenrikinI::virGetCurrentInfo( CURRENT_INFO* uCurInfo )
{
...
//********************************************************************************
int	CfrmUc152KenrikinI::virUpdateRelationTblChengeFormType()
{
...
//		RET		BOOL		TRUE:正常終了，FALSE:エラー
//********************************************************************************
BOOL CfrmUc152KenrikinI::virUpdateRelationTblChengeFormTypeSave()
{
	//CfrmUc151Tidaiyatin	pfrm151;
	CfrmUc151TidaiyatinI	pfrm151;
	//CfrmUc153Kougyou		pfrm153;
	...
	// ⑮-2で通常/個別を変更した場合、⑮-3のm_uInfoを保存する
	ret2 = pfrm153.CmnSetInitialUchiwakeInfo(ID_FORMNO_153);
...
//********************************************************************************
//	通常/個別切り替え時の頁構成を更新（⑮-1，⑮-3から実行される処理）
//		IN		なし
//		RET		なし
//********************************************************************************
int	CfrmUc152KenrikinI::UpdateTbl152ChangeFormType()
{
	// 初期値設定
	CmnSetInitialUchiwakeInfo(ID_FORMNO_152);	// 共通データ
	virSetInitialValue();						// 帳表固有データ
...
//	【戻値】	なし
//**************************************************
void CfrmUc152KenrikinI::SetInputMode( int nRow, long nMode )
{
	m_pDiag->ModifyItem( CmnGetControlIndex( nRow, ID_COL_152I_INVONOT ), nMode );	//	登録番号（T選択）
	m_pDiag->ModifyItem( CmnGetControlIndex( nRow, ID_COL_152I_INVONO ), nMode );	//	登録番号
	m_pDiag->ModifyItem( CmnGetControlIndex( nRow, ID_COL_152I_ADNAME1 ), nMode );	//	支払先の名称	
	m_pDiag->ModifyItem( CmnGetControlIndex( nRow, ID_COL_152I_ADADD1 ), nMode );	//	支払先の所在地（上段）
	m_pDiag->ModifyItem( CmnGetControlIndex( nRow, ID_COL_152I_ADADD2 ), nMode );	//	支払先の所在地（下段）
	m_pDiag->ModifyItem( CmnGetControlIndex( nRow, ID_COL_152I_SPDATE ), nMode );	//	支払年月日
	m_pDiag->ModifyItem( CmnGetControlIndex( nRow, ID_COL_152I_VAL ), nMode );		//	支払金額
	m_pDiag->ModifyItem( CmnGetControlIndex( nRow, ID_COL_152I_NAIYOU ), nMode );	//	権利金等の内容
	m_pDiag->ModifyItem( CmnGetControlIndex( nRow, ID_COL_152I_TEKI ), nMode );		//	摘要
}
...
//	【戻値】	なし
//**************************************************
void CfrmUc152KenrikinI::SetDiagBackColor()
{
	...
	m_DiagKeiKobetu.SetBackColor( m_ViewColor );
	m_DiagKeiKobetu2.SetBackColor( m_ViewColor );
	m_DiagKeiNormal.SetBackColor( m_ViewColor );
...
//***************************************************************************
BOOL CfrmUc152KenrikinI::virEndProc(void)
{
	TRACE(_T("***** CfrmUc152KenrikinI::virEndProc\n"));
...
int CfrmUc152KenrikinI::CursorControl(short nChar, int sw)
{
	int				rv=0;
	int				intCol=0;
	int				pos=0;
	...
	if((nChar == VK_TAB && (key & 0x80) == 0x80) || (nChar == VK_LEFT) || (nChar == VK_RIGHT)) {
		...
		if(intCol == ID_COL_152I_INVONOT)	{	// 登録番号(T選択)
			m_pDiag->ComboDropDown(m_uInfo.intCurCtlIndex, FALSE);
			CmnDiagSetCombo(m_pDiag, m_uInfo.intCurCtlIndex, m_uInfo.OldCombo);
		}
	}
...
// ------------------------------------------------------------------------------------------------------------------------
void CfrmUc152KenrikinI::TitleColorChg(void)
{
	int					nCharOver[2]={0};	// 電子申告の文字数を超えたかどうかのサイン		1:電子申告の文字数を超えた
											// 様式⑮-2		[0]:権利金等の内容(30文字)	[1]:摘要(40文字)
	...
	// 権利金等の内容
	strSQL.Format(_T("select max(oversgn) from (select CASE when len(%s) > %d then 1 else 0 end as oversgn from uc_152_kenrikin where FgShow=%d) tbl1"),
		MakeReplaceSent(_T("Naiyou")),UC_152_NAIYOU_LEN,ID_FGSHOW_OFF);
	...
	// 摘要
	strSQL.Format(_T("select max(oversgn) from (select CASE when len(%s) > %d then 1 else 0 end as oversgn from uc_152_kenrikin where FgShow=%d) tbl1"),
		MakeReplaceSent(_T("Teki")),UC_152_TEKI_LEN,ID_FGSHOW_OFF);
	rs.Open( CRecordset::forwardOnly, strSQL);
	rs.GetFieldValue((short)0, strData);
	rs.Close();
	nCharOver[1] = 0;
	...
	// 項目タイトル(ヘッダ部)の再設定
	if(nCharOver[0] == 1)	CmnHeadDiagSetTitle(&m_HeadDiag,5,_T("権利金等の内容(30)"),1);
	else					CmnHeadDiagSetTitle(&m_HeadDiag,5,_T("権利金等の内容"),0);

	if(nCharOver[1] == 1)	CmnHeadDiagSetTitle(&m_HeadDiag,6,_T("摘  要(40)"),1);
...
// --------------------------------------------------------------------------------------------------------
void CfrmUc152KenrikinI::Date_ChkAndSet(short index, int col, short sign)
{
	short			sv_sel=0;
	int				sv_index=0;
	int				day=0,gen=0;
	...
	if(col != ID_COL_152I_SPDATE)	return;
	...
	if(sign == 1)	{
		if(col == ID_COL_152I_SPDATE)	{		// 支払年月日
...
LRESULT CfrmUc152KenrikinI::OnUserReDrawView(WPARAM wParam, LPARAM lParam)
{
	virUpdateControlTblData();
	CmnDiagSetFocus(m_pDiag, 1, 1);
...
//		RET		なし
// --------------------------------------------------------------------------------------------------------
void CfrmUc152KenrikinI::virDiagGetHjnData(CDatabase* pDB, HJN_REC_NEW* phjnRec)
{
	int				nPage,nRow;
	int				intIndex;	// 対象行の各インデックス
	int				tsel=0;
	...
	// 登録番号（法人番号）
	cst.Empty();
	intIndex = CmnGetControlIndex(nRow, ID_COL_152I_INVONO);
	...
	// 名称1(氏名)
	intIndex = CmnGetControlIndex(nRow, ID_COL_152I_ADNAME1);
	...
	// 所在地1(住所)
	intIndex = CmnGetControlIndex(nRow, ID_COL_152I_ADADD1);
	cst = m_clsFunc.DiagGetString(m_pDiag, intIndex);
	cst.TrimRight();
	if(cst.IsEmpty() == FALSE)	{
		memset(buf, 0, sizeof(buf));
	...
	// 所在地2(住所)
	intIndex = CmnGetControlIndex(nRow, ID_COL_152I_ADADD2);
	cst = m_clsFunc.DiagGetString(m_pDiag, intIndex);
	cst.TrimRight();
	if(cst.IsEmpty() == FALSE) {
		memset(buf, 0, sizeof(buf));
...
//		RET		なし
// --------------------------------------------------------------------------------------------------------
void	CfrmUc152KenrikinI::virDiagSetHjnData(int pSw, CString rtInvNo, CString rtName, CString rtAdrs1, CString rtAdrs2, CString rtKana)
{
	int					ret = 0;
	int					intIndex;
...
// 修正No.168361,168369,168371,168378 del <--
		// 登録番号（T選択）
		intIndex = CmnGetControlIndex(m_uInfo.intCurRow, ID_COL_152I_INVONOT);
		CmnDiagSetCombo3(m_pDiag, intIndex, strInvoNo);

		// 登録番号
		InvoNoSplit(strInvoNo, &cs1, &cs2);
		intIndex = CmnGetControlIndex(m_uInfo.intCurRow, ID_COL_152I_INVONO);
...
// --------------------------------------------------------------------------------------------------------
// --------------------------------------------------------------------------------------------------------
int CfrmUc152KenrikinI::virCallChkInvoiceNum(int pSw, int inPage, int inRow)
{
...
//				CString		pInvno	登録番号
// --------------------------------------------------------------------------------------------------------
int CfrmUc152KenrikinI::ChkInvoiceNum(CDatabase* pDB, int pSw, int inPage, int inRow,
...
// 修正No.168361,168369,168371,168378 del -->
	...
	//		DIAGRAM_DATA	ddata;
	//		ddata.data_combo = 0;
	//		m_pDiag->SetData(CmnGetControlIndex(inRow, ID_COL_152I_INVONOT), (LPUNKNOWN)&ddata);
	//		ddata.data_edit.Empty();
	//		m_pDiag->DataClear(CmnGetControlIndex(inRow, ID_COL_152I_INVONO), TRUE);
	//		// エラーメッセージを表示
...
// 修正No.168443 add <--
			...
			if(pZmSel && pZmSel->IsDisplay() != FALSE && cst.GetLength() < 3) {
				...
				if(tmpzd.errflg != -1) {
					...
					m_pDiag->SetData(CmnGetControlIndex(inRow, ID_COL_152I_INVONO), (LPUNKNOWN)&ddata);
					// 再描画
					m_pDiag->Refresh();
...
// 修正No.168425,168443 add -->
					if(pSw == 3 || m_EndSyorityu == 1)	{
						...
						m_uInfo.intCurCol = ID_COL_152I_INVONO;
