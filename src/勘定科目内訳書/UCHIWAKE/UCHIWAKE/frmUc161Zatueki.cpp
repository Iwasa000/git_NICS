...
IMPLEMENT_DYNCREATE( CfrmUc161Zatueki, CfrmUc000Common )


BEGIN_MESSAGE_MAP( CfrmUc161Zatueki, CfrmUc000Common )
	ON_WM_SIZE()
...
//	ON_COMMAND( ID_BUTTON_F3, OnButtonF3 )
	...
	ON_COMMAND( ID_PRINTSETUP_MENU, &CfrmUc161Zatueki::OnMenuPrintSetup )
	ON_COMMAND( ID_PRINTALL_MENU, &CfrmUc161Zatueki::OnMenuPrintAll )
	ON_COMMAND( ID_OUTPUTFORM_MENU, &CfrmUc161Zatueki::OnMenuFormTypeSetup )
	ON_COMMAND( ID_SPECIALROW_MENU, &CfrmUc161Zatueki::OnMenuSpecialRow )
	ON_COMMAND( ID_SORT_MENU, &CfrmUc161Zatueki::OnMenuSort )
	ON_COMMAND(ID_IKKATUADD_MENU, &CfrmUc161Zatueki::OnIkkatuAddMenu)
	ON_COMMAND( ID_DISPDIALOG_MENU, &CfrmUc161Zatueki::OnMenuIkkatuKingaku )
	ON_COMMAND( ID_ZEROMONEY_MENU, &CfrmUc161Zatueki::OnMenuZeroMoney )
	ON_COMMAND( ID_ZEROMONEYMOVE_MENU, &CfrmUc161Zatueki::OnMenuZeroMoneyMove )
	ON_COMMAND( ID_AMOUTDIALOG_MENU, &CfrmUc161Zatueki::OnMenuOutKeiSetup )
// midori 160606 add -->
	ON_COMMAND( ID_CLEAR_MENU, &CfrmUc161Zatueki::OnMenuClear )
// midori 160606 add <--
	ON_COMMAND( ID_RENDO_MENU, &CfrmUc161Zatueki::OnMenuZaimuRendo )
	ON_COMMAND( ID_TITLEMENU, &CfrmUc161Zatueki::OnMenuTitleRestore )
	ON_COMMAND( ID_USER_SETTING_MENU, &CfrmUc161Zatueki::OnMenuOptionSetting )
	ON_COMMAND( ID_COPY_SETTING_INFO_MENU, &CfrmUc161Zatueki::OnMenuCopySettingInfo )
	ON_COMMAND( ID_DELETE_DATA_MENU, &CfrmUc161Zatueki::OnMenuDeleteDataEachYoushiki )
	ON_BN_CLICKED( IDC_PAGEBACK_BUTTON1, &CfrmUc161Zatueki::OnPageBack )
	ON_BN_CLICKED( IDC_PAGENEXT_BUTTON1, &CfrmUc161Zatueki::OnPageNext )
	ON_BN_CLICKED( IDC_PAGENEW_BUTTON1, &CfrmUc161Zatueki::OnPageNew )
	ON_BN_CLICKED( IDC_PAGEINSERT_BUTTON1, &CfrmUc161Zatueki::OnPageInsert )
	ON_BN_CLICKED( IDC_ROWCOPY_BUTTON1, &CfrmUc161Zatueki::OnRowCopy )
	ON_BN_CLICKED( IDC_ROWPASTE_BUTTON1, &CfrmUc161Zatueki::OnRowPaste )
	ON_BN_CLICKED( IDC_ROWINSERT_BUTTON1, &CfrmUc161Zatueki::OnRowInsert )
	ON_BN_CLICKED( IDC_YOUSHIKINEXT_BUTTON1, &CfrmUc161Zatueki::OnMoveYoushikiNext )
	ON_BN_CLICKED( IDC_YOUSHIKIBACK_BUTTON1, &CfrmUc161Zatueki::OnMoveYoushikiBack )
//	ON_UPDATE_COMMAND_UI( ID_BUTTON_F1, &CfrmUc161Zatueki::OnUpdateButtonF1 )
//	ON_UPDATE_COMMAND_UI( ID_BUTTON_F3, &CfrmUc161Zatueki::OnUpdateButtonF3 )
	ON_UPDATE_COMMAND_UI( ID_BUTTON_F6, &CfrmUc161Zatueki::OnUpdateButtonF6 )
	ON_UPDATE_COMMAND_UI( ID_BUTTON_F7, &CfrmUc161Zatueki::OnUpdateButtonF7 )
	ON_UPDATE_COMMAND_UI( ID_BUTTON_F8, &CfrmUc161Zatueki::OnUpdateButtonF8 )
	ON_UPDATE_COMMAND_UI( ID_BUTTON_F9, &CfrmUc161Zatueki::OnUpdateButtonF9 )
	ON_UPDATE_COMMAND_UI( ID_BUTTON_F11, &CfrmUc161Zatueki::OnUpdateButtonF11 )
	ON_UPDATE_COMMAND_UI( ID_BUTTON_F12, &CfrmUc161Zatueki::OnUpdateButtonF12 )
	ON_UPDATE_COMMAND_UI( ID_BUTTON_HOME, &CfrmUc161Zatueki::OnUpdateButtonHome )
	ON_UPDATE_COMMAND_UI( ID_IKKATUADD_MENU, &CfrmUc161Zatueki::OnUpdateIkkatuaddMenu)
	ON_UPDATE_COMMAND_UI( ID_DISPDIALOG_MENU, &CfrmUc161Zatueki::OnUpdateMenuIkkatuKingaku )
// midori 160612 add -->
	ON_UPDATE_COMMAND_UI( ID_SORT_MENU, &CfrmUc161Zatueki::OnUpdateMenuSort )
	ON_UPDATE_COMMAND_UI( ID_CLEAR_MENU, &CfrmUc161Zatueki::OnUpdateMenuClear )
// midori 160612 add <--
	ON_UPDATE_COMMAND_UI( ID_ZEROMONEY_MENU, &CfrmUc161Zatueki::OnUpdateMenuZeroMoney )
// midori 160612 add -->
	ON_UPDATE_COMMAND_UI( ID_ZEROMONEYMOVE_MENU, &CfrmUc161Zatueki::OnUpdateMenuZeroMoneyMove)
// midori 160612 add <--
	ON_UPDATE_COMMAND_UI( ID_RENDO_MENU, &CfrmUc161Zatueki::OnUpdateMenuZaimuRendo )
	ON_UPDATE_COMMAND_UI(ID_SPECIALROW_MENU, &CfrmUc161Zatueki::OnUpdateMenuSpecialRow)
// midori 160612 add -->
	ON_UPDATE_COMMAND_UI( ID_TITLEMENU, &CfrmUc161Zatueki::OnUpdateMenuTitleRestore )
	ON_UPDATE_COMMAND_UI( ID_DELETE_DATA_MENU, &CfrmUc161Zatueki::OnUpdateMenuDeleteDataEachYoushiki )
// midori 160612 add <--
	ON_MESSAGE(WM_USER_REDRAWVIEW, OnUserReDrawView)		// 修正No.162446 add
END_MESSAGE_MAP()


CfrmUc161Zatueki::CfrmUc161Zatueki()
	: CfrmUc000Common( CfrmUc161Zatueki::IDD )
{
...
CfrmUc161Zatueki::~CfrmUc161Zatueki()
{
	...
	TRACE(_T("***** CfrmUc161Zatueki::~CfrmUc161Zatueki\n"));

	//m_pDiag = NULL;
	//m_pTitleDiag = NULL;
}

void CfrmUc161Zatueki::DoDataExchange( CDataExchange* pDX )
{
...
void CfrmUc161Zatueki::OnInitialUpdate()
{
...
#ifdef _DEBUG
void CfrmUc161Zatueki::AssertValid() const
{
	CfrmUc000Common::AssertValid();
}

#ifndef _WIN32_WCE
void CfrmUc161Zatueki::Dump( CDumpContext& dc ) const
{
...
BEGIN_EVENTSINK_MAP( CfrmUc161Zatueki, CfrmUc000Common )
	ON_EVENT( CfrmUc161Zatueki, IDC_YOUSHIKIDIAG1, 3, CfrmUc161Zatueki::TerminationYoushikidiag1, VTS_I2 VTS_I2 VTS_I2 VTS_UNKNOWN )
	ON_EVENT( CfrmUc161Zatueki, IDC_YOUSHIKIDIAG1, 2, CfrmUc161Zatueki::EditOFFYoushikidiag1, VTS_I2 )
	ON_EVENT( CfrmUc161Zatueki, IDC_YOUSHIKIDIAG1, 1, CfrmUc161Zatueki::EditONYoushikidiag1, VTS_I2 )
// midori 151405 add -->
	ON_EVENT(CfrmUc161Zatueki, IDC_YOUSHIKIDIAG1, 12, CfrmUc161Zatueki::VScrollYoushikidiag1, VTS_I2)
// midori 151405 add <--
// midori 152134 add -->
	ON_EVENT(CfrmUc161Zatueki, IDC_YOUSHIKIDIAG1, 8, CfrmUc161Zatueki::ComboSelYoushikidiag1, VTS_I2 VTS_UNKNOWN)
// midori 152134 add <--

	ON_EVENT( CfrmUc161Zatueki, IDC_YOUSHIKIDIAG2, 3, CfrmUc161Zatueki::TerminationYoushikidiag1, VTS_I2 VTS_I2 VTS_I2 VTS_UNKNOWN )
	ON_EVENT( CfrmUc161Zatueki, IDC_YOUSHIKIDIAG2, 2, CfrmUc161Zatueki::EditOFFYoushikidiag1, VTS_I2 )
	ON_EVENT( CfrmUc161Zatueki, IDC_YOUSHIKIDIAG2, 1, CfrmUc161Zatueki::EditONYoushikidiag1, VTS_I2 )
// midori 151405 add -->
	ON_EVENT(CfrmUc161Zatueki, IDC_YOUSHIKIDIAG2, 12, CfrmUc161Zatueki::VScrollYoushikidiag1, VTS_I2)
// midori 151405 add <--
// midori 152134 add -->
	ON_EVENT(CfrmUc161Zatueki, IDC_YOUSHIKIDIAG2, 8, CfrmUc161Zatueki::ComboSelYoushikidiag1, VTS_I2 VTS_UNKNOWN)
// midori 152134 add <--

	ON_EVENT( CfrmUc161Zatueki, IDC_YOUSHIKIDIAG3, 3, CfrmUc161Zatueki::TerminationYoushikidiag1, VTS_I2 VTS_I2 VTS_I2 VTS_UNKNOWN )
	ON_EVENT( CfrmUc161Zatueki, IDC_YOUSHIKIDIAG3, 2, CfrmUc161Zatueki::EditOFFYoushikidiag1, VTS_I2 )
	ON_EVENT( CfrmUc161Zatueki, IDC_YOUSHIKIDIAG3, 1, CfrmUc161Zatueki::EditONYoushikidiag1, VTS_I2 )
// midori 151405 add -->
	ON_EVENT(CfrmUc161Zatueki, IDC_YOUSHIKIDIAG3, 12, CfrmUc161Zatueki::VScrollYoushikidiag1, VTS_I2)
// midori 151405 add <--
// midori 152134 add -->
	ON_EVENT(CfrmUc161Zatueki, IDC_YOUSHIKIDIAG3, 8, CfrmUc161Zatueki::ComboSelYoushikidiag1, VTS_I2 VTS_UNKNOWN)
// midori 152134 add <--

	ON_EVENT( CfrmUc161Zatueki, IDC_YOUSHIKIDIAG4, 3, CfrmUc161Zatueki::TerminationYoushikidiag1, VTS_I2 VTS_I2 VTS_I2 VTS_UNKNOWN )
	ON_EVENT( CfrmUc161Zatueki, IDC_YOUSHIKIDIAG4, 2, CfrmUc161Zatueki::EditOFFYoushikidiag1, VTS_I2 )
	ON_EVENT( CfrmUc161Zatueki, IDC_YOUSHIKIDIAG4, 1, CfrmUc161Zatueki::EditONYoushikidiag1, VTS_I2 )
// midori 151405 add -->
	ON_EVENT(CfrmUc161Zatueki, IDC_YOUSHIKIDIAG4, 12, CfrmUc161Zatueki::VScrollYoushikidiag1, VTS_I2)
// midori 151405 add <--
// midori 152134 add -->
	ON_EVENT(CfrmUc161Zatueki, IDC_YOUSHIKIDIAG4, 8, CfrmUc161Zatueki::ComboSelYoushikidiag1, VTS_I2 VTS_UNKNOWN)
// midori 152134 add <--

	ON_EVENT( CfrmUc161Zatueki, IDC_YOUSHIKIDIAG5, 3, CfrmUc161Zatueki::TerminationYoushikidiag1, VTS_I2 VTS_I2 VTS_I2 VTS_UNKNOWN )
	ON_EVENT( CfrmUc161Zatueki, IDC_YOUSHIKIDIAG5, 2, CfrmUc161Zatueki::EditOFFYoushikidiag1, VTS_I2 )
	ON_EVENT( CfrmUc161Zatueki, IDC_YOUSHIKIDIAG5, 1, CfrmUc161Zatueki::EditONYoushikidiag1, VTS_I2 )
// midori 151405 add -->
	ON_EVENT(CfrmUc161Zatueki, IDC_YOUSHIKIDIAG5, 12, CfrmUc161Zatueki::VScrollYoushikidiag1, VTS_I2)
// midori 151405 add <--
// midori 152134 add -->
	ON_EVENT(CfrmUc161Zatueki, IDC_YOUSHIKIDIAG5, 8, CfrmUc161Zatueki::ComboSelYoushikidiag1, VTS_I2 VTS_UNKNOWN)
// midori 152134 add <--

	ON_EVENT( CfrmUc161Zatueki, IDC_YOUSHIKIDIAG6, 3, CfrmUc161Zatueki::TerminationYoushikidiag1, VTS_I2 VTS_I2 VTS_I2 VTS_UNKNOWN )
	ON_EVENT( CfrmUc161Zatueki, IDC_YOUSHIKIDIAG6, 2, CfrmUc161Zatueki::EditOFFYoushikidiag1, VTS_I2 )
	ON_EVENT( CfrmUc161Zatueki, IDC_YOUSHIKIDIAG6, 1, CfrmUc161Zatueki::EditONYoushikidiag1, VTS_I2 )
// midori 151405 add -->
	ON_EVENT(CfrmUc161Zatueki, IDC_YOUSHIKIDIAG6, 12, CfrmUc161Zatueki::VScrollYoushikidiag1, VTS_I2)
// midori 151405 add <--
// midori 152134 add -->
	ON_EVENT(CfrmUc161Zatueki, IDC_YOUSHIKIDIAG6, 8, CfrmUc161Zatueki::ComboSelYoushikidiag1, VTS_I2 VTS_UNKNOWN)
// midori 152134 add <--

	ON_EVENT( CfrmUc161Zatueki, IDC_TITLEDIAG1, 3, CfrmUc161Zatueki::TerminationTitlediag1, VTS_I2 VTS_I2 VTS_I2 VTS_UNKNOWN )
	ON_EVENT( CfrmUc161Zatueki, IDC_TITLEDIAG1, 2, CfrmUc161Zatueki::EditOFFTitlediag1, VTS_I2 )
	ON_EVENT( CfrmUc161Zatueki, IDC_TITLEDIAG1, 1, CfrmUc161Zatueki::EditONTitlediag1, VTS_I2 )
	ON_EVENT( CfrmUc161Zatueki, IDC_TITLEDIAG1, 6, CfrmUc161Zatueki::FocusTitlediag1, VTS_NONE )

	ON_EVENT( CfrmUc161Zatueki, IDC_PAGEDIAG1, 3, CfrmUc161Zatueki::TerminationPagediag1, VTS_I2 VTS_I2 VTS_I2 VTS_UNKNOWN )
	ON_EVENT( CfrmUc161Zatueki, IDC_PAGEDIAG1, 2, CfrmUc161Zatueki::EditOFFPagediag1, VTS_I2 )
	ON_EVENT( CfrmUc161Zatueki, IDC_PAGEDIAG1, 1, CfrmUc161Zatueki::EditONPagediag1, VTS_I2 )
	ON_EVENT( CfrmUc161Zatueki, IDC_PAGEDIAG1, 6, CfrmUc161Zatueki::FocusPagediag1, VTS_NONE )
END_EVENTSINK_MAP()

//********************************************************************************
//	初期処理
//********************************************************************************
BOOL	CfrmUc161Zatueki::virStartJob()
{
	// 初期値設定
...
//	共通データの初期値設定
//********************************************************************************
void	CfrmUc161Zatueki::virSetInitialUchiwakeInfo()
{
	// 「雑益」の固有データ
	...
	m_uInfo.intColMax = ID_COLMAX_161;				// １行内のコントロール個数
	m_uInfo.intColMaxData = ID_COLMAXDATA_161;		// １行内の列数
	m_uInfo.intCtlStartIndex = ID_CTLSTARTINDEX_161;// １行目の入力項目の先頭インデックス番号
	m_uInfo.intT1StartIndex = ID_T1STARTNORMAL_161;	// 合計行①の先頭インデックス番号
	m_uInfo.intT2StartIndex = ID_T2STARTNORMAL_161;	// 合計行②の入力項目の先頭インデックス番号
	m_uInfo.intCursolDefPos = ID_COL_161_NAIYOU;	// カーソル移動時の初期位置（タイトルから↓，合計から↑で使用）
	m_uInfo.intCursolKeiPos = ID_COL_161_KNORDER;	// 合計行のカーソル移動位置（カーソル移動で使用）
	...
	m_uInfo.intT1StartNormal = ID_T1STARTNORMAL_161;	// 通常時：合計行①の先頭インデックス
	m_uInfo.intT2StartNormal = ID_T2STARTNORMAL_161;	// 通常時：合計行②の先頭インデックス
	m_uInfo.intT1StartKobetu = ID_T1STARTKOBETU_161;	// 個別時：合計行①の先頭インデックス
	m_uInfo.intT2StartKobetu = ID_T2STARTKOBETU_161;	// 個別時：合計行②の先頭インデックス
	m_uInfo.intRowKei = ID_ROWKEI_161;				// 帳表固定の合計行数（1:合計あり，0:なし）
	m_uInfo.intKei1StartIndex = ID_COL_161_KEI1_MEISYO;	// 計ダイアグラム1行目の先頭インデックス
	m_uInfo.intKei2StartIndex = ID_COL_161_KEI2_MEISYO;	// 計ダイアグラム2行目の先頭インデックス
...
// 【戻値】    なし
//**************************************************
void	CfrmUc161Zatueki::virSetInitialDiag()
{
	int     nIndex;
...
// 修正No.158178 del <--
	...
	// コンボボックスの属性取得
	nIndex = CmnGetControlIndex( 1, ID_COL_161_KNORDER );
...
//	帳表固有変数の初期値設定
//********************************************************************************
void	CfrmUc161Zatueki::virSetInitialValue()
{
	// 1ページ分のローカルバッファをクリア
	RecBufClearAllData();
...
//	帳表コントロールの初期化（データ領域）
//********************************************************************************
BOOL	CfrmUc161Zatueki::InitialControlDataArea()
{
	int		intMax;
	int		i;
// No.200903 add -->
...
// No.200903 add <--
	...
	for ( i = m_uInfo.intCtlStartIndex; i < intMax; i += m_uInfo.intColMax ) {
		// ComboBox：クリア
		CmnDiagSetString( m_pDiag, i + ID_COL_161_KNORDER - 1, "", 0 );	// 科目

		// 漢字入力欄の初期化
		CmnDiagSetAttrInpmax( m_pDiag, i + ID_COL_161_NAIYOU    - 1, MAX_KETA_161_NAIYOU );		// 取引の内容
		CmnDiagSetAttrInpmax( m_pDiag, i + ID_COL_161_ADNAME1    - 1, MAX_KETA_161_ADNAME1*2 );	// 相手先1
		CmnDiagSetAttrInpmax( m_pDiag, i + ID_COL_161_ADADD1    - 1, MAX_KETA_161_ADADD1 );		// 所在地1
		CmnDiagSetAttrInpmax( m_pDiag, i + ID_COL_161_ADADD2    - 1, MAX_KETA_161_ADADD2 );		// 所在地2

		// 金額欄：桁数初期化
// No.200903 del -->
		//CmnDiagSetAttrDigit( m_pDiag, i + ID_COL_161_VAL - 1, ID_VAL_161_DATA );	// 金額
// No.200903 del <--
// No.200903 add -->
		if(bG_Kanso == TRUE)	len = ID_VAL_161_K_DATA;
		else					len = ID_VAL_161_DATA;
		CmnDiagSetAttrDigit( m_pDiag, i + ID_COL_161_VAL - 1, len );	// 金額
// No.200903 add <--
	...
	// 半角/全角設定
	CmnDiagSetAttrColZenHan( m_pDiag , ID_COL_161_NAIYOU );		// 取引の内容
	CmnDiagSetAttrColZenHan( m_pDiag , ID_COL_161_ADNAME1 );		// 相手先1
	CmnDiagSetAttrColZenHan( m_pDiag , ID_COL_161_ADADD1 );		// 所在地1
	CmnDiagSetAttrColZenHan( m_pDiag , ID_COL_161_ADADD2 );		// 所在地2
...
//********************************************************************************
BOOL	CfrmUc161Zatueki::InitialControlDataAreaHide( CICSDiag* pDiag )
{
	int		intMax;
	int		i;
// No.200903 add -->
...
// No.200903 add <--
	...
	for ( i = m_uInfo.intCtlStartIndex; i < intMax; i += m_uInfo.intColMax ) {
		// ComboBox：クリア
		CmnDiagSetString( pDiag, i + ID_COL_161_KNORDER - 1, "", 0 );	// 科目

		// 漢字入力欄の初期化
		CmnDiagSetAttrInpmax( pDiag, i + ID_COL_161_NAIYOU    - 1, MAX_KETA_161_NAIYOU );		// 取引の内容
		CmnDiagSetAttrInpmax( pDiag, i + ID_COL_161_ADNAME1    - 1, MAX_KETA_161_ADNAME1*2 );	// 相手先1
		CmnDiagSetAttrInpmax( pDiag, i + ID_COL_161_ADADD1    - 1, MAX_KETA_161_ADADD1 );		// 所在地1
		CmnDiagSetAttrInpmax( pDiag, i + ID_COL_161_ADADD2    - 1, MAX_KETA_161_ADADD2 );		// 所在地2

		// 金額欄：桁数初期化
// No.200903 del -->
		//CmnDiagSetAttrDigit( pDiag, i + ID_COL_161_VAL - 1, ID_VAL_161_DATA );	// 金額
// No.200903 del <--
// No.200903 add -->
		if(bG_Kanso == TRUE)	len = ID_VAL_161_K_DATA;
		else					len = ID_VAL_161_DATA;
		CmnDiagSetAttrDigit( pDiag, i + ID_COL_161_VAL - 1, len );	// 金額
// No.200903 add <--
	}
...
//********************************************************************************
BOOL	CfrmUc161Zatueki::InitialControlComboBox()
{
	...
	for ( i = 1; i <= intMax; i++ ) {
		...
		intIndex = CmnGetControlIndex( i, ID_COL_161_KNORDER );
...
//********************************************************************************
void	CfrmUc161Zatueki::InitialControlTotalArea()
{
	int		nKeiType;			//	計の種別
...
// 修正No.157898 add -->
	if(flg2[0] == 1)	{
		// 一括自動行の科目を入力可能にする
		m_pDiag->ModifyItem( CmnGetControlIndex( (nDataRowPos[0]+1), ID_COL_161_KNORDER ), (DIAG_MDFY_EDIT | DIAG_MDFY_OPAQUE) );
	}
	if(flg2[1] == 1)	{
		// 一括自動行の科目を入力可能にする
		m_pDiag->ModifyItem( CmnGetControlIndex( (nDataRowPos[1]+1), ID_COL_161_KNORDER ), (DIAG_MDFY_EDIT | DIAG_MDFY_OPAQUE) );
	}
// 修正No.157898 add <--
...
// midori 152166 add <--
	...
	m_pDiagKei->ModifyItem(ID_COL_161_KEI1_VAL, intKeiRow);
	m_pDiagKei->ModifyItem(ID_COL_161_KEI2_VAL, intKeiRow);
	...
	//m_pDiag->ModifyItem( CmnGetControlTotalIndex( 1, ID_COL_161_KNORDER ), nKeiRow[0] );
	//m_pDiag->ModifyItem( CmnGetControlTotalIndex( 2, ID_COL_161_KNORDER ), nKeiRow[1] );
	
// No.200903 del -->
	//// 合計行の金額欄は、金額欄 + 1桁
	//CmnDiagSetAttrDigit( m_pDiagKei, ID_COL_161_KEI1_VAL, ID_VAL_161_TOTAL );
	//CmnDiagSetAttrDigit( m_pDiagKei, ID_COL_161_KEI2_VAL, ID_VAL_161_TOTAL );
	////CmnDiagSetAttrDigit( m_pDiag, CmnGetControlTotalIndex( 1, ID_COL_161_VAL ), ID_VAL_161_TOTAL );
	////CmnDiagSetAttrDigit( m_pDiag, CmnGetControlTotalIndex( 2, ID_COL_161_VAL ), ID_VAL_161_TOTAL );
// No.200903 del <--
}
...
//		→表示していない方のDiag(通常 or 個別)の設定に使用する
//********************************************************************************
void	CfrmUc161Zatueki::InitialControlTotalAreaHide( CICSDiag* pDiag )
{
	int intIndex = 0;
	...
	// 合計行の金額欄は、金額欄 + 1桁
	intIndex = m_intT1StartIndexHide + m_uInfo.intCtlStartIndex + ID_COL_161_VAL - 1;
	CmnDiagSetAttrDigit( pDiag, intIndex, ID_VAL_161_TOTAL );

	intIndex = m_intT2StartIndexHide + m_uInfo.intCtlStartIndex + ID_COL_161_VAL - 1;
	CmnDiagSetAttrDigit( pDiag, intIndex, ID_VAL_161_TOTAL );
}
...
//	RET	なし
//********************************************************************************
void	CfrmUc161Zatueki::InitialControlSpecialRow( int intRow, int intFgFunc )
{
	DIAGRAM_DATA	diadata;	// ICSDIAG構造体
	...
	case ID_FGFUNC_IKKATUAUTO:		// 一括集計金額行（自動）
		// 桁数を設定
		CmnDiagSetAttrDigit( m_pDiag, CmnGetControlIndex( intRow , ID_COL_161_VAL ), ID_VAL_161_TOTAL );
		break;
	}
	...
	case ID_FGFUNC_IKKATUAUTO:		// 一括集計金額行（自動）
		...
		if ( intFgFunc != ID_FGFUNC_IKKATUAUTO ) {
			...
			m_pDiag->ModifyItem( CmnGetControlIndex( intRow, ID_COL_161_KNORDER ), DIAG_MDFY_NODROPDOWN );

			// ComboBoxの選択項目クリア
			m_clsFunc.DiagInit( &diadata );
			diadata.text_combo = _T( "\r\n" );
			m_pDiag->SetData( CmnGetControlIndex( intRow, ID_COL_161_KNORDER ), (LPUNKNOWN)&diadata );
		}
...
// 改良No.21-0086,21-0529 cor <--
			...
			if (intFgFunc == ID_FGFUNC_IKKATUAUTO ){
				//	科目
				m_pDiag->ModifyItem( CmnGetControlIndex( intRow, ID_COL_161_KNORDER ), DIAG_MDFY_INPUT );
			}
		}
// No.200905 add <--
...
//	帳表タイトル情報の表示
//********************************************************************************
void	CfrmUc161Zatueki::virUpdateControlTitle()
{
//	int		intMax;
...
//	帳表ページ情報の表示
//********************************************************************************
void	CfrmUc161Zatueki::UpdateControlPage()
{
	BOOL	bBack = TRUE;
	BOOL	bNext = TRUE;
...
//	帳表データの表示（１ページ分）
//********************************************************************************
BOOL	CfrmUc161Zatueki::virUpdateControlTblData()
{
	// ダイアログ切替
	if( m_pDiag != NULL ){
		virSetInitialDiag();
...
// No.200601 add -->
		...
		if(bG_Kanso == TRUE) {
			...
			// 科目
			CmnInitialControlFgStringCell( m_pDiag, dbRec.m_NumRow, ID_COL_161_KNORDER, dbRec.m_FgFunc, UC_KAMOKU_LEN, dbRec.m_KnName);
			// 取引の内容
			CmnInitialControlFgStringCell( m_pDiag, dbRec.m_NumRow, ID_COL_161_NAIYOU, dbRec.m_FgFunc, UC_161_NAIYOU_LEN, dbRec.m_Naiyou);
		}
// No.200601 add <--
...
// 修正No.157626 add <--
		...
		//// メッセージ配置
		//CmnDiagSetString( m_pDiag , intlblIndex , "雑損失は、⑯－2で入力して下さい" , 1 );
		//// 背景色設定
...
//	保管件数の表示
//********************************************************************************
BOOL CfrmUc161Zatueki::virUpdateControlTblData2()
{
	int					hcnt=0;
	CString				cs=_T("");
...
//		RET		なし
//********************************************************************************
void	CfrmUc161Zatueki::UpdateControlRowData( CdbUc161Zatueki* prmDbRec ) {
	DIAGRAM_DATA	diadata;	// ICSDiag構造体
	int				intCell;	// 保存フィールド
	...
	// 読込み対象セル取得
	intCell = CmnGetControlIndex( prmDbRec->m_NumRow, ID_COL_161_KNORDER );
...
//		RET		なし
//********************************************************************************
void	CfrmUc161Zatueki::UpdateControlRowTotal( CdbUc161Zatueki* prmDbRec )
{
	int		intTotalType;
	...
	// 頁計/累計の名称表示
	if ( intRowName > 0 ) {
		//CmnDiagSetString( m_pDiag, CmnGetControlTotalIndex( intRowName, ID_COL_161_KNORDER ), prmDbRec->m_KeiStr, 0 );
		CmnDiagSetString( m_pDiagKei, CmnGetKeiDiagIndex( intRowName, ID_COL_161_KEI1_MEISYO ), prmDbRec->m_KeiStr, 1 );
	}
	// 頁計/累計の金額表示
	if ( intRowVal > 0 ) {
		//CmnDiagSetKingaku( m_pDiag, CmnGetControlTotalIndex( intRowName, ID_COL_161_VAL ), prmDbRec->m_Val );
		CmnDiagSetKingaku( m_pDiagKei, CmnGetKeiDiagIndex( intRowVal, ID_COL_161_KEI1_VAL ), prmDbRec->m_Val );
	}
}
...
//		RET		なし
//********************************************************************************
void	CfrmUc161Zatueki::virFncCellCopyProc( CdbUc000Common* rsData )
{
	CdbUc161Zatueki*	rs;
	int					intCol;	// 現在の列
...
//********************************************************************************
int	CfrmUc161Zatueki::virFncReferenceGetType(int intCol, int* intGrSeq, long* lngItemSeq, int* intAdd1, int* intAdd2, int* intAdd1Col, int* intAdd2Col, REFERENCE_INFO* pudReference)
{
	int		intRefType;
	...
	//case ID_COL_161_ADADD2:
		...
		*lngItemSeq = m_ReadData[m_uInfo.intCurRow].m_AdSeq;
		...
		// 住所欄なら住所１、２の列番号取得
		//if ( intCol != ID_COL_161_ADNAME1 ){
		//	*intAdd1Col = ID_COL_161_ADADD1;
		//	*intAdd2Col = ID_COL_161_ADADD2;
		//}
		break;
...
//		RET		なし
//********************************************************************************
void	CfrmUc161Zatueki::virFncReferenceSetData( CdlgReference* dlgRef, int intRefType, int intCol )
{
	switch ( intRefType ) {
...
// midori 152137 add <--
	...
	case ID_DLGTYPE_ADDRESS:
		// 選択内容を表示
		CmnDiagSetString( m_pDiag, CmnGetControlIndex( m_uInfo.intCurRow, ID_COL_161_ADNAME1 ), 
						  m_clsFunc.StrDocking( dlgRef->m_udAddress.m_AdName1 , dlgRef->m_udAddress.m_AdName2 ), 0 );
		CmnDiagSetString( m_pDiag, CmnGetControlIndex( m_uInfo.intCurRow, ID_COL_161_ADADD1 ), 
						  dlgRef->m_udAddress.m_AdAdd1, 0 );
		CmnDiagSetString( m_pDiag, CmnGetControlIndex( m_uInfo.intCurRow, ID_COL_161_ADADD2 ), 
...
//		RET		なし
//********************************************************************************
void	CfrmUc161Zatueki::virFncReferenceSetICSData(CdlgAddressSearch* dlgAddd)
{
	int			intIndex;

	// 売却(買入)先の所在地1(住所)
	intIndex = CmnGetControlIndex( m_uInfo.intCurRow, ID_COL_161_ADADD1 );
	CmnDiagSetString( m_pDiag, intIndex, dlgAddd->m_AdAdd1, 0 );

	// 売却(買入)先の所在地2(住所)
	intIndex = CmnGetControlIndex( m_uInfo.intCurRow, ID_COL_161_ADADD2 );
...
//		RET		なし
//********************************************************************************
void	CfrmUc161Zatueki::virFncReferenceUpdateTbl( int intRefType, int nRefMode/*=0*/ )
{
...
void CfrmUc161Zatueki::virActivateFrameK(UINT nState, CFrameWnd* pDeactivateFrame)
{
	int		index = 0;
	...
	if(pWnd != NULL)	{
		if(m_DataKakutei == FALSE)	{
			if(m_uInfo.intCurCol == ID_COL_161_KNORDER)	{
				virKamokuAddCancel();
			}
		}
	}
...
void CfrmUc161Zatueki::virKamokuAddCancel()
{
	...
	// 科目列なら
	if(m_uInfo.intCurCol == ID_COL_161_KNORDER && m_F9OnSw != TRUE)	{
		DIAGRAM_DATA	diadata;
		m_pDiag->GetData(m_uInfo.intCurCtlIndex,(LPUNKNOWN)&diadata);
		// 【新規作成】が選択されていれば
		if(diadata.data_combo > m_CmbCnt)	{
			// 前回の値に戻す
			CmnDiagSetCombo(m_pDiag,CmnGetControlIndex(m_uInfo.intCurRow,ID_COL_161_KNORDER),m_uInfo.OldCombo);
		}
	}
}
// 要通知案件修正 21/07/09 add <--
...
//	その他イベント処理
//********************************************************************************
BOOL	CfrmUc161Zatueki::PreTranslateMessage( MSG* pMsg )
{
//	int				intID;
...
//				if ((CmnGetControlCol() != ID_COL_161_KNORDER) || (CmnCheckTotalRow() == TRUE )){
// midori 160611 del <--
				// カレントインデックスを保存
...
//				//}
//// ---------------------
//				if(CmnGetControlCol() == ID_COL_161_KNORDER)	{
//					rv=1;
//				}
//// midori 160611 cor <--
// midori 152134 17/10/07 del <--
...
/*
		...
		case VK_TAB:
			...
			if ((intID == IDC_PAGEBACK_BUTTON1) && (CmnCheckShiftKey() == TRUE)) {
				...
				CmnDiagSetFocus(m_pDiag, m_uInfo.intRowMax, ID_COL_161_VAL);
				return 1;
			}
			break;
*/
...
// 修正No.158259 add -->
				...
				intCol = CmnGetControlCol();
				if(intCol == ID_COL_161_KNORDER && (pMsg->wParam == VK_LEFT || pMsg->wParam == VK_RIGHT))	{
...
// 頁コントロールのフォーカス設定
void	CfrmUc161Zatueki::FocusPagediag1()
{
...
// 頁コントロールのゲットフォーカス
void	CfrmUc161Zatueki::EditONPagediag1( short index )
{
// midori 151405 add -->
	// スクロールフラグをクリアする
	nG_MScroll = 0;
...
// midori 151405 add <--
	...
	// 1行登録
//	if( CmnGetControlCol() != ID_COL_161_VAL ){
...
// 頁コントロールのロストフォーカス
void	CfrmUc161Zatueki::EditOFFPagediag1( short index )
{
// midori 155028 add -->
...
// 頁コントロールのキー操作
void	CfrmUc161Zatueki::TerminationPagediag1( short index, short nChar, short length, LPUNKNOWN data )
{
	int nMaxDataCol = 0;
	// カレント頁の合計行の種別を取得
...
// midori 160612 cor <--
			...
			//CmnDiagSetFocus(m_pDiag, m_uInfo.intRowMax, ID_COL_161_VAL);
			CmnDiagSetFocus(m_pDiag, nMaxDataCol, ID_COL_161_VAL);
		}
		break;
	case VK_DOWN:
		// タイトルコントロールへ移動
...
// タイトルコントロールのフォーカス設定
void	CfrmUc161Zatueki::FocusTitlediag1()
{
//マウスクリックでキャレットが表示できないためコメントとする
//	// ボタンからTabキー移動した場合に必要
//	m_TitleDiag.SetPosition( 0 );
...
// タイトルコントロールのゲットフォーカス
void	CfrmUc161Zatueki::EditONTitlediag1( short index )
{
// midori 151405 add -->
	// スクロールフラグをクリアする
	nG_MScroll = 0;
...
// タイトルコントロールのロストフォーカス
void	CfrmUc161Zatueki::EditOFFTitlediag1 (short index )
{
// midori 151405 add -->
	m_Titlefocus = 0;
// midori 151405 add <--
...
//	タイトル更新
void CfrmUc161Zatueki::virUpdateTitle()
{
...
// タイトルコントロールのキーイベント
void	CfrmUc161Zatueki::TerminationTitlediag1( short index, short nChar, short length, LPUNKNOWN data )
{
	// フォーカス移動
	switch ( nChar ) {
	case VK_RETURN:
...
void	CfrmUc161Zatueki::EditONYoushikidiag1( short index )
{
	DIAGRAM_DATA	diadata;
...
//			if( CmnGetControlCol() != ID_COL_161_VAL ){
			...
			BOOL adadd1_to_adadd2 = IsSaveMoveReference(ID_COL_161_ADADD1, ID_COL_161_ADADD2);
			// [Home]キー押下の住所検索ダイアログの戻り（フォーカスをセットしている）は保存しない（改良依頼No15-1613）
			BOOL adadd1_to_adadd1 = IsSaveMoveReference(ID_COL_161_ADADD1, ID_COL_161_ADADD1);	// 所在地1(住所)→所在地1(住所)
			BOOL adadd2_to_adadd2 = IsSaveMoveReference(ID_COL_161_ADADD2, ID_COL_161_ADADD2);	// 所在地2(住所)→所在地2(住所)　所在地2から住所が長すぎる場合、ここがFALSEになる
...
// データコントロールのロストフォーカス
void	CfrmUc161Zatueki::EditOFFYoushikidiag1( short index )
{
	if( m_EndView != FALSE )	return;
...
//	入力確定
void CfrmUc161Zatueki::virInputDecisionEditOFF()
{
	// フォーカスフラグOFF
...
// 預貯金データコントロールのキーイベント
void	CfrmUc161Zatueki::TerminationYoushikidiag1( short index, short nChar, short length, LPUNKNOWN data )
{
	//--------------------------------------------------------------------------------
	//	キー操作仕様
...
// midori 151405 add -->
void CfrmUc161Zatueki::VScrollYoushikidiag1(short mode)
{
...
//********************************************************************************
int	CfrmUc161Zatueki::GetFocusPosition( int nChar )
{
	int		intRow;				// カレント行番号
	int		intCol;				// カレント列番号
	...
	else if ( intCol == ID_COL_161_ADADD1 ) {
		// カレント列が「所在地1」の場合
	...
	else if ( intCol == ID_COL_161_ADADD2 ) {
		// カレント列が「所在地2」の場合
	...
	case VK_TAB:
		if ( CmnCheckShiftKey() == FALSE ) {
			...
			// それ以外は「←」キーと同じ
			if ( ( intRow <= 1 ) && ( intCol == ID_COL_161_KNORDER ) ) {
				return -1;
			}
...
//********************************************************************************
int	CfrmUc161Zatueki::GetTotalRowIndex( int nCharOrg, int intIndex, int intNext )
{
	...
	if ( nNowRow <= nBorder[0] ){
		...
		if (( intNext > CmnGetControlIndex( m_uInfo.intRowMax, ID_COL_161_VAL ) ) && ( nCharOrg == VK_TAB )){
			return( -2 );
		}
		//	データ行を超えた？かつ計行あり？
		else if (( nNextRow > nBorder[0] ) && ( nBorder[1] > 0 )){
			//	計行に移動
			//nRet = CmnGetControlIndex( ( nBorder[1] + 2 ), ID_COL_161_KNORDER );
			if (nCharOrg == VK_TAB) {
				return -2;
			}
		}
	...
	//	現在、頁計に居る
		...
		case VK_UP:			// ↑：23行目のデータ行の支店名項目へ移動
			nRet = CmnGetControlIndex( nBorder[0], ID_COL_161_NAIYOU );
			break;
		case VK_LEFT:		// ←/Shift+Tab：23行目のデータ行の摘要項目へ移動
			nRet = CmnGetControlIndex( nBorder[0], ID_COL_161_VAL );
			break;
		default:			// →/↓/Return/Tab：25行目の合計行②へ移動
			...
			//	累計なし
				...
				nRet = CmnGetControlIndex( ( nBorder[2] + 2 ), ID_COL_161_KNORDER );
			}
			break;
		}
	}
...
//		RET		なし
//********************************************************************************
void	CfrmUc161Zatueki::virTblEditIkkatuLine( int nType, CdbUc000Common* rsData,
...
//********************************************************************************
int	CfrmUc161Zatueki::virTblSortSubSortProc( CdlgSort* pCdlgSort, CdbUc000Common* rsData )
{
	CdbUc161Zatueki*	rs;
	CString				strFilter;
	CString				strSort;
...
/**********************************************************************
	...
	戻値
		int		成功/失敗
				FUNCTION_OK
***********************************************************************/
int	CfrmUc161Zatueki::RecBufSetData( CdbUc161Zatueki* prmDbRec )
{
...
/**********************************************************************
	...
	戻値
		int		成功/失敗
				FUNCTION_OK
***********************************************************************/
int	CfrmUc161Zatueki::RecBufClearAllData()
{
...
/**********************************************************************
	...
	戻値
		int		成功/失敗
				FUNCTION_OK
***********************************************************************/
int	CfrmUc161Zatueki::RecBufClearData( P_REC_UC_161_ZATUEKI inRecData )
{
...
/**********************************************************************
	...
	戻値
		int				成功(更新あり)/成功(更新なし)/失敗
						...
						FUNCTION_NG		: 失敗
***********************************************************************/
int	CfrmUc161Zatueki::virRecBufSaveData( int inPage, int inRow )
{
	...
	// 科目
	intIndex = CmnGetControlIndex( inRow, ID_COL_161_KNORDER );
...
// midori 152137 add <--
	...
	// 取引の内容
	intIndex = CmnGetControlIndex( inRow, ID_COL_161_NAIYOU );
	tmpSaveData.m_Naiyou = m_clsFunc.DiagGetString( m_pDiag, intIndex );

	// 相手先1
	CStringArray strArray;
	intIndex = CmnGetControlIndex( inRow, ID_COL_161_ADNAME1 );
// 158138 del -->
...
// 158138 add <--
	...
	if ( tmpSaveData.m_AdName2.IsEmpty() ){
		if(m_uInfo.intCurCol == ID_COL_161_ADNAME1 && m_uInfo.intCurRow != m_uInfo.OldRow){	// 各カラムごとにvirRecBufSaveData()がコールされるようになり、かつタイミングがEditOffからEditOnに移ったことによりCmnDiagSetString()でカレットが末尾から先頭に移ってしまう為、制御（修正依頼No150489）
			CmnDiagSetString( m_pDiag, intIndex, tmpSaveData.m_AdName1, 0 );
		}
	}

	// 所在地1
	intIndex = CmnGetControlIndex( inRow, ID_COL_161_ADADD1 );
	tmpSaveData.m_AdAdd1 = m_clsFunc.DiagGetString( m_pDiag, intIndex );

	// 所在地2
	intIndex = CmnGetControlIndex( inRow, ID_COL_161_ADADD2 );
	tmpSaveData.m_AdAdd2 = m_clsFunc.DiagGetString( m_pDiag, intIndex );

	// 金額
	intIndex = CmnGetControlIndex( inRow, ID_COL_161_VAL );
...
***********************************************************************/
int	CfrmUc161Zatueki::virRecBufSaveDataForPasteInsert( int inPage, int inRow )
{
...
***********************************************************************/
int	CfrmUc161Zatueki::virRecBufSaveDataForPaste( int inPage, int inRow )
{
	///////////////////////////////////////////////////////////////
	// 登録処理呼び出し
	return RecBufSaveDataSub( inPage, inRow, &m_CopyData );
...
/**********************************************************************
	...
	戻値
			int					成功(更新あり)/成功(更新なし)/失敗
								...
								FUNCTION_NG		: 失敗
***********************************************************************/
int	CfrmUc161Zatueki::RecBufSaveDataSub( 
							int inPage,
							int inRow,
...
// midori 152137 add <--
		...
		if ((udtTemp.m_FgFunc == ID_FGFUNC_DATA) && 
			((ufgAdName1 == TRUE) || (ufgAdName2 == TRUE) || (ufgAdAdd1 == TRUE) || (ufgAdAdd2 == TRUE))) {	// 変更ありの場合
				...
				if(m_RegAutoRef)	udtTemp.m_AdSeq = rsAdd.CheckEntry(udtTemp.m_AdName1, udtTemp.m_AdName2, udtTemp.m_AdAdd1, udtTemp.m_AdAdd2, ID_ADDRESSGR_KAI, TRUE);
				else				udtTemp.m_AdSeq = rsAdd.GetSeqFromAdName(ID_ADDRESSGR_KAI, udtTemp.m_AdName1, udtTemp.m_AdName2, udtTemp.m_AdAdd1, udtTemp.m_AdAdd2);
...
//********************************************************************************
CdbUc000Common*	CfrmUc161Zatueki::virGetDataTableObject()
{
	// 「雑益」テーブルのオブジェクトを生成し、ポインタを返す
...
//	RET	なし
//********************************************************************************
void	CfrmUc161Zatueki::virRowButtonCopyProc()
{
...
//	RET	なし
//********************************************************************************
void	CfrmUc161Zatueki::virTblGetKamokuInfo( CdbUc000Common* rsData, SORTKAMOKU_INFO* uKamoku )
{
	CdbUc161Zatueki*	rs = (CdbUc161Zatueki*)rsData;
...
//	RET	なし
//********************************************************************************
void	CfrmUc161Zatueki::virGetCurrentInfo( CURRENT_INFO* uCurInfo )
{
...
//********************************************************************************
int	CfrmUc161Zatueki::virUpdateRelationTblChengeFormType()
{
	// ⑯-1で通常/個別を変更した場合、⑯-2の頁構成の更新が必要となる
	CfrmUc162Zatuson	pfrm162;
// midori 152770 del -->
//	int intRet = pfrm162.UpdateTbl162ChangeFormType();
// midori 152770 del <--
// midori 152770 add -->
...
//		RET		BOOL		TRUE:正常終了，FALSE:エラー
//********************************************************************************
BOOL CfrmUc161Zatueki::virUpdateRelationTblChengeFormTypeSave()
{
...
////		RET		なし
////********************************************************************************
//int	CfrmUc161Zatueki::UpdateTbl161ChangeFormType()
//{
//	// 初期値設定
...
//		RET		なし
//********************************************************************************
int	CfrmUc161Zatueki::UpdateTbl161ChangeFormType(UCHIWAKE_INFO pInfoSv)
{
	// データ無しならデータ更新しない
...
//	【戻値】	なし
//**************************************************
void CfrmUc161Zatueki::SetInputMode( int nRow, long nMode )
{
	m_pDiag->ModifyItem( CmnGetControlIndex( nRow, ID_COL_161_KNORDER ), nMode );	//	科目
	m_pDiag->ModifyItem( CmnGetControlIndex( nRow, ID_COL_161_NAIYOU ), nMode );	//	取引の内容
	m_pDiag->ModifyItem( CmnGetControlIndex( nRow, ID_COL_161_ADNAME1 ), nMode );	//	相手先（上段）
	m_pDiag->ModifyItem( CmnGetControlIndex( nRow, ID_COL_161_ADADD1 ), nMode );	//	所在地（上段）
	m_pDiag->ModifyItem( CmnGetControlIndex( nRow, ID_COL_161_ADADD2 ), nMode );	//	所在地（下段）
	m_pDiag->ModifyItem( CmnGetControlIndex( nRow, ID_COL_161_VAL ), nMode );		//	金額
}
...
//	【戻値】	なし
//**************************************************
void CfrmUc161Zatueki::SetDiagBackColor()
{
...
//		RET		なし					
//********************************************************************************
void CfrmUc161Zatueki::virRendoCreateData(CdbUc000Common* rsData, RENTEMP_INFO* uRenInfo)
{
	CString			strTemp;
...
//		CdbUcLstAddress		rsLstAdd(m_pDB);								// rs_lst_Address
//// midori 152152 del -->
////		m_clsFunc.StrDivisionEx( uRenInfo->strAdName , &strArry , ( MAX_KETA_161_ADNAME1 / 2 ) , 2 );
//// midori 152152 del <--
//// midori 152152 add -->
//		m_clsFunc.StrDivisionEx( uRenInfo->strAdName , &strArry , MAX_KETA_161_ADNAME1 , 2 );
//// midori 152152 add <--
//		int intSeq = rsLstAdd.CheckEntry( strArry.GetAt(0), strArry.GetAt(1) , _T("") , _T("") , ID_ADDRESSGR_KAI, TRUE);
//		if (intSeq > 0) {
...
//		RET		なし					
//********************************************************************************
void CfrmUc161Zatueki::virRendoUpdateData(CdbUc000Common* rsData, RENTEMP_INFO* uRenInfo)
{
	CdbUc161Zatueki*	rs = (CdbUc161Zatueki*)rsData;
...
//***************************************************************************
BOOL CfrmUc161Zatueki::virEndProc(void)
{
	TRACE(_T("***** CfrmUc161Zatueki::virEndProc\n"));
...
// midori 161106 add -->
void CfrmUc161Zatueki::ComboNew(short index)
{
	short			sv_sel=0;
// midori 152201 add -->
...
// midori 151405 add -->
int CfrmUc161Zatueki::CursorControl(short nChar, int sw)
{
	int				rv=0;
	int				intCol=0;
	int				pos=0;
...
// midori 152134 add -->
void CfrmUc161Zatueki::ComboSelYoushikidiag1(short index, LPUNKNOWN data)
{
// 要通知案件修正 21/07/09 del -->
...
// ------------------------------------------------------------------------------------------------------------------------
void CfrmUc161Zatueki::TitleColorChg(void)
{
	...
	// 科目
// 修正No.157628 del -->
	//strSQL.Format(_T("select max(oversgn) from (select CASE when len(Replace(isnull(KnName,''),CHAR(13)+CHAR(10),'')) > %d then 1 else 0 end as oversgn from uc_161_zatueki where FgShow=%d) tbl1"),UC_KAMOKU_LEN,ID_FGSHOW_OFF);
// 修正No.157628 del <--
// 修正No.157628 add -->
...
// 修正No.157628 add <--
	...
	// 取引の内容
// 修正No.157628 del -->
	//strSQL.Format(_T("select max(oversgn) from (select CASE when len(Replace(isnull(Naiyou,''),CHAR(13)+CHAR(10),'')) > %d then 1 else 0 end as oversgn from uc_161_zatueki where FgShow=%d) tbl1"),UC_161_NAIYOU_LEN,ID_FGSHOW_OFF);
// 修正No.157628 del <--
// 修正No.157628 add -->
	strSQL.Format(_T("select max(oversgn) from (select CASE when len(%s) > %d then 1 else 0 end as oversgn from uc_161_zatueki where FgShow=%d) tbl1"),
...
// 修正No.162446 add -->
LRESULT CfrmUc161Zatueki::OnUserReDrawView(WPARAM wParam, LPARAM lParam)
{
	virUpdateControlTblData();
	CmnDiagSetFocus(m_pDiag, 1, 1);
