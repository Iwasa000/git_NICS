virSetInitialValue()
{
	// 1ページ分のローカルバッファをクリア
	RecBufClearAllData();
...
//	帳表コントロールの初期化（データ領域）
//********************************************************************************
BOOL	CfrmUc061Yuukasyouken::InitialControlDataArea()
{
	int		intMax;
	int		i;
	...
	for ( i = m_uInfo.intCtlStartIndex; i < intMax; i += m_uInfo.intColMax ) {
		// ComboBox：クリア
		CmnDiagSetString( m_pDiag, i + ID_COL_061_KUBUN - 1, "", 0 );	// 区分

		// 漢字入力欄の初期化
		CmnDiagSetAttrInpmax( m_pDiag, i + ID_COL_061_SYURUI    - 1, MAX_KETA_061_SYURUI );		// 種類・銘柄	
		CmnDiagSetAttrInpmax( m_pDiag, i + ID_COL_061_TANNI    - 1, MAX_KETA_061_TANNI );		// 単位
		CmnDiagSetAttrInpmax( m_pDiag, i + ID_COL_061_SPDATE    - 1, MAX_KETA_061_SPDATE );		// 異動年月日
		CmnDiagSetAttrInpmax( m_pDiag, i + ID_COL_061_RIYUU    - 1, MAX_KETA_061_RIYUU );		// 異動事由
		CmnDiagSetAttrInpmax( m_pDiag, i + ID_COL_061_TANNI2    - 1, MAX_KETA_061_TANNI2 );		// 単位2
		CmnDiagSetAttrInpmax( m_pDiag, i + ID_COL_061_ADNAME1    - 1, MAX_KETA_061_ADNAME1 );	// 売却先の名称1
		CmnDiagSetAttrInpmax( m_pDiag, i + ID_COL_061_ADADD1    - 1, MAX_KETA_061_ADADD1 );		// 売却先の所在地1
		CmnDiagSetAttrInpmax( m_pDiag, i + ID_COL_061_ADADD2    - 1, MAX_KETA_061_ADADD2 );		// 売却先の所在地2
		CmnDiagSetAttrInpmax( m_pDiag, i + ID_COL_061_TEKI    - 1, MAX_KETA_061_TEKI );			// 摘要

		// 金額欄：桁数初期化
		CmnDiagSetAttrDigit( m_pDiag, i + ID_COL_061_VAL - 1, ID_VAL_061_DATA );	// 金額(1)
		CmnDiagSetAttrDigit( m_pDiag, i + ID_COL_061_VAL2 - 1, ID_VAL2_061_DATA );	// 金額(2)
		CmnDiagSetAttrDigit( m_pDiag, i + ID_COL_061_VAL3 - 1, ID_VAL3_061_DATA );	// 金額

		// 小数点付き数値の設定
		// カンマを抜き、9桁入力に変更(ただし、リソース画面上では8桁のまま、ここで9桁に変更)
		// マイナス入力可能(リソース画面で変更)
		CmnDiagSetAttrDigit( m_pDiag, i + ID_COL_061_SUURYOU - 1, 9/*8*/, TRUE, TRUE, 3 );	// 数量
		CmnDiagSetAttrDigit( m_pDiag, i + ID_COL_061_SUURYOU2 - 1, 9/*8*/, TRUE, TRUE, 3 );	// 数量2
	...
	// 半角/全角設定
	CmnDiagSetAttrColZenHan( m_pDiag , ID_COL_061_SYURUI );		// 種類
	CmnDiagSetAttrColZenHan( m_pDiag , ID_COL_061_TANNI );		// 単位
	CmnDiagSetAttrColZenHan( m_pDiag , ID_COL_061_RIYUU );		// 異動事由
	CmnDiagSetAttrColZenHan( m_pDiag , ID_COL_061_TANNI2 );		// 単位2
	CmnDiagSetAttrColZenHan( m_pDiag , ID_COL_061_ADNAME1 );		// 売却(買入)先の名称1(氏名)
	CmnDiagSetAttrColZenHan( m_pDiag , ID_COL_061_ADADD1 );		// 売却(買入)先の所在地1(住所)
	CmnDiagSetAttrColZenHan( m_pDiag , ID_COL_061_ADADD2 );		// 売却(買入)先の所在地2(住所)
	CmnDiagSetAttrColZenHan( m_pDiag , ID_COL_061_TEKI );		// 摘要
...
//********************************************************************************
BOOL	CfrmUc061Yuukasyouken::InitialControlComboBox()
{
	...
	for ( i = 1; i <= intMax; i++ ) {
		...
		intIndex = CmnGetControlIndex( i, ID_COL_061_KUBUN );
...
//********************************************************************************
void	CfrmUc061Yuukasyouken::InitialControlTotalArea()
{
	int		nKeiType;			//	計の種別
	int		nDataRow;			//	データ行属性
...
// midori 152166 add <--
	...
	//m_pDiag->ModifyItem( CmnGetControlTotalIndex( 1, ID_COL_061_KUBUN ), nKeiRow[0] );
	//m_pDiag->ModifyItem( CmnGetControlTotalIndex( 2, ID_COL_061_KUBUN ), nKeiRow[1] );
	...
	//CmnDiagSetAttrDigit( m_pDiag, CmnGetControlTotalIndex( 1, ID_COL_061_VAL ), ID_VAL_061_TOTAL );
	//CmnDiagSetAttrDigit( m_pDiag, CmnGetControlTotalIndex( 2, ID_COL_061_VAL ), ID_VAL_061_TOTAL );
	//CmnDiagSetAttrDigit( m_pDiag, CmnGetControlTotalIndex( 1, ID_COL_061_VAL2 ), ID_VAL2_061_TOTAL );
	//CmnDiagSetAttrDigit( m_pDiag, CmnGetControlTotalIndex( 2, ID_COL_061_VAL2 ), ID_VAL2_061_TOTAL );
	//CmnDiagSetAttrDigit( m_pDiag, CmnGetControlTotalIndex( 1, ID_COL_061_VAL3 ), ID_VAL3_061_TOTAL );
	//CmnDiagSetAttrDigit( m_pDiag, CmnGetControlTotalIndex( 2, ID_COL_061_VAL3 ), ID_VAL3_061_TOTAL );
}
...
//	RET	なし
//********************************************************************************
void	CfrmUc061Yuukasyouken::InitialControlSpecialRow( int intRow, int intFgFunc )
{
	DIAGRAM_DATA	diadata;	// ICSDIAG構造体
	...
	case ID_FGFUNC_IKKATUAUTO:		// 一括集計金額行（自動）
		// 桁数を設定
		CmnDiagSetAttrDigit( m_pDiag, CmnGetControlIndex( intRow , ID_COL_061_VAL ), ID_VAL_061_TOTAL );
		CmnDiagSetAttrDigit( m_pDiag, CmnGetControlIndex( intRow , ID_COL_061_VAL2 ), ID_VAL2_061_TOTAL );
		CmnDiagSetAttrDigit( m_pDiag, CmnGetControlIndex( intRow , ID_COL_061_VAL3 ), ID_VAL3_061_TOTAL );
		break;
	}
	...
	case ID_FGFUNC_IKKATUAUTO:		// 一括集計金額行（自動）
		...
		if ( intFgFunc != ID_FGFUNC_IKKATUAUTO ) {
			...
			m_pDiag->ModifyItem( CmnGetControlIndex( intRow, ID_COL_061_KUBUN ), DIAG_MDFY_NODROPDOWN );

			// ComboBoxの選択項目クリア
			m_clsFunc.DiagInit( &diadata );
			diadata.text_combo = _T( "\r\n" );
			m_pDiag->SetData( CmnGetControlIndex( intRow, ID_COL_061_KUBUN ), (LPUNKNOWN)&diadata );
...
//	帳表タイトル情報の表示
//********************************************************************************
void	CfrmUc061Yuukasyouken::virUpdateControlTitle()
{
//	int		intMax;
...
//	帳表ページ情報の表示
//********************************************************************************
void	CfrmUc061Yuukasyouken::UpdateControlPage()
{
	BOOL	bBack = TRUE;
	BOOL	bNext = TRUE;
...
//	帳表データの表示（１ページ分）
//********************************************************************************
BOOL	CfrmUc061Yuukasyouken::virUpdateControlTblData()
{
	// ダイアログ切替
	if( m_pDiag != NULL ){
		virSetInitialDiag();
...
//	保管件数の表示
//********************************************************************************
BOOL CfrmUc061Yuukasyouken::virUpdateControlTblData2()
{
	int					hcnt=0;
	CString				cs=_T("");
...
//		RET		なし
//********************************************************************************
void	CfrmUc061Yuukasyouken::UpdateControlRowData( CdbUc061Yuukasyouken* prmDbRec ) {
	DIAGRAM_DATA	diadata;	// ICSDiag構造体
	int				intCell;	// 保存フィールド
	...
	// 読込み対象セル取得
	intCell = CmnGetControlIndex( prmDbRec->m_NumRow, ID_COL_061_KUBUN );
...
//		RET		なし
//********************************************************************************
void	CfrmUc061Yuukasyouken::UpdateControlRowTotal( CdbUc061Yuukasyouken* prmDbRec )
{
	int		intTotalType;
	...
	// 頁計/累計の名称表示
	if ( intRowName > 0 ) {
		//CmnDiagSetString( m_pDiag, CmnGetControlTotalIndex( intRowName, ID_COL_061_KUBUN ), prmDbRec->m_KeiStr, 0 );
		CmnDiagSetString( m_pDiagKei, CmnGetKeiDiagIndex( intRowName, ID_COL_061_KEI1_MEISYO ), prmDbRec->m_KeiStr, 1 );
	}
	// 頁計/累計の金額表示
	if ( intRowVal > 0 ) {
		//CmnDiagSetKingaku( m_pDiag, CmnGetControlTotalIndex( intRowName, ID_COL_061_VAL ), prmDbRec->m_Val );
		//CmnDiagSetKingaku( m_pDiagKei, CmnGetKeiDiagIndex( intRowVal, ID_COL_061_KEI1_VAL ), mfcRec->m_Val );
	}
	if ( intRowVal2 > 0 ) {
		//CmnDiagSetKingaku( m_pDiag, CmnGetControlTotalIndex( intRowName, ID_COL_061_VAL2 ), prmDbRec->m_Val2 );
		CmnDiagSetKingaku( m_pDiagKei, CmnGetKeiDiagIndex( intRowVal2, ID_COL_061_KEI1_VAL2 ), prmDbRec->m_Val2 );
	}
	if ( intRowVal3 > 0 ) {
		//CmnDiagSetKingaku( m_pDiag, CmnGetControlTotalIndex( intRowName, ID_COL_061_VAL3 ), prmDbRec->m_Val3 );
...
//		RET		なし
//********************************************************************************
void	CfrmUc061Yuukasyouken::virFncCellCopyProc( CdbUc000Common* rsData )
{
...
//********************************************************************************
int	CfrmUc061Yuukasyouken::virFncReferenceGetType(int intCol, int* intGrSeq, long* lngItemSeq, int* intAdd1, int* intAdd2, int* intAdd1Col, int* intAdd2Col, REFERENCE_INFO* pudReference)
{
	int			intRefType = 0;
	...
	case ID_COL_061_ADADD2:
		...
		*intAdd1 = 15 * 2;			// Byte指定
		*intAdd2 = 15 * 2;			// Byte指定
		*intAdd1Col = ID_COL_061_ADADD1;
		*intAdd2Col = ID_COL_061_ADADD2;
		break;
...
//		RET		なし
//********************************************************************************
void CfrmUc061Yuukasyouken::virFncReferenceSetData( CdlgReference* dlgRef, int intRefType, int intCol )
{
...
//		RET		なし
//********************************************************************************
void CfrmUc061Yuukasyouken::virFncReferenceUpdateTbl( int intRefType, int nRefMode/*=0*/ )
{
	switch (intRefType) {
...
//		RET		なし
//********************************************************************************
void	CfrmUc061Yuukasyouken::virFncReferenceSetICSData(CdlgAddressSearch* dlgAddd)
{
	int			intIndex;

	// 売却(買入)先の所在地1(住所)
	intIndex = CmnGetControlIndex( m_uInfo.intCurRow, ID_COL_061_ADADD1 );
	CmnDiagSetString( m_pDiag, intIndex, dlgAddd->m_AdAdd1, 0 );

	// 売却(買入)先の所在地2(住所)
	intIndex = CmnGetControlIndex( m_uInfo.intCurRow, ID_COL_061_ADADD2 );
	CmnDiagSetString( m_pDiag, intIndex, dlgAddd->m_AdAdd2, 0 );
}

// 要通知案件修正 21/07/09 add -->
void CfrmUc061Yuukasyouken::virActivateFrameK(UINT nState, CFrameWnd* pDeactivateFrame)
{
	int		index = 0;
	...
	if(pWnd != NULL)	{
		if(m_DataKakutei == FALSE)	{
			if(m_uInfo.intCurCol == ID_COL_061_KUBUN)	{
				virKamokuAddCancel();
			}
		}
	}
...
void CfrmUc061Yuukasyouken::virKamokuAddCancel()
{
	...
	// 科目列なら
	if(m_uInfo.intCurCol == ID_COL_061_KUBUN && m_F9OnSw != TRUE)	{
		DIAGRAM_DATA	diadata;
		m_pDiag->GetData(m_uInfo.intCurCtlIndex,(LPUNKNOWN)&diadata);
		// 【新規作成】が選択されていれば
		if(diadata.data_combo > m_CmbCnt)	{
			// 前回の値に戻す
			CmnDiagSetCombo(m_pDiag,CmnGetControlIndex(m_uInfo.intCurRow,ID_COL_061_KUBUN),m_uInfo.OldCombo);
		}
	}
}
// 要通知案件修正 21/07/09 add <--
...
//	その他イベント処理
//********************************************************************************
BOOL	CfrmUc061Yuukasyouken::PreTranslateMessage( MSG* pMsg )
{
//	int				intID;
...
//				if ((CmnGetControlCol() != ID_COL_061_KUBUN) || (CmnCheckTotalRow() == TRUE )){
// midori 160611 del <--
				// カレントインデックスを保存
...
//				//}
//// ---------------------
//				if(CmnGetControlCol() == ID_COL_061_KUBUN)	{
//					rv=1;
//				}
//// midori 160611 cor <--
// midori 152134 17/10/07 del <--
...
/*
		...
		case VK_TAB:
			...
			if ((intID == IDC_PAGEBACK_BUTTON1) && (CmnCheckShiftKey() == TRUE)) {
				...
				CmnDiagSetFocus(m_pDiag, m_uInfo.intRowMax, ID_COL_061_KUBUN);
				return 1;
			}
			break;
*/
...
// 修正No.158259 add -->
				...
				intCol = CmnGetControlCol();
				if(intCol == ID_COL_061_KUBUN && (pMsg->wParam == VK_LEFT || pMsg->wParam == VK_RIGHT))	{
...
// 頁コントロールのフォーカス設定
void	CfrmUc061Yuukasyouken::FocusPagediag1()
{
...
// 頁コントロールのゲットフォーカス
void	CfrmUc061Yuukasyouken::EditONPagediag1( short index )
{
// midori 151405 add -->
	// スクロールフラグをクリアする
	nG_MScroll = 0;
...
//	if(( nCol != ID_COL_061_VAL2 ) || ( nCol != ID_COL_061_VAL3 )){
...
// 頁コントロールのロストフォーカス
void	CfrmUc061Yuukasyouken::EditOFFPagediag1( short index )
{
// midori 155028 add -->
...
// 頁コントロールのキー操作
void	CfrmUc061Yuukasyouken::TerminationPagediag1( short index, short nChar, short length, LPUNKNOWN data )
{
	int nMaxDataCol = 0;
	// カレント頁の合計行の種別を取得
...
// midori 160612 cor <--
			...
			//CmnDiagSetFocus(m_pDiag, m_uInfo.intRowMax, ID_COL_061_KUBUN);
			CmnDiagSetFocus(m_pDiag, nMaxDataCol, ID_COL_061_TEKI);
		}
		break;
	case VK_DOWN:
		// タイトルコントロールへ移動
...
// タイトルコントロールのフォーカス設定
void	CfrmUc061Yuukasyouken::FocusTitlediag1()
{
//マウスクリックでキャレットが表示できないためコメントとする
//	// ボタンからTabキー移動した場合に必要
//	m_TitleDiag.SetPosition( 0 );
...
// タイトルコントロールのゲットフォーカス
void	CfrmUc061Yuukasyouken::EditONTitlediag1( short index )
{
// midori 151405 add -->
	// スクロールフラグをクリアする
	nG_MScroll = 0;
...
// タイトルコントロールのロストフォーカス
void	CfrmUc061Yuukasyouken::EditOFFTitlediag1 (short index )
{
// midori 151405 add -->
	m_Titlefocus = 0;
// midori 151405 add <--
...
//	タイトル更新
void CfrmUc061Yuukasyouken::virUpdateTitle()
{
...
// タイトルコントロールのキーイベント
void	CfrmUc061Yuukasyouken::TerminationTitlediag1( short index, short nChar, short length, LPUNKNOWN data )
{
	// フォーカス移動
	switch ( nChar ) {
	case VK_RETURN:
...
void	CfrmUc061Yuukasyouken::EditONYoushikidiag1( short index )
{
	DIAGRAM_DATA	diadata;
	int				intRet = -1;
...
// データコントロールのロストフォーカス
void	CfrmUc061Yuukasyouken::EditOFFYoushikidiag1( short index )
{
	if( m_EndView != FALSE )	return;
...
//	入力確定
void CfrmUc061Yuukasyouken::virInputDecisionEditOFF()
{
	// フォーカスフラグOFF
...
// 預貯金データコントロールのキーイベント
void	CfrmUc061Yuukasyouken::TerminationYoushikidiag1( short index, short nChar, short length, LPUNKNOWN data )
{
	//--------------------------------------------------------------------------------
	//	キー操作仕様
...
// midori 151405 del -->
	...
	//	//if(( intCol == ID_COL_061_VAL ) || ( intCol == ID_COL_061_VAL2 ) || ( intCol == ID_COL_061_VAL3 )){		
	//	//	switch(nChar){
	//	//		// 行を跨がないカーソル移動
	//	//		case VK_TAB:
	//	//		case VK_RIGHT:
...
// midori 151405 add -->
void CfrmUc061Yuukasyouken::VScrollYoushikidiag1(short mode)
{
...
//********************************************************************************
int	CfrmUc061Yuukasyouken::GetFocusPosition( int nChar )
{
	int		intRow;				// カレント行番号
	int		intCol;				// カレント列番号
	...
	else if ( intCol == ID_COL_061_SYURUI ) {
		// カレント列が「種類」の場合
	...
	else if ( intCol == ID_COL_061_SUURYOU ) {
		// カレント列が「数量」の場合
		intVector[0] = m_uInfo.intCurCtlIndex + 1 ;						// ↑
		intVector[1] = m_uInfo.intCurCtlIndex + 1;						// →
		intVector[2] = m_uInfo.intCurCtlIndex + m_uInfo.intColMax + 1;	// ↓
	...
	else if ( intCol == ID_COL_061_TANNI ) {
		// カレント列が「単位」の場合
	...
	else if (( intCol == ID_COL_061_VAL )	||
			 ( intCol == ID_COL_061_SPDATE )){
		// カレント列が「金額(1)」の場合
		intVector[0] = m_uInfo.intCurCtlIndex - m_uInfo.intColMax + 1 ;	// ↑
		intVector[1] = m_uInfo.intCurCtlIndex + 1;						// →
		intVector[2] = m_uInfo.intCurCtlIndex + 1;						// ↓
	...
	else if (( intCol == ID_COL_061_VAL2 )	||
	         ( intCol == ID_COL_061_RIYUU )){
		// カレント列が「金額(2)」の場合
		intVector[0] = m_uInfo.intCurCtlIndex - 1;						// ↑
		intVector[1] = m_uInfo.intCurCtlIndex + 1;						// →
		intVector[2] = m_uInfo.intCurCtlIndex + m_uInfo.intColMax - 1;	// ↓
	...
	else if ( intCol == ID_COL_061_SUURYOU2 ) {
		// カレント列が「数量2」の場合
		intVector[0] = m_uInfo.intCurCtlIndex + 1;						// ↑
		intVector[1] = m_uInfo.intCurCtlIndex + 1;						// →
	...
	else if ( intCol == ID_COL_061_TANNI2 ) {
		// カレント列が「単位2」の場合
		intVector[0] = m_uInfo.intCurCtlIndex - m_uInfo.intColMax + 1;	// ↑
		intVector[1] = m_uInfo.intCurCtlIndex + 1;						// →
		intVector[2] = m_uInfo.intCurCtlIndex - 1;						// ↓
	...
	else if ( intCol == ID_COL_061_VAL3 ) {
		// カレント列が「金額」の場合
	...
	else if ( intCol == ID_COL_061_ADNAME1 ) {
	...
	else if ( intCol == ID_COL_061_ADADD1  ) {
	...
	else if ( intCol == ID_COL_061_ADADD2 ) {
	...
	else if ( intCol == ID_COL_061_TEKI ) {
		// カレント列が「摘要」の場合
		intVector[0] = m_uInfo.intCurCtlIndex - m_uInfo.intColMax;		// ↑
	...
	case VK_TAB:
		if ( CmnCheckShiftKey() == FALSE ) {
			...
			// それ以外は「←」キーと同じ
			if ( ( intRow <= 1 ) && ( intCol == ID_COL_061_KUBUN ) ) {
				return -1;
			}
...
//********************************************************************************
int	CfrmUc061Yuukasyouken::GetTotalRowIndex( int nCharOrg, int intIndex, int intNext )
{
	...
	if ( nNowRow <= nBorder[0] ){
		...
		if ( nNextRow > nBorder[0] ){
			//	計行に移動
			//nRet = CmnGetControlIndex( ( nBorder[1] + 1 ), ID_COL_061_KUBUN );
			if (nCharOrg == VK_TAB) {
				return -2;
			}
		}
	...
	//		nRet = CmnGetControlIndex( nBorder[0], ID_COL_061_SUURYOU );
	//		break;
	//	case VK_LEFT:		// ←/Shift+Tab：23行目のデータ行の摘要項目へ移動
	//		nRet = CmnGetControlIndex( nBorder[0], ID_COL_061_TEKI );
	//		break;
	...
	//		//	累計あり
	//		else{
	//			nRet = CmnGetControlIndex( ( nBorder[2] + 1 ), ID_COL_061_KUBUN );
	//		}
	//		break;
	//	}
	//}
...
//********************************************************************************
int	CfrmUc061Yuukasyouken::virTblSortSubSortProc( CdlgSort* pCdlgSort, CdbUc000Common* rsData )
{
	CdbUc061Yuukasyouken*	rs;
	CString				strFilter;
	CString				strSort;
...
/**********************************************************************
	...
	戻値
		int		成功/失敗
				FUNCTION_OK
***********************************************************************/
int	CfrmUc061Yuukasyouken::RecBufSetData( CdbUc061Yuukasyouken* prmDbRec )
{
...
/**********************************************************************
	...
	戻値
		int		成功/失敗
				FUNCTION_OK
***********************************************************************/
int	CfrmUc061Yuukasyouken::RecBufClearAllData()
{
...
/**********************************************************************
	...
	戻値
		int		成功/失敗
				FUNCTION_OK
***********************************************************************/
int	CfrmUc061Yuukasyouken::RecBufClearData( P_REC_UC_061_YUUKASYOUKEN inRecData )
{
...
/**********************************************************************
	...
	戻値
		int				成功(更新あり)/成功(更新なし)/失敗
						...
						FUNCTION_NG		: 失敗
***********************************************************************/
int	CfrmUc061Yuukasyouken::virRecBufSaveData( int inPage, int inRow )
{
	...
	// 区分
	intIndex = CmnGetControlIndex( inRow, ID_COL_061_KUBUN );
...
// midori 152137 add <--
	...
	// 種類
	intIndex = CmnGetControlIndex( inRow, ID_COL_061_SYURUI );
	tmpSaveData.m_Syurui = m_clsFunc.DiagGetString( m_pDiag, intIndex );

	// 数量
	intIndex = CmnGetControlIndex( inRow, ID_COL_061_SUURYOU );
	tmpSaveData.m_Suuryou = CmnDiagGetKingaku( m_pDiag, intIndex );

	// 単位
	intIndex = CmnGetControlIndex( inRow, ID_COL_061_TANNI );
	tmpSaveData.m_Tanni = m_clsFunc.DiagGetString( m_pDiag, intIndex );

	// 金額(1)
	intIndex = CmnGetControlIndex( inRow, ID_COL_061_VAL );
	tmpSaveData.m_Val = CmnDiagGetKingaku( m_pDiag, intIndex );

	// 金額(2)
	intIndex = CmnGetControlIndex( inRow, ID_COL_061_VAL2 );
	tmpSaveData.m_Val2 = CmnDiagGetKingaku( m_pDiag, intIndex );

	// 異動年月日
	intIndex = CmnGetControlIndex( inRow, ID_COL_061_SPDATE );
	...
	// 異動事由
	intIndex = CmnGetControlIndex( inRow, ID_COL_061_RIYUU );
	tmpSaveData.m_Riyuu = m_clsFunc.DiagGetString( m_pDiag, intIndex );

	// 数量2
	intIndex = CmnGetControlIndex( inRow, ID_COL_061_SUURYOU2 );
	tmpSaveData.m_Suuryou2 = CmnDiagGetKingaku( m_pDiag, intIndex );

	// 単位2
	intIndex = CmnGetControlIndex( inRow, ID_COL_061_TANNI2 );
	tmpSaveData.m_Tanni2 = m_clsFunc.DiagGetString( m_pDiag, intIndex );

	// 金額
	intIndex = CmnGetControlIndex( inRow, ID_COL_061_VAL3 );
	tmpSaveData.m_Val3 = CmnDiagGetKingaku( m_pDiag, intIndex );

	// 売却(買入)先の名称1(氏名)
	CStringArray strArray;
	intIndex = CmnGetControlIndex( inRow, ID_COL_061_ADNAME1 );
	...
	if ( tmpSaveData.m_AdName2.IsEmpty() ){
		if(m_uInfo.intCurCol == ID_COL_061_ADNAME1 && m_uInfo.intCurRow != m_uInfo.OldRow){	// 各カラムごとにvirRecBufSaveData()がコールされるようになり、かつタイミングがEditOffからEditOnに移ったことによりCmnDiagSetString()でカレットが末尾から先頭に移ってしまう為、制御（修正依頼No150489）
			CmnDiagSetString( m_pDiag, intIndex, tmpSaveData.m_AdName1, 0 );
		}
	}
	
	// 売却(買入)先の所在地1(住所)
	intIndex = CmnGetControlIndex( inRow, ID_COL_061_ADADD1 );
	tmpSaveData.m_AdAdd1 = m_clsFunc.DiagGetString( m_pDiag, intIndex );

	// 売却(買入)先の所在地2(住所)
	intIndex = CmnGetControlIndex( inRow, ID_COL_061_ADADD2 );
	tmpSaveData.m_AdAdd2 = m_clsFunc.DiagGetString( m_pDiag, intIndex );

	// 摘要
	intIndex = CmnGetControlIndex( inRow, ID_COL_061_TEKI );
...
***********************************************************************/
int	CfrmUc061Yuukasyouken::virRecBufSaveDataForPasteInsert( int inPage, int inRow )
{
...
***********************************************************************/
int	CfrmUc061Yuukasyouken::virRecBufSaveDataForPaste( int inPage, int inRow )
{
	///////////////////////////////////////////////////////////////
	// 登録処理呼び出し
	return RecBufSaveDataSub( inPage, inRow, &m_CopyData );
...
/**********************************************************************
	...
	戻値
			int					成功(更新あり)/成功(更新なし)/失敗
								...
								FUNCTION_NG		: 失敗
***********************************************************************/
int	CfrmUc061Yuukasyouken::RecBufSaveDataSub( 
							int inPage,
							int inRow,
...
//********************************************************************************
CdbUc000Common*	CfrmUc061Yuukasyouken::virGetDataTableObject()
{
	// 「有価証券」テーブルのオブジェクトを生成し、ポインタを返す
...
//	RET	なし
//********************************************************************************
void	CfrmUc061Yuukasyouken::virRowButtonCopyProc()
{
...
//	RET	なし
//********************************************************************************
void	CfrmUc061Yuukasyouken::virTblGetKamokuInfo( CdbUc000Common* rsData, SORTKAMOKU_INFO* uKamoku )
{
...
//	RET	なし
//********************************************************************************
void	CfrmUc061Yuukasyouken::virGetCurrentInfo( CURRENT_INFO* uCurInfo )
{
...
/**********************************************************************
	...
	戻値
		CString			成功/失敗
						...
						NULL		: 失敗
***********************************************************************/
/*CString	CfrmUc061Yuukasyouken::GetKubunName( int inOrder ){
...
//	【戻値】	なし
//**************************************************
void CfrmUc061Yuukasyouken::SetInputMode( int nRow, long nMode )
{
	m_pDiag->ModifyItem( CmnGetControlIndex( nRow, ID_COL_061_KUBUN ), nMode );		//	区分
	m_pDiag->ModifyItem( CmnGetControlIndex( nRow, ID_COL_061_SYURUI ), nMode );	//	種類・銘柄
	m_pDiag->ModifyItem( CmnGetControlIndex( nRow, ID_COL_061_SUURYOU ), nMode );	//	数量
	m_pDiag->ModifyItem( CmnGetControlIndex( nRow, ID_COL_061_TANNI ), nMode );		//	単位
	m_pDiag->ModifyItem( CmnGetControlIndex( nRow, ID_COL_061_VAL ), nMode );		//	金額（上段）
	m_pDiag->ModifyItem( CmnGetControlIndex( nRow, ID_COL_061_VAL2 ), nMode );		//	金額（下段）
	m_pDiag->ModifyItem( CmnGetControlIndex( nRow, ID_COL_061_SPDATE ), nMode );	//	異動年月日
	m_pDiag->ModifyItem( CmnGetControlIndex( nRow, ID_COL_061_RIYUU ), nMode );		//	異動事由
	m_pDiag->ModifyItem( CmnGetControlIndex( nRow, ID_COL_061_SUURYOU2 ), nMode );	//	数量
	m_pDiag->ModifyItem( CmnGetControlIndex( nRow, ID_COL_061_TANNI2 ), nMode );	//	単位
	m_pDiag->ModifyItem( CmnGetControlIndex( nRow, ID_COL_061_VAL3 ), nMode );		//	金額
	m_pDiag->ModifyItem( CmnGetControlIndex( nRow, ID_COL_061_ADNAME1 ), nMode );	//	名称（上段）
	m_pDiag->ModifyItem( CmnGetControlIndex( nRow, ID_COL_061_ADADD1 ), nMode );	//	所在地（上段）
	m_pDiag->ModifyItem( CmnGetControlIndex( nRow, ID_COL_061_ADADD2 ), nMode );	//	所在地（下段）
	m_pDiag->ModifyItem( CmnGetControlIndex( nRow, ID_COL_061_TEKI ), nMode );		//	摘要
}
...
//	【戻値】	なし
//**************************************************
void CfrmUc061Yuukasyouken::SetDiagBackColor()
{
...
//***************************************************************************
BOOL CfrmUc061Yuukasyouken::virEndProc(void)
{
	TRACE(_T("***** CfrmUc061Yuukasyouken::virEndProc\n"));
...
// midori 161106 add -->
void CfrmUc061Yuukasyouken::ComboNew(short index)
{
	short			sv_sel=0;
// midori 152201 add -->
...
// midori 151405 add -->
int CfrmUc061Yuukasyouken::CursorControl(short nChar, int sw)
{
	int				rv=0;
	int				intCol=0;
	int				pos=0;
...
// midori 152134 add -->
void CfrmUc061Yuukasyouken::ComboSelYoushikidiag1(short index, LPUNKNOWN data)
{
// 要通知案件修正 21/07/09 del -->
...
// 修正No.162446 add -->
LRESULT CfrmUc061Yuukasyouken::OnUserReDrawView(WPARAM wParam, LPARAM lParam)
{
	virUpdateControlTblData();
	CmnDiagSetFocus(m_pDiag, 1, 1);
