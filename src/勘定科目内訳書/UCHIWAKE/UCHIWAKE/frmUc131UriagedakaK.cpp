...
IMPLEMENT_DYNCREATE( CfrmUc131UriagedakaK, CfrmUc000Common )


BEGIN_MESSAGE_MAP( CfrmUc131UriagedakaK, CfrmUc000Common )
	ON_WM_SIZE()
...
//	ON_COMMAND( ID_BUTTON_F3, OnButtonF3 )
	...
	ON_COMMAND( ID_PRINTSETUP_MENU, &CfrmUc131UriagedakaK::OnMenuPrintSetup )
	ON_COMMAND( ID_PRINTALL_MENU, &CfrmUc131UriagedakaK::OnMenuPrintAll )
//	ON_COMMAND( ID_OUTPUTFORM_MENU, &CfrmUc131UriagedakaK::OnMenuFormTypeSetup )
	ON_COMMAND( ID_SPECIALROW_MENU, &CfrmUc131UriagedakaK::OnMenuSpecialRow )
	ON_COMMAND( ID_SORT_MENU, &CfrmUc131UriagedakaK::OnMenuSort )
//	ON_COMMAND( ID_DISPDIALOG_MENU, &CfrmUc131UriagedakaK::OnMenuIkkatuKingaku )
	ON_COMMAND( ID_ZEROMONEY_MENU, &CfrmUc131UriagedakaK::OnMenuZeroMoney )
	ON_COMMAND( ID_ZEROMONEYMOVE_MENU, &CfrmUc131UriagedakaK::OnMenuZeroMoneyMove )
	ON_COMMAND( ID_AMOUTDIALOG_MENU, &CfrmUc131UriagedakaK::OnMenuOutKeiSetup )
// midori 160606 add -->
	ON_COMMAND( ID_CLEAR_MENU, &CfrmUc131UriagedakaK::OnMenuClear )
// midori 160606 add <--
	ON_COMMAND( ID_TITLEMENU, &CfrmUc131UriagedakaK::OnMenuTitleRestore )
	ON_COMMAND( ID_USER_SETTING_MENU, &CfrmUc131UriagedakaK::OnMenuOptionSetting )
	ON_COMMAND( ID_COPY_SETTING_INFO_MENU, &CfrmUc131UriagedakaK::OnMenuCopySettingInfo )
	ON_COMMAND( ID_DELETE_DATA_MENU, &CfrmUc131UriagedakaK::OnMenuDeleteDataEachYoushiki )
	ON_BN_CLICKED( IDC_PAGEBACK_BUTTON1, &CfrmUc131UriagedakaK::OnPageBack )
	ON_BN_CLICKED( IDC_PAGENEXT_BUTTON1, &CfrmUc131UriagedakaK::OnPageNext )
	ON_BN_CLICKED( IDC_PAGENEW_BUTTON1, &CfrmUc131UriagedakaK::OnPageNew )
	ON_BN_CLICKED( IDC_PAGEINSERT_BUTTON1, &CfrmUc131UriagedakaK::OnPageInsert )
	ON_BN_CLICKED( IDC_ROWCOPY_BUTTON1, &CfrmUc131UriagedakaK::OnRowCopy )
	ON_BN_CLICKED( IDC_ROWPASTE_BUTTON1, &CfrmUc131UriagedakaK::OnRowPaste )
	ON_BN_CLICKED( IDC_ROWINSERT_BUTTON1, &CfrmUc131UriagedakaK::OnRowInsert )
	ON_BN_CLICKED( IDC_YOUSHIKINEXT_BUTTON1, &CfrmUc131UriagedakaK::OnMoveYoushikiNext )
	ON_BN_CLICKED( IDC_YOUSHIKIBACK_BUTTON1, &CfrmUc131UriagedakaK::OnMoveYoushikiBack )
//	ON_UPDATE_COMMAND_UI( ID_BUTTON_F1, &CfrmUc131UriagedakaK::OnUpdateButtonF1 )
//	ON_UPDATE_COMMAND_UI( ID_BUTTON_F3, &CfrmUc131UriagedakaK::OnUpdateButtonF3 )
	ON_UPDATE_COMMAND_UI( ID_BUTTON_F6, &CfrmUc131UriagedakaK::OnUpdateButtonF6 )
	ON_UPDATE_COMMAND_UI( ID_BUTTON_F7, &CfrmUc131UriagedakaK::OnUpdateButtonF7 )
	ON_UPDATE_COMMAND_UI( ID_BUTTON_F8, &CfrmUc131UriagedakaK::OnUpdateButtonF8 )
	ON_UPDATE_COMMAND_UI( ID_BUTTON_F9, &CfrmUc131UriagedakaK::OnUpdateButtonF9 )
	ON_UPDATE_COMMAND_UI( ID_BUTTON_F11, &CfrmUc131UriagedakaK::OnUpdateButtonF11 )
	ON_UPDATE_COMMAND_UI( ID_BUTTON_F12, &CfrmUc131UriagedakaK::OnUpdateButtonF12 )
	ON_UPDATE_COMMAND_UI( ID_BUTTON_HOME, &CfrmUc131UriagedakaK::OnUpdateButtonHome )
//	ON_UPDATE_COMMAND_UI( ID_DISPDIALOG_MENU, &CfrmUc131UriagedakaK::OnUpdateMenuIkkatuKingaku )
// midori 160612 add -->
	ON_UPDATE_COMMAND_UI( ID_SORT_MENU, &CfrmUc131UriagedakaK::OnUpdateMenuSort )
	ON_UPDATE_COMMAND_UI( ID_CLEAR_MENU, &CfrmUc131UriagedakaK::OnUpdateMenuClear )
// midori 160612 add <--
	ON_UPDATE_COMMAND_UI( ID_ZEROMONEY_MENU, &CfrmUc131UriagedakaK::OnUpdateMenuZeroMoney )
// midori 160612 add -->
	ON_UPDATE_COMMAND_UI( ID_ZEROMONEYMOVE_MENU, &CfrmUc131UriagedakaK::OnUpdateMenuZeroMoneyMove)
// midori 160612 add <--
	ON_UPDATE_COMMAND_UI(ID_SPECIALROW_MENU, &CfrmUc131UriagedakaK::OnUpdateMenuSpecialRow)
// midori 160612 add -->
	ON_UPDATE_COMMAND_UI( ID_TITLEMENU, &CfrmUc131UriagedakaK::OnUpdateMenuTitleRestore )
	ON_UPDATE_COMMAND_UI( ID_DELETE_DATA_MENU, &CfrmUc131UriagedakaK::OnUpdateMenuDeleteDataEachYoushiki )
// midori 160612 add <--
	ON_MESSAGE(WM_USER_REDRAWVIEW, OnUserReDrawView)		// 修正No.162446 add
END_MESSAGE_MAP()


CfrmUc131UriagedakaK::CfrmUc131UriagedakaK()
	: CfrmUc000Common( CfrmUc131UriagedakaK::IDD )
{
...
CfrmUc131UriagedakaK::~CfrmUc131UriagedakaK()
{
	...
	TRACE(_T("***** CfrmUc131UriagedakaK::~CfrmUc131UriagedakaK\n"));

	//m_pDiag = NULL;
	//m_pTitleDiag = NULL;
}

void CfrmUc131UriagedakaK::DoDataExchange( CDataExchange* pDX )
{
...
void CfrmUc131UriagedakaK::OnInitialUpdate()
{
...
#ifdef _DEBUG
void CfrmUc131UriagedakaK::AssertValid() const
{
	CfrmUc000Common::AssertValid();
}

#ifndef _WIN32_WCE
void CfrmUc131UriagedakaK::Dump( CDumpContext& dc ) const
{
...
BEGIN_EVENTSINK_MAP( CfrmUc131UriagedakaK, CfrmUc000Common )
	ON_EVENT( CfrmUc131UriagedakaK, IDC_YOUSHIKIDIAG1, 3, CfrmUc131UriagedakaK::TerminationYoushikidiag1, VTS_I2 VTS_I2 VTS_I2 VTS_UNKNOWN )
	ON_EVENT( CfrmUc131UriagedakaK, IDC_YOUSHIKIDIAG1, 2, CfrmUc131UriagedakaK::EditOFFYoushikidiag1, VTS_I2 )
	ON_EVENT( CfrmUc131UriagedakaK, IDC_YOUSHIKIDIAG1, 1, CfrmUc131UriagedakaK::EditONYoushikidiag1, VTS_I2 )
// midori 151405 add -->
	ON_EVENT(CfrmUc131UriagedakaK, IDC_YOUSHIKIDIAG1, 12, CfrmUc131UriagedakaK::VScrollYoushikidiag1, VTS_I2)
// midori 151405 add <--

	ON_EVENT( CfrmUc131UriagedakaK, IDC_YOUSHIKIDIAG2, 3, CfrmUc131UriagedakaK::TerminationYoushikidiag1, VTS_I2 VTS_I2 VTS_I2 VTS_UNKNOWN )
	ON_EVENT( CfrmUc131UriagedakaK, IDC_YOUSHIKIDIAG2, 2, CfrmUc131UriagedakaK::EditOFFYoushikidiag1, VTS_I2 )
	ON_EVENT( CfrmUc131UriagedakaK, IDC_YOUSHIKIDIAG2, 1, CfrmUc131UriagedakaK::EditONYoushikidiag1, VTS_I2 )
// midori 151405 add -->
	ON_EVENT(CfrmUc131UriagedakaK, IDC_YOUSHIKIDIAG2, 12, CfrmUc131UriagedakaK::VScrollYoushikidiag1, VTS_I2)
// midori 151405 add <--

	ON_EVENT( CfrmUc131UriagedakaK, IDC_TITLEDIAG1, 3, CfrmUc131UriagedakaK::TerminationTitlediag1, VTS_I2 VTS_I2 VTS_I2 VTS_UNKNOWN )
	ON_EVENT( CfrmUc131UriagedakaK, IDC_TITLEDIAG1, 2, CfrmUc131UriagedakaK::EditOFFTitlediag1, VTS_I2 )
	ON_EVENT( CfrmUc131UriagedakaK, IDC_TITLEDIAG1, 1, CfrmUc131UriagedakaK::EditONTitlediag1, VTS_I2 )
	ON_EVENT( CfrmUc131UriagedakaK, IDC_TITLEDIAG1, 6, CfrmUc131UriagedakaK::FocusTitlediag1, VTS_NONE )

	ON_EVENT( CfrmUc131UriagedakaK, IDC_PAGEDIAG1, 3, CfrmUc131UriagedakaK::TerminationPagediag1, VTS_I2 VTS_I2 VTS_I2 VTS_UNKNOWN )
	ON_EVENT( CfrmUc131UriagedakaK, IDC_PAGEDIAG1, 2, CfrmUc131UriagedakaK::EditOFFPagediag1, VTS_I2 )
	ON_EVENT( CfrmUc131UriagedakaK, IDC_PAGEDIAG1, 1, CfrmUc131UriagedakaK::EditONPagediag1, VTS_I2 )
	ON_EVENT( CfrmUc131UriagedakaK, IDC_PAGEDIAG1, 6, CfrmUc131UriagedakaK::FocusPagediag1, VTS_NONE )
END_EVENTSINK_MAP()

//********************************************************************************
//	初期処理
//********************************************************************************
BOOL	CfrmUc131UriagedakaK::virStartJob()
{
	// 初期値設定
...
//	共通データの初期値設定
//********************************************************************************
void	CfrmUc131UriagedakaK::virSetInitialUchiwakeInfo()
{
	// 「売上高」の固有データ
...
// 【戻値】    なし
//**************************************************
void	CfrmUc131UriagedakaK::virSetInitialDiag()
{
	// オブジェクト未生成時は処理を抜ける
...
//	帳表固有変数の初期値設定
//********************************************************************************
void	CfrmUc131UriagedakaK::virSetInitialValue()
{
	// 1ページ分のローカルバッファをクリア
	RecBufClearAllData();
...
//	帳表コントロールの初期化（データ領域）
//********************************************************************************
BOOL	CfrmUc131UriagedakaK::InitialControlDataArea()
{
	int		intMax;
	int		i;
...
// No.200903 del <--
// No.200903 add -->
		CmnDiagSetAttrDigit( m_pDiag, i + ID_COL_131_VAL - 1, ID_VAL_131_K_DATA );		// 売上高
		CmnDiagSetAttrDigit( m_pDiag, i + ID_COL_131_VAL2 - 1, ID_VAL2_131_K_DATA );	// 期末現在高
// No.200903 add <--
...
//********************************************************************************
BOOL	CfrmUc131UriagedakaK::InitialControlComboBox()
{
	// コンボボックスを初期化する関数です。
	return TRUE;
}
...
//********************************************************************************
void	CfrmUc131UriagedakaK::InitialControlTotalArea()
{
	int		nKeiType;			//	計の種別
	int		nDataRow;			//	データ行属性
...
//	RET	なし
//********************************************************************************
void	CfrmUc131UriagedakaK::InitialControlSpecialRow( int intRow, int intFgFunc )
{
...
//	帳表タイトル情報の表示
//********************************************************************************
void	CfrmUc131UriagedakaK::virUpdateControlTitle()
{
//	int		intMax;
...
//	帳表ページ情報の表示
//********************************************************************************
void	CfrmUc131UriagedakaK::UpdateControlPage()
{
	BOOL	bBack = TRUE;
	BOOL	bNext = TRUE;
...
//	帳表データの表示（１ページ分）
//********************************************************************************
BOOL	CfrmUc131UriagedakaK::virUpdateControlTblData()
{
	// ダイアログ切替
	if( m_pDiag != NULL ){
		virSetInitialDiag();
...
// No.200601 add -->
		...
		// 代表者との関係
		CmnInitialControlFgStringCell( m_pDiag, dbRec.m_NumRow, ID_COL_131_KANKEI, dbRec.m_FgFunc, UC_131_KANKEI_LEN, dbRec.m_Kankei);
		// 源泉所得税納付書
		CmnInitialControlFgStringCell( m_pDiag, dbRec.m_NumRow, ID_COL_131_HDNAME2, dbRec.m_FgFunc, UC_131_HDNAME2_LEN, dbRec.m_HdName2);
		// 摘要
		CmnInitialControlFgStringCell( m_pDiag, dbRec.m_NumRow, ID_COL_131_TEKI, dbRec.m_FgFunc, UC_131_TEKI_LEN, dbRec.m_Teki);
// No.200601 add <--
...
// midori 190301 add -->
	// 使用建物の延面積(入力部)を入力不可・非表示にする
	CmnDiagSetAttrDisableHide(m_pDiag,ID_COL_131_AREA,1);
	// 使用建物の延面積(表示部)を非表示にする
	CmnDiagSetAttrDisableHide(m_pDiag,8,0);
	// 使用建物の延面積と期末従業員数の区切り線を非表示にする
	CmnDiagSetAttrDisableHide(m_pDiag,25,0);

	// [計行]
	CmnDiagSetAttrDisableHide(&m_DiagKei1,8,2);
	CmnDiagSetAttrDisableHide(&m_DiagKei1,10,2);
	CmnDiagSetAttrDisableHide(&m_DiagKei2,8,2);
	CmnDiagSetAttrDisableHide(&m_DiagKei2,10,2);
	CmnDiagSetAttrDisableHide(&m_DiagKei2,24,2);
...
//	保管件数の表示
//********************************************************************************
BOOL CfrmUc131UriagedakaK::virUpdateControlTblData2()
{
	int					hcnt=0;
	CString				cs=_T("");
...
//		RET		なし
//********************************************************************************
void	CfrmUc131UriagedakaK::UpdateControlRowData( CdbUc131Uriagedaka* prmDbRec ) {
	DIAGRAM_DATA	diadata;	// ICSDiag構造体
	int				intCell;	// 保存フィールド
...
//		RET		なし
//********************************************************************************
void	CfrmUc131UriagedakaK::UpdateControlRowTotal( CdbUc131Uriagedaka* prmDbRec )
{
	int		intTotalType;
...
//		RET		なし
//********************************************************************************
void	CfrmUc131UriagedakaK::virFncCellCopyProc( CdbUc000Common* rsData )
{
...
//********************************************************************************
int	CfrmUc131UriagedakaK::virFncReferenceGetType(int intCol, int* intGrSeq, long* lngItemSeq, int* intAdd1, int* intAdd2, int* intAdd1Col, int* intAdd2Col, REFERENCE_INFO* pudReference)
{
	int		intRefType;
...
//		RET		なし
//********************************************************************************
void	CfrmUc131UriagedakaK::virFncReferenceSetICSData(CdlgAddressSearch* dlgAddd)
{
	int			intIndex;
...
//	その他イベント処理
//********************************************************************************
BOOL	CfrmUc131UriagedakaK::PreTranslateMessage( MSG* pMsg )
{
//	int				intID;
...
// 頁コントロールのフォーカス設定
void	CfrmUc131UriagedakaK::FocusPagediag1()
{
...
// 頁コントロールのゲットフォーカス
void	CfrmUc131UriagedakaK::EditONPagediag1( short index )
{
// midori 151405 add -->
	// スクロールフラグをクリアする
	nG_MScroll = 0;
...
// 頁コントロールのロストフォーカス
void	CfrmUc131UriagedakaK::EditOFFPagediag1( short index )
{
// midori 155028 add -->
...
// 頁コントロールのキー操作
void	CfrmUc131UriagedakaK::TerminationPagediag1( short index, short nChar, short length, LPUNKNOWN data )
{
	int nMaxDataCol = 0;
	// カレント頁の合計行の種別を取得
...
// タイトルコントロールのフォーカス設定
void	CfrmUc131UriagedakaK::FocusTitlediag1()
{
//マウスクリックでキャレットが表示できないためコメントとする
//	// ボタンからTabキー移動した場合に必要
//	m_TitleDiag.SetPosition( 0 );
...
// タイトルコントロールのゲットフォーカス
void	CfrmUc131UriagedakaK::EditONTitlediag1( short index )
{
// midori 151405 add -->
	// スクロールフラグをクリアする
	nG_MScroll = 0;
...
// タイトルコントロールのロストフォーカス
void	CfrmUc131UriagedakaK::EditOFFTitlediag1 (short index )
{
// midori 151405 add -->
	m_Titlefocus = 0;
// midori 151405 add <--
...
//	タイトル更新
void CfrmUc131UriagedakaK::virUpdateTitle()
{
...
// タイトルコントロールのキーイベント
void	CfrmUc131UriagedakaK::TerminationTitlediag1( short index, short nChar, short length, LPUNKNOWN data )
{
	// フォーカス移動
	switch ( nChar ) {
	case VK_RETURN:
...
void	CfrmUc131UriagedakaK::EditONYoushikidiag1( short index )
{
...
// データコントロールのロストフォーカス
void	CfrmUc131UriagedakaK::EditOFFYoushikidiag1( short index )
{
	if( m_EndView != FALSE )	return;
...
//	入力確定
void CfrmUc131UriagedakaK::virInputDecisionEditOFF()
{
	// フォーカスフラグOFF
...
// 預貯金データコントロールのキーイベント
void	CfrmUc131UriagedakaK::TerminationYoushikidiag1( short index, short nChar, short length, LPUNKNOWN data )
{
	//--------------------------------------------------------------------------------
	//	キー操作仕様
...
// midori 151405 add -->
void CfrmUc131UriagedakaK::VScrollYoushikidiag1(short mode)
{
...
//********************************************************************************
int	CfrmUc131UriagedakaK::GetFocusPosition( int nChar )
{
	int		intRow;				// カレント行番号
	int		intCol;				// カレント列番号
	...
	else if ( intCol == ID_COL_131_WORKER )	{
		// カレント列が「期末従業員数」の場合
	...
	else if ( intCol == ID_COL_131_HDNAME2 ) {
		// カレント列が「源泉所得税納付署」の場合
		intVector[0] = m_uInfo.intCurCtlIndex - m_uInfo.intColMax;		// ↑
		intVector[1] = m_uInfo.intCurCtlIndex + 1;						// →
		intVector[2] = m_uInfo.intCurCtlIndex + m_uInfo.intColMax;		// ↓
...
//********************************************************************************
int	CfrmUc131UriagedakaK::GetTotalRowIndex( int nCharOrg, int intIndex, int intNext )
{
...
//********************************************************************************
int	CfrmUc131UriagedakaK::virTblSortSubSortProc( CdlgSort* pCdlgSort, CdbUc000Common* rsData )
{
	CdbUc131Uriagedaka*	rs;
	CString				strFilter;
	CString				strSort;
...
/**********************************************************************
	...
	戻値
		int		成功/失敗
				FUNCTION_OK
***********************************************************************/
int	CfrmUc131UriagedakaK::RecBufSetData( CdbUc131Uriagedaka* prmDbRec )
{
...
/**********************************************************************
	...
	戻値
		int		成功/失敗
				FUNCTION_OK
***********************************************************************/
int	CfrmUc131UriagedakaK::RecBufClearAllData()
{
...
/**********************************************************************
	...
	戻値
		int		成功/失敗
				FUNCTION_OK
***********************************************************************/
int	CfrmUc131UriagedakaK::RecBufClearData( P_REC_UC_131_URIAGEDATA inRecData )
{
...
/**********************************************************************
	...
	戻値
		int				成功(更新あり)/成功(更新なし)/失敗
						...
						FUNCTION_NG		: 失敗
***********************************************************************/
int	CfrmUc131UriagedakaK::virRecBufSaveData( int inPage, int inRow )
{
...
***********************************************************************/
int	CfrmUc131UriagedakaK::virRecBufSaveDataForPasteInsert( int inPage, int inRow )
{
...
***********************************************************************/
int	CfrmUc131UriagedakaK::virRecBufSaveDataForPaste( int inPage, int inRow )
{
	///////////////////////////////////////////////////////////////
	// 登録処理呼び出し
	return RecBufSaveDataSub( inPage, inRow, &m_CopyData );
...
/**********************************************************************
	...
	戻値
			int					成功(更新あり)/成功(更新なし)/失敗
								...
								FUNCTION_NG		: 失敗
***********************************************************************/
int	CfrmUc131UriagedakaK::RecBufSaveDataSub( 
							int inPage,
							int inRow,
...
//********************************************************************************
CdbUc000Common*	CfrmUc131UriagedakaK::virGetDataTableObject()
{
	// 「売上高」テーブルのオブジェクトを生成し、ポインタを返す
...
//	RET	なし
//********************************************************************************
void	CfrmUc131UriagedakaK::virRowButtonCopyProc()
{
...
//	RET	なし
//********************************************************************************
void	CfrmUc131UriagedakaK::virGetCurrentInfo( CURRENT_INFO* uCurInfo )
{
...
//	【戻値】	なし
//**************************************************
void CfrmUc131UriagedakaK::SetInputMode( int nRow, long nMode )
{
...
//	【戻値】	なし
//**************************************************
void CfrmUc131UriagedakaK::SetDiagBackColor()
{
...
//***************************************************************************
BOOL CfrmUc131UriagedakaK::virEndProc(void)
{
	TRACE(_T("***** CfrmUc131UriagedakaK::virEndProc\n"));
...
// midori 151405 add -->
int CfrmUc131UriagedakaK::CursorControl(short nChar, int sw)
{
	int				rv=0;
	int				intCol=0;
	int				pos=0;
...
// ------------------------------------------------------------------------------------------------------------------------
void CfrmUc131UriagedakaK::TitleColorChg(void)
{
	int					nCharOver[4]={0};	// 電子申告の文字数を超えたかどうかのサイン		1:電子申告の文字数を超えた
											// 様式②	[0]:代表者との関係(10文字)				[1]:源泉所得税納付書(15文字)
											//			[2]:摘要(30文字)
	CRecordset			rs(m_pDB);
	CString				strSQL=_T("");
	CString				strData=_T("");
	...
	// 代表者との関係
// 修正No.157628 del -->
	//strSQL.Format(_T("select max(oversgn) from (select CASE when len(Replace(isnull(Kankei,''),CHAR(13)+CHAR(10),'')) > %d then 1 else 0 end as oversgn from uc_131_uriagedaka where FgShow=%d) tbl1"),UC_131_KANKEI_LEN,ID_FGSHOW_OFF);
// 修正No.157628 del <--
// 修正No.157628 add -->
	strSQL.Format(_T("select max(oversgn) from (select CASE when len(%s) > %d then 1 else 0 end as oversgn from uc_131_uriagedaka where FgShow=%d) tbl1"),
		MakeReplaceSent(_T("Kankei")),UC_131_KANKEI_LEN,ID_FGSHOW_OFF);
// 修正No.157628 add <--
	...
	// 源泉所得税納付書
// 修正No.157628 del -->
	//strSQL.Format(_T("select max(oversgn) from (select CASE when len(Replace(isnull(HdName2,''),CHAR(13)+CHAR(10),'')) > %d then 1 else 0 end as oversgn from uc_131_uriagedaka where FgShow=%d) tbl1"),UC_131_HDNAME2_LEN,ID_FGSHOW_OFF);
// 修正No.157628 del <--
// 修正No.157628 add -->
	strSQL.Format(_T("select max(oversgn) from (select CASE when len(%s) > %d then 1 else 0 end as oversgn from uc_131_uriagedaka where FgShow=%d) tbl1"),
		MakeReplaceSent(_T("HdName2")),UC_131_HDNAME2_LEN,ID_FGSHOW_OFF);
// 修正No.157628 add <--
	rs.Open( CRecordset::forwardOnly, strSQL);
	rs.GetFieldValue((short)0, strData);
	rs.Close();
	...
	// 摘要
// 修正No.157628 del -->
	//strSQL.Format(_T("select max(oversgn) from (select CASE when len(Replace(isnull(Teki,''),CHAR(13)+CHAR(10),'')) > %d then 1 else 0 end as oversgn from uc_131_uriagedaka where FgShow=%d) tbl1"),UC_131_TEKI_LEN,ID_FGSHOW_OFF);
// 修正No.157628 del <--
// 修正No.157628 add -->
	strSQL.Format(_T("select max(oversgn) from (select CASE when len(%s) > %d then 1 else 0 end as oversgn from uc_131_uriagedaka where FgShow=%d) tbl1"),
		MakeReplaceSent(_T("Teki")),UC_131_TEKI_LEN,ID_FGSHOW_OFF);
// 修正No.157628 add <--
	rs.Open( CRecordset::forwardOnly, strSQL);
	rs.GetFieldValue((short)0, strData);
	rs.Close();
	...
	// 項目タイトル(ヘッダ部)の再設定
// 修正No.157626,157639 del -->
	//CmnHeadDiagSetTitle(&m_HeadDiag,3,_T("代表者との関係(10)"),nCharOver[0]);
	////CmnHeadDiagSetTitle(&m_HeadDiag,9,_T("源泉所得\r\n税納付署(15)"),nCharOver[1]);
	//CmnHeadDiagSetTitle(&m_HeadDiag,9,_T("源泉所得\r\n税納付署\r\n(15)"),nCharOver[1]);
	//CmnHeadDiagSetTitle(&m_HeadDiag,10,_T("摘  要(30)"),nCharOver[2]);
// 修正No.157626,157639 del <--
// 修正No.157626,157639 add -->
	if(nCharOver[0] == 1)	CmnHeadDiagSetTitle(&m_HeadDiag,3,_T("代表者との関係\r\n(10)"),1);
	else					CmnHeadDiagSetTitle(&m_HeadDiag,3,_T("代表者との関係"),0);

	if(nCharOver[1] == 1)	CmnHeadDiagSetTitle(&m_HeadDiag,9,_T("源泉所得\r\n税納付署\r\n(15)"),1);
	else					CmnHeadDiagSetTitle(&m_HeadDiag,9,_T("源泉所得\r\n税納付署"),0);

	if(nCharOver[2] == 1)	CmnHeadDiagSetTitle(&m_HeadDiag,10,_T("摘  要(30)"),1);
...
// 修正No.162446 add -->
LRESULT CfrmUc131UriagedakaK::OnUserReDrawView(WPARAM wParam, LPARAM lParam)
{
	virUpdateControlTblData();
	CmnDiagSetFocus(m_pDiag, 1, 1);
