...
IMPLEMENT_DYNCREATE( CfrmUc042Kasituke, CfrmUc000Common )


BEGIN_MESSAGE_MAP( CfrmUc042Kasituke, CfrmUc000Common )
	ON_WM_SIZE()
...
//	ON_COMMAND( ID_BUTTON_F3, OnButtonF3 )
	...
	ON_COMMAND( ID_PRINTSETUP_MENU, &CfrmUc042Kasituke::OnMenuPrintSetup )
	ON_COMMAND( ID_PRINTALL_MENU, &CfrmUc042Kasituke::OnMenuPrintAll )
	ON_COMMAND( ID_OUTPUTFORM_MENU, &CfrmUc042Kasituke::OnMenuFormTypeSetup )
	ON_COMMAND( ID_SPECIALROW_MENU, &CfrmUc042Kasituke::OnMenuSpecialRow )
	ON_COMMAND( ID_SORT_MENU, &CfrmUc042Kasituke::OnMenuSort )
	ON_COMMAND(ID_IKKATUADD_MENU, &CfrmUc042Kasituke::OnIkkatuAddMenu)
	ON_COMMAND( ID_DISPDIALOG_MENU, &CfrmUc042Kasituke::OnMenuIkkatuKingaku )
	ON_COMMAND( ID_ZEROMONEY_MENU, &CfrmUc042Kasituke::OnMenuZeroMoney )
	ON_COMMAND( ID_ZEROMONEYMOVE_MENU, &CfrmUc042Kasituke::OnMenuZeroMoneyMove )
	ON_COMMAND( ID_AMOUTDIALOG_MENU, &CfrmUc042Kasituke::OnMenuOutKeiSetup )
// midori 160606 add -->
	ON_COMMAND( ID_CLEAR_MENU, &CfrmUc042Kasituke::OnMenuClear )
// midori 160606 add <--
	ON_COMMAND( ID_RENDO_MENU, &CfrmUc042Kasituke::OnMenuZaimuRendo )
	ON_COMMAND( ID_TITLEMENU, &CfrmUc042Kasituke::OnMenuTitleRestore )
	ON_COMMAND( ID_USER_SETTING_MENU, &CfrmUc042Kasituke::OnMenuOptionSetting )
	ON_COMMAND( ID_COPY_SETTING_INFO_MENU, &CfrmUc042Kasituke::OnMenuCopySettingInfo )
	ON_COMMAND( ID_DELETE_DATA_MENU, &CfrmUc042Kasituke::OnMenuDeleteDataEachYoushiki )
	ON_BN_CLICKED( IDC_PAGEBACK_BUTTON1, &CfrmUc042Kasituke::OnPageBack )
	ON_BN_CLICKED( IDC_PAGENEXT_BUTTON1, &CfrmUc042Kasituke::OnPageNext )
	ON_BN_CLICKED( IDC_PAGENEW_BUTTON1, &CfrmUc042Kasituke::OnPageNew )
	ON_BN_CLICKED( IDC_PAGEINSERT_BUTTON1, &CfrmUc042Kasituke::OnPageInsert )
	ON_BN_CLICKED( IDC_ROWCOPY_BUTTON1, &CfrmUc042Kasituke::OnRowCopy )
	ON_BN_CLICKED( IDC_ROWPASTE_BUTTON1, &CfrmUc042Kasituke::OnRowPaste )
	ON_BN_CLICKED( IDC_ROWINSERT_BUTTON1, &CfrmUc042Kasituke::OnRowInsert )
	ON_BN_CLICKED( IDC_YOUSHIKINEXT_BUTTON1, &CfrmUc042Kasituke::OnMoveYoushikiNext )
	ON_BN_CLICKED( IDC_YOUSHIKIBACK_BUTTON1, &CfrmUc042Kasituke::OnMoveYoushikiBack )
//	ON_UPDATE_COMMAND_UI( ID_BUTTON_F1, &CfrmUc042Kasituke::OnUpdateButtonF1 )
//	ON_UPDATE_COMMAND_UI( ID_BUTTON_F3, &CfrmUc042Kasituke::OnUpdateButtonF3 )
	ON_UPDATE_COMMAND_UI( ID_BUTTON_F6, &CfrmUc042Kasituke::OnUpdateButtonF6 )
	ON_UPDATE_COMMAND_UI( ID_BUTTON_F7, &CfrmUc042Kasituke::OnUpdateButtonF7 )
	ON_UPDATE_COMMAND_UI( ID_BUTTON_F8, &CfrmUc042Kasituke::OnUpdateButtonF8 )
	ON_UPDATE_COMMAND_UI( ID_BUTTON_F9, &CfrmUc042Kasituke::OnUpdateButtonF9 )
	ON_UPDATE_COMMAND_UI( ID_BUTTON_F11, &CfrmUc042Kasituke::OnUpdateButtonF11 )
	ON_UPDATE_COMMAND_UI( ID_BUTTON_F12, &CfrmUc042Kasituke::OnUpdateButtonF12 )
	ON_UPDATE_COMMAND_UI( ID_BUTTON_HOME, &CfrmUc042Kasituke::OnUpdateButtonHome )
	ON_UPDATE_COMMAND_UI( ID_IKKATUADD_MENU, &CfrmUc042Kasituke::OnUpdateIkkatuaddMenu)
	ON_UPDATE_COMMAND_UI( ID_DISPDIALOG_MENU, &CfrmUc042Kasituke::OnUpdateMenuIkkatuKingaku )
// midori 160612 add -->
	ON_UPDATE_COMMAND_UI( ID_SORT_MENU, &CfrmUc042Kasituke::OnUpdateMenuSort )
	ON_UPDATE_COMMAND_UI( ID_CLEAR_MENU, &CfrmUc042Kasituke::OnUpdateMenuClear )
// midori 160612 add <--
	ON_UPDATE_COMMAND_UI( ID_ZEROMONEY_MENU, &CfrmUc042Kasituke::OnUpdateMenuZeroMoney )
// midori 160612 add -->
	ON_UPDATE_COMMAND_UI( ID_ZEROMONEYMOVE_MENU, &CfrmUc042Kasituke::OnUpdateMenuZeroMoneyMove)
// midori 160612 add <--
	ON_UPDATE_COMMAND_UI( ID_RENDO_MENU, &CfrmUc042Kasituke::OnUpdateMenuZaimuRendo )
	ON_UPDATE_COMMAND_UI(ID_SPECIALROW_MENU, &CfrmUc042Kasituke::OnUpdateMenuSpecialRow)
// midori 160612 add -->
	ON_UPDATE_COMMAND_UI( ID_TITLEMENU, &CfrmUc042Kasituke::OnUpdateMenuTitleRestore )
	ON_UPDATE_COMMAND_UI( ID_DELETE_DATA_MENU, &CfrmUc042Kasituke::OnUpdateMenuDeleteDataEachYoushiki )
// midori 160612 add <--
	ON_MESSAGE(WM_USER_REDRAWVIEW, OnUserReDrawView)		// 修正No.162446 add
END_MESSAGE_MAP()


CfrmUc042Kasituke::CfrmUc042Kasituke()
	: CfrmUc000Common( CfrmUc042Kasituke::IDD )
{
...
CfrmUc042Kasituke::~CfrmUc042Kasituke()
{
	...
	TRACE(_T("***** CfrmUc042Kasituke::~CfrmUc042Kasituke\n"));

	//m_pDiag = NULL;
	//m_pTitleDiag = NULL;
}

void CfrmUc042Kasituke::DoDataExchange( CDataExchange* pDX )
{
...
void CfrmUc042Kasituke::OnInitialUpdate()
{
...
#ifdef _DEBUG
void CfrmUc042Kasituke::AssertValid() const
{
	CfrmUc000Common::AssertValid();
}

#ifndef _WIN32_WCE
void CfrmUc042Kasituke::Dump( CDumpContext& dc ) const
{
...
BEGIN_EVENTSINK_MAP( CfrmUc042Kasituke, CfrmUc000Common )
	ON_EVENT( CfrmUc042Kasituke, IDC_YOUSHIKIDIAG1, 3, CfrmUc042Kasituke::TerminationYoushikidiag1, VTS_I2 VTS_I2 VTS_I2 VTS_UNKNOWN )
	ON_EVENT( CfrmUc042Kasituke, IDC_YOUSHIKIDIAG1, 2, CfrmUc042Kasituke::EditOFFYoushikidiag1, VTS_I2 )
	ON_EVENT( CfrmUc042Kasituke, IDC_YOUSHIKIDIAG1, 1, CfrmUc042Kasituke::EditONYoushikidiag1, VTS_I2 )
// midori 151405 add -->
	ON_EVENT(CfrmUc042Kasituke, IDC_YOUSHIKIDIAG1, 12, CfrmUc042Kasituke::VScrollYoushikidiag1, VTS_I2)
// midori 151405 add <--

	ON_EVENT( CfrmUc042Kasituke, IDC_YOUSHIKIDIAG2, 3, CfrmUc042Kasituke::TerminationYoushikidiag1, VTS_I2 VTS_I2 VTS_I2 VTS_UNKNOWN )
	ON_EVENT( CfrmUc042Kasituke, IDC_YOUSHIKIDIAG2, 2, CfrmUc042Kasituke::EditOFFYoushikidiag1, VTS_I2 )
	ON_EVENT( CfrmUc042Kasituke, IDC_YOUSHIKIDIAG2, 1, CfrmUc042Kasituke::EditONYoushikidiag1, VTS_I2 )
// midori 151405 add -->
	ON_EVENT(CfrmUc042Kasituke, IDC_YOUSHIKIDIAG2, 12, CfrmUc042Kasituke::VScrollYoushikidiag1, VTS_I2)
// midori 151405 add <--

	ON_EVENT( CfrmUc042Kasituke, IDC_YOUSHIKIDIAG3, 3, CfrmUc042Kasituke::TerminationYoushikidiag1, VTS_I2 VTS_I2 VTS_I2 VTS_UNKNOWN )
	ON_EVENT( CfrmUc042Kasituke, IDC_YOUSHIKIDIAG3, 2, CfrmUc042Kasituke::EditOFFYoushikidiag1, VTS_I2 )
	ON_EVENT( CfrmUc042Kasituke, IDC_YOUSHIKIDIAG3, 1, CfrmUc042Kasituke::EditONYoushikidiag1, VTS_I2 )
// midori 151405 add -->
	ON_EVENT(CfrmUc042Kasituke, IDC_YOUSHIKIDIAG3, 12, CfrmUc042Kasituke::VScrollYoushikidiag1, VTS_I2)
// midori 151405 add <--

	ON_EVENT( CfrmUc042Kasituke, IDC_YOUSHIKIDIAG5, 3, CfrmUc042Kasituke::TerminationYoushikidiag1, VTS_I2 VTS_I2 VTS_I2 VTS_UNKNOWN )
	ON_EVENT( CfrmUc042Kasituke, IDC_YOUSHIKIDIAG5, 2, CfrmUc042Kasituke::EditOFFYoushikidiag1, VTS_I2 )
	ON_EVENT( CfrmUc042Kasituke, IDC_YOUSHIKIDIAG5, 1, CfrmUc042Kasituke::EditONYoushikidiag1, VTS_I2 )
// midori 151405 add -->
	ON_EVENT(CfrmUc042Kasituke, IDC_YOUSHIKIDIAG5, 12, CfrmUc042Kasituke::VScrollYoushikidiag1, VTS_I2)
// midori 151405 add <--

	ON_EVENT( CfrmUc042Kasituke, IDC_TITLEDIAG1, 3, CfrmUc042Kasituke::TerminationTitlediag1, VTS_I2 VTS_I2 VTS_I2 VTS_UNKNOWN )
	ON_EVENT( CfrmUc042Kasituke, IDC_TITLEDIAG1, 2, CfrmUc042Kasituke::EditOFFTitlediag1, VTS_I2 )
	ON_EVENT( CfrmUc042Kasituke, IDC_TITLEDIAG1, 1, CfrmUc042Kasituke::EditONTitlediag1, VTS_I2 )
	ON_EVENT( CfrmUc042Kasituke, IDC_TITLEDIAG1, 6, CfrmUc042Kasituke::FocusTitlediag1, VTS_NONE )

	ON_EVENT( CfrmUc042Kasituke, IDC_PAGEDIAG1, 3, CfrmUc042Kasituke::TerminationPagediag1, VTS_I2 VTS_I2 VTS_I2 VTS_UNKNOWN )
	ON_EVENT( CfrmUc042Kasituke, IDC_PAGEDIAG1, 2, CfrmUc042Kasituke::EditOFFPagediag1, VTS_I2 )
	ON_EVENT( CfrmUc042Kasituke, IDC_PAGEDIAG1, 1, CfrmUc042Kasituke::EditONPagediag1, VTS_I2 )
	ON_EVENT( CfrmUc042Kasituke, IDC_PAGEDIAG1, 6, CfrmUc042Kasituke::FocusPagediag1, VTS_NONE )
END_EVENTSINK_MAP()

//********************************************************************************
//	初期処理
//********************************************************************************
BOOL	CfrmUc042Kasituke::virStartJob()
{
	// 初期値設定
...
//	共通データの初期値設定
//********************************************************************************
void	CfrmUc042Kasituke::virSetInitialUchiwakeInfo()
{
	// 「貸付金」の固有データ
	...
	m_uInfo.intColMax = ID_COLMAX_042;				// １行内のコントロール個数
	m_uInfo.intColMaxData = ID_COLMAXDATA_042;		// １行内の列数
	m_uInfo.intCtlStartIndex = ID_CTLSTARTINDEX_042;// １行目の入力項目の先頭インデックス番号
	m_uInfo.intT1StartIndex = ID_T1STARTNORMAL_042;	// 合計行①の先頭インデックス番号
	m_uInfo.intT2StartIndex = ID_T2STARTNORMAL_042;	// 合計行②の入力項目の先頭インデックス番号
	m_uInfo.intCursolDefPos = ID_COL_042_ADNAME1;	// カーソル移動時の初期位置（タイトルから↓，合計から↑で使用）
	m_uInfo.intCursolKeiPos = ID_COL_042_ADNAME1;	// 合計行のカーソル移動位置（カーソル移動で使用）
	...
	m_uInfo.intT1StartNormal = ID_T1STARTNORMAL_042;	// 通常時：合計行①の先頭インデックス
	m_uInfo.intT2StartNormal = ID_T2STARTNORMAL_042;	// 通常時：合計行②の先頭インデックス
	m_uInfo.intT1StartKobetu = ID_T1STARTKOBETU_042;	// 個別時：合計行①の先頭インデックス
	m_uInfo.intT2StartKobetu = ID_T2STARTKOBETU_042;	// 個別時：合計行②の先頭インデックス
	m_uInfo.intRowKei = ID_ROWKEI_042;				// 帳表固定の合計行数（1:合計あり，0:なし）
	m_uInfo.intKei1StartIndex = ID_COL_042_KEI1_MEISYO;	// 計ダイアグラム1行目の先頭インデックス
	m_uInfo.intKei2StartIndex = ID_COL_042_KEI2_MEISYO;	// 計ダイアグラム2行目の先頭インデックス
...
// 【戻値】    なし
//**************************************************
void	CfrmUc042Kasituke::virSetInitialDiag()
{
...
//	帳表固有変数の初期値設定
//********************************************************************************
void	CfrmUc042Kasituke::virSetInitialValue()
{
	// 1ページ分のローカルバッファをクリア
	RecBufClearAllData();
...
//	帳表コントロールの初期化（データ領域）
//********************************************************************************
BOOL	CfrmUc042Kasituke::InitialControlDataArea()
{
	int		intMax;
	int		i;
	...
	for ( i = m_uInfo.intCtlStartIndex; i < intMax; i += m_uInfo.intColMax ) {
		...
		// 漢字入力欄の初期化
		CmnDiagSetAttrInpmax( m_pDiag, i + ID_COL_042_ADNAME1    - 1, MAX_KETA_042_ADNAME1 );	// 貸付先1
		CmnDiagSetAttrInpmax( m_pDiag, i + ID_COL_042_KANKEI    - 1, MAX_KETA_042_KANKEI );		// 法人･代表者との関係
		CmnDiagSetAttrInpmax( m_pDiag, i + ID_COL_042_ADADD1    - 1, MAX_KETA_042_ADADD1 );		// 所在地1
		CmnDiagSetAttrInpmax( m_pDiag, i + ID_COL_042_ADADD2    - 1, MAX_KETA_042_ADADD2 );		// 所在地2
		CmnDiagSetAttrInpmax( m_pDiag, i + ID_COL_042_RIYUU    - 1, MAX_KETA_042_RIYUU );		// 貸付理由
		CmnDiagSetAttrInpmax( m_pDiag, i + ID_COL_042_NAIYOU    - 1, MAX_KETA_042_NAIYOU );		// 担保の内容

		// 金額欄：桁数初期化
		CmnDiagSetAttrDigit( m_pDiag, i + ID_COL_042_VAL - 1, ID_VAL_042_DATA );	// 期末現在高
// No.200903 del -->
		//CmnDiagSetAttrDigit( m_pDiag, i + ID_COL_042_RISOKU - 1, ID_RISOKUL_042_DATA );	// 期中の受取利息額
// No.200903 del <--
// No.200903 add -->
		CmnDiagSetAttrDigit( m_pDiag, i + ID_COL_042_RISOKU - 1, ID_RISOKU_042_DATA );	// 期中の受取利息額
// No.200903 add <--

		// 小数点付き数値の設定
		CmnDiagSetAttrDigit( m_pDiag, i + ID_COL_042_RATE - 1, 2, TRUE, TRUE, 3 );	// 利率
	...
	// 半角/全角設定
	CmnDiagSetAttrColZenHan( m_pDiag , ID_COL_042_ADNAME1 );		// 貸付先1
	CmnDiagSetAttrColZenHan( m_pDiag , ID_COL_042_KANKEI );		// 法人・代表者との関係
	CmnDiagSetAttrColZenHan( m_pDiag , ID_COL_042_ADADD1 );		// 所在地1（住所）
	CmnDiagSetAttrColZenHan( m_pDiag , ID_COL_042_ADADD2 );		// 所在地2（住所）
	CmnDiagSetAttrColZenHan( m_pDiag , ID_COL_042_RIYUU );		// 貸付理由
	CmnDiagSetAttrColZenHan( m_pDiag , ID_COL_042_NAIYOU );		// 担保の内容
...
//********************************************************************************
BOOL	CfrmUc042Kasituke::InitialControlDataAreaHide( CICSDiag* pDiag )
{
	int		intMax;
	int		i;
	...
	for ( i = m_uInfo.intCtlStartIndex; i < intMax; i += m_uInfo.intColMax ) {
		...
		// 漢字入力欄の初期化
		CmnDiagSetAttrInpmax( pDiag, i + ID_COL_042_ADNAME1    - 1, MAX_KETA_042_ADNAME1 );	// 貸付先1
		CmnDiagSetAttrInpmax( pDiag, i + ID_COL_042_KANKEI    - 1, MAX_KETA_042_KANKEI );		// 法人･代表者との関係
		CmnDiagSetAttrInpmax( pDiag, i + ID_COL_042_ADADD1    - 1, MAX_KETA_042_ADADD1 );		// 所在地1
		CmnDiagSetAttrInpmax( pDiag, i + ID_COL_042_ADADD2    - 1, MAX_KETA_042_ADADD2 );		// 所在地2
		CmnDiagSetAttrInpmax( pDiag, i + ID_COL_042_RIYUU    - 1, MAX_KETA_042_RIYUU );		// 貸付理由
		CmnDiagSetAttrInpmax( pDiag, i + ID_COL_042_NAIYOU    - 1, MAX_KETA_042_NAIYOU );		// 担保の内容

		// 金額欄：桁数初期化
		CmnDiagSetAttrDigit( pDiag, i + ID_COL_042_VAL - 1, ID_VAL_042_DATA );	// 期末現在高
// No.200903 del -->
		//CmnDiagSetAttrDigit( pDiag, i + ID_COL_042_RISOKU - 1, ID_RISOKUL_042_DATA );	// 期中の受取利息額
// No.200903 del <--
// No.200903 add -->
		CmnDiagSetAttrDigit( pDiag, i + ID_COL_042_RISOKU - 1, ID_RISOKU_042_DATA );	// 期中の受取利息額
// No.200903 add <--

		// 小数点付き数値の設定
		CmnDiagSetAttrDigit( pDiag, i + ID_COL_042_RATE - 1, 2, TRUE, TRUE, 3 );	// 利率
	}
...
//********************************************************************************
BOOL	CfrmUc042Kasituke::InitialControlComboBox()
{
	// コンボボックスを初期化する関数です。
	return TRUE;
}
...
//********************************************************************************
void	CfrmUc042Kasituke::InitialControlTotalArea()
{
	int		nKeiType;			//	計の種別
	int		nDataRow;			//	データ行属性
...
// midori 152166 add <--
	...
	m_pDiagKei->ModifyItem(ID_COL_042_KEI1_VAL, intKeiRow);
	m_pDiagKei->ModifyItem(ID_COL_042_KEI2_VAL, intKeiRow);
	m_pDiagKei->ModifyItem(ID_COL_042_KEI1_RISOKU, intKeiRow);
// midori M-16081501 cor -->
	//m_pDiagKei->ModifyItem(ID_COL_042_KEI1_RISOKU, intKeiRow);
// -------------------------
	m_pDiagKei->ModifyItem(ID_COL_042_KEI2_RISOKU, intKeiRow);
// midori M-16081501 cor <--
	...
	//m_pDiag->ModifyItem( CmnGetControlTotalIndex( 1, ID_COL_042_ADNAME1 ), nKeiRow[0] );
	//m_pDiag->ModifyItem( CmnGetControlTotalIndex( 2, ID_COL_042_ADNAME1 ), nKeiRow[1] );
	
	// 合計行の金額欄は、金額欄 + 1桁
	CmnDiagSetAttrDigit( m_pDiagKei, ID_COL_042_KEI1_VAL, ID_VAL_042_TOTAL );
	CmnDiagSetAttrDigit( m_pDiagKei, ID_COL_042_KEI2_VAL, ID_VAL_042_TOTAL );
	CmnDiagSetAttrDigit( m_pDiagKei, ID_COL_042_KEI1_RISOKU, ID_RISOKU_042_TOTAL );
	CmnDiagSetAttrDigit( m_pDiagKei, ID_COL_042_KEI2_RISOKU, ID_RISOKU_042_TOTAL );
	//CmnDiagSetAttrDigit( m_pDiag, CmnGetControlTotalIndex( 1, ID_COL_042_VAL ), ID_VAL_042_TOTAL );
	//CmnDiagSetAttrDigit( m_pDiag, CmnGetControlTotalIndex( 2, ID_COL_042_VAL ), ID_VAL_042_TOTAL );
	//CmnDiagSetAttrDigit( m_pDiag, CmnGetControlTotalIndex( 1, ID_COL_042_RISOKU ), ID_RISOKU_042_TOTAL );
	//CmnDiagSetAttrDigit( m_pDiag, CmnGetControlTotalIndex( 2, ID_COL_042_RISOKU ), ID_RISOKU_042_TOTAL );
}
...
//		→表示していない方のDiag(通常 or 個別)の設定に使用する
//********************************************************************************
void	CfrmUc042Kasituke::InitialControlTotalAreaHide( CICSDiag* pDiag )
{
	int intIndex = 0;
	...
	// 合計行の金額欄は、金額欄 + 1桁
	intIndex = m_intT1StartIndexHide + m_uInfo.intCtlStartIndex + ID_COL_042_VAL - 1;
	CmnDiagSetAttrDigit( pDiag, intIndex, ID_VAL_042_TOTAL );
	
	intIndex = m_intT2StartIndexHide + m_uInfo.intCtlStartIndex + ID_COL_042_VAL - 1;
	CmnDiagSetAttrDigit( pDiag, intIndex, ID_VAL_042_TOTAL );

	intIndex = m_intT1StartIndexHide + m_uInfo.intCtlStartIndex + ID_COL_042_RISOKU - 1;
	CmnDiagSetAttrDigit( pDiag, intIndex, ID_RISOKU_042_TOTAL );
	
	intIndex = m_intT2StartIndexHide + m_uInfo.intCtlStartIndex + ID_COL_042_RISOKU - 1;
	CmnDiagSetAttrDigit( pDiag, intIndex, ID_RISOKU_042_TOTAL );
}
...
//	RET	なし
//********************************************************************************
void	CfrmUc042Kasituke::InitialControlSpecialRow( int intRow, int intFgFunc )
{
	...
	case ID_FGFUNC_IKKATUAUTO:		// 一括集計金額行（自動）
		// 桁数を設定
		CmnDiagSetAttrDigit( m_pDiag, CmnGetControlIndex( intRow , ID_COL_042_VAL ), ID_VAL_042_TOTAL );
		CmnDiagSetAttrDigit( m_pDiag, CmnGetControlIndex( intRow , ID_COL_042_RISOKU ), ID_RISOKU_042_TOTAL );
		break;
	}
...
//	帳表タイトル情報の表示
//********************************************************************************
void	CfrmUc042Kasituke::virUpdateControlTitle()
{
//	int		intMax;
...
//	帳表ページ情報の表示
//********************************************************************************
void	CfrmUc042Kasituke::UpdateControlPage()
{
	BOOL	bBack = TRUE;
	BOOL	bNext = TRUE;
...
//	帳表データの表示（１ページ分）
//********************************************************************************
BOOL	CfrmUc042Kasituke::virUpdateControlTblData()
{
	// ダイアログ切替
	if( m_pDiag != NULL ){
		virSetInitialDiag();
...
//	保管件数の表示
//********************************************************************************
BOOL CfrmUc042Kasituke::virUpdateControlTblData2()
{
	int					hcnt=0;
	CString				cs=_T("");
...
//		RET		なし
//********************************************************************************
void	CfrmUc042Kasituke::UpdateControlRowData( CdbUc042Kasituke* prmDbRec ) {
	DIAGRAM_DATA	diadata;	// ICSDiag構造体
	int				intCell;	// 保存フィールド
	...
	// 読込み対象セル取得
	intCell = CmnGetControlIndex( prmDbRec->m_NumRow, ID_COL_042_ADNAME1 );
...
//		RET		なし
//********************************************************************************
void	CfrmUc042Kasituke::UpdateControlRowTotal( CdbUc042Kasituke* prmDbRec )
{
	int		intTotalType;
	...
	// 頁計/累計の名称表示
	if ( intRowName > 0 ) {
		//CmnDiagSetString( m_pDiag, CmnGetControlTotalIndex( intRowName, ID_COL_042_ADNAME1 ), prmDbRec->m_KeiStr, 0 );
		CmnDiagSetString( m_pDiagKei, CmnGetKeiDiagIndex( intRowName, ID_COL_042_KEI1_MEISYO ), prmDbRec->m_KeiStr, 1 );
	}
	// 頁計/累計の金額表示
	if ( intRowVal > 0 ) {
		//CmnDiagSetKingaku( m_pDiag, CmnGetControlTotalIndex( intRowName, ID_COL_042_VAL ), prmDbRec->m_Val );
		CmnDiagSetKingaku( m_pDiagKei, CmnGetKeiDiagIndex( intRowVal, ID_COL_042_KEI1_VAL ), prmDbRec->m_Val );
	}
	if ( intRowRisoku > 0 ) {
		//CmnDiagSetKingaku( m_pDiag, CmnGetControlTotalIndex( intRowName, ID_COL_042_RISOKU ), prmDbRec->m_Risoku );
		CmnDiagSetKingaku( m_pDiagKei, CmnGetKeiDiagIndex( intRowRisoku, ID_COL_042_KEI1_RISOKU ), prmDbRec->m_Risoku );
	}
}
...
//		RET		なし
//********************************************************************************
void	CfrmUc042Kasituke::virFncCellCopyProc( CdbUc000Common* rsData )
{
	CdbUc042Kasituke*	rs;
	int					intCol;	// 現在の列
...
//********************************************************************************
int	CfrmUc042Kasituke::virFncReferenceGetType(int intCol, int* intGrSeq, long* lngItemSeq, int* intAdd1, int* intAdd2, int* intAdd1Col, int* intAdd2Col, REFERENCE_INFO* pudReference)
{
	int		intRefType;
	...
	//case ID_COL_042_ADADD2:
		...
		*lngItemSeq = m_ReadData[m_uInfo.intCurRow].m_AdSeq;
		...
		// 住所欄なら住所１、２の列番号取得
		//if ( intCol != ID_COL_042_ADNAME1 ){
		//	*intAdd1Col = ID_COL_042_ADADD1;
		//	*intAdd2Col = ID_COL_042_ADADD2;
		//}
		break;
...
//		RET		なし
//********************************************************************************
void	CfrmUc042Kasituke::virFncReferenceSetData( CdlgReference* dlgRef, int intRefType, int intCol )
{
	switch ( intRefType ) {
	...
	case ID_DLGTYPE_ADDRESS:
		// 選択内容を表示
		CmnDiagSetString( m_pDiag, CmnGetControlIndex( m_uInfo.intCurRow, ID_COL_042_ADNAME1 ), 
						  m_clsFunc.StrDocking( dlgRef->m_udAddress.m_AdName1 , dlgRef->m_udAddress.m_AdName2 ) , 0 );
		CmnDiagSetString( m_pDiag, CmnGetControlIndex( m_uInfo.intCurRow, ID_COL_042_ADADD1 ), 
						  dlgRef->m_udAddress.m_AdAdd1, 0 );
		CmnDiagSetString( m_pDiag, CmnGetControlIndex( m_uInfo.intCurRow, ID_COL_042_ADADD2 ), 
...
//		RET		なし
//********************************************************************************
void	CfrmUc042Kasituke::virFncReferenceSetICSData(CdlgAddressSearch* dlgAddd)
{
	int			intIndex;

	// 売却(買入)先の所在地1(住所)
	intIndex = CmnGetControlIndex( m_uInfo.intCurRow, ID_COL_042_ADADD1 );
	CmnDiagSetString( m_pDiag, intIndex, dlgAddd->m_AdAdd1, 0 );

	// 売却(買入)先の所在地2(住所)
	intIndex = CmnGetControlIndex( m_uInfo.intCurRow, ID_COL_042_ADADD2 );
...
//		RET		なし
//********************************************************************************
void	CfrmUc042Kasituke::virFncReferenceUpdateTbl( int intRefType, int nRefMode/*=0*/ )
{
	switch ( intRefType ) {
...
//	その他イベント処理
//********************************************************************************
BOOL	CfrmUc042Kasituke::PreTranslateMessage( MSG* pMsg )
{
//	int				intID;
...
/*
		...
		case VK_TAB:
			...
			if ((intID == IDC_PAGEBACK_BUTTON1) && (CmnCheckShiftKey() == TRUE)) {
				...
				CmnDiagSetFocus(m_pDiag, m_uInfo.intRowMax, ID_COL_042_ADNAME1);
				return 1;
			}
			break;
*/
...
// 頁コントロールのフォーカス設定
void	CfrmUc042Kasituke::FocusPagediag1()
{
...
// 頁コントロールのゲットフォーカス
void	CfrmUc042Kasituke::EditONPagediag1( short index )
{
// midori 151405 add -->
	// スクロールフラグをクリアする
	nG_MScroll = 0;
...
//	if(( nCol != ID_COL_042_VAL ) || ( nCol != ID_COL_042_RISOKU )){
...
// 頁コントロールのロストフォーカス
void	CfrmUc042Kasituke::EditOFFPagediag1( short index )
{
// midori 155028 add -->
...
// 頁コントロールのキー操作
void	CfrmUc042Kasituke::TerminationPagediag1( short index, short nChar, short length, LPUNKNOWN data )
{
	int nMaxDataCol = 0;
	// カレント頁の合計行の種別を取得
...
// midori 160612 cor <--
			...
			//CmnDiagSetFocus(m_pDiag, m_uInfo.intRowMax, ID_COL_042_ADNAME1);
			CmnDiagSetFocus(m_pDiag, nMaxDataCol, ID_COL_042_NAIYOU);
		}
		break;
	case VK_DOWN:
		// タイトルコントロールへ移動
...
// タイトルコントロールのフォーカス設定
void	CfrmUc042Kasituke::FocusTitlediag1()
{
//マウスクリックでキャレットが表示できないためコメントとする
//	// ボタンからTabキー移動した場合に必要
//	m_TitleDiag.SetPosition( 0 );
...
// タイトルコントロールのゲットフォーカス
void	CfrmUc042Kasituke::EditONTitlediag1( short index )
{
// midori 151405 add -->
	// スクロールフラグをクリアする
	nG_MScroll = 0;
...
// タイトルコントロールのロストフォーカス
void	CfrmUc042Kasituke::EditOFFTitlediag1 (short index )
{
// midori 151405 add -->
	m_Titlefocus = 0;
// midori 151405 add <--
...
//	タイトル更新
void CfrmUc042Kasituke::virUpdateTitle()
{
...
// タイトルコントロールのキーイベント
void	CfrmUc042Kasituke::TerminationTitlediag1( short index, short nChar, short length, LPUNKNOWN data )
{
	// フォーカス移動
	switch ( nChar ) {
	case VK_RETURN:
...
void	CfrmUc042Kasituke::EditONYoushikidiag1( short index )
{
...
//			if(( nCol != ID_COL_042_VAL ) || ( nCol != ID_COL_042_RISOKU )){
			...
			BOOL adadd1_to_adadd2 = IsSaveMoveReference(ID_COL_042_ADADD1, ID_COL_042_ADADD2);
			// [Home]キー押下の住所検索ダイアログの戻り（フォーカスをセットしている）は保存しない（改良依頼No15-1613）
			BOOL adadd1_to_adadd1 = IsSaveMoveReference(ID_COL_042_ADADD1, ID_COL_042_ADADD1);	// 所在地1(住所)→所在地1(住所)
...
// データコントロールのロストフォーカス
void	CfrmUc042Kasituke::EditOFFYoushikidiag1( short index )
{
	if( m_EndView != FALSE )	return;
...
//	入力確定
void CfrmUc042Kasituke::virInputDecisionEditOFF()
{
	// フォーカスフラグOFF
...
// 預貯金データコントロールのキーイベント
void	CfrmUc042Kasituke::TerminationYoushikidiag1( short index, short nChar, short length, LPUNKNOWN data )
{
	//--------------------------------------------------------------------------------
	//	キー操作仕様
...
// midori 151405 del -->
	...
	//	//if(( intCol == ID_COL_042_VAL ) || ( intCol == ID_COL_042_RISOKU )){
	//	//	switch(nChar){
	//	//		// 行を跨がないカーソル移動
	//	//		case VK_TAB:
	//	//		case VK_RIGHT:
...
// midori 151405 add -->
void CfrmUc042Kasituke::VScrollYoushikidiag1(short mode)
{
...
//********************************************************************************
int	CfrmUc042Kasituke::GetFocusPosition( int nChar )
{
	int		intRow;				// カレント行番号
	int		intCol;				// カレント列番号
	...
	else if ( intCol == ID_COL_042_KANKEI ) {
	...
	else if ( intCol == ID_COL_042_ADADD1 ) {
		// カレント列が「所在地1」の場合
	...
	else if ( intCol == ID_COL_042_ADADD2 ) {
		// カレント列が「所在地2」の場合
	...
	else if ( intCol == ID_COL_042_RISOKU ) {
		// カレント列が「期中の受取利息額」の場合
	...
	else if ( intCol == ID_COL_042_RATE ) {
		// カレント列が「利率」の場合
		intVector[0] = m_uInfo.intCurCtlIndex - 1;						// ↑
		intVector[1] = m_uInfo.intCurCtlIndex + 1;						// →
	...
	else if ( intCol == ID_COL_042_NAIYOU ) {
		// カレント列が「担保の内容」の場合
	...
	case VK_RETURN:	// Enterキーでカーソルを下に移動するモード対応
		if(m_ReturnMoveDown){
			if ( intCol == ID_COL_042_ADNAME1 ) 	intNext = intVector[1];			//	カレント列が「貸付先1」の場合は「→」キーと同じ
...
//********************************************************************************
int	CfrmUc042Kasituke::GetTotalRowIndex( int nCharOrg, int intIndex, int intNext )
{
	...
	if ( nNowRow <= nBorder[0] ){
		...
		if ( nNextRow > nBorder[0] ){
			//	計行に移動
			//nRet = CmnGetControlIndex( ( nBorder[1] + 1 ), ID_COL_042_ADNAME1 );
			if (nCharOrg == VK_TAB) {
				return -2;
			}
		}
	...
	//	現在、頁計に居る
		...
		case VK_UP:			// ↑：23行目のデータ行の支店名項目へ移動
			nRet = CmnGetControlIndex( nBorder[0], ID_COL_042_ADADD2 );
			break;
		case VK_LEFT:		// ←/Shift+Tab：23行目のデータ行の摘要項目へ移動
			nRet = CmnGetControlIndex( nBorder[0], ID_COL_042_NAIYOU );
			break;
		default:			// →/↓/Return/Tab：25行目の合計行②へ移動
			...
			//	累計あり
				...
				nRet = CmnGetControlIndex( ( nBorder[2] + 1 ), ID_COL_042_ADNAME1 );
			}
			break;
		}
	}
...
//		RET		なし
//********************************************************************************
void	CfrmUc042Kasituke::virTblEditIkkatuLine( int nType, CdbUc000Common* rsData,
...
//********************************************************************************
int	CfrmUc042Kasituke::virTblSortSubSortProc( CdlgSort* pCdlgSort, CdbUc000Common* rsData )
{
	CdbUc042Kasituke*	rs;
	CString				strFilter;
	CString				strSort;
...
/**********************************************************************
	...
	戻値
		int		成功/失敗
				FUNCTION_OK
***********************************************************************/
int	CfrmUc042Kasituke::RecBufSetData( CdbUc042Kasituke* prmDbRec )
{
...
/**********************************************************************
	...
	戻値
		int		成功/失敗
				FUNCTION_OK
***********************************************************************/
int	CfrmUc042Kasituke::RecBufClearAllData()
{
...
/**********************************************************************
	...
	戻値
		int		成功/失敗
				FUNCTION_OK
***********************************************************************/
int	CfrmUc042Kasituke::RecBufClearData( P_REC_UC_042_KASITUKE inRecData )
{
...
/**********************************************************************
	...
	戻値
		int				成功(更新あり)/成功(更新なし)/失敗
						...
						FUNCTION_NG		: 失敗
***********************************************************************/
int	CfrmUc042Kasituke::virRecBufSaveData( int inPage, int inRow )
{
	...
	intIndex = CmnGetControlIndex( inRow, ID_COL_042_ADNAME1 );
// 158138 del -->
...
// 158138 add <--
	...
	if ( tmpSaveData.m_AdName2.IsEmpty() ){
		if(m_uInfo.intCurCol == ID_COL_042_ADNAME1 && m_uInfo.intCurRow != m_uInfo.OldRow){	// 各カラムごとにvirRecBufSaveData()がコールされるようになり、かつタイミングがEditOffからEditOnに移ったことによりCmnDiagSetString()でカレットが末尾から先頭に移ってしまう為、制御（修正依頼No150489）
			CmnDiagSetString( m_pDiag, intIndex, tmpSaveData.m_AdName1, 0 );
		}
	}

	// 法人・代表者との関係
	intIndex = CmnGetControlIndex( inRow, ID_COL_042_KANKEI );
	tmpSaveData.m_Kankei = m_clsFunc.DiagGetString( m_pDiag, intIndex );

	// 所在地1（住所）
	intIndex = CmnGetControlIndex( inRow, ID_COL_042_ADADD1 );
	tmpSaveData.m_AdAdd1 = m_clsFunc.DiagGetString( m_pDiag, intIndex );

	// 所在地2（住所）
	intIndex = CmnGetControlIndex( inRow, ID_COL_042_ADADD2 );
	tmpSaveData.m_AdAdd2 = m_clsFunc.DiagGetString( m_pDiag, intIndex );

	// 期末現在高
	intIndex = CmnGetControlIndex( inRow, ID_COL_042_VAL );
	tmpSaveData.m_Val = CmnDiagGetKingaku( m_pDiag, intIndex );

	// 期中の受取利息額
	intIndex = CmnGetControlIndex( inRow, ID_COL_042_RISOKU );
	tmpSaveData.m_Risoku = CmnDiagGetKingaku( m_pDiag, intIndex );

	// 利率
	intIndex = CmnGetControlIndex( inRow, ID_COL_042_RATE );
	tmpSaveData.m_Rate = CmnDiagGetKingaku( m_pDiag, intIndex );

	// 貸付理由
	intIndex = CmnGetControlIndex( inRow, ID_COL_042_RIYUU );
	tmpSaveData.m_Riyuu = m_clsFunc.DiagGetString( m_pDiag, intIndex );

	// 担保の内容
	intIndex = CmnGetControlIndex( inRow, ID_COL_042_NAIYOU );
...
***********************************************************************/
int	CfrmUc042Kasituke::virRecBufSaveDataForPasteInsert( int inPage, int inRow )
{
...
***********************************************************************/
int	CfrmUc042Kasituke::virRecBufSaveDataForPaste( int inPage, int inRow )
{
	///////////////////////////////////////////////////////////////
	// 登録処理呼び出し
	return RecBufSaveDataSub( inPage, inRow, &m_CopyData );
...
/**********************************************************************
	...
	戻値
			int					成功(更新あり)/成功(更新なし)/失敗
								...
								FUNCTION_NG		: 失敗
***********************************************************************/
int	CfrmUc042Kasituke::RecBufSaveDataSub( 
							int inPage,
							int inRow,
...
//********************************************************************************
CdbUc000Common*	CfrmUc042Kasituke::virGetDataTableObject()
{
	// 「貸付金」テーブルのオブジェクトを生成し、ポインタを返す
...
//	RET	なし
//********************************************************************************
void	CfrmUc042Kasituke::virRowButtonCopyProc()
{
...
//	RET	なし
//********************************************************************************
void CfrmUc042Kasituke::virTblGetIkkatuSumValue(CdbUc000Common* rsData, int nFgShow, int nGroup, CALCKEI_INFO* uCalcKei)
{
	// 通常は"Val"項目のみ集計する。
...
//	RET	なし
//********************************************************************************
void	CfrmUc042Kasituke::virGetCurrentInfo( CURRENT_INFO* uCurInfo )
{
...
//********************************************************************************
int	CfrmUc042Kasituke::virUpdateRelationTblChengeFormType()
{
...
//		RET		BOOL		TRUE:正常終了，FALSE:エラー
//********************************************************************************
BOOL CfrmUc042Kasituke::virUpdateRelationTblChengeFormTypeSave()
{
...
////		RET		なし
////********************************************************************************
//int	CfrmUc042Kasituke::UpdateTbl042ChangeFormType()
//{
//	// 初期値設定
...
//		RET		なし
//********************************************************************************
int	CfrmUc042Kasituke::UpdateTbl042ChangeFormType(UCHIWAKE_INFO pInfoSv)
{
	// データ無しならデータ更新しない
...
//	【戻値】	なし
//**************************************************
void CfrmUc042Kasituke::SetInputMode( int nRow, long nMode )
{
	m_pDiag->ModifyItem( CmnGetControlIndex( nRow, ID_COL_042_ADNAME1 ), nMode );	//	
	m_pDiag->ModifyItem( CmnGetControlIndex( nRow, ID_COL_042_KANKEI ), nMode );	//	
	m_pDiag->ModifyItem( CmnGetControlIndex( nRow, ID_COL_042_ADADD1 ), nMode );	//	
	m_pDiag->ModifyItem( CmnGetControlIndex( nRow, ID_COL_042_ADADD2 ), nMode );	//	
	m_pDiag->ModifyItem( CmnGetControlIndex( nRow, ID_COL_042_VAL ), nMode );		//	
	m_pDiag->ModifyItem( CmnGetControlIndex( nRow, ID_COL_042_RISOKU ), nMode );	//	
	m_pDiag->ModifyItem( CmnGetControlIndex( nRow, ID_COL_042_RATE ), nMode );		//	
	m_pDiag->ModifyItem( CmnGetControlIndex( nRow, ID_COL_042_RIYUU ), nMode );		//	
	m_pDiag->ModifyItem( CmnGetControlIndex( nRow, ID_COL_042_NAIYOU ), nMode );	//	
}
...
//	【戻値】	なし
//**************************************************
void CfrmUc042Kasituke::SetDiagBackColor()
{
...
//		RET		なし					
//********************************************************************************
void CfrmUc042Kasituke::virRendoCreateData(CdbUc000Common* rsData, RENTEMP_INFO* uRenInfo)
{
	CString			strTemp;
...
//		RET		なし					
//********************************************************************************
void CfrmUc042Kasituke::virRendoUpdateData(CdbUc000Common* rsData, RENTEMP_INFO* uRenInfo)
{
	CdbUc042Kasituke*	rs = (CdbUc042Kasituke*)rsData;
...
//***************************************************************************
BOOL CfrmUc042Kasituke::virEndProc(void)
{
	TRACE(_T("***** CfrmUc042Kasituke::virEndProc\n"));
...
// midori 151405 add -->
int CfrmUc042Kasituke::CursorControl(short nChar, int sw)
{
	int				rv=0;
	int				intCol=0;
	int				pos=0;
...
// 修正No.162446 add -->
LRESULT CfrmUc042Kasituke::OnUserReDrawView(WPARAM wParam, LPARAM lParam)
{
	virUpdateControlTblData();
	CmnDiagSetFocus(m_pDiag, 1, 1);
