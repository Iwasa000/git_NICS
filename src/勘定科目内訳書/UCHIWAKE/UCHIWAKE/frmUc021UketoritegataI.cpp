...
IMPLEMENT_DYNCREATE( CfrmUc021UketoritegataI, CfrmUc000Common )


BEGIN_MESSAGE_MAP( CfrmUc021UketoritegataI, CfrmUc000Common )
	ON_WM_SIZE()
	...
	ON_COMMAND( ID_PRINTSETUP_MENU, &CfrmUc021UketoritegataI::OnMenuPrintSetup )
	ON_COMMAND( ID_PRINTALL_MENU, &CfrmUc021UketoritegataI::OnMenuPrintAll )
	ON_COMMAND( ID_SPECIALROW_MENU, &CfrmUc021UketoritegataI::OnMenuSpecialRow )
	ON_COMMAND( ID_SORT_MENU, &CfrmUc021UketoritegataI::OnMenuSort )
	ON_COMMAND( ID_IKKATUADD_MENU, &CfrmUc021UketoritegataI::OnIkkatuAddMenu)
	ON_COMMAND( ID_DISPDIALOG_MENU, &CfrmUc021UketoritegataI::OnMenuIkkatuKingaku )
	ON_COMMAND( ID_ZEROMONEY_MENU, &CfrmUc021UketoritegataI::OnMenuZeroMoney )
	ON_COMMAND( ID_ZEROMONEYMOVE_MENU, &CfrmUc021UketoritegataI::OnMenuZeroMoneyMove )
	ON_COMMAND( ID_AMOUTDIALOG_MENU, &CfrmUc021UketoritegataI::OnMenuOutKeiSetup )
	ON_COMMAND( ID_CLEAR_MENU, &CfrmUc021UketoritegataI::OnMenuClear )
	ON_COMMAND( ID_RENDO_MENU, &CfrmUc021UketoritegataI::OnMenuZaimuRendo )
	ON_COMMAND( ID_TITLEMENU, &CfrmUc021UketoritegataI::OnMenuTitleRestore )
	ON_COMMAND( ID_USER_SETTING_MENU, &CfrmUc021UketoritegataI::OnMenuOptionSetting )
	ON_COMMAND( ID_COPY_SETTING_INFO_MENU, &CfrmUc021UketoritegataI::OnMenuCopySettingInfo )
	ON_COMMAND( ID_DELETE_DATA_MENU, &CfrmUc021UketoritegataI::OnMenuDeleteDataEachYoushiki )
	ON_BN_CLICKED( IDC_PAGEBACK_BUTTON1, &CfrmUc021UketoritegataI::OnPageBack )
	ON_BN_CLICKED( IDC_PAGENEXT_BUTTON1, &CfrmUc021UketoritegataI::OnPageNext )
	ON_BN_CLICKED( IDC_PAGENEW_BUTTON1, &CfrmUc021UketoritegataI::OnPageNew )
	ON_BN_CLICKED( IDC_PAGEINSERT_BUTTON1, &CfrmUc021UketoritegataI::OnPageInsert )
	ON_BN_CLICKED( IDC_ROWCOPY_BUTTON1, &CfrmUc021UketoritegataI::OnRowCopy )
	ON_BN_CLICKED( IDC_ROWPASTE_BUTTON1, &CfrmUc021UketoritegataI::OnRowPaste )
	ON_BN_CLICKED( IDC_ROWINSERT_BUTTON1, &CfrmUc021UketoritegataI::OnRowInsert )
	ON_BN_CLICKED( IDC_YOUSHIKINEXT_BUTTON1, &CfrmUc021UketoritegataI::OnMoveYoushikiNext )
	ON_BN_CLICKED( IDC_YOUSHIKIBACK_BUTTON1, &CfrmUc021UketoritegataI::OnMoveYoushikiBack )
	ON_UPDATE_COMMAND_UI( ID_BUTTON_F6, &CfrmUc021UketoritegataI::OnUpdateButtonF6 )
	ON_UPDATE_COMMAND_UI( ID_BUTTON_F7, &CfrmUc021UketoritegataI::OnUpdateButtonF7 )
	ON_UPDATE_COMMAND_UI( ID_BUTTON_F8, &CfrmUc021UketoritegataI::OnUpdateButtonF8 )
	ON_UPDATE_COMMAND_UI( ID_BUTTON_F9, &CfrmUc021UketoritegataI::OnUpdateButtonF9 )
	ON_UPDATE_COMMAND_UI( ID_BUTTON_F11, &CfrmUc021UketoritegataI::OnUpdateButtonF11 )
	ON_UPDATE_COMMAND_UI( ID_BUTTON_F12, &CfrmUc021UketoritegataI::OnUpdateButtonF12 )
	ON_UPDATE_COMMAND_UI( ID_BUTTON_HOME, &CfrmUc021UketoritegataI::OnUpdateButtonHome )
	//ON_UPDATE_COMMAND_UI(ID_IKKATUADD_MENU, &CfrmUc000Common::OnUpdateIkkatuaddMenu)				// 改良No.21-0086,21-0529 del
	ON_UPDATE_COMMAND_UI(ID_IKKATUADD_MENU, &CfrmUc021UketoritegataI::OnUpdateIkkatuaddMenu)		// 改良No.21-0086,21-0529 add
	ON_UPDATE_COMMAND_UI( ID_DISPDIALOG_MENU, &CfrmUc021UketoritegataI::OnUpdateMenuIkkatuKingaku )
	ON_UPDATE_COMMAND_UI( ID_SORT_MENU, &CfrmUc021UketoritegataI::OnUpdateMenuSort )
	ON_UPDATE_COMMAND_UI( ID_CLEAR_MENU, &CfrmUc021UketoritegataI::OnUpdateMenuClear )
	ON_UPDATE_COMMAND_UI( ID_ZEROMONEY_MENU, &CfrmUc021UketoritegataI::OnUpdateMenuZeroMoney )
	ON_UPDATE_COMMAND_UI( ID_ZEROMONEYMOVE_MENU, &CfrmUc021UketoritegataI::OnUpdateMenuZeroMoneyMove)
	ON_UPDATE_COMMAND_UI( ID_RENDO_MENU, &CfrmUc021UketoritegataI::OnUpdateMenuZaimuRendo )
	ON_UPDATE_COMMAND_UI(ID_SPECIALROW_MENU, &CfrmUc021UketoritegataI::OnUpdateMenuSpecialRow)
	ON_UPDATE_COMMAND_UI( ID_TITLEMENU, &CfrmUc021UketoritegataI::OnUpdateMenuTitleRestore )
	ON_UPDATE_COMMAND_UI( ID_DELETE_DATA_MENU, &CfrmUc021UketoritegataI::OnUpdateMenuDeleteDataEachYoushiki )
	ON_MESSAGE(WM_USER_REDRAWVIEW, OnUserReDrawView)
END_MESSAGE_MAP()


CfrmUc021UketoritegataI::CfrmUc021UketoritegataI()
	: CfrmUc000Common( CfrmUc021UketoritegataI::IDD )
{
	...
	m_pDiagKei2 = &m_DiagKei1;		// 修正No.168481,168502,168517 add
}

CfrmUc021UketoritegataI::~CfrmUc021UketoritegataI()
{
	// 2009.09.08 TS自動ログオフ対応(virEndProcへ移動)
	TRACE(_T("***** CfrmUc021UketoritegataI::~CfrmUc021UketoritegataI\n"));
}

void CfrmUc021UketoritegataI::DoDataExchange( CDataExchange* pDX )
{
...
void CfrmUc021UketoritegataI::OnInitialUpdate()
{
...
#ifdef _DEBUG
void CfrmUc021UketoritegataI::AssertValid() const
{
	CfrmUc000Common::AssertValid();
}

#ifndef _WIN32_WCE
void CfrmUc021UketoritegataI::Dump( CDumpContext& dc ) const
{
...
BEGIN_EVENTSINK_MAP( CfrmUc021UketoritegataI, CfrmUc000Common )
	ON_EVENT(CfrmUc021UketoritegataI, IDC_YOUSHIKIDIAG1, 3, CfrmUc021UketoritegataI::TerminationYoushikidiag1, VTS_I2 VTS_I2 VTS_I2 VTS_UNKNOWN )
	ON_EVENT(CfrmUc021UketoritegataI, IDC_YOUSHIKIDIAG1, 2, CfrmUc021UketoritegataI::EditOFFYoushikidiag1, VTS_I2 )
	ON_EVENT(CfrmUc021UketoritegataI, IDC_YOUSHIKIDIAG1, 1, CfrmUc021UketoritegataI::EditONYoushikidiag1, VTS_I2 )
	ON_EVENT(CfrmUc021UketoritegataI, IDC_YOUSHIKIDIAG1, 12, CfrmUc021UketoritegataI::VScrollYoushikidiag1, VTS_I2)
	ON_EVENT(CfrmUc021UketoritegataI, IDC_YOUSHIKIDIAG1, 8, CfrmUc021UketoritegataI::ComboSelYoushikidiag1, VTS_I2 VTS_UNKNOWN)

	ON_EVENT(CfrmUc021UketoritegataI, IDC_YOUSHIKIDIAG2, 3, CfrmUc021UketoritegataI::TerminationYoushikidiag1, VTS_I2 VTS_I2 VTS_I2 VTS_UNKNOWN )
	ON_EVENT(CfrmUc021UketoritegataI, IDC_YOUSHIKIDIAG2, 2, CfrmUc021UketoritegataI::EditOFFYoushikidiag1, VTS_I2 )
	ON_EVENT(CfrmUc021UketoritegataI, IDC_YOUSHIKIDIAG2, 1, CfrmUc021UketoritegataI::EditONYoushikidiag1, VTS_I2 )
	ON_EVENT(CfrmUc021UketoritegataI, IDC_YOUSHIKIDIAG2, 12, CfrmUc021UketoritegataI::VScrollYoushikidiag1, VTS_I2)
	ON_EVENT(CfrmUc021UketoritegataI, IDC_YOUSHIKIDIAG2, 8, CfrmUc021UketoritegataI::ComboSelYoushikidiag1, VTS_I2 VTS_UNKNOWN)

	ON_EVENT(CfrmUc021UketoritegataI, IDC_TITLEDIAG1, 3, CfrmUc021UketoritegataI::TerminationTitlediag1, VTS_I2 VTS_I2 VTS_I2 VTS_UNKNOWN )
	ON_EVENT(CfrmUc021UketoritegataI, IDC_TITLEDIAG1, 2, CfrmUc021UketoritegataI::EditOFFTitlediag1, VTS_I2 )
	ON_EVENT(CfrmUc021UketoritegataI, IDC_TITLEDIAG1, 1, CfrmUc021UketoritegataI::EditONTitlediag1, VTS_I2 )
	ON_EVENT(CfrmUc021UketoritegataI, IDC_TITLEDIAG1, 6, CfrmUc021UketoritegataI::FocusTitlediag1, VTS_NONE )

	ON_EVENT(CfrmUc021UketoritegataI, IDC_PAGEDIAG1, 3, CfrmUc021UketoritegataI::TerminationPagediag1, VTS_I2 VTS_I2 VTS_I2 VTS_UNKNOWN )
	ON_EVENT(CfrmUc021UketoritegataI, IDC_PAGEDIAG1, 2, CfrmUc021UketoritegataI::EditOFFPagediag1, VTS_I2 )
	ON_EVENT(CfrmUc021UketoritegataI, IDC_PAGEDIAG1, 1, CfrmUc021UketoritegataI::EditONPagediag1, VTS_I2 )
	ON_EVENT(CfrmUc021UketoritegataI, IDC_PAGEDIAG1, 6, CfrmUc021UketoritegataI::FocusPagediag1, VTS_NONE )
END_EVENTSINK_MAP()

//********************************************************************************
//	初期処理
//********************************************************************************
BOOL	CfrmUc021UketoritegataI::virStartJob()
{
	// 初期値設定
...
//	共通データの初期値設定
//********************************************************************************
void	CfrmUc021UketoritegataI::virSetInitialUchiwakeInfo()
{
	// 「受取手形」の固有データ
	m_uInfo.intOutKeiDialog		= AM_TYPE_ALL;				// 計設定ダイアログのボタン指定
	m_uInfo.intRowMax			= ID_ROWKOBETU_021;			// １頁内の合計行を含む全体の行数
	m_uInfo.intRowMaxData		= ID_ROWKOBETU_021 - 1;		// １頁内のデータ行数（合計行は含まず）
	m_uInfo.intColMax			= ID_COLMAX_021I;			// １行内のコントロール個数
	m_uInfo.intColMaxData		= ID_COLMAXDATA_021I;		// １行内の列数
	m_uInfo.intCtlStartIndex	= ID_CTLSTARTINDEX_021I;	// １行目の入力項目の先頭インデックス番号
	m_uInfo.intT1StartIndex		= ID_T1STARTNORMAL_021I;	// 合計行①の先頭インデックス番号
	m_uInfo.intT2StartIndex		= ID_T2STARTNORMAL_021I;	// 合計行②の入力項目の先頭インデックス番号
	m_uInfo.intCursolDefPos		= ID_COL_021I_KAMOKU;		// カーソル移動時の初期位置（タイトルから↓，合計から↑で使用）
	m_uInfo.intCursolKeiPos		= ID_COL_021I_KAMOKU;		// 合計行のカーソル移動位置（カーソル移動で使用）

	m_uInfo.intFormSeq			= ID_FORMNO_021;			// 様式シーケンス番号
	m_uInfo.intFormNo			= 2;						// 様式番号（uc_inf_sub）
	m_uInfo.intFormNo2			= 1;						// 様式番号枝番（uc_inf_sub）

	m_uInfo.intRowNormal		= ID_ROWNORMAL_021;			// 通常時：１頁内の合計行を含む全体の行数
	m_uInfo.intRowKobetu		= ID_ROWKOBETU_021;			// 個別時：１頁内の合計行を含む全体の行数
	m_uInfo.intT1StartNormal	= ID_T1STARTNORMAL_021I;	// 通常時：合計行①の先頭インデックス
	m_uInfo.intT2StartNormal	= ID_T2STARTNORMAL_021I;	// 通常時：合計行②の先頭インデックス
	m_uInfo.intT1StartKobetu	= ID_T1STARTKOBETU_021I;	// 個別時：合計行①の先頭インデックス
	m_uInfo.intT2StartKobetu	= ID_T2STARTKOBETU_021I;	// 個別時：合計行②の先頭インデックス
	m_uInfo.intRowKei			= ID_ROWKEI_021;			// 帳表固定の合計行数（1:合xxx1計あり，0:なし）
	m_uInfo.intKei1StartIndex	= ID_COL_021I_KEI1_MEISYO;	// 計ダイアグラム1行目の先頭インデックス
	m_uInfo.intKei2StartIndex	= ID_COL_021I_KEI2_MEISYO;	// 計ダイアグラム2行目の先頭インデックス

	// 集計処理の設定
	m_uInfo.uCalcInfo.intMaxCount = ID_CALC_021_MAX;		// 集計フィールド件数
	m_uInfo.uCalcInfo.strField[0] = ID_CALC_021_FIELD1;		// 集計フィールド名称1
}
...
// 【戻値】    なし
//**************************************************
void	CfrmUc021UketoritegataI::virSetInitialDiag()
{
	int		nIndex;
	...
	//	コンボボックスの属性取得
	nIndex = CmnGetControlIndex(1, ID_COL_021I_KAMOKU);
...
//	帳表固有変数の初期値設定
//********************************************************************************
void	CfrmUc021UketoritegataI::virSetInitialValue()
{
	// 1ページ分のローカルバッファをクリア
	RecBufClearAllData();
...
//	帳表コントロールの初期化（データ領域）
//********************************************************************************
BOOL	CfrmUc021UketoritegataI::InitialControlDataArea()
{
	int					intMax;
	int					i;
	...
	for(i=m_uInfo.intCtlStartIndex; i<intMax; i+=m_uInfo.intColMax)	{
		...
		// 振出年月日
		m_pDiag->GetAttribute((i + ID_COL_021I_SPDATE - 1), (LPUNKNOWN)&diaatt);
		diaatt.attr_dayattr = 15;
		m_pDiag->SetAttribute((i + ID_COL_021I_SPDATE - 1), (LPUNKNOWN)&diaatt, TRUE);
		// 支払期日
		m_pDiag->GetAttribute((i + ID_COL_021I_PMDATE - 1), (LPUNKNOWN)&diaatt);
		diaatt.attr_dayattr = 15;
		m_pDiag->SetAttribute((i + ID_COL_021I_PMDATE - 1), (LPUNKNOWN)&diaatt, TRUE);

		// ComboBox：クリア
		CmnDiagSetString(m_pDiag, i + ID_COL_021I_KAMOKU - 1, "", 0);	// 科目
		CmnDiagSetString(m_pDiag, i + ID_COL_021I_INVONOT - 1, "", 0);	// 登録番号(T選択)

		// 漢字入力欄の初期化
		CmnDiagSetAttrInpmax(m_pDiag, i + ID_COL_021I_ADNAME1  - 1, MAX_KETA_021_ADNAME1);		// 振出人
		CmnDiagSetAttrInpmax(m_pDiag, i + ID_COL_021I_SPDATE   - 1, MAX_KETA_021_SPDATE);		// 振出年月日
		CmnDiagSetAttrInpmax(m_pDiag, i + ID_COL_021I_PMDATE   - 1, MAX_KETA_021_PMDATE);		// 支払期日
		CmnDiagSetAttrInpmax(m_pDiag, i + ID_COL_021I_BKNAME1  - 1, MAX_KETA_021_BKNAME1);		// 支払銀行名
		CmnDiagSetAttrInpmax(m_pDiag, i + ID_COL_021I_BKNAME2  - 1, MAX_KETA_021_BKNAME2);		// 支払銀行名(支店名)
		CmnDiagSetAttrInpmax(m_pDiag, i + ID_COL_021I_BK2NAME1 - 1, MAX_KETA_021_BK2NAME1);		// 割引銀行名等
		CmnDiagSetAttrInpmax(m_pDiag, i + ID_COL_021I_BK2NAME2 - 1, MAX_KETA_021_BK2NAME2);		// 割引銀行名等(支店名)
		CmnDiagSetAttrInpmax(m_pDiag, i + ID_COL_021I_TEKI     - 1, MAX_KETA_021_TEKI);			// 摘要

		// 金額欄：桁数初期化
		CmnDiagSetAttrDigit(m_pDiag, i + ID_COL_021I_VAL - 1, ID_VAL_021_K_DATA);	// 金額
	...
	// 半角/全角設定
	CmnDiagSetAttrColZenHan(m_pDiag, ID_COL_021I_ADNAME1);	// 振出人
	CmnDiagSetAttrColZenHan(m_pDiag, ID_COL_021I_SPDATE);	// 振出年月日
	CmnDiagSetAttrColZenHan(m_pDiag, ID_COL_021I_PMDATE);	// 支払期日
	CmnDiagSetAttrColZenHan(m_pDiag, ID_COL_021I_BKNAME1);	// 支払銀行名
	CmnDiagSetAttrColZenHan(m_pDiag, ID_COL_021I_BKNAME2);	// 支払銀行名（支店名）
	CmnDiagSetAttrColZenHan(m_pDiag, ID_COL_021I_BK2NAME1);	// 割引銀行名等
	CmnDiagSetAttrColZenHan(m_pDiag, ID_COL_021I_BK2NAME2);	// 割引銀行名等（支店名）
	CmnDiagSetAttrColZenHan(m_pDiag, ID_COL_021I_TEKI);		// 摘要
...
//********************************************************************************
BOOL	CfrmUc021UketoritegataI::InitialControlComboBox()
{
	// コンボボックスを初期化する関数です。
	...
	for(i=1; i<=intMax; i++)	{
		...
		intIndex = CmnGetControlIndex(i, ID_COL_021I_KAMOKU);		// 科目
		intIndex2 = CmnGetControlIndex(i, ID_COL_021I_INVONOT);		// T選択
...
//********************************************************************************
void	CfrmUc021UketoritegataI::InitialControlTotalArea()
{
	int		nKeiType;			//	計の種別
	int		nDataRow;			//	データ行属性
			...
			if(m_DataKakutei == FALSE) {
				if(IsSpecialRow(m_ReadData[nDataRowPos + 1].m_FgFunc) != 0) {
					...
					if(m_ReadData[nDataRowPos + 1].m_FgFunc == ID_FGFUNC_SYOKEI || m_ReadData[nDataRowPos + 1].m_FgFunc == ID_FGFUNC_CHUKEI || m_ReadData[nDataRowPos + 1].m_FgFunc == ID_FGFUNC_KAMOKU) {
						...
						if(KamokuRowEnableSgn(m_pDB, 0, m_uInfo.intFormSeq) == 1)	{	// 改良No.21-0086,21-0529 add
							flg = 1;
						}
					}
	...
	for(nCnt=0; nCnt<m_uInfo.intColMax; nCnt++)	{
		if((nDataRow & DIAG_MDFY_READONLY) == 0)	{
			...
			if(col == ID_COL_021I_SPDATE || col == ID_COL_021I_PMDATE)	{
	...
	if(flg == 1)	{
		// 科目行、小計行の名称を入力可能にする
		m_pDiag->ModifyItem(CmnGetControlIndex((nDataRowPos + 1), ID_COL_021I_ADNAME1), (DIAG_MDFY_EDIT | DIAG_MDFY_OPAQUE));
		// 入力可能の場合、カーソルポジションの移動は行わないようにする
		if((intIndex == CmnGetControlIndex((nDataRowPos + 1), ID_COL_021I_ADNAME1)))		nSw = 0;
	}
	else if(flg2 == 1)	{
		// 一括自動行の科目を入力可能にする
		m_pDiag->ModifyItem(CmnGetControlIndex((nDataRowPos + 1), ID_COL_021I_KAMOKU), (DIAG_MDFY_EDIT | DIAG_MDFY_OPAQUE));
	}
	...
	m_pDiagKei->ModifyItem(ID_COL_021I_KEI1_VAL, intKeiRow);
	m_pDiagKei->ModifyItem(ID_COL_021I_KEI2_VAL, intKeiRow);
	...
	// 合計行の金額欄は、13桁
	CmnDiagSetAttrDigit(m_pDiagKei, ID_COL_021I_KEI1_VAL, ID_VAL_021_K_TOTAL);
	CmnDiagSetAttrDigit(m_pDiagKei, ID_COL_021I_KEI2_VAL, ID_VAL_021_K_TOTAL);
}
...
//	RET	なし
//********************************************************************************
void	CfrmUc021UketoritegataI::InitialControlSpecialRow(int intRow, int intFgFunc)
{
	...
	switch(intFgFunc)	{
		...
		case ID_FGFUNC_IKKATUAUTO:		// 一括集計金額行（自動）
			// 桁数を設定
			CmnDiagSetAttrDigit(m_pDiag, CmnGetControlIndex(intRow, ID_COL_021I_VAL), ID_VAL_021_K_TOTAL);
			break;
	}
	...
	switch(intFgFunc)	{
		...
		case ID_FGFUNC_KAMOKU:			// 科目行（見出し）
			...
			if(intFgFunc != ID_FGFUNC_IKKATUAUTO)	{
				...
				m_pDiag->ModifyItem(CmnGetControlIndex(intRow, ID_COL_021I_KAMOKU), DIAG_MDFY_NODROPDOWN);
				// 「登録番号(T選択)」はComboBoxのため、DropDown不可とする
				m_pDiag->ModifyItem(CmnGetControlIndex(intRow, ID_COL_021I_INVONOT), DIAG_MDFY_NODROPDOWN);

				// ComboBoxの選択項目クリア
				m_clsFunc.DiagInit(&diadata);
				diadata.text_combo = _T("\r\n");
				m_pDiag->SetData(CmnGetControlIndex(intRow, ID_COL_021I_KAMOKU), (LPUNKNOWN)&diadata);
				m_pDiag->SetData(CmnGetControlIndex(intRow, ID_COL_021I_INVONOT), (LPUNKNOWN)&diadata);
			}
			...
			if(KamokuRowEnableSgn(m_pDB, 1, m_uInfo.intFormSeq) == 1)	{	// 改良No.21-0086,21-0529 add
				...
				if(intFgFunc == ID_FGFUNC_SYOKEI || intFgFunc == ID_FGFUNC_CHUKEI || intFgFunc == ID_FGFUNC_KAMOKU)		{
					//	振出人
					m_pDiag->ModifyItem(CmnGetControlIndex(intRow, ID_COL_021I_ADNAME1), DIAG_MDFY_INPUT);
				}
				// 小計の場合、26文字編集可能にする
				if(intFgFunc == ID_FGFUNC_SYOKEI || intFgFunc == ID_FGFUNC_CHUKEI)	{
					//	振出人
					CmnDiagSetAttrInpmax(m_pDiag, CmnGetControlIndex(intRow, ID_COL_021I_ADNAME1), MAX_KETA_021_SYOKEI);
				}
				// 一括集計金額（自動）行の場合、科目のみ入力可能とする
				if(intFgFunc == ID_FGFUNC_IKKATUAUTO)	{
					//	科目
					m_pDiag->ModifyItem(CmnGetControlIndex(intRow, ID_COL_021I_KAMOKU), DIAG_MDFY_INPUT);
				}
			}
			break;
...
//	帳表タイトル情報の表示
//********************************************************************************
void	CfrmUc021UketoritegataI::virUpdateControlTitle()
{
	DIAGRAM_ATTRIBUTE diaatt;
...
//	帳表ページ情報の表示
//********************************************************************************
void	CfrmUc021UketoritegataI::UpdateControlPage()
{
	BOOL	bBack = TRUE;
	BOOL	bNext = TRUE;
...
//	帳表データの表示（１ページ分）
//********************************************************************************
BOOL	CfrmUc021UketoritegataI::virUpdateControlTblData()
{
	int			sw = 0;
	CString		cst = _T("");
	...
	sw = KamokuRowEnableSgn(m_pDB, 0, m_uInfo.intFormSeq);	// 改良No.21-0086,21-0529 add

	CdbUc021Uketoritegata	dbRec(m_pDB);
	...
	while(!dbRec.IsEOF())	{		// ファイル終端まで
		...
		// 支払銀行名称
		CmnInitialControlFgStringCell(m_pDiag, dbRec.m_NumRow, ID_COL_021I_BKNAME1, dbRec.m_FgFunc, UC_BANK_LEN, dbRec.m_BkName1);
		// 支払銀行支店名
		CmnInitialControlFgStringCell(m_pDiag, dbRec.m_NumRow, ID_COL_021I_BKNAME2, dbRec.m_FgFunc, UC_BANK_LEN, dbRec.m_BkName2);
		// 割引銀行名および支店名等
		// 割引銀行名 + 支店名で判断する
		cst = dbRec.m_Bk2Name1 + dbRec.m_Bk2Name2;
		CmnInitialControlFgStringCell(m_pDiag, dbRec.m_NumRow, ID_COL_021I_BK2NAME1, dbRec.m_FgFunc, (UC_BANK_LEN * 2), cst);
		CmnInitialControlFgStringCell(m_pDiag, dbRec.m_NumRow, ID_COL_021I_BK2NAME2, dbRec.m_FgFunc, (UC_BANK_LEN * 2), cst);
		// 摘要
		CmnInitialControlFgStringCell(m_pDiag, dbRec.m_NumRow, ID_COL_021I_TEKI, dbRec.m_FgFunc, UC_021_TEKI_LEN, dbRec.m_Teki);
	...
	CmnDiagSetAttrEditFormat(m_pDiag, ID_COL_021I_BKNAME1, MAX_KETA_021_BKNAME1, 2, _T("5,5"));		// 支払銀行名
	CmnDiagSetAttrEditFormat(m_pDiag, ID_COL_021I_BKNAME2, MAX_KETA_021_BKNAME2, 2, _T("5,5"));		// 支払銀行支店名
	CmnDiagSetAttrEditFormat(m_pDiag, ID_COL_021I_TEKI, MAX_KETA_021_TEKI, 3, _T("11,11,10"));		// 摘要

	// [計行] 支払銀行支店名を非表示にする
	CmnDiagSetAttrDisableHide(&m_DiagKei1, 5, 2);
	CmnDiagSetAttrDisableHide(&m_DiagKei1, 14, 2);
	CmnDiagSetAttrDisableHide(&m_DiagKei2, 5, 2);
	CmnDiagSetAttrDisableHide(&m_DiagKei2, 14, 2);
	CmnDiagSetAttrDisableHide(&m_DiagKei2, 21, 2);
	CmnDiagSetAttrDisableHide(&m_DiagKei2, 30, 2);
...
//	保管件数の表示
//********************************************************************************
BOOL CfrmUc021UketoritegataI::virUpdateControlTblData2()
{
	int					hcnt = 0;
	CString				cs = _T("");
...
//		IN		CdbUc021Uketoritegata*	「受取手形」
//				int						 1:小計、中計行の名称編集可能
//		RET		なし
// ---------------------------------------------------------------------------------------------------------------
void	CfrmUc021UketoritegataI::UpdateControlRowData(CdbUc021Uketoritegata* prmDbRec, int pSw)
{
	...
	// 読込み対象セル取得
	intCell = CmnGetControlIndex(prmDbRec->m_NumRow, ID_COL_021I_KAMOKU);
	...
	// 割引銀行名等
	diadata.data_edit = prmDbRec->m_Bk2Name1;
	m_pDiag->SetData(intCell, (LPUNKNOWN)&diadata);
	intCell++;

	// 割引銀行名等（支店名）
	diadata.data_edit = prmDbRec->m_Bk2Name2;
	m_pDiag->SetData(intCell, (LPUNKNOWN)&diadata);
	intCell++;
...
//********************************************************************************
//	帳表データの１行表示（累計，頁計行）
//		IN		CdbUc021Uketoritegata*	「受取手形」テーブル情報
//		RET		なし
//********************************************************************************
void	CfrmUc021UketoritegataI::UpdateControlRowTotal(CdbUc021Uketoritegata* prmDbRec)
{
	int		intTotalType;
	...
	// 頁計/累計の名称表示
	if(intRowName > 0)	{
		CmnDiagSetString(m_pDiagKei, CmnGetKeiDiagIndex(intRowName, ID_COL_021I_KEI1_MEISYO), prmDbRec->m_KeiStr, 1);
	}
	// 頁計/累計の金額表示
	if(intRowVal > 0)	{
		CmnDiagSetKingaku(m_pDiagKei, CmnGetKeiDiagIndex(intRowVal, ID_COL_021I_KEI1_VAL), prmDbRec->m_Val);
	}
}
...
//		RET		なし
//********************************************************************************
void	CfrmUc021UketoritegataI::virFncCellCopyProc(CdbUc000Common* rsData)
{
	CdbUc021Uketoritegata*	rs;
	int						intCol;	// 現在の列
	int						ind1,ind2;
	CString					cs1,cs2;

	rs = (CdbUc021Uketoritegata*)rsData;
	...
	switch(intCol)	{
		// 科目
		case ID_COL_021I_KAMOKU:
			CmnDiagSetCombo2(m_pDiag, m_uInfo.intCurCtlIndex, rs->m_KnOrder);
			break;
		// 登録番号（T選択）
		case ID_COL_021I_INVONOT:
		// 登録番号
		case ID_COL_021I_INVONO:
			if(intCol == ID_COL_021I_INVONOT) {
...
//********************************************************************************
int	CfrmUc021UketoritegataI::virFncReferenceGetType(int intCol, int* intGrSeq, long* lngItemSeq, int* intAdd1, int* intAdd2, int* intAdd1Col, int* intAdd2Col, REFERENCE_INFO* pudReference)
{
	int		intRefType;
	...
	switch(intCol)	{
		...
		case ID_COL_021I_BK2NAME2:
			intRefType = ID_DLGTYPE_BANK;
			*intGrSeq = ID_ADDRESSGR_NONE;
			*lngItemSeq = m_ReadData[m_uInfo.intCurRow].m_Bk2Seq;
			break;
...
//		RET		なし
//********************************************************************************
void	CfrmUc021UketoritegataI::virFncReferenceSetData(CdlgReference* dlgRef, int intRefType, int intCol)
{
	CString			cst,cst2;
	CString			str1,str2;
	...
	switch(intRefType)	{
		...
		case ID_DLGTYPE_ADDRESS:
			...
			// 登録番号
			else if(intCol == ID_COL_021I_INVONO)	{
				// 選択内容を表示
				// T
			...
			// 振出人
			else if(intCol == ID_COL_021I_ADNAME1)	{
				// 選択内容を表示
				// T
...
//		RET		なし
//********************************************************************************
void	CfrmUc021UketoritegataI::virFncReferenceUpdateTbl(int intRefType, int nRefMode/*=0*/)
{
...
void CfrmUc021UketoritegataI::virActivateFrame(UINT nState, CFrameWnd* pDeactivateFrame)
{
	int		index = 0;
		...
		if(m_DataKakutei == FALSE)	{
			if(m_uInfo.intCurCol == ID_COL_021I_SPDATE || m_uInfo.intCurCol == ID_COL_021I_PMDATE)	{
				if(m_uInfo.EditSign == 1)	{
					m_uInfo.EditSign = -1;
					m_uInfo.GenListSw = 0;
					if(m_uInfo.intCurCol == ID_COL_021I_SPDATE)	{
						m_uInfo.OldDate[0] = 0;
...
void CfrmUc021UketoritegataI::virActivateFrameK(UINT nState, CFrameWnd* pDeactivateFrame)
{
	int		index = 0;
	CWnd*	pWnd = this->GetFocus();
	...
	if(pWnd != NULL)	{
		if(m_DataKakutei == FALSE)	{
			if(m_uInfo.intCurCol == ID_COL_021I_KAMOKU)	{
				virKamokuAddCancel();
			}
		}
	}
...
void CfrmUc021UketoritegataI::virKamokuAddCancel()
{
	...
	// 科目列なら
	if(m_uInfo.intCurCol == ID_COL_021I_KAMOKU && m_F9OnSw != TRUE)	{
		DIAGRAM_DATA	diadata;
		m_pDiag->GetData(m_uInfo.intCurCtlIndex,(LPUNKNOWN)&diadata);
		// 【新規作成】が選択されていれば
		if(diadata.data_combo > m_CmbCnt)	{
			// 前回の値に戻す
			CmnDiagSetCombo(m_pDiag,CmnGetControlIndex(m_uInfo.intCurRow,ID_COL_021I_KAMOKU),m_uInfo.OldCombo);
		}
	}
}
...
//	その他イベント処理
//********************************************************************************
BOOL	CfrmUc021UketoritegataI::PreTranslateMessage(MSG* pMsg)
{
					...
					if(IsSpecialRow(m_ReadData[m_uInfo.intCurRow].m_FgFunc) == 1) {
						...
						if(KamokuRowEnableSgn(m_pDB, 1, m_uInfo.intFormSeq) == 1)	{	// 改良No.21-0086,21-0529 add
							if((m_ReadData[m_uInfo.intCurRow].m_FgFunc != ID_FGFUNC_SYOKEI && m_ReadData[m_uInfo.intCurRow].m_FgFunc != ID_FGFUNC_CHUKEI && m_ReadData[m_uInfo.intCurRow].m_FgFunc != ID_FGFUNC_KAMOKU) ||
							   (m_ReadData[m_uInfo.intCurRow].m_FgFunc == ID_FGFUNC_SYOKEI && m_uInfo.intCurCol != ID_COL_021I_ADNAME1) ||
							   (m_ReadData[m_uInfo.intCurRow].m_FgFunc == ID_FGFUNC_CHUKEI && m_uInfo.intCurCol != ID_COL_021I_ADNAME1) ||
							   (m_ReadData[m_uInfo.intCurRow].m_FgFunc == ID_FGFUNC_KAMOKU && m_uInfo.intCurCol != ID_COL_021I_ADNAME1)) {
...
// 修正No.168362 add <--
						...
						if(intCol == ID_COL_021I_KAMOKU || intCol == ID_COL_021I_SPDATE || intCol == ID_COL_021I_PMDATE || intCol == ID_COL_021I_INVONOT) {
							rv = 1;
						}
// 修正No.168362 add -->
					} 
// 修正No.168362 add <--
			...
			case VK_RIGHT:
				if(nG_MScroll == 1) {
					...
					intCol = CmnGetControlCol();
					if(intCol == ID_COL_021I_SPDATE || intCol == ID_COL_021I_PMDATE) {
						if(pMsg->wParam == VK_UP || pMsg->wParam == VK_DOWN) {
							if(intCol == ID_COL_021I_SPDATE) {
					...
					else if(intCol == ID_COL_021I_KAMOKU) {
...
// 頁コントロールのフォーカス設定
void	CfrmUc021UketoritegataI::FocusPagediag1()
{
}

// 頁コントロールのゲットフォーカス
void	CfrmUc021UketoritegataI::EditONPagediag1(short index)
{
// 修正No.168443 add -->
	// ---- 登録番号一覧関連 ----->
	if(pZmSel && pZmSel->IsDisplay() != FALSE) {
...
// 頁コントロールのロストフォーカス
void	CfrmUc021UketoritegataI::EditOFFPagediag1(short index)
{
...
// 頁コントロールのキー操作
void	CfrmUc021UketoritegataI::TerminationPagediag1(short index, short nChar, short length, LPUNKNOWN data)
{
	int nMaxDataCol = 0;
	// カレント頁の合計行の種別を取得
	...
	switch(nChar)	{
		...
		case VK_TAB:
			...
			if(CmnCheckShiftKey() == FALSE)	{
				...
				CmnDiagSetFocus(m_pDiag, nMaxDataCol, ID_COL_021I_TEKI);
			}
			break;
		case VK_DOWN:
			// タイトルコントロールへ移動
...
// タイトルコントロールのフォーカス設定
void	CfrmUc021UketoritegataI::FocusTitlediag1()
{
}

// タイトルコントロールのゲットフォーカス
void	CfrmUc021UketoritegataI::EditONTitlediag1(short index)
{
// 修正No.168443 add -->
	// ---- 登録番号一覧関連 ----->
	if(pZmSel && pZmSel->IsDisplay() != FALSE) {
...
// タイトルコントロールのロストフォーカス
void	CfrmUc021UketoritegataI::EditOFFTitlediag1 (short index )
{
	m_Titlefocus = 0;
	virUpdateTitle();
}
...
//	タイトルの更新
void CfrmUc021UketoritegataI::virUpdateTitle()
{
...
// タイトルコントロールのキーイベント
void	CfrmUc021UketoritegataI::TerminationTitlediag1(short index, short nChar, short length, LPUNKNOWN data)
{
	// フォーカス移動
	switch(nChar)	{
		case VK_RETURN:
...
//********************************************************************************
//	「受取手形」データコントロール処理（EditON，EditOFF，Terminationイベント）
//********************************************************************************

// 「受取手形」データコントロールのゲットフォーカス
void	CfrmUc021UketoritegataI::EditONYoushikidiag1(short index)
{
	DIAGRAM_DATA	diadata;
	int				intRet = -1;
	...
	if(m_uInfo.intCurCol == ID_COL_021I_SPDATE || m_uInfo.intCurCol == ID_COL_021I_PMDATE)	m_uInfo.EditSign = 1;
	else																					m_uInfo.EditSign = -1;

	switch(m_uInfo.intCurCol)	{
		case ID_COL_021I_KAMOKU:	// 科目
			// コンボボックスのオフセット値取得
			m_pDiag->GetData(m_uInfo.intCurCtlIndex, (LPUNKNOWN)&diadata);
			if(diadata.data_combo <= m_CmbCnt)	{
		...
		case ID_COL_021I_INVONOT:	// 登録番号(T選択)
			// コンボボックスのオフセット値取得
			m_pDiag->GetData(m_uInfo.intCurCtlIndex, (LPUNKNOWN)&diadata);
			m_uInfo.OldCombo = diadata.data_combo;
			break;

		case ID_COL_021I_SPDATE:	// 振出年月日
	...
	if((m_uInfo.OldRow > 0))	{
		if(m_uInfo.OldPage == m_uInfo.intCurPage && m_uInfo.OldPage > 0)	{
			BOOL isSaveInv = IsSaveMoveReference(ID_COL_021I_INVONOT, ID_COL_021I_INVONO);		// 登録番号(法人番号)
			BOOL isSaveBk1 = IsSaveMoveReference(ID_COL_021I_BKNAME1, ID_COL_021I_BKNAME2);		// 支払銀行名
			BOOL isSaveBk2 = IsSaveMoveReference(ID_COL_021I_BK2NAME1, ID_COL_021I_BK2NAME2);	// 割引銀行名
			//if((isSaveBk1 != FALSE) && (isSaveBk2 != FALSE))	{	// 銀行名→支店名　支店名→銀行名の移動は保存しない
			if((isSaveInv != FALSE) && (isSaveBk1 != FALSE) && (isSaveBk2 != FALSE))	{	// T選択→番号　番号→T選択　銀行名→支店名　支店名→銀行名の移動は保存しない
				// カレント行登録＋再表示
	...
	if(m_uInfo.intCurCol == ID_COL_021I_INVONO && m_EndSyorityu == 0)	{
// 修正No.168377 del -->
...
// 修正No.168377 add -->
		// 登録番号のT選択の値を取得
		int pos = CmnGetControlIndex(m_uInfo.intCurRow, ID_COL_021I_INVONOT);
...
// データコントロールのロストフォーカス
void	CfrmUc021UketoritegataI::EditOFFYoushikidiag1(short index)
{
	if(m_EndView != FALSE)	return;

// 修正No.168443 add -->
	// ---- 登録番号一覧関連 ----->
	if(m_uInfo.intCurCol != ID_COL_021I_INVONO) {
		if(pZmSel && pZmSel->IsDisplay() != FALSE) {
			pZmSel->DialogOFF();
		}
	}
...
// 修正No.168443 del -->
	//// ---- 登録番号一覧関連 ----->
	//if(pZmSel && m_uInfo.intCurCol != ID_COL_021I_INVONO) {
	...
	//		// カーソル移動処理
	//		//CmnDiagSetFocus( m_pDiag, m_uInfo.intCurRow, ID_COL_021I_INVONO );
	//		//PostMessage(WM_USER_FOCUSSET4, m_uInfo.intCurRow, ID_COL_021I_INVONO);
	//	}
	//}
// 修正No.168443 del <--
// 修正No.168443 add -->
...
//	入力確定
void CfrmUc021UketoritegataI::virInputDecisionEditOFF()
{
	// フォーカスフラグOFF
...
// 預貯金データコントロールのキーイベント
void	CfrmUc021UketoritegataI::TerminationYoushikidiag1(short index, short nChar, short length, LPUNKNOWN data)
{
	//--------------------------------------------------------------------------------
	//	キー操作仕様
...
// 改良No.21-0086,21-0529 cor -->
					//if(KamokuRowEnableSgn(m_pDB, 1) == 1 && intCol == ID_COL_021I_ADNAME1) {
// ------------------------------
					if(KamokuRowEnableSgn(m_pDB, 1, m_uInfo.intFormSeq) == 1 && intCol == ID_COL_021I_ADNAME1) {
// 改良No.21-0086,21-0529 cor <--
				...
				default:
					// 項目をクリア（ただしComboBoxはクリアしない）
					//if(intCol != ID_COL_021I_KAMOKU)		{
					if(intCol != ID_COL_021I_KAMOKU && intCol != ID_COL_021I_INVONOT)		{
						m_pDiag->DataClear(m_uInfo.intCurCtlIndex, TRUE);
					}
					...
					else if(intCol == ID_COL_021I_PMDATE)	{
						m_uInfo.OldDate[1] = 0;
						m_uInfo.OldGengo[1] = 0;
					}
...
void CfrmUc021UketoritegataI::VScrollYoushikidiag1(short mode)
{
// 修正No.168430 del -->
...
//********************************************************************************
int	CfrmUc021UketoritegataI::GetFocusPosition(int nChar)
{
	int		intRow;				// カレント行番号
	int		intCol;				// カレント列番号
	...
	// 行をまたぐ場合のインデックス増減数（摘要→次の行の科目）
	// ※背景にある表示の数が項目数とイコールではなくなったため、固定値を入れる
	//intRowChange = m_uInfo.intCtlStartIndex + 1 + 2/*列分割の線の数*/;
	intRowChange = ID_BACKCOLMAX_021I + ID_LINECOLMAX_021I + 1;

	//	計行じゃない？
	if(CmnCheckTotalRow() == FALSE)		{
		// 「種類」と「登録番号(T選択)」はComboBoxのため、「↑，↓」キーではカーソルを移動しない（特殊行は除く）
		//if(intCol == ID_COL_021I_KAMOKU)		{
		if(intCol == ID_COL_021I_KAMOKU || intCol == ID_COL_021I_INVONOT)		{
	...
	else if(intCol == ID_COL_021I_INVONOT)	{
	...
	else if(intCol == ID_COL_021I_BK2NAME1)	{
		// カレント列が「割引銀行名」の場合
	...
	else if(intCol == ID_COL_021I_BK2NAME2)	{
		// カレント列が「割引銀行名(支店名)」の場合
		intVector[0] = m_uInfo.intCurCtlIndex - 1;							// ↑
		intVector[1] = m_uInfo.intCurCtlIndex + 1;							// →
		intVector[2] = m_uInfo.intCurCtlIndex + m_uInfo.intColMax - 1;		// ↓
		intVector[3] = m_uInfo.intCurCtlIndex - 1;							// ←
	}
	else if(intCol == ID_COL_021I_TEKI)	{
		// カレント列が「摘要」の場合
	...
	switch(nChar)	{
		...
		case VK_RETURN:	// Enterキーでカーソルを下に移動するモード対応
			if(m_ReturnMoveDown)	{
				if(intCol == ID_COL_021I_INVONOT)	intNext = intVector[1];		//	カレント列が「登録番号(T表示)」欄の場合「→」キーと同じ
...
//********************************************************************************
int	CfrmUc021UketoritegataI::GetTotalRowIndex(int nCharOrg, int intIndex, int intNext)
{
	...
	//	現在、頁計に居る
		...
		switch(nCharTemp)	{
			case VK_UP:			// ↑：23行目のデータ行の支店名項目へ移動
				nRet = CmnGetControlIndex(nBorder[0], ID_COL_021I_ADNAME1);
				break;

			case VK_LEFT:		// ←/Shift+Tab：23行目のデータ行の摘要項目へ移動
				nRet = CmnGetControlIndex(nBorder[0], ID_COL_021I_TEKI);
				break;
			...
			default:			// →/↓/Return/Tab：25行目の合計行②へ移動
				...
				//	累計あり
					...
					nRet = CmnGetControlIndex((nBorder[2] + 1), ID_COL_021I_ADNAME1);
				}
				break;
		}
	}
	//	現在、累計に居る場合
		...
		switch(nCharTemp)	{
			...
			case VK_LEFT:		// ←/Shift+Tab：24行目の合計行① or 24行目のデータ行の摘要項目へ移動
				nRet = CmnGetControlIndex((nBorder[1] + 1), ID_COL_021I_ADNAME1);
				break;
...
//		RET		なし
//********************************************************************************
void	CfrmUc021UketoritegataI::virTblEditIkkatuLine(int nType, CdbUc000Common* rsData,
...
//		RET		なし
//********************************************************************************
void	CfrmUc021UketoritegataI::virTblEditKamokuLine(CdbUc000Common* rsData, int pPage, int pRow, CString strName)
{
...
//		RET		なし
//********************************************************************************
CString CfrmUc021UketoritegataI::virTblSortGetKamokuName(CdbUc000Common* rsData)
{
	CString					ret = _T("");
	CdbUc021Uketoritegata*	rs = (CdbUc021Uketoritegata*)rsData;
...
//		RET		int					取引先コード
//********************************************************************************
int CfrmUc021UketoritegataI::virTblSortGetTorihikisakiCode(CdbUc000Common* rsData)
{
	int						ret = 0;
	CdbUc021Uketoritegata*	rs = (CdbUc021Uketoritegata*)rsData;
...
//		RET		CString				取引先名称
//********************************************************************************
CString CfrmUc021UketoritegataI::virTblSortGetTorihikisakiName(CdbUc000Common* rsData)
{
	CString					ret = _T("");
...
//		RET		int					取引先コード
//********************************************************************************
int CfrmUc021UketoritegataI::virTblSortGetKamokuCode(CdbUc000Common* rsData)
{
	int						ret = 0;
	CdbUc021Uketoritegata*	rs = (CdbUc021Uketoritegata*)rsData;
...
//********************************************************************************
int	CfrmUc021UketoritegataI::virTblSortSubSortProc(CdlgSort* pCdlgSort, CdbUc000Common* rsData)
{
	CdbUc021Uketoritegata*	rs;
	CString				strFilter;
	CString				strSort;
	...
	// ソート項目の再設定（金融機関）･･･ 現時点ではソートで未使用だが念のため
	CdbUcLstBank	rsBank(m_pDB);
...
/**********************************************************************
	RecBufSetData(CdbUc021Uketoritegata* prmDbRec)
		ローカルのレコードバッファに、1行分のデータを格納する

	引数
		CdbUc021Uketoritegata*	prmDbRec	レコードセット(データがあること）
	戻値
		int		成功/失敗
				FUNCTION_OK
***********************************************************************/
int	CfrmUc021UketoritegataI::RecBufSetData(CdbUc021Uketoritegata* prmDbRec)
{
	...
	m_ReadData[trgRow].m_AdName1		= prmDbRec->m_AdName1;	// 振出人（名称：上段）
	m_ReadData[trgRow].m_AdName2		= prmDbRec->m_AdName2;	// 振出人（名称：下段）
	...
	m_ReadData[trgRow].m_Bk2Seq			= prmDbRec->m_Bk2Seq;	// 金融機関（シーケンス番号）
	m_ReadData[trgRow].m_Bk2Order		= prmDbRec->m_Bk2Order;	// 金融機関（並び順）
	m_ReadData[trgRow].m_Bk2Name1		= prmDbRec->m_Bk2Name1;	// 割引銀行名等（銀行名）
	m_ReadData[trgRow].m_Bk2Name2		= prmDbRec->m_Bk2Name2;	// 割引銀行名等（支店名）
	...
	m_ReadData[trgRow].m_AdKana			= prmDbRec->m_AdKana;	// 振出人
...
/**********************************************************************
	...
	戻値
		int		成功/失敗
				FUNCTION_OK
***********************************************************************/
int	CfrmUc021UketoritegataI::RecBufClearAllData()
{
...
/**********************************************************************
	...
	引数
		P_REC_UC_021_UKETORITEGATE inRecData レコードへのポインタ
	戻値
		int		成功/失敗
				FUNCTION_OK
***********************************************************************/
int	CfrmUc021UketoritegataI::RecBufClearData(P_REC_UC_021_UKETORITEGATE inRecData)
{
	...
	inRecData->m_AdName1		= _T("");	// 振出人（名称：上段）
	inRecData->m_AdName2		= _T("");	// 振出人（名称：下段）
	...
	inRecData->m_Bk2Seq			= 0;		// 金融機関（シーケンス番号）
	inRecData->m_Bk2Order		= 0;		// 金融機関（並び順）
	inRecData->m_Bk2Name1		= _T("");	// 割引銀行名等（銀行名）
	inRecData->m_Bk2Name2		= _T("");	// 割引銀行名等（支店名）
...
/**********************************************************************
	...
	戻値
		int				成功(更新あり)/成功(更新なし)/失敗
						...
						FUNCTION_NG		: 失敗
***********************************************************************/
int	CfrmUc021UketoritegataI::virRecBufSaveData(int inPage, int inRow)
{
	REC_UC_021_UKETORITEGATE	tmpSaveData;		// 画面データ1レコード格納用
	...
	// 科目
	intIndex = CmnGetControlIndex(inRow, ID_COL_021I_KAMOKU);
	...
	// 登録番号（T選択）
	intIndex = CmnGetControlIndex(inRow, ID_COL_021I_INVONOT);
	m_pDiag->GetData(intIndex, (LPUNKNOWN)&diadata);
	tsel = diadata.data_combo;

	// 登録番号（法人番号）
	intIndex = CmnGetControlIndex(inRow, ID_COL_021I_INVONO);
...
// 修正No.168402,168405 add <--
	...
	intIndex = CmnGetControlIndex(inRow, ID_COL_021I_ADNAME1);
	if(m_ReadData[inRow].m_FgFunc == ID_FGFUNC_SYOKEI || m_ReadData[inRow].m_FgFunc == ID_FGFUNC_CHUKEI || m_ReadData[inRow].m_FgFunc == ID_FGFUNC_KAMOKU)	{
		...
		if(tmpSaveData.m_AdName2.IsEmpty())		{
			if(m_uInfo.intCurCol == ID_COL_021I_ADNAME1 && m_uInfo.intCurRow != m_uInfo.OldRow)	{	// 各カラムごとにvirRecBufSaveData()がコールされるようになり、かつタイミングがEditOffからEditOnに移ったことによりCmnDiagSetString()でカレットが末尾から先頭に移ってしまう為、制御
	...
	// 振出年月日
	intIndex = CmnGetControlIndex(inRow, ID_COL_021I_SPDATE);
	...
	// 支払期日
	intIndex = CmnGetControlIndex(inRow, ID_COL_021I_PMDATE);
	...
	// 支払銀行名
	intIndex = CmnGetControlIndex(inRow, ID_COL_021I_BKNAME1);
	tmpSaveData.m_BkName1 = m_clsFunc.DiagGetString(m_pDiag, intIndex);

	// 支払銀行名（支店名）
	intIndex = CmnGetControlIndex(inRow, ID_COL_021I_BKNAME2);
	tmpSaveData.m_BkName2 = m_clsFunc.DiagGetString(m_pDiag, intIndex);

	// 金額
	intIndex = CmnGetControlIndex(inRow, ID_COL_021I_VAL);
	tmpSaveData.m_Val = CmnDiagGetKingaku(m_pDiag, intIndex);

	// 割引銀行名等
	intIndex = CmnGetControlIndex(inRow, ID_COL_021I_BK2NAME1);
	tmpSaveData.m_Bk2Name1 = m_clsFunc.DiagGetString(m_pDiag, intIndex);

	// 割引銀行名等（支店名）
	intIndex = CmnGetControlIndex(inRow, ID_COL_021I_BK2NAME2);
	tmpSaveData.m_Bk2Name2 = m_clsFunc.DiagGetString(m_pDiag, intIndex);

	// 摘要
	intIndex = CmnGetControlIndex(inRow, ID_COL_021I_TEKI);
...
***********************************************************************/
int	CfrmUc021UketoritegataI::virRecBufSaveDataForPasteInsert(int inPage, int inRow)
{
...
***********************************************************************/
int	CfrmUc021UketoritegataI::virRecBufSaveDataForPaste(int inPage, int inRow)
{
	///////////////////////////////////////////////////////////////
	// 登録処理呼び出し
	return RecBufSaveDataSub(inPage, inRow, &m_CopyData);
...
/**********************************************************************
	...
	戻値
			int					成功(更新あり)/成功(更新なし)/失敗
								...
								FUNCTION_NG		: 失敗
***********************************************************************/
int	CfrmUc021UketoritegataI::RecBufSaveDataSub(
	int inPage,
	int inRow,
	P_REC_UC_021_UKETORITEGATE inSaveData)
{
	REC_UC_021_UKETORITEGATE	udtTemp;
	...
	udtTemp.m_BkOrder = 0;
	udtTemp.m_BkSeq = 0;
	udtTemp.m_Bk2Order = 0;
	udtTemp.m_Bk2Seq = 0;
	udtTemp.m_FgFunc = 0;
	udtTemp.m_AdSeq = 0;
	udtTemp.m_AdKana = _T("");	// 振出人
...
//	// 変更があったかのフラグ（変更あり:TRUE、なし:FALSE)
	...
	BOOL	ufgAdName = FALSE;	// 変更確認フラグ(振出人)
	...
	BOOL	ufgBk2 = FALSE;		// 変更確認フラグ(割引銀行名等・支店名)
	...
	// テーブルアクセスクラス
	CdbUc021Uketoritegata	rs(m_pDB);
	...
	// 末尾のスペースをカット
	udtTemp.m_AdName1 = m_clsFunc.DeleteRightSpace(inSaveData->m_AdName1);		// (振出人1)
	// 末尾のスペースをカット
	udtTemp.m_AdName2 = m_clsFunc.DeleteRightSpace(inSaveData->m_AdName2);		// (振出人2)
	...
	// 末尾のスペースをカット
	udtTemp.m_Bk2Name1 = m_clsFunc.DeleteRightSpace(inSaveData->m_Bk2Name1);	// (割引銀行名等)
	// 末尾のスペースをカット
	udtTemp.m_Bk2Name2 = m_clsFunc.DeleteRightSpace(inSaveData->m_Bk2Name2);	// (割引銀行名等（支店名）)
	...
	if(udtTemp.m_FgFunc <= ID_FGFUNC_DATA)	{	// データ行 または、空行なら
		...
		if((udtTemp.m_KnOrder == 0)			// 画面上のデータ格納用(科目)
		   ...
		   && (udtTemp.m_AdName1 == "")		// 画面上のデータ格納用(振出人1)
		   && (udtTemp.m_AdName2 == "")		// 画面上のデータ格納用(振出人2)
		   && (udtTemp.m_SpDate == 0)		// 画面上のデータ格納用(振出年月日)
		   && (udtTemp.m_PmDate == 0)		// 画面上のデータ格納用(支払期日)
		   && (udtTemp.m_BkName1 == "")		// 画面上のデータ格納用(支払銀行名)
		   && (udtTemp.m_BkName2 == "")		// 画面上のデータ格納用(支払銀行名（支店名）)
		   && (udtTemp.m_Val == "")			// 画面上のデータ格納用(金額)
		   && (udtTemp.m_Bk2Name1 == "")	// 画面上のデータ格納用(割引銀行名等)
		   && (udtTemp.m_Bk2Name2 == "")	// 画面上のデータ格納用(割引銀行名等（支店名）)
	...
	// (2)登録番号
	//tno1 = tno2 =_T("");
	//cst = udtTemp.m_InvNo.Left(1);
	//if(strcmp(cst, _T("T")) == 0 || strcmp(cst, _T(" ")) == 0) {
	//	tno1 = udtTemp.m_InvNo.Mid(1, 13);
	//}
	//else	{
	//	tno1 = udtTemp.m_InvNo;
	//}
	//cst = m_ReadData[inRow].m_InvNo.Left(1);
	//if(strcmp(cst, _T("T")) == 0 || strcmp(cst, _T(" ")) == 0) {
	//	tno2 = m_ReadData[inRow].m_InvNo.Mid(1, 13);
	//}
	//else {
	//	tno2 = m_ReadData[inRow].m_InvNo;
	//}
	//if(tno1 != tno2)	{
	...
	// (10) 割引銀行名等
	if(udtTemp.m_Bk2Name1 != m_ReadData[inRow].m_Bk2Name1)	{
		ufgUpData = TRUE;		// 全体(データ行/空行)
		ufgBk2 = TRUE;			// 「割引銀行名等」用
	}

	// (11) 割引銀行名等（支店名）
	if(udtTemp.m_Bk2Name2 != m_ReadData[inRow].m_Bk2Name2)	{
		ufgUpData = TRUE;		// 全体(データ行/空行)
		ufgBk2 = TRUE;			// 「割引銀行名等（支店名）」用
	}
...
// 修正No.168402,168405 add -->
		...
		if((udtTemp.m_FgFunc == ID_FGFUNC_DATA) && (m_InvnoErrFlg == 0 && ufgInvNo == TRUE))	{	// 変更ありの場合	// 修正No.168443 add
			...
			if(m_RegAutoRef)	udtTemp.m_AdSeq = rsAdd.CheckAdSeqEntry_Inv(udtTemp.m_AdSeq, udtTemp.m_AdName1, udtTemp.m_AdName2, "", "", udtTemp.m_InvNo, ID_ADDRESSGR_URI, FALSE, TRUE, 1);
			else				udtTemp.m_AdSeq = rsAdd.GetSeqFromAdName_Inv(ID_ADDRESSGR_URI, udtTemp.m_AdName1, udtTemp.m_AdName2, udtTemp.m_InvNo);
...
// 修正No.168402,168405 add <--
			...
			if(m_RegAutoRef)	udtTemp.m_AdSeq = rsAdd.CheckEntryAddNone_Inv(udtTemp.m_AdName1, udtTemp.m_AdName2, "", "", udtTemp.m_InvNo, ID_ADDRESSGR_URI, FALSE, TRUE);
			else				udtTemp.m_AdSeq = rsAdd.GetSeqFromAdName_Inv(ID_ADDRESSGR_URI, udtTemp.m_AdName1, udtTemp.m_AdName2, udtTemp.m_InvNo);
		...
		// 割引銀行名：金融機関名称リストへの登録チェック
		if((udtTemp.m_FgFunc == ID_FGFUNC_DATA) && (ufgBk2 == TRUE))	{	// 変更ありの場合
			CdbUcLstBank	rsBank(m_pDB);

			if(m_RegAutoRef)	udtTemp.m_Bk2Seq = rsBank.CheckEntry(udtTemp.m_Bk2Name1, udtTemp.m_Bk2Name2);
			else				udtTemp.m_Bk2Seq = rsBank.GetSeqFromBkName(udtTemp.m_Bk2Name1, udtTemp.m_Bk2Name2);

			if(udtTemp.m_Bk2Seq < 0)	{	// エラー
				rsBank.Fin();
				return(FUNCTION_NG);
			}

			if(udtTemp.m_Bk2Seq == 0)	udtTemp.m_Bk2Order = 0;
			else						udtTemp.m_Bk2Order = rsBank.m_OrderNum;
		...
		if(ufgUpData == TRUE)	{		// テーブルへ更新(1レコード更新)
			...
			if(!rs.IsEOF())		{		// レコードが取得できた(取得できないことはないはず)
				...
				// 割引銀行名
				if(ufgBk2 == TRUE)	{		// 変更ありの場合
					rs.m_Bk2Seq = udtTemp.m_Bk2Seq;
					rs.m_Bk2Order = udtTemp.m_Bk2Order;
					rs.m_Bk2Name1 = m_clsFunc.DeleteRightSpace(udtTemp.m_Bk2Name1);
					rs.m_Bk2Name2 = m_clsFunc.DeleteRightSpace(udtTemp.m_Bk2Name2);
					rs.m_Bk2Order = udtTemp.m_Bk2Order;
				}
	...
	// 小計、中計、科目行名称
		...
		if(ufgUpData == TRUE)	{		// テーブルへ更新(1レコード更新)
			...
			if(!rs.IsEOF())		{		// レコードが取得できた(取得できないことはないはず)
				...
				rs.m_AdName1 = _T("");			// 振出人（名称：上段）
				rs.m_AdName2 = _T("");			// 振出人（名称：下段）
				rs.m_SpDate = 0;				// 振出年月日
				rs.m_PmDate = 0;				// 支払期日
				...
				rs.m_Val = _T("");				// 金額
				rs.m_Bk2Seq = 0;				// 金融機関（シーケンス番号）
				rs.m_Bk2Order = 0;				// 金融機関（並び順）
				rs.m_Bk2Name1 = _T("");			// 割引銀行名等（銀行名）
				rs.m_Bk2Name2 = _T("");			// 割引銀行名等（支店名）
				rs.m_Teki = _T("");				// 摘要
				rs.m_KnSeq = 0;					// 科目シーケンス
				rs.m_KnOrder = 0;				// 科目順序
				rs.m_KnName = _T("");			// 科目名
				rs.m_AdKana = _T("");			// 振出人カナ
				rs.m_KnKana = _T("");			// 科目カナ
				rs.m_InvNo = _T("");			// 登録番号
...
//********************************************************************************
CdbUc000Common*	CfrmUc021UketoritegataI::virGetDataTableObject()
{
	// 「受取手形」テーブルのオブジェクトを生成し、ポインタを返す
	return (CdbUc000Common*)(new CdbUc021Uketoritegata(m_pDB));
}
...
//	RET	なし
//********************************************************************************
void	CfrmUc021UketoritegataI::virRowButtonCopyProc()
{
...
//	RET	なし
//********************************************************************************
void	CfrmUc021UketoritegataI::virGetCurrentInfo(CURRENT_INFO* uCurInfo)
{
...
//	【戻値】	なし
//**************************************************
void CfrmUc021UketoritegataI::SetInputMode(int nRow, long nMode)
{
	m_pDiag->ModifyItem(CmnGetControlIndex(nRow, ID_COL_021I_KAMOKU), nMode);	//	科目
	m_pDiag->ModifyItem(CmnGetControlIndex(nRow, ID_COL_021I_INVONOT), nMode);	//	登録番号（T選択）
	m_pDiag->ModifyItem(CmnGetControlIndex(nRow, ID_COL_021I_INVONO), nMode);	//	登録番号
	m_pDiag->ModifyItem(CmnGetControlIndex(nRow, ID_COL_021I_ADNAME1), nMode);	//	振出人
	m_pDiag->ModifyItem(CmnGetControlIndex(nRow, ID_COL_021I_SPDATE), nMode);	//	振出年月日
	m_pDiag->ModifyItem(CmnGetControlIndex(nRow, ID_COL_021I_PMDATE), nMode);	//	支払期日
	m_pDiag->ModifyItem(CmnGetControlIndex(nRow, ID_COL_021I_BKNAME1), nMode);	//	支払銀行名
	m_pDiag->ModifyItem(CmnGetControlIndex(nRow, ID_COL_021I_BKNAME2), nMode);	//	支払支店名
	m_pDiag->ModifyItem(CmnGetControlIndex(nRow, ID_COL_021I_VAL), nMode);		//	金額
	m_pDiag->ModifyItem(CmnGetControlIndex(nRow, ID_COL_021I_BK2NAME1), nMode);	//	割引銀行名
	m_pDiag->ModifyItem(CmnGetControlIndex(nRow, ID_COL_021I_BK2NAME2), nMode);	//	割引支店名
	m_pDiag->ModifyItem(CmnGetControlIndex(nRow, ID_COL_021I_TEKI), nMode);		//	摘要
}
...
//	【戻値】	なし
//**************************************************
void CfrmUc021UketoritegataI::SetDiagBackColor()
{
...
//		RET		なし					
//********************************************************************************
void CfrmUc021UketoritegataI::virRendoCreateData(CdbUc000Common* rsData, RENTEMP_INFO* uRenInfo)
{
	CString			strTemp;
	...
	if(sw != 0)		{
		m_clsFunc.StrDivisionEx(uRenInfo->strAdName, &strArry, (MAX_KETA_021_ADNAME1 / 2), 2);
		if(sw == 1)		{
			//intSeq = rsLstAdd.CheckEntryAddNoneRen(strArry.GetAt(0), strArry.GetAt(1), _T(""), _T(""), uRenInfo->strAdKana, ID_ADDRESSGR_URI, FALSE, TRUE);
			intSeq = rsLstAdd.CheckEntryAddNoneRen_Inv(strArry.GetAt(0), strArry.GetAt(1), _T(""), _T(""), uRenInfo->strAdKana, uRenInfo->strInvNo, ID_ADDRESSGR_URI, FALSE, TRUE);
...
//		RET		なし					
//********************************************************************************
void CfrmUc021UketoritegataI::virRendoUpdateData(CdbUc000Common* rsData, RENTEMP_INFO* uRenInfo)
{
	CdbUc021Uketoritegata*	rs = (CdbUc021Uketoritegata*)rsData;
...
//***************************************************************************
BOOL CfrmUc021UketoritegataI::virEndProc(void)
{
	TRACE(_T("***** CfrmUc021UketoritegataI::virEndProc\n"));
...
// 2012/06/29追加
//********************************************************************************
void CfrmUc021UketoritegataI::virTblGetKamokuInfo( CdbUc000Common* rsData, SORTKAMOKU_INFO* uKamoku )
{
	CdbUc021Uketoritegata*	rs = (CdbUc021Uketoritegata*)rsData;
...
void CfrmUc021UketoritegataI::ComboNew(short index)
{
	short			sv_sel=0;
...
int CfrmUc021UketoritegataI::CursorControl(short nChar, int sw)
{
	int				rv = 0;
	int				intCol = 0;
	int				pos = 0;
	...
	if((nChar == VK_TAB && (key & 0x80) == 0x80) || (nChar == VK_LEFT) || (nChar == VK_RIGHT)) {
		...
		if(intCol == ID_COL_021I_INVONOT)	{	// 登録番号(T選択)
			m_pDiag->ComboDropDown(m_uInfo.intCurCtlIndex, FALSE);
			CmnDiagSetCombo(m_pDiag, m_uInfo.intCurCtlIndex, m_uInfo.OldCombo);
		}
	}
...
void CfrmUc021UketoritegataI::ComboSelYoushikidiag1(short index, LPUNKNOWN data)
{
...
// ------------------------------------------------------------------------------------------------------------------------
void CfrmUc021UketoritegataI::BankCellChg(int nRow, int nCol)
{
	int				sign = 0;
	int				index = 0;
	int				nCharOver = 0;
	...
	if(nCol != ID_COL_021I_BKNAME1 && nCol != ID_COL_021I_BKNAME2)	{
		return;
	}
	// 画面から名称を取得
	...
	if(nCharOver == 0)	{
		...
		if(nCol == ID_COL_021I_BKNAME1)	{
			...
			strSQL2.Format(_T("from uc_021_uketoritegata where FgShow=%d AND NOT(NumPage = %d AND NumRow = %d)) tbl1 "), ID_FGSHOW_OFF, m_ReadData[nRow].m_NumPage, nRow);
	...
	if(nCol == ID_COL_021I_BKNAME1)	{
		//if(nCharOver == 1)	CmnHeadDiagSetTitle(&m_HeadDiag, 5, _T("名    称(11)"), 1);
		//else				CmnHeadDiagSetTitle(&m_HeadDiag, 5, _T("名　　称"), 0);
		if(nCharOver == 1)	CmnHeadDiagSetTitle(&m_HeadDiag, 6, _T("名称(11)"), 1);
		else				CmnHeadDiagSetTitle(&m_HeadDiag, 6, _T("名称"), 0);
	}
	else	{
		//if(nCharOver == 1)	CmnHeadDiagSetTitle(&m_HeadDiag, 6, _T("支  店  名(11)"), 1);
		//else				CmnHeadDiagSetTitle(&m_HeadDiag, 6, _T("支　店　名"), 0);
	...
	// 支払銀行名称
	if(nCol == ID_COL_021I_BKNAME2)	{
		strSQL.Format(_T("select max(oversgn) from (select CASE when len(%s) > %d then 1 else 0 end as oversgn from uc_021_uketoritegata where FgShow=%d) tbl1"),
	...
	// 割引銀行名および支店名等
	strSQL.Format(_T("select max(oversgn) from (select CASE when len(%s) > %d then 1 else 0 end as oversgn from uc_021_uketoritegata where FgShow=%d) tbl1"),
				  MakeReplaceSent2(_T("Bk2Name1"), _T("Bk2Name2")), (UC_BANK_LEN * 2), ID_FGSHOW_OFF);
	rs.Open(CRecordset::forwardOnly, strSQL);
	rs.GetFieldValue((short)0, strData);
	rs.Close();
	nCharOver2[1] = 0;
	...
	// 摘要
	strSQL.Format(_T("select max(oversgn) from (select CASE when len(%s) > %d then 1 else 0 end as oversgn from uc_021_uketoritegata where FgShow=%d) tbl1"),
				  MakeReplaceSent(_T("Teki")), UC_021_TEKI_LEN, ID_FGSHOW_OFF);
	rs.Open(CRecordset::forwardOnly, strSQL);
	rs.GetFieldValue((short)0, strData);
	rs.Close();
	nCharOver2[2] = 0;
...
// ------------------------------------------------------------------------------------------------------------------------
void CfrmUc021UketoritegataI::TitleColorChg(void)
{
	int					nCharOver[4] = {0};	// 電子申告の文字数を超えたかどうかのサイン		1:電子申告の文字数を超えた
											// 様式②	[0]:支払銀行名称(11文字)				[1]:支払銀行支店名(11文字)
											//			[2]:割引銀行名および支店名等(22文字)	[3]:摘要(50文字)
	int					nFontSize=0;		// 「支払先名称、支店名」のフォントサイズ
	CRecordset			rs(m_pDB);
	CString				strSQL = _T("");
	CString				strData = _T("");
	...
	// 項目タイトル(ヘッダ部)の再設定
	//if(nCharOver[0] == 1)	CmnHeadDiagSetTitle(&m_HeadDiag, 5, _T("名    称(11)"), 1);
	//else					CmnHeadDiagSetTitle(&m_HeadDiag, 5, _T("名　　称"), 0);
	if(nCharOver[0] == 1)	CmnHeadDiagSetTitle(&m_HeadDiag, 6, _T("名称(11)"), 1);
	else					CmnHeadDiagSetTitle(&m_HeadDiag, 6, _T("名称"), 0);

	//if(nCharOver[1] == 1)	CmnHeadDiagSetTitle(&m_HeadDiag, 6, _T("支  店  名(11)"), 1);
	//else					CmnHeadDiagSetTitle(&m_HeadDiag, 6, _T("支　店　名"), 0);
	if(nCharOver[1] == 1)	CmnHeadDiagSetTitle(&m_HeadDiag, 7, _T("支店名(11)"), 1);
	else					CmnHeadDiagSetTitle(&m_HeadDiag, 7, _T("支店名"), 0);

	//if(nCharOver[2] == 1)	CmnHeadDiagSetTitle(&m_HeadDiag, 8, _T("割引銀行名\r\n及び支店名等\r\n(22)"), 1);
	//else					CmnHeadDiagSetTitle(&m_HeadDiag, 8, _T("割引銀行名\r\n及び支店名等"), 0);
	if(nCharOver[2] == 1)	CmnHeadDiagSetTitle(&m_HeadDiag, 9, _T("割引銀行名\r\n及び支店名等\r\n(22)"), 1);
	else					CmnHeadDiagSetTitle(&m_HeadDiag, 9, _T("割引銀行名\r\n及び支店名等"), 0);

	//if(nCharOver[3] == 1)	CmnHeadDiagSetTitle(&m_HeadDiag, 9, _T("摘      要(50)"), 1);
	//else					CmnHeadDiagSetTitle(&m_HeadDiag, 9, _T("摘　　　要"), 0);
	if(nCharOver[3] == 1)	CmnHeadDiagSetTitle(&m_HeadDiag, 10, _T("摘      要(50)"), 1);
	else					CmnHeadDiagSetTitle(&m_HeadDiag, 10, _T("摘　　　要"), 0);
	...
	nFontSize = 90;
	try	{
		m_HeadDiag.ChangeFontSize(6, nFontSize);
		m_HeadDiag.ChangeFontSize(7, nFontSize);
	}
	catch(CException* e){
		e->Delete();
	}
...
// --------------------------------------------------------------------------------------------------------
void CfrmUc021UketoritegataI::Date_ChkAndSet(short index, int col, short sign)
{
	short			sv_sel = 0;
	int				sv_index = 0;
	int				day = 0, gen = 0;
	...
	if(m_DataKakutei == TRUE)									return;
	if(col != ID_COL_021I_SPDATE && col != ID_COL_021I_PMDATE)	return;
	...
	if(sign == 1)	{
		if(col == ID_COL_021I_SPDATE)	{		// 振出年月日
		...
		else if(col == ID_COL_021I_PMDATE)	{		// 支払期日
...
// --------------------------------------------------------------------------------------------------------
// --------------------------------------------------------------------------------------------------------
LRESULT CfrmUc021UketoritegataI::OnUserReDrawView(WPARAM wParam, LPARAM lParam)
{
	virUpdateControlTblData();
	CmnDiagSetFocus(m_pDiag, 1, 1);
...
//		RET		なし
// --------------------------------------------------------------------------------------------------------
void CfrmUc021UketoritegataI::virDiagGetHjnData(CDatabase* pDB, HJN_REC_NEW* phjnRec)
{
	int				nPage,nRow;
	int				intIndex;	// 対象行の各インデックス
	int				tsel=0;
	...
	// 登録番号（法人番号）
	cst.Empty();
	intIndex = CmnGetControlIndex(nRow, ID_COL_021I_INVONO);
	...
	// 名称1(氏名)
	intIndex = CmnGetControlIndex(nRow, ID_COL_021I_ADNAME1);
	m_clsFunc.StrDivision(m_clsFunc.DiagGetString(m_pDiag, intIndex), &strArray, 2, FALSE, TRUE);
	cst.Empty();
	...
	if(m_ReadData[nRow].m_AdSeq != 0) {
		...
		if(ret == 0) {
			// 住所（上段）
			memset(buf, 0, sizeof(buf));
			sprintf_s(buf, _T("%s"), rsAdd.m_AdAdd1);
			memcpy(phjnRec->wAdrs1, buf, strlen(buf));

			// 住所（下段）
			memset(buf, 0, sizeof(buf));
			sprintf_s(buf, _T("%s"), rsAdd.m_AdAdd2);
...
//		RET		なし
// --------------------------------------------------------------------------------------------------------
void	CfrmUc021UketoritegataI::virDiagSetHjnData(int pSw, CString rtInvNo, CString rtName, CString rtAdrs1, CString rtAdrs2, CString rtKana)
{
	int					ret = 0;
	int					intIndex;
...
// 修正No.168361,168369,168371,168378 del <--
		// 登録番号（T選択）
		intIndex = CmnGetControlIndex(m_uInfo.intCurRow, ID_COL_021I_INVONOT);
		CmnDiagSetCombo3(m_pDiag, intIndex, strInvoNo);

		// 登録番号
		InvoNoSplit(strInvoNo, &cs1, &cs2);
		intIndex = CmnGetControlIndex(m_uInfo.intCurRow, ID_COL_021I_INVONO);
		...
		//cst = cs1 = cs2 = cs3 = _T("");
		//cs1 = rtName;
		//if(ufc.GetKaigyoCount(cs1) > 0) {
		//	cs1.Replace(PRT_FORMAT_CHCODE, _T(""));
		//}
		//if(cs1.GetLength() > 20) {
		//	cst = cs1;
		//	cs1.Empty();
		//	cs2 = m_clsFunc.GetSpritString(cst, &cs1, 20);
		//	if(cst.GetLength() > 20) {
		//		cst = cs2;
		//		cs2.Empty();
		//		cs3 = m_clsFunc.GetSpritString(cst, &cs2, 20);
		//	}
		//}
		//if(cs2.IsEmpty() == FALSE)		strName = cs1 + _T("\r\n") + cs2;
		//else							strName = cs1;

		//intIndex = CmnGetControlIndex(m_uInfo.intCurRow, ID_COL_021I_ADNAME1);
		//CmnDiagSetString(m_pDiag, intIndex, strName, 0);
...
// 修正No.168361,168369,168371,168378 del <--
	...
	//※今回は法人登録、API情報からのデータ取得は行わないため、その対応が必要になったときに再考する（23/11/28）
	//// 取引先、金融機関を自動で登録する
	//if(m_RegAutoRef && rtKana.IsEmpty() == FALSE) {
	//	// カナを上書き
	//}
}
...
// --------------------------------------------------------------------------------------------------------
// --------------------------------------------------------------------------------------------------------
int CfrmUc021UketoritegataI::virCallChkInvoiceNum(int pSw, int inPage, int inRow)
{
...
//				int			pSw		呼び元　0:法人検索、1:登録番号一覧、2:EditOFF、3,4:virCallChkInvoiceNum
//				int			inPage	頁番号
//				int			inRow	選択行
//				CString		pInvno	登録番号＝””
//	【返送値】	int					-1:登録エラー、0:登録番号入力無し、1:前回と異なる登録番号が入力された
// --------------------------------------------------------------------------------------------------------
int CfrmUc021UketoritegataI::ChkInvoiceNum(CDatabase* pDB, int pSw, int inPage, int inRow,
...
// 修正No.168361,168369,168371,168378 del -->
	...
	//		DIAGRAM_DATA	ddata;
	//		ddata.data_combo = 0;
	//		m_pDiag->SetData(CmnGetControlIndex(inRow, ID_COL_021I_INVONOT), (LPUNKNOWN)&ddata);
	//		ddata.data_edit.Empty();
	//		m_pDiag->DataClear(CmnGetControlIndex(inRow, ID_COL_021I_INVONO), TRUE);
	//		// エラーメッセージを表示
	...
	//		//	ret = rsAdd.GetAddressInf_Inv(ID_ADDRESSGR_URI, invono);
...
// 修正No.168443 add <--
			...
			if(pZmSel && pZmSel->IsDisplay() != FALSE && cst.GetLength() < 3) {
				...
				if(tmpzd.errflg != -1) {
					...
					m_pDiag->SetData(CmnGetControlIndex(inRow, ID_COL_021I_INVONO), (LPUNKNOWN)&ddata);
					// 再描画
					m_pDiag->Refresh();
...
// 修正No.168425,168443 add -->
					if(pSw == 3 || m_EndSyorityu == 1)	{
						...
						//// 登録番号を前に入力していた番号に戻す
						//if(m_ReadData[inRow].m_InvNo.IsEmpty() == FALSE) {
						//	DIAGRAM_DATA	ddata;
						//	cs1 = cs2 = _T("");
						//	InvoNoSplit(m_ReadData[inRow].m_InvNo, &cs1, &cs2);
						//	m_clsFunc.DiagInit(&ddata);
						//	ddata.data_edit.Format(cs2);
						//	m_pDiag->SetData(CmnGetControlIndex(inRow, ID_COL_021I_INVONO), (LPUNKNOWN)&ddata);
						//	m_pDiag->Refresh();
						//}
						//else	{
						...
						m_uInfo.intCurCol = ID_COL_021I_INVONO;
