...
// midori 190301 del <--
// midori 190301 add -->
#define	ID_COLMAX_081K				14		// １行内のコントロール個数
#define	ID_COLMAXDATA_081K			7		// １行内の入力コントロール数
#define	ID_CTLSTARTINDEX_081K		7		// １行目の入力項目の先頭インデックス番号
#define ID_T1STARTNORMAL_081K		322		// 通常時：合計行①の先頭インデックス番号
#define ID_T2STARTNORMAL_081K		336		// 通常時：合計行②の先頭インデックス番号
#define ID_T1STARTKOBETU_081K		322		// 個別時：合計行①の先頭インデックス番号
#define ID_T2STARTKOBETU_081K		336		// 個別時：合計行②の先頭インデックス番号

//	「支払手形」の内訳書_計ダイアグラムの入力インデックス
#define ID_COL_081K_KEI1_MEISYO		0		// 計ダイアログ1行目の計名称（計or合計、頁計、累計）
#define ID_COL_081K_KEI1_VAL		6		// 計ダイアログ1行目の金額
#define ID_COL_081K_KEI2_MEISYO		12		// 計ダイアログ2行目の計名称（計or合計、頁計、累計）
#define ID_COL_081K_KEI2_VAL		18		// 計ダイアログ2行目の金額
// midori 190301 add <--

class CfrmUc081SiharaitegataK: public CfrmUc000Common
{
	DECLARE_DYNCREATE( CfrmUc081SiharaitegataK )

public:
	CfrmUc081SiharaitegataK();
	virtual	~CfrmUc081SiharaitegataK();
