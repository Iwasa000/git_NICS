...
class CfrmUc131UriagedakaK: public CfrmUc000Common
{
	DECLARE_DYNCREATE( CfrmUc131UriagedakaK )

public:
	CfrmUc131UriagedakaK();
	virtual	~CfrmUc131UriagedakaK();
