...
IMPLEMENT_DYNCREATE( CfrmUc181Sonota2, CfrmUc000Common )


BEGIN_MESSAGE_MAP( CfrmUc181Sonota2, CfrmUc000Common )
	ON_WM_SIZE()
...
//	ON_COMMAND( ID_BUTTON_F3, OnButtonF3 )
	...
	ON_COMMAND( ID_PRINTSETUP_MENU, &CfrmUc181Sonota2::OnMenuPrintSetup )
	ON_COMMAND( ID_PRINTALL_MENU, &CfrmUc181Sonota2::OnMenuPrintAll )
//	ON_COMMAND( ID_OUTPUTFORM_MENU, &CfrmUc181Sonota2::OnMenuFormTypeSetup )
	ON_COMMAND( ID_SPECIALROW_MENU, &CfrmUc181Sonota2::OnMenuSpecialRow )
	ON_COMMAND( ID_SORT_MENU, &CfrmUc181Sonota2::OnMenuSort )
	ON_COMMAND(ID_IKKATUADD_MENU, &CfrmUc181Sonota2::OnIkkatuAddMenu)
	ON_COMMAND( ID_DISPDIALOG_MENU, &CfrmUc181Sonota2::OnMenuIkkatuKingaku )
	ON_COMMAND( ID_ZEROMONEY_MENU, &CfrmUc181Sonota2::OnMenuZeroMoney )
	ON_COMMAND( ID_ZEROMONEYMOVE_MENU, &CfrmUc181Sonota2::OnMenuZeroMoneyMove )
	ON_COMMAND( ID_AMOUTDIALOG_MENU, &CfrmUc181Sonota2::OnMenuOutKeiSetup )
// midori 160606 add -->
	ON_COMMAND( ID_CLEAR_MENU, &CfrmUc181Sonota2::OnMenuClear )
// midori 160606 add <--
	ON_COMMAND( ID_RENDO_MENU, &CfrmUc181Sonota2::OnMenuZaimuRendo )
	ON_COMMAND( ID_TITLEMENU, &CfrmUc181Sonota2::OnMenuTitleRestore )
	ON_COMMAND( ID_USER_SETTING_MENU, &CfrmUc181Sonota2::OnMenuOptionSetting )
	ON_COMMAND( ID_COPY_SETTING_INFO_MENU, &CfrmUc181Sonota2::OnMenuCopySettingInfo )
	ON_COMMAND( ID_DELETE_DATA_MENU, &CfrmUc181Sonota2::OnMenuDeleteDataEachYoushiki )
	ON_BN_CLICKED( IDC_PAGEBACK_BUTTON1, &CfrmUc181Sonota2::OnPageBack )
	ON_BN_CLICKED( IDC_PAGENEXT_BUTTON1, &CfrmUc181Sonota2::OnPageNext )
	ON_BN_CLICKED( IDC_PAGENEW_BUTTON1, &CfrmUc181Sonota2::OnPageNew )
	ON_BN_CLICKED( IDC_PAGEINSERT_BUTTON1, &CfrmUc181Sonota2::OnPageInsert )
	ON_BN_CLICKED( IDC_ROWCOPY_BUTTON1, &CfrmUc181Sonota2::OnRowCopy )
	ON_BN_CLICKED( IDC_ROWPASTE_BUTTON1, &CfrmUc181Sonota2::OnRowPaste )
	ON_BN_CLICKED( IDC_ROWINSERT_BUTTON1, &CfrmUc181Sonota2::OnRowInsert )
	ON_BN_CLICKED( IDC_YOUSHIKINEXT_BUTTON1, &CfrmUc181Sonota2::OnMoveYoushikiNext )
	ON_BN_CLICKED( IDC_YOUSHIKIBACK_BUTTON1, &CfrmUc181Sonota2::OnMoveYoushikiBack )
//	ON_UPDATE_COMMAND_UI( ID_BUTTON_F1, &CfrmUc181Sonota2::OnUpdateButtonF1 )
//	ON_UPDATE_COMMAND_UI( ID_BUTTON_F3, &CfrmUc181Sonota2::OnUpdateButtonF3 )
	ON_UPDATE_COMMAND_UI( ID_BUTTON_F6, &CfrmUc181Sonota2::OnUpdateButtonF6 )
	ON_UPDATE_COMMAND_UI( ID_BUTTON_F7, &CfrmUc181Sonota2::OnUpdateButtonF7 )
	ON_UPDATE_COMMAND_UI( ID_BUTTON_F8, &CfrmUc181Sonota2::OnUpdateButtonF8 )
	ON_UPDATE_COMMAND_UI( ID_BUTTON_F9, &CfrmUc181Sonota2::OnUpdateButtonF9 )
	ON_UPDATE_COMMAND_UI( ID_BUTTON_F11, &CfrmUc181Sonota2::OnUpdateButtonF11 )
	ON_UPDATE_COMMAND_UI( ID_BUTTON_F12, &CfrmUc181Sonota2::OnUpdateButtonF12 )
	ON_UPDATE_COMMAND_UI( ID_BUTTON_HOME, &CfrmUc181Sonota2::OnUpdateButtonHome )
	ON_UPDATE_COMMAND_UI( ID_IKKATUADD_MENU, &CfrmUc181Sonota2::OnUpdateIkkatuaddMenu)
	ON_UPDATE_COMMAND_UI( ID_DISPDIALOG_MENU, &CfrmUc181Sonota2::OnUpdateMenuIkkatuKingaku )
// midori 160612 add -->
	ON_UPDATE_COMMAND_UI( ID_SORT_MENU, &CfrmUc181Sonota2::OnUpdateMenuSort )
	ON_UPDATE_COMMAND_UI( ID_CLEAR_MENU, &CfrmUc181Sonota2::OnUpdateMenuClear )
// midori 160612 add <--
	ON_UPDATE_COMMAND_UI( ID_ZEROMONEY_MENU, &CfrmUc181Sonota2::OnUpdateMenuZeroMoney )
// midori 160612 add -->
	ON_UPDATE_COMMAND_UI( ID_ZEROMONEYMOVE_MENU, &CfrmUc181Sonota2::OnUpdateMenuZeroMoneyMove)
// midori 160612 add <--
	ON_UPDATE_COMMAND_UI( ID_RENDO_MENU, &CfrmUc181Sonota2::OnUpdateMenuZaimuRendo )
	ON_UPDATE_COMMAND_UI(ID_SPECIALROW_MENU, &CfrmUc181Sonota2::OnUpdateMenuSpecialRow)
// midori 160612 add -->
	ON_UPDATE_COMMAND_UI( ID_TITLEMENU, &CfrmUc181Sonota2::OnUpdateMenuTitleRestore )
	ON_UPDATE_COMMAND_UI( ID_DELETE_DATA_MENU, &CfrmUc181Sonota2::OnUpdateMenuDeleteDataEachYoushiki )
// midori 160612 add <--
	ON_MESSAGE(WM_USER_REDRAWVIEW, OnUserReDrawView)		// 修正No.162446 add
END_MESSAGE_MAP()


CfrmUc181Sonota2::CfrmUc181Sonota2()
	: CfrmUc000Common( CfrmUc181Sonota2::IDD )
{
...
CfrmUc181Sonota2::~CfrmUc181Sonota2()
{
	...
	TRACE(_T("***** CfrmUc181Sonota2::~CfrmUc181Sonota2\n"));

	//m_pDiag = NULL;
	//m_pTitleDiag = NULL;
}

void CfrmUc181Sonota2::DoDataExchange( CDataExchange* pDX )
{
...
void CfrmUc181Sonota2::OnInitialUpdate()
{
...
#ifdef _DEBUG
void CfrmUc181Sonota2::AssertValid() const
{
	CfrmUc000Common::AssertValid();
}

#ifndef _WIN32_WCE
void CfrmUc181Sonota2::Dump( CDumpContext& dc ) const
{
...
BEGIN_EVENTSINK_MAP( CfrmUc181Sonota2, CfrmUc000Common )
	ON_EVENT( CfrmUc181Sonota2, IDC_YOUSHIKIDIAG1, 3, CfrmUc181Sonota2::TerminationYoushikidiag1, VTS_I2 VTS_I2 VTS_I2 VTS_UNKNOWN )
	ON_EVENT( CfrmUc181Sonota2, IDC_YOUSHIKIDIAG1, 2, CfrmUc181Sonota2::EditOFFYoushikidiag1, VTS_I2 )
	ON_EVENT( CfrmUc181Sonota2, IDC_YOUSHIKIDIAG1, 1, CfrmUc181Sonota2::EditONYoushikidiag1, VTS_I2 )
// midori 151405 add -->
	ON_EVENT(CfrmUc181Sonota2, IDC_YOUSHIKIDIAG1, 12, CfrmUc181Sonota2::VScrollYoushikidiag1, VTS_I2)
// midori 151405 add <--
// midori 152134 add -->
	ON_EVENT(CfrmUc181Sonota2, IDC_YOUSHIKIDIAG1, 8, CfrmUc181Sonota2::ComboSelYoushikidiag1, VTS_I2 VTS_UNKNOWN)
// midori 152134 add <--

	ON_EVENT( CfrmUc181Sonota2, IDC_YOUSHIKIDIAG2, 3, CfrmUc181Sonota2::TerminationYoushikidiag1, VTS_I2 VTS_I2 VTS_I2 VTS_UNKNOWN )
	ON_EVENT( CfrmUc181Sonota2, IDC_YOUSHIKIDIAG2, 2, CfrmUc181Sonota2::EditOFFYoushikidiag1, VTS_I2 )
	ON_EVENT( CfrmUc181Sonota2, IDC_YOUSHIKIDIAG2, 1, CfrmUc181Sonota2::EditONYoushikidiag1, VTS_I2 )
// midori 151405 add -->
	ON_EVENT(CfrmUc181Sonota2, IDC_YOUSHIKIDIAG2, 12, CfrmUc181Sonota2::VScrollYoushikidiag1, VTS_I2)
// midori 151405 add <--
// midori 152134 add -->
	ON_EVENT(CfrmUc181Sonota2, IDC_YOUSHIKIDIAG2, 8, CfrmUc181Sonota2::ComboSelYoushikidiag1, VTS_I2 VTS_UNKNOWN)
// midori 152134 add <--

	ON_EVENT( CfrmUc181Sonota2, IDC_TITLEDIAG1, 3, CfrmUc181Sonota2::TerminationTitlediag1, VTS_I2 VTS_I2 VTS_I2 VTS_UNKNOWN )
	ON_EVENT( CfrmUc181Sonota2, IDC_TITLEDIAG1, 2, CfrmUc181Sonota2::EditOFFTitlediag1, VTS_I2 )
	ON_EVENT( CfrmUc181Sonota2, IDC_TITLEDIAG1, 1, CfrmUc181Sonota2::EditONTitlediag1, VTS_I2 )
	ON_EVENT( CfrmUc181Sonota2, IDC_TITLEDIAG1, 6, CfrmUc181Sonota2::FocusTitlediag1, VTS_NONE )

	ON_EVENT( CfrmUc181Sonota2, IDC_PAGEDIAG1, 3, CfrmUc181Sonota2::TerminationPagediag1, VTS_I2 VTS_I2 VTS_I2 VTS_UNKNOWN )
	ON_EVENT( CfrmUc181Sonota2, IDC_PAGEDIAG1, 2, CfrmUc181Sonota2::EditOFFPagediag1, VTS_I2 )
	ON_EVENT( CfrmUc181Sonota2, IDC_PAGEDIAG1, 1, CfrmUc181Sonota2::EditONPagediag1, VTS_I2 )
	ON_EVENT( CfrmUc181Sonota2, IDC_PAGEDIAG1, 6, CfrmUc181Sonota2::FocusPagediag1, VTS_NONE )

	ON_EVENT(CfrmUc181Sonota2, IDC_TOPICDIAG1, 3, CfrmUc181Sonota2::TerminationTopicdiag1, VTS_I2 VTS_I2 VTS_I2 VTS_UNKNOWN)
	ON_EVENT(CfrmUc181Sonota2, IDC_TOPICDIAG1, 2, CfrmUc181Sonota2::EditOFFTopicdiag1, VTS_I2)
	ON_EVENT(CfrmUc181Sonota2, IDC_TOPICDIAG1, 1, CfrmUc181Sonota2::EditONTopicdiag1, VTS_I2)
	ON_EVENT(CfrmUc181Sonota2, IDC_TOPICDIAG1, 6, CfrmUc181Sonota2::FocusTopicdiag1, VTS_NONE)
END_EVENTSINK_MAP()

//********************************************************************************
//	初期処理
//********************************************************************************
BOOL	CfrmUc181Sonota2::virStartJob()
{
	// 初期値設定
...
//	共通データの初期値設定
//********************************************************************************
void	CfrmUc181Sonota2::virSetInitialUchiwakeInfo()
{
	// 「その他2」の固有データ
	m_uInfo.intOutKeiDialog = AM_TYPE_ALL;			// 計設定ダイアログのボタン指定
	m_uInfo.intRowMax = ID_ROWKOBETU_181;			// １頁内の合計行を含む全体の行数
	m_uInfo.intRowMaxData = ID_ROWKOBETU_181 - 1;	// １頁内のデータ行数（合計行は含まず）
	m_uInfo.intColMax = ID_COLMAX_181;				// １行内のコントロール個数
	m_uInfo.intColMaxData = ID_COLMAXDATA_181;		// １行内の列数
	m_uInfo.intCtlStartIndex = ID_CTLSTARTINDEX_181;// １行目の入力項目の先頭インデックス番号
	m_uInfo.intT1StartIndex = ID_T1STARTNORMAL_181;	// 合計行①の先頭インデックス番号
	m_uInfo.intT2StartIndex = ID_T2STARTNORMAL_181;	// 合計行②の入力項目の先頭インデックス番号
	m_uInfo.intCursolDefPos = ID_COL_181_ITEM;		// カーソル移動時の初期位置（タイトルから↓，合計から↑で使用）
	m_uInfo.intCursolKeiPos = ID_COL_181_KNORDER;	// 合計行のカーソル移動位置（カーソル移動で使用）

/*	「FormSeq」は「CmnSetInitialUchiwakeInfo」で読み込むのでここでは設定しない。
	m_uInfo.intFormSeq = ID_FORMNO_181;				// 様式シーケンス番号
*/
	m_uInfo.intFormNo = 18;							// 様式番号（uc_inf_sub）
	m_uInfo.intFormNo2 = 1;							// 様式番号枝番（uc_inf_sub）

	m_uInfo.intRowNormal = ID_ROWNORMAL_181;		// 通常時：１頁内の合計行を含む全体の行数
	m_uInfo.intRowKobetu = ID_ROWKOBETU_181;		// 個別時：１頁内の合計行を含む全体の行数
	m_uInfo.intT1StartNormal = ID_T1STARTNORMAL_181;	// 通常時：合計行①の先頭インデックス
	m_uInfo.intT2StartNormal = ID_T2STARTNORMAL_181;	// 通常時：合計行②の先頭インデックス
	m_uInfo.intT1StartKobetu = ID_T1STARTKOBETU_181;	// 個別時：合計行①の先頭インデックス
	m_uInfo.intT2StartKobetu = ID_T2STARTKOBETU_181;	// 個別時：合計行②の先頭インデックス
	m_uInfo.intRowKei = ID_ROWKEI_181;				// 帳表固定の合計行数（1:合計あり，0:なし）
	m_uInfo.intKei1StartIndex = ID_COL_181_KEI1_MEISYO;	// 計ダイアグラム1行目の先頭インデックス
	m_uInfo.intKei2StartIndex = ID_COL_181_KEI2_MEISYO;	// 計ダイアグラム2行目の先頭インデックス

	// 集計処理の設定
	m_uInfo.uCalcInfo.intMaxCount = ID_CALC_181_MAX;		// 集計フィールド件数
	m_uInfo.uCalcInfo.strField[0] = ID_CALC_181_FIELD1;		// 集計フィールド名称1
}
...
// 【戻値】    なし
//**************************************************
void	CfrmUc181Sonota2::virSetInitialDiag()
{
	int     nIndex;
	...
	// コンボボックスの属性取得
	nIndex = CmnGetControlIndex( 1, ID_COL_181_KNORDER );
...
//	帳表固有変数の初期値設定
//********************************************************************************
void	CfrmUc181Sonota2::virSetInitialValue()
{
	// 1ページ分のローカルバッファをクリア
	RecBufClearAllData();
...
//	帳表コントロールの初期化（データ領域）
//********************************************************************************
BOOL	CfrmUc181Sonota2::InitialControlDataArea()
{
	int		intMax;
	int		i;
// No.200903 add -->
...
// No.200903 add <--
	...
	for ( i = m_uInfo.intCtlStartIndex; i < intMax; i += m_uInfo.intColMax ) {
		// ComboBox：クリア
		CmnDiagSetString( m_pDiag, i + ID_COL_181_KNORDER - 1, "", 0 );	// 科目
		
		// 漢字入力欄の初期化
		CmnDiagSetAttrInpmax( m_pDiag, i + ID_COL_181_ITEM    - 1, MAX_KETA_181_ITEM );				//	項目
		CmnDiagSetAttrInpmax( m_pDiag, i + ID_COL_181_TEKI    - 1, MAX_KETA_181_TEKI );				//	摘要

		// 金額欄：桁数初期化
// No.200903 del -->
		//CmnDiagSetAttrDigit( m_pDiag, i + ID_COL_181_VAL - 1, ID_VAL_181_DATA );	// 金額
// No.200903 del <--
// No.200903 add -->
		if(bG_Kanso == TRUE)	len = ID_VAL_181_K_DATA;
		else					len = ID_VAL_181_DATA;
		CmnDiagSetAttrDigit( m_pDiag, i + ID_COL_181_VAL - 1, len );	// 金額
// No.200903 add <--
	...
	// 半角/全角設定
	CmnDiagSetAttrColZenHan( m_pDiag , ID_COL_181_ITEM );		// 内訳（摘要）
	CmnDiagSetAttrColZenHan( m_pDiag , ID_COL_181_TEKI );		// 備考
...
//********************************************************************************
BOOL	CfrmUc181Sonota2::InitialControlComboBox()
{
	...
	for ( i = 1; i <= intMax; i++ ) {
		...
		intIndex = CmnGetControlIndex( i, ID_COL_181_KNORDER );
...
//********************************************************************************
void	CfrmUc181Sonota2::InitialControlTotalArea()
{
	int		nKeiType;			//	計の種別
	int		nDataRow;			//	データ行属性
...
// 修正No.157898 add -->
	if(flg2 == 1)	{
		// 一括自動行の科目を入力可能にする
		m_pDiag->ModifyItem( CmnGetControlIndex( (nDataRowPos+1), ID_COL_181_KNORDER ), (DIAG_MDFY_EDIT | DIAG_MDFY_OPAQUE) );
	}
// 修正No.157898 add <--
...
// midori 152166 add <--
	...
	m_pDiagKei->ModifyItem(ID_COL_181_KEI1_VAL, intKeiRow);
	m_pDiagKei->ModifyItem(ID_COL_181_KEI2_VAL, intKeiRow);
	//// 28行目の合計行①
	//nStart = m_uInfo.intT1StartIndex;
	//for ( nCnt = 0; nCnt < m_uInfo.intColMax; nCnt++ ){
	//	m_pDiag->ModifyItem( nStart + nCnt, nKeiRow[0] );
	...
	//m_pDiag->ModifyItem( CmnGetControlTotalIndex( 1, ID_COL_181_KNORDER ), nKeiRow[0] );
	//m_pDiag->ModifyItem( CmnGetControlTotalIndex( 2, ID_COL_181_KNORDER ), nKeiRow[1] );
	
// No.200903 del -->
	//// 合計行の金額欄は、金額欄 + 1桁
	//CmnDiagSetAttrDigit( m_pDiagKei, ID_COL_181_KEI1_VAL, ID_VAL_181_TOTAL );
	//CmnDiagSetAttrDigit( m_pDiagKei, ID_COL_181_KEI2_VAL, ID_VAL_181_TOTAL );
	////CmnDiagSetAttrDigit( m_pDiag, CmnGetControlTotalIndex( 1, ID_COL_181_VAL ), ID_VAL_181_TOTAL );
	////CmnDiagSetAttrDigit( m_pDiag, CmnGetControlTotalIndex( 2, ID_COL_181_VAL ), ID_VAL_181_TOTAL );
// No.200903 del <--
}
...
//	RET	なし
//********************************************************************************
void	CfrmUc181Sonota2::InitialControlSpecialRow( int intRow, int intFgFunc )
{
// No.200903 add -->
	int				len=0;
// No.200903 add <--
	...
	case ID_FGFUNC_IKKATUAUTO:		// 一括集計金額行（自動）
		// 桁数を設定
// No.200903 del -->
		//CmnDiagSetAttrDigit( m_pDiag, CmnGetControlIndex( intRow , ID_COL_181_VAL ), ID_VAL_181_TOTAL );
// No.200903 del <--
// No.200903 add -->
		if(bG_Kanso == TRUE)	len = ID_VAL_181_K_TOTAL;
		else					len = ID_VAL_181_TOTAL;
		CmnDiagSetAttrDigit( m_pDiag, CmnGetControlIndex( intRow , ID_COL_181_VAL ), len );
// No.200903 add <--
		break;
	}
	...
	case ID_FGFUNC_IKKATUAUTO:		// 一括集計金額行（自動）
		...
		if ( intFgFunc != ID_FGFUNC_IKKATUAUTO ) {
			...
			m_pDiag->ModifyItem( CmnGetControlIndex( intRow, ID_COL_181_KNORDER ), DIAG_MDFY_NODROPDOWN );

			// ComboBoxの選択項目クリア
			m_clsFunc.DiagInit( &diadata );
			diadata.text_combo = _T( "\r\n" );
			m_pDiag->SetData( CmnGetControlIndex( intRow, ID_COL_181_KNORDER ), (LPUNKNOWN)&diadata );
		}
...
// 改良No.21-0086,21-0529 cor <--
			...
			if (intFgFunc == ID_FGFUNC_IKKATUAUTO ){
				//	科目
				m_pDiag->ModifyItem( CmnGetControlIndex( intRow, ID_COL_181_KNORDER ), DIAG_MDFY_INPUT );
			}
		}
// No.200905 add <--
...
//	帳表タイトル情報の表示
//********************************************************************************
void	CfrmUc181Sonota2::virUpdateControlTitle()
{
//	int		intMax;
...
//	帳表ページ情報の表示
//********************************************************************************
void	CfrmUc181Sonota2::UpdateControlPage()
{
	BOOL	bBack = TRUE;
	BOOL	bNext = TRUE;
...
//	帳表データの表示（１ページ分）
//********************************************************************************
BOOL	CfrmUc181Sonota2::virUpdateControlTblData()
{
// No.200903 add -->
	int len = 0;
// No.200903 add <--
	...
	CdbUc181Sonota2	dbRec( m_pDB, m_uInfo.intFormSeq );
...
// No.200903 add -->
	...
	CmnDiagSetAttrDigit( m_pDiagKei, ID_COL_181_KEI1_VAL, len );
	CmnDiagSetAttrDigit( m_pDiagKei, ID_COL_181_KEI2_VAL, len );
// No.200903 add <--
...
// midori M-17082101 add -->
	if(m_DataKakutei == FALSE)	{
		m_HeadDiag.ModifyItem(4, (DIAG_MDFY_EDIT | DIAG_MDFY_OPAQUE));
	}
	else{
		m_HeadDiag.ModifyItem(4, (DIAG_MDFY_READONLY | DIAG_MDFY_OPAQUE));
	}
// midori M-17082101 add <--
...
//	保管件数の表示
//********************************************************************************
BOOL CfrmUc181Sonota2::virUpdateControlTblData2()
{
	int					hcnt=0;
	CString				cs=_T("");
...
//		IN		CdbUc181Sonota2*	「その他2」
//		RET		なし
//********************************************************************************
void	CfrmUc181Sonota2::UpdateControlRowData( CdbUc181Sonota2* prmDbRec ) {
	DIAGRAM_DATA	diadata;	// ICSDiag構造体
	int				intCell;	// 保存フィールド
	...
	// 読込み対象セル取得
	intCell = CmnGetControlIndex( prmDbRec->m_NumRow, ID_COL_181_KNORDER );
...
// midori 152137 add <--
	...
	case ID_FGFUNC_IKKATUAUTO:
	//------------------------------
		diadata.data_edit = prmDbRec->m_Item;
		break;
	default:
...
//********************************************************************************
//	帳表データの１行表示（累計，頁計行）
//		IN		CdbUc181Sonota2*	「その他2」テーブル情報
//		RET		なし
//********************************************************************************
void	CfrmUc181Sonota2::UpdateControlRowTotal( CdbUc181Sonota2* prmDbRec )
{
	int		intTotalType;
...
// 修正No.157629 add <--
	...
	// 頁計/累計の名称表示
	if ( intRowName > 0 ) {
		//CmnDiagSetString( m_pDiag, CmnGetControlTotalIndex( intRowName, ID_COL_181_KNORDER ), prmDbRec->m_KeiStr, 0 );
		CmnDiagSetString( m_pDiagKei, CmnGetKeiDiagIndex( intRowName, ID_COL_181_KEI1_MEISYO ), prmDbRec->m_KeiStr, 1 );
	}
	// 頁計/累計の金額表示
	if ( intRowVal > 0 ) {
		//CmnDiagSetKingaku( m_pDiag, CmnGetControlTotalIndex( intRowName, ID_COL_181_VAL ), prmDbRec->m_Val );
		CmnDiagSetKingaku( m_pDiagKei, CmnGetKeiDiagIndex( intRowVal, ID_COL_181_KEI1_VAL ), prmDbRec->m_Val );
	}
}
...
//		RET		なし
//********************************************************************************
void	CfrmUc181Sonota2::virFncCellCopyProc( CdbUc000Common* rsData )
{
	CdbUc181Sonota2*	rs;
	int					intCol;	// 現在の列

	rs = (CdbUc181Sonota2*)rsData;
...
// midori 152137 add <--
		break;
	// 内訳（摘要）
	case ID_COL_181_ITEM:
		CmnDiagSetString( m_pDiag, m_uInfo.intCurCtlIndex, rs->m_Item, 0 );
		break;
	// 金額
	case ID_COL_181_VAL:
...
//********************************************************************************
int	CfrmUc181Sonota2::virFncReferenceGetType(int intCol, int* intGrSeq, long* lngItemSeq, int* intAdd1, int* intAdd2, int* intAdd1Col, int* intAdd2Col, REFERENCE_INFO* pudReference)
{
	int				intRefType;
...
//		RET		なし
//********************************************************************************
void	CfrmUc181Sonota2::virFncReferenceSetData( CdlgReference* dlgRef, int intRefType, int intCol )
{
	switch (intRefType) {
...
//		RET		なし
//********************************************************************************
void	CfrmUc181Sonota2::virFncReferenceUpdateTbl( int intRefType, int nRefMode/*=0*/ )
{
	switch (intRefType) {
...
void CfrmUc181Sonota2::virActivateFrameK(UINT nState, CFrameWnd* pDeactivateFrame)
{
	int		index = 0;
	...
	if(pWnd != NULL)	{
		if(m_DataKakutei == FALSE)	{
			if(m_uInfo.intCurCol == ID_COL_181_KNORDER)	{
				virKamokuAddCancel();
			}
		}
	}
...
void CfrmUc181Sonota2::virKamokuAddCancel()
{
	...
	// 科目列なら
	if(m_uInfo.intCurCol == ID_COL_181_KNORDER && m_F9OnSw != TRUE)	{
		DIAGRAM_DATA	diadata;
		m_pDiag->GetData(m_uInfo.intCurCtlIndex,(LPUNKNOWN)&diadata);
		// 【新規作成】が選択されていれば
		if(diadata.data_combo > m_CmbCnt)	{
			// 前回の値に戻す
			CmnDiagSetCombo(m_pDiag,CmnGetControlIndex(m_uInfo.intCurRow,ID_COL_181_KNORDER),m_uInfo.OldCombo);
		}
	}
}
// 要通知案件修正 21/07/09 add <--
...
//	その他イベント処理
//********************************************************************************
BOOL	CfrmUc181Sonota2::PreTranslateMessage( MSG* pMsg )
{
//	int				intID;
...
//				if ((CmnGetControlCol() != ID_COL_181_KNORDER) || (CmnCheckTotalRow() == TRUE )){
// midori 160611 del <--
				// カレントインデックスを保存
...
//				//}
//// ---------------------
//				if(CmnGetControlCol() == ID_COL_181_KNORDER)	{
//					rv=1;
//				}
//// midori 160611 cor <--
// midori 152134 17/10/07 del <--
...
/*
		...
		case VK_TAB:
			...
			if ((intID == IDC_PAGEBACK_BUTTON1) && (CmnCheckShiftKey() == TRUE)) {
				...
				CmnDiagSetFocus(m_pDiag, m_uInfo.intRowMax, ID_COL_181_KNORDER);
				return 1;
			}
			break;
*/
...
// 修正No.158259 add -->
				...
				intCol = CmnGetControlCol();
				if(intCol == ID_COL_181_KNORDER && (pMsg->wParam == VK_LEFT || pMsg->wParam == VK_RIGHT))	{
...
// 頁コントロールのフォーカス設定
void	CfrmUc181Sonota2::FocusPagediag1()
{
...
// 頁コントロールのゲットフォーカス
void	CfrmUc181Sonota2::EditONPagediag1( short index )
{
// midori 151405 add -->
	// スクロールフラグをクリアする
	nG_MScroll = 0;
...
// midori 151405 add <--
	...
	// 1行登録
//	if( CmnGetControlCol() != ID_COL_181_VAL ){
...
// 頁コントロールのロストフォーカス
void	CfrmUc181Sonota2::EditOFFPagediag1( short index )
{
// midori 155028 add -->
...
// 頁コントロールのキー操作
void	CfrmUc181Sonota2::TerminationPagediag1( short index, short nChar, short length, LPUNKNOWN data )
{
	int nMaxDataCol = 0;
	// カレント頁の合計行の種別を取得
...
// midori 160612 cor <--
			...
			//CmnDiagSetFocus(m_pDiag, m_uInfo.intRowMax, ID_COL_181_KNORDER);
			CmnDiagSetFocus(m_pDiag, nMaxDataCol, ID_COL_181_TEKI);
		}
		break;
	case VK_DOWN:
		// タイトルコントロールへ移動
...
// タイトルコントロールのフォーカス設定
void	CfrmUc181Sonota2::FocusTitlediag1()
{
//マウスクリックでキャレットが表示できないためコメントとする
//	// ボタンからTabキー移動した場合に必要
//	m_TitleDiag.SetPosition( 0 );
...
// タイトルコントロールのゲットフォーカス
void	CfrmUc181Sonota2::EditONTitlediag1( short index )
{
// midori 151405 add -->
	// スクロールフラグをクリアする
	nG_MScroll = 0;
...
// タイトルコントロールのロストフォーカス
void	CfrmUc181Sonota2::EditOFFTitlediag1 (short index )
{
// midori 151405 add -->
	m_Titlefocus = 0;
// midori 151405 add <--
...
//	タイトル更新
void CfrmUc181Sonota2::virUpdateTitle()
{
...
// タイトルコントロールのキーイベント
void	CfrmUc181Sonota2::TerminationTitlediag1( short index, short nChar, short length, LPUNKNOWN data )
{
	// フォーカス移動
	switch ( nChar ) {
	case VK_RETURN:
		m_HeadDiag.SetPosition( 4 ) ;
		break;
	case VK_TAB:
		// Shiftキーの有無は？
		if ( CmnCheckShiftKey() == FALSE ) {
...
//********************************************************************************
//	「その他2」データコントロール処理（EditON，EditOFF，Terminationイベント）
//********************************************************************************

// 「その他2」データコントロールのゲットフォーカス
void	CfrmUc181Sonota2::EditONYoushikidiag1( short index )
{
	DIAGRAM_DATA	diadata;
...
// データコントロールのロストフォーカス
void	CfrmUc181Sonota2::EditOFFYoushikidiag1( short index )
{
	if( m_EndView != FALSE )	return;
...
//	入力確定
void CfrmUc181Sonota2::virInputDecisionEditOFF()
{
	// フォーカスフラグOFF
...
// 預貯金データコントロールのキーイベント
void	CfrmUc181Sonota2::TerminationYoushikidiag1( short index, short nChar, short length, LPUNKNOWN data )
{
	//--------------------------------------------------------------------------------
	//	キー操作仕様
...
// midori 151405 add -->
void CfrmUc181Sonota2::VScrollYoushikidiag1(short mode)
{
	if(mode == 8 && m_DataKakutei == FALSE && m_Pagefocus == 0 && m_Titlefocus == 0 && m_Headfocus == 0)	{
// midori UC_0002 add -->
		virInputDecisionEditOFF();
// midori UC_0002 add <--
		nG_MScroll=1;
...
//********************************************************************************
int	CfrmUc181Sonota2::GetFocusPosition( int nChar )
{
	int		intRow;					// カレント行番号
	int		intCol;					// カレント列番号
	...
	else if ( intCol == ID_COL_181_TEKI ){
		// カレント列が「摘要」の場合
	...
	case VK_TAB:
		if (CmnCheckShiftKey() == FALSE) {
			...
			// それ以外は「←」キーと同じ
			if ((intRow <= 1) && (intCol == ID_COL_181_KNORDER)) {
				return -1;
			}
...
//********************************************************************************
int	CfrmUc181Sonota2::GetTotalRowIndex( int nCharOrg, int intIndex, int intNext )
{
	...
	if ( nNowRow <= nBorder[0] ){
		...
		if ( nNextRow > nBorder[0] ){
			//	計行に移動
			//nRet = CmnGetControlIndex( ( nBorder[1] + 1 ), ID_COL_181_KNORDER );
			if (nCharOrg == VK_TAB) {
				return -2;
			}
		}
	...
	//	現在、頁計に居る
		...
		case VK_UP:			// ↑：23行目のデータ行の支店名項目へ移動
			nRet = CmnGetControlIndex( nBorder[0], ID_COL_181_ITEM );
			break;
		case VK_LEFT:		// ←/Shift+Tab：23行目のデータ行の摘要項目へ移動
			nRet = CmnGetControlIndex( nBorder[0], ID_COL_181_TEKI );
			break;
		default:			// →/↓/Return/Tab：25行目の合計行②へ移動
			...
			//	累計あり
				...
				nRet = CmnGetControlIndex( ( nBorder[2] + 1 ), ID_COL_181_KNORDER );
			}
			break;
		}
	}
...
//		RET		なし
//********************************************************************************
void	CfrmUc181Sonota2::virTblEditIkkatuLine( int nType, CdbUc000Common* rsData,
									CString strName, CALCKEI_INFO uCalcKei, SORTKAMOKU_INFO uKamoku )
{
	CdbUc181Sonota2*	mfcRec = (CdbUc181Sonota2*)rsData;

	switch (nType) {
	case	0:
		// ソートの一括集計処理 ･･･ 科目の無い帳表はいらない
		mfcRec->m_Item = strName;					// 名称：項目
...
//********************************************************************************
int	CfrmUc181Sonota2::virTblSortSubSortProc( CdlgSort* pCdlgSort, CdbUc000Common* rsData )
{
	CdbUc181Sonota2*	rs;
	CString				strFilter;
	CString				strSort;
...
/**********************************************************************
	RecBufSetData(CdbUc181Sonota2* prmDbRec)
		ローカルのレコードバッファに、1行分のデータを格納する

	引数
		CdbUc181Sonota2*	prmDbRec	レコードセット(データがあること）
	戻値
		int		成功/失敗
				FUNCTION_OK
***********************************************************************/
int	CfrmUc181Sonota2::RecBufSetData( CdbUc181Sonota2* prmDbRec )
{
	...
	m_ReadData[trgRow].m_Item = prmDbRec->m_Item;	// 項目
...
/**********************************************************************
	...
	戻値
		int		成功/失敗
				FUNCTION_OK
***********************************************************************/
int	CfrmUc181Sonota2::RecBufClearAllData()
{
...
/**********************************************************************
	...
	引数
		P_REC_UC_181_SONOTA2 inRecData レコードへのポインタ
	戻値
		int		成功/失敗
				FUNCTION_OK
***********************************************************************/
int	CfrmUc181Sonota2::RecBufClearData( P_REC_UC_181_SONOTA2 inRecData )
{
...
/**********************************************************************
	...
	戻値
		int				成功(更新あり)/成功(更新なし)/失敗
						...
						FUNCTION_NG		: 失敗
***********************************************************************/
int	CfrmUc181Sonota2::virRecBufSaveData( int inPage, int inRow )
{
	REC_UC_181_SONOTA2	tmpSaveData;	// 画面データ1レコード格納用
	...
	// 科目
	intIndex = CmnGetControlIndex( inRow, ID_COL_181_KNORDER );
...
// midori 152137 add <--
	...
	// 内訳（摘要）
	intIndex = CmnGetControlIndex( inRow, ID_COL_181_ITEM );
	tmpSaveData.m_Item = m_clsFunc.DiagGetString( m_pDiag, intIndex );

	// 金額
	intIndex = CmnGetControlIndex( inRow, ID_COL_181_VAL );
	tmpSaveData.m_Val = CmnDiagGetKingaku( m_pDiag, intIndex );

	// 備考
	intIndex = CmnGetControlIndex( inRow, ID_COL_181_TEKI );
...
***********************************************************************/
int	CfrmUc181Sonota2::virRecBufSaveDataForPasteInsert( int inPage, int inRow )
{
...
***********************************************************************/
int	CfrmUc181Sonota2::virRecBufSaveDataForPaste( int inPage, int inRow )
{
	///////////////////////////////////////////////////////////////
	// 登録処理呼び出し
	return RecBufSaveDataSub( inPage, inRow, &m_CopyData );
...
/**********************************************************************
	...
	戻値
			int					成功(更新あり)/成功(更新なし)/失敗
								...
								FUNCTION_NG		: 失敗
***********************************************************************/
int	CfrmUc181Sonota2::RecBufSaveDataSub( 
							int inPage,
							int inRow,
							P_REC_UC_181_SONOTA2 inSaveData )
{
	REC_UC_181_SONOTA2	udTemp;			//	画面上のデータ格納用
	...
	// テーブルアクセスクラス
	CdbUc181Sonota2	mfcRec( m_pDB, m_uInfo.intFormSeq );
	...
	//	(2) 項目
	if (udTemp.m_Item != m_ReadData[inRow].m_Item ) {
		ufgUpData	= TRUE;		// 全体(データ行/空行)
		ufgUpToku	= TRUE;
		ufgItem		= TRUE;		// 取引先
	}
	...
	//	(5) 特殊行フラグ(基本的には、空行/データ行のチェックになるはず) 
...
// midori 152137 add <--
				...
				if (ufgItem == TRUE) {
					...
					m_clsFunc.StrDivision( udTemp.m_Item, &strArray, 2, TRUE, TRUE );
					mfcRec.m_Item		= m_clsFunc.StrDocking( &strArray );
				}
...
//********************************************************************************
//	「その他2」テーブルのオブジェクトを生成し、ポインタを返す
//********************************************************************************
CdbUc000Common*	CfrmUc181Sonota2::virGetDataTableObject()
{
	// 「その他2」テーブルのオブジェクトを生成し、ポインタを返す
	return (CdbUc000Common*)( new CdbUc181Sonota2( m_pDB, m_uInfo.intFormSeq ) );
}
...
//	RET	なし
//********************************************************************************
void	CfrmUc181Sonota2::virRowButtonCopyProc()
{
...
//	RET	なし
//********************************************************************************
void	CfrmUc181Sonota2::virTblGetKamokuInfo( CdbUc000Common* rsData, SORTKAMOKU_INFO* uKamoku )
{
	CdbUc181Sonota2*	rs = (CdbUc181Sonota2*)rsData;
...
//	RET	なし
//********************************************************************************
void	CfrmUc181Sonota2::virGetCurrentInfo( CURRENT_INFO* uCurInfo )
{
...
//	フォーカスオン（ヘッダ）
//++++++++++++++++++++++++++++++++++++++++++++++++++
void CfrmUc181Sonota2::FocusTopicdiag1()
{
//マウスクリックでキャレットが表示できないためコメントとする
//	// ボタンからTabキー移動した場合に必要
//	m_HeadDiag.SetPosition( 4 );
...
//	エディットオン（ヘッダ）
//++++++++++++++++++++++++++++++++++++++++++++++++++
void CfrmUc181Sonota2::EditONTopicdiag1(short index)
{
// midori 151405 add -->
	// スクロールフラグをクリアする
	nG_MScroll = 0;
...
//	エディットオフ（ヘッダ）
//++++++++++++++++++++++++++++++++++++++++++++++++++
void CfrmUc181Sonota2::EditOFFTopicdiag1(short index)
{
...
// midori 151405 add <--
	//	初期化成功？
	if ( mfcRec.Init( m_uInfo.intFormSeq ) == DB_ERR_OK ){
		...
		if ( !mfcRec.IsEOF() ){
			...
			mfcRec.Edit();
			//	項目を設定
			mfcRec.m_ItemName = m_clsFunc.DiagGetString( &m_HeadDiag, 4 );
			//	更新
			mfcRec.Update(); 
		}
		//	閉じる
...
//	キーイベント（ヘッダ）
//++++++++++++++++++++++++++++++++++++++++++++++++++
void CfrmUc181Sonota2::TerminationTopicdiag1(short index, short nChar, short length, LPUNKNOWN data)
{
	// TODO: ここにメッセージ ハンドラ コードを追加します。
...
//	【戻値】	なし
//**************************************************
BOOL CfrmUc181Sonota2::UpdateControlItem()
{
	CdbUcInfSonotaItem		mfcRec( m_pDB );	//	uc_inf_sonota_itemテーブルクラス
	...
	// 対象セルの現属性を取得
	m_HeadDiag.GetAttribute(4, (LPUNKNOWN)&diaatt);

	// 属性にANK文字の入力有効指定
	diaatt.attr_editattr = diaatt.attr_editattr | DIAG_EATTR_ZENHAN;

	// 対象セルにANK文字入力有効指定
	m_HeadDiag.SetAttribute(4, (LPUNKNOWN)&diaatt, TRUE);
	...
	if ( mfcRec.Init( m_uInfo.intFormSeq ) == DB_ERR_OK ){
		...
		if ( !mfcRec.IsEOF() ){
			...
			mfcRec.MoveFirst();
			//	項目を設定
			CmnDiagSetString( &m_HeadDiag, 4, mfcRec.m_ItemName, 0 );
		}
		//	閉じる
		mfcRec.Fin();
	}
...
//	【戻値】	なし
//**************************************************
void CfrmUc181Sonota2::SetInputMode( int nRow, long nMode )
{
	m_pDiag->ModifyItem( CmnGetControlIndex( nRow, ID_COL_181_KNORDER ), nMode );	//	科目
	m_pDiag->ModifyItem( CmnGetControlIndex( nRow, ID_COL_181_ITEM ), nMode );		//	項目
	m_pDiag->ModifyItem( CmnGetControlIndex( nRow, ID_COL_181_VAL ), nMode );		//	期末現在高
	m_pDiag->ModifyItem( CmnGetControlIndex( nRow, ID_COL_181_TEKI ), nMode );		//	摘要
}
...
//	【戻値】	なし
//**************************************************
void CfrmUc181Sonota2::SetDiagBackColor()
{
...
//		RET		なし					
//********************************************************************************
void CfrmUc181Sonota2::virRendoCreateData(CdbUc000Common* rsData, RENTEMP_INFO* uRenInfo)
{
	CString			strTemp;
// midori 152153 add -->
	int				sw = 0;
...
//		RET		なし					
//********************************************************************************
void CfrmUc181Sonota2::virRendoUpdateData(CdbUc000Common* rsData, RENTEMP_INFO* uRenInfo)
{
	CdbUc181Sonota2*	rs = (CdbUc181Sonota2*)rsData;
...
//***************************************************************************
BOOL CfrmUc181Sonota2::virEndProc(void)
{
	TRACE(_T("***** CfrmUc181Sonota2::virEndProc\n"));
...
// midori 161106 add -->
void CfrmUc181Sonota2::ComboNew(short index)
{
	short			sv_sel=0;
// midori 152201 add -->
...
// midori 151405 add -->
int CfrmUc181Sonota2::CursorControl(short nChar, int sw)
{
	int				rv=0;
	int				intCol=0;
	int				pos=0;
...
// midori 152134 add -->
void CfrmUc181Sonota2::ComboSelYoushikidiag1(short index, LPUNKNOWN data)
{
// 要通知案件修正 21/07/09 del -->
...
// 修正No.162446 add -->
LRESULT CfrmUc181Sonota2::OnUserReDrawView(WPARAM wParam, LPARAM lParam)
{
	virUpdateControlTblData();
	CmnDiagSetFocus(m_pDiag, 1, 1);
