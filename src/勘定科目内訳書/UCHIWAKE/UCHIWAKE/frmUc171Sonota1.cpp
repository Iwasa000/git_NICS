...
IMPLEMENT_DYNCREATE( CfrmUc171Sonota1, CfrmUc000Common )


BEGIN_MESSAGE_MAP( CfrmUc171Sonota1, CfrmUc000Common )
	ON_WM_SIZE()
...
//	ON_COMMAND( ID_BUTTON_F3, OnButtonF3 )
	...
	ON_COMMAND( ID_PRINTSETUP_MENU, &CfrmUc171Sonota1::OnMenuPrintSetup )
	ON_COMMAND( ID_PRINTALL_MENU, &CfrmUc171Sonota1::OnMenuPrintAll )
//	ON_COMMAND( ID_OUTPUTFORM_MENU, &CfrmUc171Sonota1::OnMenuFormTypeSetup )
	ON_COMMAND( ID_SPECIALROW_MENU, &CfrmUc171Sonota1::OnMenuSpecialRow )
	ON_COMMAND( ID_SORT_MENU, &CfrmUc171Sonota1::OnMenuSort )
	ON_COMMAND(ID_IKKATUADD_MENU, &CfrmUc171Sonota1::OnIkkatuAddMenu)
	ON_COMMAND( ID_DISPDIALOG_MENU, &CfrmUc171Sonota1::OnMenuIkkatuKingaku )
	ON_COMMAND( ID_ZEROMONEY_MENU, &CfrmUc171Sonota1::OnMenuZeroMoney )
	ON_COMMAND( ID_ZEROMONEYMOVE_MENU, &CfrmUc171Sonota1::OnMenuZeroMoneyMove )
	ON_COMMAND( ID_AMOUTDIALOG_MENU, &CfrmUc171Sonota1::OnMenuOutKeiSetup )
// midori 160606 add -->
	ON_COMMAND( ID_CLEAR_MENU, &CfrmUc171Sonota1::OnMenuClear )
// midori 160606 add <--
	ON_COMMAND( ID_RENDO_MENU, &CfrmUc171Sonota1::OnMenuZaimuRendo )
	ON_COMMAND( ID_TITLEMENU, &CfrmUc171Sonota1::OnMenuTitleRestore )
	ON_COMMAND( ID_USER_SETTING_MENU, &CfrmUc171Sonota1::OnMenuOptionSetting )
	ON_COMMAND( ID_COPY_SETTING_INFO_MENU, &CfrmUc171Sonota1::OnMenuCopySettingInfo )
	ON_COMMAND( ID_DELETE_DATA_MENU, &CfrmUc171Sonota1::OnMenuDeleteDataEachYoushiki )
	ON_BN_CLICKED( IDC_PAGEBACK_BUTTON1, &CfrmUc171Sonota1::OnPageBack )
	ON_BN_CLICKED( IDC_PAGENEXT_BUTTON1, &CfrmUc171Sonota1::OnPageNext )
	ON_BN_CLICKED( IDC_PAGENEW_BUTTON1, &CfrmUc171Sonota1::OnPageNew )
	ON_BN_CLICKED( IDC_PAGEINSERT_BUTTON1, &CfrmUc171Sonota1::OnPageInsert )
	ON_BN_CLICKED( IDC_ROWCOPY_BUTTON1, &CfrmUc171Sonota1::OnRowCopy )
	ON_BN_CLICKED( IDC_ROWPASTE_BUTTON1, &CfrmUc171Sonota1::OnRowPaste )
	ON_BN_CLICKED( IDC_ROWINSERT_BUTTON1, &CfrmUc171Sonota1::OnRowInsert )
	ON_BN_CLICKED( IDC_YOUSHIKINEXT_BUTTON1, &CfrmUc171Sonota1::OnMoveYoushikiNext )
	ON_BN_CLICKED( IDC_YOUSHIKIBACK_BUTTON1, &CfrmUc171Sonota1::OnMoveYoushikiBack )
//	ON_UPDATE_COMMAND_UI( ID_BUTTON_F1, &CfrmUc171Sonota1::OnUpdateButtonF1 )
//	ON_UPDATE_COMMAND_UI( ID_BUTTON_F3, &CfrmUc171Sonota1::OnUpdateButtonF3 )
	ON_UPDATE_COMMAND_UI( ID_BUTTON_F6, &CfrmUc171Sonota1::OnUpdateButtonF6 )
	ON_UPDATE_COMMAND_UI( ID_BUTTON_F7, &CfrmUc171Sonota1::OnUpdateButtonF7 )
	ON_UPDATE_COMMAND_UI( ID_BUTTON_F8, &CfrmUc171Sonota1::OnUpdateButtonF8 )
	ON_UPDATE_COMMAND_UI( ID_BUTTON_F9, &CfrmUc171Sonota1::OnUpdateButtonF9 )
	ON_UPDATE_COMMAND_UI( ID_BUTTON_F11, &CfrmUc171Sonota1::OnUpdateButtonF11 )
	ON_UPDATE_COMMAND_UI( ID_BUTTON_F12, &CfrmUc171Sonota1::OnUpdateButtonF12 )
	ON_UPDATE_COMMAND_UI( ID_BUTTON_HOME, &CfrmUc171Sonota1::OnUpdateButtonHome )
	ON_UPDATE_COMMAND_UI( ID_IKKATUADD_MENU, &CfrmUc171Sonota1::OnUpdateIkkatuaddMenu)
	ON_UPDATE_COMMAND_UI( ID_DISPDIALOG_MENU, &CfrmUc171Sonota1::OnUpdateMenuIkkatuKingaku )
// midori 160612 add -->
	ON_UPDATE_COMMAND_UI( ID_SORT_MENU, &CfrmUc171Sonota1::OnUpdateMenuSort )
	ON_UPDATE_COMMAND_UI( ID_CLEAR_MENU, &CfrmUc171Sonota1::OnUpdateMenuClear )
// midori 160612 add <--
	ON_UPDATE_COMMAND_UI( ID_ZEROMONEY_MENU, &CfrmUc171Sonota1::OnUpdateMenuZeroMoney )
// midori 160612 add -->
	ON_UPDATE_COMMAND_UI( ID_ZEROMONEYMOVE_MENU, &CfrmUc171Sonota1::OnUpdateMenuZeroMoneyMove)
// midori 160612 add <--
	ON_UPDATE_COMMAND_UI( ID_RENDO_MENU, &CfrmUc171Sonota1::OnUpdateMenuZaimuRendo )
	ON_UPDATE_COMMAND_UI(ID_SPECIALROW_MENU, &CfrmUc171Sonota1::OnUpdateMenuSpecialRow)
// midori 160612 add -->
	ON_UPDATE_COMMAND_UI( ID_TITLEMENU, &CfrmUc171Sonota1::OnUpdateMenuTitleRestore )
	ON_UPDATE_COMMAND_UI( ID_DELETE_DATA_MENU, &CfrmUc171Sonota1::OnUpdateMenuDeleteDataEachYoushiki )
// midori 160612 add <--
	ON_MESSAGE(WM_USER_REDRAWVIEW, OnUserReDrawView)		// 修正No.162446 add
END_MESSAGE_MAP()


CfrmUc171Sonota1::CfrmUc171Sonota1()
	: CfrmUc000Common( CfrmUc171Sonota1::IDD )
{
...
CfrmUc171Sonota1::~CfrmUc171Sonota1()
{
	...
	TRACE(_T("***** CfrmUc171Sonota1::~CfrmUc171Sonota1\n"));

	//m_pDiag = NULL;
	//m_pTitleDiag = NULL;
}

void CfrmUc171Sonota1::DoDataExchange( CDataExchange* pDX )
{
...
void CfrmUc171Sonota1::OnInitialUpdate()
{
...
#ifdef _DEBUG
void CfrmUc171Sonota1::AssertValid() const
{
	CfrmUc000Common::AssertValid();
}

#ifndef _WIN32_WCE
void CfrmUc171Sonota1::Dump( CDumpContext& dc ) const
{
...
BEGIN_EVENTSINK_MAP( CfrmUc171Sonota1, CfrmUc000Common )
	ON_EVENT( CfrmUc171Sonota1, IDC_YOUSHIKIDIAG1, 3, CfrmUc171Sonota1::TerminationYoushikidiag1, VTS_I2 VTS_I2 VTS_I2 VTS_UNKNOWN )
	ON_EVENT( CfrmUc171Sonota1, IDC_YOUSHIKIDIAG1, 2, CfrmUc171Sonota1::EditOFFYoushikidiag1, VTS_I2 )
	ON_EVENT( CfrmUc171Sonota1, IDC_YOUSHIKIDIAG1, 1, CfrmUc171Sonota1::EditONYoushikidiag1, VTS_I2 )
// midori 151405 add -->
	ON_EVENT(CfrmUc171Sonota1, IDC_YOUSHIKIDIAG1, 12, CfrmUc171Sonota1::VScrollYoushikidiag1, VTS_I2)
// midori 151405 add <--
// midori 152134 add -->
	ON_EVENT(CfrmUc171Sonota1, IDC_YOUSHIKIDIAG1, 8, CfrmUc171Sonota1::ComboSelYoushikidiag1, VTS_I2 VTS_UNKNOWN)
// midori 152134 add <--

	ON_EVENT( CfrmUc171Sonota1, IDC_YOUSHIKIDIAG2, 3, CfrmUc171Sonota1::TerminationYoushikidiag1, VTS_I2 VTS_I2 VTS_I2 VTS_UNKNOWN )
	ON_EVENT( CfrmUc171Sonota1, IDC_YOUSHIKIDIAG2, 2, CfrmUc171Sonota1::EditOFFYoushikidiag1, VTS_I2 )
	ON_EVENT( CfrmUc171Sonota1, IDC_YOUSHIKIDIAG2, 1, CfrmUc171Sonota1::EditONYoushikidiag1, VTS_I2 )
// midori 151405 add -->
	ON_EVENT(CfrmUc171Sonota1, IDC_YOUSHIKIDIAG2, 12, CfrmUc171Sonota1::VScrollYoushikidiag1, VTS_I2)
// midori 151405 add <--
// midori 152134 add -->
	ON_EVENT(CfrmUc171Sonota1, IDC_YOUSHIKIDIAG2, 8, CfrmUc171Sonota1::ComboSelYoushikidiag1, VTS_I2 VTS_UNKNOWN)
// midori 152134 add <--

	ON_EVENT( CfrmUc171Sonota1, IDC_TITLEDIAG1, 3, CfrmUc171Sonota1::TerminationTitlediag1, VTS_I2 VTS_I2 VTS_I2 VTS_UNKNOWN )
	ON_EVENT( CfrmUc171Sonota1, IDC_TITLEDIAG1, 2, CfrmUc171Sonota1::EditOFFTitlediag1, VTS_I2 )
	ON_EVENT( CfrmUc171Sonota1, IDC_TITLEDIAG1, 1, CfrmUc171Sonota1::EditONTitlediag1, VTS_I2 )
	ON_EVENT( CfrmUc171Sonota1, IDC_TITLEDIAG1, 6, CfrmUc171Sonota1::FocusTitlediag1, VTS_NONE )

	ON_EVENT( CfrmUc171Sonota1, IDC_PAGEDIAG1, 3, CfrmUc171Sonota1::TerminationPagediag1, VTS_I2 VTS_I2 VTS_I2 VTS_UNKNOWN )
	ON_EVENT( CfrmUc171Sonota1, IDC_PAGEDIAG1, 2, CfrmUc171Sonota1::EditOFFPagediag1, VTS_I2 )
	ON_EVENT( CfrmUc171Sonota1, IDC_PAGEDIAG1, 1, CfrmUc171Sonota1::EditONPagediag1, VTS_I2 )
	ON_EVENT( CfrmUc171Sonota1, IDC_PAGEDIAG1, 6, CfrmUc171Sonota1::FocusPagediag1, VTS_NONE )
END_EVENTSINK_MAP()

//********************************************************************************
//	初期処理
//********************************************************************************
BOOL	CfrmUc171Sonota1::virStartJob()
{
	// 初期値設定
...
//	共通データの初期値設定
//********************************************************************************
void	CfrmUc171Sonota1::virSetInitialUchiwakeInfo()
{
	// 「その他1」の固有データ
	...
	m_uInfo.intColMax = ID_COLMAX_171;				// １行内のコントロール個数
	m_uInfo.intColMaxData = ID_COLMAXDATA_171;		// １行内の列数
	m_uInfo.intCtlStartIndex = ID_CTLSTARTINDEX_171;// １行目の入力項目の先頭インデックス番号
	m_uInfo.intT1StartIndex = ID_T1STARTNORMAL_171;	// 合計行①の先頭インデックス番号
	m_uInfo.intT2StartIndex = ID_T2STARTNORMAL_171;	// 合計行②の入力項目の先頭インデックス番号
	m_uInfo.intCursolDefPos = ID_COL_171_ADNAME1;	// カーソル移動時の初期位置（タイトルから↓，合計から↑で使用）
	m_uInfo.intCursolKeiPos = ID_COL_171_KNORDER;	// 合計行のカーソル移動位置（カーソル移動で使用）

/*	「FormSeq」は「CmnSetInitialUchiwakeInfo」で読み込むのでここでは設定しない。
	m_uInfo.intFormSeq = ID_FORMNO_171;				// 様式シーケンス番号
*/
	...
	m_uInfo.intT1StartNormal = ID_T1STARTNORMAL_171;	// 通常時：合計行①の先頭インデックス
	m_uInfo.intT2StartNormal = ID_T2STARTNORMAL_171;	// 通常時：合計行②の先頭インデックス
	m_uInfo.intT1StartKobetu = ID_T1STARTKOBETU_171;	// 個別時：合計行①の先頭インデックス
	m_uInfo.intT2StartKobetu = ID_T2STARTKOBETU_171;	// 個別時：合計行②の先頭インデックス
	m_uInfo.intRowKei = ID_ROWKEI_171;				// 帳表固定の合計行数（1:合計あり，0:なし）
	m_uInfo.intKei1StartIndex = ID_COL_171_KEI1_MEISYO;	// 計ダイアグラム1行目の先頭インデックス
	m_uInfo.intKei2StartIndex = ID_COL_171_KEI2_MEISYO;	// 計ダイアグラム2行目の先頭インデックス
...
// 【戻値】    なし
//**************************************************
void	CfrmUc171Sonota1::virSetInitialDiag()
{
	int     nIndex;
	...
	// コンボボックスの属性取得
	nIndex = CmnGetControlIndex( 1, ID_COL_171_KNORDER );
...
//	帳表固有変数の初期値設定
//********************************************************************************
void	CfrmUc171Sonota1::virSetInitialValue()
{
	// 1ページ分のローカルバッファをクリア
	RecBufClearAllData();
...
//	帳表コントロールの初期化（データ領域）
//********************************************************************************
BOOL	CfrmUc171Sonota1::InitialControlDataArea()
{
	int		intMax;
	int		i;
// No.200903 add -->
...
// No.200903 add <--
	...
	for ( i = m_uInfo.intCtlStartIndex; i < intMax; i += m_uInfo.intColMax ) {
		// ComboBox：クリア
		CmnDiagSetString( m_pDiag, i + ID_COL_171_KNORDER - 1, "", 0 );	// 科目
		
		// 漢字入力欄の初期化
		CmnDiagSetAttrInpmax( m_pDiag, i + ID_COL_171_ADNAME1    - 1, MAX_KETA_171_ADNAME1 );		//	名称１
		CmnDiagSetAttrInpmax( m_pDiag, i + ID_COL_171_ADADD1    - 1, MAX_KETA_171_ADADD1 );			//	住所１
		CmnDiagSetAttrInpmax( m_pDiag, i + ID_COL_171_ADADD2    - 1, MAX_KETA_171_ADADD2 );			//	住所２
		CmnDiagSetAttrInpmax( m_pDiag, i + ID_COL_171_TEKI    - 1, MAX_KETA_171_TEKI );				//	摘要

		// 金額欄：桁数初期化
// No.200903 del -->
		//CmnDiagSetAttrDigit( m_pDiag, i + ID_COL_171_VAL - 1, ID_VAL_171_DATA );	// 期末現在高
// No.200903 del <--
// No.200903 add -->
		if(bG_Kanso == TRUE)	len = ID_VAL_171_K_DATA;
		else					len = ID_VAL_171_DATA;
		CmnDiagSetAttrDigit( m_pDiag, i + ID_COL_171_VAL - 1, len );	// 期末現在高
// No.200903 add <--
	...
	// 半角/全角設定
	CmnDiagSetAttrColZenHan( m_pDiag , ID_COL_171_ADNAME1 );		// 名称1
	CmnDiagSetAttrColZenHan( m_pDiag , ID_COL_171_ADADD1 );		// 所在地1
	CmnDiagSetAttrColZenHan( m_pDiag , ID_COL_171_ADADD2 );		// 所在地2
	CmnDiagSetAttrColZenHan( m_pDiag , ID_COL_171_TEKI );		// 摘要
...
//********************************************************************************
BOOL	CfrmUc171Sonota1::InitialControlComboBox()
{
	...
	for ( i = 1; i <= intMax; i++ ) {
		...
		intIndex = CmnGetControlIndex( i, ID_COL_171_KNORDER );
...
//********************************************************************************
void	CfrmUc171Sonota1::InitialControlTotalArea()
{
	int		nKeiType;			//	計の種別
	int		nDataRow;			//	データ行属性
...
// 修正No.157898 add -->
	if(flg2 == 1)	{
		// 一括自動行の科目を入力可能にする
		m_pDiag->ModifyItem( CmnGetControlIndex( (nDataRowPos+1), ID_COL_171_KNORDER ), (DIAG_MDFY_EDIT | DIAG_MDFY_OPAQUE) );
	}
// 修正No.157898 add <--
...
// midori 152166 add <--
	...
	m_pDiagKei->ModifyItem(ID_COL_171_KEI1_VAL, intKeiRow);
	m_pDiagKei->ModifyItem(ID_COL_171_KEI2_VAL, intKeiRow);
	//// 28行目の合計行①
	//nStart = m_uInfo.intT1StartIndex;
	//for ( nCnt = 0; nCnt < m_uInfo.intColMax; nCnt++ ){
	//	m_pDiag->ModifyItem( nStart + nCnt, nKeiRow[0] );
	...
	//m_pDiag->ModifyItem( CmnGetControlTotalIndex( 1, ID_COL_171_KNORDER ), nKeiRow[0] );
	//m_pDiag->ModifyItem( CmnGetControlTotalIndex( 2, ID_COL_171_KNORDER ), nKeiRow[1] );
	
// No.200903 del -->
	//// 合計行の金額欄は、金額欄 + 1桁
	//CmnDiagSetAttrDigit( m_pDiagKei, ID_COL_171_KEI1_VAL, ID_VAL_171_TOTAL );
	//CmnDiagSetAttrDigit( m_pDiagKei, ID_COL_171_KEI2_VAL, ID_VAL_171_TOTAL );
	////CmnDiagSetAttrDigit( m_pDiag, CmnGetControlTotalIndex( 1, ID_COL_171_VAL ), ID_VAL_171_TOTAL );
	////CmnDiagSetAttrDigit( m_pDiag, CmnGetControlTotalIndex( 2, ID_COL_171_VAL ), ID_VAL_171_TOTAL );
// No.200903 del <--
}
...
//	RET	なし
//********************************************************************************
void	CfrmUc171Sonota1::InitialControlSpecialRow( int intRow, int intFgFunc )
{
// No.200903 add -->
	int				len=0;
// No.200903 add <--
	...
	case ID_FGFUNC_IKKATUAUTO:		// 一括集計金額行（自動）
		// 桁数を設定
// No.200903 del -->
		//CmnDiagSetAttrDigit( m_pDiag, CmnGetControlIndex( intRow , ID_COL_171_VAL ), ID_VAL_171_TOTAL );
// No.200903 del <--
// No.200903 add -->
		if(bG_Kanso == TRUE)	len = ID_VAL_171_K_TOTAL;
		else					len = ID_VAL_171_TOTAL;
		CmnDiagSetAttrDigit( m_pDiag, CmnGetControlIndex( intRow , ID_COL_171_VAL ), len );
// No.200903 add <--
		break;
	}
	...
	case ID_FGFUNC_IKKATUAUTO:		// 一括集計金額行（自動）
		...
		if ( intFgFunc != ID_FGFUNC_IKKATUAUTO ) {
			...
			m_pDiag->ModifyItem( CmnGetControlIndex( intRow, ID_COL_171_KNORDER ), DIAG_MDFY_NODROPDOWN );

			// ComboBoxの選択項目クリア
			m_clsFunc.DiagInit( &diadata );
			diadata.text_combo = _T( "\r\n" );
			m_pDiag->SetData( CmnGetControlIndex( intRow, ID_COL_171_KNORDER ), (LPUNKNOWN)&diadata );
		}
...
// 改良No.21-0086,21-0529 cor <--
			...
			if (intFgFunc == ID_FGFUNC_IKKATUAUTO ){
				//	科目
				m_pDiag->ModifyItem( CmnGetControlIndex( intRow, ID_COL_171_KNORDER ), DIAG_MDFY_INPUT );
			}
		}
// No.200905 add <--
...
//	帳表タイトル情報の表示
//********************************************************************************
void	CfrmUc171Sonota1::virUpdateControlTitle()
{
//	int		intMax;
...
//	帳表ページ情報の表示
//********************************************************************************
void	CfrmUc171Sonota1::UpdateControlPage()
{
	BOOL	bBack = TRUE;
	BOOL	bNext = TRUE;
...
//	帳表データの表示（１ページ分）
//********************************************************************************
BOOL	CfrmUc171Sonota1::virUpdateControlTblData()
{
// No.200903 add -->
	int len = 0;
// No.200903 add <--
...
// No.200903 add -->
	...
	CmnDiagSetAttrDigit( m_pDiagKei, ID_COL_171_KEI1_VAL, len );
	CmnDiagSetAttrDigit( m_pDiagKei, ID_COL_171_KEI2_VAL, len );
// No.200903 add <--
...
//	保管件数の表示
//********************************************************************************
BOOL CfrmUc171Sonota1::virUpdateControlTblData2()
{
	int					hcnt=0;
	CString				cs=_T("");
...
//		RET		なし
//********************************************************************************
void	CfrmUc171Sonota1::UpdateControlRowData( CdbUc171Sonota1* prmDbRec ) {
	...
	// 読込み対象セル取得
	intCell = CmnGetControlIndex( prmDbRec->m_NumRow, ID_COL_171_KNORDER );
...
//		RET		なし
//********************************************************************************
void	CfrmUc171Sonota1::UpdateControlRowTotal( CdbUc171Sonota1* prmDbRec )
{
	int		intTotalType;
...
// 修正No.157629 add <--
	...
	// 頁計/累計の名称表示
	if ( intRowName > 0 ) {
		//CmnDiagSetString( m_pDiag, CmnGetControlTotalIndex( intRowName, ID_COL_171_KNORDER ), prmDbRec->m_KeiStr, 0 );
		CmnDiagSetString( m_pDiagKei, CmnGetKeiDiagIndex( intRowName, ID_COL_171_KEI1_MEISYO ), prmDbRec->m_KeiStr, 1 );
	}
	// 頁計/累計の金額表示
	if ( intRowVal > 0 ) {
		//CmnDiagSetKingaku( m_pDiag, CmnGetControlTotalIndex( intRowName, ID_COL_171_VAL ), prmDbRec->m_Val );
		CmnDiagSetKingaku( m_pDiagKei, CmnGetKeiDiagIndex( intRowVal, ID_COL_171_KEI1_VAL ), prmDbRec->m_Val );
	}
}
...
//		RET		なし
//********************************************************************************
void	CfrmUc171Sonota1::virFncCellCopyProc( CdbUc000Common* rsData )
{
	CdbUc171Sonota1*	rs;
	int					intCol;	// 現在の列
...
//********************************************************************************
int	CfrmUc171Sonota1::virFncReferenceGetType(int intCol, int* intGrSeq, long* lngItemSeq, int* intAdd1, int* intAdd2, int* intAdd1Col, int* intAdd2Col, REFERENCE_INFO* pudReference)
{
int				intRefType;
	...
	case ID_COL_171_ADADD2:
		...
		*intAdd1 = 40;
		*intAdd2 = 40;
		*intAdd1Col = ID_COL_171_ADADD1;
		*intAdd2Col = ID_COL_171_ADADD2;
		break;
...
//		RET		なし
//********************************************************************************
void	CfrmUc171Sonota1::virFncReferenceSetData( CdlgReference* dlgRef, int intRefType, int intCol )
{
	switch (intRefType) {
...
//		RET		なし
//********************************************************************************
void CfrmUc171Sonota1::virFncReferenceSetICSData(CdlgAddressSearch* dlgAddd)
{
	int		nCurRow;	//	カレント行
	int		nCurCol;	//	カレント列
	int		nPos;		//	位置
	...
	//	現在行の取引先の名称１の位置を算出
	nPos = (( nCurRow - 1 ) * m_uInfo.intColMax ) + ( m_uInfo.intCtlStartIndex + ( ID_COL_171_ADADD1 - 1 ));
...
//		RET		なし
//********************************************************************************
void	CfrmUc171Sonota1::virFncReferenceUpdateTbl( int intRefType, int nRefMode/*=0*/ )
{
	switch (intRefType) {
...
void CfrmUc171Sonota1::virActivateFrameK(UINT nState, CFrameWnd* pDeactivateFrame)
{
	int		index = 0;
	...
	if(pWnd != NULL)	{
		if(m_DataKakutei == FALSE)	{
			if(m_uInfo.intCurCol == ID_COL_171_KNORDER)	{
				virKamokuAddCancel();
			}
		}
	}
...
void CfrmUc171Sonota1::virKamokuAddCancel()
{
	...
	// 科目列なら
	if(m_uInfo.intCurCol == ID_COL_171_KNORDER && m_F9OnSw != TRUE)	{
		DIAGRAM_DATA	diadata;
		m_pDiag->GetData(m_uInfo.intCurCtlIndex,(LPUNKNOWN)&diadata);
		// 【新規作成】が選択されていれば
		if(diadata.data_combo > m_CmbCnt)	{
			// 前回の値に戻す
			CmnDiagSetCombo(m_pDiag,CmnGetControlIndex(m_uInfo.intCurRow,ID_COL_171_KNORDER),m_uInfo.OldCombo);
		}
	}
}
// 要通知案件修正 21/07/09 add <--
...
//	その他イベント処理
//********************************************************************************
BOOL	CfrmUc171Sonota1::PreTranslateMessage( MSG* pMsg )
{
//	int				intID;
...
//				if ((CmnGetControlCol() != ID_COL_171_KNORDER) || (CmnCheckTotalRow() == TRUE )){
// midori 160611 del <--
				// カレントインデックスを保存
...
//				//}
//// ---------------------
//				if(CmnGetControlCol() == ID_COL_171_KNORDER)	{
//					rv=1;
//				}
//// midori 160611 cor <--
// midori 152134 17/10/07 del <--
...
/*
		...
		case VK_TAB:
			...
			if ((intID == IDC_PAGEBACK_BUTTON1) && (CmnCheckShiftKey() == TRUE)) {
				...
				CmnDiagSetFocus(m_pDiag, m_uInfo.intRowMax, ID_COL_171_KNORDER);
				return 1;
			}
			break;
*/
...
// 修正No.158259 add -->
				...
				intCol = CmnGetControlCol();
				if(intCol == ID_COL_171_KNORDER && (pMsg->wParam == VK_LEFT || pMsg->wParam == VK_RIGHT))	{
...
// 頁コントロールのフォーカス設定
void	CfrmUc171Sonota1::FocusPagediag1()
{
...
// 頁コントロールのゲットフォーカス
void	CfrmUc171Sonota1::EditONPagediag1( short index )
{
// midori 151405 add -->
	// スクロールフラグをクリアする
	nG_MScroll = 0;
...
// midori 151405 add <--
	...
	// 1行登録
//	if( CmnGetControlCol() != ID_COL_171_VAL ){
...
// 頁コントロールのロストフォーカス
void	CfrmUc171Sonota1::EditOFFPagediag1( short index )
{
// midori 155028 add -->
...
// 頁コントロールのキー操作
void	CfrmUc171Sonota1::TerminationPagediag1( short index, short nChar, short length, LPUNKNOWN data )
{
	int nMaxDataCol = 0;
	// カレント頁の合計行の種別を取得
...
// midori 160612 cor <--
			...
			//CmnDiagSetFocus(m_pDiag, m_uInfo.intRowMax, ID_COL_171_KNORDER);
			CmnDiagSetFocus(m_pDiag, nMaxDataCol, ID_COL_171_TEKI);
		}
		break;
	case VK_DOWN:
		// タイトルコントロールへ移動
...
// タイトルコントロールのフォーカス設定
void	CfrmUc171Sonota1::FocusTitlediag1()
{
//マウスクリックでキャレットが表示できないためコメントとする
//	// ボタンからTabキー移動した場合に必要
//	m_TitleDiag.SetPosition( 0 );
...
// タイトルコントロールのゲットフォーカス
void	CfrmUc171Sonota1::EditONTitlediag1( short index )
{
// midori 151405 add -->
	// スクロールフラグをクリアする
	nG_MScroll = 0;
...
// タイトルコントロールのロストフォーカス
void	CfrmUc171Sonota1::EditOFFTitlediag1 (short index )
{
// midori 151405 add -->
	m_Titlefocus = 0;
// midori 151405 add <--
...
//	タイトル更新
void CfrmUc171Sonota1::virUpdateTitle()
{
...
// タイトルコントロールのキーイベント
void	CfrmUc171Sonota1::TerminationTitlediag1( short index, short nChar, short length, LPUNKNOWN data )
{
	// フォーカス移動
	switch ( nChar ) {
	case VK_RETURN:
...
void	CfrmUc171Sonota1::EditONYoushikidiag1( short index )
{
	DIAGRAM_DATA	diadata;
...
//			if( CmnGetControlCol() != ID_COL_171_VAL ){
			...
			BOOL adadd1_to_adadd2 = IsSaveMoveReference(ID_COL_171_ADADD1, ID_COL_171_ADADD2);
			// [Home]キー押下の住所検索ダイアログの戻り（フォーカスをセットしている）は保存しない（改良依頼No15-1613）
			BOOL adadd1_to_adadd1 = IsSaveMoveReference(ID_COL_171_ADADD1, ID_COL_171_ADADD1);	// 所在地1(住所)→所在地1(住所)
			BOOL adadd2_to_adadd2 = IsSaveMoveReference(ID_COL_171_ADADD2, ID_COL_171_ADADD2);	// 所在地2(住所)→所在地2(住所)　所在地2から住所が長すぎる場合、ここがFALSEになる
...
// データコントロールのロストフォーカス
void	CfrmUc171Sonota1::EditOFFYoushikidiag1( short index )
{
	if( m_EndView != FALSE )	return;
...
//	入力確定
void CfrmUc171Sonota1::virInputDecisionEditOFF()
{
	// フォーカスフラグOFF
...
// 預貯金データコントロールのキーイベント
void	CfrmUc171Sonota1::TerminationYoushikidiag1( short index, short nChar, short length, LPUNKNOWN data )
{
	//--------------------------------------------------------------------------------
	//	キー操作仕様
...
// midori 151405 add -->
void CfrmUc171Sonota1::VScrollYoushikidiag1(short mode)
{
...
//********************************************************************************
int	CfrmUc171Sonota1::GetFocusPosition( int nChar )
{
	int		intRow;					// カレント行番号
	int		intCol;					// カレント列番号
	...
	else if ( intCol == ID_COL_171_ADNAME1 ){
		// カレント列が「名称１」の場合
	...
	else if ( intCol == ID_COL_171_ADADD1 ){
		// カレント列が「住所１」の場合
	...
	else if ( intCol == ID_COL_171_ADADD2 ){
		// カレント列が「住所２」の場合
	...
	else if ( intCol == ID_COL_171_TEKI ){
		// カレント列が「取引の内容」の場合
		intVector[0] = m_uInfo.intCurCtlIndex - m_uInfo.intColMax;		// ↑
	...
	case VK_TAB:
		if (CmnCheckShiftKey() == FALSE) {
			...
			// それ以外は「←」キーと同じ
			if ((intRow <= 1) && (intCol == ID_COL_171_KNORDER)) {
				return -1;
			}
...
//********************************************************************************
int	CfrmUc171Sonota1::GetTotalRowIndex( int nCharOrg, int intIndex, int intNext )
{
	...
	if ( nNowRow <= nBorder[0] ){
		...
		if ( nNextRow > nBorder[0] ){
			//	計行に移動
			//nRet = CmnGetControlIndex( ( nBorder[1] + 1 ), ID_COL_171_KNORDER );
			if (nCharOrg == VK_TAB) {
				return -2;
			}
		}
	...
	//	現在、頁計に居る
		...
		case VK_UP:			// ↑：23行目のデータ行の支店名項目へ移動
			nRet = CmnGetControlIndex( nBorder[0], ID_COL_171_ADNAME1 );
			break;
		case VK_LEFT:		// ←/Shift+Tab：23行目のデータ行の摘要項目へ移動
			nRet = CmnGetControlIndex( nBorder[0], ID_COL_171_TEKI );
			break;
		default:			// →/↓/Return/Tab：25行目の合計行②へ移動
			...
			//	累計あり
				...
				nRet = CmnGetControlIndex( ( nBorder[2] + 1 ), ID_COL_171_KNORDER );
			}
			break;
		}
	}
...
//		RET		なし
//********************************************************************************
void	CfrmUc171Sonota1::virTblEditIkkatuLine( int nType, CdbUc000Common* rsData,
...
//********************************************************************************
int	CfrmUc171Sonota1::virTblSortSubSortProc( CdlgSort* pCdlgSort, CdbUc000Common* rsData )
{
	CdbUc171Sonota1*	rs;
	CString				strFilter;
	CString				strSort;
...
/**********************************************************************
	...
	戻値
		int		成功/失敗
				FUNCTION_OK
***********************************************************************/
int	CfrmUc171Sonota1::RecBufSetData( CdbUc171Sonota1* prmDbRec )
{
...
/**********************************************************************
	...
	戻値
		int		成功/失敗
				FUNCTION_OK
***********************************************************************/
int	CfrmUc171Sonota1::RecBufClearAllData()
{
...
/**********************************************************************
	...
	戻値
		int		成功/失敗
				FUNCTION_OK
***********************************************************************/
int	CfrmUc171Sonota1::RecBufClearData( P_REC_UC_171_SONOTA1 inRecData )
{
...
/**********************************************************************
	...
	戻値
		int				成功(更新あり)/成功(更新なし)/失敗
						...
						FUNCTION_NG		: 失敗
***********************************************************************/
int	CfrmUc171Sonota1::virRecBufSaveData( int inPage, int inRow )
{
	...
	// 科目
	intIndex = CmnGetControlIndex( inRow, ID_COL_171_KNORDER );
...
// midori 152137 add <--
	...
	intIndex = CmnGetControlIndex( inRow, ID_COL_171_ADNAME1 );
	...
	// 所在地1
	intIndex = CmnGetControlIndex( inRow, ID_COL_171_ADADD1 );
	tmpSaveData.m_AdAdd1 = m_clsFunc.DiagGetString( m_pDiag, intIndex );

	// 所在地2
	intIndex = CmnGetControlIndex( inRow, ID_COL_171_ADADD2 );
	tmpSaveData.m_AdAdd2 = m_clsFunc.DiagGetString( m_pDiag, intIndex );

	// 期末現在高
	intIndex = CmnGetControlIndex( inRow, ID_COL_171_VAL );
	tmpSaveData.m_Val = CmnDiagGetKingaku( m_pDiag, intIndex );

	// 摘要
	intIndex = CmnGetControlIndex( inRow, ID_COL_171_TEKI );
...
***********************************************************************/
int	CfrmUc171Sonota1::virRecBufSaveDataForPasteInsert( int inPage, int inRow )
{
...
***********************************************************************/
int	CfrmUc171Sonota1::virRecBufSaveDataForPaste( int inPage, int inRow )
{
	///////////////////////////////////////////////////////////////
	// 登録処理呼び出し
	return RecBufSaveDataSub( inPage, inRow, &m_CopyData );
...
/**********************************************************************
	...
	戻値
			int					成功(更新あり)/成功(更新なし)/失敗
								...
								FUNCTION_NG		: 失敗
***********************************************************************/
int	CfrmUc171Sonota1::RecBufSaveDataSub( 
							int inPage,
							int inRow,
...
//********************************************************************************
CdbUc000Common*	CfrmUc171Sonota1::virGetDataTableObject()
{
	// 「その他1」テーブルのオブジェクトを生成し、ポインタを返す
...
//	RET	なし
//********************************************************************************
void	CfrmUc171Sonota1::virRowButtonCopyProc()
{
...
//	RET	なし
//********************************************************************************
void	CfrmUc171Sonota1::virTblGetKamokuInfo( CdbUc000Common* rsData, SORTKAMOKU_INFO* uKamoku )
{
...
//	RET	なし
//********************************************************************************
void	CfrmUc171Sonota1::virGetCurrentInfo( CURRENT_INFO* uCurInfo )
{
...
//	【戻値】	なし
//**************************************************
void CfrmUc171Sonota1::SetInputMode( int nRow, long nMode )
{
	m_pDiag->ModifyItem( CmnGetControlIndex( nRow, ID_COL_171_KNORDER ), nMode );	//	科目
	m_pDiag->ModifyItem( CmnGetControlIndex( nRow, ID_COL_171_ADNAME1 ), nMode );	//	取引の内容
	m_pDiag->ModifyItem( CmnGetControlIndex( nRow, ID_COL_171_ADADD1 ), nMode );	//	所在地（上段）
	m_pDiag->ModifyItem( CmnGetControlIndex( nRow, ID_COL_171_ADADD2 ), nMode );	//	所在地（下段）
	m_pDiag->ModifyItem( CmnGetControlIndex( nRow, ID_COL_171_VAL ), nMode );		//	期末現在高
	m_pDiag->ModifyItem( CmnGetControlIndex( nRow, ID_COL_171_TEKI ), nMode );		//	摘要
}
...
//	【戻値】	なし
//**************************************************
void CfrmUc171Sonota1::SetDiagBackColor()
{
...
//		RET		なし					
//********************************************************************************
void CfrmUc171Sonota1::virRendoCreateData(CdbUc000Common* rsData, RENTEMP_INFO* uRenInfo)
{
	CString			strTemp;
...
// midori 152153 del -->
	//// 科目残高以外のみ設定
	//if ( uRenInfo->intOpRenType != ID_RENDATA_KZ ){
	//	// 名称(氏名)
...
//		RET		なし					
//********************************************************************************
void CfrmUc171Sonota1::virRendoUpdateData(CdbUc000Common* rsData, RENTEMP_INFO* uRenInfo)
{
	CdbUc171Sonota1*	rs = (CdbUc171Sonota1*)rsData;
...
//***************************************************************************
BOOL CfrmUc171Sonota1::virEndProc(void)
{
	TRACE(_T("***** CfrmUc171Sonota1::virEndProc\n"));
...
// midori 161106 add -->
void CfrmUc171Sonota1::ComboNew(short index)
{
	short			sv_sel=0;
// midori 152201 add -->
...
// midori 151405 add -->
int CfrmUc171Sonota1::CursorControl(short nChar, int sw)
{
	int				rv=0;
	int				intCol=0;
	int				pos=0;
...
// midori 152134 add -->
void CfrmUc171Sonota1::ComboSelYoushikidiag1(short index, LPUNKNOWN data)
{
// 要通知案件修正 21/07/09 del -->
...
// 修正No.162446 add -->
LRESULT CfrmUc171Sonota1::OnUserReDrawView(WPARAM wParam, LPARAM lParam)
{
	virUpdateControlTblData();
	CmnDiagSetFocus(m_pDiag, 1, 1);
