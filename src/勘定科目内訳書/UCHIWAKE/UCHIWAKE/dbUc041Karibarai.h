// dbUc041Karibarai.h : ヘッダー ファイル
//

#ifndef	_DB_UC_041_KARIBARAI_H_
#define	_DB_UC_041_KARIBARAI_H_

#include "dbUc000Common.h"

/////////////////////////////////////////////////////////////////////////////
// CdbUc041Karibarai レコードセット

class CdbUc041Karibarai : public CdbUc000Common
{
public:
...
// midori 160606 cor <--
	...
	//	virtual CString GetSortItemType();	// CdbUc041Karibaraiの相手先名称ソートは改頁設定がない為、必要なし

	CdbUc041Karibarai(CDatabase* pDatabase = NULL);
	DECLARE_DYNAMIC(CdbUc041Karibarai)

// フィールド/パラメータ データ
	//{{AFX_FIELD(CdbUc041Karibarai, CRecordset)
	long	m_KnSeq;
	long	m_KnOrder;
	CString	m_KnName;
	long	m_AdSeq;
