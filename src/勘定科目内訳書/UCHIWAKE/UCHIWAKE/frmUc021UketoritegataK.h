...
// midori kanso_0318 del <--
#define	ID_COLMAX_021K			22/*21*/		// １行内のコントロール個数
// midori kanso_0318 del -->
...
// midori kanso_0318 del <--
#define ID_T1STARTNORMAL_021K	506/*528*//*483*/		// 通常時：合計行①の先頭インデックス番号
#define ID_T2STARTNORMAL_021K	530/*552*//*504*/		// 通常時：合計行②の先頭インデックス番号
#define ID_T1STARTKOBETU_021K	506/*528*//*483*/		// 個別時：合計行①の先頭インデックス番号
#define ID_T2STARTKOBETU_021K	530/*552*//*504*/		// 個別時：合計行②の先頭インデックス番号
//
// midori kanso_0318 del -->
//// 「受取手形」テーブル名称
...
//// midori 152503 add -->
// midori kanso_0318 del <--
#define ID_COL_021K_KEI1_MEISYO		0				// 計ダイアログ1行目の計名称（計or合計、頁計、累計）
#define ID_COL_021K_KEI1_VAL		6				// 計ダイアログ1行目の期末現在高
#define ID_COL_021K_KEI2_MEISYO		14				// 計ダイアログ2行目の計名称（計or合計、頁計、累計）
#define ID_COL_021K_KEI2_VAL		20				// 計ダイアログ2行目の期末現在高
// midori kanso_0318 del -->
//// midori 152503 add <--
//
////////////////////////////////////////////////////////////////////
////	1レコード分の構造体
//typedef struct tagRecuc_021K_Uketoritegata
//{
//	long	m_Seq;	// シーケンス番号
//	int		m_NumPage;	// 頁番号
//	BYTE	m_NumRow;	// 行番号
...
class CfrmUc021UketoritegataK: public CfrmUc000Common
{
	DECLARE_DYNCREATE( CfrmUc021UketoritegataK )

public:
	CfrmUc021UketoritegataK();
	virtual	~CfrmUc021UketoritegataK();
