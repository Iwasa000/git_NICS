	...
	// 半角/全角設定
	CmnDiagSetAttrColZenHan( m_pDiag , ID_COL_162I_NAIYOU );		// 取引の内容
	CmnDiagSetAttrColZenHan( m_pDiag , ID_COL_162I_ADNAME1 );		// 相手先1
	CmnDiagSetAttrColZenHan( m_pDiag , ID_COL_162I_ADADD1 );		// 所在地1
	CmnDiagSetAttrColZenHan( m_pDiag , ID_COL_162I_ADADD2 );		// 所在地2
...
//********************************************************************************
BOOL	CfrmUc162ZatusonI::InitialControlDataAreaHide( CICSDiag* pDiag )
{
	int		intMax;
	int		i;
	int		len=0;
	...
	for ( i = m_uInfo.intCtlStartIndex; i < intMax; i += m_uInfo.intColMax ) {
		// ComboBox：クリア
		CmnDiagSetString( pDiag, i + ID_COL_162I_KNORDER - 1, "", 0 );	// 科目

		// 漢字入力欄の初期化
		CmnDiagSetAttrInpmax( pDiag, i + ID_COL_162I_NAIYOU  - 1, MAX_KETA_162_NAIYOU );	// 取引の内容
		CmnDiagSetAttrInpmax( pDiag, i + ID_COL_162I_ADNAME1 - 1, MAX_KETA_162_ADNAME1*2 );	// 相手先1
		CmnDiagSetAttrInpmax( pDiag, i + ID_COL_162I_ADADD1  - 1, MAX_KETA_162_ADADD1 );	// 所在地1
		CmnDiagSetAttrInpmax( pDiag, i + ID_COL_162I_ADADD2  - 1, MAX_KETA_162_ADADD2 );	// 所在地2

		// 金額欄：桁数初期化
		len = ID_VAL_162_K_DATA;
		CmnDiagSetAttrDigit( pDiag, i + ID_COL_162I_VAL - 1, len );	// 金額
	}
...
//********************************************************************************
BOOL	CfrmUc162ZatusonI::InitialControlComboBox()
{
	...
	for(i = 1; i <= intMax; i++) {
		...
		// 科目
		intIndex = CmnGetControlIndex(i, ID_COL_162I_KNORDER);
		// T選択
		intIndex2 = CmnGetControlIndex(i, ID_COL_162I_INVONOT);
...
//********************************************************************************
void	CfrmUc162ZatusonI::InitialControlTotalArea()
{
	int		nKeiType;			//	計の種別
	...
	if(flg2[0] == 1)	{
		// 一括自動行の科目を入力可能にする
		m_pDiag->ModifyItem( CmnGetControlIndex( (nDataRowPos[0]+1), ID_COL_162I_KNORDER ), (DIAG_MDFY_EDIT | DIAG_MDFY_OPAQUE) );
	}
	if(flg2[1] == 1)	{
		// 一括自動行の科目を入力可能にする
		m_pDiag->ModifyItem( CmnGetControlIndex( (nDataRowPos[1]+1), ID_COL_162I_KNORDER ), (DIAG_MDFY_EDIT | DIAG_MDFY_OPAQUE) );
	}
	...
	m_pDiagKei->ModifyItem(ID_COL_162I_KEI1_VAL, intKeiRow);
	m_pDiagKei->ModifyItem(ID_COL_162I_KEI2_VAL, intKeiRow);
}
...
//		→表示していない方のDiag(通常 or 個別)の設定に使用する
//********************************************************************************
void	CfrmUc162ZatusonI::InitialControlTotalAreaHide( CICSDiag* pDiag )
{
	int intIndex = 0;
	...
	// 合計行の金額欄は、金額欄 + 1桁
	intIndex = m_intT1StartIndexHide + m_uInfo.intCtlStartIndex + ID_COL_162I_VAL - 1;
	CmnDiagSetAttrDigit( pDiag, intIndex, ID_VAL_162_TOTAL );

	intIndex = m_intT2StartIndexHide + m_uInfo.intCtlStartIndex + ID_COL_162I_VAL - 1;
	CmnDiagSetAttrDigit( pDiag, intIndex, ID_VAL_162_TOTAL );
}
...
//	RET	なし
//********************************************************************************
void	CfrmUc162ZatusonI::InitialControlSpecialRow( int intRow, int intFgFunc )
{
	int				nIndex;		//	インデックス
	...
	switch ( intFgFunc ) {
		...
		case ID_FGFUNC_IKKATUAUTO:		// 一括集計金額行（自動）
			// 桁数を設定
			CmnDiagSetAttrDigit( m_pDiag, CmnGetControlIndex( intRow , ID_COL_162I_VAL ), ID_VAL_162_TOTAL );
			break;
	}
	...
	switch (intFgFunc) {
		...
		case ID_FGFUNC_IKKATUAUTO:		// 一括集計金額行（自動）
			...
			if(intFgFunc != ID_FGFUNC_IKKATUAUTO) {
				...
				m_pDiag->ModifyItem(CmnGetControlIndex(intRow, ID_COL_162I_KNORDER), DIAG_MDFY_NODROPDOWN);
				// 「登録番号(T選択)」はComboBoxのため、DropDown不可とする
				m_pDiag->ModifyItem(CmnGetControlIndex(intRow, ID_COL_162I_INVONOT), DIAG_MDFY_NODROPDOWN);

				// ComboBoxの選択項目クリア
				m_clsFunc.DiagInit(&diadata);
				diadata.text_combo = _T("\r\n");
				m_pDiag->SetData(CmnGetControlIndex(intRow, ID_COL_162I_KNORDER), (LPUNKNOWN)&diadata);
				m_pDiag->SetData(CmnGetControlIndex(intRow, ID_COL_162I_INVONOT), (LPUNKNOWN)&diadata);
			}
...
// 改良No.21-0086,21-0529 cor <--
				...
				if (intFgFunc == ID_FGFUNC_IKKATUAUTO ){
					//	科目
					m_pDiag->ModifyItem( CmnGetControlIndex( intRow, ID_COL_162I_KNORDER ), DIAG_MDFY_INPUT );
				}
			}
...
//	帳表タイトル情報の表示
//********************************************************************************
void	CfrmUc162ZatusonI::virUpdateControlTitle()
{
...
//	帳表ページ情報の表示
//********************************************************************************
void	CfrmUc162ZatusonI::UpdateControlPage()
{
	BOOL	bBack = TRUE;
	BOOL	bNext = TRUE;
...
//	帳表データの表示（１ページ分）
//********************************************************************************
BOOL	CfrmUc162ZatusonI::virUpdateControlTblData()
{
	// ダイアログ切替
	if( m_pDiag != NULL ){
		virSetInitialDiag();
	...
	// 頁計、累計行の桁数をセットする
	CmnDiagSetAttrDigit( m_pDiagKei, ID_COL_162I_KEI1_VAL, ID_VAL_162_TOTAL );
	CmnDiagSetAttrDigit( m_pDiagKei, ID_COL_162I_KEI2_VAL, ID_VAL_162_TOTAL );
	...
	while ( !dbRec.IsEOF() ) {		// ファイル終端まで
		...
		// 科目
		CmnInitialControlFgStringCell( m_pDiag, dbRec.m_NumRow, ID_COL_162I_KNORDER, dbRec.m_FgFunc, UC_KAMOKU_LEN, dbRec.m_KnName);
		// 取引の内容
		CmnInitialControlFgStringCell( m_pDiag, dbRec.m_NumRow, ID_COL_162I_NAIYOU, dbRec.m_FgFunc, UC_162_NAIYOU_LEN, dbRec.m_Naiyou);
...
//	保管件数の表示
//********************************************************************************
BOOL CfrmUc162ZatusonI::virUpdateControlTblData2()
{
	int					hcnt=0;
	CString				cs=_T("");
...
//		RET		なし
//********************************************************************************
void	CfrmUc162ZatusonI::UpdateControlRowData( CdbUc162Zatuson* prmDbRec ) {
	DIAGRAM_DATA		diadata;		// ICSDiag構造体
	int					intCell;		// 保存フィールド
	CString				cs1, cs2, cst;
	...
	// 読込み対象セル取得
	intCell = CmnGetControlIndex( prmDbRec->m_NumRow, ID_COL_162I_KNORDER );
...
//		RET		なし
//********************************************************************************
void	CfrmUc162ZatusonI::UpdateControlRowTotal( CdbUc162Zatuson* prmDbRec )
{
	int		intTotalType;
	...
	// 頁計/累計の名称表示
	if ( intRowName > 0 ) {
		CmnDiagSetString( m_pDiagKei, CmnGetKeiDiagIndex( intRowName, ID_COL_162I_KEI1_MEISYO ), prmDbRec->m_KeiStr, 1 );
	}
	// 頁計/累計の金額表示
	if ( intRowVal > 0 ) {
		CmnDiagSetKingaku( m_pDiagKei, CmnGetKeiDiagIndex( intRowVal, ID_COL_162I_KEI1_VAL ), prmDbRec->m_Val );
	}
}
...
//		RET		なし
//********************************************************************************
void	CfrmUc162ZatusonI::virFncCellCopyProc( CdbUc000Common* rsData )
{
	CdbUc162Zatuson*	rs;
	int					intCol;	// 現在の列
	int					ind1,ind2;
	...
	switch( intCol ){
		// 科目
		case ID_COL_162I_KNORDER:
			CmnDiagSetCombo2( m_pDiag, m_uInfo.intCurCtlIndex, rs->m_KnOrder );
			break;
		// 取引の内容
		case ID_COL_162I_NAIYOU:
			CmnDiagSetString( m_pDiag, m_uInfo.intCurCtlIndex, rs->m_Naiyou, 0 );
			break;
		// 登録番号（T選択）
		case ID_COL_162I_INVONOT:
		// 登録番号
		case ID_COL_162I_INVONO:
			if(intCol == ID_COL_162I_INVONOT) {
...
//********************************************************************************
int	CfrmUc162ZatusonI::virFncReferenceGetType(int intCol, int* intGrSeq, long* lngItemSeq, int* intAdd1, int* intAdd2, int* intAdd1Col, int* intAdd2Col, REFERENCE_INFO* pudReference)
{
	int		intRefType;
	...
	switch ( intCol ) {
		...
		case ID_COL_162I_ADADD2:
			...
			*intAdd1Col = ID_COL_162I_ADADD1;
			*intAdd2Col = ID_COL_162I_ADADD2;
			break;
...
//		RET		なし
//********************************************************************************
void	CfrmUc162ZatusonI::virFncReferenceSetData( CdlgReference* dlgRef, int intRefType, int intCol )
{
	...
	switch(intRefType)	{
		...
		case ID_DLGTYPE_ADDRESS:
			// 選択内容を表示
			//	登録番号（T選択）
			CmnDiagSetCombo3(m_pDiag, CmnGetControlIndex(m_uInfo.intCurRow, ID_COL_162I_INVONOT), dlgRef->m_udAddress.m_InvNo);
			// 登録番号
			InvoNoSplit(dlgRef->m_udAddress.m_InvNo, &str1, &str2);
			CmnDiagSetString(m_pDiag, CmnGetControlIndex(m_uInfo.intCurRow, ID_COL_162I_INVONO), str2, 0);
			// 名称
			CmnDiagSetString(m_pDiag, CmnGetControlIndex(m_uInfo.intCurRow, ID_COL_162I_ADNAME1),
							 m_clsFunc.StrDocking(dlgRef->m_udAddress.m_AdName1, dlgRef->m_udAddress.m_AdName2), 0);
			// 所在地（上段）
			CmnDiagSetString(m_pDiag, CmnGetControlIndex(m_uInfo.intCurRow, ID_COL_162I_ADADD1), dlgRef->m_udAddress.m_AdAdd1, 0);
			// 所在地（下段）
			CmnDiagSetString(m_pDiag, CmnGetControlIndex(m_uInfo.intCurRow, ID_COL_162I_ADADD2), dlgRef->m_udAddress.m_AdAdd2, 0);
			break;
...
//		RET		なし
//********************************************************************************
void	CfrmUc162ZatusonI::virFncReferenceSetICSData(CdlgAddressSearch* dlgAddd)
{
	int			intIndex;

	// 売却(買入)先の所在地1(住所)
	intIndex = CmnGetControlIndex( m_uInfo.intCurRow, ID_COL_162I_ADADD1 );
	CmnDiagSetString( m_pDiag, intIndex, dlgAddd->m_AdAdd1, 0 );

	// 売却(買入)先の所在地2(住所)
	intIndex = CmnGetControlIndex( m_uInfo.intCurRow, ID_COL_162I_ADADD2 );
...
//		RET		なし
//********************************************************************************
void	CfrmUc162ZatusonI::virFncReferenceUpdateTbl( int intRefType, int nRefMode/*=0*/ )
{
...
void CfrmUc162ZatusonI::virActivateFrameK(UINT nState, CFrameWnd* pDeactivateFrame)
{
	int		index = 0;
	...
	if(pWnd != NULL)	{
		if(m_DataKakutei == FALSE)	{
			if(m_uInfo.intCurCol == ID_COL_162I_KNORDER)	{
				virKamokuAddCancel();
			}
		}
	}
...
void CfrmUc162ZatusonI::virKamokuAddCancel()
{
	...
	// 科目列なら
	if(m_uInfo.intCurCol == ID_COL_162I_KNORDER && m_F9OnSw != TRUE)	{
		DIAGRAM_DATA	diadata;
		m_pDiag->GetData(m_uInfo.intCurCtlIndex,(LPUNKNOWN)&diadata);
		// 【新規作成】が選択されていれば
		if(diadata.data_combo > m_CmbCnt)	{
			// 前回の値に戻す
			CmnDiagSetCombo(m_pDiag,CmnGetControlIndex(m_uInfo.intCurRow,ID_COL_162I_KNORDER),m_uInfo.OldCombo);
		}
	}
}
...
//	その他イベント処理
//********************************************************************************
BOOL	CfrmUc162ZatusonI::PreTranslateMessage( MSG* pMsg )
{
...
// 修正No.168362 add <--
						...
						if(intCol == ID_COL_162I_KNORDER || intCol == ID_COL_162I_INVONOT)	{
							rv=1;
						}
// 修正No.168362 add -->
					} 
// 修正No.168362 add <--
			...
			case VK_RIGHT:
				if(nG_MScroll == 1)	{
					...
					intCol = CmnGetControlCol();
					if(intCol == ID_COL_162I_KNORDER && (pMsg->wParam == VK_LEFT || pMsg->wParam == VK_RIGHT))	{
...
// 頁コントロールのフォーカス設定
void	CfrmUc162ZatusonI::FocusPagediag1()
{
...
// 頁コントロールのゲットフォーカス
void	CfrmUc162ZatusonI::EditONPagediag1( short index )
{
// 修正No.168443 add -->
	// ---- 登録番号一覧関連 ----->
	if(pZmSel && pZmSel->IsDisplay() != FALSE) {
...
// 頁コントロールのロストフォーカス
void	CfrmUc162ZatusonI::EditOFFPagediag1( short index )
{
...
// 頁コントロールのキー操作
void	CfrmUc162ZatusonI::TerminationPagediag1( short index, short nChar, short length, LPUNKNOWN data )
{
	int nMaxDataCol = 0;
	// カレント頁の合計行の種別を取得
	...
	case VK_TAB:
		...
		if ( CmnCheckShiftKey() == FALSE ) {
			...
			CmnDiagSetFocus(m_pDiag, nMaxDataCol, ID_COL_162I_VAL);
		}
		break;
	case VK_DOWN:
		// タイトルコントロールへ移動
...
// タイトルコントロールのフォーカス設定
void	CfrmUc162ZatusonI::FocusTitlediag1()
{
}

// タイトルコントロールのゲットフォーカス
void	CfrmUc162ZatusonI::EditONTitlediag1( short index )
{
// 修正No.168443 add -->
	// ---- 登録番号一覧関連 ----->
	if(pZmSel && pZmSel->IsDisplay() != FALSE) {
...
// タイトルコントロールのロストフォーカス
void	CfrmUc162ZatusonI::EditOFFTitlediag1 (short index )
{
	m_Titlefocus = 0;
	virUpdateTitle();
}
...
//	タイトル更新
void CfrmUc162ZatusonI::virUpdateTitle()
{
...
// タイトルコントロールのキーイベント
void	CfrmUc162ZatusonI::TerminationTitlediag1( short index, short nChar, short length, LPUNKNOWN data )
{
	// フォーカス移動
	switch ( nChar ) {
		case VK_RETURN:
...
void	CfrmUc162ZatusonI::EditONYoushikidiag1( short index )
{
	DIAGRAM_DATA	diadata;
	...
	switch(m_uInfo.intCurCol) {
		...
		case ID_COL_162I_INVONOT:	// 登録番号(T選択)
			// コンボボックスのオフセット値取得
			m_pDiag->GetData(m_uInfo.intCurCtlIndex, (LPUNKNOWN)&diadata);
			m_uInfo.OldCombo = diadata.data_combo;
			break;
	...
	if ( ( m_uInfo.OldRow > 0 ) ) {
		if ( m_uInfo.OldPage == m_uInfo.intCurPage && m_uInfo.OldPage > 0 ) {
			...
			BOOL adadd1_to_adadd2 = IsSaveMoveReference(ID_COL_162I_ADADD1, ID_COL_162I_ADADD2);
			// [Home]キー押下の住所検索ダイアログの戻り（フォーカスをセットしている）は保存しない（改良依頼No15-1613）
			BOOL adadd1_to_adadd1 = IsSaveMoveReference(ID_COL_162I_ADADD1, ID_COL_162I_ADADD1);	// 所在地1(住所)→所在地1(住所)
			BOOL adadd2_to_adadd2 = IsSaveMoveReference(ID_COL_162I_ADADD2, ID_COL_162I_ADADD2);	// 所在地2(住所)→所在地2(住所)　所在地2から住所が長すぎる場合、ここがFALSEになる
			// T選択⇔登録番号は保存しない
			BOOL tsel_to_invno = IsSaveMoveReference(ID_COL_162I_INVONOT, ID_COL_162I_INVONO);
	...
	if(m_uInfo.intCurCol == ID_COL_162I_INVONO && m_EndSyorityu == 0)	{
// 修正No.168377 del -->
...
// 修正No.168377 add -->
		// 登録番号のT選択の値を取得
		int pos = CmnGetControlIndex(m_uInfo.intCurRow, ID_COL_162I_INVONOT);
...
// データコントロールのロストフォーカス
void	CfrmUc162ZatusonI::EditOFFYoushikidiag1( short index )
{
	if( m_EndView != FALSE )	return;

// 修正No.168443 add -->
	// ---- 登録番号一覧関連 ----->
	if(m_uInfo.intCurCol != ID_COL_162I_INVONO) {
		if(pZmSel && pZmSel->IsDisplay() != FALSE) {
			pZmSel->DialogOFF();
		}
	}
...
// 修正No.168443 del -->
	...
	//		//// カーソル移動処理
	//		//CmnDiagSetFocus( m_pDiag, m_uInfo.intCurRow, ID_COL_162I_INVONO );
	//	}
	//}

	//// ---- 登録番号一覧関連 ----->
	//if(pZmSel && m_uInfo.intCurCol != ID_COL_162I_INVONO) {
...
//	入力確定
void CfrmUc162ZatusonI::virInputDecisionEditOFF()
{
	// フォーカスフラグOFF
...
// 預貯金データコントロールのキーイベント
void	CfrmUc162ZatusonI::TerminationYoushikidiag1( short index, short nChar, short length, LPUNKNOWN data )
{
	//--------------------------------------------------------------------------------
	//	キー操作仕様
...
void CfrmUc162ZatusonI::VScrollYoushikidiag1(short mode)
{
// 修正No.168430 del -->
...
//********************************************************************************
int	CfrmUc162ZatusonI::GetFocusPosition( int nChar )
{
	int		intRow;				// カレント行番号
	int		intCol;				// カレント列番号
	...
	else if ( intCol == ID_COL_162I_ADADD1 ) {
		// カレント列が「所在地1」の場合
	...
	else if ( intCol == ID_COL_162I_ADADD2 ) {
		// カレント列が「所在地2」の場合
	...
	else if ( intCol == ID_COL_162I_VAL ) {
		// カレント列が「金額」の場合
		intVector[0] = m_uInfo.intCurCtlIndex - m_uInfo.intColMax;		// ↑
	...
	case VK_RETURN:	// Enterキーでカーソルを下に移動するモード対応
		if(m_ReturnMoveDown) {
			if(intCol == ID_COL_162I_INVONOT)	intNext = intVector[1];			//	カレント列が「登録番号(T表示)」欄の場合「→」キーと同じ
	...
	case VK_TAB:
		if ( CmnCheckShiftKey() == FALSE ) {
			...
			// それ以外は「←」キーと同じ
			if ( ( intRow <= 1 ) && ( intCol == ID_COL_162I_KNORDER ) ) {
				return -1;
			}
...
//********************************************************************************
int	CfrmUc162ZatusonI::GetTotalRowIndex( int nCharOrg, int intIndex, int intNext )
{
	...
	if ( nNowRow <= nBorder[0] ){
		...
		if (( intNext > CmnGetControlIndex( m_uInfo.intRowMax, ID_COL_162I_VAL ) ) && ( nCharOrg == VK_TAB )){
			return( -2 );
		}
		//	データ行を超えた？かつ計行あり？
	...
	//	現在、頁計に居る
		...
		switch ( nCharTemp ){
			case VK_UP:			// ↑：23行目のデータ行の支店名項目へ移動
				nRet = CmnGetControlIndex( nBorder[0], ID_COL_162I_NAIYOU );
				break;
			case VK_LEFT:		// ←/Shift+Tab：23行目のデータ行の摘要項目へ移動
				nRet = CmnGetControlIndex( nBorder[0], ID_COL_162I_VAL );
				break;
			default:			// →/↓/Return/Tab：25行目の合計行②へ移動
				...
				//	累計あり
					...
					nRet = CmnGetControlIndex( ( nBorder[2] + 2 ), ID_COL_162I_KNORDER );
				}
				break;
		}
	}
	//	現在、累計に居る場合
		...
		switch ( nCharTemp ){
			...
			case VK_LEFT:		// ←/Shift+Tab：24行目の合計行① or 24行目のデータ行の摘要項目へ移動
				nRet = CmnGetControlIndex( ( nBorder[1] + 2 ), ID_COL_162I_KNORDER );
				break;
			default:			// →/↓：移動できない
				// 例外処理：最終項目で"Tab"は別コントロールへ移動
				// それ以外は「→」キーと同じ
...
//		RET		なし
//********************************************************************************
void	CfrmUc162ZatusonI::virTblEditIkkatuLine( int nType, CdbUc000Common* rsData,
...
//********************************************************************************
int	CfrmUc162ZatusonI::virTblSortSubSortProc( CdlgSort* pCdlgSort, CdbUc000Common* rsData )
{
	CdbUc162Zatuson*	rs;
	CString				strFilter;
	CString				strSort;
...
/**********************************************************************
	...
	戻値
		int		成功/失敗
				FUNCTION_OK
***********************************************************************/
int	CfrmUc162ZatusonI::RecBufSetData( CdbUc162Zatuson* prmDbRec )
{
...
/**********************************************************************
	...
	戻値
		int		成功/失敗
				FUNCTION_OK
***********************************************************************/
int	CfrmUc162ZatusonI::RecBufClearAllData()
{
...
/**********************************************************************
	...
	戻値
		int		成功/失敗
				FUNCTION_OK
***********************************************************************/
int	CfrmUc162ZatusonI::RecBufClearData( P_REC_UC_162_ZATUSON inRecData )
{
...
/**********************************************************************
	...
	戻値
		int				成功(更新あり)/成功(更新なし)/失敗
						...
						FUNCTION_NG		: 失敗
***********************************************************************/
int	CfrmUc162ZatusonI::virRecBufSaveData( int inPage, int inRow )
{
	...
	// 科目
	intIndex = CmnGetControlIndex( inRow, ID_COL_162I_KNORDER );
	...
	// 取引の内容
	intIndex = CmnGetControlIndex( inRow, ID_COL_162I_NAIYOU );
	tmpSaveData.m_Naiyou = m_clsFunc.DiagGetString( m_pDiag, intIndex );

	// 登録番号（T選択）
	intIndex = CmnGetControlIndex(inRow, ID_COL_162I_INVONOT);
	m_pDiag->GetData(intIndex, (LPUNKNOWN)&diadata);
	tsel = diadata.data_combo;

	// 登録番号（法人番号）
	intIndex = CmnGetControlIndex(inRow, ID_COL_162I_INVONO);
...
// 修正No.168534,168539 add <--
	...
	intIndex = CmnGetControlIndex( inRow, ID_COL_162I_ADNAME1 );
	...
	if ( tmpSaveData.m_AdName2.IsEmpty() ){
		if(m_uInfo.intCurCol == ID_COL_162I_ADNAME1 && m_uInfo.intCurRow != m_uInfo.OldRow){	// 各カラムごとにvirRecBufSaveData()がコールされるようになり、かつタイミングがEditOffからEditOnに移ったことによりCmnDiagSetString()でカレットが末尾から先頭に移ってしまう為、制御
			CmnDiagSetString( m_pDiag, intIndex, tmpSaveData.m_AdName1, 0 );
		}
	}

	// 所在地1
	intIndex = CmnGetControlIndex( inRow, ID_COL_162I_ADADD1 );
	tmpSaveData.m_AdAdd1 = m_clsFunc.DiagGetString( m_pDiag, intIndex );

	// 所在地2
	intIndex = CmnGetControlIndex( inRow, ID_COL_162I_ADADD2 );
	tmpSaveData.m_AdAdd2 = m_clsFunc.DiagGetString( m_pDiag, intIndex );

	// 金額
	intIndex = CmnGetControlIndex( inRow, ID_COL_162I_VAL );
...
***********************************************************************/
int	CfrmUc162ZatusonI::virRecBufSaveDataForPasteInsert( int inPage, int inRow )
{
...
***********************************************************************/
int	CfrmUc162ZatusonI::virRecBufSaveDataForPaste( int inPage, int inRow )
{
	///////////////////////////////////////////////////////////////
	// 登録処理呼び出し
	return RecBufSaveDataSub( inPage, inRow, &m_CopyData );
...
/**********************************************************************
	...
	戻値
			int					成功(更新あり)/成功(更新なし)/失敗
								...
								FUNCTION_NG		: 失敗
***********************************************************************/
int	CfrmUc162ZatusonI::RecBufSaveDataSub( 
							int inPage,
							int inRow,
...
// 修正No.168534,168539 add -->
		if((udtTemp.m_FgFunc == ID_FGFUNC_DATA) && ((m_InvnoErrFlg == 0 && ufgInvNo == TRUE))) {	// 変更ありの場合
			...
			// 自動登録しない→自動登録する
			if(m_RegAutoRef)	udtTemp.m_AdSeq = rsAdd.CheckAdSeqEntry_Inv(udtTemp.m_AdSeq, udtTemp.m_AdName1, udtTemp.m_AdName2, udtTemp.m_AdAdd1, udtTemp.m_AdAdd2, udtTemp.m_InvNo, ID_ADDRESSGR_URI, FALSE, TRUE, 0);
			else				udtTemp.m_AdSeq = rsAdd.GetSeqFromAdName_Inv(ID_ADDRESSGR_URI, udtTemp.m_AdName1, udtTemp.m_AdName2, udtTemp.m_AdAdd1, udtTemp.m_AdAdd2, udtTemp.m_InvNo);
...
// 修正No.168534,168539 del -->
		...
		//	((ufgAdName1 == TRUE) || (ufgAdName2 == TRUE) || (ufgAdAdd1 == TRUE) || (ufgAdAdd2 == TRUE) || (m_InvnoErrFlg == 0 && ufgInvNo == TRUE)))	{	// 変更ありの場合		// 修正No.168443 add
// 修正No.168534,168539 del <--
// 修正No.168534,168539 add -->
		if ((udtTemp.m_FgFunc == ID_FGFUNC_DATA) && 
			((ufgAdName1 == TRUE) || (ufgAdName2 == TRUE) || (ufgAdAdd1 == TRUE) || (ufgAdAdd2 == TRUE)))	{	// 変更ありの場合		// 修正No.168443 add
// 修正No.168534,168539 add <--
				CdbUcLstAddress		rsAdd( m_pDB );

				// 自動登録しない→自動登録する（2016/01/28）
				if(m_RegAutoRef)	udtTemp.m_AdSeq = rsAdd.CheckEntry_Inv(udtTemp.m_AdName1, udtTemp.m_AdName2, udtTemp.m_AdAdd1, udtTemp.m_AdAdd2, udtTemp.m_InvNo, ID_ADDRESSGR_URI, TRUE);
				else				udtTemp.m_AdSeq = rsAdd.GetSeqFromAdName_Inv(ID_ADDRESSGR_URI, udtTemp.m_AdName1, udtTemp.m_AdName2, udtTemp.m_AdAdd1, udtTemp.m_AdAdd2, udtTemp.m_InvNo);
...
//********************************************************************************
CdbUc000Common*	CfrmUc162ZatusonI::virGetDataTableObject()
{
	// 「雑損失」テーブルのオブジェクトを生成し、ポインタを返す
...
//	RET	なし
//********************************************************************************
void	CfrmUc162ZatusonI::virRowButtonCopyProc()
{
...
//	RET	なし
//********************************************************************************
void	CfrmUc162ZatusonI::virTblGetKamokuInfo( CdbUc000Common* rsData, SORTKAMOKU_INFO* uKamoku )
{
	CdbUc162Zatuson*	rs = (CdbUc162Zatuson*)rsData;
...
//	RET	なし
//********************************************************************************
void	CfrmUc162ZatusonI::virGetCurrentInfo( CURRENT_INFO* uCurInfo )
{
...
//********************************************************************************
int	CfrmUc162ZatusonI::virUpdateRelationTblChengeFormType()
{
...
//		RET		BOOL		TRUE:正常終了，FALSE:エラー
//********************************************************************************
BOOL CfrmUc162ZatusonI::virUpdateRelationTblChengeFormTypeSave()
{
...
//		RET		なし
//********************************************************************************
int	CfrmUc162ZatusonI::UpdateTbl162ChangeFormType(UCHIWAKE_INFO pInfoSv)
{
	// データ無しならデータ更新しない
...
//	【戻値】	なし
//**************************************************
void CfrmUc162ZatusonI::SetInputMode( int nRow, long nMode )
{
	m_pDiag->ModifyItem( CmnGetControlIndex( nRow, ID_COL_162I_KNORDER ), nMode );	//	科目
	m_pDiag->ModifyItem( CmnGetControlIndex( nRow, ID_COL_162I_NAIYOU ), nMode );	//	取引の内容
	m_pDiag->ModifyItem( CmnGetControlIndex( nRow, ID_COL_162I_INVONOT ), nMode );	//	登録番号（T選択）
	m_pDiag->ModifyItem( CmnGetControlIndex( nRow, ID_COL_162I_INVONO ), nMode );	//	登録番号
	m_pDiag->ModifyItem( CmnGetControlIndex( nRow, ID_COL_162I_ADNAME1 ), nMode );	//	相手先（上段）
	m_pDiag->ModifyItem( CmnGetControlIndex( nRow, ID_COL_162I_ADADD1 ), nMode );	//	所在地（上段）
	m_pDiag->ModifyItem( CmnGetControlIndex( nRow, ID_COL_162I_ADADD2 ), nMode );	//	所在地（下段）
	m_pDiag->ModifyItem( CmnGetControlIndex( nRow, ID_COL_162I_VAL ), nMode );		//	金額
}
...
//	【戻値】	なし
//**************************************************
void CfrmUc162ZatusonI::SetDiagBackColor()
{
...
//		RET		なし					
//********************************************************************************
void CfrmUc162ZatusonI::virRendoCreateData(CdbUc000Common* rsData, RENTEMP_INFO* uRenInfo)
{
	CString			strTemp;
...
//		RET		なし					
//********************************************************************************
void CfrmUc162ZatusonI::virRendoUpdateData(CdbUc000Common* rsData, RENTEMP_INFO* uRenInfo)
{
	CdbUc162Zatuson*	rs = (CdbUc162Zatuson*)rsData;
...
//***************************************************************************
BOOL CfrmUc162ZatusonI::virEndProc(void)
{
	TRACE(_T("***** CfrmUc162ZatusonI::virEndProc\n"));
...
void CfrmUc162ZatusonI::ComboNew(short index)
{
	short			sv_sel=0;
...
int CfrmUc162ZatusonI::CursorControl(short nChar, int sw)
{
	int				rv=0;
	int				intCol=0;
	int				pos=0;
	...
	if((nChar == VK_TAB && (key & 0x80) == 0x80) || (nChar == VK_LEFT) || (nChar == VK_RIGHT)) {
		...
		if(intCol == ID_COL_162I_INVONOT)	{	// 登録番号(T選択)
			m_pDiag->ComboDropDown(m_uInfo.intCurCtlIndex, FALSE);
			CmnDiagSetCombo(m_pDiag, m_uInfo.intCurCtlIndex, m_uInfo.OldCombo);
		}
	}
...
void CfrmUc162ZatusonI::ComboSelYoushikidiag1(short index, LPUNKNOWN data)
{
...
// ------------------------------------------------------------------------------------------------------------------------
void CfrmUc162ZatusonI::TitleColorChg(void)
{
...
LRESULT CfrmUc162ZatusonI::OnUserReDrawView(WPARAM wParam, LPARAM lParam)
{
	virUpdateControlTblData();
	CmnDiagSetFocus(m_pDiag, 1, 1);
...
//		RET		なし
// --------------------------------------------------------------------------------------------------------
void CfrmUc162ZatusonI::virDiagGetHjnData(CDatabase* pDB, HJN_REC_NEW* phjnRec)
{
	int				nPage,nRow;
	int				intIndex;	// 対象行の各インデックス
	int				tsel=0;
	...
	// 登録番号（法人番号）
	cst.Empty();
	intIndex = CmnGetControlIndex(nRow, ID_COL_162I_INVONO);
	...
	// 名称1(氏名)
	intIndex = CmnGetControlIndex(nRow, ID_COL_162I_ADNAME1);
	m_clsFunc.StrDivision(m_clsFunc.DiagGetString(m_pDiag, intIndex), &strArray, 2, FALSE, TRUE);
	cst.Empty();
	...
	// 所在地1(住所)
	intIndex = CmnGetControlIndex(nRow, ID_COL_162I_ADADD1);
	cst = m_clsFunc.DiagGetString(m_pDiag, intIndex);
	cst.TrimRight();
	if(cst.IsEmpty() == FALSE)	{
		memset(buf, 0, sizeof(buf));
	...
	// 所在地2(住所)
	intIndex = CmnGetControlIndex(nRow, ID_COL_162I_ADADD2);
	cst = m_clsFunc.DiagGetString(m_pDiag, intIndex);
	cst.TrimRight();
	if(cst.IsEmpty() == FALSE) {
		memset(buf, 0, sizeof(buf));
...
//		RET		なし
// --------------------------------------------------------------------------------------------------------
void	CfrmUc162ZatusonI::virDiagSetHjnData(int pSw, CString rtInvNo, CString rtName, CString rtAdrs1, CString rtAdrs2, CString rtKana)
{
	int					ret = 0;
	int					intIndex;
...
// 修正No.168361,168369,168371,168378 del <--
		// 登録番号（T選択）
		intIndex = CmnGetControlIndex(m_uInfo.intCurRow, ID_COL_162I_INVONOT);
		CmnDiagSetCombo3(m_pDiag, intIndex, strInvoNo);

		// 登録番号
		InvoNoSplit(strInvoNo, &cs1, &cs2);
		intIndex = CmnGetControlIndex(m_uInfo.intCurRow, ID_COL_162I_INVONO);
...
// --------------------------------------------------------------------------------------------------------
// --------------------------------------------------------------------------------------------------------
int CfrmUc162ZatusonI::virCallChkInvoiceNum(int pSw, int inPage, int inRow)
{
...
//				CString		pInvno	登録番号
// --------------------------------------------------------------------------------------------------------
int CfrmUc162ZatusonI::ChkInvoiceNum(CDatabase* pDB, int pSw, int inPage, int inRow,
...
// 修正No.168361,168369,168371,168378 del -->
	...
	//		DIAGRAM_DATA	ddata;
	//		ddata.data_combo = 0;
	//		m_pDiag->SetData(CmnGetControlIndex(inRow, ID_COL_162I_INVONOT), (LPUNKNOWN)&ddata);
	//		ddata.data_edit.Empty();
	//		m_pDiag->DataClear(CmnGetControlIndex(inRow, ID_COL_162I_INVONO), TRUE);
	//		// エラーメッセージを表示
...
// 修正No.168443 add <--
			...
			if(pZmSel && pZmSel->IsDisplay() != FALSE && cst.GetLength() < 3) {
				...
				if(tmpzd.errflg != -1) {
					...
					m_pDiag->SetData(CmnGetControlIndex(inRow, ID_COL_162I_INVONO), (LPUNKNOWN)&ddata);
					// 再描画
					m_pDiag->Refresh();
...
// 修正No.168425,168443 add -->
					if(pSw == 3 || m_EndSyorityu == 1)	{
						...
						m_uInfo.intCurCol = ID_COL_162I_INVONO;
