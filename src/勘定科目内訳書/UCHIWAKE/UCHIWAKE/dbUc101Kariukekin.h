// dbUc101Kariukekin.h : ヘッダー ファイル
//

#ifndef	_DB_UC_101_KARIUKEKIN_H_
#define	_DB_UC_101_KARIUKEKIN_H_

#include "dbUc000Common.h"

/////////////////////////////////////////////////////////////////////////////
// CdbUc101Kariukekin レコードセット

class CdbUc101Kariukekin : public CdbUc000Common
{
public:
...
// midori 160606 cor <--
	...
	CdbUc101Kariukekin(CDatabase* pDatabase = NULL);
	DECLARE_DYNAMIC(CdbUc101Kariukekin)

// フィールド/パラメータ データ
	//{{AFX_FIELD(CdbUc101Kariukekin, CRecordset)
	long	m_KnSeq;
	long	m_KnOrder;
	CString	m_KnName;
	long	m_AdSeq;
...
// オーバーライド
	...
	//{{AFX_VIRTUAL(CdbUc101Kariukekin)
	public:
...
#endif	//_DB_UC_101_KARIUKEKIN_H_
