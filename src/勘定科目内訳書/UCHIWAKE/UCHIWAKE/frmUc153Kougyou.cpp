...
#include "frmUc151Tidaiyatin.h"		// 通常/個別切り替えにて"⑮-1"データ更新が必要
...
IMPLEMENT_DYNCREATE( CfrmUc153Kougyou, CfrmUc000Common )


BEGIN_MESSAGE_MAP( CfrmUc153Kougyou, CfrmUc000Common )
	ON_WM_SIZE()
...
//	ON_COMMAND( ID_BUTTON_F3, OnButtonF3 )
	...
	ON_COMMAND( ID_PRINTSETUP_MENU, &CfrmUc153Kougyou::OnMenuPrintSetup )
	ON_COMMAND( ID_PRINTALL_MENU, &CfrmUc153Kougyou::OnMenuPrintAll )
	ON_COMMAND( ID_OUTPUTFORM_MENU, &CfrmUc153Kougyou::OnMenuFormTypeSetup )
	ON_COMMAND( ID_SPECIALROW_MENU, &CfrmUc153Kougyou::OnMenuSpecialRow )
	ON_COMMAND( ID_SORT_MENU, &CfrmUc153Kougyou::OnMenuSort )
//	ON_COMMAND( ID_DISPDIALOG_MENU, &CfrmUc153Kougyou::OnMenuIkkatuKingaku )
	ON_COMMAND( ID_ZEROMONEY_MENU, &CfrmUc153Kougyou::OnMenuZeroMoney )
	ON_COMMAND( ID_ZEROMONEYMOVE_MENU, &CfrmUc153Kougyou::OnMenuZeroMoneyMove )
	ON_COMMAND( ID_AMOUTDIALOG_MENU, &CfrmUc153Kougyou::OnMenuOutKeiSetup )
// midori 160606 add -->
	ON_COMMAND( ID_CLEAR_MENU, &CfrmUc153Kougyou::OnMenuClear )
// midori 160606 add <--
	ON_COMMAND( ID_TITLEMENU, &CfrmUc153Kougyou::OnMenuTitleRestore )
	ON_COMMAND( ID_USER_SETTING_MENU, &CfrmUc153Kougyou::OnMenuOptionSetting )
	ON_COMMAND( ID_COPY_SETTING_INFO_MENU, &CfrmUc153Kougyou::OnMenuCopySettingInfo )
	ON_COMMAND( ID_DELETE_DATA_MENU, &CfrmUc153Kougyou::OnMenuDeleteDataEachYoushiki )
	ON_BN_CLICKED( IDC_PAGEBACK_BUTTON1, &CfrmUc153Kougyou::OnPageBack )
	ON_BN_CLICKED( IDC_PAGENEXT_BUTTON1, &CfrmUc153Kougyou::OnPageNext )
	ON_BN_CLICKED( IDC_PAGENEW_BUTTON1, &CfrmUc153Kougyou::OnPageNew )
	ON_BN_CLICKED( IDC_PAGEINSERT_BUTTON1, &CfrmUc153Kougyou::OnPageInsert )
	ON_BN_CLICKED( IDC_ROWCOPY_BUTTON1, &CfrmUc153Kougyou::OnRowCopy )
	ON_BN_CLICKED( IDC_ROWPASTE_BUTTON1, &CfrmUc153Kougyou::OnRowPaste )
	ON_BN_CLICKED( IDC_ROWINSERT_BUTTON1, &CfrmUc153Kougyou::OnRowInsert )
	ON_BN_CLICKED( IDC_YOUSHIKINEXT_BUTTON1, &CfrmUc153Kougyou::OnMoveYoushikiNext )
	ON_BN_CLICKED( IDC_YOUSHIKIBACK_BUTTON1, &CfrmUc153Kougyou::OnMoveYoushikiBack )
//	ON_UPDATE_COMMAND_UI( ID_BUTTON_F1, &CfrmUc153Kougyou::OnUpdateButtonF1 )
//	ON_UPDATE_COMMAND_UI( ID_BUTTON_F3, &CfrmUc153Kougyou::OnUpdateButtonF3 )
	ON_UPDATE_COMMAND_UI( ID_BUTTON_F6, &CfrmUc153Kougyou::OnUpdateButtonF6 )
	ON_UPDATE_COMMAND_UI( ID_BUTTON_F7, &CfrmUc153Kougyou::OnUpdateButtonF7 )
	ON_UPDATE_COMMAND_UI( ID_BUTTON_F8, &CfrmUc153Kougyou::OnUpdateButtonF8 )
	ON_UPDATE_COMMAND_UI( ID_BUTTON_F9, &CfrmUc153Kougyou::OnUpdateButtonF9 )
	ON_UPDATE_COMMAND_UI( ID_BUTTON_F11, &CfrmUc153Kougyou::OnUpdateButtonF11 )
	ON_UPDATE_COMMAND_UI( ID_BUTTON_F12, &CfrmUc153Kougyou::OnUpdateButtonF12 )
	ON_UPDATE_COMMAND_UI( ID_BUTTON_HOME, &CfrmUc153Kougyou::OnUpdateButtonHome )
//	ON_UPDATE_COMMAND_UI( ID_DISPDIALOG_MENU, &CfrmUc153Kougyou::OnUpdateMenuIkkatuKingaku )
// midori 160612 add -->
	ON_UPDATE_COMMAND_UI( ID_SORT_MENU, &CfrmUc153Kougyou::OnUpdateMenuSort )
	ON_UPDATE_COMMAND_UI( ID_CLEAR_MENU, &CfrmUc153Kougyou::OnUpdateMenuClear )
// midori 160612 add <--
	ON_UPDATE_COMMAND_UI( ID_ZEROMONEY_MENU, &CfrmUc153Kougyou::OnUpdateMenuZeroMoney )
// midori 160612 add -->
	ON_UPDATE_COMMAND_UI( ID_ZEROMONEYMOVE_MENU, &CfrmUc153Kougyou::OnUpdateMenuZeroMoneyMove)
// midori 160612 add <--
	ON_UPDATE_COMMAND_UI(ID_SPECIALROW_MENU, &CfrmUc153Kougyou::OnUpdateMenuSpecialRow)
// midori 160612 add -->
	ON_UPDATE_COMMAND_UI( ID_TITLEMENU, &CfrmUc153Kougyou::OnUpdateMenuTitleRestore )
	ON_UPDATE_COMMAND_UI( ID_DELETE_DATA_MENU, &CfrmUc153Kougyou::OnUpdateMenuDeleteDataEachYoushiki )
// midori 160612 add <--
	ON_MESSAGE(WM_USER_REDRAWVIEW, OnUserReDrawView)		// 修正No.162446 add
END_MESSAGE_MAP()


CfrmUc153Kougyou::CfrmUc153Kougyou()
	: CfrmUc000Common( CfrmUc153Kougyou::IDD )
{
...
CfrmUc153Kougyou::~CfrmUc153Kougyou()
{
	...
	TRACE(_T("***** CfrmUc153Kougyou::~CfrmUc153Kougyou\n"));

	//m_pDiag = NULL;
	//m_pTitleDiag = NULL;
}

void CfrmUc153Kougyou::DoDataExchange( CDataExchange* pDX )
{
...
// midori 161108 add <--
// 修正No.157626 add -->
	DDX_Control(pDX, IDC_ICSDISPGUIDE11, m_Guide11);
	DDX_Control(pDX, IDC_ICSDISPGUIDE12, m_Guide12);
	DDX_Control(pDX, IDC_ICSDISPGUIDE13, m_Guide13);
	DDX_Control(pDX, IDC_ICSDISPGUIDE2, m_Guide2);
// 修正No.157626 add <--
}

void CfrmUc153Kougyou::OnInitialUpdate()
{
...
// 修正No.158252 add -->
		// 欄外ガイドの背景色
		m_Guide11.SetBackColor(m_ViewColor);
		m_Guide12.SetBackColor(m_ViewColor);
		m_Guide13.SetBackColor(m_ViewColor);
		m_Guide2.SetBackColor(m_ViewColor);
		m_Guide11.ShowWindow(FALSE);
		m_Guide12.ShowWindow(FALSE);
		m_Guide13.ShowWindow(FALSE);
...
#ifdef _DEBUG
void CfrmUc153Kougyou::AssertValid() const
{
	CfrmUc000Common::AssertValid();
}

#ifndef _WIN32_WCE
void CfrmUc153Kougyou::Dump( CDumpContext& dc ) const
{
...
BEGIN_EVENTSINK_MAP( CfrmUc153Kougyou, CfrmUc000Common )
	ON_EVENT( CfrmUc153Kougyou, IDC_YOUSHIKIDIAG1, 3, CfrmUc153Kougyou::TerminationYoushikidiag1, VTS_I2 VTS_I2 VTS_I2 VTS_UNKNOWN )
	ON_EVENT( CfrmUc153Kougyou, IDC_YOUSHIKIDIAG1, 2, CfrmUc153Kougyou::EditOFFYoushikidiag1, VTS_I2 )
	ON_EVENT( CfrmUc153Kougyou, IDC_YOUSHIKIDIAG1, 1, CfrmUc153Kougyou::EditONYoushikidiag1, VTS_I2 )
// midori 151405 add -->
	ON_EVENT(CfrmUc153Kougyou, IDC_YOUSHIKIDIAG1, 12, CfrmUc153Kougyou::VScrollYoushikidiag1, VTS_I2)
// midori 151405 add <--

	ON_EVENT( CfrmUc153Kougyou, IDC_YOUSHIKIDIAG2, 3, CfrmUc153Kougyou::TerminationYoushikidiag1, VTS_I2 VTS_I2 VTS_I2 VTS_UNKNOWN )
	ON_EVENT( CfrmUc153Kougyou, IDC_YOUSHIKIDIAG2, 2, CfrmUc153Kougyou::EditOFFYoushikidiag1, VTS_I2 )
	ON_EVENT( CfrmUc153Kougyou, IDC_YOUSHIKIDIAG2, 1, CfrmUc153Kougyou::EditONYoushikidiag1, VTS_I2 )
// midori 151405 add -->
	ON_EVENT(CfrmUc153Kougyou, IDC_YOUSHIKIDIAG2, 12, CfrmUc153Kougyou::VScrollYoushikidiag1, VTS_I2)
// midori 151405 add <--

	ON_EVENT( CfrmUc153Kougyou, IDC_YOUSHIKIDIAG3, 3, CfrmUc153Kougyou::TerminationYoushikidiag1, VTS_I2 VTS_I2 VTS_I2 VTS_UNKNOWN )
	ON_EVENT( CfrmUc153Kougyou, IDC_YOUSHIKIDIAG3, 2, CfrmUc153Kougyou::EditOFFYoushikidiag1, VTS_I2 )
	ON_EVENT( CfrmUc153Kougyou, IDC_YOUSHIKIDIAG3, 1, CfrmUc153Kougyou::EditONYoushikidiag1, VTS_I2 )
// midori 151405 add -->
	ON_EVENT(CfrmUc153Kougyou, IDC_YOUSHIKIDIAG3, 12, CfrmUc153Kougyou::VScrollYoushikidiag1, VTS_I2)
// midori 151405 add <--

	ON_EVENT( CfrmUc153Kougyou, IDC_YOUSHIKIDIAG4, 3, CfrmUc153Kougyou::TerminationYoushikidiag1, VTS_I2 VTS_I2 VTS_I2 VTS_UNKNOWN )
	ON_EVENT( CfrmUc153Kougyou, IDC_YOUSHIKIDIAG4, 2, CfrmUc153Kougyou::EditOFFYoushikidiag1, VTS_I2 )
	ON_EVENT( CfrmUc153Kougyou, IDC_YOUSHIKIDIAG4, 1, CfrmUc153Kougyou::EditONYoushikidiag1, VTS_I2 )
// midori 151405 add -->
	ON_EVENT(CfrmUc153Kougyou, IDC_YOUSHIKIDIAG4, 12, CfrmUc153Kougyou::VScrollYoushikidiag1, VTS_I2)
// midori 151405 add <--

	ON_EVENT( CfrmUc153Kougyou, IDC_YOUSHIKIDIAG5, 3, CfrmUc153Kougyou::TerminationYoushikidiag1, VTS_I2 VTS_I2 VTS_I2 VTS_UNKNOWN )
	ON_EVENT( CfrmUc153Kougyou, IDC_YOUSHIKIDIAG5, 2, CfrmUc153Kougyou::EditOFFYoushikidiag1, VTS_I2 )
	ON_EVENT( CfrmUc153Kougyou, IDC_YOUSHIKIDIAG5, 1, CfrmUc153Kougyou::EditONYoushikidiag1, VTS_I2 )
// midori 151405 add -->
	ON_EVENT(CfrmUc153Kougyou, IDC_YOUSHIKIDIAG5, 12, CfrmUc153Kougyou::VScrollYoushikidiag1, VTS_I2)
// midori 151405 add <--

	ON_EVENT( CfrmUc153Kougyou, IDC_YOUSHIKIDIAG6, 3, CfrmUc153Kougyou::TerminationYoushikidiag1, VTS_I2 VTS_I2 VTS_I2 VTS_UNKNOWN )
	ON_EVENT( CfrmUc153Kougyou, IDC_YOUSHIKIDIAG6, 2, CfrmUc153Kougyou::EditOFFYoushikidiag1, VTS_I2 )
	ON_EVENT( CfrmUc153Kougyou, IDC_YOUSHIKIDIAG6, 1, CfrmUc153Kougyou::EditONYoushikidiag1, VTS_I2 )
// midori 151405 add -->
	ON_EVENT(CfrmUc153Kougyou, IDC_YOUSHIKIDIAG6, 12, CfrmUc153Kougyou::VScrollYoushikidiag1, VTS_I2)
// midori 151405 add <--

	ON_EVENT( CfrmUc153Kougyou, IDC_TITLEDIAG1, 3, CfrmUc153Kougyou::TerminationTitlediag1, VTS_I2 VTS_I2 VTS_I2 VTS_UNKNOWN )
	ON_EVENT( CfrmUc153Kougyou, IDC_TITLEDIAG1, 2, CfrmUc153Kougyou::EditOFFTitlediag1, VTS_I2 )
	ON_EVENT( CfrmUc153Kougyou, IDC_TITLEDIAG1, 1, CfrmUc153Kougyou::EditONTitlediag1, VTS_I2 )
	ON_EVENT( CfrmUc153Kougyou, IDC_TITLEDIAG1, 6, CfrmUc153Kougyou::FocusTitlediag1, VTS_NONE )

	ON_EVENT( CfrmUc153Kougyou, IDC_PAGEDIAG1, 3, CfrmUc153Kougyou::TerminationPagediag1, VTS_I2 VTS_I2 VTS_I2 VTS_UNKNOWN )
	ON_EVENT( CfrmUc153Kougyou, IDC_PAGEDIAG1, 2, CfrmUc153Kougyou::EditOFFPagediag1, VTS_I2 )
	ON_EVENT( CfrmUc153Kougyou, IDC_PAGEDIAG1, 1, CfrmUc153Kougyou::EditONPagediag1, VTS_I2 )
	ON_EVENT( CfrmUc153Kougyou, IDC_PAGEDIAG1, 6, CfrmUc153Kougyou::FocusPagediag1, VTS_NONE )
END_EVENTSINK_MAP()

//********************************************************************************
//	初期処理
//********************************************************************************
BOOL	CfrmUc153Kougyou::virStartJob()
{
	// 初期値設定
...
//	共通データの初期値設定
//********************************************************************************
void	CfrmUc153Kougyou::virSetInitialUchiwakeInfo()
{
	// 「工業所有権」の固有データ
	m_uInfo.intOutKeiDialog = AM_TYPE_ALL;			// 計設定ダイアログのボタン指定
	m_uInfo.intRowMax = ID_ROWKOBETU_153;			// １頁内の合計行を含む全体の行数
	m_uInfo.intRowMaxData = ID_ROWKOBETU_153 - 1;	// １頁内のデータ行数（合計行は含まず）
	m_uInfo.intColMax = ID_COLMAX_153;				// １行内のコントロール個数
	m_uInfo.intColMaxData = ID_COLMAXDATA_153;		// １行内の列数
	m_uInfo.intCtlStartIndex = ID_CTLSTARTINDEX_153;// １行目の入力項目の先頭インデックス番号
	m_uInfo.intT1StartIndex = ID_T1STARTNORMAL_153;	// 合計行①の先頭インデックス番号
	m_uInfo.intT2StartIndex = ID_T2STARTNORMAL_153;	// 合計行②の入力項目の先頭インデックス番号
	m_uInfo.intCursolDefPos = ID_COL_153_HDNAME;	// カーソル移動時の初期位置（タイトルから↓，合計から↑で使用）
	m_uInfo.intCursolKeiPos = ID_COL_153_HDNAME;	// 合計行のカーソル移動位置（カーソル移動で使用）

	m_uInfo.intFormSeq = ID_FORMNO_153;				// 様式シーケンス番号
	m_uInfo.intFormNo = 15;							// 様式番号（uc_inf_sub）
	m_uInfo.intFormNo2 = 3;							// 様式番号枝番（uc_inf_sub）

	m_uInfo.intRowNormal = ID_ROWNORMAL_153;		// 通常時：１頁内の合計行を含む全体の行数
	m_uInfo.intRowKobetu = ID_ROWKOBETU_153;		// 個別時：１頁内の合計行を含む全体の行数
	m_uInfo.intT1StartNormal = ID_T1STARTNORMAL_153;	// 通常時：合計行①の先頭インデックス
	m_uInfo.intT2StartNormal = ID_T2STARTNORMAL_153;	// 通常時：合計行②の先頭インデックス
	m_uInfo.intT1StartKobetu = ID_T1STARTKOBETU_153;	// 個別時：合計行①の先頭インデックス
	m_uInfo.intT2StartKobetu = ID_T2STARTKOBETU_153;	// 個別時：合計行②の先頭インデックス
	m_uInfo.intRowKei = ID_ROWKEI_153;				// 帳表固定の合計行数（1:合計あり，0:なし）
	m_uInfo.intKei1StartIndex = ID_COL_153_KEI1_MEISYO;	// 計ダイアグラム1行目の先頭インデックス
	m_uInfo.intKei2StartIndex = ID_COL_153_KEI2_MEISYO;	// 計ダイアグラム2行目の先頭インデックス

	// 集計処理の設定
	m_uInfo.uCalcInfo.intMaxCount = ID_CALC_153_MAX;		// 集計フィールド件数
	m_uInfo.uCalcInfo.strField[0] = ID_CALC_153_FIELD1;		// 集計フィールド名称1
}
...
// 【戻値】    なし
//**************************************************
void	CfrmUc153Kougyou::virSetInitialDiag()
{
...
//	帳表固有変数の初期値設定
//********************************************************************************
void	CfrmUc153Kougyou::virSetInitialValue()
{
	// 1ページ分のローカルバッファをクリア
	RecBufClearAllData();
...
//	帳表コントロールの初期化（データ領域）
//********************************************************************************
BOOL	CfrmUc153Kougyou::InitialControlDataArea()
{
	int		intMax;
	int		i;
// No.200903 add -->
...
// midori 200101 add -->
		...
		if(bG_Kanso == TRUE) {
			// 支払対象期間
			m_pDiag->GetAttribute((i + ID_COL_153_SPDATE - 1),(LPUNKNOWN)&diaatt);
			diaatt.attr_dayattr = 16;
			m_pDiag->SetAttribute((i + ID_COL_153_SPDATE - 1),(LPUNKNOWN)&diaatt,TRUE);
			m_pDiag->GetAttribute((i + ID_COL_153_SPDATE2 - 1),(LPUNKNOWN)&diaatt);
			diaatt.attr_dayattr = 16;
			m_pDiag->SetAttribute((i + ID_COL_153_SPDATE2 - 1),(LPUNKNOWN)&diaatt,TRUE);
		}
		else {
			// 支払対象期間
			m_pDiag->GetAttribute((i + ID_COL_153_SPDATE - 1),(LPUNKNOWN)&diaatt);
...
// midori 200101 add <--
		...
		// 漢字入力欄の初期化
		CmnDiagSetAttrInpmax( m_pDiag, i + ID_COL_153_HDNAME    - 1, MAX_KETA_153_HDNAME );		//	名称
		CmnDiagSetAttrInpmax( m_pDiag, i + ID_COL_153_ADNAME1    - 1, MAX_KETA_153_ADNAME1 );	//	支払先の名称
		CmnDiagSetAttrInpmax( m_pDiag, i + ID_COL_153_ADADD1    - 1, MAX_KETA_153_ADADD1 );		//	支払先の住所１
		CmnDiagSetAttrInpmax( m_pDiag, i + ID_COL_153_ADADD2    - 1, MAX_KETA_153_ADADD2 );		//	支払先の住所２
		CmnDiagSetAttrInpmax( m_pDiag, i + ID_COL_153_KYDATE    - 1, MAX_KETA_153_KYDATE );		//	契約期間１
		CmnDiagSetAttrInpmax( m_pDiag, i + ID_COL_153_KYDATE2    - 1, MAX_KETA_153_KYDATE2 );	//	契約期間２
		CmnDiagSetAttrInpmax( m_pDiag, i + ID_COL_153_SPDATE    - 1, MAX_KETA_153_SPDATE );		//	支払対象期間１
		CmnDiagSetAttrInpmax( m_pDiag, i + ID_COL_153_SPDATE2    - 1, MAX_KETA_153_SPDATE2 );	//	支払対象期間２
		CmnDiagSetAttrInpmax( m_pDiag, i + ID_COL_153_TEKI    - 1, MAX_KETA_153_TEKI );			//	摘要

		// 金額欄：桁数初期化
// No.200903 del -->
		//CmnDiagSetAttrDigit( m_pDiag, i + ID_COL_153_VAL - 1, ID_VAL_153_DATA );	// 支払金額
// No.200903 del <--
// No.200903 add -->
		if(bG_Kanso == TRUE)	len = ID_VAL_153_K_DATA;
		else					len = ID_VAL_153_DATA;
		CmnDiagSetAttrDigit( m_pDiag, i + ID_COL_153_VAL - 1, len );	// 支払金額
// No.200903 add <--
	...
	// 半角/全角設定
	CmnDiagSetAttrColZenHan( m_pDiag , ID_COL_153_HDNAME );		// 名称
	CmnDiagSetAttrColZenHan( m_pDiag , ID_COL_153_ADNAME1 );		// 支払先の名称1
//	↓再度使用の可能性があるためコメントにしておく
//	CmnDiagSetAttrColZenHan( m_pDiag , ID_COL_153_ADNAME2 );		// 支払先の名称2
	CmnDiagSetAttrColZenHan( m_pDiag , ID_COL_153_ADADD1 );		// 支払先の所在地1
	CmnDiagSetAttrColZenHan( m_pDiag , ID_COL_153_ADADD2 );		// 支払先の所在地2
	CmnDiagSetAttrColZenHan( m_pDiag , ID_COL_153_TEKI );		// 摘要
...
//********************************************************************************
BOOL	CfrmUc153Kougyou::InitialControlDataAreaHide( CICSDiag* pDiag )
{
	int		intMax;
	int		i;
// No.200903 add -->
...
// No.200903 add <--
	...
	for ( i = m_uInfo.intCtlStartIndex; i < intMax; i += m_uInfo.intColMax ) {
		...
		// 漢字入力欄の初期化
		CmnDiagSetAttrInpmax( pDiag, i + ID_COL_153_HDNAME    - 1, MAX_KETA_153_HDNAME );		//	名称
		CmnDiagSetAttrInpmax( pDiag, i + ID_COL_153_ADNAME1    - 1, MAX_KETA_153_ADNAME1 );	//	支払先の名称
		CmnDiagSetAttrInpmax( pDiag, i + ID_COL_153_ADADD1    - 1, MAX_KETA_153_ADADD1 );		//	支払先の住所１
		CmnDiagSetAttrInpmax( pDiag, i + ID_COL_153_ADADD2    - 1, MAX_KETA_153_ADADD2 );		//	支払先の住所２
		CmnDiagSetAttrInpmax( pDiag, i + ID_COL_153_KYDATE    - 1, MAX_KETA_153_KYDATE );		//	契約期間１
		CmnDiagSetAttrInpmax( pDiag, i + ID_COL_153_KYDATE2    - 1, MAX_KETA_153_KYDATE2 );	//	契約期間２
		CmnDiagSetAttrInpmax( pDiag, i + ID_COL_153_SPDATE    - 1, MAX_KETA_153_SPDATE );		//	支払対象期間１
		CmnDiagSetAttrInpmax( pDiag, i + ID_COL_153_SPDATE2    - 1, MAX_KETA_153_SPDATE2 );	//	支払対象期間２
		CmnDiagSetAttrInpmax( pDiag, i + ID_COL_153_TEKI    - 1, MAX_KETA_153_TEKI );			//	摘要

		// 金額欄：桁数初期化
// No.200903 del -->
		//CmnDiagSetAttrDigit( pDiag, i + ID_COL_153_VAL - 1, ID_VAL_153_DATA );	// 支払金額
// No.200903 del <--
// No.200903 add -->
		if(bG_Kanso == TRUE)	len = ID_VAL_153_K_DATA;
		else					len = ID_VAL_153_DATA;
		CmnDiagSetAttrDigit( pDiag, i + ID_COL_153_VAL - 1, len );	// 支払金額
// No.200903 add <--
	}
...
//********************************************************************************
BOOL	CfrmUc153Kougyou::InitialControlComboBox()
{
	// コンボボックスを初期化する関数です。
	return TRUE;
}
...
//********************************************************************************
void	CfrmUc153Kougyou::InitialControlTotalArea()
{
	int		nKeiType;			//	計の種別
...
// midori 152166 add <--
	...
	m_pDiagKei->ModifyItem(ID_COL_153_KEI1_VAL, intKeiRow);
	m_pDiagKei->ModifyItem(ID_COL_153_KEI2_VAL, intKeiRow);
	...
	//m_pDiag->ModifyItem( CmnGetControlTotalIndex( 1, ID_COL_153_HDNAME ), nKeiRow[0] );
	//m_pDiag->ModifyItem( CmnGetControlTotalIndex( 2, ID_COL_153_HDNAME ), nKeiRow[1] );
	
// No.200903 del -->
	//// 合計行の金額欄は、金額欄 + 1桁
	//CmnDiagSetAttrDigit( m_pDiagKei, ID_COL_153_KEI1_VAL, ID_VAL_153_TOTAL );
	//CmnDiagSetAttrDigit( m_pDiagKei, ID_COL_153_KEI2_VAL, ID_VAL_153_TOTAL );
	////CmnDiagSetAttrDigit( m_pDiag, CmnGetControlTotalIndex( 1, ID_COL_153_VAL ), ID_VAL_153_TOTAL );
	////CmnDiagSetAttrDigit( m_pDiag, CmnGetControlTotalIndex( 2, ID_COL_153_VAL ), ID_VAL_153_TOTAL );
// No.200903 del <--
}
...
//		→表示していない方のDiag(通常 or 個別)の設定に使用する
//********************************************************************************
void	CfrmUc153Kougyou::InitialControlTotalAreaHide( CICSDiag* pDiag )
{
	int intIndex = 0;
	...
	// 合計行の金額欄は、金額欄 + 1桁
	intIndex = m_intT1StartIndexHide + m_uInfo.intCtlStartIndex + ID_COL_153_VAL - 1;
	CmnDiagSetAttrDigit( pDiag, intIndex, ID_VAL_153_TOTAL );

	intIndex = m_intT2StartIndexHide + m_uInfo.intCtlStartIndex + ID_COL_153_VAL - 1;
	CmnDiagSetAttrDigit( pDiag, intIndex, ID_VAL_153_TOTAL );
}
...
//	RET	なし
//********************************************************************************
void	CfrmUc153Kougyou::InitialControlSpecialRow( int intRow, int intFgFunc )
{
	...
	case ID_FGFUNC_IKKATUAUTO:		// 一括集計金額行（自動）
		// 桁数を設定
		CmnDiagSetAttrDigit( m_pDiag, CmnGetControlIndex( intRow , ID_COL_153_VAL ), ID_VAL_153_TOTAL );
		break;
	}
...
// midori 160612 cor <--
	...
	default:
		//	特殊行以外は契約期間に"～"を表示する
		nIndex = ( ( intRow - 1 ) * m_uInfo.intColMax ) + 4;
		CmnDiagSetString( m_pDiag, nIndex, "～", TRUE );
		//	特殊行以外は支払対象期間に"～"を表示する
		nIndex = ( ( intRow - 1 ) * m_uInfo.intColMax ) + 6;
		CmnDiagSetString( m_pDiag, nIndex, "～", TRUE );
		break;
	}
}
...
//	帳表タイトル情報の表示
//********************************************************************************
void	CfrmUc153Kougyou::virUpdateControlTitle()
{
//	int		intMax;
	DIAGRAM_ATTRIBUTE diaatt;
...
//	帳表ページ情報の表示
//********************************************************************************
void	CfrmUc153Kougyou::UpdateControlPage()
{
	BOOL	bBack = TRUE;
	BOOL	bNext = TRUE;
...
//	帳表データの表示（１ページ分）
//********************************************************************************
BOOL	CfrmUc153Kougyou::virUpdateControlTblData()
{
	// ダイアログ切替
	if( m_pDiag != NULL ){
		virSetInitialDiag();
...
// No.200601 add -->
		...
		// 名称
		CmnInitialControlFgStringCell( m_pDiag, dbRec.m_NumRow, ID_COL_153_HDNAME, dbRec.m_FgFunc, UC_153_HDNAME_LEN, dbRec.m_HdName);
		// 摘要
		CmnInitialControlFgStringCell( m_pDiag, dbRec.m_NumRow, ID_COL_153_TEKI, dbRec.m_FgFunc, UC_153_TEKI_LEN, dbRec.m_Teki);
// No.200601 add <--
...
//	保管件数の表示
//********************************************************************************
BOOL CfrmUc153Kougyou::virUpdateControlTblData2()
{
	int					hcnt=0;
	CString				cs=_T("");
...
//		IN		CdbUc153Kougyou*	「工業所有権」
//		RET		なし
//********************************************************************************
void	CfrmUc153Kougyou::UpdateControlRowData( CdbUc153Kougyou* prmDbRec ) {
	DIAGRAM_DATA	diadata;	// ICSDiag構造体
	int				intCell;	// 保存フィールド
	...
	// 読込み対象セル取得
	intCell = CmnGetControlIndex( prmDbRec->m_NumRow, ID_COL_153_HDNAME );
...
/*
	// 支払先の名称2
	diadata.data_edit = prmDbRec->m_AdName2;
	m_pDiag->SetData( intCell, ( LPUNKNOWN )&diadata );
	intCell++;
*/
	// 支払先の所在地1
	...
	CdateConvert	dc;
	// 契約期間1
	dc.Convert( prmDbRec->m_KyDate, diadata.data_day, DC_DATE_GWM );
	if ( dc.m_nDate != 0 ) {
		m_pDiag->SetData( intCell, ( LPUNKNOWN )&diadata );
	}
	else {
	...
	// 契約期間2
	dc.Convert( prmDbRec->m_KyDate2, diadata.data_day, DC_DATE_GWM );
	if ( dc.m_nDate != 0 ) {
		m_pDiag->SetData( intCell, ( LPUNKNOWN )&diadata );
	}
	else {
...
// midori 200101 add <--
	...
	// 支払対象期間2
// midori 200101 del -->
	//dc.Convert( prmDbRec->m_SpDate2, diadata.data_day, DC_DATE_WM );
// midori 200101 del <--
// midori 200101 add -->
	if(bG_Kanso == TRUE) {
...
//********************************************************************************
//	帳表データの１行表示（累計，頁計行）
//		IN		CdbUc153Kougyou*	「工業所有権」テーブル情報
//		RET		なし
//********************************************************************************
void	CfrmUc153Kougyou::UpdateControlRowTotal( CdbUc153Kougyou* prmDbRec )
{
	int		intTotalType;
	int		intRowName = 0;		// 名称表示行（0:非表示）
	int		intRowVal = 0;		// 支払金額表示行（0:非表示）
	...
	// 頁計/累計の名称表示
	if ( intRowName > 0 ) {
		//CmnDiagSetString( m_pDiag, CmnGetControlTotalIndex( intRowName, ID_COL_153_HDNAME ), prmDbRec->m_KeiStr, 0 );
		CmnDiagSetString( m_pDiagKei, CmnGetKeiDiagIndex( intRowName, ID_COL_153_KEI1_MEISYO ), prmDbRec->m_KeiStr, 1 );
	}
	// 頁計/累計の金額表示
	if ( intRowVal > 0 ) {
		//CmnDiagSetKingaku( m_pDiag, CmnGetControlTotalIndex( intRowName, ID_COL_153_VAL ), prmDbRec->m_Val );
		CmnDiagSetKingaku( m_pDiagKei, CmnGetKeiDiagIndex( intRowVal, ID_COL_153_KEI1_VAL ), prmDbRec->m_Val );
	}
}
...
//		RET		なし
//********************************************************************************
void	CfrmUc153Kougyou::virFncCellCopyProc( CdbUc000Common* rsData )
{
	CdbUc153Kougyou*	rs;
	int					intCol;	// 現在の列

	rs = (CdbUc153Kougyou*)rsData;
	...
	// 名称
	case ID_COL_153_HDNAME:
		CmnDiagSetString( m_pDiag, m_uInfo.intCurCtlIndex, rs->m_HdName, 0 );
		break;
	// 支払先の名称1
	case ID_COL_153_ADNAME1:
		CmnDiagSetString( m_pDiag, m_uInfo.intCurCtlIndex, rs->m_AdName1, 0 );
		break;
//	↓再度使用の可能性があるためコメントにしておく
/*	// 支払先の名称2
	case ID_COL_153_ADNAME2:
		CmnDiagSetString( m_pDiag, m_uInfo.intCurCtlIndex, rs->m_AdName2, 0 );
		break;
*/
	// 支払先の所在地1
	case ID_COL_153_ADADD1:
		CmnDiagSetString( m_pDiag, m_uInfo.intCurCtlIndex, rs->m_AdAdd1, 0 );
		break;
	// 支払先の所在地2
	case ID_COL_153_ADADD2:
		CmnDiagSetString( m_pDiag, m_uInfo.intCurCtlIndex, rs->m_AdAdd2, 0 );
		break;
	// 契約期間1
	case ID_COL_153_KYDATE:
		CmnDiagSetDate( m_pDiag, m_uInfo.intCurCtlIndex, DC_DATE_GWM, rs->m_KyDate );
		break;
	// 契約期間2
	case ID_COL_153_KYDATE2:
		CmnDiagSetDate( m_pDiag, m_uInfo.intCurCtlIndex, DC_DATE_GWM, rs->m_KyDate2 );
		break;
	// 支払対象期間1
	case ID_COL_153_SPDATE:
// midori 200101 del -->
...
// midori 200101 add <--
		break;
	// 支払対象期間2
	case ID_COL_153_SPDATE2:
// midori 200101 del -->
		//CmnDiagSetDate( m_pDiag, m_uInfo.intCurCtlIndex, DC_DATE_WM, rs->m_SpDate2 );
// midori 200101 del <--
// midori 200101 add -->
		if(bG_Kanso == TRUE)	CmnDiagSetDate( m_pDiag, m_uInfo.intCurCtlIndex, DC_DATE_GWM, rs->m_SpDate2 );
		else					CmnDiagSetDate( m_pDiag, m_uInfo.intCurCtlIndex, DC_DATE_WM, rs->m_SpDate2 );
// midori 200101 add <--
		break;
	// 支払金額
	case ID_COL_153_VAL:
...
//********************************************************************************
int	CfrmUc153Kougyou::virFncReferenceGetType(int intCol, int* intGrSeq, long* lngItemSeq, int* intAdd1, int* intAdd2, int* intAdd1Col, int* intAdd2Col, REFERENCE_INFO* pudReference)
{
	int		intRefType = 0;
	...
	case ID_COL_153_ADADD2:
		...
		*intAdd1 = 20 * 2;			// Byte指定
		*intAdd2 = 20 * 2;			// Byte指定
		*intAdd1Col = ID_COL_153_ADADD1;
		*intAdd2Col = ID_COL_153_ADADD2;
		break;
...
//		RET		なし
//********************************************************************************
void	CfrmUc153Kougyou::virFncReferenceSetICSData(CdlgAddressSearch* dlgAddd)
{
	int			intIndex;
	...
	case ID_COL_153_ADADD2:
		//	支払先の所在地１
		intIndex = CmnGetControlIndex( m_uInfo.intCurRow, ID_COL_153_ADADD1 );
		CmnDiagSetString( m_pDiag, intIndex, dlgAddd->m_AdAdd1, 0 );
		//	支払先の所在地２
		intIndex = CmnGetControlIndex( m_uInfo.intCurRow, ID_COL_153_ADADD2 );
...
// 修正No.157633_元号日付 add -->
void CfrmUc153Kougyou::virActivateFrame(UINT nState, CFrameWnd* pDeactivateFrame)
{
	int		index = 0;
	...
	if(pWnd != NULL)	{
		if(m_DataKakutei == FALSE)	{
			if(bG_Kanso == TRUE && 
				(m_uInfo.intCurCol == ID_COL_153_KYDATE || m_uInfo.intCurCol == ID_COL_153_KYDATE2 ||
				m_uInfo.intCurCol == ID_COL_153_SPDATE || m_uInfo.intCurCol == ID_COL_153_SPDATE2))	{
				if(m_uInfo.EditSign == 1)	{
					m_uInfo.EditSign = -1;
					m_uInfo.GenListSw = 0;
					if(m_uInfo.intCurCol == ID_COL_153_KYDATE) {
						m_uInfo.OldDate[0] = 0;
						m_uInfo.OldGengo[0] = 0;
					}
					else if(m_uInfo.intCurCol == ID_COL_153_KYDATE2) {
						m_uInfo.OldDate[1] = 0;
						m_uInfo.OldGengo[1] = 0;
					}
					else if(m_uInfo.intCurCol == ID_COL_153_SPDATE) {
						m_uInfo.OldDate[2] = 0;
						m_uInfo.OldGengo[2] = 0;
					}
					else	{
						m_uInfo.OldDate[3] = 0;
						m_uInfo.OldGengo[3] = 0;
					}
				}
			}
		}
...
//	その他イベント処理
//********************************************************************************
BOOL	CfrmUc153Kougyou::PreTranslateMessage( MSG* pMsg )
{
//	int				intID;
...
// midori M-16113009 del -->
//				// ComboBoxではPageUp，PageDownキーを実行しない又は計行である又は特殊行である
//				if (((CmnGetControlCol() != ID_COL_153_KYDATE) && (CmnGetControlCol() != ID_COL_153_KYDATE2)) || (CmnCheckTotalRow() == TRUE )){
// midori M-16113009 del <--
					// カレントインデックスを保存
					...
					if (pMsg->wParam == VK_PRIOR) {
						// PageUpの場合：Scroll＋フォーカス移動（行－８）
						m_pDiag->ScrollPos(SB_PAGEUP , 0);
						intMoveRow = intMoveRow - 7;
						if (intMoveRow < 1) {
							blnMove = FALSE;					// 移動しない
						}
					}
					else {
						// PageDownの場合：Scroll＋フォーカス移動（行＋８）
...
//				}
// midori M-16113009 del <--
// midori M-16113009 add -->
// midori 155866 del -->
				//if ((CmnGetControlCol() == ID_COL_153_KYDATE) || (CmnGetControlCol() == ID_COL_153_KYDATE2)){
// midori 155866 del <--
// midori 155866 add -->
				if ((CmnGetControlCol() == ID_COL_153_KYDATE) || (CmnGetControlCol() == ID_COL_153_KYDATE2) || 
					(CmnGetControlCol() == ID_COL_153_SPDATE) || (CmnGetControlCol() == ID_COL_153_SPDATE2)){
// midori 155866 add <--
					rv = 1;
				}
// midori M-16113009 add <--
...
/*
		...
		case VK_TAB:
			...
			if ((intID == IDC_PAGEBACK_BUTTON1) && (CmnCheckShiftKey() == TRUE)) {
				...
				CmnDiagSetFocus(m_pDiag, m_uInfo.intRowMax, ID_COL_153_TEKI);
				return 1;
			}
			break;
*/
...
// midori 155866 add <--
				intCol = CmnGetControlCol();
				if (intCol == ID_COL_153_KYDATE || intCol == ID_COL_153_KYDATE2 || intCol == ID_COL_153_SPDATE || intCol == ID_COL_153_SPDATE2) {
// 修正No.157633_元号日付 add -->
					if(bG_Kanso == TRUE)	{
						if(pMsg->wParam == VK_UP || pMsg->wParam == VK_DOWN)	{
							if(intCol == ID_COL_153_KYDATE)	{
							...
							else if(intCol == ID_COL_153_KYDATE2)	{
							...
							else if(intCol == ID_COL_153_SPDATE)	{
								m_uInfo.OldDate[2] = CmnDiagGetDate(m_pDiag, m_uInfo.intCurCtlIndex, DC_DATE_GWM);
								m_uInfo.OldGengo[2] = CmnDiagGetDate(m_pDiag, m_uInfo.intCurCtlIndex, DC_DATE_GENGOU);
							}
							else if(intCol == ID_COL_153_SPDATE2)	{
								m_uInfo.OldDate[3] = CmnDiagGetDate(m_pDiag, m_uInfo.intCurCtlIndex, DC_DATE_GWM);
								m_uInfo.OldGengo[3] = CmnDiagGetDate(m_pDiag, m_uInfo.intCurCtlIndex, DC_DATE_GENGOU);
							}
							m_uInfo.GenListSw = 0;
						}
					}
...
// 頁コントロールのフォーカス設定
void	CfrmUc153Kougyou::FocusPagediag1()
{
...
// 頁コントロールのゲットフォーカス
void	CfrmUc153Kougyou::EditONPagediag1( short index )
{
// midori 151405 add -->
	// スクロールフラグをクリアする
	nG_MScroll = 0;
...
// midori 151405 add <--
	...
	// 1行登録
//	if( CmnGetControlCol() != ID_COL_153_VAL ){
...
// 頁コントロールのロストフォーカス
void	CfrmUc153Kougyou::EditOFFPagediag1( short index )
{
// midori 155028 add -->
...
// 頁コントロールのキー操作
void	CfrmUc153Kougyou::TerminationPagediag1( short index, short nChar, short length, LPUNKNOWN data )
{
	int nMaxDataCol = 0;
	// カレント頁の合計行の種別を取得
...
// midori 160612 cor <--
			...
			//CmnDiagSetFocus(m_pDiag, m_uInfo.intRowMax, ID_COL_153_TEKI);
			CmnDiagSetFocus(m_pDiag, nMaxDataCol, ID_COL_153_TEKI);
		}
		break;
	case VK_DOWN:
		// タイトルコントロールへ移動
...
// タイトルコントロールのフォーカス設定
void	CfrmUc153Kougyou::FocusTitlediag1()
{
//マウスクリックでキャレットが表示できないためコメントとする
//	// ボタンからTabキー移動した場合に必要
//	m_TitleDiag.SetPosition( 0 );
...
// タイトルコントロールのゲットフォーカス
void	CfrmUc153Kougyou::EditONTitlediag1( short index )
{
// midori 151405 add -->
	// スクロールフラグをクリアする
	nG_MScroll = 0;
...
// タイトルコントロールのロストフォーカス
void	CfrmUc153Kougyou::EditOFFTitlediag1 (short index )
{
// midori 151405 add -->
	m_Titlefocus = 0;
// midori 151405 add <--
...
//	タイトル更新
void CfrmUc153Kougyou::virUpdateTitle()
{
...
// タイトルコントロールのキーイベント
void	CfrmUc153Kougyou::TerminationTitlediag1( short index, short nChar, short length, LPUNKNOWN data )
{
	// フォーカス移動
	switch ( nChar ) {
	case VK_RETURN:
...
//********************************************************************************
//	「工業所有権」データコントロール処理（EditON，EditOFF，Terminationイベント）
//********************************************************************************

// 「工業所有権」データコントロールのゲットフォーカス
void	CfrmUc153Kougyou::EditONYoushikidiag1( short index )
{
...
// 修正No.157633_元号日付 add -->
		...
		break;
// 修正No.157633_元号日付 add <--
	case ID_COL_153_SPDATE:		// 支払対象期間1
// 修正No.157633_元号日付 add -->
		if(bG_Kanso == TRUE && m_uInfo.GenListSw == 0)	{
			m_uInfo.OldDate[2] = 0;
			m_uInfo.OldGengo[2] = 0;
		...
		break;
// 修正No.157633_元号日付 add <--
	case ID_COL_153_SPDATE2:	// 支払対象期間2
// midori 200101 del -->
		//// 日付の値を取得
...
// データコントロールのロストフォーカス
void	CfrmUc153Kougyou::EditOFFYoushikidiag1( short index )
{
	if( m_EndView != FALSE )	return;
...
//	入力確定
void CfrmUc153Kougyou::virInputDecisionEditOFF()
{
	// フォーカスフラグOFF
...
// 預貯金データコントロールのキーイベント
void	CfrmUc153Kougyou::TerminationYoushikidiag1( short index, short nChar, short length, LPUNKNOWN data )
{
	//--------------------------------------------------------------------------------
	//	キー操作仕様
...
// 修正No.157633_元号日付 add -->
			if(bG_Kanso == TRUE)	{
				...
				if( intCol == ID_COL_153_KYDATE || intCol == ID_COL_153_KYDATE2 || 
					intCol == ID_COL_153_SPDATE || intCol == ID_COL_153_SPDATE2)	{
...
// midori 151405 add -->
void CfrmUc153Kougyou::VScrollYoushikidiag1(short mode)
{
...
//********************************************************************************
int	CfrmUc153Kougyou::GetFocusPosition( int nChar )
{
	int		intRow;				// カレント行番号
	int		intCol;				// カレント列番号
...
// midori 151405 add <--
	...
	if ( intCol == ID_COL_153_HDNAME ) {
	...
	else if ( intCol == ID_COL_153_ADNAME1 ) {
		// カレント列が「支払先の名称」の場合
	...
	else if ( intCol == ID_COL_153_ADADD1 ) {
		// カレント列が「支払先の所在地1」の場合
	...
	else if ( intCol == ID_COL_153_ADADD2 ) {
		// カレント列が「支払先の所在地2」の場合
		intVector[0] = m_uInfo.intCurCtlIndex - 1;						// ↑
		intVector[1] = m_uInfo.intCurCtlIndex + 1;						// →
	...
	else if (( intCol == ID_COL_153_KYDATE ) ||
			 ( intCol == ID_COL_153_SPDATE )){
		// カレント列が「契約期間1」,「支払対象期間1」の場合
		...
		intVector[3] = m_uInfo.intCurCtlIndex - 1;						// ←
			 ...
			 ( intCol == ID_COL_153_SPDATE2 )){
		// カレント列が「契約期間2」,「支払対象期間2」の場合
		intVector[0] = m_uInfo.intCurCtlIndex - 1;						// ↑
		intVector[1] = m_uInfo.intCurCtlIndex + 1;						// →
		intVector[2] = m_uInfo.intCurCtlIndex + m_uInfo.intColMax - 1;	// ↓
		intVector[3] = m_uInfo.intCurCtlIndex - 1;						// ←
	}
	else if ( intCol == ID_COL_153_TEKI ) {
		// カレント列が「摘要」の場合
		intVector[0] = m_uInfo.intCurCtlIndex - m_uInfo.intColMax;		// ↑
	...
	case VK_RETURN:	// Enterキーでカーソルを下に移動するモード対応
		// 契約期間は自と至で１セットの為、下移動モードでも自からは至へ移動する
		if(m_ReturnMoveDown && intCol != ID_COL_153_KYDATE)	intNext = intVector[2];			//	Enterキーでカーソルを下に移動するチェック時は「↓」キーと同じ
...
//********************************************************************************
int	CfrmUc153Kougyou::GetTotalRowIndex( int nCharOrg, int intIndex, int intNext )
{
	...
	if ( nNowRow <= nBorder[0] ){
		...
		if (( intNext > CmnGetControlIndex( m_uInfo.intRowMax, ID_COL_153_TEKI ) ) && ( nCharOrg == VK_TAB )){
			return( -2 );
		}
		//	データ行を超えた？かつ計行あり？
		else if (( nNextRow > nBorder[0] ) && ( nBorder[1] > 0 )){
			//	計行に移動
			//nRet = CmnGetControlIndex( ( nBorder[1] + 2 ), ID_COL_153_HDNAME );
			if (nCharOrg == VK_TAB) {
				return -2;
			}
		}
	...
	//	現在、頁計に居る
		...
		case VK_UP:			// ↑：23行目のデータ行の支店名項目へ移動
			nRet = CmnGetControlIndex( nBorder[0], ID_COL_153_HDNAME );
			break;
		case VK_LEFT:		// ←/Shift+Tab：23行目のデータ行の摘要項目へ移動
			nRet = CmnGetControlIndex( nBorder[0], ID_COL_153_TEKI );
			break;
		default:			// →/↓/Return/Tab：25行目の合計行②へ移動
			...
			//	累計なし
				...
				nRet = CmnGetControlIndex( ( nBorder[2] + 2 ), ID_COL_153_HDNAME );
			}
			break;
		}
	}
...
//********************************************************************************
int	CfrmUc153Kougyou::virTblSortSubSortProc( CdlgSort* pCdlgSort, CdbUc000Common* rsData )
{
	CdbUc153Kougyou*	rs;
	CString				strFilter;
	CString				strSort;
...
/**********************************************************************
	RecBufSetData(CdbUc153Kougyou* prmDbRec)
		ローカルのレコードバッファに、1行分のデータを格納する

	引数
		CdbUc153Kougyou*	prmDbRec	レコードセット(データがあること）
	戻値
		int		成功/失敗
				FUNCTION_OK
***********************************************************************/
int	CfrmUc153Kougyou::RecBufSetData( CdbUc153Kougyou* prmDbRec )
{
	...
	m_ReadData[trgRow].m_HdName = prmDbRec->m_HdName;	// 名称
	m_ReadData[trgRow].m_AdSeq = prmDbRec->m_AdSeq;	// 取引先（シーケンス番号）
	m_ReadData[trgRow].m_AdOrder = prmDbRec->m_AdOrder;	// 取引先（並び順）
	m_ReadData[trgRow].m_AdName1 = prmDbRec->m_AdName1;	// 支払先（名称１）
	m_ReadData[trgRow].m_AdName2 = prmDbRec->m_AdName2;	// 支払先（名称２）
	m_ReadData[trgRow].m_AdAdd1 = prmDbRec->m_AdAdd1;	// 支払先（所在地：上段）
	m_ReadData[trgRow].m_AdAdd2 = prmDbRec->m_AdAdd2;	// 支払先（所在地：下段）
	m_ReadData[trgRow].m_KyDate = prmDbRec->m_KyDate;	// 契約期間（開始）
	m_ReadData[trgRow].m_KyDate2 = prmDbRec->m_KyDate2;	// 契約期間（終了）
	m_ReadData[trgRow].m_SpDate = prmDbRec->m_SpDate;	// 支払対象期間（開始）
	m_ReadData[trgRow].m_SpDate2 = prmDbRec->m_SpDate2;	// 支払対象期間（終了）
	m_ReadData[trgRow].m_Val = prmDbRec->m_Val;	// 支払金額
...
/**********************************************************************
	...
	戻値
		int		成功/失敗
				FUNCTION_OK
***********************************************************************/
int	CfrmUc153Kougyou::RecBufClearAllData()
{
...
/**********************************************************************
	...
	引数
		P_REC_UC_153_KOUGYOU inRecData レコードへのポインタ
	戻値
		int		成功/失敗
				FUNCTION_OK
***********************************************************************/
int	CfrmUc153Kougyou::RecBufClearData( P_REC_UC_153_KOUGYOU inRecData )
{
	...
	inRecData->m_HdName = _T("");	// 名称
	inRecData->m_AdSeq = 0;	// 取引先（シーケンス番号）
	inRecData->m_AdOrder = 0;	// 取引先（並び順）
	inRecData->m_AdName1 = _T("");	// 支払先（名称１）
	inRecData->m_AdName2 = _T("");	// 支払先（名称２）
	inRecData->m_AdAdd1 = _T("");	// 支払先（所在地：上段）
	inRecData->m_AdAdd2 = _T("");	// 支払先（所在地：下段）
	inRecData->m_KyDate = 0;	// 契約期間（開始）
	inRecData->m_KyDate2 = 0;	// 契約期間（終了）
	inRecData->m_SpDate = 0;	// 支払対象期間（開始）
	inRecData->m_SpDate2 = 0;	// 支払対象期間（終了）
	inRecData->m_Val = _T("");	// 支払金額
...
/**********************************************************************
	...
	戻値
		int				成功(更新あり)/成功(更新なし)/失敗
						...
						FUNCTION_NG		: 失敗
***********************************************************************/
int	CfrmUc153Kougyou::virRecBufSaveData( int inPage, int inRow )
{
	REC_UC_153_KOUGYOU	tmpSaveData;	// 画面データ1レコード格納用
	...
	// 名称
	intIndex = CmnGetControlIndex( inRow, ID_COL_153_HDNAME );
	tmpSaveData.m_HdName = m_clsFunc.DiagGetString( m_pDiag, intIndex );

	// 支払先の名称1
	intIndex = CmnGetControlIndex( inRow, ID_COL_153_ADNAME1 );
	tmpSaveData.m_AdName1 = m_clsFunc.DiagGetString( m_pDiag, intIndex );
//	↓再度使用の可能性があるためコメントにしておく
/*
	// 支払先の名称2
	intIndex = CmnGetControlIndex( inRow, ID_COL_153_ADNAME2 );
	tmpSaveData.m_AdName2 = m_clsFunc.DiagGetString( m_pDiag, intIndex );
*/
	// 支払先の所在地1
	intIndex = CmnGetControlIndex( inRow, ID_COL_153_ADADD1 );
	tmpSaveData.m_AdAdd1 = m_clsFunc.DiagGetString( m_pDiag, intIndex );

	// 支払先の所在地2
	intIndex = CmnGetControlIndex( inRow, ID_COL_153_ADADD2 );
	tmpSaveData.m_AdAdd2 = m_clsFunc.DiagGetString( m_pDiag, intIndex );

	// 契約期間1
	intIndex = CmnGetControlIndex( inRow, ID_COL_153_KYDATE );
// midori 200101 del -->
//	tmpSaveData.m_KyDate = CmnDiagGetDate( m_pDiag, intIndex, DC_DATE_GWM );
// midori 200101 del <--
// midori 200101 add -->
	tmpSaveData.m_KyDate = CmnDiagGetDateGWM( m_pDiag, intIndex, m_ReadData[inRow].m_KyDate );
// midori 200101 add <--

	// 契約期間2
	intIndex = CmnGetControlIndex( inRow, ID_COL_153_KYDATE2 );
// midori 200101 del -->
//	tmpSaveData.m_KyDate2 = CmnDiagGetDate( m_pDiag, intIndex, DC_DATE_GWM );
// midori 200101 del <--
// midori 200101 add -->
	tmpSaveData.m_KyDate2 = CmnDiagGetDateGWM( m_pDiag, intIndex, m_ReadData[inRow].m_KyDate2 );
// midori 200101 add <--

	// 支払対象期間1
	intIndex = CmnGetControlIndex( inRow, ID_COL_153_SPDATE );
// midori 200101 del -->
//// midori 123 del -->
...
// midori 200101 add <--
	...
	// 支払対象期間2
	intIndex = CmnGetControlIndex( inRow, ID_COL_153_SPDATE2 );
// midori 200101 del -->
//// midori 123 del -->
////	tmpSaveData.m_SpDate2 = CmnDiagGetDate( m_pDiag, intIndex, DC_DATE_WM );
//// midori 123 del <--
//// midori 123 add -->
//	tmpSaveData.m_SpDate2 = CmnDiagGetDateWM( m_pDiag, intIndex, m_ReadData[inRow].m_SpDate2 );
//// midori 123 add <--
// midori 200101 del <--
// midori 200101 add -->
	if(bG_Kanso == TRUE)	tmpSaveData.m_SpDate2 = CmnDiagGetDateGWM( m_pDiag, intIndex, m_ReadData[inRow].m_SpDate2 );
	else					tmpSaveData.m_SpDate2 = CmnDiagGetDateWM( m_pDiag, intIndex, m_ReadData[inRow].m_SpDate2 );
// midori 200101 add <--

	// 支払金額
	intIndex = CmnGetControlIndex( inRow, ID_COL_153_VAL );
	tmpSaveData.m_Val = CmnDiagGetKingaku( m_pDiag, intIndex );

	// 摘要
	intIndex = CmnGetControlIndex( inRow, ID_COL_153_TEKI );
...
***********************************************************************/
int	CfrmUc153Kougyou::virRecBufSaveDataForPasteInsert( int inPage, int inRow )
{
...
***********************************************************************/
int	CfrmUc153Kougyou::virRecBufSaveDataForPaste( int inPage, int inRow )
{
	///////////////////////////////////////////////////////////////
	// 登録処理呼び出し
	return RecBufSaveDataSub( inPage, inRow, &m_CopyData );
...
/**********************************************************************
	...
	戻値
			int					成功(更新あり)/成功(更新なし)/失敗
								...
								FUNCTION_NG		: 失敗
***********************************************************************/
int	CfrmUc153Kougyou::RecBufSaveDataSub( 
							int inPage,
							int inRow,
							P_REC_UC_153_KOUGYOU inSaveData )
{
	REC_UC_153_KOUGYOU udtTemp;
...
//	// 変更があったかのフラグ（変更あり:TRUE、なし:FALSE)
	...
	BOOL	ufgHdName = FALSE;	// 変更確認フラグ(名称)
	BOOL	ufgAdName1 = FALSE;	// 変更確認フラグ(支払先の名称1)
	BOOL	ufgAdAdd1 = FALSE;	// 変更確認フラグ(支払先の所在地1)
	BOOL	ufgAdAdd2 = FALSE;	// 変更確認フラグ(支払先の所在地2)
	BOOL	ufgKyDate = FALSE;	// 変更確認フラグ(契約期間1)
	BOOL	ufgKyDate2 = FALSE;	// 変更確認フラグ(契約期間2)
	BOOL	ufgSpDate = FALSE;	// 変更確認フラグ(支払対象期間1)
	BOOL	ufgSpDate2 = FALSE;	// 変更確認フラグ(支払対象期間2)
	BOOL	ufgVal = FALSE;		// 変更確認フラグ(支払金額)
	...
	if ( udtTemp.m_FgFunc <= ID_FGFUNC_DATA ) {	// データ行 または、空行なら
		...
		if ( ( udtTemp.m_HdName == "" )		// 画面上のデータ格納用(名称)
		  && ( udtTemp.m_AdName1 == "" )		// 画面上のデータ格納用(支払先の名称1)
		  && ( udtTemp.m_AdName2 == "" )		// 画面上のデータ格納用(支払先の名称2)
		  && ( udtTemp.m_AdAdd1 == "" )		// 画面上のデータ格納用(支払先の所在地1)
		  && ( udtTemp.m_AdAdd2 == "" )		// 画面上のデータ格納用(支払先の所在地2)
		  && ( udtTemp.m_KyDate == 0 )		// 画面上のデータ格納用(契約期間1)
		  && ( udtTemp.m_KyDate2 == 0 )		// 画面上のデータ格納用(契約期間2)
		  && ( udtTemp.m_SpDate == 0 )		// 画面上のデータ格納用(支払対象期間1)
		  && ( udtTemp.m_SpDate2 == 0 )		// 画面上のデータ格納用(支払対象期間2)
		  && ( udtTemp.m_Val == "" )		// 画面上のデータ格納用(支払金額)
	...
	if ( udtTemp.m_AdName1 != m_ReadData[inRow].m_AdName1 ) {
		ufgUpData = TRUE;		// 全体(データ行/空行)
		ufgAdName1 = TRUE;		// 「支払先の名称1」用
	}

	//(4) 支払先の所在地1
	if ( udtTemp.m_AdAdd1 != m_ReadData[inRow].m_AdAdd1 ) {
		ufgUpData = TRUE;		// 全体(データ行/空行)
		ufgAdAdd1 = TRUE;		// 「支払先の所在地1」用
	}

	//(5) 支払先の所在地2
	if ( udtTemp.m_AdAdd2 != m_ReadData[inRow].m_AdAdd2 ) {
		ufgUpData = TRUE;		// 全体(データ行/空行)
		ufgAdAdd2 = TRUE;		// 「支払先の所在地2」用
	}

	//(6) 契約期間1
	if ( udtTemp.m_KyDate != m_ReadData[inRow].m_KyDate ) {
		ufgUpData = TRUE;		// 全体(データ行/空行)
		ufgKyDate = TRUE;		// 「契約期間1」用
	}

	//(7) 契約期間2
	if ( udtTemp.m_KyDate2 != m_ReadData[inRow].m_KyDate2 ) {
		ufgUpData = TRUE;		// 全体(データ行/空行)
		ufgKyDate2 = TRUE;		// 「契約期間2」用
	}

	//(8) 支払対象期間1
	if ( udtTemp.m_SpDate != m_ReadData[inRow].m_SpDate ) {
		ufgUpData = TRUE;		// 全体(データ行/空行)
		ufgSpDate = TRUE;		// 「支払対象期間1」用
	}

	//(9) 支払対象期間2
	if ( udtTemp.m_SpDate2 != m_ReadData[inRow].m_SpDate2 ) {
		ufgUpData = TRUE;		// 全体(データ行/空行)
		ufgSpDate2 = TRUE;		// 「支払対象期間2」用
	}
	...
	if ( ( udtTemp.m_FgFunc == ID_FGFUNC_DATA ) || ( udtTemp.m_FgFunc == ID_FGFUNC_IKKATUMANUAL ) ) {	// データ行or一括集計金額行（手動）
		...
		if ( ufgUpData == TRUE ) {		// テーブルへ更新(1レコード更新)
			...
			if ( !rs.IsEOF() ) {		// レコードが取得できた(取得できないことはないはず)
				...
				// 契約期間1
				if ( ufgKyDate == TRUE ) {	// 変更ありの場合
					rs.m_KyDate = udtTemp.m_KyDate;
				}

				// 契約期間2
				if ( ufgKyDate2 == TRUE ) {	// 変更ありの場合
					rs.m_KyDate2 = udtTemp.m_KyDate2;
				}
		...
		if ( ufgUpData == TRUE ) {		// テーブルへ更新(1レコード更新)
			...
			if ( !rs.IsEOF() ) {		// レコードが取得できた(取得できないことはないはず)
				...
				rs.m_AdName1 = _T("");	// 支払先（名称１）
				rs.m_AdName2 = _T("");	// 支払先（名称２）
				rs.m_AdAdd1 = _T("");	// 支払先（所在地：上段）
				rs.m_AdAdd2 = _T("");	// 支払先（所在地：下段）
				rs.m_KyDate = 0;	// 契約期間（開始）
				rs.m_KyDate2 = 0;	// 契約期間（終了）
...
//********************************************************************************
//	「工業所有権」テーブルのオブジェクトを生成し、ポインタを返す
//********************************************************************************
CdbUc000Common*	CfrmUc153Kougyou::virGetDataTableObject()
{
	// 「工業所有権」テーブルのオブジェクトを生成し、ポインタを返す
	return (CdbUc000Common*)( new CdbUc153Kougyou( m_pDB ) );
}
...
//	RET	なし
//********************************************************************************
void	CfrmUc153Kougyou::virRowButtonCopyProc()
{
...
//	RET	なし
//********************************************************************************
void	CfrmUc153Kougyou::virGetCurrentInfo( CURRENT_INFO* uCurInfo )
{
...
//********************************************************************************
int	CfrmUc153Kougyou::virUpdateRelationTblChengeFormType()
{
	// ⑮-3で通常/個別を変更した場合、⑮-1の頁構成の更新が必要となる
	CfrmUc151Tidaiyatin	pfrm151;
// midori 152770 del -->
//	int intRet1 = pfrm151.UpdateTbl151ChangeFormType();
// midori 152770 del <--
// midori 152770 add -->
	int intRet1 = pfrm151.UpdateTbl151ChangeFormType(m_uInfoSv);
// midori 152770 add <--

	// ⑮-3で通常/個別を変更した場合、⑮-2の頁構成の更新が必要となる
	CfrmUc152Kenrikin	pfrm152;
	int intRet2 = pfrm152.UpdateTbl152ChangeFormType();
...
//		RET		BOOL		TRUE:正常終了，FALSE:エラー
//********************************************************************************
BOOL CfrmUc153Kougyou::virUpdateRelationTblChengeFormTypeSave()
{
	// ④-1で通常/個別を変更した場合、④-2のm_uInfoを保存する
	CfrmUc151Tidaiyatin	pfrm151;
	BOOL				ret=FALSE;

	ret = pfrm151.CmnSetInitialUchiwakeInfo(ID_FORMNO_151);

	m_uInfoSv = pfrm151.m_uInfo;
...
// midori 152770 del -->
////********************************************************************************
////	通常/個別切り替え時の頁構成を更新（⑮-1，⑮-2から実行される処理）
////		IN		なし
////		RET		なし
////********************************************************************************
//int	CfrmUc153Kougyou::UpdateTbl153ChangeFormType()
//{
//	// 初期値設定
//	CmnSetInitialUchiwakeInfo(ID_FORMNO_153);	// 共通データ
//	virSetInitialValue();						// 帳表固有データ
//
//	// データ無しならデータ更新しない
...
//		RET		なし
//********************************************************************************
int	CfrmUc153Kougyou::UpdateTbl153ChangeFormType(UCHIWAKE_INFO pInfoSv)
{
	// データ無しならデータ更新しない
...
//	【戻値】	なし
//**************************************************
void CfrmUc153Kougyou::SetInputMode( int nRow, long nMode )
{
	m_pDiag->ModifyItem( CmnGetControlIndex( nRow, ID_COL_153_HDNAME ), nMode );	//	名称
	m_pDiag->ModifyItem( CmnGetControlIndex( nRow, ID_COL_153_ADNAME1 ), nMode );	//	支払先
	m_pDiag->ModifyItem( CmnGetControlIndex( nRow, ID_COL_153_ADADD1 ), nMode );	//	所在地（上段）
	m_pDiag->ModifyItem( CmnGetControlIndex( nRow, ID_COL_153_ADADD2 ), nMode );	//	所在地（下段）
	m_pDiag->ModifyItem( CmnGetControlIndex( nRow, ID_COL_153_KYDATE ), nMode );	//	契約期間（上段）
	m_pDiag->ModifyItem( CmnGetControlIndex( nRow, ID_COL_153_KYDATE2 ), nMode );	//	契約期間（下段）
	m_pDiag->ModifyItem( CmnGetControlIndex( nRow, ID_COL_153_SPDATE ), nMode );	//	支払対象期間（上段）
	m_pDiag->ModifyItem( CmnGetControlIndex( nRow, ID_COL_153_SPDATE2 ), nMode );	//	支払対象期間（下段）
	m_pDiag->ModifyItem( CmnGetControlIndex( nRow, ID_COL_153_VAL ), nMode );		//	支払金額
	m_pDiag->ModifyItem( CmnGetControlIndex( nRow, ID_COL_153_TEKI ), nMode );		//	摘要
}
...
//	【戻値】	なし
//**************************************************
void CfrmUc153Kougyou::SetDiagBackColor()
{
...
//***************************************************************************
BOOL CfrmUc153Kougyou::virEndProc(void)
{
	TRACE(_T("***** CfrmUc153Kougyou::virEndProc\n"));
...
// midori 151405 add -->
int CfrmUc153Kougyou::CursorControl(short nChar, int sw)
{
	int				rv=0;
	int				intCol=0;
// midori 154712 add -->
...
// midori 154712 del <--
// midori 154712 add -->
		// 以下の条件がすべて成立する場合は何もしない
		// 1.最終行の契約期間(終了)にフォーカスがある
		// 2.ENTERキー押下
		// 3.オプションのENTERキー押下の動作が↓
		if(m_uInfo.intFormType == ID_FORMTYPE_NORMAL)	intMax = ID_ROWNORMAL_153;
		else											intMax = ID_ROWKOBETU_153;
		if(intTotalType == 1)		intMax=intMax-1;	// 頁計
		else if(intTotalType == 2)	intMax=intMax-1;	// 累計
		else if(intTotalType == 3)	intMax=intMax-2;	// 頁計＋累計
		if(intRow == intMax && intCol == ID_COL_153_KYDATE2 && nChar == VK_RETURN && m_ReturnMoveDown)	{
			pos = m_pDiag->GetPosition();
			m_pDiag->SetPosition(pos);
		}
		else	{
...
// ------------------------------------------------------------------------------------------------------------------------
void CfrmUc153Kougyou::TitleColorChg(void)
{
	int					nCharOver[2]={0};	// 電子申告の文字数を超えたかどうかのサイン		1:電子申告の文字数を超えた
											// 様式⑮-3		[0]:名称(10文字)	[1]:摘要(40文字)
// 修正No.157626 add -->
	int					totaltype=0;		// 合計タイプ
	BOOL				bSign[4]={FALSE};	// 欄外ガイド表示/非表示のサイン
// 修正No.157626 add <--
	CRecordset			rs(m_pDB);
	CString				strSQL=_T("");
	CString				strData=_T("");
	...
	// 名称
// 修正No.157628 del -->
	//strSQL.Format(_T("select max(oversgn) from (select CASE when len(Replace(isnull(HdName,''),CHAR(13)+CHAR(10),'')) > %d then 1 else 0 end as oversgn from uc_153_kougyou where FgShow=%d) tbl1"),UC_153_HDNAME_LEN,ID_FGSHOW_OFF);
// 修正No.157628 del <--
// 修正No.157628 add -->
	strSQL.Format(_T("select max(oversgn) from (select CASE when len(%s) > %d then 1 else 0 end as oversgn from uc_153_kougyou where FgShow=%d) tbl1"),
		MakeReplaceSent(_T("HdName")),UC_153_HDNAME_LEN,ID_FGSHOW_OFF);
// 修正No.157628 add <--
	...
	// 摘要
// 修正No.157628 del -->
	//strSQL.Format(_T("select max(oversgn) from (select CASE when len(Replace(isnull(Teki,''),CHAR(13)+CHAR(10),'')) > %d then 1 else 0 end as oversgn from uc_153_kougyou where FgShow=%d) tbl1"),UC_153_TEKI_LEN,ID_FGSHOW_OFF);
// 修正No.157628 del <--
// 修正No.157628 add -->
	strSQL.Format(_T("select max(oversgn) from (select CASE when len(%s) > %d then 1 else 0 end as oversgn from uc_153_kougyou where FgShow=%d) tbl1"),
		MakeReplaceSent(_T("Teki")),UC_153_TEKI_LEN,ID_FGSHOW_OFF);
// 修正No.157628 add <--
	rs.Open( CRecordset::forwardOnly, strSQL);
	rs.GetFieldValue((short)0, strData);
	rs.Close();
	...
	// 項目タイトル(ヘッダ部)の再設定
// 修正No.157626 del -->
	//CmnHeadDiagSetTitle(&m_HeadDiag,0,_T("名  称(10)"),nCharOver[0]);
	//CmnHeadDiagSetTitle(&m_HeadDiag,7,_T("摘  要(40)"),nCharOver[1]);
// 修正No.157626 del <--
// 修正No.157626 add -->
	if(nCharOver[0] == 1)	CmnHeadDiagSetTitle(&m_HeadDiag,0,_T("名  称(10)"),1);
	else					CmnHeadDiagSetTitle(&m_HeadDiag,0,_T("名　称"),0);

	if(nCharOver[1] == 1)	CmnHeadDiagSetTitle(&m_HeadDiag,7,_T("摘  要(40)"),1);
	else					CmnHeadDiagSetTitle(&m_HeadDiag,7,_T("摘　要"),0);

	// 欄外ガイドの表示
	bSign[0] = FALSE;	// m_Guide11
	bSign[1] = FALSE;	// m_Guide12
	bSign[2] = FALSE;	// m_Guide13
	bSign[3] = FALSE;	// m_Guide2
	if(nCharOver[0] == 1 || nCharOver[1] == 1)	{
		// 出力形式：通常
		if(m_uInfo.intFormType == ID_FORMTYPE_NORMAL)	{
			// カレント頁の合計行の種別を取得
			totaltype = CmnGetControlTotalType();
			switch(totaltype)	{
				case ID_OUTKEI_OFF:		// オフ
					bSign[1] = TRUE;
					break;
	...
	// 表示/非表示
	m_Guide11.ShowWindow(bSign[0]);
	m_Guide12.ShowWindow(bSign[1]);
	m_Guide13.ShowWindow(bSign[2]);
	m_Guide2.ShowWindow(bSign[3]);
// 修正No.157626 add <--
}
// No.200601 add <--
...
// --------------------------------------------------------------------------------------------------------
void CfrmUc153Kougyou::Date_ChkAndSet(short index, int col, short sign)
{
	short			sv_sel=0;
	int				sv_index=0;
	int				day=0,gen=0;
	...
	if(col != ID_COL_153_KYDATE && col != ID_COL_153_KYDATE2 && col != ID_COL_153_SPDATE && col != ID_COL_153_SPDATE2)	return;

	if(m_uInfo.EditSign == -1)																							return;

	// 「契約期間 支払対象期間」列なら入力された日付を取得
	...
	if(sign == 1)	{
		if(col == ID_COL_153_KYDATE)	{		// 契約期間1
		...
		else if(col == ID_COL_153_KYDATE2)	{		// 契約期間2
		...
		else if(col == ID_COL_153_SPDATE)	{		// 支払対象期間1
			if(m_uInfo.OldDate[2] > 0 || m_uInfo.OldGengo[2] > 0)	{
				// 初期化
				m_clsFunc.DiagInit( &diadata );

				if(m_uInfo.GenListSw == 0 && m_uInfo.OldDate[2] > 0 && day == 0)	{
					// 元号リストが表示されたことにより日付がクリアされるので、
					// 保存している日付を再セット
					m_uInfo.GenListSw++;

					cDC.Convert( m_uInfo.OldDate[2], diadata.data_day, DC_DATE_GWM );
					if(cDC.m_nDate != 0)	m_pDiag->SetData(index, ( LPUNKNOWN )&diadata);
					else					m_pDiag->DataClear(index, TRUE);
				}
				else if(m_uInfo.GenListSw > 0)	{
		...
		else if(col == ID_COL_153_SPDATE2)	{		// 支払対象期間2
			if(m_uInfo.OldDate[3] > 0 || m_uInfo.OldGengo[3] > 0)	{
				// 初期化
				m_clsFunc.DiagInit( &diadata );

				if(m_uInfo.GenListSw == 0 && m_uInfo.OldDate[3] > 0 && day == 0)	{
					// 元号リストが表示されたことにより日付がクリアされるので、
					// 保存している日付を再セット
					m_uInfo.GenListSw++;

					cDC.Convert( m_uInfo.OldDate[3], diadata.data_day, DC_DATE_GWM );
					if(cDC.m_nDate != 0)	m_pDiag->SetData(index, ( LPUNKNOWN )&diadata);
					else					m_pDiag->DataClear(index, TRUE);
				}
				else if(m_uInfo.GenListSw > 0)	{
...
// 修正No.162446 add -->
LRESULT CfrmUc153Kougyou::OnUserReDrawView(WPARAM wParam, LPARAM lParam)
{
	virUpdateControlTblData();
	CmnDiagSetFocus(m_pDiag, 1, 1);
