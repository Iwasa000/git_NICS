...
#define	ID_COLMAX_162I			14			// １行内のコントロール個数
#define	ID_COLMAXDATA_162I		8			// １行内の入力コントロール数
#define	ID_CTLSTARTINDEX_162I	6			// １行目の入力項目の先頭インデックス番号
#define ID_T1STARTNORMAL_162I	/*110*/140	// 通常時：合計行①の先頭インデックス番号
#define ID_T2STARTNORMAL_162I	/*121*/154	// 通常時：合計行②の先頭インデックス番号
#define ID_T1STARTKOBETU_162I	/*220*/280	// 個別時：合計行①の先頭インデックス番号
#define ID_T2STARTKOBETU_162I	/*231*/294	// 個別時：合計行②の先頭インデックス番号
...
typedef enum {
	ID_COL_162I_KNORDER = 1,			// 1	科目
	ID_COL_162I_NAIYOU,					// 2	取引の内容
	ID_COL_162I_INVONOT,				// 3	登録番号（T選択）
	ID_COL_162I_INVONO,					// 4	登録番号
	ID_COL_162I_ADNAME1,				// 5	相手先1
	ID_COL_162I_ADADD1,					// 6	所在地1
	ID_COL_162I_ADADD2,					// 7	所在地2
	ID_COL_162I_VAL,					// 8	金額
} EnumIdFormCol162I;
...
#define ID_COL_162I_KEI1_MEISYO		0			// 計ダイアログ1行目の計名称（計or合計、頁計、累計）
#define ID_COL_162I_KEI1_VAL		/*5*/6		// 計ダイアログ1行目の金額
#define ID_COL_162I_KEI2_MEISYO		/*6*/7		// 計ダイアログ2行目の計名称（計or合計、頁計、累計）
#define ID_COL_162I_KEI2_VAL		/*11*/13	// 計ダイアログ2行目の金額
...
class CfrmUc162ZatusonI: public CfrmUc000Common
{
	DECLARE_DYNCREATE( CfrmUc162ZatusonI )

public:
	CfrmUc162ZatusonI();
	virtual	~CfrmUc162ZatusonI();
