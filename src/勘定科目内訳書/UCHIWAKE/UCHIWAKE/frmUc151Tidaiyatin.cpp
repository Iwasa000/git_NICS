...
IMPLEMENT_DYNCREATE( CfrmUc151Tidaiyatin, CfrmUc000Common )


BEGIN_MESSAGE_MAP( CfrmUc151Tidaiyatin, CfrmUc000Common )
	ON_WM_SIZE()
...
//	ON_COMMAND( ID_BUTTON_F3, OnButtonF3 )
	...
	ON_COMMAND( ID_PRINTSETUP_MENU, &CfrmUc151Tidaiyatin::OnMenuPrintSetup )
	ON_COMMAND( ID_PRINTALL_MENU, &CfrmUc151Tidaiyatin::OnMenuPrintAll )
	ON_COMMAND( ID_OUTPUTFORM_MENU, &CfrmUc151Tidaiyatin::OnMenuFormTypeSetup )
	ON_COMMAND( ID_SPECIALROW_MENU, &CfrmUc151Tidaiyatin::OnMenuSpecialRow )
	ON_COMMAND( ID_SORT_MENU, &CfrmUc151Tidaiyatin::OnMenuSort )
	//	ON_COMMAND( ID_DISPDIALOG_MENU, &CfrmUc151Tidaiyatin::OnMenuIkkatuKingaku )
	ON_COMMAND( ID_ZEROMONEY_MENU, &CfrmUc151Tidaiyatin::OnMenuZeroMoney )
	ON_COMMAND( ID_ZEROMONEYMOVE_MENU, &CfrmUc151Tidaiyatin::OnMenuZeroMoneyMove )
	ON_COMMAND( ID_AMOUTDIALOG_MENU, &CfrmUc151Tidaiyatin::OnMenuOutKeiSetup )
// midori 160606 add -->
	ON_COMMAND( ID_CLEAR_MENU, &CfrmUc151Tidaiyatin::OnMenuClear )
// midori 160606 add <--
	ON_COMMAND( ID_TITLEMENU, &CfrmUc151Tidaiyatin::OnMenuTitleRestore )
	ON_COMMAND( ID_USER_SETTING_MENU, &CfrmUc151Tidaiyatin::OnMenuOptionSetting )
	ON_COMMAND( ID_COPY_SETTING_INFO_MENU, &CfrmUc151Tidaiyatin::OnMenuCopySettingInfo )
	ON_COMMAND( ID_DELETE_DATA_MENU, &CfrmUc151Tidaiyatin::OnMenuDeleteDataEachYoushiki )
	ON_BN_CLICKED( IDC_PAGEBACK_BUTTON1, &CfrmUc151Tidaiyatin::OnPageBack )
	ON_BN_CLICKED( IDC_PAGENEXT_BUTTON1, &CfrmUc151Tidaiyatin::OnPageNext )
	ON_BN_CLICKED( IDC_PAGENEW_BUTTON1, &CfrmUc151Tidaiyatin::OnPageNew )
	ON_BN_CLICKED( IDC_PAGEINSERT_BUTTON1, &CfrmUc151Tidaiyatin::OnPageInsert )
	ON_BN_CLICKED( IDC_ROWCOPY_BUTTON1, &CfrmUc151Tidaiyatin::OnRowCopy )
	ON_BN_CLICKED( IDC_ROWPASTE_BUTTON1, &CfrmUc151Tidaiyatin::OnRowPaste )
	ON_BN_CLICKED( IDC_ROWINSERT_BUTTON1, &CfrmUc151Tidaiyatin::OnRowInsert )
	ON_BN_CLICKED( IDC_YOUSHIKINEXT_BUTTON1, &CfrmUc151Tidaiyatin::OnMoveYoushikiNext )
	ON_BN_CLICKED( IDC_YOUSHIKIBACK_BUTTON1, &CfrmUc151Tidaiyatin::OnMoveYoushikiBack )
//	ON_UPDATE_COMMAND_UI( ID_BUTTON_F1, &CfrmUc151Tidaiyatin::OnUpdateButtonF1 )
//	ON_UPDATE_COMMAND_UI( ID_BUTTON_F3, &CfrmUc151Tidaiyatin::OnUpdateButtonF3 )
	ON_UPDATE_COMMAND_UI( ID_BUTTON_F6, &CfrmUc151Tidaiyatin::OnUpdateButtonF6 )
	ON_UPDATE_COMMAND_UI( ID_BUTTON_F7, &CfrmUc151Tidaiyatin::OnUpdateButtonF7 )
	ON_UPDATE_COMMAND_UI( ID_BUTTON_F8, &CfrmUc151Tidaiyatin::OnUpdateButtonF8 )
	ON_UPDATE_COMMAND_UI( ID_BUTTON_F9, &CfrmUc151Tidaiyatin::OnUpdateButtonF9 )
	ON_UPDATE_COMMAND_UI( ID_BUTTON_F11, &CfrmUc151Tidaiyatin::OnUpdateButtonF11 )
	ON_UPDATE_COMMAND_UI( ID_BUTTON_F12, &CfrmUc151Tidaiyatin::OnUpdateButtonF12 )
	ON_UPDATE_COMMAND_UI( ID_BUTTON_HOME, &CfrmUc151Tidaiyatin::OnUpdateButtonHome )
//	ON_UPDATE_COMMAND_UI( ID_DISPDIALOG_MENU, &CfrmUc151Tidaiyatin::OnUpdateMenuIkkatuKingaku )
// midori 160612 add -->
	ON_UPDATE_COMMAND_UI( ID_SORT_MENU, &CfrmUc151Tidaiyatin::OnUpdateMenuSort )
	ON_UPDATE_COMMAND_UI( ID_CLEAR_MENU, &CfrmUc151Tidaiyatin::OnUpdateMenuClear )
// midori 160612 add <--
	ON_UPDATE_COMMAND_UI( ID_ZEROMONEY_MENU, &CfrmUc151Tidaiyatin::OnUpdateMenuZeroMoney )
// midori 160612 add -->
	ON_UPDATE_COMMAND_UI( ID_ZEROMONEYMOVE_MENU, &CfrmUc151Tidaiyatin::OnUpdateMenuZeroMoneyMove)
// midori 160612 add <--
	ON_UPDATE_COMMAND_UI(ID_SPECIALROW_MENU, &CfrmUc151Tidaiyatin::OnUpdateMenuSpecialRow)
// midori 160612 add -->
	ON_UPDATE_COMMAND_UI( ID_TITLEMENU, &CfrmUc151Tidaiyatin::OnUpdateMenuTitleRestore )
	ON_UPDATE_COMMAND_UI( ID_DELETE_DATA_MENU, &CfrmUc151Tidaiyatin::OnUpdateMenuDeleteDataEachYoushiki )
// midori 160612 add <--
	ON_MESSAGE(WM_USER_REDRAWVIEW, OnUserReDrawView)		// 修正No.162446 add
END_MESSAGE_MAP()


CfrmUc151Tidaiyatin::CfrmUc151Tidaiyatin()
	: CfrmUc000Common( CfrmUc151Tidaiyatin::IDD )
{
...
CfrmUc151Tidaiyatin::~CfrmUc151Tidaiyatin()
{
	...
	TRACE(_T("***** CfrmUc151Tidaiyatin::~CfrmUc151Tidaiyatin\n"));

	//m_pDiag = NULL;
	//m_pTitleDiag = NULL;
}

void CfrmUc151Tidaiyatin::DoDataExchange( CDataExchange* pDX )
{
...
void CfrmUc151Tidaiyatin::OnInitialUpdate()
{
...
#ifdef _DEBUG
void CfrmUc151Tidaiyatin::AssertValid() const
{
	CfrmUc000Common::AssertValid();
}

#ifndef _WIN32_WCE
void CfrmUc151Tidaiyatin::Dump( CDumpContext& dc ) const
{
...
BEGIN_EVENTSINK_MAP( CfrmUc151Tidaiyatin, CfrmUc000Common )
	ON_EVENT( CfrmUc151Tidaiyatin, IDC_YOUSHIKIDIAG1, 3, CfrmUc151Tidaiyatin::TerminationYoushikidiag1, VTS_I2 VTS_I2 VTS_I2 VTS_UNKNOWN )
	ON_EVENT( CfrmUc151Tidaiyatin, IDC_YOUSHIKIDIAG1, 2, CfrmUc151Tidaiyatin::EditOFFYoushikidiag1, VTS_I2 )
	ON_EVENT( CfrmUc151Tidaiyatin, IDC_YOUSHIKIDIAG1, 1, CfrmUc151Tidaiyatin::EditONYoushikidiag1, VTS_I2 )
// midori 151405 add -->
	ON_EVENT(CfrmUc151Tidaiyatin, IDC_YOUSHIKIDIAG1, 12, CfrmUc151Tidaiyatin::VScrollYoushikidiag1, VTS_I2)
// midori 151405 add <--
// midori 152134 add -->
	ON_EVENT(CfrmUc151Tidaiyatin, IDC_YOUSHIKIDIAG1, 8, CfrmUc151Tidaiyatin::ComboSelYoushikidiag1, VTS_I2 VTS_UNKNOWN)
// midori 152134 add <--

	ON_EVENT( CfrmUc151Tidaiyatin, IDC_YOUSHIKIDIAG2, 3, CfrmUc151Tidaiyatin::TerminationYoushikidiag1, VTS_I2 VTS_I2 VTS_I2 VTS_UNKNOWN )
	ON_EVENT( CfrmUc151Tidaiyatin, IDC_YOUSHIKIDIAG2, 2, CfrmUc151Tidaiyatin::EditOFFYoushikidiag1, VTS_I2 )
	ON_EVENT( CfrmUc151Tidaiyatin, IDC_YOUSHIKIDIAG2, 1, CfrmUc151Tidaiyatin::EditONYoushikidiag1, VTS_I2 )
// midori 151405 add -->
	ON_EVENT(CfrmUc151Tidaiyatin, IDC_YOUSHIKIDIAG2, 12, CfrmUc151Tidaiyatin::VScrollYoushikidiag1, VTS_I2)
// midori 151405 add <--
// midori 152134 add -->
	ON_EVENT(CfrmUc151Tidaiyatin, IDC_YOUSHIKIDIAG2, 8, CfrmUc151Tidaiyatin::ComboSelYoushikidiag1, VTS_I2 VTS_UNKNOWN)
// midori 152134 add <--

	ON_EVENT( CfrmUc151Tidaiyatin, IDC_YOUSHIKIDIAG3, 3, CfrmUc151Tidaiyatin::TerminationYoushikidiag1, VTS_I2 VTS_I2 VTS_I2 VTS_UNKNOWN )
	ON_EVENT( CfrmUc151Tidaiyatin, IDC_YOUSHIKIDIAG3, 2, CfrmUc151Tidaiyatin::EditOFFYoushikidiag1, VTS_I2 )
	ON_EVENT( CfrmUc151Tidaiyatin, IDC_YOUSHIKIDIAG3, 1, CfrmUc151Tidaiyatin::EditONYoushikidiag1, VTS_I2 )
// midori 151405 add -->
	ON_EVENT(CfrmUc151Tidaiyatin, IDC_YOUSHIKIDIAG3, 12, CfrmUc151Tidaiyatin::VScrollYoushikidiag1, VTS_I2)
// midori 151405 add <--
// midori 152134 add -->
	ON_EVENT(CfrmUc151Tidaiyatin, IDC_YOUSHIKIDIAG3, 8, CfrmUc151Tidaiyatin::ComboSelYoushikidiag1, VTS_I2 VTS_UNKNOWN)
// midori 152134 add <--

	ON_EVENT( CfrmUc151Tidaiyatin, IDC_YOUSHIKIDIAG4, 3, CfrmUc151Tidaiyatin::TerminationYoushikidiag1, VTS_I2 VTS_I2 VTS_I2 VTS_UNKNOWN )
	ON_EVENT( CfrmUc151Tidaiyatin, IDC_YOUSHIKIDIAG4, 2, CfrmUc151Tidaiyatin::EditOFFYoushikidiag1, VTS_I2 )
	ON_EVENT( CfrmUc151Tidaiyatin, IDC_YOUSHIKIDIAG4, 1, CfrmUc151Tidaiyatin::EditONYoushikidiag1, VTS_I2 )
// midori 151405 add -->
	ON_EVENT(CfrmUc151Tidaiyatin, IDC_YOUSHIKIDIAG4, 12, CfrmUc151Tidaiyatin::VScrollYoushikidiag1, VTS_I2)
// midori 151405 add <--
// midori 152134 add -->
	ON_EVENT(CfrmUc151Tidaiyatin, IDC_YOUSHIKIDIAG4, 8, CfrmUc151Tidaiyatin::ComboSelYoushikidiag1, VTS_I2 VTS_UNKNOWN)
// midori 152134 add <--

	ON_EVENT( CfrmUc151Tidaiyatin, IDC_YOUSHIKIDIAG5, 3, CfrmUc151Tidaiyatin::TerminationYoushikidiag1, VTS_I2 VTS_I2 VTS_I2 VTS_UNKNOWN )
	ON_EVENT( CfrmUc151Tidaiyatin, IDC_YOUSHIKIDIAG5, 2, CfrmUc151Tidaiyatin::EditOFFYoushikidiag1, VTS_I2 )
	ON_EVENT( CfrmUc151Tidaiyatin, IDC_YOUSHIKIDIAG5, 1, CfrmUc151Tidaiyatin::EditONYoushikidiag1, VTS_I2 )
// midori 151405 add -->
	ON_EVENT(CfrmUc151Tidaiyatin, IDC_YOUSHIKIDIAG5, 12, CfrmUc151Tidaiyatin::VScrollYoushikidiag1, VTS_I2)
// midori 151405 add <--
// midori 152134 add -->
	ON_EVENT(CfrmUc151Tidaiyatin, IDC_YOUSHIKIDIAG5, 8, CfrmUc151Tidaiyatin::ComboSelYoushikidiag1, VTS_I2 VTS_UNKNOWN)
// midori 152134 add <--

	ON_EVENT( CfrmUc151Tidaiyatin, IDC_YOUSHIKIDIAG6, 3, CfrmUc151Tidaiyatin::TerminationYoushikidiag1, VTS_I2 VTS_I2 VTS_I2 VTS_UNKNOWN )
	ON_EVENT( CfrmUc151Tidaiyatin, IDC_YOUSHIKIDIAG6, 2, CfrmUc151Tidaiyatin::EditOFFYoushikidiag1, VTS_I2 )
	ON_EVENT( CfrmUc151Tidaiyatin, IDC_YOUSHIKIDIAG6, 1, CfrmUc151Tidaiyatin::EditONYoushikidiag1, VTS_I2 )
// midori 151405 add -->
	ON_EVENT(CfrmUc151Tidaiyatin, IDC_YOUSHIKIDIAG6, 12, CfrmUc151Tidaiyatin::VScrollYoushikidiag1, VTS_I2)
// midori 151405 add <--
// midori 152134 add -->
	ON_EVENT(CfrmUc151Tidaiyatin, IDC_YOUSHIKIDIAG6, 8, CfrmUc151Tidaiyatin::ComboSelYoushikidiag1, VTS_I2 VTS_UNKNOWN)
// midori 152134 add <--

	ON_EVENT( CfrmUc151Tidaiyatin, IDC_TITLEDIAG1, 3, CfrmUc151Tidaiyatin::TerminationTitlediag1, VTS_I2 VTS_I2 VTS_I2 VTS_UNKNOWN )
	ON_EVENT( CfrmUc151Tidaiyatin, IDC_TITLEDIAG1, 2, CfrmUc151Tidaiyatin::EditOFFTitlediag1, VTS_I2 )
	ON_EVENT( CfrmUc151Tidaiyatin, IDC_TITLEDIAG1, 1, CfrmUc151Tidaiyatin::EditONTitlediag1, VTS_I2 )
	ON_EVENT( CfrmUc151Tidaiyatin, IDC_TITLEDIAG1, 6, CfrmUc151Tidaiyatin::FocusTitlediag1, VTS_NONE )
	
	ON_EVENT( CfrmUc151Tidaiyatin, IDC_PAGEDIAG1, 3, CfrmUc151Tidaiyatin::TerminationPagediag1, VTS_I2 VTS_I2 VTS_I2 VTS_UNKNOWN )
	ON_EVENT( CfrmUc151Tidaiyatin, IDC_PAGEDIAG1, 2, CfrmUc151Tidaiyatin::EditOFFPagediag1, VTS_I2 )
	ON_EVENT( CfrmUc151Tidaiyatin, IDC_PAGEDIAG1, 1, CfrmUc151Tidaiyatin::EditONPagediag1, VTS_I2 )
	ON_EVENT( CfrmUc151Tidaiyatin, IDC_PAGEDIAG1, 6, CfrmUc151Tidaiyatin::FocusPagediag1, VTS_NONE )
END_EVENTSINK_MAP()

//********************************************************************************
//	初期処理
//********************************************************************************
BOOL	CfrmUc151Tidaiyatin::virStartJob()
{
	// 初期値設定
...
//	共通データの初期値設定
//********************************************************************************
void	CfrmUc151Tidaiyatin::virSetInitialUchiwakeInfo()
{
	// 「地代家賃」の固有データ
	...
	m_uInfo.intColMax = ID_COLMAX_151;				// １行内のコントロール個数
	m_uInfo.intColMaxData = ID_COLMAXDATA_151;		// １行内の列数
	m_uInfo.intCtlStartIndex = ID_CTLSTARTINDEX_151;// １行目の入力項目の先頭インデックス番号
	m_uInfo.intT1StartIndex = ID_T1STARTNORMAL_151;	// 合計行①の先頭インデックス番号
	m_uInfo.intT2StartIndex = ID_T2STARTNORMAL_151;	// 合計行②の入力項目の先頭インデックス番号
	m_uInfo.intCursolDefPos = ID_COL_151_YOUTO;		// カーソル移動時の初期位置（タイトルから↓，合計から↑で使用）
	m_uInfo.intCursolKeiPos = ID_COL_151_KUBUN;		// 合計行のカーソル移動位置（カーソル移動で使用）
	...
	m_uInfo.intT1StartNormal = ID_T1STARTNORMAL_151;	// 通常時：合計行①の先頭インデックス
	m_uInfo.intT2StartNormal = ID_T2STARTNORMAL_151;	// 通常時：合計行②の先頭インデックス
	m_uInfo.intT1StartKobetu = ID_T1STARTKOBETU_151;	// 個別時：合計行①の先頭インデックス
	m_uInfo.intT2StartKobetu = ID_T2STARTKOBETU_151;	// 個別時：合計行②の先頭インデックス
	m_uInfo.intRowKei = ID_ROWKEI_151;				// 帳表固定の合計行数（1:合計あり，0:なし）
	m_uInfo.intKei1StartIndex = ID_COL_151_KEI1_MEISYO;	// 計ダイアグラム1行目の先頭インデックス
	m_uInfo.intKei2StartIndex = ID_COL_151_KEI2_MEISYO;	// 計ダイアグラム2行目の先頭インデックス
...
// 【戻値】    なし
//**************************************************
void	CfrmUc151Tidaiyatin::virSetInitialDiag()
{
	int		nIndex;
	...
	//	コンボボックスの属性取得
	nIndex = CmnGetControlIndex( 1, ID_COL_151_KUBUN );
...
//	帳表固有変数の初期値設定
//********************************************************************************
void	CfrmUc151Tidaiyatin::virSetInitialValue()
{
	// 1ページ分のローカルバッファをクリア
	RecBufClearAllData();
...
//	帳表コントロールの初期化（データ領域）
//********************************************************************************
BOOL	CfrmUc151Tidaiyatin::InitialControlDataArea()
{
	int		intMax;
	int		i;
// No.200903 add -->
...
// midori 200101 add -->
		...
		if(bG_Kanso == TRUE) {
			m_pDiag->GetAttribute((i + ID_COL_151_SPDATE - 1),(LPUNKNOWN)&diaatt);
			diaatt.attr_dayattr = 15;
			m_pDiag->SetAttribute((i + ID_COL_151_SPDATE - 1),(LPUNKNOWN)&diaatt,TRUE);
			m_pDiag->GetAttribute((i + ID_COL_151_SPDATE2 - 1),(LPUNKNOWN)&diaatt);
			diaatt.attr_dayattr = 15;
			m_pDiag->SetAttribute((i + ID_COL_151_SPDATE2 - 1),(LPUNKNOWN)&diaatt,TRUE);
		}
		else {
			m_pDiag->GetAttribute((i + ID_COL_151_SPDATE - 1),(LPUNKNOWN)&diaatt);
...
// midori 200101 add <--
		...
		// ComboBox：クリア
		CmnDiagSetString( m_pDiag, i + ID_COL_151_KUBUN - 1, "", 0 );	// 地代・家賃の区分

		
		// 漢字入力欄の初期化
//		CmnDiagSetAttrInpmax( m_pDiag, i + ID_COL_151_KUBUN    - 1, MAX_KETA_151_KUBUN );			//	地代・家賃の区分
		CmnDiagSetAttrInpmax( m_pDiag, i + ID_COL_151_YOUTO    - 1, MAX_KETA_151_YOUTO );			//	借地物件の用途
		CmnDiagSetAttrInpmax( m_pDiag, i + ID_COL_151_AD2ADD1    - 1, MAX_KETA_151_AD2ADD1 );			//	所在地１
		CmnDiagSetAttrInpmax( m_pDiag, i + ID_COL_151_AD2ADD2    - 1, MAX_KETA_151_AD2ADD2 );			//	所在地２
		CmnDiagSetAttrInpmax( m_pDiag, i + ID_COL_151_ADNAME1    - 1, MAX_KETA_151_ADNAME1 );		//	貸主の名称
		CmnDiagSetAttrInpmax( m_pDiag, i + ID_COL_151_ADADD1    - 1, MAX_KETA_151_ADADD1 );		//	貸主の所在地１
		CmnDiagSetAttrInpmax( m_pDiag, i + ID_COL_151_ADADD2    - 1, MAX_KETA_151_ADADD2 );		//	貸主の所在地２
		CmnDiagSetAttrInpmax( m_pDiag, i + ID_COL_151_SPDATE    - 1, MAX_KETA_151_SPDATE );			//	支払対象機関１
		CmnDiagSetAttrInpmax( m_pDiag, i + ID_COL_151_SPDATE2    - 1, MAX_KETA_151_SPDATE2 );		//	支払対象機関２
		CmnDiagSetAttrInpmax( m_pDiag, i + ID_COL_151_TEKI    - 1, MAX_KETA_151_TEKI );				//	摘要

		// 金額欄：桁数初期化
// No.200903 del -->
		//CmnDiagSetAttrDigit( m_pDiag, i + ID_COL_151_VAL - 1, ID_VAL_151_DATA );	// 支払貸借料
// No.200903 del <--
// No.200903 add -->
		if(bG_Kanso == TRUE)	len = ID_VAL_151_K_DATA;
		else					len = ID_VAL_151_DATA;
		CmnDiagSetAttrDigit( m_pDiag, i + ID_COL_151_VAL - 1, len );		// 支払貸借料
// No.200903 add <--
	...
	// 半角/全角設定
	CmnDiagSetAttrColZenHan( m_pDiag , ID_COL_151_KUBUN );		// 地代・家賃の区分
	CmnDiagSetAttrColZenHan( m_pDiag , ID_COL_151_YOUTO );		// 借地物件の用途
	CmnDiagSetAttrColZenHan( m_pDiag , ID_COL_151_AD2ADD1 );		// 所在地1
	CmnDiagSetAttrColZenHan( m_pDiag , ID_COL_151_AD2ADD2 );		// 所在地2
	CmnDiagSetAttrColZenHan( m_pDiag , ID_COL_151_ADNAME1 );		// 貸主の名称1
	CmnDiagSetAttrColZenHan( m_pDiag , ID_COL_151_ADADD1 );		// 貸主の所在地1
	CmnDiagSetAttrColZenHan( m_pDiag , ID_COL_151_ADADD2 );		// 貸主の所在地2
	CmnDiagSetAttrColZenHan( m_pDiag , ID_COL_151_TEKI );		// 摘要
...
//********************************************************************************
BOOL	CfrmUc151Tidaiyatin::InitialControlDataAreaHide( CICSDiag* pDiag )
{
	int		intMax;
	int		i;
// No.200903 add -->
...
// No.200903 add <--
	...
	for ( i = m_uInfo.intCtlStartIndex; i < intMax; i += m_uInfo.intColMax ) {
		// ComboBox：クリア
		CmnDiagSetString( pDiag, i + ID_COL_151_KUBUN - 1, "", 0 );	// 地代・家賃の区分

		
		// 漢字入力欄の初期化
//		CmnDiagSetAttrInpmax( pDiag, i + ID_COL_151_KUBUN    - 1, MAX_KETA_151_KUBUN );			//	地代・家賃の区分
		CmnDiagSetAttrInpmax( pDiag, i + ID_COL_151_YOUTO    - 1, MAX_KETA_151_YOUTO );			//	借地物件の用途
		CmnDiagSetAttrInpmax( pDiag, i + ID_COL_151_AD2ADD1    - 1, MAX_KETA_151_AD2ADD1 );			//	所在地１
		CmnDiagSetAttrInpmax( pDiag, i + ID_COL_151_AD2ADD2    - 1, MAX_KETA_151_AD2ADD2 );			//	所在地２
		CmnDiagSetAttrInpmax( pDiag, i + ID_COL_151_ADNAME1    - 1, MAX_KETA_151_ADNAME1 );		//	貸主の名称
		CmnDiagSetAttrInpmax( pDiag, i + ID_COL_151_ADADD1    - 1, MAX_KETA_151_ADADD1 );		//	貸主の所在地１
		CmnDiagSetAttrInpmax( pDiag, i + ID_COL_151_ADADD2    - 1, MAX_KETA_151_ADADD2 );		//	貸主の所在地２
		CmnDiagSetAttrInpmax( pDiag, i + ID_COL_151_SPDATE    - 1, MAX_KETA_151_SPDATE );			//	支払対象機関１
		CmnDiagSetAttrInpmax( pDiag, i + ID_COL_151_SPDATE2    - 1, MAX_KETA_151_SPDATE2 );		//	支払対象機関２
		CmnDiagSetAttrInpmax( pDiag, i + ID_COL_151_TEKI    - 1, MAX_KETA_151_TEKI );				//	摘要

		// 金額欄：桁数初期化
// No.200903 del -->
		//CmnDiagSetAttrDigit( pDiag, i + ID_COL_151_VAL - 1, ID_VAL_151_DATA );	// 支払貸借料
// No.200903 del <--
// No.200903 add -->
		if(bG_Kanso == TRUE)	len = ID_VAL_151_K_DATA;
		else					len = ID_VAL_151_DATA;
		CmnDiagSetAttrDigit( pDiag, i + ID_COL_151_VAL - 1, len );	// 支払貸借料
// No.200903 add <--
	}
...
//********************************************************************************
BOOL	CfrmUc151Tidaiyatin::InitialControlComboBox()
{
	...
	for ( i = 1; i <= intMax; i++ ) {
		...
		intIndex = CmnGetControlIndex( i, ID_COL_151_KUBUN );
...
//********************************************************************************
void	CfrmUc151Tidaiyatin::InitialControlTotalArea()
{
	int		nKeiType;			//	計の種別
...
// midori 152166 add <--
	...
	m_pDiagKei->ModifyItem(ID_COL_151_KEI1_VAL, intKeiRow);
	m_pDiagKei->ModifyItem(ID_COL_151_KEI2_VAL, intKeiRow);
	...
	//m_pDiag->ModifyItem( CmnGetControlTotalIndex( 1, ID_COL_151_KUBUN ), nKeiRow[0] );
	//m_pDiag->ModifyItem( CmnGetControlTotalIndex( 2, ID_COL_151_KUBUN ), nKeiRow[1] );
	
// No.200903 del -->
	//// 合計行の金額欄は、金額欄 + 1桁
	//CmnDiagSetAttrDigit( m_pDiagKei, ID_COL_151_KEI1_VAL, ID_VAL_151_TOTAL );
	//CmnDiagSetAttrDigit( m_pDiagKei, ID_COL_151_KEI2_VAL, ID_VAL_151_TOTAL );
	////CmnDiagSetAttrDigit( m_pDiag, CmnGetControlTotalIndex( 1, ID_COL_151_VAL ), ID_VAL_151_TOTAL );
	////CmnDiagSetAttrDigit( m_pDiag, CmnGetControlTotalIndex( 2, ID_COL_151_VAL ), ID_VAL_151_TOTAL );
// No.200903 del <--
}
...
//		→表示していない方のDiag(通常 or 個別)の設定に使用する
//********************************************************************************
void	CfrmUc151Tidaiyatin::InitialControlTotalAreaHide( CICSDiag* pDiag )
{
	int intIndex = 0;
	...
	// 合計行の金額欄は、金額欄 + 1桁
	intIndex = m_intT1StartIndexHide + m_uInfo.intCtlStartIndex + ID_COL_151_VAL - 1;
	CmnDiagSetAttrDigit( pDiag, intIndex, ID_VAL_151_TOTAL );

	intIndex = m_intT2StartIndexHide + m_uInfo.intCtlStartIndex + ID_COL_151_VAL - 1;
	CmnDiagSetAttrDigit( pDiag, intIndex, ID_VAL_151_TOTAL );
}
...
//	RET	なし
//********************************************************************************
void	CfrmUc151Tidaiyatin::InitialControlSpecialRow( int intRow, int intFgFunc )
{
	DIAGRAM_DATA	diadata;	// ICSDIAG構造体
	int				nIndex;		//	インデックス
...
// No.200903 add <--
		// 桁数を設定
		CmnDiagSetAttrDigit( m_pDiag, CmnGetControlIndex( intRow , ID_COL_151_VAL ), ID_VAL_151_TOTAL );
		break;
	}
	...
	case ID_FGFUNC_IKKATUAUTO:		// 一括集計金額行（自動）
		...
		if ( intFgFunc != ID_FGFUNC_IKKATUAUTO ){
			...
			m_pDiag->ModifyItem( CmnGetControlIndex( intRow, ID_COL_151_KUBUN ), DIAG_MDFY_NODROPDOWN );

			// ComboBoxの選択項目クリア
			m_clsFunc.DiagInit( &diadata );
			diadata.text_combo = _T( "\r\n" );
			m_pDiag->SetData( CmnGetControlIndex( intRow, ID_COL_151_KUBUN ), (LPUNKNOWN)&diadata );
		}
...
//	帳表タイトル情報の表示
//********************************************************************************
void	CfrmUc151Tidaiyatin::virUpdateControlTitle()
{
//	int		intMax;
	DIAGRAM_ATTRIBUTE diaatt;
...
//	帳表ページ情報の表示
//********************************************************************************
void	CfrmUc151Tidaiyatin::UpdateControlPage()
{
	BOOL	bBack = TRUE;
	BOOL	bNext = TRUE;
...
//	帳表データの表示（１ページ分）
//********************************************************************************
BOOL	CfrmUc151Tidaiyatin::virUpdateControlTblData()
{
	// ダイアログ切替
	if( m_pDiag != NULL ){
		virSetInitialDiag();
...
// No.200601 add -->
		...
		if(bG_Kanso == TRUE) {
			...
			// 地代・家賃の区分
			CmnInitialControlFgStringCell( m_pDiag, dbRec.m_NumRow, ID_COL_151_KUBUN, dbRec.m_FgFunc, UC_151_KUBUN_LEN, dbRec.m_KnName);
			// 借地(借家)物件の用途
			CmnInitialControlFgStringCell( m_pDiag, dbRec.m_NumRow, ID_COL_151_YOUTO, dbRec.m_FgFunc, UC_151_YOUTO_LEN, dbRec.m_Youto);
			// 摘要
			CmnInitialControlFgStringCell( m_pDiag, dbRec.m_NumRow, ID_COL_151_TEKI, dbRec.m_FgFunc, UC_151_TEKI_LEN, dbRec.m_Teki);
		}
// No.200601 add <--
...
//	保管件数の表示
//********************************************************************************
BOOL CfrmUc151Tidaiyatin::virUpdateControlTblData2()
{
	int					hcnt=0;
	CString				cs=_T("");
...
//		RET		なし
//********************************************************************************
void	CfrmUc151Tidaiyatin::UpdateControlRowData( CdbUc151Tidaiyatin* prmDbRec ) {
	DIAGRAM_DATA	diadata;	// ICSDiag構造体
	int				intCell;	// 保存フィールド
	...
	// 読込み対象セル取得
	intCell = CmnGetControlIndex( prmDbRec->m_NumRow, ID_COL_151_KUBUN );
...
// midori 200101 add <--
	...
	// 支払対象期間
// midori 200101 del -->
	//dc.Convert( prmDbRec->m_SpDate2, diadata.data_day, DC_DATE_WMD );
// midori 200101 del <--
// midori 200101 add -->
	if(bG_Kanso == TRUE) {
...
//		RET		なし
//********************************************************************************
void	CfrmUc151Tidaiyatin::UpdateControlRowTotal( CdbUc151Tidaiyatin* prmDbRec )
{
	int		intTotalType;
	...
	// 頁計/累計の名称表示
	if ( intRowName > 0 ) {
		//CmnDiagSetString( m_pDiag, CmnGetControlTotalIndex( intRowName, ID_COL_151_KUBUN ), prmDbRec->m_KeiStr, 0 );
		CmnDiagSetString( m_pDiagKei, CmnGetKeiDiagIndex( intRowName, ID_COL_151_KEI1_MEISYO ), prmDbRec->m_KeiStr, 1 );
	}
	// 頁計/累計の金額表示
	if ( intRowVal > 0 ) {
		//CmnDiagSetKingaku( m_pDiag, CmnGetControlTotalIndex( intRowName, ID_COL_151_VAL ), prmDbRec->m_Val );
		CmnDiagSetKingaku( m_pDiagKei, CmnGetKeiDiagIndex( intRowVal, ID_COL_151_KEI1_VAL ), prmDbRec->m_Val );
	}
}
...
//		RET		なし
//********************************************************************************
void	CfrmUc151Tidaiyatin::virFncCellCopyProc( CdbUc000Common* rsData )
{
...
// midori 200101 add -->
	...
	// 支払対象期間
	case ID_COL_151_SPDATE2:
		if(bG_Kanso == TRUE)	CmnDiagSetDateWMD( m_pDiag, m_uInfo.intCurCtlIndex, DC_DATE_GWMD, rs->m_SpDate2 );
		else					CmnDiagSetDateWMD( m_pDiag, m_uInfo.intCurCtlIndex, DC_DATE_WMD, rs->m_SpDate2 );
		break;
// midori 200101 add <--
	// 支払貸借料
	case ID_COL_151_VAL:
...
//********************************************************************************
int	CfrmUc151Tidaiyatin::virFncReferenceGetType(int intCol, int* intGrSeq, long* lngItemSeq, int* intAdd1, int* intAdd2, int* intAdd1Col, int* intAdd2Col, REFERENCE_INFO* pudReference)
{
int		intRefType = 0;
	...
	case ID_COL_151_ADADD2:
		...
		*intAdd1 = 20 * 2;			// Byte指定
		*intAdd2 = 20 * 2;			// Byte指定
		if ( ( intCol == ID_COL_151_AD2ADD1 ) || ( intCol == ID_COL_151_AD2ADD2 ) ){
			*intAdd1Col = ID_COL_151_AD2ADD1;
			*intAdd2Col = ID_COL_151_AD2ADD2;
		}
		else{
			*intAdd1Col = ID_COL_151_ADADD1;
			*intAdd2Col = ID_COL_151_ADADD2;
		}
		break;
...
//		RET		なし
//********************************************************************************
void	CfrmUc151Tidaiyatin::virFncReferenceSetData( CdlgReference* dlgRef, int intRefType, int intCol )
{
...
//		RET		なし
//********************************************************************************
void	CfrmUc151Tidaiyatin::virFncReferenceUpdateTbl( int intRefType, int nRefMode/*=0*/ )
{
	switch (intRefType) {
...
//@			rsKmk.UpdateDataTable(TBL_NAME_151, m_uInfo.intFormSeq);
...
//		RET		なし
//********************************************************************************
void	CfrmUc151Tidaiyatin::virFncReferenceSetICSData(CdlgAddressSearch* dlgAddd)
{
	int			intIndex;
	...
	case ID_COL_151_AD2ADD2:
		//	商品の所在地１
		intIndex = CmnGetControlIndex( m_uInfo.intCurRow, ID_COL_151_AD2ADD1 );
		CmnDiagSetString( m_pDiag, intIndex, dlgAddd->m_AdAdd1, 0 );
		//	商品の所在地２
		intIndex = CmnGetControlIndex( m_uInfo.intCurRow, ID_COL_151_AD2ADD2 );
	...
	case ID_COL_151_ADADD2:
		//	住所１
		intIndex = CmnGetControlIndex( m_uInfo.intCurRow, ID_COL_151_ADADD1 );
		CmnDiagSetString( m_pDiag, intIndex, dlgAddd->m_AdAdd1, 0 );
		//	住所２
		intIndex = CmnGetControlIndex( m_uInfo.intCurRow, ID_COL_151_ADADD2 );
		CmnDiagSetString( m_pDiag, intIndex, dlgAddd->m_AdAdd2, 0 );
		break;
	}
}
...
// 修正No.157633_元号日付 add -->
void CfrmUc151Tidaiyatin::virActivateFrame(UINT nState, CFrameWnd* pDeactivateFrame)
{
	int		index = 0;
	...
	if(pWnd != NULL)	{
		if(m_DataKakutei == FALSE)	{
			if(bG_Kanso == TRUE && (m_uInfo.intCurCol == ID_COL_151_SPDATE || m_uInfo.intCurCol == ID_COL_151_SPDATE2))	{
				if(m_uInfo.EditSign == 1)	{
					m_uInfo.EditSign = -1;
					m_uInfo.GenListSw = 0;
					if(m_uInfo.intCurCol == ID_COL_151_SPDATE)	{
						m_uInfo.OldDate[0] = 0;
...
void CfrmUc151Tidaiyatin::virActivateFrameK(UINT nState, CFrameWnd* pDeactivateFrame)
{
	int		index = 0;
	CWnd*	pWnd = this->GetFocus();
	...
	if(pWnd != NULL)	{
		if(m_DataKakutei == FALSE)	{
			if(m_uInfo.intCurCol == ID_COL_151_KUBUN)	{
				virKamokuAddCancel();
			}
		}
	}
...
void CfrmUc151Tidaiyatin::virKamokuAddCancel()
{
	...
	// 科目列なら
	if(m_uInfo.intCurCol == ID_COL_151_KUBUN && m_F9OnSw != TRUE)	{
		DIAGRAM_DATA	diadata;
		m_pDiag->GetData(m_uInfo.intCurCtlIndex,(LPUNKNOWN)&diadata);
		// 【新規作成】が選択されていれば
		if(diadata.data_combo > m_CmbCnt)	{
			// 前回の値に戻す
			CmnDiagSetCombo(m_pDiag,CmnGetControlIndex(m_uInfo.intCurRow,ID_COL_151_KUBUN),m_uInfo.OldCombo);
		}
	}
}
// 要通知案件修正 21/07/09 add <--
...
//	その他イベント処理
//********************************************************************************
BOOL	CfrmUc151Tidaiyatin::PreTranslateMessage( MSG* pMsg )
{
//	int				intID;
...
//				if ((CmnGetControlCol() != ID_COL_151_KUBUN) || (CmnCheckTotalRow() == TRUE )){
// midori 160611 del <--
				// カレントインデックスを保存
...
//				//}
//// ---------------------
//				if(CmnGetControlCol() == ID_COL_151_KUBUN)	{
//					rv=1;
//				}
//// midori 160611 cor <--
// midori 152134 17/10/07 del <--
...
// midori 155866 del <--
// midori 155866 add -->
				if(intCol == ID_COL_151_KUBUN || intCol == ID_COL_151_SPDATE || intCol == ID_COL_151_SPDATE2)	{
// midori 155866 add <--
					rv=1;
				}
// midori 152134 17/10/07 add <--
...
/*
		...
		case VK_TAB:
			...
			if ((intID == IDC_PAGEBACK_BUTTON1) && (CmnCheckShiftKey() == TRUE)) {
				...
				CmnDiagSetFocus(m_pDiag, m_uInfo.intRowMax, ID_COL_151_TEKI);
				return 1;
			}
			break;
*/
...
// midori 155866 add <--
				intCol = CmnGetControlCol();
				if (intCol == ID_COL_151_SPDATE || intCol == ID_COL_151_SPDATE2) {
// 修正No.157633_元号日付 add -->
					if(bG_Kanso == TRUE && (pMsg->wParam == VK_UP || pMsg->wParam == VK_DOWN))	{
						if(intCol == ID_COL_151_SPDATE)	{
...
// 修正No.158259 add -->
				else if(intCol == ID_COL_151_KUBUN)	{
...
// 頁コントロールのフォーカス設定
void	CfrmUc151Tidaiyatin::FocusPagediag1()
{
...
// 頁コントロールのゲットフォーカス
void	CfrmUc151Tidaiyatin::EditONPagediag1( short index )
{
// midori 151405 add -->
	// スクロールフラグをクリアする
	nG_MScroll = 0;
...
// midori 151405 add <--
	...
	// 1行登録
//	if( CmnGetControlCol() != ID_COL_151_VAL ){
...
// 頁コントロールのロストフォーカス
void	CfrmUc151Tidaiyatin::EditOFFPagediag1( short index )
{
// midori 155028 add -->
...
// 頁コントロールのキー操作
void	CfrmUc151Tidaiyatin::TerminationPagediag1( short index, short nChar, short length, LPUNKNOWN data )
{
	int nMaxDataCol = 0;
	// カレント頁の合計行の種別を取得
...
// midori 160612 cor <--
			...
			//CmnDiagSetFocus(m_pDiag, m_uInfo.intRowMax, ID_COL_151_TEKI);
			CmnDiagSetFocus(m_pDiag, nMaxDataCol, ID_COL_151_TEKI);
		}
		break;
	case VK_DOWN:
		// タイトルコントロールへ移動
...
// タイトルコントロールのフォーカス設定
void	CfrmUc151Tidaiyatin::FocusTitlediag1()
{
//マウスクリックでキャレットが表示できないためコメントとする
//	// ボタンからTabキー移動した場合に必要
//	m_TitleDiag.SetPosition( 0 );
...
// タイトルコントロールのゲットフォーカス
void	CfrmUc151Tidaiyatin::EditONTitlediag1( short index )
{
// midori 151405 add -->
	// スクロールフラグをクリアする
	nG_MScroll = 0;
...
// タイトルコントロールのロストフォーカス
void	CfrmUc151Tidaiyatin::EditOFFTitlediag1 (short index )
{
// midori 151405 add -->
	m_Titlefocus = 0;
// midori 151405 add <--
...
//	タイトル更新
void CfrmUc151Tidaiyatin::virUpdateTitle()
{
...
// タイトルコントロールのキーイベント
void	CfrmUc151Tidaiyatin::TerminationTitlediag1( short index, short nChar, short length, LPUNKNOWN data )
{
	// フォーカス移動
	switch ( nChar ) {
	case VK_RETURN:
...
void	CfrmUc151Tidaiyatin::EditONYoushikidiag1( short index )
{
	DIAGRAM_DATA	diadata;
	int				intRet = -1;
...
// 修正No.157633_元号日付 add -->
	...
	if(bG_Kanso == TRUE)	{
		...
		if(m_uInfo.intCurCol == ID_COL_151_SPDATE || m_uInfo.intCurCol == ID_COL_151_SPDATE2)	m_uInfo.EditSign = 1;
		else																					m_uInfo.EditSign = -1;
	}
// 修正No.157633_元号日付 add <--

	switch (m_uInfo.intCurCol) {
	case ID_COL_151_KUBUN: // 地代･家賃の区分
		// コンボボックスのオフセット値取得
		m_pDiag->GetData( m_uInfo.intCurCtlIndex , (LPUNKNOWN)&diadata );
...
// 修正No.157633_元号日付 add -->
		...
		break;
// 修正No.157633_元号日付 add <--
	case ID_COL_151_SPDATE2:	// 支払対象期間
		// 日付の値を取得
// midori 200101 del -->
...
// データコントロールのロストフォーカス
void	CfrmUc151Tidaiyatin::EditOFFYoushikidiag1( short index )
{
	if( m_EndView != FALSE )	return;
...
//	入力確定
void CfrmUc151Tidaiyatin::virInputDecisionEditOFF()
{
	// フォーカスフラグOFF
...
// 預貯金データコントロールのキーイベント
void	CfrmUc151Tidaiyatin::TerminationYoushikidiag1( short index, short nChar, short length, LPUNKNOWN data )
{
	//--------------------------------------------------------------------------------
	//	キー操作仕様
...
// 修正No.157633_元号日付 add -->
				if(bG_Kanso == TRUE)	{
					...
					else if(intCol == ID_COL_151_SPDATE2)	{
						m_uInfo.OldDate[1] = 0;
						m_uInfo.OldGengo[1] = 0;
					}
...
// midori 151405 add -->
void CfrmUc151Tidaiyatin::VScrollYoushikidiag1(short mode)
{
...
//********************************************************************************
int	CfrmUc151Tidaiyatin::GetFocusPosition( int nChar )
{
	int		intRow;				// カレント行番号
	int		intCol;				// カレント列番号
	...
	else if (( intCol == ID_COL_151_YOUTO )   ||
			 ( intCol == ID_COL_151_ADNAME1 )) {
	...
	else if (( intCol == ID_COL_151_AD2ADD1 )  ||
			 ( intCol == ID_COL_151_ADADD1 )) {
	...
	else if (( intCol == ID_COL_151_AD2ADD2 )  ||
			 ( intCol == ID_COL_151_ADADD2 )) {
	...
	else if ( intCol == ID_COL_151_SPDATE ){
		// カレント列が「支払対象期間1」の場合
		intVector[0] = m_uInfo.intCurCtlIndex - m_uInfo.intColMax + 2;	// ↑
		intVector[1] = m_uInfo.intCurCtlIndex + 1;						// →
		intVector[2] = m_uInfo.intCurCtlIndex + 1;						// ↓
	...
	else if ( intCol == ID_COL_151_TEKI ) {
		// カレント列が「摘要」の場合
		intVector[0] = m_uInfo.intCurCtlIndex - m_uInfo.intColMax;		// ↑
...
//********************************************************************************
int	CfrmUc151Tidaiyatin::GetTotalRowIndex( int nCharOrg, int intIndex, int intNext )
{
	...
	if ( nNowRow <= nBorder[0] ){
		...
		if (( intNext > CmnGetControlIndex( m_uInfo.intRowMax, ID_COL_151_TEKI ) ) && ( nCharOrg == VK_TAB )){
			return( -2 );
		}
		//	データ行を超えた？かつ計行あり？
		else if (( nNextRow > nBorder[0] ) && ( nBorder[1] > 0 )){
			//	計行に移動
			//nRet = CmnGetControlIndex( ( nBorder[1] + 2 ), ID_COL_151_KUBUN );
			if (nCharOrg == VK_TAB) {
				return -2;
			}
		}
	...
	//	現在、頁計に居る
		...
		case VK_UP:			// ↑：23行目のデータ行の支店名項目へ移動
			nRet = CmnGetControlIndex( nBorder[0], ID_COL_151_AD2ADD2 );
			break;
		case VK_LEFT:		// ←/Shift+Tab：23行目のデータ行の摘要項目へ移動
			nRet = CmnGetControlIndex( nBorder[0], ID_COL_151_TEKI );
			break;
		default:			// →/↓/Return/Tab：25行目の合計行②へ移動
			...
			//	累計なし
				...
				nRet = CmnGetControlIndex( ( nBorder[2] + 2 ), ID_COL_151_KUBUN );
			}
			break;
		}
	}
...
//********************************************************************************
int	CfrmUc151Tidaiyatin::virTblSortSubSortProc( CdlgSort* pCdlgSort, CdbUc000Common* rsData )
{
	CdbUc151Tidaiyatin*	rs;
	CString				strFilter;
	CString				strSort;
...
/**********************************************************************
	...
	戻値
		int		成功/失敗
				FUNCTION_OK
***********************************************************************/
int	CfrmUc151Tidaiyatin::RecBufSetData( CdbUc151Tidaiyatin* prmDbRec )
{
...
/**********************************************************************
	...
	戻値
		int		成功/失敗
				FUNCTION_OK
***********************************************************************/
int	CfrmUc151Tidaiyatin::RecBufClearAllData()
{
...
/**********************************************************************
	...
	戻値
		int		成功/失敗
				FUNCTION_OK
***********************************************************************/
int	CfrmUc151Tidaiyatin::RecBufClearData( P_REC_UC_151_TIDAIYATIN inRecData )
{
...
/**********************************************************************
	...
	戻値
		int				成功(更新あり)/成功(更新なし)/失敗
						...
						FUNCTION_NG		: 失敗
***********************************************************************/
int	CfrmUc151Tidaiyatin::virRecBufSaveData( int inPage, int inRow )
{
	...
	// 地代・家賃の区分
	intIndex = CmnGetControlIndex( inRow, ID_COL_151_KUBUN );
...
// midori 200101 add <--
	...
	// 支払対象期間
	intIndex = CmnGetControlIndex( inRow, ID_COL_151_SPDATE2 );
// midori 200101 del -->
	//tmpSaveData.m_SpDate2 = CmnDiagGetDateWMD( m_pDiag, intIndex, DC_DATE_WMD, m_ReadData[inRow].m_SpDate2 );
	//blnSpDate2 = CmnCheckDate( m_pDiag, intIndex, DC_DATE_WMD, m_ReadData[inRow].m_SpDate2 );
// midori 200101 del <--
// midori 200101 add -->
	if(bG_Kanso == TRUE) {
...
// midori 200101 add <--
	...
	// 支払貸借料
	intIndex = CmnGetControlIndex( inRow, ID_COL_151_VAL );
	tmpSaveData.m_Val = CmnDiagGetKingaku( m_pDiag, intIndex );

	// 摘要
	intIndex = CmnGetControlIndex( inRow, ID_COL_151_TEKI );
...
***********************************************************************/
int	CfrmUc151Tidaiyatin::virRecBufSaveDataForPasteInsert( int inPage, int inRow )
{
...
***********************************************************************/
int	CfrmUc151Tidaiyatin::virRecBufSaveDataForPaste( int inPage, int inRow )
{
	///////////////////////////////////////////////////////////////
	// 登録処理呼び出し
	return RecBufSaveDataSub( inPage, inRow, &m_CopyData );
...
/**********************************************************************
	...
	戻値
			int					成功(更新あり)/成功(更新なし)/失敗
								...
								FUNCTION_NG		: 失敗
***********************************************************************/
int	CfrmUc151Tidaiyatin::RecBufSaveDataSub( 
							int inPage,
							int inRow,
...
//	BOOL	ufgKubun = FALSE;	// 変更確認フラグ(地代・家賃の区分)
...
//********************************************************************************
CdbUc000Common*	CfrmUc151Tidaiyatin::virGetDataTableObject()
{
	// 「地代家賃」テーブルのオブジェクトを生成し、ポインタを返す
...
//	RET	なし
//********************************************************************************
void	CfrmUc151Tidaiyatin::virRowButtonCopyProc()
{
...
//	RET	なし
//********************************************************************************
void	CfrmUc151Tidaiyatin::virTblGetKamokuInfo( CdbUc000Common* rsData, SORTKAMOKU_INFO* uKamoku )
{
...
//	RET	なし
//********************************************************************************
void	CfrmUc151Tidaiyatin::virGetCurrentInfo( CURRENT_INFO* uCurInfo )
{
...
//********************************************************************************
int	CfrmUc151Tidaiyatin::virUpdateRelationTblChengeFormType()
{
...
// midori 152770 del -->
//	int intRet2 = pfrm153.UpdateTbl153ChangeFormType();
// midori 152770 del <--
// midori 152770 add -->
...
//		RET		BOOL		TRUE:正常終了，FALSE:エラー
//********************************************************************************
BOOL CfrmUc151Tidaiyatin::virUpdateRelationTblChengeFormTypeSave()
{
...
////		RET		なし
////********************************************************************************
//int	CfrmUc151Tidaiyatin::UpdateTbl151ChangeFormType()
//{
//	// 初期値設定
...
//		RET		なし
//********************************************************************************
int	CfrmUc151Tidaiyatin::UpdateTbl151ChangeFormType(UCHIWAKE_INFO pInfoSv)
{
	// データ無しならデータ更新しない
...
//	【戻値】	なし
//**************************************************
void CfrmUc151Tidaiyatin::SetInputMode( int nRow, long nMode )
{
	m_pDiag->ModifyItem( CmnGetControlIndex( nRow, ID_COL_151_KUBUN ), nMode );		//	地代・家賃の区分
	m_pDiag->ModifyItem( CmnGetControlIndex( nRow, ID_COL_151_YOUTO ), nMode );		//	借地物件の用途
	m_pDiag->ModifyItem( CmnGetControlIndex( nRow, ID_COL_151_AD2ADD1 ), nMode );	//	所在地（上段）
	m_pDiag->ModifyItem( CmnGetControlIndex( nRow, ID_COL_151_AD2ADD2 ), nMode );	//	所在地（下段）
	m_pDiag->ModifyItem( CmnGetControlIndex( nRow, ID_COL_151_ADNAME1 ), nMode );	//	貸主の名称
	m_pDiag->ModifyItem( CmnGetControlIndex( nRow, ID_COL_151_ADADD1 ), nMode );	//	貸主の所在地（上段）
	m_pDiag->ModifyItem( CmnGetControlIndex( nRow, ID_COL_151_ADADD2 ), nMode );	//	貸主の所在地（下段）
	m_pDiag->ModifyItem( CmnGetControlIndex( nRow, ID_COL_151_SPDATE ), nMode );	//	支払対象期間（上段）
	m_pDiag->ModifyItem( CmnGetControlIndex( nRow, ID_COL_151_SPDATE2 ), nMode );	//	支払対象期間（下段）
	m_pDiag->ModifyItem( CmnGetControlIndex( nRow, ID_COL_151_VAL ), nMode );		//	支払貸借料
	m_pDiag->ModifyItem( CmnGetControlIndex( nRow, ID_COL_151_TEKI ), nMode );		//	摘要
}
...
//	【戻値】	なし
//**************************************************
void CfrmUc151Tidaiyatin::SetDiagBackColor()
{
...
//***************************************************************************
BOOL CfrmUc151Tidaiyatin::virEndProc(void)
{
	TRACE(_T("***** CfrmUc151Tidaiyatin::virEndProc\n"));
...
// midori 161106 add -->
void CfrmUc151Tidaiyatin::ComboNew(short index)
{
	short			sv_sel=0;
// midori 152201 add -->
...
// midori 151405 add -->
int CfrmUc151Tidaiyatin::CursorControl(short nChar, int sw)
{
	int				rv=0;
	int				intCol=0;
	int				pos=0;
...
// midori 152134 add -->
void CfrmUc151Tidaiyatin::ComboSelYoushikidiag1(short index, LPUNKNOWN data)
{
// 要通知案件修正 21/07/09 del -->
...
// ------------------------------------------------------------------------------------------------------------------------
void CfrmUc151Tidaiyatin::TitleColorChg(void)
{
	...
	// 地代・家賃の区分
// 修正No.157628 del -->
	//strSQL.Format(_T("select max(oversgn) from (select CASE when len(Replace(isnull(KnName,''),CHAR(13)+CHAR(10),'')) > %d then 1 else 0 end as oversgn from uc_151_tidaiyatin where FgShow=%d) tbl1"),UC_151_KUBUN_LEN,ID_FGSHOW_OFF);
// 修正No.157628 del <--
// 修正No.157628 add -->
...
// 修正No.157628 add <--
	...
	// 借地(借家)物件の用途
// 修正No.157628 del -->
	//strSQL.Format(_T("select max(oversgn) from (select CASE when len(Replace(isnull(Youto,''),CHAR(13)+CHAR(10),'')) > %d then 1 else 0 end as oversgn from uc_151_tidaiyatin where FgShow=%d) tbl1"),UC_151_YOUTO_LEN,ID_FGSHOW_OFF);
// 修正No.157628 del <--
// 修正No.157628 add -->
	strSQL.Format(_T("select max(oversgn) from (select CASE when len(%s) > %d then 1 else 0 end as oversgn from uc_151_tidaiyatin where FgShow=%d) tbl1"),
...
// 修正No.157628 add <--
	...
	// 摘要
// 修正No.157628 del -->
	//strSQL.Format(_T("select max(oversgn) from (select CASE when len(Replace(isnull(Teki,''),CHAR(13)+CHAR(10),'')) > %d then 1 else 0 end as oversgn from uc_151_tidaiyatin where FgShow=%d) tbl1"),UC_151_TEKI_LEN,ID_FGSHOW_OFF);
// 修正No.157628 del <--
// 修正No.157628 add -->
	strSQL.Format(_T("select max(oversgn) from (select CASE when len(%s) > %d then 1 else 0 end as oversgn from uc_151_tidaiyatin where FgShow=%d) tbl1"),
...
// 修正No.157628 add <--
	...
	// 項目タイトル(ヘッダ部)の再設定
// 修正No.157626 del -->
	////CmnHeadDiagSetTitle(&m_HeadDiag,0,_T("地代・家賃\r\nの  区  分(10)"),nCharOver[0]);
	//CmnHeadDiagSetTitle(&m_HeadDiag,0,_T("地代・家賃\r\nの　区　分\r\n(10)"),nCharOver[0]);
	//CmnHeadDiagSetTitle(&m_HeadDiag,1,_T("借地（借家）物件の用途(10)"),nCharOver[1]);
	//CmnHeadDiagSetTitle(&m_HeadDiag,7,_T("摘  要(40)"),nCharOver[2]);
// 修正No.157626 del <--
// 修正No.157626 add -->
	...
	if(nCharOver[2] == 1)	CmnHeadDiagSetTitle(&m_HeadDiag,7,_T("摘  要(40)"),1);
...
// --------------------------------------------------------------------------------------------------------
void CfrmUc151Tidaiyatin::Date_ChkAndSet(short index, int col, short sign)
{
	short			sv_sel=0;
	int				sv_index=0;
	int				day=0,gen=0;
	...
	if(m_DataKakutei == TRUE)									return;
	if(col != ID_COL_151_SPDATE && col != ID_COL_151_SPDATE2)	return;
	...
	if(sign == 1)	{
		if(col == ID_COL_151_SPDATE)	{		// 支払対象期間1
		...
		else if(col == ID_COL_151_SPDATE2)	{	// 支払対象期間2
...
// 修正No.162446 add -->
LRESULT CfrmUc151Tidaiyatin::OnUserReDrawView(WPARAM wParam, LPARAM lParam)
{
	virUpdateControlTblData();
	CmnDiagSetFocus(m_pDiag, 1, 1);
