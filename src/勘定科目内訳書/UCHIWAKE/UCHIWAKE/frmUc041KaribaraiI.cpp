...
IMPLEMENT_DYNCREATE( CfrmUc041KaribaraiI, CfrmUc000Common )


BEGIN_MESSAGE_MAP( CfrmUc041KaribaraiI, CfrmUc000Common )
	ON_WM_SIZE()
	...
	ON_COMMAND( ID_PRINTSETUP_MENU, &CfrmUc041KaribaraiI::OnMenuPrintSetup )
	ON_COMMAND( ID_PRINTALL_MENU, &CfrmUc041KaribaraiI::OnMenuPrintAll )
	ON_COMMAND( ID_OUTPUTFORM_MENU, &CfrmUc041KaribaraiI::OnMenuFormTypeSetup )
	ON_COMMAND( ID_SPECIALROW_MENU, &CfrmUc041KaribaraiI::OnMenuSpecialRow )
	ON_COMMAND( ID_SORT_MENU, &CfrmUc041KaribaraiI::OnMenuSort )
	ON_COMMAND(ID_IKKATUADD_MENU, &CfrmUc041KaribaraiI::OnIkkatuAddMenu)
	ON_COMMAND( ID_DISPDIALOG_MENU, &CfrmUc041KaribaraiI::OnMenuIkkatuKingaku )
	ON_COMMAND( ID_ZEROMONEY_MENU, &CfrmUc041KaribaraiI::OnMenuZeroMoney )
	ON_COMMAND( ID_ZEROMONEYMOVE_MENU, &CfrmUc041KaribaraiI::OnMenuZeroMoneyMove )
	ON_COMMAND( ID_AMOUTDIALOG_MENU, &CfrmUc041KaribaraiI::OnMenuOutKeiSetup )
	ON_COMMAND( ID_CLEAR_MENU, &CfrmUc041KaribaraiI::OnMenuClear )
	ON_COMMAND( ID_RENDO_MENU, &CfrmUc041KaribaraiI::OnMenuZaimuRendo )
	ON_COMMAND( ID_TITLEMENU, &CfrmUc041KaribaraiI::OnMenuTitleRestore )
	ON_COMMAND( ID_USER_SETTING_MENU, &CfrmUc041KaribaraiI::OnMenuOptionSetting )
	ON_COMMAND( ID_COPY_SETTING_INFO_MENU, &CfrmUc041KaribaraiI::OnMenuCopySettingInfo )
	ON_COMMAND( ID_DELETE_DATA_MENU, &CfrmUc041KaribaraiI::OnMenuDeleteDataEachYoushiki )
	ON_BN_CLICKED( IDC_PAGEBACK_BUTTON1, &CfrmUc041KaribaraiI::OnPageBack )
	ON_BN_CLICKED( IDC_PAGENEXT_BUTTON1, &CfrmUc041KaribaraiI::OnPageNext )
	ON_BN_CLICKED( IDC_PAGENEW_BUTTON1, &CfrmUc041KaribaraiI::OnPageNew )
	ON_BN_CLICKED( IDC_PAGEINSERT_BUTTON1, &CfrmUc041KaribaraiI::OnPageInsert )
	ON_BN_CLICKED( IDC_ROWCOPY_BUTTON1, &CfrmUc041KaribaraiI::OnRowCopy )
	ON_BN_CLICKED( IDC_ROWPASTE_BUTTON1, &CfrmUc041KaribaraiI::OnRowPaste )
	ON_BN_CLICKED( IDC_ROWINSERT_BUTTON1, &CfrmUc041KaribaraiI::OnRowInsert )
	ON_BN_CLICKED( IDC_YOUSHIKINEXT_BUTTON1, &CfrmUc041KaribaraiI::OnMoveYoushikiNext )
	ON_BN_CLICKED( IDC_YOUSHIKIBACK_BUTTON1, &CfrmUc041KaribaraiI::OnMoveYoushikiBack )
	ON_UPDATE_COMMAND_UI( ID_BUTTON_F6, &CfrmUc041KaribaraiI::OnUpdateButtonF6 )
	ON_UPDATE_COMMAND_UI( ID_BUTTON_F7, &CfrmUc041KaribaraiI::OnUpdateButtonF7 )
	ON_UPDATE_COMMAND_UI( ID_BUTTON_F8, &CfrmUc041KaribaraiI::OnUpdateButtonF8 )
	ON_UPDATE_COMMAND_UI( ID_BUTTON_F9, &CfrmUc041KaribaraiI::OnUpdateButtonF9 )
	ON_UPDATE_COMMAND_UI( ID_BUTTON_F11, &CfrmUc041KaribaraiI::OnUpdateButtonF11 )
	ON_UPDATE_COMMAND_UI( ID_BUTTON_F12, &CfrmUc041KaribaraiI::OnUpdateButtonF12 )
	ON_UPDATE_COMMAND_UI( ID_BUTTON_HOME, &CfrmUc041KaribaraiI::OnUpdateButtonHome )
	ON_UPDATE_COMMAND_UI( ID_IKKATUADD_MENU, &CfrmUc041KaribaraiI::OnUpdateIkkatuaddMenu)
	ON_UPDATE_COMMAND_UI( ID_DISPDIALOG_MENU, &CfrmUc041KaribaraiI::OnUpdateMenuIkkatuKingaku )
	ON_UPDATE_COMMAND_UI( ID_SORT_MENU, &CfrmUc041KaribaraiI::OnUpdateMenuSort )
	ON_UPDATE_COMMAND_UI( ID_CLEAR_MENU, &CfrmUc041KaribaraiI::OnUpdateMenuClear )
	ON_UPDATE_COMMAND_UI( ID_ZEROMONEY_MENU, &CfrmUc041KaribaraiI::OnUpdateMenuZeroMoney )
	ON_UPDATE_COMMAND_UI( ID_ZEROMONEYMOVE_MENU, &CfrmUc041KaribaraiI::OnUpdateMenuZeroMoneyMove)
	ON_UPDATE_COMMAND_UI( ID_RENDO_MENU, &CfrmUc041KaribaraiI::OnUpdateMenuZaimuRendo )
	ON_UPDATE_COMMAND_UI(ID_SPECIALROW_MENU, &CfrmUc041KaribaraiI::OnUpdateMenuSpecialRow)
	ON_UPDATE_COMMAND_UI( ID_TITLEMENU, &CfrmUc041KaribaraiI::OnUpdateMenuTitleRestore )
	ON_UPDATE_COMMAND_UI( ID_DELETE_DATA_MENU, &CfrmUc041KaribaraiI::OnUpdateMenuDeleteDataEachYoushiki )
	ON_MESSAGE(WM_USER_REDRAWVIEW, OnUserReDrawView)
END_MESSAGE_MAP()


CfrmUc041KaribaraiI::CfrmUc041KaribaraiI()
	: CfrmUc000Common( CfrmUc041KaribaraiI::IDD )
{
...
CfrmUc041KaribaraiI::~CfrmUc041KaribaraiI()
{
	...
	TRACE(_T("***** CfrmUc041KaribaraiI::~CfrmUc041KaribaraiI\n"));
}

void CfrmUc041KaribaraiI::DoDataExchange( CDataExchange* pDX )
{
...
void CfrmUc041KaribaraiI::OnInitialUpdate()
{
...
#ifdef _DEBUG
void CfrmUc041KaribaraiI::AssertValid() const
{
	CfrmUc000Common::AssertValid();
}

#ifndef _WIN32_WCE
void CfrmUc041KaribaraiI::Dump( CDumpContext& dc ) const
{
...
BEGIN_EVENTSINK_MAP( CfrmUc041KaribaraiI, CfrmUc000Common )
	ON_EVENT( CfrmUc041KaribaraiI, IDC_YOUSHIKIDIAG1, 3, CfrmUc041KaribaraiI::TerminationYoushikidiag1, VTS_I2 VTS_I2 VTS_I2 VTS_UNKNOWN )
	ON_EVENT( CfrmUc041KaribaraiI, IDC_YOUSHIKIDIAG1, 2, CfrmUc041KaribaraiI::EditOFFYoushikidiag1, VTS_I2 )
	ON_EVENT( CfrmUc041KaribaraiI, IDC_YOUSHIKIDIAG1, 1, CfrmUc041KaribaraiI::EditONYoushikidiag1, VTS_I2 )
	ON_EVENT(CfrmUc041KaribaraiI, IDC_YOUSHIKIDIAG1, 12, CfrmUc041KaribaraiI::VScrollYoushikidiag1, VTS_I2)
	ON_EVENT(CfrmUc041KaribaraiI, IDC_YOUSHIKIDIAG1, 8, CfrmUc041KaribaraiI::ComboSelYoushikidiag1, VTS_I2 VTS_UNKNOWN)

	ON_EVENT( CfrmUc041KaribaraiI, IDC_YOUSHIKIDIAG2, 3, CfrmUc041KaribaraiI::TerminationYoushikidiag1, VTS_I2 VTS_I2 VTS_I2 VTS_UNKNOWN )
	ON_EVENT( CfrmUc041KaribaraiI, IDC_YOUSHIKIDIAG2, 2, CfrmUc041KaribaraiI::EditOFFYoushikidiag1, VTS_I2 )
	ON_EVENT( CfrmUc041KaribaraiI, IDC_YOUSHIKIDIAG2, 1, CfrmUc041KaribaraiI::EditONYoushikidiag1, VTS_I2 )
	ON_EVENT(CfrmUc041KaribaraiI, IDC_YOUSHIKIDIAG2, 12, CfrmUc041KaribaraiI::VScrollYoushikidiag1, VTS_I2)
	ON_EVENT(CfrmUc041KaribaraiI, IDC_YOUSHIKIDIAG2, 8, CfrmUc041KaribaraiI::ComboSelYoushikidiag1, VTS_I2 VTS_UNKNOWN)

	ON_EVENT( CfrmUc041KaribaraiI, IDC_YOUSHIKIDIAG3, 3, CfrmUc041KaribaraiI::TerminationYoushikidiag1, VTS_I2 VTS_I2 VTS_I2 VTS_UNKNOWN )
	ON_EVENT( CfrmUc041KaribaraiI, IDC_YOUSHIKIDIAG3, 2, CfrmUc041KaribaraiI::EditOFFYoushikidiag1, VTS_I2 )
	ON_EVENT( CfrmUc041KaribaraiI, IDC_YOUSHIKIDIAG3, 1, CfrmUc041KaribaraiI::EditONYoushikidiag1, VTS_I2 )
	ON_EVENT(CfrmUc041KaribaraiI, IDC_YOUSHIKIDIAG3, 12, CfrmUc041KaribaraiI::VScrollYoushikidiag1, VTS_I2)
	ON_EVENT(CfrmUc041KaribaraiI, IDC_YOUSHIKIDIAG3, 8, CfrmUc041KaribaraiI::ComboSelYoushikidiag1, VTS_I2 VTS_UNKNOWN)

	ON_EVENT( CfrmUc041KaribaraiI, IDC_YOUSHIKIDIAG4, 3, CfrmUc041KaribaraiI::TerminationYoushikidiag1, VTS_I2 VTS_I2 VTS_I2 VTS_UNKNOWN )
	ON_EVENT( CfrmUc041KaribaraiI, IDC_YOUSHIKIDIAG4, 2, CfrmUc041KaribaraiI::EditOFFYoushikidiag1, VTS_I2 )
	ON_EVENT( CfrmUc041KaribaraiI, IDC_YOUSHIKIDIAG4, 1, CfrmUc041KaribaraiI::EditONYoushikidiag1, VTS_I2 )
	ON_EVENT(CfrmUc041KaribaraiI, IDC_YOUSHIKIDIAG4, 12, CfrmUc041KaribaraiI::VScrollYoushikidiag1, VTS_I2)
	ON_EVENT(CfrmUc041KaribaraiI, IDC_YOUSHIKIDIAG4, 8, CfrmUc041KaribaraiI::ComboSelYoushikidiag1, VTS_I2 VTS_UNKNOWN)

	ON_EVENT( CfrmUc041KaribaraiI, IDC_TITLEDIAG1, 3, CfrmUc041KaribaraiI::TerminationTitlediag1, VTS_I2 VTS_I2 VTS_I2 VTS_UNKNOWN )
	ON_EVENT( CfrmUc041KaribaraiI, IDC_TITLEDIAG1, 2, CfrmUc041KaribaraiI::EditOFFTitlediag1, VTS_I2 )
	ON_EVENT( CfrmUc041KaribaraiI, IDC_TITLEDIAG1, 1, CfrmUc041KaribaraiI::EditONTitlediag1, VTS_I2 )
	ON_EVENT( CfrmUc041KaribaraiI, IDC_TITLEDIAG1, 6, CfrmUc041KaribaraiI::FocusTitlediag1, VTS_NONE )

	ON_EVENT( CfrmUc041KaribaraiI, IDC_PAGEDIAG1, 3, CfrmUc041KaribaraiI::TerminationPagediag1, VTS_I2 VTS_I2 VTS_I2 VTS_UNKNOWN )
	ON_EVENT( CfrmUc041KaribaraiI, IDC_PAGEDIAG1, 2, CfrmUc041KaribaraiI::EditOFFPagediag1, VTS_I2 )
	ON_EVENT( CfrmUc041KaribaraiI, IDC_PAGEDIAG1, 1, CfrmUc041KaribaraiI::EditONPagediag1, VTS_I2 )
	ON_EVENT( CfrmUc041KaribaraiI, IDC_PAGEDIAG1, 6, CfrmUc041KaribaraiI::FocusPagediag1, VTS_NONE )
END_EVENTSINK_MAP()

//********************************************************************************
//	初期処理
//********************************************************************************
BOOL	CfrmUc041KaribaraiI::virStartJob()
{
	// 初期値設定
...
//	共通データの初期値設定
//********************************************************************************
void	CfrmUc041KaribaraiI::virSetInitialUchiwakeInfo()
{
	// 「仮払金」の固有データ
	...
	m_uInfo.intColMax = ID_COLMAX_041I;					// １行内のコントロール個数
	m_uInfo.intColMaxData = ID_COLMAXDATA_041I;			// １行内の列数
	m_uInfo.intCtlStartIndex = ID_CTLSTARTINDEX_041I;	// １行目の入力項目の先頭インデックス番号
	m_uInfo.intT1StartIndex = ID_T1STARTNORMAL_041I;	// 合計行①の先頭インデックス番号
	m_uInfo.intT2StartIndex = ID_T2STARTNORMAL_041I;	// 合計行②の入力項目の先頭インデックス番号
	m_uInfo.intCursolDefPos = ID_COL_041I_INVONO;		// カーソル移動時の初期位置（タイトルから↓，合計から↑で使用）
	m_uInfo.intCursolKeiPos = ID_COL_041I_ADSEQ;		// 合計行のカーソル移動位置（カーソル移動で使用）
	...
	m_uInfo.intT1StartNormal = ID_T1STARTNORMAL_041I;	//	通常時：合計行①の先頭インデックス
	m_uInfo.intT2StartNormal = ID_T2STARTNORMAL_041I;	//	通常時：合計行②の先頭インデックス
	m_uInfo.intT1StartKobetu = ID_T1STARTKOBETU_041I;	//	個別時：合計行①の先頭インデックス
	m_uInfo.intT2StartKobetu = ID_T2STARTKOBETU_041I;	//	個別時：合計行②の先頭インデックス
	m_uInfo.intRowKei = ID_ROWKEI_041;					// 帳表固定の合計行数（1:合計あり，0:なし）
	m_uInfo.intKei1StartIndex = ID_COL_041I_KEI1_MEISYO;	// 計ダイアグラム1行目の先頭インデックス
	m_uInfo.intKei2StartIndex = ID_COL_041I_KEI2_MEISYO;	// 計ダイアグラム2行目の先頭インデックス
...
//	【戻値】	なし
//**************************************************
void CfrmUc041KaribaraiI::virSetInitialDiag()
{	
	int		nIndex;
	...
	//	コンボボックスの属性取得
	nIndex = CmnGetControlIndex( 1, ID_COL_041I_ADSEQ );
...
//	帳表固有変数の初期値設定
//********************************************************************************
void	CfrmUc041KaribaraiI::virSetInitialValue()
{
	// 1ページ分のローカルバッファをクリア
	RecBufClearAllData();
...
//	帳表コントロールの初期化（データ領域）
//********************************************************************************
BOOL	CfrmUc041KaribaraiI::InitialControlDataArea()
{
	int		intMax;
	int		i;
	int		len=0;
	...
	for ( i = m_uInfo.intCtlStartIndex; i < intMax; i += m_uInfo.intColMax ) {
		// ComboBox：クリア
		CmnDiagSetString(m_pDiag, i + ID_COL_041I_ADSEQ   - 1, "", 0);	// 科目
		CmnDiagSetString(m_pDiag, i + ID_COL_041I_INVONOT - 1, "", 0);	// 登録番号(T選択)

		// 漢字入力欄の初期化
		CmnDiagSetAttrInpmax( m_pDiag, i + ID_COL_041I_ADNAME1 - 1, MAX_KETA_041_ADNAME1 );		//	名称１
		CmnDiagSetAttrInpmax( m_pDiag, i + ID_COL_041I_ADADD1  - 1, MAX_KETA_041_ADADD1 );		//	住所１
		CmnDiagSetAttrInpmax( m_pDiag, i + ID_COL_041I_ADADD2  - 1, MAX_KETA_041_ADADD2 );		//	住所２
		CmnDiagSetAttrInpmax( m_pDiag, i + ID_COL_041I_KANKEI  - 1, MAX_KETA_041_KANKEI );		//	法人・代表者との関係
		CmnDiagSetAttrInpmax( m_pDiag, i + ID_COL_041I_NAIYOU  - 1, MAX_KETA_041_NAIYOU );		//	摘要

		// 金額欄：桁数初期化
		// 期末現在高
		len = ID_VAL_041_K_DATA;
		CmnDiagSetAttrDigit( m_pDiag, i + ID_COL_041I_VAL - 1, len );
	...
	// 半角/全角設定
	CmnDiagSetAttrColZenHan( m_pDiag , ID_COL_041I_ADNAME1 );		// 名称1(氏名)
	CmnDiagSetAttrColZenHan( m_pDiag , ID_COL_041I_ADADD1 );		// 所在地1(住所)
	CmnDiagSetAttrColZenHan( m_pDiag , ID_COL_041I_ADADD2 );		// 所在地2(住所)
	CmnDiagSetAttrColZenHan( m_pDiag , ID_COL_041I_KANKEI );		// 法人・代表者との関係
	CmnDiagSetAttrColZenHan( m_pDiag , ID_COL_041I_NAIYOU );		// 取引の内容
...
//********************************************************************************
BOOL	CfrmUc041KaribaraiI::InitialControlDataAreaHide( CICSDiag* pDiag )
{
	int		intMax;
	int		i;
	int		len=0;
	...
	for ( i = m_uInfo.intCtlStartIndex; i < intMax; i += m_uInfo.intColMax ) {
		// ComboBox：クリア
		CmnDiagSetString( pDiag, i + ID_COL_041I_ADSEQ - 1, "", 0 );	// 科目

		// 漢字入力欄の初期化
		CmnDiagSetAttrInpmax( pDiag, i + ID_COL_041I_ADNAME1 - 1, MAX_KETA_041_ADNAME1 );			//	名称１
		CmnDiagSetAttrInpmax( pDiag, i + ID_COL_041I_ADADD1  - 1, MAX_KETA_041_ADADD1 );			//	住所１
		CmnDiagSetAttrInpmax( pDiag, i + ID_COL_041I_ADADD2  - 1, MAX_KETA_041_ADADD2 );			//	住所２
		CmnDiagSetAttrInpmax( pDiag, i + ID_COL_041I_KANKEI  - 1, MAX_KETA_041_KANKEI );			//	法人・代表者との関係
		CmnDiagSetAttrInpmax( pDiag, i + ID_COL_041I_NAIYOU  - 1, MAX_KETA_041_NAIYOU );			//	摘要

		// 金額欄：桁数初期化
		// 期末現在高
		len = ID_VAL_041_K_DATA;
		CmnDiagSetAttrDigit( pDiag, i + ID_COL_041I_VAL - 1, len );
	}
...
//********************************************************************************
BOOL	CfrmUc041KaribaraiI::InitialControlComboBox()
{
	...
	for(i = 1; i <= intMax; i++) {
		...
		// 科目
		intIndex = CmnGetControlIndex(i, ID_COL_041I_ADSEQ);
		// T選択
		intIndex2 = CmnGetControlIndex(i, ID_COL_041I_INVONOT);
...
//********************************************************************************
void	CfrmUc041KaribaraiI::InitialControlTotalArea()
{
	int		nKeiType;			//	計の種別
	...
	if(flg2[0] == 1)	{
		// 一括自動行の科目を入力可能にする
		m_pDiag->ModifyItem( CmnGetControlIndex( (nDataRowPos[0]+1), ID_COL_041I_ADSEQ ), (DIAG_MDFY_EDIT | DIAG_MDFY_OPAQUE) );
	}
	if(flg2[1] == 1)	{
		// 一括自動行の科目を入力可能にする
		m_pDiag->ModifyItem( CmnGetControlIndex( (nDataRowPos[1]+1), ID_COL_041I_ADSEQ ), (DIAG_MDFY_EDIT | DIAG_MDFY_OPAQUE) );
	}

	// 計専用ダイアグラムの金額欄を入力不可にする
	int intKeiRow = (DIAG_MDFY_READONLY | DIAG_MDFY_OPAQUE);
	m_pDiagKei->ModifyItem(ID_COL_041I_KEI1_VAL, intKeiRow);
	m_pDiagKei->ModifyItem(ID_COL_041I_KEI2_VAL, intKeiRow);
	if(nSw != 0)	{
...
//		→表示していない方のDiag(通常 or 個別)の設定に使用する
//********************************************************************************
void	CfrmUc041KaribaraiI::InitialControlTotalAreaHide( CICSDiag* pDiag )
{
	int intIndex = 0;
	...
	// 合計行の金額欄は、金額欄 + 1桁
	intIndex = m_intT1StartIndexHide + m_uInfo.intCtlStartIndex + ID_COL_041I_VAL - 1;
	CmnDiagSetAttrDigit( pDiag, intIndex, ID_VAL_041_TOTAL );

	intIndex = m_intT2StartIndexHide + m_uInfo.intCtlStartIndex + ID_COL_041I_VAL - 1;
	CmnDiagSetAttrDigit( pDiag, intIndex, ID_VAL_041_TOTAL );
}
...
//	RET	なし
//********************************************************************************
void	CfrmUc041KaribaraiI::InitialControlSpecialRow( int intRow, int intFgFunc )
{
	int				nIndex;		// インデックス
	...
	switch ( intFgFunc ) {
		...
		case ID_FGFUNC_IKKATUAUTO:		// 一括集計金額行（自動）
			// 桁数を設定
			CmnDiagSetAttrDigit( m_pDiag, CmnGetControlIndex( intRow , ID_COL_041I_VAL ), ID_VAL_041_TOTAL );
			break;
	}
	...
	switch (intFgFunc) {
		...
		case ID_FGFUNC_IKKATUAUTO:		// 一括集計金額行（自動）		
			...
			if ( intFgFunc != ID_FGFUNC_IKKATUAUTO ){
				...
				m_pDiag->ModifyItem( CmnGetControlIndex( intRow, ID_COL_041I_ADSEQ ), DIAG_MDFY_NODROPDOWN );
				// 「登録番号(T選択)」はComboBoxのため、DropDown不可とする
				m_pDiag->ModifyItem( CmnGetControlIndex( intRow, ID_COL_041I_INVONOT ), DIAG_MDFY_NODROPDOWN );

				// ComboBoxの選択項目クリア
				m_clsFunc.DiagInit( &diadata );
				diadata.text_combo = _T( "\r\n" );
				m_pDiag->SetData( CmnGetControlIndex( intRow, ID_COL_041I_ADSEQ ), (LPUNKNOWN)&diadata );
				m_pDiag->SetData( CmnGetControlIndex( intRow, ID_COL_041I_INVONOT ), (LPUNKNOWN)&diadata );
			}
...
// 改良No.21-0086,21-0529 cor <--
				...
				if (intFgFunc == ID_FGFUNC_IKKATUAUTO ){
					//	科目
					m_pDiag->ModifyItem( CmnGetControlIndex( intRow, ID_COL_041I_ADSEQ ), DIAG_MDFY_INPUT );
				}
			}
...
//	帳表タイトル情報の表示
//********************************************************************************
void	CfrmUc041KaribaraiI::virUpdateControlTitle()
{
...
//	帳表ページ情報の表示
//********************************************************************************
void	CfrmUc041KaribaraiI::UpdateControlPage()
{
	BOOL	bBack = TRUE;
	BOOL	bNext = TRUE;
...
//	帳表データの表示（１ページ分）
//********************************************************************************
BOOL	CfrmUc041KaribaraiI::virUpdateControlTblData()
{
	// ダイアログ切替
	if( m_pDiag != NULL ){
		virSetInitialDiag();
	...
	if(m_uInfo.intFormType == ID_FORMTYPE_NORMAL)	{
		CmnDiagSetAttrDigit( m_pDiagKei, CmnGetControlTotalIndex(1, ID_COL_041I_VAL), ID_VAL_041_TOTAL );
		CmnDiagSetAttrDigit( m_pDiagKei, CmnGetControlTotalIndex(2, ID_COL_041I_VAL), ID_VAL_041_TOTAL );
	}
	else {
		CmnDiagSetAttrDigit( m_pDiagKei, ID_COL_041I_KEI1_VAL, ID_VAL_041_TOTAL );
		CmnDiagSetAttrDigit( m_pDiagKei, ID_COL_041I_KEI2_VAL, ID_VAL_041_TOTAL );
	}
	...
	while ( !dbRec.IsEOF() ) {		// ファイル終端まで
		...
		// 科目
		CmnInitialControlFgStringCell( m_pDiag, dbRec.m_NumRow, ID_COL_041I_ADSEQ, dbRec.m_FgFunc, UC_KAMOKU_LEN, dbRec.m_KnName);
		// 相手先 法人・代表者との関係
		CmnInitialControlFgStringCell( m_pDiag, dbRec.m_NumRow, ID_COL_041I_KANKEI, dbRec.m_FgFunc, UC_041_KANKEI_LEN, dbRec.m_Kankei);
...
//	保管件数の表示
//********************************************************************************
BOOL CfrmUc041KaribaraiI::virUpdateControlTblData2()
{
	int					hcnt=0;
	CString				cs=_T("");
...
//		RET		なし
//********************************************************************************
void	CfrmUc041KaribaraiI::UpdateControlRowData( CdbUc041Karibarai* prmDbRec ) {
	...
	m_clsFunc.DiagInit( &diadata );
	// 読込み対象セル取得
	intCell = CmnGetControlIndex( prmDbRec->m_NumRow, ID_COL_041I_ADSEQ );
...
//		RET		なし
//********************************************************************************
void	CfrmUc041KaribaraiI::UpdateControlRowTotal( CdbUc041Karibarai* prmDbRec ) {
	...
	if (intRowName > 0) {
		if( m_uInfo.intFormType == ID_FORMTYPE_NORMAL ){
			// 計なしは従来通り
			CmnDiagSetString(m_pDiag, CmnGetControlTotalIndex(intRowName, ID_COL_041I_ADSEQ), prmDbRec->m_KeiStr, 0);
		}
		else{
			// 計ありは新たに追加した計ダイアログにセット
			CmnDiagSetString( m_pDiagKei, CmnGetKeiDiagIndex( intRowName, ID_COL_041I_KEI1_MEISYO ), prmDbRec->m_KeiStr, 1 );
		}
	}
	// 頁計/累計の金額表示
	if (intRowKingaku > 0) {
		if( m_uInfo.intFormType == ID_FORMTYPE_NORMAL ){
			// 計なしは従来通り
			CmnDiagSetKingaku(m_pDiag, CmnGetControlTotalIndex(intRowKingaku, ID_COL_041I_VAL), prmDbRec->m_Val);
		}
		else{
			// 計ありは新たに追加した計ダイアログにセット
			CmnDiagSetKingaku( m_pDiagKei, CmnGetKeiDiagIndex( intRowKingaku, ID_COL_041I_KEI1_VAL ), prmDbRec->m_Val );
		}
	}
}
...
//		RET		なし
//********************************************************************************
void	CfrmUc041KaribaraiI::virFncCellCopyProc( CdbUc000Common* rsData )
{
	...
	switch( intCol ){
		// 科目
		case ID_COL_041I_ADSEQ:
			CmnDiagSetCombo2( m_pDiag, m_uInfo.intCurCtlIndex, rs->m_KnOrder );
			break;
		// 登録番号（法人番号）
		case ID_COL_041I_INVONOT:
		// 登録番号
		case ID_COL_041I_INVONO:
			if(intCol == ID_COL_041I_INVONOT) {
...
//********************************************************************************
int		CfrmUc041KaribaraiI::virFncReferenceGetType(int intCol, int* intGrSeq, long* lngItemSeq, int* intAdd1, int* intAdd2, int* intAdd1Col, int* intAdd2Col, REFERENCE_INFO* pudReference)
{
	int				intRefType;
	...
	switch (intCol) {
		...
		case ID_COL_041I_ADADD2:
			...
			*intAdd1Col = ID_COL_041I_ADADD1;
			*intAdd2Col = ID_COL_041I_ADADD2;
			break;
...
//		RET		なし
//********************************************************************************
void	CfrmUc041KaribaraiI::virFncReferenceSetData( CdlgReference* dlgRef, int intRefType, int intCol )
{
	int			nCurRow;	//	カレント行
	int			nCurCol;	//	カレント列
	int			nPos;		//	位置
	...
	switch (intRefType) {
		...
		case ID_DLGTYPE_ADDRESS:
			...
			if(intCol == ID_COL_041I_INVONOT) {
				//	現在行の登録番号の位置を算出
				nPos = ((nCurRow - 1) * m_uInfo.intColMax) + (m_uInfo.intCtlStartIndex + (ID_COL_041I_INVONOT - 1));
			...
			else if(intCol == ID_COL_041I_INVONO) {
				//	現在行の登録番号の位置を算出
				nPos = ((nCurRow - 1) * m_uInfo.intColMax) + (m_uInfo.intCtlStartIndex + (ID_COL_041I_INVONO - 1));
			...
			else if(intCol == ID_COL_041I_ADNAME1) {
				//	現在行の名称１の位置を算出
				nPos = ((nCurRow - 1) * m_uInfo.intColMax) + (m_uInfo.intCtlStartIndex + (ID_COL_041I_ADNAME1 - 1));
...
//		RET		なし
//********************************************************************************
void	CfrmUc041KaribaraiI::virFncReferenceSetICSData(CdlgAddressSearch* dlgAddd)
{
	int			intIndex;

	// 売却(買入)先の所在地1(住所)
	intIndex = CmnGetControlIndex( m_uInfo.intCurRow, ID_COL_041I_ADADD1 );
	CmnDiagSetString( m_pDiag, intIndex, dlgAddd->m_AdAdd1, 0 );

	// 売却(買入)先の所在地2(住所)
	intIndex = CmnGetControlIndex( m_uInfo.intCurRow, ID_COL_041I_ADADD2 );
...
//		RET		なし
//********************************************************************************
void	CfrmUc041KaribaraiI::virFncReferenceUpdateTbl( int intRefType, int nRefMode/*=0*/ )
{
	switch (intRefType) {
		// 科目
		case ID_DLGTYPE_KAMOKU:
...
void	CfrmUc041KaribaraiI::OnSize( UINT nType, int cx, int cy )
{
...
// ウィンドウ消去
BOOL	CfrmUc041KaribaraiI::DestroyWindow()
{
...
//	その他イベント処理
//********************************************************************************
BOOL	CfrmUc041KaribaraiI::PreTranslateMessage( MSG* pMsg )
{
...
// 修正No.168362 add <--
						...
						if(intCol == ID_COL_041I_ADSEQ || intCol == ID_COL_041I_INVONOT)	{
							rv=1;
						}
// 修正No.168362 add -->
					} 
// 修正No.168362 add <--
			...
			case VK_RIGHT:
				if(nG_MScroll == 1)	{
					...
					intCol = CmnGetControlCol();
					if(intCol == ID_COL_041I_ADSEQ && (pMsg->wParam == VK_LEFT || pMsg->wParam == VK_RIGHT))	{
...
// 頁コントロールのフォーカス設定
void	CfrmUc041KaribaraiI::FocusPagediag1()
{
}

// 頁コントロールのゲットフォーカス
void	CfrmUc041KaribaraiI::EditONPagediag1( short index )
{
// 修正No.168443 add -->
	// ---- 登録番号一覧関連 ----->
	if(pZmSel && pZmSel->IsDisplay() != FALSE) {
...
// 頁コントロールのロストフォーカス
void	CfrmUc041KaribaraiI::EditOFFPagediag1( short index )
{
...
// 頁コントロールのキー操作
void	CfrmUc041KaribaraiI::TerminationPagediag1( short index, short nChar, short length, LPUNKNOWN data )
{
	int nMaxDataCol = 0;
	// カレント頁の合計行の種別を取得
	...
	switch ( nChar ) {
		...
		case VK_TAB:
			...
			if ( CmnCheckShiftKey() == FALSE ) {
				...
				CmnDiagSetFocus(m_pDiag, nMaxDataCol, ID_COL_041I_NAIYOU);
			}
			break;
		case VK_DOWN:
			// タイトルコントロールへ移動
...
// タイトルコントロールのフォーカス設定
void	CfrmUc041KaribaraiI::FocusTitlediag1()
{
}

// タイトルコントロールのゲットフォーカス
void	CfrmUc041KaribaraiI::EditONTitlediag1( short index )
{
// 修正No.168443 add -->
	// ---- 登録番号一覧関連 ----->
	if(pZmSel && pZmSel->IsDisplay() != FALSE) {
...
// タイトルコントロールのロストフォーカス
void	CfrmUc041KaribaraiI::EditOFFTitlediag1 (short index )
{
	m_Titlefocus = 0;
	virUpdateTitle();
}
...
//	タイトル更新
void CfrmUc041KaribaraiI::virUpdateTitle()
{
...
// タイトルコントロールのキーイベント
void	CfrmUc041KaribaraiI::TerminationTitlediag1( short index, short nChar, short length, LPUNKNOWN data )
{
	// フォーカス移動
	switch ( nChar ) {
		case VK_RETURN:
...
void	CfrmUc041KaribaraiI::EditONYoushikidiag1( short index )
{
	DIAGRAM_DATA	diadata;
	...
	switch (m_uInfo.intCurCol) {
		...
		case ID_COL_041I_INVONOT:	// 登録番号(T選択)
			// コンボボックスのオフセット値取得
			m_pDiag->GetData(m_uInfo.intCurCtlIndex, (LPUNKNOWN)&diadata);
			m_uInfo.OldCombo = diadata.data_combo;
			break;
	...
	if ( ( m_uInfo.OldRow > 0 ) ) {
		if ( m_uInfo.OldPage == m_uInfo.intCurPage && m_uInfo.OldPage > 0 ) {
			...
			BOOL adadd1_to_adadd2 = IsSaveMoveReference(ID_COL_041I_ADADD1, ID_COL_041I_ADADD2);
			// [Home]キー押下の住所検索ダイアログの戻り（フォーカスをセットしている）は保存しない（改良依頼No15-1613）
			BOOL adadd1_to_adadd1 = IsSaveMoveReference(ID_COL_041I_ADADD1, ID_COL_041I_ADADD1);	// 所在地1(住所)→所在地1(住所)
			BOOL adadd2_to_adadd2 = IsSaveMoveReference(ID_COL_041I_ADADD2, ID_COL_041I_ADADD2);	// 所在地2(住所)→所在地2(住所)　所在地2から住所が長すぎる場合、ここがFALSEになる
			// T選択⇔登録番号は保存しない
			BOOL tsel_to_invno = IsSaveMoveReference(ID_COL_041I_INVONOT, ID_COL_041I_INVONO);
	...
	if(m_uInfo.intCurCol == ID_COL_041I_INVONO && m_EndSyorityu == 0)	{
// 修正No.168377 del -->
...
// 修正No.168377 add -->
		// 登録番号のT選択の値を取得
		int pos = CmnGetControlIndex(m_uInfo.intCurRow, ID_COL_041I_INVONOT);
...
// データコントロールのロストフォーカス
void	CfrmUc041KaribaraiI::EditOFFYoushikidiag1( short index )
{
	if( m_EndView != FALSE )	return;

// 修正No.168443 add -->
	// ---- 登録番号一覧関連 ----->
	if(m_uInfo.intCurCol != ID_COL_041I_INVONO) {
		if(pZmSel && pZmSel->IsDisplay() != FALSE) {
			pZmSel->DialogOFF();
		}
	}
...
// 修正No.168443 add <--
	...
	if(m_uInfo.intCurCol == ID_COL_041I_ADSEQ)	{
		if(m_ComboSgn != 1)	{
			ComboNew(index);
		}
	}
...
// 修正No.168443 del -->
	//// ---- 登録番号一覧関連 ----->
	//if(pZmSel && m_uInfo.intCurCol != ID_COL_041I_INVONO) {
	...
	//		//// カーソル移動処理
	//		//CmnDiagSetFocus( m_pDiag, m_uInfo.intCurRow, ID_COL_041I_INVONO );
	//	}
	//}
// 修正No.168443 del <--
// 修正No.168443 add -->
...
//	入力確定
void CfrmUc041KaribaraiI::virInputDecisionEditOFF()
{
		// フォーカスフラグOFF
...
// 改良No.21-0086,21-0529 cor <--
		if (m_uInfo.intCurCol == ID_COL_041I_ADSEQ) {
			//	前回の値に戻す
			CmnDiagSetCombo(m_pDiag, CmnGetControlIndex(m_uInfo.intCurRow, ID_COL_041I_ADSEQ), m_uInfo.OldCombo);
		}
	}
...
void CfrmUc041KaribaraiI::virActivateFrameK(UINT nState, CFrameWnd* pDeactivateFrame)
{
	int		index = 0;
	CWnd*	pWnd = this->GetFocus();
...
void CfrmUc041KaribaraiI::virKamokuAddCancel()
{
	...
	CmnGetControlPosition(&m_uInfo.intCurRow,&m_uInfo.intCurCol,&m_uInfo.OldCol);
	// 科目列なら
	if(m_uInfo.intCurCol == ID_COL_041I_ADSEQ && m_F9OnSw != TRUE)	{
		DIAGRAM_DATA	diadata;
		m_pDiag->GetData(m_uInfo.intCurCtlIndex,(LPUNKNOWN)&diadata);
		// 【新規作成】が選択されていれば
		if(diadata.data_combo > m_CmbCnt)	{
...
// 預貯金データコントロールのキーイベント
void	CfrmUc041KaribaraiI::TerminationYoushikidiag1( short index, short nChar, short length, LPUNKNOWN data )
{
	//--------------------------------------------------------------------------------
	//	キー操作仕様
...
void CfrmUc041KaribaraiI::VScrollYoushikidiag1(short mode)
{
// 修正No.168430 del -->
...
//********************************************************************************
int	CfrmUc041KaribaraiI::GetFocusPosition( int nChar )
{
	int		intRow;					// カレント行番号
	int		intCol;					// カレント列番号
	...
	else if ( intCol == ID_COL_041I_ADADD1 ){
		// カレント列が「住所１」の場合
	...
	else if ( intCol == ID_COL_041I_ADADD2 ){
		// カレント列が「住所２」の場合
	...
	else if ( intCol == ID_COL_041I_NAIYOU ){
		// カレント列が「取引の内容」の場合
		intVector[0] = m_uInfo.intCurCtlIndex - m_uInfo.intColMax;		// ↑
	...
	switch (nChar) {
		...
		case VK_RETURN:	// Enterキーでカーソルを下に移動するモード対応
			if(m_ReturnMoveDown) {
				if(intCol == ID_COL_041I_INVONOT)	intNext = intVector[1];			//	カレント列が「登録番号(T表示)」欄の場合「→」キーと同じ
		...
		case VK_TAB:
			if (CmnCheckShiftKey() == FALSE) {
				...
				// それ以外は「←」キーと同じ
				if ((intRow <= 1) && (intCol == ID_COL_041I_ADSEQ)) {
					return -1;
				}
...
//********************************************************************************
int	CfrmUc041KaribaraiI::GetTotalRowIndex( int nCharOrg ,int intIndex ,int intNext )
{
	...
	if ( nNowRow <= nBorder[0] ){
		...
		if (( intNext > CmnGetControlIndex( m_uInfo.intRowMax, ID_COL_041I_NAIYOU ) ) && ( nCharOrg == VK_TAB )){
			return( -2 );
		}
		//	データ行を超えた？かつ計行あり？
	...
	//	現在、頁計に居る
		...
		switch ( nCharTemp ){
			case VK_UP:			// ↑：23行目のデータ行の支店名項目へ移動
				nRet = CmnGetControlIndex( nBorder[0], ID_COL_041I_ADNAME1 );
				break;
			case VK_LEFT:		// ←/Shift+Tab：23行目のデータ行の摘要項目へ移動
				nRet = CmnGetControlIndex( nBorder[0], ID_COL_041I_NAIYOU );
				break;
			default:			// →/↓/Return/Tab：25行目の合計行②へ移動
				...
				//	累計なし
					...
					nRet = CmnGetControlIndex( ( nBorder[2] + 2 ), ID_COL_041I_ADSEQ );
				}
				break;
		}
	}
	//	現在、累計に居る場合
		...
		switch ( nCharTemp ){
			...
			case VK_LEFT:		// ←/Shift+Tab：24行目の合計行① or 24行目のデータ行の摘要項目へ移動
				nRet = CmnGetControlIndex( ( nBorder[1] + 2 ), ID_COL_041I_ADSEQ );
				break;
			default:			// →/↓：移動できない
				// 例外処理：最終項目で"Tab"は別コントロールへ移動
				// それ以外は「→」キーと同じ
...
//		RET		なし
//********************************************************************************
void	CfrmUc041KaribaraiI::virTblEditIkkatuLine( int nType, CdbUc000Common* rsData,
...
//********************************************************************************
int	CfrmUc041KaribaraiI::virTblSortSubSortProc( CdlgSort* pCdlgSort, CdbUc000Common* rsData )
{
	CdbUc041Karibarai*	rs;
	CString				strFilter;
	CString				strSort;
...
/**********************************************************************
	...
	戻値
		int		成功/失敗
				FUNCTION_OK
***********************************************************************/
int	CfrmUc041KaribaraiI::RecBufSetData( CdbUc041Karibarai* prmDbRec )
{
...
/**********************************************************************
	...
	戻値
		int		成功/失敗
				FUNCTION_OK
***********************************************************************/
int	CfrmUc041KaribaraiI::RecBufClearAllData()
{
...
/**********************************************************************
	...
	戻値
		int		成功/失敗
				FUNCTION_OK
***********************************************************************/
int	CfrmUc041KaribaraiI::RecBufClearData( P_REC_UC_041_KARIBARAI inRecData )
{
	inRecData->m_Seq = 0;
...
/**********************************************************************
	...
	戻値
		int				成功(更新あり)/成功(更新なし)/失敗
						...
						FUNCTION_NG		: 失敗
***********************************************************************/
int	CfrmUc041KaribaraiI::virRecBufSaveData( int inPage, int inRow )
{
	...
	// 科目
	intIndex = CmnGetControlIndex( inRow, ID_COL_041I_ADSEQ );
	...
	// 登録番号（T選択）
	intIndex = CmnGetControlIndex(inRow, ID_COL_041I_INVONOT);
	m_pDiag->GetData(intIndex, (LPUNKNOWN)&diadata);
	tsel = diadata.data_combo;

	// 登録番号（法人番号）
	intIndex = CmnGetControlIndex(inRow, ID_COL_041I_INVONO);
...
// 修正No.168534,168539 add <--
	...
	intIndex = CmnGetControlIndex( inRow, ID_COL_041I_ADNAME1 );
	...
	if ( tmpSaveData.m_AdName2.IsEmpty() ){
		if(m_uInfo.intCurCol == ID_COL_041I_ADNAME1 && m_uInfo.intCurRow != m_uInfo.OldRow){	// 各カラムごとにvirRecBufSaveData()がコールされるようになり、かつタイミングがEditOffからEditOnに移ったことによりCmnDiagSetString()でカレットが末尾から先頭に移ってしまう為、制御
			CmnDiagSetString( m_pDiag, intIndex, tmpSaveData.m_AdName1, 0 );
		}
	}

	// 所在地1(住所)
	intIndex = CmnGetControlIndex( inRow, ID_COL_041I_ADADD1 );
	tmpSaveData.m_AdAdd1 = m_clsFunc.DiagGetString( m_pDiag, intIndex );

	// 所在地2(住所)
	intIndex = CmnGetControlIndex( inRow, ID_COL_041I_ADADD2 );
	tmpSaveData.m_AdAdd2 = m_clsFunc.DiagGetString( m_pDiag, intIndex );

	// 法人・代表者との関係
	intIndex = CmnGetControlIndex( inRow, ID_COL_041I_KANKEI );
	tmpSaveData.m_Kankei = m_clsFunc.DiagGetString( m_pDiag, intIndex );

	// 期末現在高
	intIndex = CmnGetControlIndex( inRow, ID_COL_041I_VAL );
	tmpSaveData.m_Val = CmnDiagGetKingaku( m_pDiag, intIndex );

	// 取引の内容
	intIndex = CmnGetControlIndex( inRow, ID_COL_041I_NAIYOU );
...
***********************************************************************/
int	CfrmUc041KaribaraiI::virRecBufSaveDataForPasteInsert( int inPage, int inRow )
{
...
***********************************************************************/
int	CfrmUc041KaribaraiI::virRecBufSaveDataForPaste( int inPage, int inRow )
{
	///////////////////////////////////////////////////////////////
	// 登録処理呼び出し
	return RecBufSaveDataSub( inPage, inRow, &m_CopyData );
...
/**********************************************************************
	...
	戻値
			int				成功(更新あり)/成功(更新なし)/失敗
							...
							FUNCTION_NG	: 失敗
***********************************************************************/
int	CfrmUc041KaribaraiI::RecBufSaveDataSub( 
						int		inPage,
						int		inRow,
...
//********************************************************************************
CdbUc000Common*	CfrmUc041KaribaraiI::virGetDataTableObject()
{
	// 「仮払金」テーブルのオブジェクトを生成し、ポインタを返す
...
//	RET	なし
//********************************************************************************
void	CfrmUc041KaribaraiI::virRowButtonCopyProc()
{
...
//	RET	なし
//********************************************************************************
void	CfrmUc041KaribaraiI::virTblGetKamokuInfo( CdbUc000Common* rsData, SORTKAMOKU_INFO* uKamoku )
{
...
//	RET	なし
//********************************************************************************
void	CfrmUc041KaribaraiI::virGetCurrentInfo( CURRENT_INFO* uCurInfo )
{
...
//********************************************************************************
int	CfrmUc041KaribaraiI::virUpdateRelationTblChengeFormType()
{
	int		intRet=0;

	//CfrmUc042KasitukeK	pfrm042;
	CfrmUc042KasitukeI	pfrm042;
...
//		RET		BOOL		TRUE:正常終了，FALSE:エラー
//********************************************************************************
BOOL CfrmUc041KaribaraiI::virUpdateRelationTblChengeFormTypeSave()
{
...
//		RET		なし
//********************************************************************************
int	CfrmUc041KaribaraiI::UpdateTbl041ChangeFormType(UCHIWAKE_INFO pInfoSv)
{
	// データ無しならデータ更新しない
...
//	【戻値】	なし
//**************************************************
void CfrmUc041KaribaraiI::SetInputMode( int nRow, long nMode )
{
	m_pDiag->ModifyItem( CmnGetControlIndex( nRow, ID_COL_041I_ADSEQ ), nMode );	//	科目（※科目がエディットボックスに変更された際に必要）
	m_pDiag->ModifyItem( CmnGetControlIndex( nRow, ID_COL_041I_INVONOT), nMode );	//	登録番号(T選択)
	m_pDiag->ModifyItem( CmnGetControlIndex( nRow, ID_COL_041I_INVONO), nMode );	//	登録番号
	m_pDiag->ModifyItem( CmnGetControlIndex( nRow, ID_COL_041I_ADNAME1 ), nMode );	//	名称（上段）
	m_pDiag->ModifyItem( CmnGetControlIndex( nRow, ID_COL_041I_ADADD1 ), nMode );	//	所在地（上段）
	m_pDiag->ModifyItem( CmnGetControlIndex( nRow, ID_COL_041I_ADADD2 ), nMode );	//	所在地（下段）
	m_pDiag->ModifyItem( CmnGetControlIndex( nRow, ID_COL_041I_KANKEI ), nMode );	//	法人・代表者との関係
	m_pDiag->ModifyItem( CmnGetControlIndex( nRow, ID_COL_041I_VAL ), nMode );		//	期末現在高
	m_pDiag->ModifyItem( CmnGetControlIndex( nRow, ID_COL_041I_NAIYOU ), nMode );	//	取引の内容
}
...
//	【戻値】	なし
//**************************************************
void CfrmUc041KaribaraiI::SetDiagBackColor()
{
...
//		RET		なし					
//********************************************************************************
void CfrmUc041KaribaraiI::virRendoCreateData(CdbUc000Common* rsData, RENTEMP_INFO* uRenInfo)
{
	CString			strTemp;
...
//		RET		なし					
//********************************************************************************
void CfrmUc041KaribaraiI::virRendoUpdateData(CdbUc000Common* rsData, RENTEMP_INFO* uRenInfo)
{
	CdbUc041Karibarai*	rs = (CdbUc041Karibarai*)rsData;
...
//***************************************************************************
BOOL CfrmUc041KaribaraiI::virEndProc(void)
{
	TRACE(_T("***** CfrmUc041KaribaraiI::virEndProc\n"));
...
void CfrmUc041KaribaraiI::ComboNew(short index)
{
	short			sv_sel=0;
...
int CfrmUc041KaribaraiI::CursorControl(short nChar, int sw)
{
	int				rv=0;
	int				intCol=0;
	int				pos=0;
	...
	if((nChar == VK_TAB && (key & 0x80) == 0x80) || (nChar == VK_LEFT) || (nChar == VK_RIGHT)) {
		...
		if(intCol == ID_COL_041I_INVONOT)	{	// 登録番号(T選択)
			m_pDiag->ComboDropDown(m_uInfo.intCurCtlIndex, FALSE);
			CmnDiagSetCombo(m_pDiag, m_uInfo.intCurCtlIndex, m_uInfo.OldCombo);
		}
	}
...
void CfrmUc041KaribaraiI::ComboSelYoushikidiag1(short index, LPUNKNOWN data)
{
...
// ------------------------------------------------------------------------------------------------------------------------
void CfrmUc041KaribaraiI::TitleColorChg(void)
{
...
LRESULT CfrmUc041KaribaraiI::OnUserReDrawView(WPARAM wParam, LPARAM lParam)
{
	virUpdateControlTblData();
	CmnDiagSetFocus(m_pDiag, 1, 1);
...
//		RET		なし
// --------------------------------------------------------------------------------------------------------
void CfrmUc041KaribaraiI::virDiagGetHjnData(CDatabase* pDB, HJN_REC_NEW* phjnRec)
{
	int				nPage,nRow;
	int				intIndex;	// 対象行の各インデックス
	int				tsel=0;
	...
	// 登録番号（法人番号）
	cst.Empty();
	intIndex = CmnGetControlIndex(nRow, ID_COL_041I_INVONO);
	...
	// 名称1(氏名)
	intIndex = CmnGetControlIndex(nRow, ID_COL_041I_ADNAME1);
	m_clsFunc.StrDivision(m_clsFunc.DiagGetString(m_pDiag, intIndex), &strArray, 2, FALSE, TRUE);
	cst.Empty();
	...
	// 所在地1(住所)
	intIndex = CmnGetControlIndex(nRow, ID_COL_041I_ADADD1);
	cst = m_clsFunc.DiagGetString(m_pDiag, intIndex);
	cst.TrimRight();
	if(cst.IsEmpty() == FALSE)	{
		memset(buf, 0, sizeof(buf));
	...
	// 所在地2(住所)
	intIndex = CmnGetControlIndex(nRow, ID_COL_041I_ADADD2);
	cst = m_clsFunc.DiagGetString(m_pDiag, intIndex);
	cst.TrimRight();
	if(cst.IsEmpty() == FALSE) {
		memset(buf, 0, sizeof(buf));
...
//		RET		なし
// --------------------------------------------------------------------------------------------------------
void	CfrmUc041KaribaraiI::virDiagSetHjnData(int pSw, CString rtInvNo, CString rtName, CString rtAdrs1, CString rtAdrs2, CString rtKana)
{
	int					ret = 0;
	int					intIndex;
...
// 修正No.168361,168369,168371,168378 del <--
		// 登録番号（T選択）
		intIndex = CmnGetControlIndex(m_uInfo.intCurRow, ID_COL_041I_INVONOT);
		CmnDiagSetCombo3(m_pDiag, intIndex, strInvoNo);

		// 登録番号
		InvoNoSplit(strInvoNo, &cs1, &cs2);
		intIndex = CmnGetControlIndex(m_uInfo.intCurRow, ID_COL_041I_INVONO);
...
// --------------------------------------------------------------------------------------------------------
// --------------------------------------------------------------------------------------------------------
int CfrmUc041KaribaraiI::virCallChkInvoiceNum(int pSw, int inPage, int inRow)
{
...
//				CString		pInvno	登録番号
// --------------------------------------------------------------------------------------------------------
int CfrmUc041KaribaraiI::ChkInvoiceNum(CDatabase* pDB, int pSw, int inPage, int inRow, 
...
// 修正No.168361,168369,168371,168378 del -->
	...
	//		DIAGRAM_DATA	ddata;
	//		ddata.data_combo = 0;
	//		m_pDiag->SetData(CmnGetControlIndex(inRow, ID_COL_041I_INVONOT), (LPUNKNOWN)&ddata);
	//		ddata.data_edit.Empty();
	//		m_pDiag->DataClear(CmnGetControlIndex(inRow, ID_COL_041I_INVONO), TRUE);
	//		// エラーメッセージを表示
...
// 修正No.168443 add <--
			...
			if(pZmSel && pZmSel->IsDisplay() != FALSE && cst.GetLength() < 3) {
				...
				if(tmpzd.errflg != -1) {
					...
					m_pDiag->SetData(CmnGetControlIndex(inRow, ID_COL_041I_INVONO), (LPUNKNOWN)&ddata);
					// 再描画
					m_pDiag->Refresh();
...
// 修正No.168425,168443 add -->
					if(pSw == 3 || m_EndSyorityu == 1)	{
						...
						m_uInfo.intCurCol = ID_COL_041I_INVONO;
