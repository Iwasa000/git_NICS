...
IMPLEMENT_DYNCREATE( CfrmUc042KasitukeI, CfrmUc000Common )


BEGIN_MESSAGE_MAP( CfrmUc042KasitukeI, CfrmUc000Common )
	ON_WM_SIZE()
	...
	ON_COMMAND( ID_PRINTSETUP_MENU, &CfrmUc042KasitukeI::OnMenuPrintSetup )
	ON_COMMAND( ID_PRINTALL_MENU, &CfrmUc042KasitukeI::OnMenuPrintAll )
	ON_COMMAND( ID_OUTPUTFORM_MENU, &CfrmUc042KasitukeI::OnMenuFormTypeSetup )
	ON_COMMAND( ID_SPECIALROW_MENU, &CfrmUc042KasitukeI::OnMenuSpecialRow )
	ON_COMMAND( ID_SORT_MENU, &CfrmUc042KasitukeI::OnMenuSort )
	ON_COMMAND(ID_IKKATUADD_MENU, &CfrmUc042KasitukeI::OnIkkatuAddMenu)
	ON_COMMAND( ID_DISPDIALOG_MENU, &CfrmUc042KasitukeI::OnMenuIkkatuKingaku )
	ON_COMMAND( ID_ZEROMONEY_MENU, &CfrmUc042KasitukeI::OnMenuZeroMoney )
	ON_COMMAND( ID_ZEROMONEYMOVE_MENU, &CfrmUc042KasitukeI::OnMenuZeroMoneyMove )
	ON_COMMAND( ID_AMOUTDIALOG_MENU, &CfrmUc042KasitukeI::OnMenuOutKeiSetup )
	ON_COMMAND( ID_CLEAR_MENU, &CfrmUc042KasitukeI::OnMenuClear )
	ON_COMMAND( ID_RENDO_MENU, &CfrmUc042KasitukeI::OnMenuZaimuRendo )
	ON_COMMAND( ID_TITLEMENU, &CfrmUc042KasitukeI::OnMenuTitleRestore )
	ON_COMMAND( ID_USER_SETTING_MENU, &CfrmUc042KasitukeI::OnMenuOptionSetting )
	ON_COMMAND( ID_COPY_SETTING_INFO_MENU, &CfrmUc042KasitukeI::OnMenuCopySettingInfo )
	ON_COMMAND( ID_DELETE_DATA_MENU, &CfrmUc042KasitukeI::OnMenuDeleteDataEachYoushiki )
	ON_BN_CLICKED( IDC_PAGEBACK_BUTTON1, &CfrmUc042KasitukeI::OnPageBack )
	ON_BN_CLICKED( IDC_PAGENEXT_BUTTON1, &CfrmUc042KasitukeI::OnPageNext )
	ON_BN_CLICKED( IDC_PAGENEW_BUTTON1, &CfrmUc042KasitukeI::OnPageNew )
	ON_BN_CLICKED( IDC_PAGEINSERT_BUTTON1, &CfrmUc042KasitukeI::OnPageInsert )
	ON_BN_CLICKED( IDC_ROWCOPY_BUTTON1, &CfrmUc042KasitukeI::OnRowCopy )
	ON_BN_CLICKED( IDC_ROWPASTE_BUTTON1, &CfrmUc042KasitukeI::OnRowPaste )
	ON_BN_CLICKED( IDC_ROWINSERT_BUTTON1, &CfrmUc042KasitukeI::OnRowInsert )
	ON_BN_CLICKED( IDC_YOUSHIKINEXT_BUTTON1, &CfrmUc042KasitukeI::OnMoveYoushikiNext )
	ON_BN_CLICKED( IDC_YOUSHIKIBACK_BUTTON1, &CfrmUc042KasitukeI::OnMoveYoushikiBack )
	ON_UPDATE_COMMAND_UI( ID_BUTTON_F6, &CfrmUc042KasitukeI::OnUpdateButtonF6 )
	ON_UPDATE_COMMAND_UI( ID_BUTTON_F7, &CfrmUc042KasitukeI::OnUpdateButtonF7 )
	ON_UPDATE_COMMAND_UI( ID_BUTTON_F8, &CfrmUc042KasitukeI::OnUpdateButtonF8 )
	ON_UPDATE_COMMAND_UI( ID_BUTTON_F9, &CfrmUc042KasitukeI::OnUpdateButtonF9 )
	ON_UPDATE_COMMAND_UI( ID_BUTTON_F11, &CfrmUc042KasitukeI::OnUpdateButtonF11 )
	ON_UPDATE_COMMAND_UI( ID_BUTTON_F12, &CfrmUc042KasitukeI::OnUpdateButtonF12 )
	ON_UPDATE_COMMAND_UI( ID_BUTTON_HOME, &CfrmUc042KasitukeI::OnUpdateButtonHome )
	ON_UPDATE_COMMAND_UI( ID_IKKATUADD_MENU, &CfrmUc042KasitukeI::OnUpdateIkkatuaddMenu)
	ON_UPDATE_COMMAND_UI( ID_DISPDIALOG_MENU, &CfrmUc042KasitukeI::OnUpdateMenuIkkatuKingaku )
	ON_UPDATE_COMMAND_UI( ID_SORT_MENU, &CfrmUc042KasitukeI::OnUpdateMenuSort )
	ON_UPDATE_COMMAND_UI( ID_CLEAR_MENU, &CfrmUc042KasitukeI::OnUpdateMenuClear )
	ON_UPDATE_COMMAND_UI( ID_ZEROMONEY_MENU, &CfrmUc042KasitukeI::OnUpdateMenuZeroMoney )
	ON_UPDATE_COMMAND_UI( ID_ZEROMONEYMOVE_MENU, &CfrmUc042KasitukeI::OnUpdateMenuZeroMoneyMove)
	ON_UPDATE_COMMAND_UI( ID_RENDO_MENU, &CfrmUc042KasitukeI::OnUpdateMenuZaimuRendo )
	ON_UPDATE_COMMAND_UI(ID_SPECIALROW_MENU, &CfrmUc042KasitukeI::OnUpdateMenuSpecialRow)
	ON_UPDATE_COMMAND_UI( ID_TITLEMENU, &CfrmUc042KasitukeI::OnUpdateMenuTitleRestore )
	ON_UPDATE_COMMAND_UI( ID_DELETE_DATA_MENU, &CfrmUc042KasitukeI::OnUpdateMenuDeleteDataEachYoushiki )
	ON_MESSAGE(WM_USER_REDRAWVIEW, OnUserReDrawView)
END_MESSAGE_MAP()


CfrmUc042KasitukeI::CfrmUc042KasitukeI()
	: CfrmUc000Common( CfrmUc042KasitukeI::IDD )
{
...
CfrmUc042KasitukeI::~CfrmUc042KasitukeI()
{
	...
	TRACE(_T("***** CfrmUc042KasitukeI::~CfrmUc042KasitukeI\n"));

	//m_pDiag = NULL;
	//m_pTitleDiag = NULL;
}

void CfrmUc042KasitukeI::DoDataExchange( CDataExchange* pDX )
{
...
void CfrmUc042KasitukeI::OnInitialUpdate()
{
...
#ifdef _DEBUG
void CfrmUc042KasitukeI::AssertValid() const
{
	CfrmUc000Common::AssertValid();
}

#ifndef _WIN32_WCE
void CfrmUc042KasitukeI::Dump( CDumpContext& dc ) const
{
...
BEGIN_EVENTSINK_MAP( CfrmUc042KasitukeI, CfrmUc000Common )
	ON_EVENT( CfrmUc042KasitukeI, IDC_YOUSHIKIDIAG1, 3, CfrmUc042KasitukeI::TerminationYoushikidiag1, VTS_I2 VTS_I2 VTS_I2 VTS_UNKNOWN )
	ON_EVENT( CfrmUc042KasitukeI, IDC_YOUSHIKIDIAG1, 2, CfrmUc042KasitukeI::EditOFFYoushikidiag1, VTS_I2 )
	ON_EVENT( CfrmUc042KasitukeI, IDC_YOUSHIKIDIAG1, 1, CfrmUc042KasitukeI::EditONYoushikidiag1, VTS_I2 )
	ON_EVENT(CfrmUc042KasitukeI, IDC_YOUSHIKIDIAG1, 12, CfrmUc042KasitukeI::VScrollYoushikidiag1, VTS_I2)

	ON_EVENT( CfrmUc042KasitukeI, IDC_YOUSHIKIDIAG2, 3, CfrmUc042KasitukeI::TerminationYoushikidiag1, VTS_I2 VTS_I2 VTS_I2 VTS_UNKNOWN )
	ON_EVENT( CfrmUc042KasitukeI, IDC_YOUSHIKIDIAG2, 2, CfrmUc042KasitukeI::EditOFFYoushikidiag1, VTS_I2 )
	ON_EVENT( CfrmUc042KasitukeI, IDC_YOUSHIKIDIAG2, 1, CfrmUc042KasitukeI::EditONYoushikidiag1, VTS_I2 )
	ON_EVENT(CfrmUc042KasitukeI, IDC_YOUSHIKIDIAG2, 12, CfrmUc042KasitukeI::VScrollYoushikidiag1, VTS_I2)

	ON_EVENT( CfrmUc042KasitukeI, IDC_YOUSHIKIDIAG3, 3, CfrmUc042KasitukeI::TerminationYoushikidiag1, VTS_I2 VTS_I2 VTS_I2 VTS_UNKNOWN )
	ON_EVENT( CfrmUc042KasitukeI, IDC_YOUSHIKIDIAG3, 2, CfrmUc042KasitukeI::EditOFFYoushikidiag1, VTS_I2 )
	ON_EVENT( CfrmUc042KasitukeI, IDC_YOUSHIKIDIAG3, 1, CfrmUc042KasitukeI::EditONYoushikidiag1, VTS_I2 )
	ON_EVENT(CfrmUc042KasitukeI, IDC_YOUSHIKIDIAG3, 12, CfrmUc042KasitukeI::VScrollYoushikidiag1, VTS_I2)

	ON_EVENT( CfrmUc042KasitukeI, IDC_YOUSHIKIDIAG5, 3, CfrmUc042KasitukeI::TerminationYoushikidiag1, VTS_I2 VTS_I2 VTS_I2 VTS_UNKNOWN )
	ON_EVENT( CfrmUc042KasitukeI, IDC_YOUSHIKIDIAG5, 2, CfrmUc042KasitukeI::EditOFFYoushikidiag1, VTS_I2 )
	ON_EVENT( CfrmUc042KasitukeI, IDC_YOUSHIKIDIAG5, 1, CfrmUc042KasitukeI::EditONYoushikidiag1, VTS_I2 )
	ON_EVENT(CfrmUc042KasitukeI, IDC_YOUSHIKIDIAG5, 12, CfrmUc042KasitukeI::VScrollYoushikidiag1, VTS_I2)

	ON_EVENT( CfrmUc042KasitukeI, IDC_TITLEDIAG1, 3, CfrmUc042KasitukeI::TerminationTitlediag1, VTS_I2 VTS_I2 VTS_I2 VTS_UNKNOWN )
	ON_EVENT( CfrmUc042KasitukeI, IDC_TITLEDIAG1, 2, CfrmUc042KasitukeI::EditOFFTitlediag1, VTS_I2 )
	ON_EVENT( CfrmUc042KasitukeI, IDC_TITLEDIAG1, 1, CfrmUc042KasitukeI::EditONTitlediag1, VTS_I2 )
	ON_EVENT( CfrmUc042KasitukeI, IDC_TITLEDIAG1, 6, CfrmUc042KasitukeI::FocusTitlediag1, VTS_NONE )

	ON_EVENT( CfrmUc042KasitukeI, IDC_PAGEDIAG1, 3, CfrmUc042KasitukeI::TerminationPagediag1, VTS_I2 VTS_I2 VTS_I2 VTS_UNKNOWN )
	ON_EVENT( CfrmUc042KasitukeI, IDC_PAGEDIAG1, 2, CfrmUc042KasitukeI::EditOFFPagediag1, VTS_I2 )
	ON_EVENT( CfrmUc042KasitukeI, IDC_PAGEDIAG1, 1, CfrmUc042KasitukeI::EditONPagediag1, VTS_I2 )
	ON_EVENT( CfrmUc042KasitukeI, IDC_PAGEDIAG1, 6, CfrmUc042KasitukeI::FocusPagediag1, VTS_NONE )
END_EVENTSINK_MAP()

//********************************************************************************
//	初期処理
//********************************************************************************
BOOL	CfrmUc042KasitukeI::virStartJob()
{
	// 初期値設定
...
//	共通データの初期値設定
//********************************************************************************
void	CfrmUc042KasitukeI::virSetInitialUchiwakeInfo()
{
	// 「貸付金」の固有データ
	...
	m_uInfo.intColMax = ID_COLMAX_042I;					// １行内のコントロール個数
	m_uInfo.intColMaxData = ID_COLMAXDATA_042I;			// １行内の列数
	m_uInfo.intCtlStartIndex = ID_CTLSTARTINDEX_042I;	// １行目の入力項目の先頭インデックス番号
	m_uInfo.intT1StartIndex = ID_T1STARTNORMAL_042I;	// 合計行①の先頭インデックス番号
	m_uInfo.intT2StartIndex = ID_T2STARTNORMAL_042I;	// 合計行②の入力項目の先頭インデックス番号
	m_uInfo.intCursolDefPos = ID_COL_042I_INVONOT;		// カーソル移動時の初期位置（タイトルから↓，合計から↑で使用）
	m_uInfo.intCursolKeiPos = ID_COL_042I_ADNAME1;		// 合計行のカーソル移動位置（カーソル移動で使用）
	...
	m_uInfo.intT1StartNormal = ID_T1STARTNORMAL_042I;	// 通常時：合計行①の先頭インデックス
	m_uInfo.intT2StartNormal = ID_T2STARTNORMAL_042I;	// 通常時：合計行②の先頭インデックス
	m_uInfo.intT1StartKobetu = ID_T1STARTKOBETU_042I;	// 個別時：合計行①の先頭インデックス
	m_uInfo.intT2StartKobetu = ID_T2STARTKOBETU_042I;	// 個別時：合計行②の先頭インデックス
	m_uInfo.intRowKei = ID_ROWKEI_042;					// 帳表固定の合計行数（1:合計あり，0:なし）
	m_uInfo.intKei1StartIndex = ID_COL_042I_KEI1_MEISYO;	// 計ダイアグラム1行目の先頭インデックス
	m_uInfo.intKei2StartIndex = ID_COL_042I_KEI2_MEISYO;	// 計ダイアグラム2行目の先頭インデックス
...
// 【戻値】    なし
//**************************************************
void	CfrmUc042KasitukeI::virSetInitialDiag()
{
...
//	帳表固有変数の初期値設定
//********************************************************************************
void	CfrmUc042KasitukeI::virSetInitialValue()
{
	// 1ページ分のローカルバッファをクリア
	RecBufClearAllData();
...
//	帳表コントロールの初期化（データ領域）
//********************************************************************************
BOOL	CfrmUc042KasitukeI::InitialControlDataArea()
{
	int		intMax;
	int		i;
	...
	for ( i = m_uInfo.intCtlStartIndex; i < intMax; i += m_uInfo.intColMax ) {
		// ComboBox：クリア
		CmnDiagSetString(m_pDiag, i + ID_COL_042I_INVONOT - 1, "", 0);	// 登録番号(T選択)

		// 漢字入力欄の初期化
		CmnDiagSetAttrInpmax( m_pDiag, i + ID_COL_042I_ADNAME1 - 1, MAX_KETA_042_ADNAME1 );		// 貸付先1
		CmnDiagSetAttrInpmax( m_pDiag, i + ID_COL_042I_ADADD1  - 1, MAX_KETA_042_ADADD1 );		// 所在地1
		CmnDiagSetAttrInpmax( m_pDiag, i + ID_COL_042I_ADADD2  - 1, MAX_KETA_042_ADADD2 );		// 所在地2
		CmnDiagSetAttrInpmax( m_pDiag, i + ID_COL_042I_KANKEI  - 1, MAX_KETA_042_KANKEI );		// 法人･代表者との関係
		CmnDiagSetAttrInpmax( m_pDiag, i + ID_COL_042I_RIYUU   - 1, MAX_KETA_042_RIYUU );		// 貸付理由
		CmnDiagSetAttrInpmax( m_pDiag, i + ID_COL_042I_NAIYOU  - 1, MAX_KETA_042_NAIYOU );		// 担保の内容

		// 金額欄：桁数初期化
		CmnDiagSetAttrDigit( m_pDiag, i + ID_COL_042I_VAL    - 1, ID_VAL_042_K_DATA );			// 期末現在高
		CmnDiagSetAttrDigit( m_pDiag, i + ID_COL_042I_RISOKU - 1, ID_RISOKU_042_K_DATA );		// 期中の受取利息額

		// 小数点付き数値の設定
		CmnDiagSetAttrDigit( m_pDiag, i + ID_COL_042I_RATE - 1, 2, TRUE, TRUE, 3 );	// 利率
	...
	// 半角/全角設定
	CmnDiagSetAttrColZenHan( m_pDiag , ID_COL_042I_ADNAME1 );		// 貸付先1
	CmnDiagSetAttrColZenHan( m_pDiag , ID_COL_042I_ADADD1 );		// 所在地1（住所）
	CmnDiagSetAttrColZenHan( m_pDiag , ID_COL_042I_ADADD2 );		// 所在地2（住所）
	CmnDiagSetAttrColZenHan( m_pDiag , ID_COL_042I_KANKEI );		// 法人・代表者との関係
	CmnDiagSetAttrColZenHan( m_pDiag , ID_COL_042I_RIYUU );			// 貸付理由
	CmnDiagSetAttrColZenHan( m_pDiag , ID_COL_042I_NAIYOU );		// 担保の内容
...
//********************************************************************************
BOOL	CfrmUc042KasitukeI::InitialControlDataAreaHide( CICSDiag* pDiag )
{
	int		intMax;
	int		i;
	...
	for ( i = m_uInfo.intCtlStartIndex; i < intMax; i += m_uInfo.intColMax ) {
		// 漢字入力欄の初期化
		CmnDiagSetAttrInpmax( pDiag, i + ID_COL_042I_ADNAME1 - 1, MAX_KETA_042_ADNAME1 );		// 貸付先1
		CmnDiagSetAttrInpmax( pDiag, i + ID_COL_042I_ADADD1  - 1, MAX_KETA_042_ADADD1 );		// 所在地1
		CmnDiagSetAttrInpmax( pDiag, i + ID_COL_042I_ADADD2  - 1, MAX_KETA_042_ADADD2 );		// 所在地2
		CmnDiagSetAttrInpmax( pDiag, i + ID_COL_042I_KANKEI  - 1, MAX_KETA_042_KANKEI );		// 法人･代表者との関係
		CmnDiagSetAttrInpmax( pDiag, i + ID_COL_042I_RIYUU   - 1, MAX_KETA_042_RIYUU );			// 貸付理由
		CmnDiagSetAttrInpmax( pDiag, i + ID_COL_042I_NAIYOU  - 1, MAX_KETA_042_NAIYOU );		// 担保の内容

		// 金額欄：桁数初期化
		CmnDiagSetAttrDigit( pDiag, i + ID_COL_042I_VAL      - 1, ID_VAL_042_K_DATA );			// 期末現在高
		CmnDiagSetAttrDigit( pDiag, i + ID_COL_042I_RISOKU   - 1, ID_RISOKU_042_K_DATA );		// 期中の受取利息額

		// 小数点付き数値の設定
		CmnDiagSetAttrDigit( pDiag, i + ID_COL_042I_RATE - 1, 2, TRUE, TRUE, 3 );	// 利率
	}
...
//********************************************************************************
BOOL	CfrmUc042KasitukeI::InitialControlComboBox()
{
	// コンボボックスを初期化する関数です。
	...
	for(i = 1; i <= intMax; i++) {
		...
		intIndex = CmnGetControlIndex(i, ID_COL_042I_INVONOT);
...
//********************************************************************************
void	CfrmUc042KasitukeI::InitialControlTotalArea()
{
	int		nKeiType;			//	計の種別
	int		nDataRow;			//	データ行属性
	...
	m_pDiagKei->ModifyItem(ID_COL_042I_KEI1_VAL, intKeiRow);
	m_pDiagKei->ModifyItem(ID_COL_042I_KEI2_VAL, intKeiRow);
	m_pDiagKei->ModifyItem(ID_COL_042I_KEI1_RISOKU, intKeiRow);
	m_pDiagKei->ModifyItem(ID_COL_042I_KEI2_RISOKU, intKeiRow);

	// 合計行の金額欄は、金額欄 + 1桁
	CmnDiagSetAttrDigit( m_pDiagKei, ID_COL_042I_KEI1_VAL, ID_VAL_042_TOTAL );
	CmnDiagSetAttrDigit( m_pDiagKei, ID_COL_042I_KEI2_VAL, ID_VAL_042_TOTAL );
	CmnDiagSetAttrDigit( m_pDiagKei, ID_COL_042I_KEI1_RISOKU, ID_RISOKU_042_TOTAL );
	CmnDiagSetAttrDigit( m_pDiagKei, ID_COL_042I_KEI2_RISOKU, ID_RISOKU_042_TOTAL );
}
...
//		→表示していない方のDiag(通常 or 個別)の設定に使用する
//********************************************************************************
void	CfrmUc042KasitukeI::InitialControlTotalAreaHide( CICSDiag* pDiag )
{
	int intIndex = 0;
	...
	// 合計行の金額欄は、金額欄 + 1桁
	intIndex = m_intT1StartIndexHide + m_uInfo.intCtlStartIndex + ID_COL_042I_VAL - 1;
	CmnDiagSetAttrDigit( pDiag, intIndex, ID_VAL_042_TOTAL );
	
	intIndex = m_intT2StartIndexHide + m_uInfo.intCtlStartIndex + ID_COL_042I_VAL - 1;
	CmnDiagSetAttrDigit( pDiag, intIndex, ID_VAL_042_TOTAL );

	intIndex = m_intT1StartIndexHide + m_uInfo.intCtlStartIndex + ID_COL_042I_RISOKU - 1;
	CmnDiagSetAttrDigit( pDiag, intIndex, ID_RISOKU_042_TOTAL );
	
	intIndex = m_intT2StartIndexHide + m_uInfo.intCtlStartIndex + ID_COL_042I_RISOKU - 1;
	CmnDiagSetAttrDigit( pDiag, intIndex, ID_RISOKU_042_TOTAL );
}
...
//	RET	なし
//********************************************************************************
void	CfrmUc042KasitukeI::InitialControlSpecialRow( int intRow, int intFgFunc )
{
	int				nIndex;		//	インデックス
	DIAGRAM_DATA	diadata;	// ICSDIAG構造体
	...
	switch ( intFgFunc ) {
		...
		case ID_FGFUNC_IKKATUAUTO:		// 一括集計金額行（自動）
			// 桁数を設定
			CmnDiagSetAttrDigit( m_pDiag, CmnGetControlIndex( intRow , ID_COL_042I_VAL ), ID_VAL_042_TOTAL );
			CmnDiagSetAttrDigit( m_pDiag, CmnGetControlIndex( intRow , ID_COL_042I_RISOKU ), ID_RISOKU_042_TOTAL );
			break;
	}
	...
	switch (intFgFunc) {
		...
		case ID_FGFUNC_IKKATUAUTO:		// 一括集計金額行（自動）
			...
			if(intFgFunc != ID_FGFUNC_IKKATUAUTO) {
				...
				m_pDiag->ModifyItem(CmnGetControlIndex(intRow, ID_COL_042I_INVONOT), DIAG_MDFY_NODROPDOWN);

				// ComboBoxの選択項目クリア
				m_clsFunc.DiagInit(&diadata);
				diadata.text_combo = _T("\r\n");
				m_pDiag->SetData(CmnGetControlIndex(intRow, ID_COL_042I_INVONOT), (LPUNKNOWN)&diadata);
			}
...
//	帳表タイトル情報の表示
//********************************************************************************
void	CfrmUc042KasitukeI::virUpdateControlTitle()
{
//	int		intMax;
...
//	帳表ページ情報の表示
//********************************************************************************
void	CfrmUc042KasitukeI::UpdateControlPage()
{
	BOOL	bBack = TRUE;
	BOOL	bNext = TRUE;
...
//	帳表データの表示（１ページ分）
//********************************************************************************
BOOL	CfrmUc042KasitukeI::virUpdateControlTblData()
{
	// ダイアログ切替
	if( m_pDiag != NULL ){
		virSetInitialDiag();
	...
	while ( !dbRec.IsEOF() ) {		// ファイル終端まで
		...
		// 貸付先 法人・代表者との関係(10文字)
		CmnInitialControlFgStringCell( m_pDiag, dbRec.m_NumRow, ID_COL_042I_KANKEI, dbRec.m_FgFunc, UC_042_KANKEI_LEN, dbRec.m_Kankei );
		// 担保の内容(40文字)
		CmnInitialControlFgStringCell( m_pDiag, dbRec.m_NumRow, ID_COL_042I_NAIYOU, dbRec.m_FgFunc, UC_042_NAIYOU_LEN, dbRec.m_Naiyou );
	...
	CmnDiagSetAttrEditFormat(m_pDiag,ID_COL_042I_ADNAME1,MAX_KETA_042_ADNAME1,2,_T("10,10"));	// 名称(氏名)
	CmnDiagSetAttrEditFormat(m_pDiag,ID_COL_042I_ADADD1,MAX_KETA_042_ADADD1,2,_T("10,10"));		// 所在地(住所)１
	CmnDiagSetAttrEditFormat(m_pDiag,ID_COL_042I_ADADD2,MAX_KETA_042_ADADD2,2,_T("10,10"));		// 所在地(住所)２
	CmnDiagSetAttrEditFormat(m_pDiag,ID_COL_042I_NAIYOU,MAX_KETA_042_NAIYOU,2,_T("15,15"));		// 担保の内容
...
//	保管件数の表示
//********************************************************************************
BOOL CfrmUc042KasitukeI::virUpdateControlTblData2()
{
	int					hcnt=0;
	CString				cs=_T("");
...
//		RET		なし
//********************************************************************************
void	CfrmUc042KasitukeI::UpdateControlRowData( CdbUc042Kasituke* prmDbRec ) {
	DIAGRAM_DATA	diadata;	// ICSDiag構造体
	int				intCell;	// 保存フィールド
	CString			cs1, cs2, cst;
	...
	// 読込み対象セル取得
	intCell = CmnGetControlIndex( prmDbRec->m_NumRow, ID_COL_042I_INVONOT );
...
//		RET		なし
//********************************************************************************
void	CfrmUc042KasitukeI::UpdateControlRowTotal( CdbUc042Kasituke* prmDbRec )
{
	int		intTotalType;
	...
	// 頁計/累計の名称表示
	if ( intRowName > 0 ) {
		CmnDiagSetString( m_pDiagKei, CmnGetKeiDiagIndex( intRowName, ID_COL_042I_KEI1_MEISYO-1 ), prmDbRec->m_KeiStr, 1 );
	}
	// 頁計/累計の金額表示
	if ( intRowVal > 0 ) {
		CmnDiagSetKingaku( m_pDiagKei, CmnGetKeiDiagIndex( intRowVal, ID_COL_042I_KEI1_VAL-1 ), prmDbRec->m_Val );
	}
	if ( intRowRisoku > 0 ) {
		CmnDiagSetKingaku( m_pDiagKei, CmnGetKeiDiagIndex( intRowRisoku, ID_COL_042I_KEI1_RISOKU-1 ), prmDbRec->m_Risoku );
	}
}
...
//		RET		なし
//********************************************************************************
void	CfrmUc042KasitukeI::virFncCellCopyProc( CdbUc000Common* rsData )
{
	CdbUc042Kasituke*	rs;
	int					intCol;	// 現在の列
	int					ind1,ind2;
	...
	switch( intCol ){
		// 登録番号（法人番号）
		case ID_COL_042I_INVONOT:
		// 登録番号
		case ID_COL_042I_INVONO:
			if(intCol == ID_COL_042I_INVONOT) {
...
//********************************************************************************
int	CfrmUc042KasitukeI::virFncReferenceGetType(int intCol, int* intGrSeq, long* lngItemSeq, int* intAdd1, int* intAdd2, int* intAdd1Col, int* intAdd2Col, REFERENCE_INFO* pudReference)
{
	int		intRefType;
	...
	switch ( intCol ) {
		...
		case ID_COL_042I_ADADD2:
			...
			*intAdd1Col = ID_COL_042I_ADADD1;
			*intAdd2Col = ID_COL_042I_ADADD2;
			break;
...
//		RET		なし
//********************************************************************************
void	CfrmUc042KasitukeI::virFncReferenceSetData( CdlgReference* dlgRef, int intRefType, int intCol )
{
	CString				cs=_T("");
	CString				cs1=_T("");
	CString				cs2=_T("");
	...
	switch ( intRefType ) {
		...
		case ID_DLGTYPE_ADDRESS:
			// 選択内容を表示
			//	登録番号（T選択）
			CmnDiagSetCombo3(m_pDiag, CmnGetControlIndex(m_uInfo.intCurRow, ID_COL_042I_INVONOT), dlgRef->m_udAddress.m_InvNo);
			// 登録番号
			InvoNoSplit(dlgRef->m_udAddress.m_InvNo, &cs1, &cs2);
			CmnDiagSetString(m_pDiag, CmnGetControlIndex(m_uInfo.intCurRow, ID_COL_042I_INVONO), cs2, 0);
			// 名称
			CmnDiagSetString(m_pDiag, CmnGetControlIndex(m_uInfo.intCurRow, ID_COL_042I_ADNAME1),
			...
			CmnDiagSetString(m_pDiag, CmnGetControlIndex(m_uInfo.intCurRow, ID_COL_042I_ADADD1), cs, 0);
			// 住所下段
			// 全角１０文字を超えていれば改行マークを挿入する
			...
			CmnDiagSetString(m_pDiag, CmnGetControlIndex(m_uInfo.intCurRow, ID_COL_042I_ADADD2), cs, 0);
			break;
...
//		RET		なし
//********************************************************************************
void	CfrmUc042KasitukeI::virFncReferenceSetICSData(CdlgAddressSearch* dlgAddd)
{
	int			intIndex;
	CString		cs=_T("");
	CString		cs1=_T("");
	...
	// 売却(買入)先の所在地1(住所)
	intIndex = CmnGetControlIndex( m_uInfo.intCurRow, ID_COL_042I_ADADD1 );
	cs = dlgAddd->m_AdAdd1;
	if(cs.GetLength() > 20)	{
	...
	// 売却(買入)先の所在地2(住所)
	intIndex = CmnGetControlIndex( m_uInfo.intCurRow, ID_COL_042I_ADADD2 );
	cs = dlgAddd->m_AdAdd2;
	if(cs.GetLength() > 20)	{
		// 全角１０文字を超えていれば改行マークを挿入して取り込む
		cs2 = m_clsFunc.GetSpritString(cs,&cs1,20);
...
//		RET		なし
//********************************************************************************
void	CfrmUc042KasitukeI::virFncReferenceUpdateTbl( int intRefType, int nRefMode/*=0*/ )
{
	switch ( intRefType ) {
		// 貸付先1・貸付先2，所在地1・所在地2
		case ID_DLGTYPE_ADDRESS:
...
//	その他イベント処理
//********************************************************************************
BOOL	CfrmUc042KasitukeI::PreTranslateMessage( MSG* pMsg )
{
...
// 頁コントロールのフォーカス設定
void	CfrmUc042KasitukeI::FocusPagediag1()
{
}

// 頁コントロールのゲットフォーカス
void	CfrmUc042KasitukeI::EditONPagediag1( short index )
{
// 修正No.168443 add -->
	// ---- 登録番号一覧関連 ----->
	if(pZmSel && pZmSel->IsDisplay() != FALSE) {
...
// 頁コントロールのロストフォーカス
void	CfrmUc042KasitukeI::EditOFFPagediag1( short index )
{
...
// 頁コントロールのキー操作
void	CfrmUc042KasitukeI::TerminationPagediag1( short index, short nChar, short length, LPUNKNOWN data )
{
	int nMaxDataCol = 0;
	// カレント頁の合計行の種別を取得
	...
	switch ( nChar ) {
		...
		case VK_TAB:
			...
			if ( CmnCheckShiftKey() == FALSE ) {
				...
				CmnDiagSetFocus(m_pDiag, nMaxDataCol, ID_COL_042I_NAIYOU);
			}
			break;
		case VK_DOWN:
			// タイトルコントロールへ移動
...
// タイトルコントロールのフォーカス設定
void	CfrmUc042KasitukeI::FocusTitlediag1()
{
}

// タイトルコントロールのゲットフォーカス
void	CfrmUc042KasitukeI::EditONTitlediag1( short index )
{
// 修正No.168443 add -->
	// ---- 登録番号一覧関連 ----->
	if(pZmSel && pZmSel->IsDisplay() != FALSE) {
...
// タイトルコントロールのロストフォーカス
void	CfrmUc042KasitukeI::EditOFFTitlediag1 (short index )
{
	m_Titlefocus = 0;
	virUpdateTitle();
}
...
//	タイトル更新
void CfrmUc042KasitukeI::virUpdateTitle()
{
...
// タイトルコントロールのキーイベント
void	CfrmUc042KasitukeI::TerminationTitlediag1( short index, short nChar, short length, LPUNKNOWN data )
{
	// フォーカス移動
	switch ( nChar ) {
		case VK_RETURN:
...
void	CfrmUc042KasitukeI::EditONYoushikidiag1( short index )
{
	...
	switch (m_uInfo.intCurCol) {
		case ID_COL_042I_INVONOT:	// 登録番号(T選択)
			// コンボボックスのオフセット値取得
	...
	if ( ( m_uInfo.OldRow > 0 ) ) {
		if ( m_uInfo.OldPage == m_uInfo.intCurPage && m_uInfo.OldPage > 0 ) {
			...
			BOOL adadd1_to_adadd2 = IsSaveMoveReference(ID_COL_042I_ADADD1, ID_COL_042I_ADADD2);
			// [Home]キー押下の住所検索ダイアログの戻り（フォーカスをセットしている）は保存しない（改良依頼No15-1613）
			BOOL adadd1_to_adadd1 = IsSaveMoveReference(ID_COL_042I_ADADD1, ID_COL_042I_ADADD1);	// 所在地1(住所)→所在地1(住所)
			BOOL adadd2_to_adadd2 = IsSaveMoveReference(ID_COL_042I_ADADD2, ID_COL_042I_ADADD2);	// 所在地2(住所)→所在地2(住所)　所在地2から住所が長すぎる場合、ここがFALSEになる
			// T選択⇔登録番号は保存しない
			BOOL tsel_to_invno = IsSaveMoveReference(ID_COL_042I_INVONOT, ID_COL_042I_INVONO);
	...
	if(m_uInfo.intCurCol == ID_COL_042I_INVONO && m_EndSyorityu == 0)	{
// 修正No.168377 del -->
...
// 修正No.168377 add -->
		// 登録番号のT選択の値を取得
		int pos = CmnGetControlIndex(m_uInfo.intCurRow, ID_COL_042I_INVONOT);
...
// データコントロールのロストフォーカス
void	CfrmUc042KasitukeI::EditOFFYoushikidiag1( short index )
{
	if( m_EndView != FALSE )	return;

// 修正No.168443 add -->
	// ---- 登録番号一覧関連 ----->
	if(m_uInfo.intCurCol != ID_COL_042I_INVONO) {
		if(pZmSel && pZmSel->IsDisplay() != FALSE) {
			pZmSel->DialogOFF();
		}
	}
...
// 修正No.168443 del -->
	//// ---- 登録番号一覧関連 ----->
	//if(pZmSel && m_uInfo.intCurCol != ID_COL_042I_INVONO) {
	...
	//		//// カーソル移動処理
	//		//CmnDiagSetFocus( m_pDiag, m_uInfo.intCurRow, ID_COL_042I_INVONO );
	//	}
	//}
// 修正No.168443 del <--
// 修正No.168443 add -->
...
//	入力確定
void CfrmUc042KasitukeI::virInputDecisionEditOFF()
{
	// フォーカスフラグOFF
...
// 預貯金データコントロールのキーイベント
void	CfrmUc042KasitukeI::TerminationYoushikidiag1( short index, short nChar, short length, LPUNKNOWN data )
{
	//--------------------------------------------------------------------------------
	//	キー操作仕様
...
void CfrmUc042KasitukeI::VScrollYoushikidiag1(short mode)
{
// 修正No.168430 del -->
...
//********************************************************************************
int	CfrmUc042KasitukeI::GetFocusPosition( int nChar )
{
	int		intRow;				// カレント行番号
	int		intCol;				// カレント列番号
	...
	else if(intCol == ID_COL_042I_ADADD1)	{
		// カレント列が「所在地1」の場合
	...
	else if(intCol == ID_COL_042I_ADADD2)	{
		// カレント列が「所在地2」の場合
	...
	else if(intCol == ID_COL_042I_RATE)	{
		// カレント列が「利率」の場合
		intVector[0] = m_uInfo.intCurCtlIndex - m_uInfo.intColMax;		// ↑
	...
	else if(intCol == ID_COL_042I_NAIYOU)	{
		// カレント列が「担保の内容」の場合
		intVector[0] = m_uInfo.intCurCtlIndex - m_uInfo.intColMax;		// ↑
	...
	switch ( nChar ) {
		...
		case VK_RETURN:	// Enterキーでカーソルを下に移動するモード対応
			if(m_ReturnMoveDown){
				if(intCol == ID_COL_042I_INVONOT)	intNext = intVector[1];		//	カレント列が「登録番号(T表示)」欄の場合「→」キーと同じ
...
//********************************************************************************
int	CfrmUc042KasitukeI::GetTotalRowIndex( int nCharOrg, int intIndex, int intNext )
{
	...
	//	現在、頁計に居る
		...
		switch ( nCharTemp ){
			case VK_UP:			// ↑：23行目のデータ行の支店名項目へ移動
				nRet = CmnGetControlIndex( nBorder[0], ID_COL_042I_ADADD2 );
				break;
			case VK_LEFT:		// ←/Shift+Tab：23行目のデータ行の摘要項目へ移動
				nRet = CmnGetControlIndex( nBorder[0], ID_COL_042I_NAIYOU );
				break;
			default:			// →/↓/Return/Tab：25行目の合計行②へ移動
				...
				//	累計あり
					...
					nRet = CmnGetControlIndex( ( nBorder[2] + 1 ), ID_COL_042I_ADNAME1 );
				}
				break;
		}
	}
	//	現在、累計に居る場合
		...
		switch ( nCharTemp ){
			...
			case VK_LEFT:		// ←/Shift+Tab：24行目の合計行① or 24行目のデータ行の摘要項目へ移動
				nRet = CmnGetControlIndex( ( nBorder[1] + 1 ), ID_COL_042I_ADNAME1 );
				break;
			default:			// →/↓：移動できない
				// 例外処理：最終項目で"Tab"は別コントロールへ移動
				// それ以外は「→」キーと同じ
...
//		RET		なし
//********************************************************************************
void	CfrmUc042KasitukeI::virTblEditIkkatuLine( int nType, CdbUc000Common* rsData,
...
//********************************************************************************
int	CfrmUc042KasitukeI::virTblSortSubSortProc( CdlgSort* pCdlgSort, CdbUc000Common* rsData )
{
	CdbUc042Kasituke*	rs;
	CString				strFilter;
	CString				strSort;
...
/**********************************************************************
	...
	戻値
		int		成功/失敗
				FUNCTION_OK
***********************************************************************/
int	CfrmUc042KasitukeI::RecBufSetData( CdbUc042Kasituke* prmDbRec )
{
...
/**********************************************************************
	...
	戻値
		int		成功/失敗
				FUNCTION_OK
***********************************************************************/
int	CfrmUc042KasitukeI::RecBufClearAllData()
{
...
/**********************************************************************
	...
	戻値
		int		成功/失敗
				FUNCTION_OK
***********************************************************************/
int	CfrmUc042KasitukeI::RecBufClearData( P_REC_UC_042_KASITUKE inRecData )
{
...
/**********************************************************************
	...
	戻値
		int				成功(更新あり)/成功(更新なし)/失敗
						...
						FUNCTION_NG		: 失敗
***********************************************************************/
int	CfrmUc042KasitukeI::virRecBufSaveData( int inPage, int inRow )
{
	...
	// 登録番号（T選択）
	intIndex = CmnGetControlIndex(inRow, ID_COL_042I_INVONOT);
	m_pDiag->GetData(intIndex, (LPUNKNOWN)&diadata);
	tsel = diadata.data_combo;

	// 登録番号（法人番号）
	intIndex = CmnGetControlIndex(inRow, ID_COL_042I_INVONO);
...
// 修正No.168534,168539 add <--
	...
	intIndex = CmnGetControlIndex( inRow, ID_COL_042I_ADNAME1 );
	...
	if ( tmpSaveData.m_AdName2.IsEmpty() ){
		if(m_uInfo.intCurCol == ID_COL_042I_ADNAME1 && m_uInfo.intCurRow != m_uInfo.OldRow){	// 各カラムごとにvirRecBufSaveData()がコールされるようになり、かつタイミングがEditOffからEditOnに移ったことによりCmnDiagSetString()でカレットが末尾から先頭に移ってしまう為、制御
			CmnDiagSetString( m_pDiag, intIndex, tmpSaveData.m_AdName1, 0 );
		}
	}

	// 法人・代表者との関係
	intIndex = CmnGetControlIndex( inRow, ID_COL_042I_KANKEI );
	tmpSaveData.m_Kankei = m_clsFunc.DiagGetString( m_pDiag, intIndex );

	// 所在地1（住所）
	intIndex = CmnGetControlIndex( inRow, ID_COL_042I_ADADD1 );
	tmpSaveData.m_AdAdd1 = m_clsFunc.DiagGetString( m_pDiag, intIndex );

	// 所在地2（住所）
	intIndex = CmnGetControlIndex( inRow, ID_COL_042I_ADADD2 );
	tmpSaveData.m_AdAdd2 = m_clsFunc.DiagGetString( m_pDiag, intIndex );

	// 期末現在高
	intIndex = CmnGetControlIndex( inRow, ID_COL_042I_VAL );
	tmpSaveData.m_Val = CmnDiagGetKingaku( m_pDiag, intIndex );

	// 期中の受取利息額
	intIndex = CmnGetControlIndex( inRow, ID_COL_042I_RISOKU );
	tmpSaveData.m_Risoku = CmnDiagGetKingaku( m_pDiag, intIndex );

	// 利率
	intIndex = CmnGetControlIndex( inRow, ID_COL_042I_RATE );
	tmpSaveData.m_Rate = CmnDiagGetKingaku( m_pDiag, intIndex );

	// 貸付理由
	intIndex = CmnGetControlIndex( inRow, ID_COL_042I_RIYUU );
	tmpSaveData.m_Riyuu = m_clsFunc.DiagGetString( m_pDiag, intIndex );

	// 担保の内容
	intIndex = CmnGetControlIndex( inRow, ID_COL_042I_NAIYOU );
...
***********************************************************************/
int	CfrmUc042KasitukeI::virRecBufSaveDataForPasteInsert( int inPage, int inRow )
{
...
***********************************************************************/
int	CfrmUc042KasitukeI::virRecBufSaveDataForPaste( int inPage, int inRow )
{
	///////////////////////////////////////////////////////////////
	// 登録処理呼び出し
	return RecBufSaveDataSub( inPage, inRow, &m_CopyData );
...
/**********************************************************************
	...
	戻値
			int					成功(更新あり)/成功(更新なし)/失敗
								...
								FUNCTION_NG		: 失敗
***********************************************************************/
int	CfrmUc042KasitukeI::RecBufSaveDataSub( 
							int inPage,
							int inRow,
							P_REC_UC_042_KASITUKE inSaveData )
{
	...
	udtTemp.m_AdSeq = inSaveData->m_AdSeq;										// (取引先シーケンス番号)	// 修正No.168534,168539 add
	...
	// 各行末尾のスペースをカット
	udtTemp.m_AdAdd1 = m_clsFunc.DeleteRightSpace(inSaveData->m_AdAdd1);		// (所在地1（住所）)
	// 各行末尾のスペースをカット
	udtTemp.m_AdAdd2 = m_clsFunc.DeleteRightSpace(inSaveData->m_AdAdd2);		// (所在地2（住所）)
	...
	if ( udtTemp.m_FgFunc <= ID_FGFUNC_DATA ) {	// データ行 または、空行なら
		...
		if ( ( udtTemp.m_InvNo == "" )			// 画面上のデータ格納用(登録番号)
		  && ( udtTemp.m_AdName1 == "" )		// 画面上のデータ格納用(貸付先1)
...
// 修正No.168534,168539 add -->
		if((udtTemp.m_FgFunc == ID_FGFUNC_DATA) && (m_InvnoErrFlg == 0 && ufgInvNo == TRUE)) {	// 変更ありの場合
			...
			if(m_RegAutoRef)	udtTemp.m_AdSeq = rsAdd.CheckAdSeqEntry_Inv(udtTemp.m_AdSeq, udtTemp.m_AdName1, udtTemp.m_AdName2, cs1, cs2, udtTemp.m_InvNo, ID_ADDRESSGR_URI, FALSE, TRUE, 0);
			else				udtTemp.m_AdSeq = rsAdd.GetSeqFromAdName_Inv(ID_ADDRESSGR_URI, udtTemp.m_AdName1, udtTemp.m_AdName2, cs1, cs2, udtTemp.m_InvNo);
...
// 修正No.168534,168539 add <--
				...
				if(m_RegAutoRef)	udtTemp.m_AdSeq = rsAdd.CheckEntry_Inv(udtTemp.m_AdName1, udtTemp.m_AdName2, cs1, cs2, udtTemp.m_InvNo, ID_ADDRESSGR_URI, TRUE);
				else				udtTemp.m_AdSeq = rsAdd.GetSeqFromAdName_Inv(ID_ADDRESSGR_URI, udtTemp.m_AdName1, udtTemp.m_AdName2, cs1, cs2, udtTemp.m_InvNo);
...
//********************************************************************************
CdbUc000Common*	CfrmUc042KasitukeI::virGetDataTableObject()
{
	// 「貸付金」テーブルのオブジェクトを生成し、ポインタを返す
...
//	RET	なし
//********************************************************************************
void	CfrmUc042KasitukeI::virRowButtonCopyProc()
{
...
//	RET	なし
//********************************************************************************
void CfrmUc042KasitukeI::virTblGetIkkatuSumValue(CdbUc000Common* rsData, int nFgShow, int nGroup, CALCKEI_INFO* uCalcKei)
{
	// 通常は"Val"項目のみ集計する。
...
//	RET	なし
//********************************************************************************
void	CfrmUc042KasitukeI::virGetCurrentInfo( CURRENT_INFO* uCurInfo )
{
...
//********************************************************************************
int	CfrmUc042KasitukeI::virUpdateRelationTblChengeFormType()
{
	// ④-2で通常/個別を変更した場合、④-1の頁構成の更新が必要となる
	//CfrmUc041Karibarai	pfrm041;
	CfrmUc041KaribaraiI	pfrm041;
...
//		RET		BOOL		TRUE:正常終了，FALSE:エラー
//********************************************************************************
BOOL CfrmUc042KasitukeI::virUpdateRelationTblChengeFormTypeSave()
{
...
//		RET		なし
//********************************************************************************
int	CfrmUc042KasitukeI::UpdateTbl042ChangeFormType(UCHIWAKE_INFO pInfoSv)
{
	// データ無しならデータ更新しない
...
//	【戻値】	なし
//**************************************************
void CfrmUc042KasitukeI::SetInputMode( int nRow, long nMode )
{
	m_pDiag->ModifyItem( CmnGetControlIndex( nRow, ID_COL_042I_INVONOT ), nMode );	//	登録番号（T選択）
	m_pDiag->ModifyItem( CmnGetControlIndex( nRow, ID_COL_042I_INVONO), nMode );	//	登録番号
	m_pDiag->ModifyItem( CmnGetControlIndex( nRow, ID_COL_042I_ADNAME1 ), nMode );	//	
	m_pDiag->ModifyItem( CmnGetControlIndex( nRow, ID_COL_042I_ADADD1 ), nMode );	//	
	m_pDiag->ModifyItem( CmnGetControlIndex( nRow, ID_COL_042I_ADADD2 ), nMode );	//	
	m_pDiag->ModifyItem( CmnGetControlIndex( nRow, ID_COL_042I_KANKEI ), nMode );	//	
	m_pDiag->ModifyItem( CmnGetControlIndex( nRow, ID_COL_042I_VAL ), nMode );		//	
	m_pDiag->ModifyItem( CmnGetControlIndex( nRow, ID_COL_042I_RISOKU ), nMode );	//	
	m_pDiag->ModifyItem( CmnGetControlIndex( nRow, ID_COL_042I_RATE ), nMode );		//	
	m_pDiag->ModifyItem( CmnGetControlIndex( nRow, ID_COL_042I_RIYUU ), nMode );	//	
	m_pDiag->ModifyItem( CmnGetControlIndex( nRow, ID_COL_042I_NAIYOU ), nMode );	//	
}
...
//	【戻値】	なし
//**************************************************
void CfrmUc042KasitukeI::SetDiagBackColor()
{
...
//		RET		なし					
//********************************************************************************
void CfrmUc042KasitukeI::virRendoCreateData(CdbUc000Common* rsData, RENTEMP_INFO* uRenInfo)
{
	CString			strTemp;
...
//		RET		なし					
//********************************************************************************
void CfrmUc042KasitukeI::virRendoUpdateData(CdbUc000Common* rsData, RENTEMP_INFO* uRenInfo)
{
	CdbUc042Kasituke*	rs = (CdbUc042Kasituke*)rsData;
...
//***************************************************************************
BOOL CfrmUc042KasitukeI::virEndProc(void)
{
	TRACE(_T("***** CfrmUc042KasitukeI::virEndProc\n"));
...
int CfrmUc042KasitukeI::CursorControl(short nChar, int sw)
{
	int				rv=0;
	int				intCol=0;
	int				pos=0;
	...
	if((nChar == VK_TAB && (key & 0x80) == 0x80) || (nChar == VK_LEFT) || (nChar == VK_RIGHT)) {
		...
		if(intCol == ID_COL_042I_INVONOT)	{	// 登録番号(T選択)
			m_pDiag->ComboDropDown(m_uInfo.intCurCtlIndex, FALSE);
			CmnDiagSetCombo(m_pDiag, m_uInfo.intCurCtlIndex, m_uInfo.OldCombo);
		}
	}
...
// ------------------------------------------------------------------------------------------------------------------------
void CfrmUc042KasitukeI::TitleColorChg(void)
{
...
LRESULT CfrmUc042KasitukeI::OnUserReDrawView(WPARAM wParam, LPARAM lParam)
{
	virUpdateControlTblData();
	CmnDiagSetFocus(m_pDiag, 1, 1);
...
//		RET		なし
// --------------------------------------------------------------------------------------------------------
void CfrmUc042KasitukeI::virDiagGetHjnData(CDatabase* pDB, HJN_REC_NEW* phjnRec)
{
	int					nPage,nRow;
	int					intIndex;	// 対象行の各インデックス
	int					tsel=0;
	...
	// 登録番号（法人番号）
	cst.Empty();
	intIndex = CmnGetControlIndex(nRow, ID_COL_042I_INVONO);
	...
	// 名称1(氏名)
	intIndex = CmnGetControlIndex(nRow, ID_COL_042I_ADNAME1);
	m_clsFunc.StrDivision(m_clsFunc.DiagGetString(m_pDiag, intIndex), &strArray, 2, FALSE, TRUE);
	cst.Empty();
	...
	// 所在地1(住所)
	intIndex = CmnGetControlIndex(nRow, ID_COL_042I_ADADD1);
	cst = m_clsFunc.DiagGetString(m_pDiag, intIndex);
	cst.TrimRight();
	if(cst.IsEmpty() == FALSE)	{
		if(ufc.GetKaigyoCount(cst) > 0) {
			cst.Replace(PRT_FORMAT_CHCODE, _T(""));
		}
		memset(buf, 0, sizeof(buf));
		sprintf_s(buf, _T("%s"), cst);
	...
	// 所在地2(住所)
	intIndex = CmnGetControlIndex(nRow, ID_COL_042I_ADADD2);
	cst = m_clsFunc.DiagGetString(m_pDiag, intIndex);
	cst.TrimRight();
	if(cst.IsEmpty() == FALSE) {
		if(ufc.GetKaigyoCount(cst) > 0) {
...
//		RET		なし
// --------------------------------------------------------------------------------------------------------
void	CfrmUc042KasitukeI::virDiagSetHjnData(int pSw, CString rtInvNo, CString rtName, CString rtAdrs1, CString rtAdrs2, CString rtKana)
{
	int					ret = 0;
	int					intIndex;
	CString				strInvoNo, strName, strAdd1, strAdd2, strKana;
	CString				cst, cs1, cs2, cs3, cs4, cs5;
	CUcFunctionCommon	ufc;
...
// 修正No.168361,168369,168371,168378 del <--
		// 登録番号（T選択）
		intIndex = CmnGetControlIndex(m_uInfo.intCurRow, ID_COL_042I_INVONOT);
		CmnDiagSetCombo3(m_pDiag, intIndex, strInvoNo);

		// 登録番号
		InvoNoSplit(strInvoNo, &cs1, &cs2);
		intIndex = CmnGetControlIndex(m_uInfo.intCurRow, ID_COL_042I_INVONO);
...
// --------------------------------------------------------------------------------------------------------
// --------------------------------------------------------------------------------------------------------
int CfrmUc042KasitukeI::virCallChkInvoiceNum(int pSw, int inPage, int inRow)
{
...
//				CString		pInvno	登録番号
// --------------------------------------------------------------------------------------------------------
int CfrmUc042KasitukeI::ChkInvoiceNum(CDatabase* pDB, int pSw, int inPage, int inRow, 
...
// 修正No.168361,168369,168371,168378 del -->
	...
	//		DIAGRAM_DATA	ddata;
	//		ddata.data_combo = 0;
	//		m_pDiag->SetData(CmnGetControlIndex(inRow, ID_COL_042I_INVONOT), (LPUNKNOWN)&ddata);
	//		ddata.data_edit.Empty();
	//		m_pDiag->DataClear(CmnGetControlIndex(inRow, ID_COL_042I_INVONO), TRUE);
	//		// エラーメッセージを表示
	...
	//		//			}
	//		//		}
	//		//		if(cs2.IsEmpty() == FALSE)	cst = cs1 + _T("\r\n") + cs2;
	//		//		else						cst = cs1;
	//		//		intIndex = CmnGetControlIndex(inRow, ID_COL_042I_ADADD1);
	//		//		CmnDiagSetString(m_pDiag, intIndex, cst, 0);
...
// 修正No.168443 add <--
			...
			if(pZmSel && pZmSel->IsDisplay() != FALSE && cst.GetLength() < 3) {
				...
				if(tmpzd.errflg != -1) {
					...
					m_pDiag->SetData(CmnGetControlIndex(inRow, ID_COL_042I_INVONO), (LPUNKNOWN)&ddata);
					// 再描画
					m_pDiag->Refresh();
...
// 修正No.168425,168443 add -->
					if(pSw == 3 || m_EndSyorityu == 1)	{
						...
						m_uInfo.intCurCol = ID_COL_042I_INVONO;
