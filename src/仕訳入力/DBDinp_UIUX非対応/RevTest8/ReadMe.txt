================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: RevTest8 プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した RevTest8 には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには RevTest8 アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
RevTest8.h
   ...
   CRevTest8App アプリケーション クラスを宣言します。

RevTest8.cpp
   これは、アプリケーション クラス CRevTest8App を含むメイン アプリケー
   ション ソース ファイルです。
...
res\RevTest8.ico
   ...
   アイコンはメイン リソース ファイル RevTest8.rc に含まれていま
   す。
...
RevTest8Dlg.h, RevTest8Dlg.cpp - ダイアログ
   これらのファイルは CRevTest8Dlg クラスを含みます。このクラスはアプ
   リケーションのメイン ダイアログの動作を定義します。ダイアログ テンプレートは
   Microsoft Visual C++ で編集可能な RevTest8.rc に含まれます。
...
StdAfx.h, StdAfx.cpp
   ...
   RevTest8.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
