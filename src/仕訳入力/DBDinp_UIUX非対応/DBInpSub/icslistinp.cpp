...
void CICSListInp::SetLineCountEX(short line)
{
	static BYTE parms[] = VTS_I2 ;
	InvokeHelper(0x2d, DISPATCH_METHOD, VT_EMPTY, NULL, parms, line);
}

void CICSListInp::EnableDelete(short mode)
{
	static BYTE parms[] = VTS_I2 ;
	InvokeHelper(0x2e, DISPATCH_METHOD, VT_EMPTY, NULL, parms, mode);
}
